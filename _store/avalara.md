...
common:
  ...
  - url: https://developer.avalara.com/avatax/authentication-in-rest/
    name: Authentication in AvaTax REST v2 | Avalara Developer
    type: Authentication
    description: 'null'
  - url: https://developer.avalara.com/avatax/errors/
    name: REST Error Codes | Avalara Developer
    type: Errors
    description: 'null'
  ...
  - type: NaftikoCapability
    url: https://raw.githubusercontent.com/api-evangelist/avalara/refs/heads/main/capabilities/avalara-tax-compliance.yaml
  - type: NaftikoCapability
    url: https://raw.githubusercontent.com/api-evangelist/avalara/refs/heads/main/capabilities/avalara-cross-border-compliance.yaml
  - type: Features
    data:
