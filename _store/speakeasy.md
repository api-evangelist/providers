  ...
  - aid: speakeasy:speakeasy
    ...
    properties:
      ...
      - url: https://github.com/speakeasy-api/speakeasy
        type: GitHubRepo
    description: The platform to build APIs your users love. Best-in-class API tooling for robust SDKs, API documentation, Terraform providers, MCP servers, and end-to-end contract testing. OpenAPI-native with no proprietary DSLs.
