...
- name: vSphere Web Services API
  ...
  - type: API Guide
    url: https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere-sdks-tools/8-0/vmware-vsphere-automation-rest-programming-guide-8-0.html
  - type: SDKs
...
- name: vCloud Director API
  ...
  - type: API Reference
    url: https://developer.vmware.com/apis/vmware-cloud-director/latest/reference/
  - type: API Reference
...
- name: vRealize Automation API
  ...
  - type: API Guide
    url: https://techdocs.broadcom.com/us/en/vmware-cis/aria/aria-automation/8-18/aria-automation-api-programming-guide-on-prem-8-18.html
...
- name: vRealize Operations API
  ...
  - type: REST API Guide
    url: https://docs.vmware.com/en/vRealize-Operations/index.html
  - type: API Guide
    url: https://techdocs.broadcom.com/us/en/vmware-cis/aria/aria-operations/8-18/vmware-aria-operations-api-programming-guide-8-18.html
...
- name: VMware Aria Suite Lifecycle API
  ...
  - type: API Guide
    url: https://techdocs.broadcom.com/us/en/vmware-cis/aria/aria-suite-lifecycle/8-18/vmware-aria-suite-lifecycle-programming-guide-8-18.html
...
- name: VMware Aria Automation Orchestrator API
  ...
  - type: API Guide
    url: https://techdocs.broadcom.com/us/en/vmware-cis/aria/aria-automation/all/developing-web-services-client-for-vco-all.html
  - type: Documentation
...
- name: VMware Cloud Director OpenAPI
  ...
  - type: API Guide
    url: https://techdocs.broadcom.com/us/en/vmware-cis/cloud-director/vmware-cloud-director/10-6/-vcloud-api-programming-guide-for-service-providers-10-6.html
