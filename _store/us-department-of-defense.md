...
- aid: us-department-of-defense:us-department-of-defense
  ...
  - url: https://data.defense.gov/Featured-API
    type: Documentation
  description: This months featured Application Programming Interface (API) is . The US Army Corps of Engineers Lock Performance Monitoring System (LPMS). The LPMS Data Web Services provides data via Extensible Markup Language (XML) for the Lock Queue Report (past 24 hours), the Tonnage Report and the Traffic Report (past 30 days).
name: US Department of Defense
tags:
- Federal Government
type: Contract
