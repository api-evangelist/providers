...
aid: braze
url: >-
  https://raw.githubusercontent.com/api-evangelist/braze/refs/heads/main/apis.yml
apis:
  - aid: braze:braze
    name: Braze
    tags:
    ...
    description: >-
      ...
      generated, custom events and user attributes are sent to Braze in
      real-time. These events and attributes can then be used to trigger
      location-based campaigns, power last-mile pickup and delivery operations,
      monitor fleet and shipping logistics, or build user segments based on
      location patterns. 
name: Braze
tags:
  - Locations
