...
- name: OCI API Gateway
  ...
  - type: Overview
    url: https://docs.oracle.com/en-us/iaas/Content/APIGateway/Concepts/apigatewayoverview.htm
  - type: Getting Started
...
- name: OCI Data Science API
  ...
  - type: Overview
    url: https://docs.oracle.com/en-us/iaas/data-science/using/data-science.htm
...
- name: OCI Search with OpenSearch API
  ...
  - type: Overview
    url: https://docs.oracle.com/en-us/iaas/Content/search-opensearch/Concepts/ociopensearch.htm
...
modified: '2026-04-07'
position: Consuming
description: Collection of Oracle's APIs and developer resources.
maintainers:
- FN: Kin Lane
