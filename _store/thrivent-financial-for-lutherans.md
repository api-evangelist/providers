---
aid: thrivent-financial-for-lutherans
...
tags:
  ...
  - Mutual Funds
  - Non Profit
url: https://raw.githubusercontent.com/api-evangelist/thrivent-financial-for-lutherans/refs/heads/main/apis.yml
created: '2026-03-21'
modified: '2026-05-03'
specificationVersion: '0.19'
apis:
  - aid: thrivent-financial-for-lutherans:thrivent-financial-planning
    name: Thrivent Financial Planning
    description: Comprehensive financial planning and advisory services from Thrivent Financial, offering personalized advice across investments, insurance, estate planning, and retirement. Services include free Money Coaching, Dedicated Planning Services with ongoing advisor relationships, and Managed Accounts for investment management.
    humanURL: https://www.thrivent.com/
    ...
    contact:
      - FN: Thrivent Financial
        url: https://www.thrivent.com/about-us/support
  - aid: thrivent-financial-for-lutherans:thrivent-insurance
    ...
    humanURL: https://www.thrivent.com/product-overview
    tags:
    ...
    properties:
      - type: Documentation
        url: https://www.thrivent.com/product-overview
  - aid: thrivent-financial-for-lutherans:thrivent-investments
    name: Thrivent Investments
    description: Investment products from Thrivent Financial including mutual funds, actively managed ETFs, annuities, and managed accounts. Includes the Thrivent Managed Accounts Program (minimum $25,000 investment) and a range of actively managed ETFs.
    humanURL: https://www.thrivent.com/product-overview
    tags:
      - Annuities
      - ETFs
    ...
    properties:
      - type: Documentation
        url: https://www.thrivent.com/product-overview
  - aid: thrivent-financial-for-lutherans:thrivent-bank
    name: Thrivent Bank
    ...
    properties:
      - type: Documentation
        url: https://www.thrivent.com/product-overview
  - aid: thrivent-financial-for-lutherans:thrivent-charitable
    name: Thrivent Charitable
    description: Charitable giving and generosity programs from Thrivent including Thrivent Action Teams (190,000 teams with 2.4M volunteers in 2025), donor-advised funds, and member giving programs designed to connect financial resources with community impact.
    humanURL: https://www.thrivent.com/
    tags:
      - Charitable Giving
      - Community Impact
