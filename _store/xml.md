...
apis:
  ...
  - aid: xml:xml-11
    name: XML 1.1
    description: Extensible Markup Language (XML) 1.1 is a W3C Recommendation published in 2006 that extends XML 1.0 to support newer Unicode versions, additional line ending characters, and a broader set of name characters. XML 1.1 is rarely deployed in practice; XML 1.0 remains the dominant version used in production systems.
  ...
  - aid: xml:xml-namespaces
    name: XML Namespaces
    description: Namespaces in XML 1.0 (Third Edition) is the W3C Recommendation that defines a mechanism for qualifying element and attribute names in XML documents using URI references. XML Namespaces allow vocabularies from different sources to be combined in a single document without naming collisions, and underpin every modern XML application including XHTML, SOAP, XSLT, and SVG.
