...
apis:
  ...
  - aid: microsoft-graph:microsoft-graph-agreement-acceptances
    ...
    description: >-
      ...
      records of users’ responses to your organization’s Terms of Use configured
      ...
      declined), the timestamp, and—if per‑device consent is required—the device
  ...
  - aid: microsoft-graph:microsoft-graph-agreements
    ...
    description: >-
      ...
      notices, or acceptable use policies), configure how they’re shown to
      ...
      provides detailed acceptance records—who accepted, when, which version,
      and often device/context—so you can audit compliance at scale and automate
  ...
  - aid: microsoft-graph:microsoft-graph-applicaiton-catalogs
    ...
    description: >-
      ...
      Store and your organization’s private app catalog. Through the
      ...
      line‑of‑business Teams apps, and remove them when needed. It also supports
      installing or removing apps for users, teams, or group chats at scale,
      enabling end‑to‑end automation of app lifecycle and governance from within
  ...
  - aid: microsoft-graph:microsoft-graph-applications
    ...
    description: >-
      ...
      integration, insights and analytics, and cross‑app experiences. They
      support both delegated permissions (acting as a signed‑in user) and
      ...
      Outlook, OneDrive, SharePoint, Teams, Planner, Excel, and more—using
      Microsoft identity, consent, and scopes to enforce fine‑grained,
  ...
  - aid: microsoft-graph:microsoft-graph-application-templates
    ...
    properties:
      ...
      - url: openapi/applicationtemplates-openapi-original.yml
        type: OpenAPI
    description: >-
      Microsoft Graph Application Templates are open‑source, ready‑to‑deploy
      ...
      end‑to‑end code (UI, APIs, background processing), Azure
  ...
  - aid: microsoft-graph:microsoft-graph-audit-logs
    ...
    description: >-
      ...
      available fields depend on your tenant’s licensing and configuration, and
  ...
  - aid: microsoft-graph:microsoft-graph-authentication-method-configurations
    ...
    description: >-
      ...
      available in Microsoft Entra ID (formerly Azure AD), how they’re
      configured, and who they apply to. Through Graph endpoints—such as the
      authentication methods policy and method-specific resources—you can enable
  ...
  - aid: microsoft-graph:microsoft-graph-authentication-methods-policies
    ...
    description: >-
      ...
      Microsoft Entra ID (Azure AD) and how they’re used. Through Graph API
      ...
      behavior such as registration requirements, use for MFA and self‑service
      password reset, key and device restrictions, TAP lifetimes/one‑time use,
  ...
  - aid: >-
    ...
    properties:
      ...
      - url: openapi/certificatebasedauthconfiguration-openapi-original.yml
        type: OpenAPI
    description: >-
      Microsoft Graph’s certificate-based authentication configuration is a
  ...
  - aid: microsoft-graph:microsoft-graph-chats
    ...
    description: >-
      ...
      and chat messages. With it, you can list a user’s 1:1, group, and meeting
  ...
  - aid: microsoft-graph:microsoft-graph-communications
    ...
    description: >-
      ...
      voice/video bots—such as IVRs, meeting assistants, and compliance
      recording solutions—that join Teams calls and meetings (including those
  ...
  - aid: microsoft-graph:microsoft-graph-compliance
    ...
    description: >-
      ...
      lets you orchestrate eDiscovery (Premium) end to end—create cases, add
      custodians and data sources, place legal holds, run searches, collect to
      review sets, and export results—integrating these steps into custom apps
      ...
      privacy regulations. Built on Microsoft Graph’s permissions, RBAC, and
  ...
  - aid: microsoft-graph:microsoft-graph-connections
    ...
    description: >-
      ...
      data—like content from Salesforce, ServiceNow, Confluence, file shares, or
      custom line‑of‑business apps—into Microsoft 365 by indexing it in
      ...
      security‑trimmed and searchable across Microsoft Search, appears in apps
  ...
  - aid: microsoft-graph:microsoft-graph-contracts
    ...
    description: >-
      ...
      customer tenants they have a relationship with. It returns each customer’s
      key directory identifiers and metadata—like tenant (customer) ID, default
      domain name, display name, and the relationship/contract type—so partner
  ...
  - aid: microsoft-graph:microsoft-graph-copilot
    ...
    description: >-
      ...
      Microsoft 365 data. It honors your organization’s security and only works
      with data you’re authorized to access.
  - aid: microsoft-graph:microsoft-graph-data-policy-operations
    ...
    description: >-
      ...
      tasks, most commonly exporting a user’s personal data. When you start an
  ...
  - aid: microsoft-graph:microsoft-graph-device-management
    ...
    description: >-
      ...
      expose Microsoft Intune’s endpoint management capabilities, letting you
      ...
      Because it’s part of Microsoft Graph, you can combine device management
  ...
  - aid: microsoft-graph:microsoft-graph-devices
    ...
    description: >-
      ...
      can list and query Azure AD–registered or joined devices and their
      ...
      support actions—such as sync, retire, wipe, restart, remote lock, and
      more—subject to the appropriate permissions and device platform
      capabilities. Organizations use these APIs to build asset inventories,
      drive conditional access and app targeting, automate help‑desk workflows,
  ...
  - aid: microsoft-graph:microsoft-graph-directory
    ...
    description: >-
      ...
      Microsoft Graph, providing programmatic access to an organization’s
      ...
      governed by Graph’s granular permission model for delegated and app-only
      access. Because it’s part of Microsoft Graph, directory objects are
  ...
  - aid: microsoft-graph:microsoft-graph-directory-objects
    ...
    description: >-
      ...
      and contacts—and gives them a consistent ID, metadata, and set of
  ...
  - aid: microsoft-graph:microsoft-graph-directory-roles
    ...
    description: >-
      ...
      roles—the RBAC roles that control permissions across Microsoft 365 and
      Entra. Through the API you can list which roles are active in a tenant,
      read role definitions from templates, activate built‑in roles, enumerate a
      role’s members, and add or remove assignments for users, groups, or
      ...
      least‑privilege access, inventory and audit who has what permissions, and
  ...
  - aid: microsoft-graph:microsoft-graph-directory-role-templates
    ...
    description: >-
      ...
      names and descriptions. You can use a template’s ID to activate that role
      ...
      collection and can have members assigned. Templates themselves can’t be
  ...
  - aid: microsoft-graph:microsoft-graph-domain-dns-records
    ...
    description: >-
      ...
      action. Graph itself doesn’t change your DNS; you publish the returned
  ...
  - aid: microsoft-graph:microsoft-graph-domains
    ...
    description: >-
      ...
      for discovering and managing your organization’s domain names in Microsoft
      ...
      domains when they’re no longer referenced. These capabilities enable
  ...
  - aid: microsoft-graph:microsoft-graph-drives
    ...
    description: >-
      ...
      library—personal or shared—and exposes its files and folders (driveItems)
      in the same way whether they live in a user’s OneDrive, a SharePoint site,
  ...
  - aid: microsoft-graph:microsoft-graph-employee-experience
    ...
    description: >-
      ...
      manage learning assignments, and track users’ course activities—all while
  ...
  - aid: microsoft-graph:microsoft-graph-external
    ...
    description: >-
      ...
      /external namespace) that lets you bring content from third‑party apps and
      line‑of‑business systems into Microsoft 365. You create external
  ...
  - aid: microsoft-graph:microsoft-graph-filter-operators
    ...
    description: >-
      ...
      to Graph API requests to narrow results on the server before they’re
      returned. They let you select only the resources that match certain
      criteria—such as equality and comparison checks (eq, ne, gt, ge, lt, le),
      ...
      avoiding client‑side post‑processing. Support for specific operators
      varies by resource and property (not all fields are filterable), and some
      advanced scenarios—like filtering on certain directory properties or using
      $count with filters—require the ConsistencyLevel: eventual header.
  ...
  - aid: microsoft-graph:microsoft-graph-group-lifecycle-policies
    ...
    description: >-
      ...
      soft‑deleted and can be restored within a grace period. Policies can be
      created and managed programmatically via Microsoft Graph—specifying the
      lifetime in days, choosing which groups are managed, adding or removing
      groups from a policy, and triggering renewals—helping organizations reduce
  ...
  - aid: microsoft-graph:microsoft-graph-groups
    ...
    description: >-
      ...
      such as expiration. For Microsoft 365 groups, it also links to the group’s
      collaborative assets—SharePoint site and files (drive), mailbox and
      calendar, Planner plans, and Microsoft Teams—so apps can provision groups,
      automate membership and governance, and enable end‑to‑end collaboration
  ...
  - aid: microsoft-graph:microsoft-graph-group-setting-templates
    ...
    description: >-
      ...
      that enforce organization‑wide or per‑group behavior—such as who can
  ...
  - aid: microsoft-graph:microsoft-graph-identity
    ...
    description: >-
      ...
      security and compliance signals—such as sign-in and audit logs and risk
      detections—for monitoring and response. Organizations use it to build SSO
  ...
  - aid: microsoft-graph:microsoft-graph-identity-governance
    ...
    description: >-
      ...
      to what, for how long, and why—across employees, contractors, guests, and
      connected applications. Through Graph, you can orchestrate
      joiner–mover–leaver lifecycle workflows; deliver governed access via
  ...
  - aid: microsoft-graph:microsoft-graph-identity-providers
    ...
    description: >-
      ...
      Connect–compliant providers; supply client IDs/secrets and issuer/metadata
  ...
  - aid: microsoft-graph:microsoft-graph-information-protection
    ...
    description: >-
      ...
      tenant’s label taxonomy and policy settings, evaluate which label should
      ...
      workflows, embed labeling into custom solutions, run what‑if policy
  ...
  - aid: microsoft-graph:microsoft-graph-invitations
    ...
    description: >-
      ...
      You can set the invited user’s email and display name, choose a
  ...
  - aid: microsoft-graph:microsoft-graph-me
    ...
    properties:
      ...
      - url: openapi/me-openapi-original.yml
        type: OpenAPI
    description: >-
      Microsoft Graph “Me” is a shortcut to the signed-in user’s resource,
      letting apps work with the current user’s data across Microsoft 365
      without knowing their user ID. Through the /me endpoint, you can retrieve
      and update profile details and settings; get the user’s photo and
  ...
  - aid: microsoft-graph:microsoft-graph-oauth2-permission-grants
    ...
    description: >-
      ...
      delegated permissions (scopes) a client application’s service principal
      ...
      app role assignments (appRoleAssignment). These objects don’t contain
      tokens or secrets—they are authoritative consent records used by the
  ...
  - aid: microsoft-graph:microsoft-graph-organizations
    ...
    properties:
      ...
      - url: openapi/organization-openapi-original.yml
        type: OpenAPI
    description: >-
      Microsoft Graph Organizations exposes a tenant’s organization profile in
      Microsoft Entra ID (formerly Azure Active Directory) so apps can discover
      and manage directory‑level information through a single API. It lets you
      read core details like the tenant’s display name and ID, verified domains,
      ...
      multi‑tenant app experiences, verifying domain ownership, showing company
  ...
  - aid: microsoft-graph:microsoft-graph-places
    ...
    description: >-
      ...
      Microsoft 365—primarily meeting rooms and room lists (and, in some
  ...
  - aid: microsoft-graph:microsoft-graph-planner
    ...
    description: >-
      ...
      integration scenarios—such as syncing tasks with line-of-business systems,
      building dashboards and reports, or triggering workflows and
      notifications—while honoring Microsoft 365 permissions and compliance.
      They’re available via REST and Microsoft Graph SDKs with delegated or
  ...
  - aid: microsoft-graph:microsoft-graph-print
    ...
    description: >-
      ...
      subscriptions for event-driven processing and notifications. Because it’s
      ...
      printers—eliminating the need for local print servers or device-specific
      drivers.
  ...
  - aid: microsoft-graph:microsoft-graph-reports
    ...
    description: >-
      ...
      Print—covering activity (active users, messages, meetings, file actions),
      storage and mailbox usage, app activations, and device usage—as well as
  ...
  - aid: microsoft-graph:microsoft-graph-role-management
    ...
    description: >-
      ...
      With these endpoints, you can automate least-privilege governance—discover
  ...
  - aid: microsoft-graph:microsoft-graph-schema-extensions
    ...
    description: >-
      ...
      fields to Microsoft 365 resources—such as users, groups, messages, events,
      devices, and more—so your application’s data can live alongside Microsoft
      ...
      service, keeps data consistent and secured under Microsoft Graph’s auth
  ...
  - aid: microsoft-graph:microsoft-graph-scoped-role-memberships
    ...
    description: >-
      ...
      Administrator) so that the assignee’s authority applies only to the users,
      groups, or other objects contained in a specific administrative unit. This
      enables least‑privilege, regional or departmental delegation, supports
      listing and removing scoped assignments, and provides a way to audit who
      has which admin capabilities over which subset of the directory—all via
      Microsoft Graph.
  - aid: microsoft-graph:microsoft-graph-search
    ...
    description: >-
      ...
      Teams, and more—as well as external systems connected through Graph
      connectors. It returns security‑trimmed, relevance‑ranked, and
      personalized results based on the user’s permissions and work signals.
  ...
  - aid: microsoft-graph:microsoft-graph-security
    ...
    description: >-
      ...
      custom apps—all through a consistent schema, single authentication and
  ...
  - aid: microsoft-graph:microsoft-graph-service-principals
    ...
    description: >-
      ...
      target against which your app’s own service principal is granted consent.
      Once consented, your app can obtain tokens and call Microsoft Graph—either
  ...
  - aid: microsoft-graph:microsoft-graph-shares
    ...
    description: >-
      ...
      thumbnails, and download content—and, if the link grants edit rights, make
  ...
  - aid: microsoft-graph:microsoft-graph-sites
    ...
    description: >-
      ...
      by URL, search for sites, and navigate a site’s structure to access
      ...
      a site to connected resources like users, groups, and Teams. Because it’s
  ...
  - aid: microsoft-graph:microsoft-graph-solutions
    ...
    description: >-
      ...
      scale—all governed by Microsoft Entra ID’s consent and granular
  ...
  - aid: microsoft-graph:microsoft-graph-storage
    ...
    description: >-
      ...
      exposed through Microsoft Graph—primarily OneDrive and SharePoint—via the
      ...
      developers can use the user’s OneDrive appFolder as a private per-app
  ...
  - aid: microsoft-graph:microsoft-graph-subscribed-skus
    ...
    description: >-
      ...
      then use Graph’s license assignment endpoints to add or remove that
  ...
  - aid: microsoft-graph:microsoft-graph-subscriptions
    ...
    description: >-
      ...
      notifications (webhooks) when Microsoft 365 data changes—such as Outlook
  ...
  - aid: microsoft-graph:microsoft-graph-teamwork
    ...
    description: >-
      ...
      activity notifications; and discover a user’s associated teams. All of
      this is delivered with Graph’s unified authentication, permissions,
