...
apis:
  - aid: web-summit:attendee-platform
    ...
    description: The Web Summit attendee platform provides conference scheduling, attendee discovery, and networking capabilities through the Web Summit mobile app and web portal. Attendees can browse sessions, discover other attendees and companies, send connection requests, and schedule one-on-one meetings during the event.
  ...
  - aid: web-summit:startup-programme
    ...
    description: The Web Summit Startup Programme (ALPHA and BETA tracks) provides early-stage companies with exhibition space, investor meeting access, masterclass eligibility, and entry into the PITCH competition. The programme is designed to connect startups with investors and media.
  ...
  - aid: web-summit:developer-programme
    ...
    description: The Web Summit Developer Programme provides free ticket access for active developers and open source contributors. The programme includes dedicated content tracks like Developer Summit, AI Summit, SaaS Summit, and FinTech Summit with speakers from OpenAI, Amazon, Uber, Cloudflare, and more.
...
common:
  ...
  - url: https://www.linkedin.com/company/web-summit
    ...
    type: LinkedIn
    description: Web Summit LinkedIn company page.
