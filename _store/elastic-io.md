...
aid: elastic-io
url: >-
  https://raw.githubusercontent.com/api-evangelist/elastic-io/refs/heads/main/apis.yml
apis:
  - aid: elastic-io:elastic-io
    ...
    description: >-
      ...
      you can generate more value from your data with less distraction from your
      core business. 
name: elastic.io
tags:
  - Integrations
...
common:
  ...
  - name: Enterprise Integration Platform by elastic.io
    ...
    data:
      ...
      - name: Stripe
      - name: AccountingFinancesOnline store
      - name: Sugar CRM logo
      - name: Sugar CRM
      - name: CRMCustomer management
      - name: Telegram
