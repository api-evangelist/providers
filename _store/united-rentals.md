---
aid: united-rentals
url: https://raw.githubusercontent.com/api-evangelist/united-rentals/refs/heads/main/apis.yml
created: '2026-03-21'
modified: '2026-05-03'
name: United Rentals
...
tags:
  ...
  - Fortune 500
apis:
  - name: United Rentals Total Control Integration API
    description: United Rentals provides a broad selection of APIs to simplify the procure-to-pay lifecycle for equipment rentals. The Total Control platform supports system integration via EDI, cXML, JSON, spreadsheet, and flat-file formats. Customers can integrate with their procurement or ERP systems for punch-out catalog ordering, automated invoicing, PO management, fleet management, and bill pay. Processes hundreds of secure customer integrations.
    image: https://kinlane-productions2.s3.amazonaws.com/apis-json/apis-json-logo.jpg
    humanURL: https://www.unitedrentals.com/services/online-services/total-control/system-integration
...
common:
  ...
  - type: NaftikoCapabilities
    url: https://raw.githubusercontent.com/api-evangelist/united-rentals/main/capabilities/equipment-rental.yaml
  - type: JSONSchema
