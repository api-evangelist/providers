  ...
  - aid: zuplo:zuplo
    ...
    properties:
      ...
      - url: https://zuplo.com/docs/articles/api-key-api
        type: GettingStarted
    description: The Zuplo Developer API (ZAPI) enables developers to programmatically manage API keys, consumers, buckets, tunnels, deployments, metering, audit logs, and more. It is used to perform management actions on your Zuplo account and integrations.
name: Zuplo
tags:
  - AI Gateway
  - API Management
