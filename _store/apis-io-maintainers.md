---
aid: apis-io-maintainers
url: https://github.com/api-search/maintainer-api/blob/main/apis.yml
apis:
  - aid: apis-io-maintainers:maintainer-api
    ...
    baseURL: https://maintainer-api.apis.io
    contact:
      - FN: APIs.io
        email: info@apis.io
    humanURL: https://developer.apis.io/documentation
    properties:
      - url: https://github.com/api-search/maintainer-api
        type: GitHubRepository
      - url: >-
          https://github.com/api-search/maintainer-api/blob/main/.github/workflows/pipeline.yml
        type: GitHubActions
      ...
      - url: properties/openapi.yml
        type: OpenAPI
    description: >-
      This is the API for managing all the maintainers who are indexed as part
      of the APIs.io search engine.
...
common:
  ...
  - url: >-
      https://www.postman.com/api-evangelist/apis-io-api-search-maintainer/overview
  ...
  - url: https://developer.apis.io/plans/
    type: Plans
  - url: https://developer.apis.io/maintainer/
    type: Maintainer
  ...
  - url: https://github.com/orgs/api-search/discussions
    type: Forums
  - url: >-
      https://github.com/api-search/maintainer-api/issues?q=is%3Aissue+is%3Aopen+label%3Asupport
    type: SupportGitHubIssues
  - url: info@apievangelist.com
    type: SupportEmail
  - url: >-
      https://github.com/api-search/maintainer-api/issues?q=is%3Aissue+is%3Aopen+label%3Afeedback
    type: FeedbackGitHubIssues
  - url: info@apievangelist.com
    type: FeedbackEmail
  - url: >-
      https://github.com/api-search/maintainer-api/issues?q=is%3Aissue+is%3Aopen+label%3Aquestion
  ...
  - url: >-
      https://api-evangelist-tools.github.io/apis-io-maintainer-api-operational-validator/
    type: OperationalValidation
  - url: >-
      https://api-evangelist-tools.github.io/apis-io-maintainer-api-api-validator/
    type: APIValidation
created: '2024-08-20'
modified: '2024-11-26'
position: Producing
description: >-
  This is the contract for the APIs.io Maintainer API used to govern the APIs.io
  search maintainer.
maintainers:
  - FN: Kin Lane
