...
- aid: cat:cat
  ...
  - url: https://digital.cat.com/api-catalog-overview
    type: Documentation
  - url: properties/cat-openapi.yml
    type: OpenAPI
  description: Explore the different API catalog along with create processes list of APIs with documentation. Make use of the ability to subscribe and execute calls to use different Cat digital products.
name: CAT
tags:
- Construction
- Equipment
...
- url: https://digital.cat.com/
  name: Home | CAT Digital Marketplace
  type: Portal
  description: 'null'
- url: https://digital.cat.com/applications
  name: Applications | CAT Digital Marketplace
  type: Applications
  description: 'null'
- url: https://digital.cat.com/knowledge-hub/faq
  name: FAQ | CAT Digital Marketplace
  type: FAQ
  description: 'null'
- url: https://digital.cat.com/news-announcements-list
  name: News and Announcements | CAT Digital Marketplace
  type: News
  description: 'null'
- url: https://digital.cat.com/release-notes-manager
  name: Release Notes | CAT Digital Marketplace
  type: ChangeLog
  description: 'null'
- url: https://digital.cat.com/legal
  name: CAT Digital Marketplace End User Agreement | CAT Digital Marketplace
  type: TermsOfService
  description: 'null'
- url: https://digital.cat.com/privacy
  name: Privacy Notice for Caterpillar Digital Marketplace | CAT Digital Marketplace
  type: PrivacyPolicy
  description: 'null'
...
modified: '2026-04-07'
position: Consuming
description: Caterpillar Inc. is the world's leading manufacturer of construction and mining equipment, off-highway diesel and natural gas engines, industrial gas turbines and diesel-electric locomotives.
maintainers:
- FN: Kin Lane
