...
apis:
  ...
  - name: Forward Geocoding API
    ...
    aid: geoapify:forward-geocoding-api
  - name: Reverse Geocoding API
    ...
    aid: geoapify:reverse-geocoding-api
  - name: Address Autocomplete API
    ...
    aid: geoapify:address-autocomplete-api
  - name: Batch Geocoding API
    ...
    aid: geoapify:batch-geocoding-api
  - name: IP Geolocation API
    ...
    aid: geoapify:ip-geolocation-api
  - name: Routing API
  ...
  - name: Router Planner API
    ...
    aid: geoapify:router-planner-api
  - name: Places API
  ...
  - name: Place Details API
    ...
    aid: geoapify:place-details-api
  - name: Boundaries API
