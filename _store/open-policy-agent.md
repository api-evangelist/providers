  ...
  - aid: open-policy-agent:query-api
    ...
    properties:
      - url: https://www.openpolicyagent.org/docs/latest/rest-api/#query-api
        type: Documentation
      - url: properties/query-api.yml
        type: OpenAPI
      - url: query/bruno.json
        type: BrunoCollection
      - url: >-
          https://api-evangelist.postman.co/workspace/Open-Policy-Agent~bcc99d6c-728a-4d86-83fd-b6495f5e8fb8/collection/35240-9170dd84-c3d5-45a4-9efc-9ef6ab30744e
        type: PostmanCollection
  ...
  - aid: open-policy-agent:compile-api
    ...
    properties:
      - url: https://www.openpolicyagent.org/docs/latest/rest-api/#compile-api
        type: Documentation
      - url: properties/compile-api.yml
        type: OpenAPI
      - url: compile/bruno.json
        type: BrunoCollection
      - url: >-
          https://api-evangelist.postman.co/workspace/Open-Policy-Agent~bcc99d6c-728a-4d86-83fd-b6495f5e8fb8/collection/35240-1e1d8e0e-7157-4b7f-99cf-611fa56a0c3c
        type: PostmanCollection
