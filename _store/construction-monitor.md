...
- aid: construction-monitor:construction-monitor
  ...
  - url: https://www.constructionmonitor.com/data
    type: Documentation
  description: Process large amounts of permit data through Construction Monitors API or automated weekly data dumps via secure FTP. Both of these powerful tools have been built with an understanding that handling millions of records requires finely tuned technology.
name: Construction Monitor
tags:
- Construction
type: Index
