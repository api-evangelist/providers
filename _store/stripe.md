  ...
  - aid: stripe:stripe-files-api
    ...
    properties:
      - url: https://stripe.com/docs/api/files
        type: Documentation
      - url: openapi/files-api-openapi.yml
        type: OpenAPI
  ...
  - aid: stripe:stripe-financial-connections-api
    ...
    properties:
      - url: https://stripe.com/docs/financial-connections
        type: Documentation
      - url: openapi/financial-connections-api-openapi.yml
        type: OpenAPI
  ...
  - aid: stripe:stripe-identity-api
    ...
    properties:
      - url: https://stripe.com/docs/identity
        type: Documentation
      - url: openapi/identity-api-openapi.yml
        type: OpenAPI
  ...
  - aid: stripe:stripe-invoice-api
    ...
    properties:
      - url: https://stripe.com/docs/api/invoices
        type: Documentation
      - url: openapi/invoice-api-openapi.yml
        type: OpenAPI
  ...
  - aid: stripe:stripe-issuing-api
    ...
    properties:
      - url: https://stripe.com/docs/issuing
        type: Documentation
      - url: openapi/issuing-api-openapi.yml
        type: OpenAPI
  ...
  - aid: stripe:stripe-link-api
    ...
    properties:
      - url: https://stripe.com/docs/payment-links/api
        type: Documentation
      - url: openapi/link-api-openapi.yml
        type: OpenAPI
  ...
  - aid: stripe:stripe-payment-intents-api
    ...
    properties:
      - url: https://stripe.com/docs/api/payment_intents
        type: Documentation
      - url: openapi/payment-intents-api-openapi.yml
        type: OpenAPI
  ...
  - aid: stripe:stripe-payment-links-api
    ...
    properties:
      - url: https://stripe.com/docs/api/payment_links/payment_links
        type: Documentation
      - url: openapi/payment-links-api-openapi.yml
        type: OpenAPI
  ...
  - aid: stripe:stripe-payment-method-api
    ...
    properties:
      - url: https://stripe.com/docs/payments/payment-methods
        type: Documentation
      - url: openapi/payment-method-api-openapi.yml
        type: OpenAPI
  ...
  - aid: stripe:stripe-payouts-api
    ...
    properties:
      - url: https://stripe.com/docs/api/payouts
        type: Documentation
      - url: openapi/payouts-api-openapi.yml
        type: OpenAPI
  ...
  - aid: stripe:stripe-plans-api
    ...
    properties:
      - url: https://stripe.com/docs/api/plans
        type: Documentation
      - url: openapi/plans-api-openapi.yml
        type: OpenAPI
  ...
  - aid: stripe:stripe-prices-api
    ...
    properties:
      - url: https://stripe.com/docs/api/prices
        type: Documentation
      - url: openapi/prices-api-openapi.yml
        type: OpenAPI
