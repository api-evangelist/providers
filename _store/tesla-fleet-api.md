...
description: A RESTful API service providing data and commands to access Tesla vehicles,
...
apis:
- name: Fleet API
  description: Provides access to Tesla vehicles and energy devices for data and command
    functionality.
