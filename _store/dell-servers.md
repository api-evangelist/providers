...
apis:
  ...
  - aid: dell-servers:dell-servers-openmanage-enterprise
    ...
    description: REST API for centralized management of Dell EMC servers, chassis, and storage. OpenManage Enterprise provides a comprehensive console for discovery, inventory, monitoring, alerting, jobs, configuration templates, firmware compliance baselines, and reporting across Dell PowerEdge infrastructure at scale.
    image: https://www.dell.com/favicon.ico
