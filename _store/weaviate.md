---
name: Weaviate
description: Weaviate is more than just a database. It's a flexible platform for
...
apis:
  - name: Weaviate API
    description: Weaviate is an open source, AI-native vector database that helps
