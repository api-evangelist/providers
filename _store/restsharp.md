...
apis:
  - aid: restsharp:restsharp
    name: RestSharp
    description: 'RestSharp is a simple REST and HTTP API client library for .NET, wrapping HttpClient with a fluent API for making HTTP requests with automatic serialization and deserialization of request and response bodies. Current version: 114.0.0 (released March 2026). Targets .NET 8.0, .NET Standard 2.0, and .NET Framework 4.7.1.'
