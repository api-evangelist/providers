...
apis:
  - aid: substly:substly
    name: Substly
    description: Substly is an uncomplicated and affordable SaaS management platform for SMBs, offering subscription tracking, spend optimization, user access management, and shadow IT detection. It integrates with Google Workspace and Microsoft Entra ID to sync users and services automatically.
    humanURL: https://www.substly.com
    tags:
      - SaaS Management
      - Subscription Management
      - Spend Management
    ...
    properties:
      ...
      - type: HowItWorks
        url: https://www.substly.com/en/how-it-works
common:
  - type: Website
    url: https://www.substly.com
  - type: Documentation
