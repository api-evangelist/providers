...
apis:
  - name: Tyson Foods EDI Integration API
    description: Tyson Foods provides EDI and API integration capabilities for trading partners and B2B supply chain connections. The integration supports order management (purchase orders, order acknowledgments), shipment tracking (advance ship notices, carrier information), and logistics operations for food supply chain partners.
    image: https://www.tysonfoods.com/favicon.ico
    humanURL: https://www.tysonfoods.com/business-solutions
    ...
    properties:
      ...
      - type: OpenAPI
        url: openapi/tyson-foods-edi-integration-api-openapi.yml
      - type: Trading Partner Portal
        url: https://www.tysonfoods.com/business-solutions/trading-partner
maintainers:
  - FN: Kin Lane
...
common:
  ...
  - type: NaftikoCapability
    url: capabilities/supply-chain-integration.yaml
---
