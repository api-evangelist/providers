...
apis:
  - aid: salesloft:salesloft-api
    name: Salesloft API
    description: The Salesloft REST API provides programmatic access to Salesloft platform data including accounts, people, cadences, calls, emails, tasks, opportunities, and analytics. Uses OAuth 2.0 and Bearer token authentication. Base URL is https://api.salesloft.com/v2.
