...
url: https://raw.githubusercontent.com/api-evangelist/syncloop/refs/heads/main/apis.yml
created: '2026-05-03'
modified: '2026-05-03'
tags:
  - API Management
  ...
  - API Gateway
apis:
  - aid: syncloop:api-management
    name: Syncloop API Management Platform
    description: The Syncloop API Management Platform provides REST APIs for managing API services, configurations, deployments, and developer portal operations. The platform enables organizations to create, publish, and manage APIs with built-in security, monitoring, and analytics capabilities.
    humanURL: https://www.syncloop.com/
    baseURL: https://api.syncloop.com
    tags:
      - API Management
      - API Gateway
      - Developer Portal
    ...
    properties:
      ...
      - type: SetupGuide
        url: https://www.syncloop.com/docs/setup-and-installation.html
common:
  - type: Website
