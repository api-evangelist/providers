  ...
  - aid: towers-watson:wtw-hr-portal
    ...
    properties:
      ...
      - url: openapi/wtw-hr-portal-openapi.yml
        type: OpenAPI
    description: Willis Towers Watson HR Portal delivers a personalized digital employee experience for total rewards and benefits communication. The API enables HR teams to manage employee content, benefits enrollment, case management, and workforce communications through a unified digital experience platform.
  - aid: towers-watson:wtw-benefits-administration
    ...
    properties:
      ...
      - url: openapi/wtw-benefits-administration-openapi.yml
        type: OpenAPI
    description: WTW Benefits Administration API provides programmatic access to employee benefits enrollment, eligibility management, plan configuration, and benefits data for health, dental, vision, life, disability, and other employee benefit programs.
common:
  - type: Website
