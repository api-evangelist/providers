...
name: SimpleLegal
description: >-
  The SimpleLegal API is organized around REST. Our API has predictable,
  ...
  are understood by off-the-shelf HTTP clients. 
type: Index
position: Consumer
access: 3rd-Party
...
apis:
  - aid: simplelegal:simplelegal
    ...
    description: >-
      ...
      errors. We use built-in HTTP features, like HTTP authentication and HTTP
      verbs, which are understood by off-the-shelf HTTP clients. 
