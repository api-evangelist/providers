...
apis:
  ...
  - aid: basetrip:basetrip-countries-api
    ...
    description: >-
      ...
      Get all the countries' names, slugs and codes. Use slug or alpha-2 code

      for a country's details endpoint as a {id} path parameter.
  ...
  - aid: basetrip:basetrip-cities-api
    ...
    description: >-
      ...
      Get all the cities from particular country, including their names and

      slugs. Use a slug or alpha-2 code for a {id} path parameter.
  ...
  - aid: basetrip:basetrip-phrases-api
    ...
    description: >-
      ...
      Get all language (travel) phrases for specific languages. Currently
