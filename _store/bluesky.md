  ...
  - aid: bluesky:bluesky
    ...
    properties:
      ...
      - data:
        ...
        type: Summary
    description: >-
      The Bluesky API allows you to work programmatically with actors, feeds,
      graph, conversations, and other resources available for the the Bluesky
...
description: >-
  ...
  TutorialsView tutorials for handling the Bluesky API. Starter TemplatesView
  starter code for ...
maintainers:
  - FN: Kin Lane
