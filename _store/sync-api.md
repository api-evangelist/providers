...
created: '2026-05-03'
modified: '2026-05-03'
url: https://raw.githubusercontent.com/api-evangelist/sync-api/refs/heads/main/apis.yml
specificationVersion: '0.19'
apis:
  - aid: sync-api:sync-api-platform
    name: Sync API Platform
    description: The Sync API bidder platform provides enterprise-grade APIs for the in-app advertising ecosystem. The platform supports real-time bidding (RTB), user acquisition optimization, LTV (Lifetime Value) forecasting, behavioral analysis for re-engagement targeting, and cross-channel campaign management. Accessed by programmatic advertisers, DSPs, and mobile marketing teams.
    humanURL: https://sync-api.com/
    ...
    properties:
      ...
      - type: Website
        url: https://sync-api.com/
  - aid: sync-api:sync-api-user-acquisition
    name: Sync API User Acquisition
    description: User acquisition API leveraging advanced algorithms to optimize user acquisition strategies for mobile apps. Provides targeting across 1.2B+ global audiences with LTV forecasting and in-app event conversion tracking across 50+ countries.
    humanURL: https://sync-api.com/
    baseURL: https://api.sync-api.com
    tags:
      - Advertising
    ...
    properties:
      ...
      - type: Website
        url: https://sync-api.com/
  - aid: sync-api:sync-api-re-engagement
