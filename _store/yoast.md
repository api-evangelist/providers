...
apis:
  ...
  - aid: yoast:yoast-metadata-api
    ...
    description: The Yoast Metadata API provides a PHP interface to add, alter, or remove metadata in the <head> of a WordPress document. Developers can hook into Yoast's meta tag output pipeline to customize titles, descriptions, robots directives, Open Graph tags, and other head elements programmatically.
