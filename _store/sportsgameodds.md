...
created: '2025-02-08'
modified: '2026-05-02'
url: https://raw.githubusercontent.com/api-evangelist/sportsgameodds/refs/heads/main/apis.yml
specificationVersion: '0.19'
apis:
  - aid: sportsgameodds:sportsgameodds
    name: SportsGameOdds API
    description: Real-time sports betting odds API aggregating data from 80+ sportsbooks with 50+ leagues including NFL, NBA, MLB, NHL, NCAAF, NCAAB, EPL, UCL, UFC, PGA, and ATP. Covers 3,000+ betting markets with moneylines, spreads, totals, team props, and player props. Includes consensus odds, live streaming data, and an interactive data explorer. Official SDKs available for JavaScript, TypeScript, Python, Java, Go, and Ruby.
    humanURL: https://sportsgameodds.com/
    ...
    properties:
      ...
      - type: Getting Started
        url: https://sportsgameodds.com/docs/v1/setup/getting-started
      - type: Explorer
        url: https://sportsgameodds.com/docs/explorer
common:
  - type: Website
