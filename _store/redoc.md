---
aid: redoc
url: https://raw.githubusercontent.com/api-evangelist/redoc/refs/heads/main/apis.yml
name: ReDoc
...
apis:
  - aid: redoc:redoc
    name: ReDoc
    description: ReDoc is an open-source API documentation renderer for OpenAPI specifications, originally created by Rebilly and now maintained by Redocly. It generates a responsive three-panel documentation layout from OpenAPI 3.1, 3.0, and Swagger 2.0 definitions. Available as a React component, HTML tag, CLI tool, and Docker image with over 23,000 GitHub stars.
