    ...
    RE_SECTIONS = [
        ...
        ("au-real-estate", "au-real-estate-roster.json", "Australian Real Estate",
         ...
         {"slug": "state-of-australian-real-estate-apis", "title": "The State of Australian Real Estate APIs",
          "blurb": "18 Australian real estate organizations scored (avg 32.0) — topped by PEXA (60.1), the electronic conveyancing rail that state law effectively requires, not by the portals that own the audience. The REA and Domain duopoly splits 22.4 to 49.0 on the same market, the state land registries out-publish the brokerages, and the valuation layer REA owns scores below the portal it feeds.", "price": "500"}),
