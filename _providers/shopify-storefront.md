...
- baseURL: https://{store_name}.myshopify.com/api/2024-10/graphql.json
  ...
  description: The Graph QL API from Shopify Storefront API — 1 operation(s) for graph ql.
  name: Shopify Storefront API Graph QL API
...
- group: company
  title: ''
  type: Website
  url: https://www.shopify.dev/
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/shopify-storefront/refs/heads/main/agentic-access/shopify-storefront-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/shopify-storefront-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/shopify-storefront/refs/heads/main/security/shopify-storefront-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/shopify-storefront-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/shopify-storefront/refs/heads/main/authentication/shopify-storefront-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Shopify Storefront API publishes 1 API on the [APIs.io](https://apis.io/) network: Graph QL API. Tagged areas include Commerce, E-Commerce, Headless, GraphQL, and Storefront.


  The Shopify Storefront API catalog on APIs.io includes 1 JSON-LD context and 2 Spectral governance rulesets.


  Shopify Storefront API''s developer surface includes authentication and 5 more developer resources.'
plans:
