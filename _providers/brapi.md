...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/brapi/refs/heads/main/agentic-access/brapi-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/brapi-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/brapi/refs/heads/main/security/brapi-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/brapi-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/brapi/refs/heads/main/security/brapi-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'brapi publishes 12 APIs on the [APIs.io](https://apis.io/) network, including Criptomoedas API, Fiis API, Inflacao API, and 9 more. Tagged areas include Finance, Brazilian Financial Data, Stock Market, Investment, and Economic Indicators.
