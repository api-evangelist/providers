...
- group: start
  title: ''
  type: GettingStarted
  url: https://docs.akto.io/getting-started/quick-start-with-akto-cloud.md
- group: company
  title: ''
  type: Blog
  url: https://www.akto.io/blog
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/akto-api-security
- group: commercial
  title: ''
  type: Pricing
  url: https://www.akto.io/pricing
- group: start
  title: ''
  type: SignUp
  url: https://app.akto.io/
- group: operate
  title: ''
  type: Support
  url: https://www.akto.io/terms/supportguide
- group: commercial
  title: ''
  type: TermsOfService
  url: https://www.akto.io/terms/terms-of-service
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://www.akto.io/terms/privacy
- group: operate
  title: ''
  type: StatusPage
  url: https://status.akto.io
- group: operate
  title: ''
  type: ChangeLog
  url: https://github.com/akto-api-security/akto/releases
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/akto/refs/heads/main/llms/akto-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/akto-llms.txt
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/akto/refs/heads/main/lifecycle/akto-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/akto-lifecycle.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/akto/refs/heads/main/security/akto-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/akto-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/akto/refs/heads/main/security/akto-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/akto-trust-center.yml
- group: auth
  title: ''
  type: Compliance
  url: https://trust.akto.io/
created: '2026-07-17'
...
nav: Providers
network: true
overview: 'Akto is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, API Security, Security, API Security Testing, and DAST.
...
- kind: trust-center
  name: Akto Trust Center
  slug: akto-trust-center
  summary_line: SOC 2, ISO 27001, GDPR, HIPAA
slug: akto
tags:
- Company
- API Security
