...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/linkett/refs/heads/main/security/linkett-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/linkett-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/linkett/refs/heads/main/llms/linkett-llms.txt
  title: ''
  type: LLMsTxt
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/linkett/refs/heads/main/plans/linkett-plans-pricing.yml
  title: ''
  type: Plans
...
nav: Providers
network: true
overview: 'Linkett is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Advertising, Digital Signage, Digital Out Of Home, and Analytics.
