...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/trackingmore/refs/heads/main/capabilities/trackingmore-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/trackingmore-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/trackingmore/refs/heads/main/agentic-access/trackingmore-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/trackingmore-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/trackingmore/refs/heads/main/security/trackingmore-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/trackingmore-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/trackingmore/refs/heads/main/authentication/trackingmore-authentication.yml
  title: ''
  type: Authentication
...
overview: 'TrackingMore publishes 3 APIs on the [APIs.io](https://apis.io/) network: Air Waybills API, Couriers API, and Trackings API. Tagged areas include Logistics, Shipping, Tracking, Parcel, and Webhook.
  ...
  TrackingMore''s developer surface includes authentication, documentation, getting-started guide, pricing, support, engineering blog, and 10 more developer resources.'
plans:
