...
common:
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/litellm/refs/heads/main/plans/litellm-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/litellm-plans-pricing.yml
- group: company
  title: ''
  type: Website
  url: https://www.litellm.ai/
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/litellm/refs/heads/main/capabilities/litellm-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/litellm-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/litellm/refs/heads/main/agentic-access/litellm-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/litellm-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/litellm/refs/heads/main/security/litellm-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'LiteLLM publishes 33 APIs on the [APIs.io](https://apis.io/) network, including Assistants API, Audio API, Batches API, and 30 more. Tagged areas include Gateways.


  LiteLLM''s developer surface includes developer portal, documentation, getting-started guide, engineering blog, changelog, release notes, support, and 21 more developer resources.'
plans:
