...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tum/refs/heads/main/conformance/tum-education-standards-conformance.yml
  title: ''
  type: x-conformance
  url: conformance/tum-education-standards-conformance.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tum/refs/heads/main/authentication/tum-authentication.yml
  title: ''
  type: x-authentication
  url: authentication/tum-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tum/refs/heads/main/scopes/tum-scopes.yml
  title: ''
  type: x-scopes
  url: scopes/tum-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tum/refs/heads/main/errors/tum-errors.yml
  title: ''
  type: x-errors
  url: errors/tum-errors.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tum/refs/heads/main/lifecycle/tum-lifecycle.yml
  title: ''
  type: x-lifecycle
  url: lifecycle/tum-lifecycle.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/tum/refs/heads/main/agentic-access/tum-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/tum-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tum/refs/heads/main/security/tum-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/tum-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tum/refs/heads/main/security/tum-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/tum-domain-security.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/tum/refs/heads/main/plans/tum-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/tum-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/tum/refs/heads/main/rate-limits/tum-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/tum-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/tum/refs/heads/main/finops/tum-finops.yml
  title: ''
  type: FinOps
  url: finops/tum-finops.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/tum/refs/heads/main/review.yml
  title: ''
  type: Review
  url: review.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tum/refs/heads/main/vocabulary/tum-vocabulary.yml
  title: ''
  type: x-vocabulary
  url: vocabulary/tum-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tum/refs/heads/main/rules/tum-rules.yml
  title: ''
  type: x-rules
  url: rules/tum-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tum/refs/heads/main/json-ld/tum-context.jsonld
  title: ''
  type: x-json-ld
...
nav: Providers
network: true
overview: 'Technical University of Munich publishes 6 APIs on the [APIs.io](https://apis.io/) network, including NavigaTUM, eat-api — Munich Student Canteen Menus, Campus API, and 3 more. Tagged areas include University, Higher Education, Education, Germany, and Technical University.
