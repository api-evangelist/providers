...
nav: Providers
network: true
overview: 'Granola publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Notes API, and 3 more. Tagged areas include Artificial Intelligence, Meeting Notes, Transcription, Productivity, and MCP.
