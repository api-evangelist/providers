...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/survicate/refs/heads/main/agentic-access/survicate-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/survicate-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/survicate/refs/heads/main/security/survicate-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/survicate-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/survicate/refs/heads/main/security/survicate-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/survicate-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/survicate/refs/heads/main/security/survicate-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/survicate-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/survicate/refs/heads/main/authentication/survicate-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/survicate/refs/heads/main/plans/survicate-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/survicate-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/survicate/refs/heads/main/rate-limits/survicate-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/survicate-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/survicate/refs/heads/main/finops/survicate-finops.yml
  title: ''
  type: FinOps
  url: finops/survicate-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/survicate/refs/heads/main/vocabulary/survicate-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/survicate-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/survicate/refs/heads/main/json-ld/survicate-context.jsonld
  title: ''
  type: JSONLD
...
nav: Providers
network: true
overview: 'Survicate publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Personal Data API, Respondents API, Responses API, and 4 more. Tagged areas include Surveys, Customer Feedback, NPS, User Research, and Feedback Analytics.
