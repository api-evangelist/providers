...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/imgflip/refs/heads/main/agentic-access/imgflip-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/imgflip-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/imgflip/refs/heads/main/security/imgflip-domain-security.yml
  title: ''
  type: DomainSecurity
...
overview: 'Imgflip publishes 1 API on the [APIs.io](https://apis.io/) network: Memes API. Tagged areas include Memes, Image, GIFs, Entertainment, and Artificial Intelligence.
  ...
  Imgflip''s developer surface includes signup flow and 7 more developer resources.'
plans:
- name: Plans
  plan_count: 2
  slug: plans
