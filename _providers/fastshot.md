...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/fastshot/refs/heads/main/security/fastshot-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/fastshot-domain-security.yml
- group: company
  title: ''
  type: Website
...
- group: start
  title: ''
  type: GettingStarted
  url: https://docs.fastshot.ai/quickstart
- group: operate
  title: ''
  type: Support
  url: https://discord.gg/4UHnKKmj9q
- group: commercial
  title: ''
  type: Pricing
  url: https://fastshot.ai/pricing
- group: start
  title: ''
  type: SignUp
  url: https://fastshot.ai/login
- group: start
  title: ''
  type: Login
  url: https://fastshot.ai/login
