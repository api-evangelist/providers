...
nav: Providers
network: true
overview: 'Metadata is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Marketing, Marketing Automation, Demand Generation, and Advertising.
...
- kind: trust-center
  ...
  summary_line: SOC 2 Type II, ISO 27001, ISO 27701, GDPR, CSA STAR
slug: metadata
tags:
- Company
- Marketing
