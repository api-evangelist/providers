...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/runtime/refs/heads/main/security/runtime-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/runtime/refs/heads/main/llms/runtime-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/runtime-llms.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/runtime/refs/heads/main/authentication/runtime-authentication.yml
  title: ''
  type: Authentication
  url: authentication/runtime-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/runtime/refs/heads/main/scopes/runtime-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/runtime-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/runtime/refs/heads/main/conventions/runtime-conventions.yml
  title: ''
  type: Conventions
...
- group: design
  ...
  url: conventions/runtime-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/runtime/refs/heads/main/errors/runtime-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/runtime-problem-types.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/runtime/refs/heads/main/rate-limits/runtime-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/runtime-rate-limits.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/runtime/refs/heads/main/lifecycle/runtime-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/runtime-lifecycle.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/runtime/refs/heads/main/changelog/runtime-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/runtime-changelog.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/runtime/refs/heads/main/packages/runtime-packages.yml
  title: ''
  type: Packages
  url: packages/runtime-packages.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/runtime/refs/heads/main/cli/runtime-cli.yml
  title: ''
  type: CLI
  url: cli/runtime-cli.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/runtime/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/runtime/refs/heads/main/security/runtime-vulnerability-disclosure.yml
  title: ''
