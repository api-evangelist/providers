...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/kennametal/refs/heads/main/security/kennametal-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/kennametal-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/kennametal
- group: company
  title: ''
  type: Website
...
- group: other
  ...
  url: https://www.kennametal.com/us/en/services/online-services.html
created: '2026-03-24'
description: Kennametal is a leading provider of productivity solutions for metalworking, earth cutting, and wear components, coatings, and powders. Kennametal offers online integration services including Punch-Out / OCI (Open Catalog Interface), EDI, and a Product Data Portal for catalog and product information.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/kennametal.png
layout: provider
modified: '2026-04-28'
name: Kennametal
nav: Providers
network: true
overview: Kennametal is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Metalworking, Manufacturing, Industrial, Tooling, and Punchout.
press:
- date: ''
