...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ubuntu/refs/heads/main/agentic-access/ubuntu-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/ubuntu-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ubuntu/refs/heads/main/security/ubuntu-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/ubuntu-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ubuntu/refs/heads/main/authentication/ubuntu-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Ubuntu publishes 17 APIs on the [APIs.io](https://apis.io/) network, including Bugs API, Categories API, Distributions API, and 14 more. Tagged areas include Cloud, Containers, DevOps, Enterprise, and Linux.
