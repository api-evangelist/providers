...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/iss-api/refs/heads/main/agentic-access/iss-api-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/iss-api-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/iss-api/refs/heads/main/security/iss-api-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'ISS Location API (Open Notify) publishes 3 APIs on the [APIs.io](https://apis.io/) network, including Astronauts API, ISS Location API, and 1 more. Tagged areas include Space, ISS, International Space Station, NASA, and Location.
