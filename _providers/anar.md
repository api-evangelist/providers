...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/anar/refs/heads/main/security/anar-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/anar-domain-security.yml
- group: company
  title: ''
  type: Website
  url: https://anar.biz/
- group: company
  title: ''
  type: Blog
  url: https://medium.com/anar-business
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/pulse/so-long-anar-farewell-reflection-nishank-jain-oifxf/
created: '2026-07-17'
...
nav: Providers
network: true
overview: 'Anar is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Mobile, Marketplace, B2B, and E-Commerce.
