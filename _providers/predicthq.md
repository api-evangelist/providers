...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/predicthq/refs/heads/main/agentic-access/predicthq-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/predicthq-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/predicthq/refs/heads/main/security/predicthq-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/predicthq-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/predicthq/refs/heads/main/authentication/predicthq-authentication.yml
  title: ''
  type: Authentication
...
overview: 'PredictHQ publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Events API, Features API, Places API, and 1 more. Tagged areas include Demand Intelligence, Event, Forecasting, Machine-Learning, and Real-World Events.
  ...
  PredictHQ''s developer surface includes authentication, developer portal, documentation, signup flow, pricing, engineering blog, support, and 11 more developer resources.'
plans:
