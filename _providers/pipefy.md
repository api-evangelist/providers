...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/pipefy/refs/heads/main/agentic-access/pipefy-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/pipefy-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pipefy/refs/heads/main/security/pipefy-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/pipefy-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pipefy/refs/heads/main/security/pipefy-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/pipefy-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pipefy/refs/heads/main/authentication/pipefy-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Pipefy publishes 1 API on the [APIs.io](https://apis.io/) network: Graph QL API. Tagged areas include Workflow-Automation, Business Process Management, No-Code, GraphQL, and Process Orchestration.
