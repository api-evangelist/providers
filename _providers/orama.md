...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/orama/refs/heads/main/agentic-access/orama-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/orama-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/orama/refs/heads/main/security/orama-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/orama-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/orama/refs/heads/main/authentication/orama-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/orama/refs/heads/main/plans/orama-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/orama-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/orama/refs/heads/main/rate-limits/orama-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/orama-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/orama/refs/heads/main/finops/orama-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Orama publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Answer API, Documents API, Indexes API, and 2 more. Tagged areas include Search, Vector Search, RAG, Open Source, and Search as a Service.
