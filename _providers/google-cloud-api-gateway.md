...
overview: 'Google Cloud API Gateway publishes 1 API on the [APIs.io](https://apis.io/) network: Projects API. Tagged areas include API Gateway, API Management, Authentication, Google Cloud, and Security.
  ...
  Google Cloud API Gateway''s developer surface includes developer portal, getting-started guide, documentation, authentication, pricing, support, engineering blog, and 8 more developer resources.'
plans:
