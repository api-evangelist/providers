...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/arcade-dev/refs/heads/main/agentic-access/arcade-dev-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/arcade-dev-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/arcade-dev/refs/heads/main/security/arcade-dev-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/arcade-dev-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/arcade-dev/refs/heads/main/authentication/arcade-dev-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/arcade-dev/refs/heads/main/plans/arcade-dev-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/arcade-dev-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/arcade-dev/refs/heads/main/rate-limits/arcade-dev-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/arcade-dev-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/arcade-dev/refs/heads/main/finops/arcade-dev-finops.yml
  title: ''
  type: FinOps
  url: finops/arcade-dev-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/arcade-dev/refs/heads/main/rules/arcade-dev-rules.yml
  title: ''
  type: SpectralRules
  url: rules/arcade-dev-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/arcade-dev/refs/heads/main/json-ld/arcade-dev-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/arcade-dev-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/arcade-dev/refs/heads/main/vocabulary/arcade-dev-vocabulary.yml
  title: ''
  type: Vocabulary
...
examples:
- key_count: 2
  name: Arcade Admin Secrets Set Example
  slug: arcade-admin-secrets-set-example
- key_count: 2
  name: Arcade Auth Authorize Example
  slug: arcade-auth-authorize-example
- key_count: 3
  name: Arcade Auth Status Example
  slug: arcade-auth-status-example
- key_count: 4
  name: Arcade Gateways Create Example
  slug: arcade-gateways-create-example
- key_count: 4
  name: Arcade Hooks Create Example
  slug: arcade-hooks-create-example
- key_count: 5
  name: Arcade Llm Chat Completions Example
  slug: arcade-llm-chat-completions-example
- key_count: 1
  name: Arcade Operations Health Example
  slug: arcade-operations-health-example
- key_count: 3
  name: Arcade Tools Authorize Example
  slug: arcade-tools-authorize-example
- key_count: 4
  name: Arcade Tools Execute Example
  slug: arcade-tools-execute-example
- key_count: 2
  name: Arcade Tools List Example
  slug: arcade-tools-list-example
- key_count: 3
  name: Arcade Workers Create Example
  slug: arcade-workers-create-example
features:
...
finops:
- name: Arcade Dev Finops
  service_category: AI and Machine Learning
  slug: arcade-dev-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/arcade-dev.png
json_schemas:
- name: Arcade Authorization
  property_count: 12
  slug: arcade-authorization
- name: Arcade Hook
  property_count: 9
  slug: arcade-hook
- name: Arcade Tool Execution
  property_count: 10
  slug: arcade-tool-execution
- name: Arcade Tool
  property_count: 8
  slug: arcade-tool
- name: Arcade Worker
  ...
  slug: arcade-worker
json_structures:
- name: Arcade Authorization Structure
  property_count: 0
  slug: arcade-authorization-structure
- name: Arcade Tool Structure
  property_count: 0
  slug: arcade-tool-structure
- name: Arcade Worker Structure
  property_count: 0
  slug: arcade-worker-structure
jsonld:
- class_count: 34
  name: Arcade Dev Context
  property_count: 10
...
nav: Providers
network: true
overview: 'Arcade.dev publishes 8 APIs on the [APIs.io](https://apis.io/) network, including arcade-dev Admin API, arcade-dev Authorization API, arcade-dev Gateways API, and 5 more. Tagged areas include Authorization, LLM, and Plugins.
