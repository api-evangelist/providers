...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/missive/refs/heads/main/capabilities/missive-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/missive-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/missive/refs/heads/main/agentic-access/missive-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/missive-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/missive/refs/heads/main/security/missive-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/missive-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/missive/refs/heads/main/security/missive-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/missive-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/missive/refs/heads/main/security/missive-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/missive-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/missive/refs/heads/main/authentication/missive-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/missive/refs/heads/main/plans/missive-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/missive-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/missive/refs/heads/main/rate-limits/missive-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/missive-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/missive/refs/heads/main/finops/missive-finops.yml
  title: ''
  type: FinOps
...
- name: Missive Price Estimates
  plan_count: 0
  slug: missive-price-estimates
random_paper: 20
rate_limits:
- limit_count: 5
