...
nav: Providers
network: true
overview: 'CargoAi publishes 9 APIs on the [APIs.io](https://apis.io/) network, including AI API, Book API, Bookings API, and 6 more. Tagged areas include Logistics, Supply Chain, Singapore, Air Cargo, and Freight Forwarding.
