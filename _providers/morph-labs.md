...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/morph-labs/refs/heads/main/agentic-access/morph-labs-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/morph-labs-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/morph-labs/refs/heads/main/security/morph-labs-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/morph-labs-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/morph-labs/refs/heads/main/authentication/morph-labs-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/morph-labs/refs/heads/main/plans/morph-labs-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/morph-labs-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/morph-labs/refs/heads/main/rate-limits/morph-labs-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/morph-labs-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/morph-labs/refs/heads/main/finops/morph-labs-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Morph publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Apply API, Embeddings API, Rerank API, and 1 more. Tagged areas include Artificial Intelligence, Code Editing, Fast Apply, Embeddings, and Sandbox.
