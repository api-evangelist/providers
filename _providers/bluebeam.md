...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/bluebeam/refs/heads/main/agentic-access/bluebeam-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/bluebeam-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bluebeam/refs/heads/main/security/bluebeam-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/bluebeam-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bluebeam/refs/heads/main/authentication/bluebeam-authentication.yml
  title: ''
  type: Authentication
  url: authentication/bluebeam-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bluebeam/refs/heads/main/scopes/bluebeam-scopes.yml
  title: ''
  type: OAuthScopes
...
nav: Providers
network: true
overview: 'Bluebeam publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Documents API, Markups API, Sessions API, and 2 more. Tagged areas include Construction, PDF, Project Management, and Documents.
