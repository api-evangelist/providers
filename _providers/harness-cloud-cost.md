...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/harness-cloud-cost/refs/heads/main/agentic-access/harness-cloud-cost-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/harness-cloud-cost-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/harness-cloud-cost/refs/heads/main/security/harness-cloud-cost-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/harness-cloud-cost-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/harness-cloud-cost/refs/heads/main/security/harness-cloud-cost-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/harness-cloud-cost-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/harness-cloud-cost/refs/heads/main/security/harness-cloud-cost-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/harness-cloud-cost-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/harness-cloud-cost/refs/heads/main/authentication/harness-cloud-cost-authentication.yml
  title: ''
  type: Authentication
