...
- group: company
  title: ''
  type: Website
  url: https://www.singularitynet.io/
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/singularity-net/refs/heads/main/agentic-access/singularity-net-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/singularity-net-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/singularity-net/refs/heads/main/security/singularity-net-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'SingularityNET publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Channels API, Organizations API, Service Groups API, and 2 more. Tagged areas include Artificial Intelligence, Blockchain, Decentralized AI, AI Marketplace, and Web3.


  The SingularityNET catalog on APIs.io includes 1 JSON-LD context and 2 Spectral governance rulesets.


  SingularityNET''s developer surface includes engineering blog, documentation, and 12 more developer resources.'
plans:
...
- AI Marketplace
- Web3
website: https://www.singularitynet.io/
---
