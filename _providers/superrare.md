...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/superrare/refs/heads/main/agentic-access/superrare-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/superrare-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/superrare/refs/heads/main/security/superrare-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'SuperRare publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Collections API, Media API, Merkle Roots API, and 7 more. Tagged areas include NFT, Digital Art, Marketplace, Ethereum, and Blockchain.
