...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://donuts.domains'', ''status'': 301, ''note'': ''declared website redirects to https://identity.digital/ — a different registrable domain (donuts.domains -> identity.digital), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/donuts/refs/heads/main/security/donuts-domain-security.yml
  title: ''
  type: DomainSecurity
