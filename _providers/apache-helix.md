...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/apache-helix/refs/heads/main/agentic-access/apache-helix-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/apache-helix-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apache-helix/refs/heads/main/security/apache-helix-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/apache-helix-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apache-helix/refs/heads/main/security/apache-helix-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/apache-helix/refs/heads/main/rules/apache-helix-spectral-rules.yml
  title: ''
  type: SpectralRules
  url: rules/apache-helix-spectral-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/apache-helix/refs/heads/main/vocabulary/apache-helix-vocabulary.yaml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'Apache Helix publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Clusters API, Instances API, Resources API, and 2 more. Tagged areas include Apache, Cluster Management, Distributed Systems, Open Source, and Partitioning.


  The Apache Helix catalog on APIs.io includes 1 JSON-LD context and 2 Spectral governance rulesets.


  Apache Helix''s developer surface includes documentation, getting-started guide, and 13 more developer resources.'
plans:
