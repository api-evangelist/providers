...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/greif/refs/heads/main/authentication/greif-authentication.yml
  title: ''
  type: Authentication
  url: authentication/greif-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/greif/refs/heads/main/conventions/greif-conventions.yml
  title: ''
  type: Conventions
  url: conventions/greif-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/greif/refs/heads/main/errors/greif-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/greif-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/greif/refs/heads/main/data-model/greif-data-model.yml
  title: ''
  type: DataModel
  url: data-model/greif-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/greif/refs/heads/main/lifecycle/greif-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/greif-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/greif/refs/heads/main/conformance/greif-conformance.yml
  title: ''
  type: Conformance
  url: conformance/greif-conformance.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/greif/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/greif/refs/heads/main/mcp/greif-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/greif-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/greif/refs/heads/main/well-known/greif-well-known.yml
  title: ''
  type: x-well-known-probe
  url: well-known/greif-well-known.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/greif/refs/heads/main/llms/greif-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/greif-llms.txt
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/greif/refs/heads/main/packages/greif-packages.yml
  title: ''
  type: Packages
  url: packages/greif-packages.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/greif/refs/heads/main/plans/greif-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/greif-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/greif/refs/heads/main/rate-limits/greif-rate-limits.yml
  title: ''
  type: RateLimits
