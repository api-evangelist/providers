...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ably/refs/heads/main/agentic-access/ably-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/ably-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ably/refs/heads/main/security/ably-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/ably-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ably/refs/heads/main/security/ably-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/ably-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ably/refs/heads/main/security/ably-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/ably-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ably/refs/heads/main/authentication/ably-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/ably/refs/heads/main/plans/ably-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/ably-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/ably/refs/heads/main/rate-limits/ably-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/ably-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/ably/refs/heads/main/finops/ably-finops.yml
  title: ''
  type: FinOps
...
overview: 'Ably publishes 12 APIs on the [APIs.io](https://apis.io/) network, including apps API, Authentication API, History API, and 9 more. Tagged areas include Real-Time, WebSocket, Pub-Sub, Messaging, and Streaming.
  ...
  Ably''s developer surface includes authentication, developer portal, documentation, pricing, GitHub presence, engineering blog, and 11 more developer resources.'
plans:
