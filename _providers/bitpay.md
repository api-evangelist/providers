...
- group: company
  title: ''
  type: Website
  url: https://www.bitpay.com/
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/bitpay/refs/heads/main/agentic-access/bitpay-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/bitpay-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bitpay/refs/heads/main/security/bitpay-domain-security.yml
  title: ''
  type: DomainSecurity
...
overview: 'BitPay publishes 13 APIs on the [APIs.io](https://apis.io/) network, including Bills API, Payouts API, Refunds API, and 10 more. Tagged areas include Cryptocurrency, Payments, Bitcoin, Blockchain, and Invoices.
  ...
  BitPay''s developer surface includes authentication, documentation, status page, support, GitHub presence, signup flow, engineering blog, and 9 more developer resources.'
plans:
- name: Plans
  plan_count: 3
  slug: plans
