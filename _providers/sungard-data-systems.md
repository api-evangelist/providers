...
- description: SunGard Financial Systems offered software and services for trading, treasury, risk management, capital markets, and investment management. Products included Adaptiv (credit and market risk), Front Ar
  ...
  slug: sungard-financial-systems
artifact_total: 5
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sungard-data-systems/refs/heads/main/security/sungard-data-systems-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/sungard-data-systems-domain-security.yml
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/sungard-labs
- group: company
  title: ''
  type: LinkedIn
...
finops:
- name: Sungard Data Systems Finops
  service_category: API
  slug: sungard-data-systems-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/sungard-data-systems.png
layout: provider
modified: '2026-05-02'
...
- limit_count: 5
  ...
  slug: sungard-data-systems-rate-limits
score:
  band: minimal
  composite: 10.5
  coverage:
