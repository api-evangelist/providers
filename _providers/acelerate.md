...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/acelerate/refs/heads/main/security/acelerate-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Acelerate is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Restaurant, Restaurant Technology, Food Service, Hospitality, and Ghost Kitchens.
