...
- group: start
  ...
  url: https://www.nfon.com/en/integrations/api
- group: docs
  title: ''
  type: Documentation
  url: https://api.nfon.net/configuration/
- group: docs
  title: ''
  type: APIReference
  url: https://nfon-ag.github.io/CTI-API/
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/NFON-AG
- group: operate
  title: ''
  type: StatusPage
  url: https://status.nfon.com
- group: operate
  title: ''
  type: Deprecation
  url: https://github.com/NFON-AG/PBX-Configuration-APIs/blob/main/api-gateway-migration-guide.md
- group: auth
  title: ''
  type: TrustCenter
  url: https://www.nfon.com/en/trust-center/
- group: auth
  title: ''
  type: Compliance
  url: https://www.nfon.com/en/trust-center/
- group: commercial
  title: ''
  type: TermsOfService
  url: https://www.nfon.com/en/legal/gtc-sla/
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://www.nfon.com/en/legal/data-protection
- group: start
  title: ''
  type: Login
  url: https://start.cloudya.com/auth/login
- group: operate
  title: ''
  type: Support
...
- SIP
- Germany
website: https://www.nfon.com/en/integrations/api
---
