...
- group: start
  ...
  url: https://docs.runwhen.com/public/
- group: docs
  title: ''
  type: Documentation
  url: https://docs.runwhen.com/public/
- group: docs
  title: ''
  type: APIReference
  url: https://docs.runwhen.com/docs/use/api-reference
- group: start
  title: ''
  type: GettingStarted
  url: https://docs.runwhen.com/docs/install/quick-start
- group: company
  title: ''
  type: Blog
  url: https://runwhen.com/blog
- group: commercial
  title: ''
  type: Pricing
  url: https://runwhen.com/pricing
- group: start
  title: ''
  type: SignUp
  url: https://www.runwhen.com/beta
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://runwhen.com/privacy
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/runwhen-contrib
- group: company
  title: ''
  type: Website
  url: https://runwhen.com
created: '2026-07-17'
description: RunWhen is an AI platform for building safe-for-production agents that triage alerts, remediate infrastructure, analyze cost, and answer questions about production systems. Engineering teams compose reusable "Skills" (CodeBundles) into agents that run standalone or from Claude, Cursor, and VS Code via the RunWhen Platform MCP server. The RunWhen Platform API (PAPI) is a versioned REST API (OpenAPI 3.1, 417 operations) over workspaces, SLXs/SLIs/SLOs, runbooks, run sessions, issues, personas, and workflows, authenticated with JWT bearer tokens and an OAuth/OIDC authorization server. RunWhen was surfaced as a Seedcamp portfolio company and enriched into the API Evangelist network.
image: https://runwhen.com/favicon.ico
layout: provider
mcp_servers:
- description: ''
  name: RunWhen MCP Server
  slug: runwhen-mcp-server
modified: '2026-07-21'
name: RunWhen
nav: Providers
network: true
overview: 'RunWhen publishes 51 APIs on the [APIs.io](https://apis.io/) network, including alert-query-proxy API, auth API, auth-providers API, and 48 more. Tagged areas include Company, AIOps, SRE, DevOps, and Observability.
