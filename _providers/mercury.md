...
- group: commercial
  title: ''
  type: Pricing
  url: https://mercury.com/pricing
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/mercury/refs/heads/main/capabilities/mercury-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/mercury-capability-edges.yml
- group: operate
  title: ''
  type: ChangeLog
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/mercury/refs/heads/main/agentic-access/mercury-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/mercury-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mercury/refs/heads/main/security/mercury-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/mercury-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mercury/refs/heads/main/authentication/mercury-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/mercury/refs/heads/main/plans/mercury-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/mercury-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/mercury/refs/heads/main/rate-limits/mercury-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/mercury-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/mercury/refs/heads/main/finops/mercury-finops.yml
  title: ''
  type: FinOps
...
overview: 'Mercury publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Webhooks API, Accounts API, Cards API, and 6 more. Tagged areas include Banking, Fintech, Startups, Treasury, and Payments.
  ...
  Mercury''s developer surface includes pricing, changelog, getting-started guide, authentication, documentation, engineering blog, and 10 more developer resources.'
plans:
- name: Mercury Plans Pricing
  plan_count: 4
  slug: mercury-plans-pricing
- name: Mercury Price Estimates
  plan_count: 0
  slug: mercury-price-estimates
random_paper: 5
rate_limits:
- limit_count: 4
