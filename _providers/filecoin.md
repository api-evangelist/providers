...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/filecoin/refs/heads/main/security/filecoin-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/filecoin-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/filecoin/refs/heads/main/authentication/filecoin-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Filecoin publishes 6 APIs on the [APIs.io](https://apis.io/) network, including HTTP REST API, and 5 more. Tagged areas include Decentralized Storage, Web3, IPFS, Blockchain, and Storage Deals.
