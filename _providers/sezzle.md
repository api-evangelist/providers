...
- group: company
  title: ''
  type: Website
  url: https://www.sezzle.com/
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/sezzle/refs/heads/main/agentic-access/sezzle-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/sezzle-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sezzle/refs/heads/main/security/sezzle-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/sezzle-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sezzle/refs/heads/main/security/sezzle-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/sezzle-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sezzle/refs/heads/main/authentication/sezzle-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Sezzle publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Bearer Authentication API, Customer API, Order API, and 4 more. Tagged areas include Buy Now Pay Later, Payments, Installments, Fintech, and Merchant Integration.


  The Sezzle catalog on APIs.io includes 1 JSON-LD context and 1 Spectral governance ruleset.


  Sezzle''s developer surface includes authentication, developer portal, GitHub presence, pricing, terms of service, privacy policy, and 12 more developer resources.'
plans:
- name: Plans
  plan_count: 2
  slug: plans
