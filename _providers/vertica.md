...
access_model:
  ...
  source:
  - authentication
  - '{''url'': ''https://www.vertica.com'', ''status'': 301, ''note'': ''declared website redirects to https://www.rocketsoftware.com/en-us/products/vertica?o=vert — a different registrable domain (vertica.com -> rocketsoftware.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: agent-aware
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/vertica/refs/heads/main/agentic-access/vertica-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/vertica-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/vertica/refs/heads/main/security/vertica-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/vertica-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/vertica/refs/heads/main/authentication/vertica-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Vertica publishes 3 APIs on the [APIs.io](https://apis.io/) network, including Health API, Lifecycle API, and 1 more. Tagged areas include Database, Analytics Database, Data Warehouse, Data Lakehouse, and Columnar Database.
