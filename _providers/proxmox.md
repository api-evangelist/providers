...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/proxmox/refs/heads/main/agentic-access/proxmox-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/proxmox-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/proxmox/refs/heads/main/security/proxmox-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/proxmox-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/proxmox/refs/heads/main/security/proxmox-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/proxmox-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/proxmox/refs/heads/main/authentication/proxmox-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Proxmox VE publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Access API, Cluster API, Containers API, and 2 more. Tagged areas include Virtualization, KVM, Containers, LXC, and Clustering.
