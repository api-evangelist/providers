...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/flying-embers/refs/heads/main/security/flying-embers-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/flying-embers/refs/heads/main/mcp/flying-embers-mcp.yml
  title: ''
  type: MCPServer
  url: mcp/flying-embers-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/flying-embers/refs/heads/main/llms/flying-embers-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/flying-embers-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/flying-embers/refs/heads/main/well-known/flying-embers-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/flying-embers-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/flying-embers/refs/heads/main/authentication/flying-embers-authentication.yml
  title: ''
  type: Authentication
  url: authentication/flying-embers-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/flying-embers/refs/heads/main/scopes/flying-embers-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/flying-embers-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/flying-embers/refs/heads/main/conventions/flying-embers-conventions.yml
  title: ''
  type: Conventions
...
- group: design
  ...
  url: conventions/flying-embers-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/flying-embers/refs/heads/main/conformance/flying-embers-conformance.yml
  title: ''
  type: Conformance
  url: conformance/flying-embers-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/flying-embers/refs/heads/main/errors/flying-embers-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/flying-embers-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/flying-embers/refs/heads/main/lifecycle/flying-embers-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/flying-embers-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/flying-embers/refs/heads/main/data-model/flying-embers-data-model.yml
  title: ''
  type: DataModel
  url: data-model/flying-embers-data-model.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/flying-embers/refs/heads/main/rate-limits/flying-embers-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/flying-embers-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/flying-embers/refs/heads/main/plans/flying-embers-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/flying-embers-plans-pricing.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/flying-embers/refs/heads/main/packages/flying-embers-packages.yml
  title: ''
  type: Packages
  url: packages/flying-embers-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/flying-embers/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
