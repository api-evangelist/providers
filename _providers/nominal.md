...
- group: auth
  ...
  url: https://trust.nominal.io
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/nominal/refs/heads/main/mcp/nominal-mcp.yml
  title: ''
  type: MCPServer
  url: mcp/nominal-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/nominal/refs/heads/main/llms/nominal-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/nominal-llms.txt
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/nominal/refs/heads/main/packages/nominal-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/nominal-packages.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/nominal/refs/heads/main/cli/nominal-cli.yml
  title: ''
  type: CLI
  url: cli/nominal-cli.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/nominal/refs/heads/main/authentication/nominal-authentication.yml
  title: ''
  type: Authentication
  url: authentication/nominal-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/nominal/refs/heads/main/conventions/nominal-conventions.yml
  title: ''
  type: Conventions
  url: conventions/nominal-conventions.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/nominal/refs/heads/main/well-known/nominal-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/nominal-well-known.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/nominal/refs/heads/main/conformance/nominal-conformance.yml
  title: ''
  type: Conformance
  url: conformance/nominal-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/nominal/refs/heads/main/lifecycle/nominal-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/nominal-lifecycle.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/nominal/refs/heads/main/changelog/nominal-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/nominal-changelog.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/nominal/refs/heads/main/security/nominal-domain-security.yml
  title: ''
  type: DomainSecurity
