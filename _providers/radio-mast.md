...
- baseURL: https://api.radiomast.io/v1
  ...
  name: Radio Mast Radio Mast API
...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/radio-mast/refs/heads/main/capabilities/radio-mast-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/radio-mast-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/radio-mast/refs/heads/main/agentic-access/radio-mast-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/radio-mast-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/radio-mast/refs/heads/main/security/radio-mast-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/radio-mast-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/radio-mast/refs/heads/main/authentication/radio-mast-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Radio Mast publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Analytics API, Listener Pools API, Radio Mast API, and 2 more. Tagged areas include Radio, Streaming, Analytics, Audio, and Broadcasting.


  Radio Mast''s developer surface includes authentication, engineering blog, and 6 more developer resources.'
plans:
