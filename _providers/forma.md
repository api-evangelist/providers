...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/forma/refs/heads/main/security/forma-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/forma-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/forma/refs/heads/main/security/forma-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/forma-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/forma/refs/heads/main/security/forma-trust-center.yml
  title: ''
  type: TrustCenter
...
nav: Providers
network: true
overview: 'Forma is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Human Resources, Employee Benefits, Lifestyle Spending Accounts, and Flexible Spending Accounts.
