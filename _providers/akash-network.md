...
- collection_type: open
  name: Akash Console Bids API
  slug: open-akash-network-bids-api
- collection_type: open
  name: Akash Console Bids Deployments API
  slug: open-akash-network-deployments-api
- collection_type: open
  name: Akash Console Bids Leases API
  slug: open-akash-network-leases-api
- collection_type: open
  name: Akash Console API
...
- group: other
  title: ''
  type: CapabilityMap
  url: capabilities/akash-network-capability-edges.yml
- group: operate
  title: ''
  type: Releases
  url: https://github.com/akash-network/provider/releases
- group: docs
  title: ''
  type: ContributionGuide
  url: https://github.com/akash-network/provider/blob/main/CONTRIBUTING.md
- group: commercial
  title: ''
  type: License
  url: https://github.com/akash-network/provider/blob/main/LICENSE
- group: agent
  title: ''
  type: AgenticAccess
...
overview: 'Akash Network publishes 3 APIs on the [APIs.io](https://apis.io/) network: Bids API, Deployments API, and Leases API. Tagged areas include Decentralized Cloud, GPU, Compute, DePIN, and Cosmos.
  ...
  Akash Network''s developer surface includes authentication, documentation, GitHub presence, developer console, engineering blog, and 9 more developer resources.'
plans:
