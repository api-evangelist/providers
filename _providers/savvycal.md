...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/savvycal/refs/heads/main/agentic-access/savvycal-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/savvycal-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/savvycal/refs/heads/main/security/savvycal-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/savvycal-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/savvycal/refs/heads/main/security/savvycal-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/savvycal-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/savvycal/refs/heads/main/security/savvycal-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/savvycal-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/savvycal/refs/heads/main/authentication/savvycal-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/savvycal/refs/heads/main/plans/savvycal-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/savvycal-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/savvycal/refs/heads/main/rate-limits/savvycal-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/savvycal-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/savvycal/refs/heads/main/finops/savvycal-finops.yml
  title: ''
  type: FinOps
  url: finops/savvycal-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/savvycal/refs/heads/main/vocabulary/savvycal-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/savvycal-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/savvycal/refs/heads/main/json-ld/savvycal-context.jsonld
  title: ''
  type: JSONLDContext
  url: json-ld/savvycal-context.jsonld
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/savvycal/refs/heads/main/json-schema/savvycal-event-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/savvycal-event-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/savvycal/refs/heads/main/json-schema/savvycal-link-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/savvycal-link-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/savvycal/refs/heads/main/json-schema/savvycal-webhook-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/savvycal-webhook-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/savvycal/refs/heads/main/json-schema/savvycal-user-schema.json
  title: ''
  type: JSONSchema
