...
- collection_type: open
  ...
  slug: open-microsoft-azure-devops
- collection_type: open
  name: Microsoft Azure OpenAI Service API
  slug: open-microsoft-azure-openai
- collection_type: open
  name: Microsoft Azure REST API
  slug: open-microsoft-azure-rest
- collection_type: open
...
common:
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/microsoft/refs/heads/main/plans/microsoft-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/microsoft-plans-pricing.yml
- group: company
  title: ''
  type: Website
...
overview: 'Microsoft publishes 59 APIs on the [APIs.io](https://apis.io/) network, including Accounts API, Applications API, Audio API, and 56 more. Tagged areas include Fortune 100 and Microsoft.
  ...
  Microsoft''s developer surface includes authentication, support, engineering blog, signup flow, pricing, GitHub presence, and 24 more developer resources.'
plans:
...
- effective_rule_count: 6
  ...
  severity_counts:
    ...
    info: 2
    warn: 4
  slug: microsoft-jsonschema-spectral-rules
scopes:
...
- kind: vulnerability-disclosure
  name: Microsoft Vulnerability Disclosure
  slug: microsoft-vulnerability-disclosure
