...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/consul-connect/refs/heads/main/agentic-access/consul-connect-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/consul-connect-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/consul-connect/refs/heads/main/security/consul-connect-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/consul-connect-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/consul-connect/refs/heads/main/authentication/consul-connect-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/consul-connect/refs/heads/main/json-ld/consul-connect-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/consul-connect-context.jsonld
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/consul-connect/refs/heads/main/json-schema/consul-connect-intention-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/consul-connect-intention-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/consul-connect/refs/heads/main/vocabulary/consul-connect-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/consul-connect-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/consul-connect/refs/heads/main/rules/consul-connect-rules.yml
  title: ''
  type: SpectralRules
...
nav: Providers
network: true
overview: 'Consul Connect publishes 4 APIs on the [APIs.io](https://apis.io/) network, including CA API, Intentions API, and 2 more. Tagged areas include Consul, Envoy, HashiCorp, Intentions, and Kubernetes.
