...
- baseURL: https://api-sandbox.koin.com.br
  baseurl_source: declared
  description: The Payment Request API from Koin — 2 operation(s) for payment request.
  name: Koin Payment Request API
...
- group: start
  ...
  url: https://api-docs.koin.com.br/
- group: docs
  title: ''
  type: Documentation
  url: https://api-docs.koin.com.br/docs/security-scheme
- group: docs
  title: ''
  type: APIReference
  url: https://api-docs.koin.com.br/reference/introduction
- group: start
  title: ''
  type: GettingStarted
  url: https://api-docs.koin.com.br/docs/integration-requirements
- group: company
  title: ''
  type: Website
...
- group: operate
  title: ''
  type: Support
  url: https://www.koin.com.br/atendimento
- group: operate
  title: ''
  type: HelpCenter
  url: https://www.koin.com.br/faq-b2b
- group: company
  title: ''
  type: Blog
  url: https://www.koin.com.br/conteudos
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/koinlatam
- group: commercial
  title: ''
  type: Pricing
  url: https://www.koin.com.br/plataforma-de-pagamentos-b2b
- group: start
  title: ''
  type: SignUp
  url: https://koin-prod.us.auth0.com/u/login
- group: commercial
  title: ''
  type: TermsOfService
  url: https://termos.koin.com.br/
- group: commercial
  title: ''
  type: PrivacyPolicy
...
nav: Providers
network: true
overview: 'Koin publishes 14 APIs on the [APIs.io](https://apis.io/) network, including Access API, Account Take Over Services API, Availability Services API, and 11 more. Tagged areas include Payments, Fraud Prevention, Buy Now Pay Later, Pix, and E-Commerce.
