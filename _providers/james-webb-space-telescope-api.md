...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/james-webb-space-telescope-api/refs/heads/main/security/james-webb-space-telescope-api-domain-security.yml
  title: ''
  type: DomainSecurity
