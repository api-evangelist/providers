...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ezee/refs/heads/main/agentic-access/ezee-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/ezee-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ezee/refs/heads/main/security/ezee-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/ezee-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ezee/refs/heads/main/security/ezee-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/ezee-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ezee/refs/heads/main/authentication/ezee-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/ezee/refs/heads/main/plans/ezee-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/ezee-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/ezee/refs/heads/main/rate-limits/ezee-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/ezee-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/ezee/refs/heads/main/finops/ezee-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'eZee Technosys publishes 2 APIs on the [APIs.io](https://apis.io/) network: Inventory and Rates API and PMS Connectivity API. Tagged areas include Hospitality, Hotels, PMS, Channel Manager, and Reservations.
