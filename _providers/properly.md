...
access_model:
  ...
  source:
  - security
  - '{''url'': ''https://properly.ca/'', ''status'': 301, ''note'': ''declared website redirects to https://www.pine.ca/homes/ — a different registrable domain (properly.ca -> pine.ca), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/properly/refs/heads/main/security/properly-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/properly-domain-security.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/properly/refs/heads/main/lifecycle/properly-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/properly-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/properly/refs/heads/main/conformance/properly-conformance.yml
  title: ''
  type: Conformance
  url: conformance/properly-conformance.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/properly/refs/heads/main/llms/properly-llms.txt
  title: ''
  type: LLMsTxt
