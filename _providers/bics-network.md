...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/bics-network/refs/heads/main/capabilities/bics-network-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/bics-network-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/bics-network/refs/heads/main/agentic-access/bics-network-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/bics-network-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bics-network/refs/heads/main/authentication/bics-network-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/bics-network/refs/heads/main/plans/bics-network-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/bics-network-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/bics-network/refs/heads/main/rate-limits/bics-network-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/bics-network-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/bics-network/refs/heads/main/finops/bics-network-finops.yml
  title: ''
  type: FinOps
