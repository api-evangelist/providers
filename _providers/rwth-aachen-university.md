...
- key_count: 2
  ...
  slug: rwth-aachen-university-get-project-example
- key_count: 2
  name: Rwth Aachen University Get Resource Example
  slug: rwth-aachen-university-get-resource-example
finops:
- name: Rwth Aachen University Finops
  service_category: Education
  slug: rwth-aachen-university-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/rwth-aachen-university.png
json_schemas:
- name: ApiTokenDto
  property_count: 6
  slug: rwth-aachen-university-apitoken
- name: ProjectDto
  property_count: 15
  slug: rwth-aachen-university-project
- name: ResourceDto
  property_count: 18
  slug: rwth-aachen-university-resource
json_structures:
- name: Rwth Aachen University Project Structure
  property_count: 14
  slug: rwth-aachen-university-project-structure
- name: Rwth Aachen University Resource Structure
  property_count: 15
  slug: rwth-aachen-university-resource-structure
jsonld:
- class_count: 20
  name: Rwth Aachen University Context
  property_count: 8
...
- limit_count: 1
  ...
  slug: rwth-aachen-university-rate-limits
rules:
- name: RWTH Aachen University API Rules
  rule_count: 5
  severity_counts:
    error: 0
    hint: 0
    info: 2
    warn: 3
  slug: rwth-aachen-university-jsonschema-spectral-rules
- name: RWTH Aachen University API Rules
  rule_count: 6
  severity_counts:
    error: 0
...
- kind: vulnerability-disclosure
  name: Rwth Aachen University Vulnerability Disclosure
  slug: rwth-aachen-university-vulnerability-disclosure
