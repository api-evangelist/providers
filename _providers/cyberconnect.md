...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cyberconnect/refs/heads/main/security/cyberconnect-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'CyberConnect publishes 2 APIs on the [APIs.io](https://apis.io/) network, including GraphQL API, and 1 more. Tagged areas include Web3, Social Graph, Decentralized, GraphQL, and Blockchain.
