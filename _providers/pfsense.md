...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/pfsense/refs/heads/main/agentic-access/pfsense-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/pfsense-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pfsense/refs/heads/main/security/pfsense-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/pfsense-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pfsense/refs/heads/main/security/pfsense-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/pfsense-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pfsense/refs/heads/main/authentication/pfsense-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'pfSense publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Authentication API, Firewall Aliases API, Firewall Apply API, and 2 more. Tagged areas include Firewall, Network Security, Router, VPN, and Open Source.
