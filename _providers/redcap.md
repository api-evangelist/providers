...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/redcap/refs/heads/main/security/redcap-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: RedCap is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Automotive, Dealership, Services, and Fixed Operations.
random_paper: 7
score:
  band: minimal
  composite: 5.0
