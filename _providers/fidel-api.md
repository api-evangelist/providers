...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/fidel-api/refs/heads/main/security/fidel-api-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/fidel-api/refs/heads/main/authentication/fidel-api-authentication.yml
  title: ''
  type: Authentication
  url: authentication/fidel-api-authentication.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/fidel-api/refs/heads/main/packages/fidel-api-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/fidel-api-packages.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/fidel-api/refs/heads/main/sandbox/fidel-api-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/fidel-api-sandbox.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/fidel-api/refs/heads/main/asyncapi/fidel-api-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/fidel-api-webhooks.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/fidel-api/refs/heads/main/conventions/fidel-api-conventions.yml
  title: ''
  type: Conventions
  url: conventions/fidel-api-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/fidel-api/refs/heads/main/lifecycle/fidel-api-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/fidel-api-lifecycle.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/fidel-api/refs/heads/main/changelog/fidel-api-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/fidel-api-changelog.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/fidel-api/refs/heads/main/conformance/fidel-api-conformance.yml
  title: ''
  type: Conformance
...
- group: auth
  ...
  url: https://docs.fidelapi.com/docs/select
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/fidel-api/refs/heads/main/components/fidel-api-components.yml
  title: ''
  type: Components
  url: components/fidel-api-components.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/fidel-api/refs/heads/main/data-model/fidel-api-data-model.yml
  title: ''
  type: DataModel
  url: data-model/fidel-api-data-model.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/fidel-api/refs/heads/main/llms/fidel-api-llms.txt
  title: ''
  type: LLMsTxt
