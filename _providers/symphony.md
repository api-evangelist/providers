...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/symphony/refs/heads/main/capabilities/symphony-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/symphony-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/symphony/refs/heads/main/agentic-access/symphony-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/symphony-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/symphony/refs/heads/main/security/symphony-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/symphony-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/symphony/refs/heads/main/authentication/symphony-authentication.yml
  title: ''
  type: Authentication
  url: authentication/symphony-authentication.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/symphonycomm
- group: company
  title: ''
  type: Website
...
- group: agent
  title: ''
  type: LlmsText
  url: https://rest-api.symphony.com/llms.txt
created: '2026-05-03'
...
examples:
- key_count: 5
  name: Symphony Create Room Example
  slug: symphony-create-room-example
- key_count: 5
  name: Symphony Post Message Example
  slug: symphony-post-message-example
finops:
...
json_schemas:
- name: Symphony Message
  property_count: 12
  slug: symphony-message
- name: Symphony Room
  property_count: 2
  slug: symphony-room
json_structures:
- name: Symphony Message Structure
  property_count: 0
  slug: symphony-message-structure
jsonld:
- class_count: 0
