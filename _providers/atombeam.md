...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/atombeam/refs/heads/main/llms/atombeam-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/atombeam-llms.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/atombeam/refs/heads/main/security/atombeam-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'AtomBeam is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Data Compression, IoT, Edge Computing, and Satellite Communications.
