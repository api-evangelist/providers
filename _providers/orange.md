...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/orange/refs/heads/main/capabilities/orange-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/orange-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/orange/refs/heads/main/agentic-access/orange-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/orange-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/orange/refs/heads/main/security/orange-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/orange-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/orange/refs/heads/main/security/orange-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/orange-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/orange/refs/heads/main/authentication/orange-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Orange publishes 15 APIs on the [APIs.io](https://apis.io/) network, including Device Phone Number API, Verify API, and 13 more. Tagged areas include Networks, Telecommunications, Identity, Messaging, and Location.
