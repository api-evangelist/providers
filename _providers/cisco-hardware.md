...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cisco-hardware/refs/heads/main/agentic-access/cisco-hardware-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/cisco-hardware-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cisco-hardware/refs/heads/main/security/cisco-hardware-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/cisco-hardware-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cisco-hardware/refs/heads/main/security/cisco-hardware-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/cisco-hardware-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cisco-hardware/refs/heads/main/authentication/cisco-hardware-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cisco-hardware/refs/heads/main/json-ld/cisco-hardware-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/cisco-hardware-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cisco-hardware/refs/heads/main/rules/cisco-hardware-rules.yml
  title: ''
  type: Spectral
...
nav: Providers
network: true
overview: 'Cisco Hardware publishes 11 APIs on the [APIs.io](https://apis.io/) network, including Authentication API, CommandRunner API, Devices API, and 8 more. Tagged areas include Hardware, Infrastructure, Networking, Router, and Switches.


  The Cisco Hardware catalog on APIs.io includes 1 JSON-LD context and 1 Spectral governance ruleset.


  Cisco Hardware''s developer surface includes authentication, developer portal, documentation, sandbox, support, and 13 more developer resources.'
plans:
