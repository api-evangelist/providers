...
- collection_type: open
  name: 2C2P Payment Gateway API (PGW v4.3) Do Payment API
  slug: open-2c2p-do-payment-api
- collection_type: open
  name: 2C2P Payment Gateway API (PGW v4.3) Do Payment Exchange Rate API
  slug: open-2c2p-exchange-rate-api
- collection_type: open
  name: 2C2P Payment Gateway API (PGW v4.3) Do Payment Inquiry API
  slug: open-2c2p-inquiry-api
- collection_type: open
  name: 2C2P Payment Gateway API (PGW v4.3) Do Payment Maintenance API
  slug: open-2c2p-maintenance-api
- collection_type: open
  name: 2C2P Payment Gateway API (PGW v4.3) Do Payment Payment Option API
  slug: open-2c2p-payment-option-api
- collection_type: open
  name: 2C2P Payment Gateway API (PGW v4.3) Do Payment Payment Token API
  slug: open-2c2p-payment-token-api
- collection_type: open
  name: 2C2P Payment Gateway API (PGW v4.3) Do Payment Tokens API
  slug: open-2c2p-tokens-api
- collection_type: open
  name: 2C2P Payment Gateway API (PGW v4.3)
  slug: open-2c2p
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/2c2p/refs/heads/main/agentic-access/2c2p-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/2c2p-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/2c2p/refs/heads/main/security/2c2p-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/2c2p-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/2c2p/refs/heads/main/authentication/2c2p-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/2c2p/refs/heads/main/plans/2c2p-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/2c2p-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/2c2p/refs/heads/main/rate-limits/2c2p-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/2c2p-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/2c2p/refs/heads/main/finops/2c2p-finops.yml
  title: ''
  type: FinOps
