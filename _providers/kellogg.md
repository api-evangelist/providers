...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/kellogg/refs/heads/main/security/kellogg-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/kellogg-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/kellogg-company
- group: company
  title: ''
  type: Website
  url: https://www.kellogg.com
- group: other
  title: ''
  type: Successor
  url: https://www.wkkellogg.com
- group: other
  title: ''
  type: Successor
...
created: '2026-03-24'
description: 'The Kellogg Company is a historic American multinational food manufacturer founded in 1906 by W.K. Kellogg in Battle Creek, Michigan. In 2023 the company split into two independent public companies: WK Kellogg Co, which retained the North American cereal business (Frosted Flakes, Rice Krispies, Special K, Corn Flakes, Raisin Bran), and Kellanova, which took the global snacks business and international cereal portfolio (Pringles, Cheez-It, Pop-Tarts, Eggo, RXBAR). This profile tracks the legacy Kellogg corporate identity and links forward to the two successor entities.'
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/kellogg.png
layout: provider
modified: '2026-04-28'
name: Kellogg
nav: Providers
