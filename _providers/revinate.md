...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/revinate/refs/heads/main/capabilities/revinate-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/revinate-capability-edges.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/revinate/refs/heads/main/overlays/revinate-porter-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/revinate-porter-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/revinate/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/revinate/refs/heads/main/security/revinate-trust-center.yml
  title: ''
  type: Compliance
  url: security/revinate-trust-center.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/revinate/refs/heads/main/llms/revinate-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/revinate-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/revinate/refs/heads/main/well-known/revinate-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/revinate-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/revinate/refs/heads/main/scopes/revinate-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/revinate-scopes.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/revinate/refs/heads/main/authentication/revinate-authentication.yml
  title: ''
  type: Authentication
  url: authentication/revinate-authentication.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/revinate/refs/heads/main/packages/revinate-packages.yml
  title: ''
  type: Packages
  url: packages/revinate-packages.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/revinate/refs/heads/main/conformance/revinate-conformance.yml
  title: ''
  type: Conformance
  url: conformance/revinate-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/revinate/refs/heads/main/lifecycle/revinate-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/revinate-lifecycle.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/revinate/refs/heads/main/security/revinate-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/revinate-domain-security.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/revinate/refs/heads/main/plans/revinate-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/revinate-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/revinate/refs/heads/main/rate-limits/revinate-rate-limits.yml
  title: ''
  type: RateLimits
