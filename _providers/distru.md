...
- acting_count: 16
  human_in_the_loop: 0
  name: Distru Agentic Access
  operation_count: 50
  slug: distru-agentic-access
...
- group: company
  title: ''
  type: Blog
  url: https://www.distru.com/cannabis-blog
- group: start
  title: ''
  type: SignUp
...
- group: start
  title: ''
  type: Login
  url: https://app.distru.com
- group: commercial
  title: ''
  type: TermsOfService
  url: https://www.distru.com/legal/terms-of-service
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://www.distru.com/legal/privacy-policy
- group: company
  title: ''
  type: LinkedIn
...
nav: Providers
network: true
overview: 'Distru publishes 21 APIs on the [APIs.io](https://apis.io/) network, including Assemblies API, Batches API, Companies API, and 18 more. Tagged areas include Company, Cannabis, ERP, Seed-to-Sale, and Inventory.
