...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/jelly-belly/refs/heads/main/agentic-access/jelly-belly-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/jelly-belly-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jelly-belly/refs/heads/main/security/jelly-belly-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: Jelly Belly publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Beans API, Combinations API, Facts API, and 3 more. Tagged areas include Beans, Candy, Confectionery, Food, and Jelly Beans.
plans:
