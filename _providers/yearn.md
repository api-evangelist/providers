...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/yearn/refs/heads/main/agentic-access/yearn-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/yearn-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/yearn/refs/heads/main/security/yearn-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Yearn Finance publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Chains API, Info API, TVL API, and 2 more. Tagged areas include DeFi, Yield Aggregator, Vault, EVM, and Web3.
