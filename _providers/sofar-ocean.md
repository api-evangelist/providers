...
api_count: 1
apis:
- baseURL: https://api.sofarocean.com
...
- collection_type: open
  name: Sofar Ocean Spotter & Smart Mooring Devices API
  slug: open-sofar-ocean-devices-api
- collection_type: open
  name: Sofar Ocean Spotter & Devices Smart Mooring API
  slug: open-sofar-ocean-smart-mooring-api
- collection_type: open
  name: Sofar Ocean Spotter & Smart Mooring Devices Spotter Data API
  slug: open-sofar-ocean-spotter-data-api
- collection_type: open
  name: Sofar Ocean Spotter & Smart Mooring Devices Wave Spectra API
