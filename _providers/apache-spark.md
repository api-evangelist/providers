...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/apache-spark/refs/heads/main/agentic-access/apache-spark-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/apache-spark-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apache-spark/refs/heads/main/security/apache-spark-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/apache-spark-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apache-spark/refs/heads/main/security/apache-spark-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Apache Spark publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Applications API, Version API, and 4 more. Tagged areas include Analytics, Big Data, Distributed Computing, Machine Learning, and Open Source.
