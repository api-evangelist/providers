...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://www.alkemics.com/'', ''status'': 301, ''note'': ''declared website redirects to https://www.salsify.com/ — a different registrable domain (alkemics.com -> salsify.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/alkemics/refs/heads/main/security/alkemics-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/alkemics-domain-security.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/alkemics/refs/heads/main/lifecycle/alkemics-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/alkemics-lifecycle.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/alkemics/refs/heads/main/packages/alkemics-packages.yml
  title: ''
  type: Packages
  url: packages/alkemics-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/alkemics/refs/heads/main/llms/alkemics-llms.txt
  title: ''
  type: LLMsTxt
...
nav: Providers
network: true
overview: 'Alkemics is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Applicative Saas, Product Content, Product Information Management, and Consumer Packaged Goods.
