...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/partykit/refs/heads/main/security/partykit-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'PartyKit publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Deployed Party (HTTP / WebSocket), and 3 more. Tagged areas include Real-Time, Multiplayer, WebSocket, Cloudflare, and Durable Objects.
