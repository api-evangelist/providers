...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/caddy/refs/heads/main/agentic-access/caddy-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/caddy-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/caddy/refs/heads/main/security/caddy-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Caddy publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Adapt API, Configuration API, Lifecycle API, and 3 more. Tagged areas include Automatic HTTPS, Go, Load Balancer, Reverse Proxy, and TLS.
