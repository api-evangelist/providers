...
nav: Providers
network: true
overview: 'MEDITECH publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Allergy API, Capability API, Condition API, and 6 more. Tagged areas include Company, EHR, Healthcare, FHIR, and HL7.
