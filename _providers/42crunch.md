...
- collection_type: open
  name: 42Crunch API Conformance Scan Jobs Manager Health API
  slug: open-42crunch-health-api
- collection_type: open
  name: 42Crunch API Conformance Scan Manager Health Jobs API
  slug: open-42crunch-jobs-api
- collection_type: open
  name: 42Crunch API Conformance Scan Jobs Manager Health Logs API
  slug: open-42crunch-logs-api
common:
- group: operate
  title: ''
  type: IssueTracker
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/42crunch/refs/heads/main/agentic-access/42crunch-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/42crunch-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/42crunch/refs/heads/main/security/42crunch-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/42crunch/refs/heads/main/rules/42crunch-spectral-rules.yml
  title: ''
  type: SpectralRules
  url: rules/42crunch-spectral-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/42crunch/refs/heads/main/vocabulary/42crunch-vocabulary.yaml
  title: ''
  type: Vocabulary
  url: vocabulary/42crunch-vocabulary.yaml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/42crunch/refs/heads/main/json-ld/42crunch-scand-manager-context.jsonld
  title: ''
  type: JSONLD
