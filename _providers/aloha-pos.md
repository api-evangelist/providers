...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/aloha-pos/refs/heads/main/agentic-access/aloha-pos-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/aloha-pos-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/aloha-pos/refs/heads/main/security/aloha-pos-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/aloha-pos-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/aloha-pos/refs/heads/main/authentication/aloha-pos-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aloha-pos/refs/heads/main/rules/ncr-voyix-platform-rules.yml
  title: ''
  type: Rules
  url: rules/ncr-voyix-platform-rules.yml
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/aloha-pos/refs/heads/main/json-schema/
  title: ''
  type: JSONSchema
  url: json-schema/
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aloha-pos/refs/heads/main/json-ld/aloha-pos-ncr-voyix-platform-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/aloha-pos-ncr-voyix-platform-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aloha-pos/refs/heads/main/vocabulary/aloha-pos-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/aloha-pos-vocabulary.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/aloha-pos/refs/heads/main/plans/aloha-pos-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/aloha-pos-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/aloha-pos/refs/heads/main/rate-limits/aloha-pos-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/aloha-pos-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/aloha-pos/refs/heads/main/finops/aloha-pos-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Aloha POS publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Catalog API, Menu API, Order API, and 2 more. Tagged areas include Point-of-Sale, Restaurant, Hospitality, and NCR.
