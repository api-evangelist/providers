...
access_model:
  ...
  - authentication
  - security
  - '{''url'': ''https://layercode.com'', ''status'': 301, ''note'': ''declared website redirects to https://toyo.ai/ — a different registrable domain (layercode.com -> toyo.ai), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: agent-aware
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/layercode/refs/heads/main/agentic-access/layercode-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/layercode-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/layercode/refs/heads/main/security/layercode-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/layercode-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/layercode/refs/heads/main/authentication/layercode-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/layercode/refs/heads/main/plans/layercode-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/layercode-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/layercode/refs/heads/main/rate-limits/layercode-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/layercode-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/layercode/refs/heads/main/finops/layercode-finops.yml
  title: ''
  type: FinOps
