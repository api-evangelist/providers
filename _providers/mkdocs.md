...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/mkdocs/refs/heads/main/vendor-facets/mkdocs-vendor-facets.yml
  title: ''
  type: VendorFacets
  url: vendor-facets/mkdocs-vendor-facets.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mkdocs/refs/heads/main/security/mkdocs-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/mkdocs/refs/heads/main/json-schema/mkdocs-config-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/mkdocs-config-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/mkdocs/refs/heads/main/json-schema/mkdocs-plugin-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/mkdocs-plugin-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mkdocs/refs/heads/main/json-ld/mkdocs-context.jsonld
  title: ''
  type: JSONLD
...
overview: 'MkDocs is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Documentation, Markdown, Open Source, Python, and Static Site Generator.
  ...
  MkDocs'' developer surface includes documentation, getting-started guide, GitHub presence, and 6 more developer resources.'
random_paper: 3
rules:
