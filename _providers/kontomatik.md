...
- group: company
  title: ''
  type: Website
  url: https://www.kontomatik.com/
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/kontomatik/refs/heads/main/agentic-access/kontomatik-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/kontomatik-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/kontomatik/refs/heads/main/security/kontomatik-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/kontomatik-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/kontomatik/refs/heads/main/security/kontomatik-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/kontomatik-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/kontomatik/refs/heads/main/authentication/kontomatik-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/kontomatik/refs/heads/main/plans/kontomatik-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/kontomatik-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/kontomatik/refs/heads/main/rate-limits/kontomatik-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/kontomatik-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/kontomatik/refs/heads/main/finops/kontomatik-finops.yml
  title: ''
  type: FinOps
  url: finops/kontomatik-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/kontomatik/refs/heads/main/vocabulary/kontomatik-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/kontomatik-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/kontomatik/refs/heads/main/rules/kontomatik-rules.yml
  title: ''
  type: SpectralRules
...
overview: 'Kontomatik publishes 16 APIs on the [APIs.io](https://apis.io/) network, including Aggregation API, Catalog API, Command API, and 13 more. Tagged areas include Open Banking, PSD2, AIS, Bank Data Aggregation, and CEE.
  ...
  Kontomatik''s developer surface includes authentication, developer portal, documentation, getting-started guide, support, signup flow, engineering blog, and 18 more developer resources.'
plans:
...
- PDF Parsing
website: https://www.kontomatik.com/
---
