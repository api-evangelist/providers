...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/dollar-general/refs/heads/main/security/dollar-general-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/dollar-general-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/dollar-general
- group: company
  title: ''
  type: Website
...
- group: start
  title: ''
  type: Vendor Portal
  url: https://www.dgpartners.com
- group: other
  title: ''
  type: New Vendors
  url: https://www.rangeme.com/dollargeneral
- group: company
  title: ''
  type: Careers
  url: https://careers.dollargeneral.com
- group: company
  title: ''
  type: Investor Relations
  url: https://investor.dollargeneral.com
created: '2026-03-21'
description: Dollar General is a Fortune 500 discount retailer operating more than 20,000 stores across the United States. Vendor and supplier integration is handled through the DG Partners portal and RangeMe for new vendor onboarding. Dollar General does not currently publish a public REST API.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/dollar-general.png
layout: provider
modified: '2026-04-28'
name: Dollar General
nav: Providers
