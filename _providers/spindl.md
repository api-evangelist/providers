...
overview: 'Spindl publishes 2 APIs on the [APIs.io](https://apis.io/) network: Events API and Short Links API. Tagged areas include Company, Crypto Web3, Attribution, Analytics, and Marketing.
  ...
  Spindl''s developer surface includes authentication, documentation, getting-started guide, engineering blog, signup flow, support, and 16 more developer resources.'
random_paper: 50
score:
  band: thin
  composite: 41.8
