...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/forto/refs/heads/main/agentic-access/forto-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/forto-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/forto/refs/heads/main/security/forto-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/forto-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/forto/refs/heads/main/security/forto-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/forto-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/forto/refs/heads/main/authentication/forto-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Forto publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Bookings API, Documents API, Shipments API, and 4 more. Tagged areas include Freight, Logistics, Supply Chain, Shipping, and Freight Forwarding.
