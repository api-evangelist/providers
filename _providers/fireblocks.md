...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/fireblocks/refs/heads/main/capabilities/fireblocks-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/fireblocks/refs/heads/main/agentic-access/fireblocks-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/fireblocks-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/fireblocks/refs/heads/main/security/fireblocks-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/fireblocks-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/fireblocks/refs/heads/main/security/fireblocks-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/fireblocks-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/fireblocks/refs/heads/main/authentication/fireblocks-authentication.yml
  title: ''
  type: Authentication
...
overview: 'Fireblocks publishes 35 APIs on the [APIs.io](https://apis.io/) network, including Vaults API, Transactions API, Tokenization API, and 32 more. Tagged areas include Digital Assets, Custody, Vault, Transaction, and Tokenization.
  ...
  Fireblocks'' developer surface includes pricing, changelog, authentication, developer portal, documentation, getting-started guide, engineering blog, and 70 more developer resources.'
plans:
- name: Fireblocks Plans Pricing
  plan_count: 2
  slug: fireblocks-plans-pricing
- name: Fireblocks Price Estimates
  plan_count: 0
  slug: fireblocks-price-estimates
random_paper: 4
rate_limits:
- limit_count: 6
