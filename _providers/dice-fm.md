...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/dice-fm/refs/heads/main/security/dice-fm-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/dice-fm-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/dice-fm/refs/heads/main/security/dice-fm-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/dice-fm/refs/heads/main/plans/dice-fm-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/dice-fm-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/dice-fm/refs/heads/main/rate-limits/dice-fm-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/dice-fm-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/dice-fm/refs/heads/main/finops/dice-fm-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'DICE publishes 5 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include Ticketing, Live Music, Event, GraphQL, and Entertainment.
