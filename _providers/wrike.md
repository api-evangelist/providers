...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/wrike/refs/heads/main/agentic-access/wrike-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/wrike-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/wrike/refs/heads/main/security/wrike-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/wrike-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/wrike/refs/heads/main/security/wrike-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/wrike-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/wrike/refs/heads/main/authentication/wrike-authentication.yml
  title: ''
  type: Authentication
  url: authentication/wrike-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/wrike/refs/heads/main/scopes/wrike-scopes.yml
  title: ''
  type: OAuthScopes
...
overview: 'Wrike publishes 13 APIs on the [APIs.io](https://apis.io/) network, including Access Roles API, Accounts API, Colors API, and 10 more. Tagged areas include Work Management, Project Management, Collaboration, Productivity, and Workflow-Automation.
  ...
  Wrike''s developer surface includes authentication, signup flow, pricing, support, FAQ, engineering blog, training material, and 18 more developer resources.'
plans:
