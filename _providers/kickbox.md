...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/kickbox/refs/heads/main/security/kickbox-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/kickbox-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/kickbox/refs/heads/main/authentication/kickbox-authentication.yml
  title: ''
  type: Authentication
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/kickbox/refs/heads/main/llms/kickbox-llms.txt
  title: ''
  type: LLMsTxt
...
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/kickbox/refs/heads/main/packages/kickbox-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/kickbox-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/kickbox/refs/heads/main/mcp/kickbox-mcp.yml
  title: ''
  type: MCPServer
  url: mcp/kickbox-mcp.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/kickbox/refs/heads/main/mcp/kickbox-tool-crosswalk.yml
  title: ''
  type: ToolCrosswalk
  url: mcp/kickbox-tool-crosswalk.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/kickbox/refs/heads/main/sandbox/kickbox-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/kickbox-sandbox.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/kickbox/refs/heads/main/conventions/kickbox-conventions.yml
  title: ''
  type: Conventions
  url: conventions/kickbox-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/kickbox/refs/heads/main/errors/kickbox-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/kickbox-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/kickbox/refs/heads/main/lifecycle/kickbox-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/kickbox/refs/heads/main/data-model/kickbox-data-model.yml
  title: ''
  type: DataModel
  url: data-model/kickbox-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/kickbox/refs/heads/main/conformance/kickbox-conformance.yml
  title: ''
  type: Conformance
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/kickbox/refs/heads/main/asyncapi/kickbox-batch-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/kickbox-batch-webhooks.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/kickbox/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/kickbox/refs/heads/main/plans/kickbox-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/kickbox-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/kickbox/refs/heads/main/rate-limits/kickbox-rate-limits.yml
  title: ''
  type: RateLimits
...
nav: Providers
network: true
overview: 'Kickbox publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Account API, Batch API, Open API, and 2 more. Tagged areas include Email Verification, Deliverability, Data Quality, and Email.
