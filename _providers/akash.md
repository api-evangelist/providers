...
api_count: 3
apis:
- description: REST API for programmatic deployment management on Akash Network with managed wallets and credit-card billing. Supports creating, listing, updating, and closing deployments via SDL manifests. Includes
  name: Akash Console Deployment API
  slug: akash-console-deployment-api
- description: Publicly accessible indexed API for querying provider information, GPU availability, resource statistics, and network-wide metrics. No authentication required. Returns real-time provider resource avai
  name: Akash Console Network Data API
  slug: akash-console-network-data-api
- description: Direct REST access to Akash blockchain state via gRPC-Gateway on port 1317. Exposes Cosmos SDK modules (auth, bank, staking, governance) and Akash-specific modules (deployment, market, provider, audit
...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/akash/refs/heads/main/capabilities/akash-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/akash-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/akash/refs/heads/main/agentic-access/akash-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/akash-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/akash/refs/heads/main/security/akash-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/akash-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/akash/refs/heads/main/authentication/akash-authentication.yml
  title: ''
  type: Authentication
  url: authentication/akash-authentication.yml
- group: company
  title: ''
  type: Website
...
overview: 'Akash Network publishes 37 APIs on the [APIs.io](https://apis.io/) network, including Addresses API, Alert API, Analytics API, and 34 more. Tagged areas include Cloud Computing, Decentralized, Blockchain, Kubernetes, and GPU.
  ...
  Akash Network''s developer surface includes authentication, documentation, GitHub presence, engineering blog, status page, changelog, and 11 more developer resources.'
plans:
- name: Plans
  plan_count: 3
  slug: plans
