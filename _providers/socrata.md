...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/socrata/refs/heads/main/security/socrata-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: Socrata publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Open Data, Public APIs, Data Catalog, Government, and Open Government.
random_paper: 1
score:
  band: minimal
  composite: 7.0
