...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/elastic-path/refs/heads/main/capabilities/elastic-path-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/elastic-path/refs/heads/main/agentic-access/elastic-path-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/elastic-path-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/elastic-path/refs/heads/main/security/elastic-path-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/elastic-path-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/elastic-path/refs/heads/main/security/elastic-path-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/elastic-path-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/elastic-path/refs/heads/main/authentication/elastic-path-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/elastic-path/refs/heads/main/plans/elastic-path-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/elastic-path-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/elastic-path/refs/heads/main/rate-limits/elastic-path-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/elastic-path-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/elastic-path/refs/heads/main/finops/elastic-path-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Elastic Path publishes 100 APIs on the [APIs.io](https://apis.io/) network, including Account Addresses API, Account Authentication Settings API, Account Cart Associations API, and 97 more. Tagged areas include Commerce, Headless Commerce, Composable Commerce, E-Commerce, and B2B.
...
- name: Elastic Path Price Estimates
  plan_count: 0
  slug: elastic-path-price-estimates
random_paper: 5
rate_limits:
- limit_count: 3
