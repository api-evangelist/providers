...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/doi/refs/heads/main/agentic-access/doi-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/doi-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/doi/refs/heads/main/security/doi-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/doi-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/doi/refs/heads/main/authentication/doi-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/doi/refs/heads/main/plans/doi-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/doi-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/doi/refs/heads/main/rate-limits/doi-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/doi-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/doi/refs/heads/main/finops/doi-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Department of Interior publishes 55 APIs on the [APIs.io](https://apis.io/) network, including Agency Codes API, Altitude Datums API, Aquifer Codes API, and 52 more. Tagged areas include Federal Government, National Parks, Federal Lands, Water Resources, and Wildlife.
