...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/fastify/refs/heads/main/security/fastify-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Fastify publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Framework, High Performance, JavaScript, JSON-Schema, and Node.js.
