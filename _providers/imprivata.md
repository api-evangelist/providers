...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/imprivata/refs/heads/main/authentication/imprivata-authentication.yml
  title: ''
  type: Authentication
  url: authentication/imprivata-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/imprivata/refs/heads/main/security/imprivata-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/imprivata-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/imprivata/refs/heads/main/security/imprivata-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Imprivata is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Identity, Access Management, Authentication, and SSO.
