...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/euronext/refs/heads/main/security/euronext-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/euronext-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/euronext/refs/heads/main/authentication/euronext-authentication.yml
  title: ''
  type: Authentication
  url: authentication/euronext-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/euronext/refs/heads/main/errors/euronext-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/euronext-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/euronext/refs/heads/main/conformance/euronext-conformance.yml
  title: ''
  type: Conformance
  url: conformance/euronext-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/euronext/refs/heads/main/lifecycle/euronext-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/euronext-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/euronext/refs/heads/main/conventions/euronext-conventions.yml
  title: ''
  type: Conventions
  url: conventions/euronext-conventions.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/euronext/refs/heads/main/changelog/euronext-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/euronext-changelog.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/euronext/refs/heads/main/sandbox/euronext-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/euronext-sandbox.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/euronext/refs/heads/main/llms/euronext-llms.txt
  title: ''
  type: LLMsTxt
...
nav: Providers
network: true
overview: 'Euronext publishes 5 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include Finance, Market Data, Stocks, Exchange, and Real-Time.
