...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/fatcat/refs/heads/main/capabilities/fatcat-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/fatcat/refs/heads/main/agentic-access/fatcat-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/fatcat-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/fatcat/refs/heads/main/authentication/fatcat-authentication.yml
  title: ''
  type: Authentication
...
overview: 'Fatcat publishes 11 APIs on the [APIs.io](https://apis.io/) network, including auth API, changelog API, containers API, and 8 more. Tagged areas include Scholarly, Research, Academic, Open Access, and Bibliographic.
  ...
  Fatcat''s developer surface includes authentication and 5 more developer resources.'
plans:
- name: Plans
  plan_count: 1
  slug: plans
