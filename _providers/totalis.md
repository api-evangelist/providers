...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/totalis/refs/heads/main/overlays/totalis-rfq-overlay.yaml
  title: ''
  type: Overlay
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/totalis/refs/heads/main/llms/totalis-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/totalis-llms.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/totalis/refs/heads/main/authentication/totalis-authentication.yml
  title: ''
  type: Authentication
  url: authentication/totalis-authentication.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/totalis/refs/heads/main/mcp/totalis-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/totalis-mcp.yml
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/totalis/refs/heads/main/asyncapi/totalis-webhooks-asyncapi.yml
  title: ''
  type: AsyncAPI
...
- group: design
  ...
  url: asyncapi/totalis-webhooks-asyncapi.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/totalis/refs/heads/main/errors/totalis-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/totalis-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/totalis/refs/heads/main/conventions/totalis-conventions.yml
  title: ''
  type: Conventions
  url: conventions/totalis-conventions.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/totalis/refs/heads/main/rate-limits/totalis-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/totalis-rate-limits.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/totalis/refs/heads/main/lifecycle/totalis-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/totalis-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/totalis/refs/heads/main/conformance/totalis-conformance.yml
  title: ''
  type: Conformance
  url: conformance/totalis-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/totalis/refs/heads/main/data-model/totalis-data-model.yml
  title: ''
  type: DataModel
  url: data-model/totalis-data-model.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/totalis/refs/heads/main/security/totalis-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/totalis-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/totalis/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
