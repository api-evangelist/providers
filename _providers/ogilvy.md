...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ogilvy/refs/heads/main/security/ogilvy-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/ogilvy-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ogilvy/refs/heads/main/security/ogilvy-vulnerability-disclosure.yml
  title: ''
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ogilvy/refs/heads/main/llms/ogilvy-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/ogilvy-llms.txt
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/ogilvy/refs/heads/main/packages/ogilvy-packages.yml
  title: ''
  type: Packages
  url: packages/ogilvy-packages.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/ogilvy/refs/heads/main/plans/ogilvy-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/ogilvy-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/ogilvy/refs/heads/main/rate-limits/ogilvy-rate-limits.yml
  title: ''
  type: RateLimits
...
- group: company
  title: ''
  type: Blog
  url: https://www.ogilvy.com/ideas
- group: company
  title: ''
  type: Website
...
- group: company
  title: ''
  type: About
  url: https://www.ogilvy.com/about
- group: other
  title: ''
  type: Work
  url: https://www.ogilvy.com/work
- group: other
  title: ''
  type: Capabilities
  url: https://www.ogilvy.com/capabilities
- group: other
  title: ''
  type: Ideas
  url: https://www.ogilvy.com/ideas
...
- group: other
  title: ''
  type: ParentProfile
  url: https://www.wpp.com/en/companies/ogilvy
- group: other
  title: ''
  type: SubBrand
  url: https://www.ogilvy.com/capabilities/pr-influence
- group: other
  title: ''
  type: SubBrand
  url: https://www.ogilvy.com/capabilities/health
- group: other
  title: ''
  type: SubBrand
  url: https://www.ogilvy.com/capabilities/consulting
- group: other
  title: ''
  type: SubBrand
  url: https://www.ogilvy.com/capabilities/relationship-design
- group: other
  title: ''
  type: SubBrand
  url: https://www.ogilvy.com/capabilities/advertising
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/ogilvy
- group: other
  title: ''
  type: Wikipedia
  url: https://en.wikipedia.org/wiki/Ogilvy_(agency)
- group: other
  title: Borderless Creativity
  type: Tagline
  url: ''
- group: other
  title: Ogilvy inspires brands and people to impact the world.
  type: Positioning
  url: ''
- group: other
...
- group: other
  ...
  url: ''
- group: other
  title: ~132 offices / 83 countries (per ogilvy.com/about); 128 offices / 88 countries (per wpp.com)
  type: Scale
  url: ''
- group: other
  title: ~17,500 (per Wikipedia, as of 2022)
  type: Employees
  url: ''
- group: other
  title: Laurent Ezekiel — Global Chief Executive Officer
  type: CEO
  url: ''
- group: other
  title: Liz Taylor — Global Chief Creative Officer
  type: Leadership
  url: ''
- group: other
  title: Mick McCabe — Global Chief Strategy Officer
  type: Leadership
  url: ''
- group: other
  title: Julianna Richter — Global CEO, Public Relations & Influence
  type: Leadership
  url: ''
- group: other
  title: Mario Muredda — Global CEO, Ogilvy Health
  type: Leadership
  url: ''
- group: other
  title: Clare Lawson — Global President & EMEA CEO, OgilvyOne
  type: Leadership
  url: ''
- group: other
  title: Cannes Lions Network of the Year (2022, 2024)
  type: Award
  url: ''
- group: other
  title: D&AD Network of the Year (2020)
  type: Award
  url: ''
- group: other
  title: The One Show — Network of the Year (2026)
  type: Award
  url: ''
- group: build
  title: Coca-Cola
  ...
  url: ''
- group: build
  title: Unilever (Dove, Vaseline, Hellmann's)
  type: NotableClient
  url: ''
- group: build
  title: IKEA
...
- group: build
  ...
  url: ''
- group: other
  title: Dove — "Campaign for Real Beauty" (2004)
  type: NotableCampaign
  url: ''
- group: other
  title: IBM — "Solutions for a Small Planet" (1994)
  type: NotableCampaign
  url: ''
- group: other
  title: American Express — "Do You Know Me?" (1974)
  type: NotableCampaign
  url: ''
- group: other
  title: Hathaway — "The Man in the Hathaway Shirt" (1951)
  type: NotableCampaign
  url: ''
- group: other
  title: India Tourism — "Incredible !ndia" (2002)
  type: NotableCampaign
  url: ''
- group: other
  title: Vaseline — "Vaseline Verified" (D&AD 2026, Ogilvy Singapore)
  type: NotableCampaign
  url: ''
- group: other
  title: Coca-Cola — "The Devil Wears Prada 2" (Diet Coke integration)
  type: NotableCampaign
  url: ''
- group: start
