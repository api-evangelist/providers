...
- group: auth
  ...
  title: ''
  type: DomainSecurity
  url: security/level-frames-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/level-frames/refs/heads/main/llms/level-frames-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/level-frames-llms.txt
- group: company
  title: ''
  type: Website
  url: https://www.levelframes.com/
- group: company
  title: ''
  type: Blog
  url: https://www.levelframes.com/blog
- group: operate
  title: ''
  type: Support
  url: https://help.levelframes.com/
- group: operate
  title: ''
  type: HelpCenter
  url: https://help.levelframes.com/
- group: commercial
  title: ''
  type: Pricing
  url: https://www.levelframes.com/pricing
- group: start
  title: ''
  type: SignUp
  url: https://www.levelframes.com/join
- group: start
  title: ''
  type: Login
  url: https://www.levelframes.com/magic_links/new
- group: commercial
  title: ''
  type: TermsOfService
  url: https://help.levelframes.com/placing-an-order/terms-of-service
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://help.levelframes.com/level-accounts/privacy-policy
created: '2026-07-17'
...
nav: Providers
network: true
overview: 'Level Frames is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Custom Framing, Art, Photo Printing, and Home Decor.
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/level-frames/refs/heads/main/screenshots/level-frames-2026-07-25T224943.png
security:
