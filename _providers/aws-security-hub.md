...
- baseURL: https://securityhub.{region}.amazonaws.com
  ...
  name: AWS Security Hub Integrations API
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/aws-security-hub/refs/heads/main/agentic-access/aws-security-hub-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/aws-security-hub-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/aws-security-hub/refs/heads/main/security/aws-security-hub-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/aws-security-hub-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/aws-security-hub/refs/heads/main/security/aws-security-hub-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/aws-security-hub-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/aws-security-hub/refs/heads/main/security/aws-security-hub-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/aws-security-hub-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/aws-security-hub/refs/heads/main/authentication/aws-security-hub-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'AWS Security Hub publishes 13 APIs on the [APIs.io](https://apis.io/) network, including Action Targets API, Automation Rules API, Configuration Policies API, and 10 more. Tagged areas include Security, Cloud Security Posture Management, Compliance, Findings, and Threat Detection.
