...
- group: company
  ...
  url: https://usda.gov
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/usda-agricultural-research-service-ars-/refs/heads/main/agentic-access/usda-agricultural-research-service-ars--agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/usda-agricultural-research-service-ars--agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/usda-agricultural-research-service-ars-/refs/heads/main/security/usda-agricultural-research-service-ars--domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/usda-agricultural-research-service-ars--domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/usda-agricultural-research-service-ars-/refs/heads/main/authentication/usda-agricultural-research-service-ars--authentication.yml
  title: ''
  type: Authentication
...
overview: 'USDA Agricultural Research Service (ARS) publishes 3 APIs on the [APIs.io](https://apis.io/) network: Datasets API, Food Search API, and Foods API. Tagged areas include Federal Government, Agriculture, Food Safety, Nutrition, and Open Data.
  ...
  USDA Agricultural Research Service (ARS)''s developer surface includes authentication, engineering blog, and 4 more developer resources.'
plans:
