...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/kserve/refs/heads/main/agentic-access/kserve-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/kserve-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/kserve/refs/heads/main/authentication/kserve-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'KServe publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Health API, Inference Protocol API, Models API, and 1 more. Tagged areas include Inference, Kubernetes, Machine Learning, MLOps, and Model Serving.
