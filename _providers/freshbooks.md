...
- baseURL: https://api.freshbooks.com
  baseurl_source: declared
  description: The Time Entries API from FreshBooks — 1 operation(s) for time entries.
  name: FreshBooks Time Entries API
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/freshbooks/refs/heads/main/agentic-access/freshbooks-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/freshbooks-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/freshbooks/refs/heads/main/security/freshbooks-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/freshbooks-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/freshbooks/refs/heads/main/authentication/freshbooks-authentication.yml
  title: ''
  type: Authentication
