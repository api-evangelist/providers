...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/alloplex-biotherapeutics/refs/heads/main/overlays/alloplex-biotherapeutics-content-overlay.yaml
  title: ''
  type: Overlay
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/alloplex-biotherapeutics/refs/heads/main/authentication/alloplex-biotherapeutics-authentication.yml
  title: ''
  type: Authentication
  url: authentication/alloplex-biotherapeutics-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/alloplex-biotherapeutics/refs/heads/main/conventions/alloplex-biotherapeutics-conventions.yml
  title: ''
  type: Conventions
  url: conventions/alloplex-biotherapeutics-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/alloplex-biotherapeutics/refs/heads/main/conformance/alloplex-biotherapeutics-conformance.yml
  title: ''
  type: Conformance
  url: conformance/alloplex-biotherapeutics-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/alloplex-biotherapeutics/refs/heads/main/errors/alloplex-biotherapeutics-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/alloplex-biotherapeutics-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/alloplex-biotherapeutics/refs/heads/main/lifecycle/alloplex-biotherapeutics-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/alloplex-biotherapeutics-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/alloplex-biotherapeutics/refs/heads/main/data-model/alloplex-biotherapeutics-data-model.yml
  title: ''
  type: DataModel
  url: data-model/alloplex-biotherapeutics-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/alloplex-biotherapeutics/refs/heads/main/json-ld/alloplex-biotherapeutics-json-ld.yml
  title: ''
  type: JSONLD
  url: json-ld/alloplex-biotherapeutics-json-ld.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/alloplex-biotherapeutics/refs/heads/main/well-known/alloplex-biotherapeutics-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/alloplex-biotherapeutics-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/alloplex-biotherapeutics/refs/heads/main/security/alloplex-biotherapeutics-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/alloplex-biotherapeutics-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/alloplex-biotherapeutics/refs/heads/main/llms/alloplex-biotherapeutics-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/alloplex-biotherapeutics-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/alloplex-biotherapeutics/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
