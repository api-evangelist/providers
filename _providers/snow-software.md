...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/snow-software/refs/heads/main/capabilities/snow-software-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/snow-software-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/snow-software/refs/heads/main/agentic-access/snow-software-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/snow-software-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/snow-software/refs/heads/main/security/snow-software-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/snow-software-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/snow-software/refs/heads/main/authentication/snow-software-authentication.yml
  title: ''
  type: Authentication
  url: authentication/snow-software-authentication.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/snow-software-ab
- group: company
  title: ''
  type: Website
...
examples:
- key_count: 4
  name: Snow Software Get Saas Applications Example
  slug: snow-software-get-saas-applications-example
finops:
- name: Snow Software Finops
  service_category: Software Asset Management
  slug: snow-software-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/snow-software.png
json_schemas:
- name: Snow Atlas Software License
  property_count: 17
  slug: snow-software-license
- name: Snow Atlas SaaS Application
  property_count: 14
  slug: snow-software-saas-application
json_structures:
- name: Snow Software Atlas Structure
  property_count: 0
  slug: snow-software-atlas-structure
jsonld:
- class_count: 6
...
nav: Providers
network: true
overview: 'Snow Software publishes 31 APIs on the [APIs.io](https://apis.io/) network, including Applications API, Assignments API, Compliance API, and 28 more. Tagged areas include Cloud License Management, FinOps, IT Asset Management, SaaS Management, and Software Asset Management.
...
- limit_count: 1
  ...
  slug: snow-software-rate-limits
rules:
- effective_rule_count: 5
  ...
  severity_counts:
    ...
    info: 2
    warn: 3
  slug: snow-software-jsonschema-spectral-rules
