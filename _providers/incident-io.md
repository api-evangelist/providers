...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/incident-io/refs/heads/main/agentic-access/incident-io-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/incident-io-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/incident-io/refs/heads/main/security/incident-io-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/incident-io-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/incident-io/refs/heads/main/security/incident-io-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/incident-io-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/incident-io/refs/heads/main/security/incident-io-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/incident-io-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/incident-io/refs/heads/main/authentication/incident-io-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Incident.io publishes 25 APIs on the [APIs.io](https://apis.io/) network, including Actions API, Alert Attributes API, Alert Routes API, and 22 more. Tagged areas include AIOps, Incident Management, and Monitoring.
