...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/spring-cloud-gateway/refs/heads/main/agentic-access/spring-cloud-gateway-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/spring-cloud-gateway-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spring-cloud-gateway/refs/heads/main/security/spring-cloud-gateway-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/spring-cloud-gateway-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spring-cloud-gateway/refs/heads/main/security/spring-cloud-gateway-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/spring-cloud-gateway/refs/heads/main/vocabulary/spring-cloud-gateway-vocabulary.yml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'Spring Cloud Gateway publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Filters API, Predicates API, Routes API, and 1 more. Tagged areas include API Gateway, Circuit Breaker, Load Balancing, Microservices, and Rate Limiting.
