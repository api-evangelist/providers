...
- group: commercial
  title: ''
  type: Pricing
  url: https://www.orderdesk.com/pricing/
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/orderdesk/refs/heads/main/capabilities/orderdesk-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/orderdesk-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/orderdesk/refs/heads/main/agentic-access/orderdesk-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/orderdesk-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/orderdesk/refs/heads/main/security/orderdesk-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/orderdesk-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/orderdesk/refs/heads/main/authentication/orderdesk-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/orderdesk/refs/heads/main/plans/orderdesk-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/orderdesk-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/orderdesk/refs/heads/main/rate-limits/orderdesk-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/orderdesk-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/orderdesk/refs/heads/main/finops/orderdesk-finops.yml
  title: ''
  type: FinOps
...
overview: 'Order Desk publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Inventory Items API, Order Items API, Orders API, and 2 more. Tagged areas include E-Commerce, Order Management, Fulfillment, Dropshipping, and Inventory.
  ...
  Order Desk''s developer surface includes pricing, authentication, documentation, and 8 more developer resources.'
plans:
- name: Orderdesk Plans Pricing
  plan_count: 3
  slug: orderdesk-plans-pricing
- name: Orderdesk Price Estimates
  plan_count: 0
  slug: orderdesk-price-estimates
random_paper: 17
rate_limits:
- limit_count: 3
