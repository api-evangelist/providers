...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/penpot/refs/heads/main/capabilities/penpot-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/penpot-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/penpot/refs/heads/main/agentic-access/penpot-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/penpot-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/penpot/refs/heads/main/security/penpot-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/penpot-domain-security.yml
- group: company
  title: ''
  type: Website
...
- group: company
  href: https://raw.githubusercontent.com/api-evangelist/penpot/refs/heads/main/blogs/blogs.json
  title: ''
  type: BlogFeed
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/penpot/refs/heads/main/plans/penpot-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/penpot-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/penpot/refs/heads/main/rate-limits/penpot-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/penpot-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/penpot/refs/heads/main/finops/penpot-finops.yml
  title: ''
  type: FinOps
...
examples:
- key_count: 4
  name: Penpot Request Examples
  slug: penpot-request-examples
finops:
- name: Penpot Finops
  service_category: ''
  slug: penpot-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/penpot.png
json_schemas:
- name: Penpot API Schemas
  property_count: 0
  slug: penpot-schemas
jsonld:
- class_count: 23
...
- name: Penpot Price Estimates
  plan_count: 0
  slug: penpot-price-estimates
random_paper: 2
rate_limits:
- limit_count: 0
  name: Penpot Rate Limits
  slug: penpot-rate-limits
rules:
- effective_rule_count: 6
  extends: []
  name: Penpot API Rules
  rule_count: 6
  severity_counts:
    error: 0
    hint: 0
