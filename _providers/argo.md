...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/argo/refs/heads/main/agentic-access/argo-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/argo-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/argo/refs/heads/main/security/argo-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/argo-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/argo/refs/heads/main/authentication/argo-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/argo/refs/heads/main/json-ld/argo-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/argo-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/argo/refs/heads/main/rules/argo-spectral-rules.yml
  title: ''
  type: SpectralRules
  url: rules/argo-spectral-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/argo/refs/heads/main/vocabulary/argo-vocabulary.yaml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'Argo publishes 14 APIs on the [APIs.io](https://apis.io/) network, including Events API, Applications API, Clusters API, and 11 more. Tagged areas include CNCF, CI/CD, GitOps, Kubernetes, and Open Source.
