...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/wikisource/refs/heads/main/agentic-access/wikisource-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/wikisource-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/wikisource/refs/heads/main/security/wikisource-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/wikisource-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/wikisource/refs/heads/main/security/wikisource-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/wikisource/refs/heads/main/plans/wikisource-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/wikisource-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/wikisource/refs/heads/main/rate-limits/wikisource-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/wikisource-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/wikisource/refs/heads/main/finops/wikisource-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Wikisource publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Citation API, Math API, Mobile API, and 7 more. Tagged areas include Open Data, Open Knowledge, Literature, Historical Documents, and Public Domain.
