...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/interpublic/refs/heads/main/security/interpublic-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/interpublic-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/interpublic/refs/heads/main/authentication/interpublic-authentication.yml
  title: ''
  type: Authentication
  url: authentication/interpublic-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/interpublic/refs/heads/main/conventions/interpublic-conventions.yml
  title: ''
  type: Conventions
  url: conventions/interpublic-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/interpublic/refs/heads/main/conformance/interpublic-conformance.yml
  title: ''
  type: Conformance
  url: conformance/interpublic-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/interpublic/refs/heads/main/errors/interpublic-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/interpublic-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/interpublic/refs/heads/main/lifecycle/interpublic-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/interpublic-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/interpublic/refs/heads/main/data-model/interpublic-data-model.yml
  title: ''
  type: DataModel
  url: data-model/interpublic-data-model.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/interpublic/refs/heads/main/packages/interpublic-packages.yml
  title: ''
  type: Packages
  url: packages/interpublic-packages.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/interpublic/refs/heads/main/rate-limits/interpublic-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/interpublic-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/interpublic/refs/heads/main/plans/interpublic-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/interpublic-plans-pricing.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/interpublic/refs/heads/main/llms/interpublic-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/interpublic-llms.txt
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/interpublic/refs/heads/main/overlays/interpublic-wp-rest-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/interpublic-wp-rest-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/interpublic/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
