...
- group: other
  title: ''
  type: ParentCompany
  url: https://apis.io/providers/ovh-cloud/
- group: company
  title: ''
  type: Website
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/openio/refs/heads/main/authentication/openio-authentication.yml
  title: ''
  type: Authentication
  url: authentication/openio-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/openio/refs/heads/main/conformance/openio-conformance.yml
  title: ''
  type: Conformance
  url: conformance/openio-conformance.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/openio/refs/heads/main/cli/openio-cli.yml
  title: ''
  type: CLI
  url: cli/openio-cli.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/openio/refs/heads/main/packages/openio-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/openio-packages.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/openio/refs/heads/main/lifecycle/openio-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/openio-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/openio/refs/heads/main/conventions/openio-conventions.yml
  title: ''
  type: Conventions
  url: conventions/openio-conventions.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/openio/refs/heads/main/llms/openio-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/openio-llms.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/openio/refs/heads/main/security/openio-domain-security.yml
  title: ''
  type: DomainSecurity
...
overview: 'OpenIO publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Infrastructure Saas, Object Storage, S3, and Cloud Storage.
  ...
  OpenIO''s developer surface includes documentation, API reference, getting-started guide, authentication, CLI, and 10 more developer resources.'
random_paper: 12
score:
  band: emerging
  composite: 17.3
