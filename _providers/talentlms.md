...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/talentlms/refs/heads/main/capabilities/talentlms-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/talentlms/refs/heads/main/agentic-access/talentlms-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/talentlms-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/talentlms/refs/heads/main/security/talentlms-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/talentlms-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/talentlms/refs/heads/main/authentication/talentlms-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/talentlms/refs/heads/main/plans/talentlms-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/talentlms-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/talentlms/refs/heads/main/rate-limits/talentlms-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/talentlms-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/talentlms/refs/heads/main/finops/talentlms-finops.yml
  title: ''
  type: FinOps
...
overview: 'TalentLMS publishes 12 APIs on the [APIs.io](https://apis.io/) network, including Batch Actions API, Branch API, and 10 more. Tagged areas include Learning Management System, LMS, E-Learning, Training, and Courses.
  ...
  TalentLMS''s developer surface includes authentication, developer portal, documentation, pricing, engineering blog, release notes, support, and 12 more developer resources.'
plans:
