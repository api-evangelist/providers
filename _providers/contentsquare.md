...
- collection_type: open
  name: Contentsquare Data Export Authentication API
  slug: open-contentsquare-authentication-api
- collection_type: open
  name: Contentsquare Data Export Authentication Exports API
  slug: open-contentsquare-exports-api
- collection_type: open
  name: Contentsquare Data Export Authentication Fields API
  slug: open-contentsquare-fields-api
- collection_type: open
  name: Contentsquare Data Export Authentication Runs API
  slug: open-contentsquare-runs-api
- collection_type: open
  name: Contentsquare Data Export API
  slug: open-contentsquare
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/contentsquare/refs/heads/main/agentic-access/contentsquare-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/contentsquare-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/contentsquare/refs/heads/main/security/contentsquare-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/contentsquare-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/contentsquare/refs/heads/main/security/contentsquare-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/contentsquare-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/contentsquare/refs/heads/main/security/contentsquare-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/contentsquare-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/contentsquare/refs/heads/main/authentication/contentsquare-authentication.yml
  title: ''
  type: Authentication
