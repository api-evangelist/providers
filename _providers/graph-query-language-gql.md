...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/graph-query-language-gql/refs/heads/main/security/graph-query-language-gql-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/graph-query-language-gql-domain-security.yml
- group: start
  title: ''
  type: Portal
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/graph-query-language-gql/refs/heads/main/graph-query-language-gql-rules.yml
  title: ''
  type: Rules
...
nav: Providers
network: true
overview: 'Graph Query Language (GQL) is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Database, Graph Database, ISO Standard, Query Language, and Standards.
