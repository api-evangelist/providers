...
- group: start
  ...
  url: https://docs.gumloop.com/api-reference/getting-started
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/gumloop/refs/heads/main/authentication/gumloop-authentication.yml
  title: ''
  type: Authentication
  url: authentication/gumloop-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/gumloop/refs/heads/main/scopes/gumloop-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/gumloop-scopes.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/gumloop/refs/heads/main/packages/gumloop-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/gumloop-packages.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/gumloop/refs/heads/main/cli/gumloop-cli.yml
  title: ''
  type: CLI
  url: cli/gumloop-cli.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/gumloop/refs/heads/main/mcp/gumloop-mcp.yml
  title: ''
  type: MCPServer
  url: mcp/gumloop-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/gumloop/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/gumloop/refs/heads/main/well-known/gumloop-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/gumloop-well-known.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/gumloop/refs/heads/main/llms/gumloop-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/gumloop-llms.txt
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/gumloop/refs/heads/main/conventions/gumloop-conventions.yml
  title: ''
  type: Conventions
  url: conventions/gumloop-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/gumloop/refs/heads/main/errors/gumloop-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/gumloop-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/gumloop/refs/heads/main/data-model/gumloop-data-model.yml
  title: ''
  type: DataModel
  url: data-model/gumloop-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/gumloop/refs/heads/main/conformance/gumloop-conformance.yml
  title: ''
  type: Conformance
  url: conformance/gumloop-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/gumloop/refs/heads/main/lifecycle/gumloop-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/gumloop/refs/heads/main/changelog/gumloop-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/gumloop-changelog.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/gumloop/refs/heads/main/asyncapi/gumloop-webhooks.yml
  title: ''
  type: Webhooks
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/gumloop/refs/heads/main/security/gumloop-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/gumloop-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/gumloop/refs/heads/main/agentic-access/gumloop-agentic-access.yml
  title: ''
  type: AgenticAccess
