...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cat/refs/heads/main/agentic-access/cat-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/cat-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cat/refs/heads/main/security/cat-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'CAT publishes 2 APIs on the [APIs.io](https://apis.io/) network: Caterpillar Telematics API and Equipment API. Tagged areas include Construction, Engines, Equipment, Heavy Equipment, and Locomotives.
