...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/roundys/refs/heads/main/security/roundys-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/roundys/refs/heads/main/vocabulary/roundys-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/roundys-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/roundys/refs/heads/main/json-ld/roundys-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/roundys-context.jsonld
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/roundys/refs/heads/main/json-schema/roundys-store-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/roundys-store-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/roundys/refs/heads/main/json-structure/roundys-store-structure.json
  title: ''
  type: JSONStructure
...
nav: Providers
network: true
overview: 'Roundy''s publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Kroger Product Catalog API, and 3 more. Tagged areas include Grocery, Kroger, Midwest, Retail, and Supermarket.
