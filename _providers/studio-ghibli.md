...
- group: operate
  title: ''
  type: IssueTracker
  url: https://github.com/janaipakos/ghibliapi/issues
- group: docs
  title: ''
  type: ContributionGuide
  url: https://github.com/janaipakos/ghibliapi/blob/master/CONTRIBUTING.md
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/studio-ghibli/refs/heads/main/agentic-access/studio-ghibli-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/studio-ghibli-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/studio-ghibli/refs/heads/main/security/studio-ghibli-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/studio-ghibli/refs/heads/main/json-ld/studio-ghibli-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/studio-ghibli-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/studio-ghibli/refs/heads/main/rules/studio-ghibli-rules.yml
  title: ''
  type: SpectralRules
  url: rules/studio-ghibli-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/studio-ghibli/refs/heads/main/vocabulary/studio-ghibli-vocabulary.yml
  title: ''
  type: Vocabulary
...
overview: 'Studio Ghibli publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Films API, Locations API, People API, and 2 more. Tagged areas include Anime, Studio Ghibli, Film, Characters, and Location.
  ...
  Studio Ghibli''s developer surface includes code examples and 20 more developer resources.'
plans:
