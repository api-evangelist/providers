...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/capabilities/canvas-medical-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/canvas-medical-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/agentic-access/canvas-medical-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/canvas-medical-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/security/canvas-medical-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/canvas-medical-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/authentication/canvas-medical-authentication.yml
  title: ''
  type: Authentication
  url: authentication/canvas-medical-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/scopes/canvas-medical-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/plans/canvas-medical-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/canvas-medical-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/rate-limits/canvas-medical-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/canvas-medical-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/finops/canvas-medical-finops.yml
  title: ''
  type: FinOps
...
- group: design
  ...
  url: ''
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/packages/canvas-medical-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/canvas-medical-packages.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/cli/canvas-medical-cli.yml
  title: ''
  type: CLI
  url: cli/canvas-medical-cli.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/components/canvas-medical-components.yml
  title: ''
  type: Components
  url: components/canvas-medical-components.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/well-known/canvas-medical-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/canvas-medical-well-known.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/well-known/canvas-medical-fhir-service-base-urls-production.json
  title: ''
  type: APICatalog
  url: well-known/canvas-medical-fhir-service-base-urls-production.json
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/llms/canvas-medical-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/canvas-medical-llms.txt
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/overlays/canvas-medical-fhir-api-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/canvas-medical-fhir-api-overlay.yaml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/grpc/canvas-medical-events.proto
  title: ''
  type: Protobuf
  url: grpc/canvas-medical-events.proto
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/grpc/canvas-medical-effects.proto
  title: ''
  type: Protobuf
  url: grpc/canvas-medical-effects.proto
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/conformance/canvas-medical-conformance.yml
  title: ''
  type: Conformance
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/errors/canvas-medical-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/canvas-medical-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/lifecycle/canvas-medical-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/conventions/canvas-medical-conventions.yml
  title: ''
  type: Conventions
  url: conventions/canvas-medical-conventions.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/changelog/canvas-medical-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/canvas-medical-changelog.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/data-model/canvas-medical-data-model.yml
  title: ''
  type: DataModel
  url: data-model/canvas-medical-data-model.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/sandbox/canvas-medical-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/canvas-medical-sandbox.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/asyncapi/canvas-medical-events-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/canvas-medical-events-webhooks.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/canvas-medical/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
