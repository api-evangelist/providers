...
- group: other
  title: ''
  type: Mobile App (iOS)
  url: https://apps.apple.com/us/app/cinemark-theatres/id383036269
- group: other
  title: ''
...
- group: commercial
  title: ''
  type: TermsOfService
  url: https://www.cinemark.com/terms-of-use
- group: operate
  title: ''
  type: Support
...
overview: 'Cinemark Holdings is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Cinema, Entertainment, Loyalty, Movie Theaters, and Ticketing.
  ...
  Cinemark Holdings'' developer surface includes support and 11 more developer resources.'
press:
- date: '2026-05-25'
