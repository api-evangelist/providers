...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/btcpay/refs/heads/main/capabilities/btcpay-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/btcpay/refs/heads/main/agentic-access/btcpay-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/btcpay-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/btcpay/refs/heads/main/security/btcpay-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/btcpay-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/btcpay/refs/heads/main/authentication/btcpay-authentication.yml
  title: ''
  type: Authentication
  url: authentication/btcpay-authentication.yml
- group: company
  title: ''
  type: Website
...
- group: company
  title: ''
  type: Twitter
  url: https://twitter.com/btcpayserver
- group: learn
  title: ''
  type: YouTube
  url: https://www.youtube.com/c/BTCPayServer
- group: operate
  title: ''
  type: ChangeLog
...
- group: operate
  title: ''
  type: StatusPage
  url: https://status.btcpayserver.org
- group: operate
  title: ''
  type: Support
  url: https://docs.btcpayserver.org/Support/
- group: commercial
  title: ''
  type: License
...
- group: other
  title: ''
  type: Contributing
  url: https://github.com/btcpayserver/btcpayserver/blob/master/CONTRIBUTING.md
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://btcpayserver.org/privacy-policy/
created: '2026-06-13'
description: BTCPay Server is a self-hosted, open-source Bitcoin and cryptocurrency payment processor with a comprehensive REST API (Greenfield API v1) for managing stores, invoices, wallets, Lightning Network nodes, payment requests, pull payments, webhooks, users, and server configuration. It operates with zero fees, no third-party dependency, and is released under the MIT license.
finops:
- name: Finops
  service_category: ''
  slug: finops
image: https://btcpayserver.org/images/btcpay-logo.svg
layout: provider
modified: '2026-06-13'
name: BTCPay Server
nav: Providers
