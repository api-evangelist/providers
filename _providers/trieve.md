...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/trieve/refs/heads/main/agentic-access/trieve-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/trieve-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/trieve/refs/heads/main/security/trieve-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/trieve-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/trieve/refs/heads/main/authentication/trieve-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Trieve publishes 21 APIs on the [APIs.io](https://apis.io/) network, including Chunk API, Dataset API, File API, and 18 more. Tagged areas include Search, RAG, Vector Search, Hybrid Search, and Recommendations.
