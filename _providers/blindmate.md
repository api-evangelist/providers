...
- group: company
  title: ''
  type: Website
  url: https://blindmate.app
- group: company
  title: ''
  type: Blog
  url: https://medium.com/@jasmine_blindmate
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://blindmate.de/app-privacy-en
- group: commercial
  title: ''
  type: TermsOfService
  url: https://blindmate.de/app-agb-en
- group: operate
  title: ''
  type: Support
  url: mailto:team@blindmate.de
- group: start
  title: ''
  type: SignUp
  url: https://apps.apple.com/de/app/blindmate-friends-dating/id1547219764
- group: auth
  title: ''
  type: Security
  url: https://blindmate.de/hacker-policies/
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/blindmate/refs/heads/main/security/blindmate-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/blindmate-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/blindmate/refs/heads/main/security/blindmate-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/blindmate-domain-security.yml
created: '2026-07-17'
description: 'Blindmate is a friend-based dating app that inverts the swipe model: instead of writing their own profile, a single person''s friends answer questions about them, and matches are made through character-first "Blindchats" that surface compatibility before appearance. Founded in Germany and available on iOS and Android in German, English, and Spanish, the app reports over one million users and positions itself around trust, reduced harassment, data privacy, and green-energy infrastructure. Blindmate is a Speedinvest portfolio company; it is a consumer mobile product and publishes no public developer API, so this profile captures its web, security, and policy surface rather than API artifacts.'
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/blindmate.png
layout: provider
modified: '2026-07-18'
name: Blindmate
nav: Providers
...
- kind: domain-security
  ...
  slug: blindmate-domain-security
  summary_line: TLSv1.3
- kind: vulnerability-disclosure
  name: Blindmate Vulnerability Disclosure
  slug: blindmate-vulnerability-disclosure
