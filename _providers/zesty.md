...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/zesty/refs/heads/main/agentic-access/zesty-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/zesty-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/zesty/refs/heads/main/security/zesty-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/zesty-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/zesty/refs/heads/main/authentication/zesty-authentication.yml
  title: ''
  type: Authentication
...
overview: 'Zesty publishes 13 APIs on the [APIs.io](https://apis.io/) network, including Instances API, Apps API, Authentication API, and 10 more. Tagged areas include CMS, Composable, Content Management, GraphQL, and Headless CMS.
  ...
  Zesty''s developer surface includes authentication, documentation, engineering blog, support, GitHub presence, and 8 more developer resources.'
plans:
