...
- acting_count: 18
  human_in_the_loop: 0
  name: Recraft Ai Agentic Access
  operation_count: 19
  slug: recraft-ai-agentic-access
...
- collection_type: open
  name: Recraft Images API
  slug: open-recraft-ai-images-api
- collection_type: open
  name: Recraft Images Prompts API
  slug: open-recraft-ai-prompts-api
- collection_type: open
  name: Recraft Images Styles API
  slug: open-recraft-ai-styles-api
- collection_type: open
  name: Recraft Images Users API
  slug: open-recraft-ai-users-api
- collection_type: open
  name: Recraft Images API
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/recraft-ai/refs/heads/main/agentic-access/recraft-ai-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/recraft-ai-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/recraft-ai/refs/heads/main/security/recraft-ai-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/recraft-ai-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/recraft-ai/refs/heads/main/security/recraft-ai-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/recraft-ai-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/recraft-ai/refs/heads/main/security/recraft-ai-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/recraft-ai-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/recraft-ai/refs/heads/main/authentication/recraft-ai-authentication.yml
  title: ''
  type: Authentication
  url: authentication/recraft-ai-authentication.yml
- group: start
  title: ''
  type: Portal
  url: https://www.recraft.ai
...
finops:
- name: Recraft Ai Finops
  service_category: AI and Machine Learning
  slug: recraft-ai-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/recraft-ai.png
json_schemas:
- name: Recraft Image
  property_count: 11
  slug: recraft-image
...
jsonld:
- class_count: 31
  name: Recraft Ai Context
  property_count: 3
  slug: recraft-ai-context
layout: provider
modified: '2026-05-25'
name: Recraft
nav: Providers
...
- limit_count: 2
  ...
  slug: recraft-ai-rate-limits
rules:
- effective_rule_count: 5
  extends: []
  name: Recraft API Rules
  rule_count: 5
  severity_counts:
    error: 0
    hint: 0
...
- kind: vulnerability-disclosure
  name: Recraft Ai Vulnerability Disclosure
  slug: recraft-ai-vulnerability-disclosure
  summary_line: security.txt · contact published
- kind: trust-center
  name: Recraft Ai Trust Center
  slug: recraft-ai-trust-center
