...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''http://www.zenaton.com'', ''status'': 301, ''note'': ''declared website redirects to https://gillesbarbier.dev/ — a different registrable domain (zenaton.com -> gillesbarbier.dev), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
- group: company
  title: ''
  type: Website
  url: http://www.zenaton.com
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/zenaton
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/zenaton/refs/heads/main/packages/zenaton-packages.yml
  title: ''
  type: Packages
  url: packages/zenaton-packages.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/zenaton/refs/heads/main/packages/zenaton-packages.yml
  title: ''
  type: SDKs
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/zenaton/refs/heads/main/screenshots/zenaton-2026-09-02T171556.png
slug: zenaton
tags:
- Company
