...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Actions API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Agents API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Applications API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Business Batches API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Businesses API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Companies API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Connections API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Documents API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Identities API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Information Requests API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Jurisdictions API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Liens API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Lien Terminations API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Mail API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Monitoring API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Orders API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Policy Results API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Prefill API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Questions API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Registration Requests API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Threads API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Timeline API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Tin Match API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Webhooks API
...
- baseURL: https://api.middesk.com/v1/
  ...
  name: Middesk Subpackage Websites API
...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/middesk/refs/heads/main/capabilities/middesk-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/middesk-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/middesk/refs/heads/main/agentic-access/middesk-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/middesk-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/middesk/refs/heads/main/security/middesk-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/middesk-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/middesk/refs/heads/main/authentication/middesk-authentication.yml
  title: ''
  type: Authentication
  url: authentication/middesk-authentication.yml
- group: company
  title: ''
  type: Website
...
- group: docs
  title: ''
  type: Documentation
  url: https://docs.middesk.com
- group: build
  title: ''
  type: GitHubOrg
  url: https://github.com/middesk
- group: company
  title: ''
  type: LinkedIn
...
- group: company
  title: ''
  type: Blog
  url: https://www.middesk.com/blog
- group: commercial
  title: ''
  type: Pricing
  url: https://www.middesk.com/pricing/business-onboarding
- group: operate
  title: ''
  type: StatusPage
  url: https://status.middesk.com
- group: other
  title: ''
  type: X
  url: https://x.com/middeskhq
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/middesk/refs/heads/main/plans/middesk-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/middesk-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/middesk/refs/heads/main/rate-limits/middesk-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/middesk-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/middesk/refs/heads/main/finops/middesk-finops.yml
  title: ''
  type: FinOps
  url: finops/middesk-finops.yml
created: 2026-06-13
description: Middesk is a business identity and verification platform providing a REST API for KYB (Know Your Business) compliance, EIN/TIN validation, business registration verification, UBO research, sanctions screening, and ongoing business monitoring. Used by fintechs, lenders, and banks to automate onboarding and compliance workflows.
examples:
- key_count: 4
  name: Middesk Create Business Example
  slug: middesk-create-business-example
- key_count: 4
  name: Middesk Create Order Example
  slug: middesk-create-order-example
- key_count: 4
  name: Middesk Create Webhook Example
  slug: middesk-create-webhook-example
- key_count: 4
  name: Middesk File Lien Example
  slug: middesk-file-lien-example
- key_count: 4
  name: Middesk Get Business Example
  slug: middesk-get-business-example
- key_count: 4
  name: Middesk List Businesses Example
  slug: middesk-list-businesses-example
- key_count: 4
  name: Middesk Screen Signal Example
  slug: middesk-screen-signal-example
finops:
- name: Middesk Finops
  service_category: ''
  slug: middesk-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/middesk.png
json_schemas:
- name: Action
  property_count: 9
  slug: action
...
- effective_rule_count: 5
  ...
  severity_counts:
    ...
    info: 1
    warn: 4
  slug: middesk-jsonschema-spectral-rules
score:
  band: developing
  composite: 43.1
  coverage:
