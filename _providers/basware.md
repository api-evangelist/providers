...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/basware/refs/heads/main/capabilities/basware-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/basware-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/basware/refs/heads/main/agentic-access/basware-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/basware-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/basware/refs/heads/main/security/basware-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/basware-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/basware/refs/heads/main/authentication/basware-authentication.yml
  title: ''
  type: Authentication
  url: authentication/basware-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/basware/refs/heads/main/scopes/basware-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/basware/refs/heads/main/plans/basware-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/basware-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/basware/refs/heads/main/rate-limits/basware-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/basware-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/basware/refs/heads/main/finops/basware-finops.yml
  title: ''
  type: FinOps
  url: finops/basware-finops.yml
created: '2026-06-13'
description: Basware is a cloud-based e-invoicing and purchase-to-pay platform that enables global enterprises to automate their invoice and procurement processes. The platform provides REST APIs for submitting and receiving electronic invoices across 70+ formats, managing purchase orders, and processing accounts payable workflows. Basware Network connects buyers and suppliers worldwide through a single integration point, handling format conversion and delivery. The APIs support master data management, user administration, document archiving, and real-time transaction data access for finance and procurement operations.
examples:
- key_count: 4
  name: Basware Api Examples
  slug: basware-api-examples
finops:
- name: Basware Finops
  service_category: ''
  slug: basware-finops
...
json_schemas:
- name: Basware OAUTH2 authentication APIs
  property_count: 0
  slug: basware-authentication
- name: Basware Data Extract APIs
  property_count: 0
  slug: basware-data-extract
- name: 'Directory API. Stage: prod'
  property_count: 0
  slug: basware-directory
- name: Basware APIs for Purchase-to-Pay and Master Data import
  property_count: 0
  slug: basware-p2p
- name: Basware push notification APIs
  property_count: 0
  slug: basware-push-notification
- name: Basware SmartPDF invoice upload API
  property_count: 0
  slug: basware-smart-pdf
- name: User Permission Management APIs
  property_count: 0
  slug: basware-user-permission
- name: Open Vault API
  property_count: 0
  slug: basware-vault
jsonld:
- class_count: 0
  name: Basware Context
  property_count: 1421
...
- limit_count: 0
  ...
  slug: basware-rate-limits
rules:
- effective_rule_count: 6
  extends: []
  name: Basware API Rules
  rule_count: 6
  severity_counts:
    error: 0
    hint: 0
    info: 2
    warn: 4
  slug: basware-jsonschema-spectral-rules
scopes:
- name: Basware Scopes
  scope_count: 86
  slug: basware-scopes
