...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://www.supervalu.com'', ''status'': 301, ''note'': ''declared website redirects to https://www.unfi.com/ — a different registrable domain (supervalu.com -> unfi.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/supervalu/refs/heads/main/security/supervalu-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/supervalu-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/supervalu
- group: company
  title: ''
  type: Website
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/supervalu.png
layout: provider
modified: '2026-05-02'
name: SuperValu
nav: Providers
