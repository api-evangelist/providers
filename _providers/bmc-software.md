...
- group: auth
  ...
  title: ''
  type: DomainSecurity
  url: security/bmc-software-domain-security.yml
- group: company
  title: ''
  type: Website
...
- group: start
  title: ''
  type: GettingStarted
  url: https://docs.bmc.com/docs/display/public/workloadautomation/Control-M+Automation+API+-+Getting+Started+Guide
- group: operate
  title: ''
  type: Support
...
- group: commercial
  title: ''
  type: Pricing
  url: https://www.bmc.com/forms/pricing-request.html
- group: start
  title: ''
  type: SignUp
  url: https://www.bmc.com/product-trials-demos.html
- group: commercial
  title: ''
  type: TermsOfService
...
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/bmc-software/refs/heads/main/packages/bmc-software-packages.yml
  title: ''
  type: Packages
  url: packages/bmc-software-packages.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/bmc-software/refs/heads/main/packages/bmc-software-packages.yml
  title: ''
  type: SDKs
  url: packages/bmc-software-packages.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/bmc-software/refs/heads/main/cli/bmc-software-cli.yml
  title: ''
  type: CLI
