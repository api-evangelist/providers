...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/strimzi/refs/heads/main/agentic-access/strimzi-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/strimzi-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/strimzi/refs/heads/main/security/strimzi-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Strimzi publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Consumer API, Producer API, Seek API, and 2 more. Tagged areas include Kafka, Kubernetes, Messaging, Operator, and Streaming.
