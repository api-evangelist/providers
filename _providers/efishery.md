...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/efishery/refs/heads/main/security/efishery-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: eFishery is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Aquaculture, AgTech, FishTech, and IoT.
random_paper: 5
score:
  band: minimal
  composite: 3.7
