...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/zyte/refs/heads/main/lifecycle/zyte-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/zyte/refs/heads/main/security/zyte-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/zyte-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/zyte/refs/heads/main/security/zyte-trust-center.yml
  title: ''
  type: TrustCenter
...
- group: auth
  ...
  url: security/zyte-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/zyte/refs/heads/main/security/zyte-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/zyte-domain-security.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/zyte/refs/heads/main/conformance/zyte-conformance.yml
  title: ''
  type: Conformance
  url: conformance/zyte-conformance.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/zyte/refs/heads/main/authentication/zyte-authentication.yml
  title: ''
  type: Authentication
  url: authentication/zyte-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/zyte/refs/heads/main/conventions/zyte-conventions.yml
  title: ''
  type: Conventions
  url: conventions/zyte-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/zyte/refs/heads/main/errors/zyte-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/zyte-problem-types.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/zyte/refs/heads/main/rate-limits/zyte-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/zyte-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/zyte/refs/heads/main/plans/zyte-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/zyte-plans-pricing.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/zyte/refs/heads/main/finops/zyte-finops.yml
  title: ''
  type: FinOps
  url: finops/zyte-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/zyte/refs/heads/main/data-model/zyte-data-model.yml
  title: ''
  type: DataModel
  url: data-model/zyte-data-model.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/zyte/refs/heads/main/changelog/zyte-changelog.yml
  title: ''
  type: ChangeLog
...
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/zyte/refs/heads/main/cli/zyte-cli.yml
  title: ''
  type: CLI
  url: cli/zyte-cli.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/zyte/refs/heads/main/packages/zyte-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/zyte-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/zyte/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
