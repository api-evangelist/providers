...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/materialize/refs/heads/main/agentic-access/materialize-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/materialize-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/materialize/refs/heads/main/security/materialize-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/materialize-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/materialize/refs/heads/main/security/materialize-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/materialize-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/materialize/refs/heads/main/authentication/materialize-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/materialize/refs/heads/main/plans/materialize-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/materialize-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/materialize/refs/heads/main/rate-limits/materialize-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/materialize-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/materialize/refs/heads/main/finops/materialize-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Materialize publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Streaming Sources and Sinks (AsyncAPI), Sql API, and 2 more. Tagged areas include Streaming, Data Warehouse, SQL, Real-Time, and PostgreSQL Compatible.
