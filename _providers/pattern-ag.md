...
access_model:
  ...
  source:
  - security
  - '{''url'': ''https://www.pattern.ag/'', ''status'': 301, ''note'': ''declared website redirects to https://earthoptics.com/ — a different registrable domain (pattern.ag -> earthoptics.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pattern-ag/refs/heads/main/security/pattern-ag-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/pattern-ag-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/pattern-ag/refs/heads/main/llms/pattern-ag-llms.txt
  title: ''
  type: LLMsTxt
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/pattern-ag/refs/heads/main/screenshots/pattern-ag-2026-09-02T150916.png
security:
