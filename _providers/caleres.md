...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/caleres/refs/heads/main/security/caleres-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/caleres-domain-security.yml
- group: company
  title: ''
  type: Website
...
- group: other
  title: ''
  type: Brands
  url: https://www.caleres.com/brands
- group: other
  title: ''
  type: Famous Footwear
  url: https://www.famousfootwear.com
- group: other
  title: ''
  type: Wikipedia
  url: https://en.wikipedia.org/wiki/Caleres
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/caleres
- group: company
  title: ''
  type: Investor Relations
  url: https://investor.caleres.com/
created: '2024-01-01'
description: Caleres is an American footwear company headquartered in Clayton, Missouri, established in 1878 (rebranded from Brown Shoe Company in 2015). It designs, develops, sources, manufactures, and distributes footwear through its Famous Footwear retail segment (approximately 900 U.S. locations) and Brand Portfolio segment which includes Sam Edelman, Stuart Weitzman, Allen Edmonds, Naturalizer, Vionic, LifeStride, Dr. Scholl's, Rykä, Franco Sarto, and Blowfish Malibu. Caleres does not currently publish a public developer API program; integrations are typically handled through B2B EDI and partner channels.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/caleres.png
layout: provider
modified: '2026-04-23'
name: Caleres
nav: Providers
