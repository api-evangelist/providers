...
nav: Providers
network: true
overview: 'Microsoft Applications publishes 1 API on the [APIs.io](https://apis.io/) network: Microsoft Graph API. Tagged areas include Cloud, Collaboration, Enterprise, Microsoft, and Office 365.'
plans:
...
- Office 365
- Productivity
website: https://www.microsoft.com/apis
---
