...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/prometheus-io/refs/heads/main/agentic-access/prometheus-io-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/prometheus-io-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/prometheus-io/refs/heads/main/security/prometheus-io-domain-security.yml
  title: ''
  type: DomainSecurity
...
overview: 'Prometheus publishes 18 APIs on the [APIs.io](https://apis.io/) network, including admin API, alert API, alertgroup API, and 15 more. Tagged areas include Monitoring, Metrics, Observability, Time Series, and Alerting.
  ...
  Prometheus'' developer surface includes developer portal, documentation, changelog, engineering blog, tooling, and 38 more developer resources.'
random_paper: 17
rules:
