...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/klavis/refs/heads/main/agentic-access/klavis-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/klavis-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/klavis/refs/heads/main/security/klavis-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/klavis-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/klavis/refs/heads/main/authentication/klavis-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Klavis AI publishes 5 APIs on the [APIs.io](https://apis.io/) network, including MCP Servers API, Sandbox API, Tools API, and 2 more. Tagged areas include MCP, MCP Server, MCP Hosting, Connectors, and Authentication.
