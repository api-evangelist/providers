...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/connect-first-credit-union/refs/heads/main/security/connect-first-credit-union-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/connect-first-credit-union-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/connect-first-credit-union/refs/heads/main/well-known/connect-first-credit-union-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/connect-first-credit-union-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/connect-first-credit-union/refs/heads/main/authentication/connect-first-credit-union-authentication.yml
  title: ''
  type: Authentication
  url: authentication/connect-first-credit-union-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/connect-first-credit-union/refs/heads/main/scopes/connect-first-credit-union-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/connect-first-credit-union-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/connect-first-credit-union/refs/heads/main/conformance/connect-first-credit-union-conformance.yml
  title: ''
  type: Conformance
  url: conformance/connect-first-credit-union-conformance.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/connect-first-credit-union/refs/heads/main/llms/connect-first-credit-union-llms.txt
  title: ''
  type: LLMsTxt
