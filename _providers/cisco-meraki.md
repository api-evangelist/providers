...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/cisco-meraki/refs/heads/main/capabilities/cisco-meraki-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cisco-meraki/refs/heads/main/agentic-access/cisco-meraki-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/cisco-meraki-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cisco-meraki/refs/heads/main/security/cisco-meraki-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/cisco-meraki-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cisco-meraki/refs/heads/main/authentication/cisco-meraki-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Cisco Meraki publishes 21 APIs on the [APIs.io](https://apis.io/) network, including Administered API, Appliance API, Camera API, and 18 more. Tagged areas include Networking, Wireless, Switching, Security Appliances, and Cloud-Managed Networking.
