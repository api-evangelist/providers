...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/webflux/refs/heads/main/json-ld/webflux-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/webflux-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/webflux/refs/heads/main/vocabulary/webflux-vocabulary.yml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'Spring WebFlux publishes 8 APIs on the [APIs.io](https://apis.io/) network, including WebSocket, and 7 more. Tagged areas include Java, Microservices, Non-Blocking IO, Reactive Programming, and REST API.
