...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/green-plains/refs/heads/main/security/green-plains-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/green-plains-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/green-plains-inc
- group: company
  title: ''
  type: Website
  url: https://www.gpreinc.com
- group: company
  title: ''
  type: Investor Relations
  url: https://investor.gpreinc.com
created: '2026-03-24'
description: Green Plains is a vertically integrated ethanol producer that operates ethanol plants, grain handling and storage facilities, and a cattle-feeding operation. No public APIs are documented.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/green-plains.png
layout: provider
modified: '2026-04-28'
name: Green Plains
nav: Providers
