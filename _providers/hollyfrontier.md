...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://www.hollyfrontier.com'', ''status'': 301, ''note'': ''declared website redirects to https://www.hfsinclair.com/home/default.aspx — a different registrable domain (hollyfrontier.com -> hfsinclair.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
description: HollyFrontier was an independent petroleum refiner and marketer that produced and marketed gasoline, diesel fuel, jet fuel, asphalt, and specialty lubricant products before becoming HF Sinclair.
...
nav: Providers
network: true
overview: Hollyfrontier is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Fortune 500.
press:
- date: '2026-05-25'
