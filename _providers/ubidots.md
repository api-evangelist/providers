...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ubidots/refs/heads/main/security/ubidots-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Ubidots publishes 3 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include IoT, Telemetry, Time Series, MQTT, and REST.
