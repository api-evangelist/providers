...
overview: 'TeamCity publishes 17 APIs on the [APIs.io](https://apis.io/) network, including Agent Pools API, Agents API, Audit API, and 14 more. Tagged areas include Build Automation, CI/CD, Continuous Integration, Deployment, and DevOps.
  ...
  TeamCity''s developer surface includes authentication, getting-started guide, documentation, pricing, engineering blog, support, changelog, and 12 more developer resources.'
plans:
