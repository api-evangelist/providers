...
- group: operate
  title: ''
  type: Releases
  url: https://github.com/paritytech/substrate-api-sidecar/releases
- group: commercial
  title: ''
  type: License
  url: https://github.com/paritytech/substrate-api-sidecar/blob/master/LICENSE
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/polkadot/refs/heads/main/agentic-access/polkadot-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/polkadot-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/polkadot/refs/heads/main/security/polkadot-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/polkadot-domain-security.yml
- group: company
  title: ''
  type: Website
...
- name: Subscan
  service_category: ''
  slug: subscan
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/polkadot.png
jsonld:
- class_count: 0
  name: Apis Context
  property_count: 0
...
overview: 'Polkadot publishes 57 APIs on the [APIs.io](https://apis.io/) network, including Account API, Accounts API, Ahm API, and 54 more. Tagged areas include Blockchain, Polkadot, Parachain, Substrate, and Crypto.
  ...
  Polkadot''s developer surface includes engineering blog, GitHub presence, and 10 more developer resources.'
plans:
- name: Subscan
  plan_count: 3
  slug: subscan
