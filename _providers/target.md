...
nav: Providers
network: true
overview: 'Target publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Inventory API, Orders API, Products API, and 5 more. Tagged areas include Fortune 100, E-Commerce, Retail, Product, and Inventory.
