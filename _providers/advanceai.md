...
- baseURL: https://api.advance.ai
  ...
  name: ADVANCE.AI Authentication API
...
- baseURL: https://api.advance.ai
  ...
  name: ADVANCE.AI Liveness Detection API
  slug: advanceai-liveness-detection-api
artifact_total: 11
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/advanceai/refs/heads/main/agentic-access/advanceai-agentic-access.yml
  title: ''
  type: AgenticAccess
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/advanceai/refs/heads/main/security/advanceai-vulnerability-disclosure.yml
  title: ''
  type: Security
  url: security/advanceai-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/advanceai/refs/heads/main/security/advanceai-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/advanceai-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/advanceai/refs/heads/main/security/advanceai-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: auth
  ...
  url: security/advanceai-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/advanceai/refs/heads/main/authentication/advanceai-authentication.yml
  title: ''
  type: Authentication
  url: authentication/advanceai-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/advanceai/refs/heads/main/conventions/advanceai-conventions.yml
  title: ''
  type: Conventions
  url: conventions/advanceai-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/advanceai/refs/heads/main/conformance/advanceai-conformance.yml
  title: ''
  type: Conformance
  url: conformance/advanceai-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/advanceai/refs/heads/main/errors/advanceai-error-codes.yml
  title: ''
  type: ErrorCatalog
  url: errors/advanceai-error-codes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/advanceai/refs/heads/main/lifecycle/advanceai-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: operate
  ...
  url: lifecycle/advanceai-lifecycle.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/advanceai/refs/heads/main/rate-limits/advanceai-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/advanceai-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/advanceai/refs/heads/main/plans/advanceai-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/advanceai-plans-pricing.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/advanceai/refs/heads/main/packages/advanceai-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/advanceai-packages.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/advanceai/refs/heads/main/data-model/advanceai-data-model.yml
  title: ''
  type: DataModel
  url: data-model/advanceai-data-model.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/advanceai/refs/heads/main/mcp/advanceai-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/advanceai-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/advanceai/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/advanceai/refs/heads/main/llms/advanceai-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/advanceai-llms.txt
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/advanceai/refs/heads/main/overlays/advanceai-open-api-overlay.yaml
  title: ''
  type: Overlay
...
nav: Providers
network: true
overview: 'ADVANCE.AI publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Authentication API, Document Verification API, Face Comparison API, and 1 more. Tagged areas include Company, Identity Verification, KYC, KYB, and AML.
