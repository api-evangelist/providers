...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/unfao/refs/heads/main/agentic-access/unfao-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/unfao-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/unfao/refs/heads/main/security/unfao-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'FAO FAOSTAT publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Catalog API, Data API, Dimensions API, and 4 more. Tagged areas include Agriculture, Food Security, Statistics, Trade, and Land Use.
