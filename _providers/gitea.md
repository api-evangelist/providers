...
nav: Providers
network: true
overview: 'Gitea publishes 13 APIs on the [APIs.io](https://apis.io/) network, including Admin API, Issue API, Miscellaneous API, and 10 more. Tagged areas include Gitea, Git, Source Control, DevOps, and CI/CD.
