...
access_model:
  ...
  - authentication
  - security
  - '{''url'': ''https://www.lucidchart.com/'', ''status'': 301, ''note'': ''declared website redirects to https://lucid.co/lucidchart — a different registrable domain (lucidchart.com -> lucid.co), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: true
agent_readiness:
  band: agent-aware
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/lucidchart/refs/heads/main/agentic-access/lucidchart-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/lucidchart-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lucidchart/refs/heads/main/security/lucidchart-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/lucidchart-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lucidchart/refs/heads/main/authentication/lucidchart-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/lucidchart/refs/heads/main/plans/lucidchart-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/lucidchart-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/lucidchart/refs/heads/main/rate-limits/lucidchart-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/lucidchart-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/lucidchart/refs/heads/main/finops/lucidchart-finops.yml
  title: ''
  type: FinOps
