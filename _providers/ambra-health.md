...
access_model:
  ...
  - plans
  - authentication
  - '{''url'': ''https://ambrahealth.com'', ''status'': 301, ''note'': ''declared website redirects to https://www.intelerad.com/en/client-support-resources/ — a different registrable domain (ambrahealth.com -> intelerad.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: agent-aware
...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/ambra-health/refs/heads/main/capabilities/ambra-health-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/ambra-health-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ambra-health/refs/heads/main/agentic-access/ambra-health-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/ambra-health-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ambra-health/refs/heads/main/security/ambra-health-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/ambra-health-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ambra-health/refs/heads/main/authentication/ambra-health-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/ambra-health/refs/heads/main/plans/ambra-health-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/ambra-health-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/ambra-health/refs/heads/main/rate-limits/ambra-health-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/ambra-health-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/ambra-health/refs/heads/main/finops/ambra-health-finops.yml
  title: ''
  type: FinOps
