...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/fibery/refs/heads/main/security/fibery-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/fibery-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/fibery/refs/heads/main/security/fibery-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/fibery/refs/heads/main/plans/fibery-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/fibery-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/fibery/refs/heads/main/rate-limits/fibery-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/fibery-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/fibery/refs/heads/main/finops/fibery-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Fibery publishes 2 APIs on the [APIs.io](https://apis.io/) network, including HTTP API, and 1 more. Tagged areas include Work Management, Project Management, Collaboration, No-Code, and Automation.
