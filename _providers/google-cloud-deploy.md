...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-deploy/refs/heads/main/agentic-access/google-cloud-deploy-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-cloud-deploy-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-deploy/refs/heads/main/security/google-cloud-deploy-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-cloud-deploy-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-deploy/refs/heads/main/security/google-cloud-deploy-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/google-cloud-deploy-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-deploy/refs/heads/main/authentication/google-cloud-deploy-authentication.yml
  title: ''
  type: Authentication
  url: authentication/google-cloud-deploy-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-deploy/refs/heads/main/scopes/google-cloud-deploy-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-deploy/refs/heads/main/json-ld/google-cloud-deploy-context.jsonld
  title: ''
  type: JSONLD
...
overview: 'Google Cloud Deploy publishes 4 APIs on the [APIs.io](https://apis.io/) network, including DeliveryPipelines API, Releases API, Rollouts API, and 1 more. Tagged areas include Continuous Delivery, Deployment, DevOps, Kubernetes, and Pipelines.
  ...
  Google Cloud Deploy''s developer surface includes authentication, developer portal, getting-started guide, documentation, pricing, developer console, CLI, and 13 more developer resources.'
plans:
