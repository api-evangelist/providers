...
nav: Providers
network: true
overview: 'Instagram publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Comments API, Hashtags API, Insights API, and 6 more. Tagged areas include Instagram, Meta, Photos, Social Media, and Video.
