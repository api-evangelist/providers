...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/capabilities/relex-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/relex-capability-edges.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/overlays/relex-data-api-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/relex-data-api-overlay.yaml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/overlays/relex-monitoring-api-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/relex-monitoring-api-overlay.yaml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/security/relex-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/relex-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/security/relex-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/relex-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/security/relex-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/scopes/relex-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/relex-scopes.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/well-known/relex-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/relex-well-known.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/conventions/relex-conventions.yml
  title: ''
  type: Conventions
...
- group: design
  ...
  url: conventions/relex-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/errors/relex-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/relex-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/lifecycle/relex-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: operate
  ...
  url: lifecycle/relex-lifecycle.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/rate-limits/relex-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/relex-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/plans/relex-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/relex-plans-pricing.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/conformance/relex-conformance.yml
  title: ''
  type: Conformance
  url: conformance/relex-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/data-model/relex-data-model.yml
  title: ''
  type: DataModel
  url: data-model/relex-data-model.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/sandbox/relex-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/relex-sandbox.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/asyncapi/relex-data-api-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/relex-data-api-webhooks.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/llms/relex-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/relex-llms.txt
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/relex/refs/heads/main/packages/relex-packages.yml
  title: ''
  type: Packages
...
nav: Providers
network: true
overview: 'RELEX Solutions publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Environments API, Events API, Health API, and 4 more. Tagged areas include Supply Chain, Retail, Demand Planning, Inventory, and Forecasting.
