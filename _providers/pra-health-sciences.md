...
- group: other
  title: ''
  type: AcquirerAnnouncement
  url: https://www.iconplc.com/insights/press-releases/2021-press-releases/icon-completes-acquisition-of-pra-health-sciences/
- group: other
  title: ''
...
- group: build
  title: ''
  type: GitHub
  url: https://github.com/api-evangelist/pra-health-sciences
created: '2026-05-05'
deprecated: true
...
nav: Providers
network: true
overview: 'PRA Health Sciences is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Clinical Trials, Contract Research Organization, CRO, Life Sciences, and Pharmaceuticals.


  PRA Health Sciences'' developer surface includes GitHub presence and 4 more developer resources.'
random_paper: 19
score:
  band: minimal
  composite: 2.5
