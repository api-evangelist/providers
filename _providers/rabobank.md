...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/rabobank/refs/heads/main/security/rabobank-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: Rabobank publishes 5 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include Finance, Banks, Banking, Open Banking, and PSD2.
random_paper: 18
score:
  band: minimal
  composite: 7.0
