...
access_model:
  ...
  source:
  - plans
  - '{''url'': ''https://www.defer.run'', ''status'': 301, ''note'': ''declared website redirects to https://digger.tools/?ref=defer.run — a different registrable domain (defer.run -> digger.tools), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/defer/refs/heads/main/security/defer-domain-security.yml
  title: ''
  type: DomainSecurity
