...
overview: 'BVNK publishes 16 APIs on the [APIs.io](https://apis.io/) network, including Address API, Asset Pool API, Channels API, and 13 more. Tagged areas include Company, Payments, Stablecoins, Cryptocurrency, and Wallets.
  ...
  BVNK''s developer surface includes documentation, API reference, getting-started guide, support, engineering blog, signup flow, changelog, and 35 more developer resources.'
random_paper: 13
scopes:
- name: Bvnk Scopes
  scope_count: 156
