...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/rest/refs/heads/main/security/rest-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'REST publishes 4 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include API Design, Architecture, Developer Tools, HTTP, and REST.
