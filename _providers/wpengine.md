...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/wpengine/refs/heads/main/vendor-facets/wpengine-vendor-facets.yml
  title: ''
  type: VendorFacets
  url: vendor-facets/wpengine-vendor-facets.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/wpengine/refs/heads/main/agentic-access/wpengine-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/wpengine-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/wpengine/refs/heads/main/security/wpengine-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/wpengine-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/wpengine/refs/heads/main/security/wpengine-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/wpengine-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/wpengine/refs/heads/main/authentication/wpengine-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/wpengine/refs/heads/main/plans/wpengine-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/wpengine-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/wpengine/refs/heads/main/rate-limits/wpengine-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/wpengine-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/wpengine/refs/heads/main/finops/wpengine-finops.yml
  title: ''
  type: FinOps
...
examples:
- key_count: 6
  name: Cancelsitetransfer
  slug: cancelSiteTransfer
- key_count: 6
  name: Checkstatus
  slug: checkStatus
- key_count: 6
...
- key_count: 6
  ...
  slug: createAccountUser
- key_count: 6
  name: Createbackup
  slug: createBackup
- key_count: 6
  name: Createbulkdomains
  slug: createBulkDomains
- key_count: 6
  name: Createdomain
  slug: createDomain
- key_count: 6
  name: Createdomaincertificateorder
  slug: createDomainCertificateOrder
- key_count: 6
  name: Createinstall
  slug: createInstall
- key_count: 6
  ...
  slug: createSite
- key_count: 6
  name: Createsitetransfer
  slug: createSiteTransfer
- key_count: 6
  name: Createsshkey
  slug: createSshKey
- key_count: 6
  name: Deleteaccountuser
  slug: deleteAccountUser
- key_count: 6
  name: Deletedomain
  slug: deleteDomain
- key_count: 6
...
- key_count: 6
  ...
  slug: getAccount
- key_count: 6
  name: Getaccountusageinsights
  slug: getAccountUsageInsights
- key_count: 6
  name: Getaccountusagemetrics
  slug: getAccountUsageMetrics
- key_count: 6
  name: Getaccountusagesummary
  slug: getAccountUsageSummary
- key_count: 6
  name: Getaccountuser
  slug: getAccountUser
- key_count: 6
  name: Getaccountslimits
  slug: getAccountsLimits
- key_count: 6
  name: Getcurrentuser
  slug: getCurrentUser
- key_count: 6
  ...
  slug: getDomain
- key_count: 6
  name: Getdomaincertificate
  slug: getDomainCertificate
- key_count: 6
  name: Getdomainreportstatus
  slug: getDomainReportStatus
- key_count: 6
  name: Getinstall
  slug: getInstall
- key_count: 6
  name: Getinstallcertificates
  slug: getInstallCertificates
- key_count: 6
  name: Getinstallusagemetrics
  slug: getInstallUsageMetrics
- key_count: 6
  name: Getlargefsvalidationfile
  slug: getLargeFSValidationFile
- key_count: 6
  name: Getoffloadsettings
  slug: getOffloadSettings
- key_count: 6
  name: Getsite
  slug: getSite
- key_count: 6
  name: Getsitetransfer
  slug: getSiteTransfer
- key_count: 6
  name: Importthirdpartysslcertificate
  slug: importThirdPartySSLCertificate
- key_count: 6
  name: Listaccountsitetransfers
  slug: listAccountSiteTransfers
- key_count: 6
  name: Listaccountusers
  slug: listAccountUsers
- key_count: 6
  name: Listaccounts
  slug: listAccounts
- key_count: 6
...
- key_count: 6
  ...
  slug: listInstalls
- key_count: 6
  name: Listsitereporttemplates
  slug: listSiteReportTemplates
- key_count: 6
  name: Listsitetransfers
  slug: listSiteTransfers
- key_count: 6
  name: Listsites
  slug: listSites
- key_count: 6
  ...
  slug: listSshKeys
- key_count: 6
  name: Patchoffloadsettings
  slug: patchOffloadSettings
- key_count: 6
  name: Post_Accounts_{Account_Id}_Usage_Refresh_Disk_Usage
  slug: post_accounts_{account_id}_usage_refresh_disk_usage
- key_count: 6
  name: Purgecache
  slug: purgeCache
- key_count: 6
  name: Refreshenvironmentdiskusage
  slug: refreshEnvironmentDiskUsage
- key_count: 6
  name: Restorebackup
  slug: restoreBackup
- key_count: 6
...
- key_count: 6
  ...
  slug: updateInstall
- key_count: 6
  name: Updateoffloadsettings
  slug: updateOffloadSettings
- key_count: 6
  name: Updatesite
  slug: updateSite
- key_count: 6
  name: Verifydomaintxtrecord
  slug: verifyDomainTxtRecord
finops:
- name: Wpengine Finops
  service_category: ''
  slug: wpengine-finops
...
- name: AccountLimits
  property_count: 3
  slug: accountlimits
- name: AccountUsageInsights
  property_count: 8
  slug: accountusageinsights
- name: AccountUsageMetricsResponse
  property_count: 6
  slug: accountusagemetricsresponse
- name: AccountUser
  property_count: 11
  slug: accountuser
- name: Archive
...
- name: AuthenticationErrorResponse
  property_count: 2
  slug: authenticationerrorresponse
- name: Backup
  property_count: 6
  slug: backup
- name: BadGatewayOperation
  property_count: 0
  slug: badgatewayoperation
- name: BadRequestErrorResponse
  property_count: 3
  slug: badrequesterrorresponse
- name: Certificate
  property_count: 15
  slug: certificate
...
- name: ConflictErrorResponse
  property_count: 2
  slug: conflicterrorresponse
- name: DailyUsageMetrics
  property_count: 14
  slug: dailyusagemetrics
- name: DailyUsageMetricsTrafficMetricsSource
  property_count: 0
  slug: dailyusagemetricstrafficmetricssource
- name: Domain
  property_count: 13
  slug: domain
- name: DomainCertificate
  property_count: 4
  slug: domaincertificate
- name: DomainOrRedirect
  property_count: 10
  slug: domainorredirect
- name: DomainReport
  property_count: 1
  slug: domainreport
- name: DomainStatus
  property_count: 23
  slug: domainstatus
- name: DomainStatusReport
  property_count: 6
  slug: domainstatusreport
- name: DomainVerification
  property_count: 6
  slug: domainverification
- name: EnvironmentMetrics
  property_count: 4
  slug: environmentmetrics
- name: EnvironmentTypeBreakdown
  property_count: 3
  slug: environmenttypebreakdown
- name: ForbiddenErrorResponse
  property_count: 2
  slug: forbiddenerrorresponse
- name: Installation
  property_count: 14
  slug: installation
- name: InstallDailyUsageMetricsSeries
  property_count: 4
  slug: installdailyusagemetricsseries
- name: InstallSSLCertificatesResponse
  property_count: 2
  slug: installsslcertificatesresponse
- name: InternalServerErrorResponse
  property_count: 1
  slug: internalservererrorresponse
- name: LargeFSConfig
  property_count: 1
  slug: largefsconfig
- name: LargeFSValidationFile
  property_count: 2
  slug: largefsvalidationfile
- name: LatestMetricValue
  property_count: 2
  slug: latestmetricvalue
- name: NextPage
  property_count: 0
  slug: nextpage
- name: NotFoundErrorResponse
  property_count: 2
  slug: notfounderrorresponse
- name: PreviousPage
  property_count: 0
  slug: previouspage
- name: ResourceError
...
- name: ResultsCount
  property_count: 0
  slug: resultscount
- name: ServiceUnavailableOperation
  property_count: 0
  slug: serviceunavailableoperation
- name: Site
  property_count: 9
  slug: site
- name: SiteTransfer
  property_count: 9
  slug: sitetransfer
- name: SiteTypeBreakdown
  property_count: 3
  slug: sitetypebreakdown
- name: SshKey
  property_count: 4
  slug: sshkey
- name: Status
...
- name: Template
  property_count: 10
  slug: template
- name: ThirdPartySuccessfulImportResponse
  property_count: 2
  slug: thirdpartysuccessfulimportresponse
- name: TooManyRequestsOperation
  property_count: 0
  slug: toomanyrequestsoperation
- name: UnprocessableEntityErrorResponse
  property_count: 3
  slug: unprocessableentityerrorresponse
- name: UsageErrorResponse
  property_count: 1
  slug: usageerrorresponse
- name: UsageMetricBreakdown
  property_count: 3
  slug: usagemetricbreakdown
- name: UsageMetricsRollup
  property_count: 8
  slug: usagemetricsrollup
- name: UsageRollup
  property_count: 3
  slug: usagerollup
- name: User
...
nav: Providers
network: true
overview: 'WP Engine publishes 17 APIs on the [APIs.io](https://apis.io/) network, including Account API, Account User API, Archive API, and 14 more. Tagged areas include WordPress, Managed Hosting, WordPress Hosting, Site Management, and Digital Experience Platform.


  The WP Engine catalog on APIs.io includes 1 Spectral governance ruleset.


  WP Engine''s developer surface includes authentication, documentation, engineering blog, pricing, and 12 more developer resources.'
plans:
...
- limit_count: 4
  ...
  slug: wpengine-rate-limits
rules:
- effective_rule_count: 5
  extends: []
  name: WP Engine API Rules
  rule_count: 5
  severity_counts:
    error: 0
    hint: 0
...
- kind: vulnerability-disclosure
  name: Wpengine Vulnerability Disclosure
  slug: wpengine-vulnerability-disclosure
