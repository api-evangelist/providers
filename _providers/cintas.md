...
- group: other
  title: ''
  type: Online Store
  url: https://www.cintas.com/store
- group: company
  title: ''
  type: Investor Relations
  url: https://investors.cintas.com
- group: company
  title: ''
  type: Careers
...
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://www.cintas.com/privacy-policy
- group: commercial
  title: ''
  type: TermsOfService
  url: https://www.cintas.com/terms-of-use
- group: operate
  title: ''
  type: Support
...
overview: 'Cintas is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Facility Services, First Aid, Fortune 500, Safety, and Uniforms.
  ...
  Cintas'' developer surface includes support and 9 more developer resources.'
press:
- date: '2026-05-25'
