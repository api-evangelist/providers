...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/prevalent/refs/heads/main/security/prevalent-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: Prevalent is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Cybersecurity, Third-Party Risk Management, Vendor Risk, and Governance Risk Compliance.
random_paper: 9
score:
  band: minimal
  composite: 5.0
