...
- group: operate
  title: ''
  type: IssueTracker
  url: https://github.com/Azure/azure-databricks-client/issues
- group: operate
  title: ''
  type: Releases
  url: https://github.com/Azure/azure-databricks-client/releases
- group: auth
  title: ''
  type: SecurityPolicy
  url: https://github.com/Azure/azure-databricks-client/blob/master/SECURITY.md
- group: build
  title: ''
  type: CodeOfConduct
...
- group: docs
  ...
  url: https://github.com/Azure/azure-databricks-client/blob/master/CONTRIBUTING.md
- group: commercial
  title: ''
  type: License
...
nav: Providers
network: true
overview: 'Azure Databricks publishes 38 APIs on the [APIs.io](https://apis.io/) network, including Clusters API, Jobs API, Workspace API, and 35 more. Tagged areas include Analytics, Apache Spark, Big Data, Data Engineering, and Machine Learning.
