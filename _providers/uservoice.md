...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/uservoice/refs/heads/main/security/uservoice-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/uservoice/refs/heads/main/plans/uservoice-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/uservoice-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/uservoice/refs/heads/main/rate-limits/uservoice-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/uservoice-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/uservoice/refs/heads/main/finops/uservoice-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'UserVoice publishes 3 APIs on the [APIs.io](https://apis.io/) network, including Admin API, and 2 more. Tagged areas include Product Feedback, Idea Management, Customer Feedback, Product Roadmap, and Voting.
