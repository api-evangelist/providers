...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/dopex/refs/heads/main/agentic-access/dopex-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/dopex-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/dopex/refs/heads/main/security/dopex-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/dopex/refs/heads/main/plans/plans.yml
  title: ''
  type: Plans
  url: plans/plans.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/dopex/refs/heads/main/rate-limits/rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/dopex/refs/heads/main/finops/finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Dopex publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Deposit API, Exercise API, Option Markets API, and 7 more. Tagged areas include DeFi, Decentralized Options, SSOV, Options Exchange, and Arbitrum.
