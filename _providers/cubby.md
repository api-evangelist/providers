...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cubby/refs/heads/main/security/cubby-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cubby/refs/heads/main/authentication/cubby-authentication.yml
  title: ''
  type: Authentication
  url: authentication/cubby-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cubby/refs/heads/main/scopes/cubby-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/cubby-scopes.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cubby/refs/heads/main/mcp/cubby-mcp.yml
  title: ''
  type: MCPServer
  url: mcp/cubby-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cubby/refs/heads/main/well-known/cubby-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/cubby-well-known.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cubby/refs/heads/main/llms/cubby-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/cubby-llms.txt
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cubby/refs/heads/main/asyncapi/cubby-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/cubby-webhooks.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/cubby/refs/heads/main/changelog/cubby-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/cubby-changelog.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cubby/refs/heads/main/lifecycle/cubby-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: operate
  ...
  url: lifecycle/cubby-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cubby/refs/heads/main/errors/cubby-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/cubby-problem-types.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/cubby/refs/heads/main/errors/cubby-decline-codes.yml
  title: ''
  type: DeclineCodes
  url: errors/cubby-decline-codes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cubby/refs/heads/main/conventions/cubby-conventions.yml
  title: ''
  type: Conventions
  url: conventions/cubby-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cubby/refs/heads/main/data-model/cubby-data-model.yml
  title: ''
  type: DataModel
  url: data-model/cubby-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cubby/refs/heads/main/conformance/cubby-conformance.yml
  title: ''
  type: Conformance
  url: conformance/cubby-conformance.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/cubby/refs/heads/main/packages/cubby-packages.yml
  title: ''
  type: Packages
  url: packages/cubby-packages.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cubby/refs/heads/main/components/cubby-components.yml
  title: ''
  type: Components
  url: components/cubby-components.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/cubby/refs/heads/main/examples/cubby-examples.yml
  title: ''
  type: Examples
  url: examples/cubby-examples.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/cubby/refs/heads/main/plans/cubby-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/cubby-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/cubby/refs/heads/main/rate-limits/cubby-rate-limits.yml
  title: ''
  type: RateLimits
