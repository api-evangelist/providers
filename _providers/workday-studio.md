...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/workday-studio/refs/heads/main/agentic-access/workday-studio-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/workday-studio-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/workday-studio/refs/heads/main/security/workday-studio-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/workday-studio-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/workday-studio/refs/heads/main/security/workday-studio-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/workday-studio-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/workday-studio/refs/heads/main/authentication/workday-studio-authentication.yml
  title: ''
  type: Authentication
  url: authentication/workday-studio-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/workday-studio/refs/heads/main/scopes/workday-studio-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/workday-studio/refs/heads/main/rules/workday-studio-spectral-rules.yml
  title: ''
  type: SpectralRules
  url: rules/workday-studio-spectral-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/workday-studio/refs/heads/main/vocabulary/workday-studio-vocabulary.yaml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'Workday Studio publishes 15 APIs on the [APIs.io](https://apis.io/) network, including Absence Management API, Benefits Administration API, Compensation API, and 12 more. Tagged areas include Cloud, Developer Tools, Development, Enterprise, and Finance.
