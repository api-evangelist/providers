...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/podcastpage-api-podcastpage-io/refs/heads/main/security/podcastpage-api-podcastpage-io-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Podcastpage is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Podcasting, Website Builder, Content Management, and Hosting.
