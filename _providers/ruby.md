...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/ruby/refs/heads/main/capabilities/ruby-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ruby/refs/heads/main/agentic-access/ruby-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/ruby-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ruby/refs/heads/main/security/ruby-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/ruby-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ruby/refs/heads/main/authentication/ruby-authentication.yml
  title: ''
  type: Authentication
  url: authentication/ruby-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ruby/refs/heads/main/rules/rubygems-registry-rules.yml
  title: ''
  type: SpectralRules
  url: rules/rubygems-registry-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ruby/refs/heads/main/vocabulary/ruby-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/ruby-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ruby/refs/heads/main/json-ld/ruby-context.jsonld
  title: ''
  type: JSONLD
...
nav: Providers
network: true
overview: 'Ruby Programming Language and Popular API Gems publishes 23 APIs on the [APIs.io](https://apis.io/) network, including Activity API, API Keys API, Downloads API, and 20 more. Tagged areas include Programming Language, Ruby, HTTP, REST, and API Client.
