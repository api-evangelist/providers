...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/housesigma/refs/heads/main/mcp/housesigma-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/housesigma-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/housesigma/refs/heads/main/agentic-access/housesigma-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/housesigma-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/housesigma/refs/heads/main/security/housesigma-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/housesigma-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/housesigma/refs/heads/main/authentication/housesigma-authentication.yml
  title: ''
  type: Authentication
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/housesigma/refs/heads/main/llms/housesigma-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/housesigma-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/housesigma/refs/heads/main/well-known/housesigma-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/housesigma-well-known.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/housesigma/refs/heads/main/conventions/housesigma-conventions.yml
  title: ''
  type: Conventions
  url: conventions/housesigma-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/housesigma/refs/heads/main/errors/housesigma-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/housesigma-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/housesigma/refs/heads/main/lifecycle/housesigma-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/housesigma-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/housesigma/refs/heads/main/conformance/housesigma-conformance.yml
  title: ''
  type: Conformance
  url: conformance/housesigma-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/housesigma/refs/heads/main/data-model/housesigma-data-model.yml
  title: ''
  type: DataModel
  url: data-model/housesigma-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/housesigma/refs/heads/main/components/housesigma-components.yml
  title: ''
  type: Components
  url: components/housesigma-components.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/housesigma/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/housesigma/refs/heads/main/examples/
  title: ''
  type: Examples
  url: examples/
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/housesigma/refs/heads/main/overlays/housesigma-blog-content-overlay.yaml
  title: ''
  type: Overlay
