...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/nasdaq-omx-group/refs/heads/main/agentic-access/nasdaq-omx-group-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/nasdaq-omx-group-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/nasdaq-omx-group/refs/heads/main/security/nasdaq-omx-group-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/nasdaq-omx-group-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/nasdaq-omx-group/refs/heads/main/authentication/nasdaq-omx-group-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Nasdaq publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Databases API, Datasets API, and 2 more. Tagged areas include Financial Services, Capital Markets, Stock Exchange, Market Data, and Economics.
