...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/roadsync/refs/heads/main/capabilities/roadsync-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/roadsync-capability-edges.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/roadsync/refs/heads/main/overlays/roadsync-client-api-overlay.yaml
  title: ''
  type: Overlay
...
- group: docs
  ...
  url: https://developer.roadsync.com/api/
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/roadsync/refs/heads/main/authentication/roadsync-authentication.yml
  title: ''
  type: Authentication
  url: authentication/roadsync-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/roadsync/refs/heads/main/conventions/roadsync-conventions.yml
  title: ''
  type: Conventions
...
- group: design
  ...
  url: conventions/roadsync-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/roadsync/refs/heads/main/errors/roadsync-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/roadsync-problem-types.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/roadsync/refs/heads/main/errors/roadsync-decline-codes.yml
  title: ''
  type: DeclineCodes
  url: errors/roadsync-decline-codes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/roadsync/refs/heads/main/lifecycle/roadsync-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/roadsync/refs/heads/main/conformance/roadsync-conformance.yml
  title: ''
  type: Conformance
  url: conformance/roadsync-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/roadsync/refs/heads/main/data-model/roadsync-data-model.yml
  title: ''
  type: DataModel
  url: data-model/roadsync-data-model.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/roadsync/refs/heads/main/sandbox/roadsync-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/roadsync-sandbox.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/roadsync/refs/heads/main/security/roadsync-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/roadsync-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/roadsync/refs/heads/main/agentic-access/roadsync-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/roadsync-agentic-access.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/roadsync/refs/heads/main/mcp/roadsync-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/roadsync-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/roadsync/refs/heads/main/llms/roadsync-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/roadsync-llms.txt
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/roadsync/refs/heads/main/packages/roadsync-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/roadsync-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/roadsync/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
...
overview: 'Roadsync publishes 18 APIs on the [APIs.io](https://apis.io/) network, including authenticated API, brokers API, department API, and 15 more. Tagged areas include Company, Financial-Services, Payments, Logistics, and Trucking.
  ...
  Roadsync''s developer surface includes documentation, API reference, authentication, sandbox, support, engineering blog, and 22 more developer resources.'
random_paper: 9
score:
  band: developing
  composite: 43.8
