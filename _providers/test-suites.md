...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/test-suites/refs/heads/main/agentic-access/test-suites-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/test-suites-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/test-suites/refs/heads/main/security/test-suites-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/test-suites-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/test-suites/refs/heads/main/security/test-suites-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/test-suites-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/test-suites/refs/heads/main/security/test-suites-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/test-suites-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/test-suites/refs/heads/main/authentication/test-suites-authentication.yml
  title: ''
  type: Authentication
