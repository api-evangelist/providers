...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/exentis-group/refs/heads/main/overlays/exentis-group-blog-categories-api-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/exentis-group-blog-categories-api-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/exentis-group/refs/heads/main/agentic-access/exentis-group-agentic-access.yml
  title: ''
  type: AgenticAccess
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/exentis-group/refs/heads/main/authentication/exentis-group-authentication.yml
  title: ''
  type: Authentication
  url: authentication/exentis-group-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/exentis-group/refs/heads/main/conventions/exentis-group-conventions.yml
  title: ''
  type: Conventions
  url: conventions/exentis-group-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/exentis-group/refs/heads/main/conformance/exentis-group-conformance.yml
  title: ''
  type: Conformance
  url: conformance/exentis-group-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/exentis-group/refs/heads/main/lifecycle/exentis-group-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/exentis-group-lifecycle.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/exentis-group/refs/heads/main/security/exentis-group-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/exentis-group-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/exentis-group/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/exentis-group/refs/heads/main/llms/exentis-group-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/exentis-group-llms.txt
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/exentis-group/refs/heads/main/packages/exentis-group-packages.yml
  title: ''
  type: Packages
  url: packages/exentis-group-packages.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/exentis-group/refs/heads/main/plans/exentis-group-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/exentis-group-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/exentis-group/refs/heads/main/rate-limits/exentis-group-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/exentis-group-rate-limits.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/exentis-group/refs/heads/main/data-model/exentis-group-data-model.yml
  title: ''
  type: DataModel
  url: data-model/exentis-group-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/exentis-group/refs/heads/main/errors/exentis-group-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/exentis-group-problem-types.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/exentis-group/refs/heads/main/examples/exentis-group-examples.yml
  title: ''
  type: Examples
  url: examples/exentis-group-examples.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/exentis-group/refs/heads/main/overlays/exentis-group-posts-api-overlay.yaml
  title: ''
  type: Overlay
