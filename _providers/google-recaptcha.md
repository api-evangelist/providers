...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-recaptcha/refs/heads/main/agentic-access/google-recaptcha-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-recaptcha-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-recaptcha/refs/heads/main/security/google-recaptcha-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-recaptcha-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-recaptcha/refs/heads/main/security/google-recaptcha-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/google-recaptcha-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-recaptcha/refs/heads/main/authentication/google-recaptcha-authentication.yml
  title: ''
  type: Authentication
  url: authentication/google-recaptcha-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-recaptcha/refs/heads/main/scopes/google-recaptcha-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-recaptcha/refs/heads/main/json-ld/google-recaptcha-context.jsonld
  title: ''
  type: JSONLD
...
nav: Providers
network: true
overview: 'Google reCAPTCHA publishes 3 APIs on the [APIs.io](https://apis.io/) network, including Assessments API, Keys API, and 1 more. Tagged areas include Abuse Prevention, Bot Detection, CAPTCHA, Fraud Prevention, and Google Cloud.


  The Google reCAPTCHA catalog on APIs.io includes 1 JSON-LD context and 1 Spectral governance ruleset.


  Google reCAPTCHA''s developer surface includes authentication, getting-started guide, pricing, developer console, support, and 11 more developer resources.'
plans:
