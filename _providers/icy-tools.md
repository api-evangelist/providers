...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://developers.icy.tools/'', ''status'': 301, ''note'': ''declared website redirects to https://www.quicknode.com/?utm_source=icy.tools — a different registrable domain (icy.tools -> quicknode.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/icy-tools/refs/heads/main/security/icy-tools-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/icy-tools-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/icy-tools/refs/heads/main/security/icy-tools-domain-security.yml
  title: ''
  type: DomainSecurity
