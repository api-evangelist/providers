...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/massachusetts-mutual-life-insurance/refs/heads/main/security/massachusetts-mutual-life-insurance-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/massachusetts-mutual-life-insurance-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
...
- group: other
  title: ''
  type: Alias
  url: https://github.com/api-evangelist/mass-mutual
created: '2026-03-24'
description: Massachusetts Mutual Life Insurance Company (MassMutual) is a leading mutual life insurance company providing life insurance, disability income insurance, long-term care insurance, retirement and annuity products, and investment management services. This repository is an alias for the MassMutual API Evangelist profile and tracks publicly available APIs, developer tools, and machine-readable API artifacts.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/massachusetts-mutual-life-insurance.png
layout: provider
modified: '2026-04-28'
