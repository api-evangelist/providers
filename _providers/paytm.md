...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/paytm/refs/heads/main/agentic-access/paytm-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/paytm-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/paytm/refs/heads/main/security/paytm-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/paytm-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/paytm/refs/heads/main/authentication/paytm-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Paytm publishes 17 APIs on the [APIs.io](https://apis.io/) network, including Payments API, Refunds API, and 15 more. Tagged areas include Payments, Payment Gateway, UPI, Payouts, and Subscription.
