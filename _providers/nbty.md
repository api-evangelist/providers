...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/nbty/refs/heads/main/security/nbty-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/nbty-domain-security.yml
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/NBTY
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/nbty
- group: company
  title: ''
  type: Website
  url: https://www.naturesbounty.com/
created: '2026-03-24'
description: NBTY was a leading global vertically integrated manufacturer, marketer, distributor, and retailer of vitamins and nutritional supplements before being renamed The Nature's Bounty Co., which was subsequently sold and reorganized. No public APIs exist under the NBTY name.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/nbty.png
layout: provider
modified: '2026-04-28'
name: NBTY
nav: Providers
...
- kind: domain-security
  name: Nbty Domain Security
  slug: nbty-domain-security
