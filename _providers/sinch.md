...
- acting_count: 73
  ...
  summary_line: 133 operations · 73 acting · 4 human-in-the-loop
api_count: 10
apis:
...
common:
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sinch/refs/heads/main/plans/sinch-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/sinch-plans-pricing.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/sinch/refs/heads/main/capabilities/sinch-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/sinch/refs/heads/main/agentic-access/sinch-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/sinch-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sinch/refs/heads/main/security/sinch-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/sinch-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sinch/refs/heads/main/security/sinch-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/sinch-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sinch/refs/heads/main/authentication/sinch-authentication.yml
  title: ''
  type: Authentication
  url: authentication/sinch-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sinch/refs/heads/main/scopes/sinch-scopes.yml
  title: ''
  type: OAuthScopes
...
overview: 'Sinch publishes 35 APIs on the [APIs.io](https://apis.io/) network, including Access Control Lists API, Active Numbers API, Applications API, and 32 more. Tagged areas include Communications, Messaging, SMS, Voice, and Verification.
  ...
  Sinch''s developer surface includes authentication, documentation, pricing, engineering blog, support, signup flow, and 15 more developer resources.'
plans:
