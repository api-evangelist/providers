...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/state-employees-credit-union/refs/heads/main/security/state-employees-credit-union-domain-security.yml
  title: ''
  type: DomainSecurity
