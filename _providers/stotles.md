...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/stotles/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
...
- group: auth
  ...
  url: https://app.eu.vanta.com/stotles.com/trust/xpcnkioxgcvk0i3qd7fm
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/stotles/refs/heads/main/conformance/stotles-conformance.yml
  title: ''
  type: Conformance
  url: conformance/stotles-conformance.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/stotles/refs/heads/main/security/stotles-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/stotles-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/stotles/refs/heads/main/llms/stotles-llms.txt
  title: ''
  type: LLMsTxt
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/stotles/refs/heads/main/security/stotles-trust-center.yml
  title: ''
  type: TrustCenter
...
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/stotles/refs/heads/main/packages/stotles-packages.yml
  title: ''
  type: Packages
  url: packages/stotles-packages.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/stotles/refs/heads/main/plans/stotles-plans-pricing.yml
  title: ''
  type: Plans
...
nav: Providers
network: true
overview: 'Stotles publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Buyers API, Frameworks API, Notices API, and 2 more. Tagged areas include Company, Procurement, Public Sector, Government, and Tenders.
