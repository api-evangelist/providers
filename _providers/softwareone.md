...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/softwareone/refs/heads/main/security/softwareone-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'SoftwareOne publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Items API, Listings API, Media API, and 5 more. Tagged areas include Marketplace, Software Procurement, Cloud Management, License Management, and Software-as-a-Service.
