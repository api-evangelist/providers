...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://www.flatlooker.com/'', ''status'': 301, ''note'': ''declared website redirects to https://www.manda.fr/ — a different registrable domain (flatlooker.com -> manda.fr), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/flatlooker/refs/heads/main/security/flatlooker-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/flatlooker-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/flatlooker/refs/heads/main/llms/flatlooker-llms.txt
  title: ''
  type: LLMsTxt
