...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/sonar/refs/heads/main/agentic-access/sonar-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/sonar-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sonar/refs/heads/main/security/sonar-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/sonar-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sonar/refs/heads/main/authentication/sonar-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sonar/refs/heads/main/vocabulary/sonar-vocabulary.yml
...
nav: Providers
network: true
overview: 'Sonar publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Issues API, Measures API, Organizations API, and 3 more. Tagged areas include CI/CD, Code Quality, Developer Tools, DevOps, and Security.
