...
- baseURL: https://api.cubesoftware.com
  baseurl_source: declared
  description: The Chat Messages API from Cube — 2 operation(s) for chat messages.
  name: Cube Chat Messages API
  slug: cubesoftware-chat-messages-api
- baseURL: https://api.cubesoftware.com
  baseurl_source: declared
  description: The Chat Sessions API from Cube — 2 operation(s) for chat sessions.
  name: Cube Chat Sessions API
  slug: cubesoftware-chat-sessions-api
- baseURL: https://api.cubesoftware.com
  baseurl_source: declared
  description: The Content Type API from Cube — 2 operation(s) for content type.
  name: Cube Content Type API
  slug: cubesoftware-content-type-api
- baseURL: https://api.cubesoftware.com
  baseurl_source: declared
  description: The Permission Sets API from Cube — 2 operation(s) for permission sets.
  name: Cube Permission Sets API
...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/cubesoftware/refs/heads/main/capabilities/cubesoftware-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cubesoftware/refs/heads/main/authentication/cubesoftware-authentication.yml
  title: ''
  type: Authentication
  url: authentication/cubesoftware-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cubesoftware/refs/heads/main/scopes/cubesoftware-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/cubesoftware-scopes.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cubesoftware/refs/heads/main/well-known/cubesoftware-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/cubesoftware-well-known.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cubesoftware/refs/heads/main/mcp/cubesoftware-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/cubesoftware-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cubesoftware/refs/heads/main/llms/cubesoftware-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/cubesoftware-llms.txt
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/cubesoftware/refs/heads/main/overlays/cubesoftware-openapi-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/cubesoftware-openapi-overlay.yaml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cubesoftware/refs/heads/main/conformance/cubesoftware-conformance.yml
  title: ''
  type: Conformance
  url: conformance/cubesoftware-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cubesoftware/refs/heads/main/errors/cubesoftware-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/cubesoftware-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cubesoftware/refs/heads/main/lifecycle/cubesoftware-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/cubesoftware-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cubesoftware/refs/heads/main/conventions/cubesoftware-conventions.yml
  title: ''
  type: Conventions
  url: conventions/cubesoftware-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cubesoftware/refs/heads/main/data-model/cubesoftware-data-model.yml
  title: ''
  type: DataModel
  url: data-model/cubesoftware-data-model.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cubesoftware/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cubesoftware/refs/heads/main/agentic-access/cubesoftware-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/cubesoftware-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cubesoftware/refs/heads/main/security/cubesoftware-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/cubesoftware-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cubesoftware/refs/heads/main/security/cubesoftware-domain-security.yml
  title: ''
  type: DomainSecurity
