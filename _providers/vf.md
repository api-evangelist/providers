...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/vf/refs/heads/main/security/vf-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/vf-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/vf-corporation
- group: company
  title: ''
  type: Website
...
- group: start
  title: ''
  type: Portal
  url: https://www.vfc.com/brands
- group: start
  title: ''
  type: Portal
  url: https://www.vfc.com/suppliers
- group: company
  title: ''
  type: Blog
  url: https://www.vfc.com/investors/news-events-presentations/press-releases/rss
created: '2024-01-01'
description: VF Corporation is a global apparel and footwear company headquartered in Denver, Colorado. VF owns major brands including Vans, The North Face, Timberland, Altra, Eastpak, Icebreaker, JanSport, Kipling, Napapijri, and Smartwool. The company does not offer a public developer API program; its technology integrations are handled through third-party e-commerce platforms and enterprise supply chain systems. VF Corporation operates more than 1,500 stores globally and integrates with platforms such as Shopify, Amazon, Magento, WooCommerce, and BigCommerce via third-party integration services.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/vf.png
layout: provider
modified: '2026-05-03'
name: VF Corporation
nav: Providers
network: true
overview: 'VF Corporation is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Apparel, Fashion, Retail, E-Commerce, and Footwear.
