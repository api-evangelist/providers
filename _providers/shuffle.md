...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/shuffle/refs/heads/main/agentic-access/shuffle-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/shuffle-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/shuffle/refs/heads/main/security/shuffle-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/shuffle-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/shuffle/refs/heads/main/security/shuffle-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/shuffle-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/shuffle/refs/heads/main/authentication/shuffle-authentication.yml
  title: ''
  type: Authentication
...
overview: 'Shuffle publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Administration API, Apps API, Datastore API, and 6 more. Tagged areas include Security, Workflows, Automation, SOAR, and Orchestration.
  ...
  Shuffle''s developer surface includes authentication and 6 more developer resources.'
plans:
