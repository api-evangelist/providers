...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/filevine/refs/heads/main/agentic-access/filevine-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/filevine-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/filevine/refs/heads/main/security/filevine-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/filevine-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/filevine/refs/heads/main/security/filevine-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/filevine-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/filevine/refs/heads/main/security/filevine-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/filevine-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/filevine/refs/heads/main/authentication/filevine-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/filevine/refs/heads/main/plans/filevine-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/filevine-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/filevine/refs/heads/main/rate-limits/filevine-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/filevine-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/filevine/refs/heads/main/finops/filevine-finops.yml
  title: ''
  type: FinOps
  url: finops/filevine-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/filevine/refs/heads/main/vocabulary/filevine-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/filevine-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/filevine/refs/heads/main/rules/filevine-rules.yml
  title: ''
  type: SpectralRules
...
overview: 'Filevine publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Identity API, Projects API, Contacts API, and 6 more. Tagged areas include Legal, Case Management, Matters, Intake, and Documents.
  ...
  Filevine''s developer surface includes authentication, developer portal, documentation, pricing, engineering blog, support, code examples, and 37 more developer resources.'
plans:
