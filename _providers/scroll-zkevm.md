...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/scroll-zkevm/refs/heads/main/agentic-access/scroll-zkevm-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/scroll-zkevm-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/scroll-zkevm/refs/heads/main/security/scroll-zkevm-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Scroll publishes 9 APIs on the [APIs.io](https://apis.io/) network, including JSON-RPC API, and 8 more. Tagged areas include zkEVM, Layer 2, Ethereum, Rollup, and Zero Knowledge.
