...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cansinotech/refs/heads/main/security/cansinotech-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: cansinotech is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Biopharmaceutical, Vaccines, Healthcare, and Life Sciences.
random_paper: 1
score:
  band: minimal
  composite: 3.3
