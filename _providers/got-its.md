...
- group: company
  title: ''
  type: Website
  url: https://reelables.com
- group: start
  title: ''
  type: DeveloperPortal
  url: https://docs.reelables.com/
- group: docs
  title: ''
  type: Documentation
  url: https://docs.reelables.com/
...
- group: start
  title: ''
  type: GettingStarted
  url: https://docs.reelables.com/topic/topic-getting-started
- group: operate
  title: ''
  type: Support
  url: mailto:support@reelables.com
- group: start
  title: ''
  type: SignUp
  url: https://app.reelables.com/
- group: start
  title: ''
  type: Login
  url: https://app.reelables.com/
...
created: '2026-07-17'
description: Reelables provides Track Anywhere smart labels and a RESTful platform API for global supply-chain and logistics visibility. The paper-thin Bluetooth and cellular smart labels are printed on off-the-shelf barcode printers, activated, attached to assets, and tracked in real time across a network of devices and gateways. The Reelables API lets developers manage Workspaces, Assets, Labels, Spaces, Gateways, Consignments, Facilities, Printers and Print Jobs, and read location, temperature and facility history for tracked assets. A separate Gateway API lets partner devices push label-data and snapshots into the platform. Reelables is a 500 Global portfolio company (surfaced in this network under the stub slug "got-its").
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/got-its.png
layout: provider
mcp_servers:
- description: Hosted Model Context Protocol server auto-generated by Bump.sh from the Reelables API OpenAPI (v1.3.11). Exposes the documented REST operations as MCP tools. Endpoint responds to POST (HTTP 405 on GET
  name: Reelables MCP Server
  slug: reelables-mcp-server
modified: '2026-07-19'
name: Reelables
nav: Providers
network: true
overview: 'Reelables publishes 24 APIs on the [APIs.io](https://apis.io/) network, including Asset Facilities API, Asset Labels API, Asset Locations API, and 21 more. Tagged areas include Company, Supply Chain, Logistics, Asset Tracking, and IoT.
  ...
  Reelables'' developer surface includes authentication, documentation, API reference, getting-started guide, support, signup flow, changelog, and 17 more developer resources.'
random_paper: 18
scopes:
- name: Got Its Scopes
  scope_count: 1
