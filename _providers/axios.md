...
access_model:
  ...
  source:
  - plans
  - '{''url'': ''https://axios-http.com'', ''status'': 301, ''note'': ''declared website redirects to https://axios.rest/ — a different registrable domain (axios-http.com -> axios.rest), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/axios/refs/heads/main/security/axios-domain-security.yml
  title: ''
  type: DomainSecurity
