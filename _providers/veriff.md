...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/veriff/refs/heads/main/agentic-access/veriff-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/veriff-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/veriff/refs/heads/main/security/veriff-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/veriff-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/veriff/refs/heads/main/security/veriff-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/veriff-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/veriff/refs/heads/main/authentication/veriff-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/veriff/refs/heads/main/plans/veriff-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/veriff-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/veriff/refs/heads/main/rate-limits/veriff-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/veriff-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/veriff/refs/heads/main/finops/veriff-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Veriff publishes 15 APIs on the [APIs.io](https://apis.io/) network, including Attempts API, Decisions API, Media API, and 12 more. Tagged areas include KYC, Identity Verification, Biometrics, Fraud Prevention, and AML.
