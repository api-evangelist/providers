...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/pubchem/refs/heads/main/agentic-access/pubchem-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/pubchem-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pubchem/refs/heads/main/security/pubchem-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/pubchem/refs/heads/main/plans/plans.yml
  title: ''
  type: Plans
  url: plans/plans.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/pubchem/refs/heads/main/rate-limits/rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/pubchem/refs/heads/main/finops/finops.yml
  title: ''
  type: FinOps
...
overview: 'PubChem publishes 3 APIs on the [APIs.io](https://apis.io/) network: Compounds API, Structure Search API, and Utilities API. Tagged areas include Chemistry, Chemical Compounds, Drug Discovery, Bioassay, and Life Sciences.
  ...
  PubChem''s developer surface includes status page, support, signup flow, GitHub presence, engineering blog, documentation, FAQ, and 9 more developer resources.'
plans:
- name: Plans
  plan_count: 2
  slug: plans
