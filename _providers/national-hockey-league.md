...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/national-hockey-league/refs/heads/main/agentic-access/national-hockey-league-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/national-hockey-league-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/national-hockey-league/refs/heads/main/security/national-hockey-league-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: National Hockey League publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Game Center API, Players API, Schedule API, and 6 more. Tagged areas include Sports, Hockey, Entertainment, and Professional League.
random_paper: 14
score:
  band: emerging
  composite: 14.8
