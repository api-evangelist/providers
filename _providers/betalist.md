...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/betalist/refs/heads/main/security/betalist-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: docs
  ...
  url: https://gist.github.com/marckohlbrugge/5a29bf1ba628bb4ca960
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/betalist/refs/heads/main/authentication/betalist-authentication.yml
  title: ''
  type: Authentication
  url: authentication/betalist-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/betalist/refs/heads/main/conventions/betalist-conventions.yml
  title: ''
  type: Conventions
  url: conventions/betalist-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/betalist/refs/heads/main/data-model/betalist-data-model.yml
  title: ''
  type: DataModel
  url: data-model/betalist-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/betalist/refs/heads/main/lifecycle/betalist-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/betalist-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/betalist/refs/heads/main/conformance/betalist-conformance.yml
  title: ''
  type: Conformance
  url: conformance/betalist-conformance.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/betalist/refs/heads/main/plans/betalist-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/betalist-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/betalist/refs/heads/main/rate-limits/betalist-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/betalist-rate-limits.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/betalist/refs/heads/main/packages/betalist-packages.yml
  title: ''
  type: Packages
  url: packages/betalist-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/betalist/refs/heads/main/llms/betalist-llms.txt
  title: ''
  type: LLMsTxt
