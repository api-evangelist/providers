...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://yplanapp.com'', ''status'': 301, ''note'': ''declared website redirects to https://checkout.timeout.com/ — a different registrable domain (yplanapp.com -> timeout.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
api_count: 0
artifact_total: 1
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/yplanapp/refs/heads/main/security/yplanapp-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/yplanapp-domain-security.yml
- group: company
  title: ''
  type: Website
