...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-monitoring/refs/heads/main/agentic-access/google-cloud-monitoring-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-cloud-monitoring-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-monitoring/refs/heads/main/security/google-cloud-monitoring-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-cloud-monitoring-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-monitoring/refs/heads/main/security/google-cloud-monitoring-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-monitoring/refs/heads/main/json-ld/json-ld.yml
  title: ''
  type: JSONLDContext
...
overview: 'Google Cloud Monitoring publishes 1 API on the [APIs.io](https://apis.io/) network: Projects API. Tagged areas include Alerting, Dashboards, Google Cloud, Metrics, and Monitoring.
  ...
  Google Cloud Monitoring''s developer surface includes developer portal, getting-started guide, documentation, authentication, pricing, support, and 10 more developer resources.'
plans:
