...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/dr-pepper-snapple-group/refs/heads/main/security/dr-pepper-snapple-group-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/dr-pepper-snapple-group-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
...
- group: company
  title: ''
  type: About
  url: https://www.keurigdrpepper.com/about-us
- group: other
  title: ''
  type: Sustainability
  url: https://www.keurigdrpepper.com/our-impact
- group: company
  title: ''
  type: InvestorRelations
  url: https://investors.keurigdrpepper.com
- group: company
  title: ''
  type: Careers
...
- group: company
  title: ''
  type: Blog
  url: https://www.keurigdrpepper.com/feed
created: '2026-03-24'
description: Dr Pepper Snapple Group was an integrated brand owner, manufacturer, and distributor of nonalcoholic beverages in the United States, Canada, Mexico, and the Caribbean. In 2018 the company merged with Keurig Green Mountain to form Keurig Dr Pepper, a leading beverage company in North America with a portfolio of more than 150 brands including Dr Pepper, 7UP, Snapple, Canada Dry, Keurig, and Peet's Coffee.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/dr-pepper-snapple-group.png
layout: provider
modified: '2026-04-28'
name: Keurig Dr Pepper (formerly Dr Pepper Snapple Group)
nav: Providers
network: true
overview: 'Keurig Dr Pepper (formerly Dr Pepper Snapple Group) is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Beverages, Consumer Packaged Goods, Fortune 500, and Food and Beverage.
...
- kind: domain-security
  name: Dr Pepper Snapple Group Domain Security
  slug: dr-pepper-snapple-group-domain-security
  summary_line: TLSv1.3 · DMARC
slug: dr-pepper-snapple-group
tags:
- Beverages
