...
nav: Providers
network: true
overview: 'Agent Failure Mode Registry publishes 1 API on the [APIs.io](https://apis.io/) network: AFMR Discovery API. Tagged areas include Company, AI Agents, Agent Governance, Standards, and Reputation.
