...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/vesper/refs/heads/main/agentic-access/vesper-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/vesper-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/vesper/refs/heads/main/security/vesper-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Vesper Finance publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Pools API, Rates API, TVL API, and 3 more. Tagged areas include DeFi, Yield Aggregator, Liquidity Pools, APY, and Staking.
