...
common:
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/nexhealth/refs/heads/main/plans/nexhealth-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/nexhealth-plans-pricing.yml
- group: other
...
- group: operate
  title: ''
  type: StatusPage
  url: https://status.nexhealth.com
- group: operate
  title: ''
  type: Deprecation
...
- group: start
  ...
  url: https://developers.nexhealth.com
- group: docs
  title: ''
  type: Documentation
  url: https://docs.nexhealth.com
- group: docs
  title: ''
  type: APIReference
  url: https://docs.nexhealth.com/reference/introduction
- group: start
  title: ''
  type: GettingStarted
  url: https://docs.nexhealth.com/docs/getting-started
- group: operate
  title: ''
  type: Support
  url: https://docs.nexhealth.com/reference/contact-us-1
- group: company
  title: ''
  type: Blog
  url: https://www.nexhealth.com/blog
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/nexhealth
- group: commercial
  title: ''
  type: Pricing
  url: https://www.nexhealth.com/pricing
- group: start
  title: ''
  type: SignUp
  url: https://developers.nexhealth.com/signup
- group: commercial
  title: ''
  type: TermsOfService
  url: https://www.nexhealth.com/terms-of-service
- group: commercial
  title: ''
  type: PrivacyPolicy
...
- group: build
  title: ''
  type: Postman
  url: https://god.gw.postman.com/run-collection/19774779-358d4afa-f4b1-4aac-8167-2d73f9a92882
- group: company
  title: ''
  type: Website
...
nav: Providers
network: true
overview: 'NexHealth publishes 33 APIs on the [APIs.io](https://apis.io/) network, including Adjustment Types API, Adjustments API, Appointment Types API, and 30 more. Tagged areas include Company, Healthcare, EHR, Practice Management, and Scheduling.


  The NexHealth catalog on APIs.io includes 1 event-driven AsyncAPI specification.


  NexHealth''s developer surface includes authentication, changelog, sandbox, documentation, API reference, getting-started guide, support, and 30 more developer resources.'
plans:
- name: Nexhealth Plans Pricing
  plan_count: 1
  slug: nexhealth-plans-pricing
random_paper: 15
score:
  band: strong
  composite: 54.7
...
- kind: trust-center
  name: Nexhealth Trust Center
  slug: nexhealth-trust-center
