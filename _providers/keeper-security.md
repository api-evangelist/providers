...
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/keeper-security/refs/heads/main/packages/keeper-security-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/keeper-security-packages.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/keeper-security/refs/heads/main/cli/keeper-security-cli.yml
  title: ''
  type: CLI
  url: cli/keeper-security-cli.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/keeper-security/refs/heads/main/well-known/keeper-security-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/keeper-security-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/keeper-security/refs/heads/main/well-known/keeper-security-security.txt
  title: ''
  type: SecurityTxt
  url: well-known/keeper-security-security.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/keeper-security/refs/heads/main/security/keeper-security-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/keeper-security-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/keeper-security/refs/heads/main/security/keeper-security-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/keeper-security-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/keeper-security/refs/heads/main/security/keeper-security-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/keeper-security-trust-center.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/keeper-security/refs/heads/main/conformance/keeper-security-conformance.yml
  title: ''
  type: Conformance
  url: conformance/keeper-security-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/keeper-security/refs/heads/main/lifecycle/keeper-security-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/keeper-security-lifecycle.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/keeper-security/refs/heads/main/llms/keeper-security-llms.txt
  title: ''
  type: LLMsTxt
