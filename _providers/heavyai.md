...
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/heavyai/refs/heads/main/changelog/heavyai-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/heavyai-changelog.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/heavyai/refs/heads/main/llms/heavyai-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/heavyai-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/heavyai/refs/heads/main/mcp/heavyai-mcp.yml
  title: ''
  type: MCPServer
  url: mcp/heavyai-mcp.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/heavyai/refs/heads/main/packages/heavyai-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/heavyai-packages.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/heavyai/refs/heads/main/cli/heavyai-cli.yml
  title: ''
  type: CLI
  url: cli/heavyai-cli.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/heavyai/refs/heads/main/authentication/heavyai-authentication.yml
  title: ''
  type: Authentication
  url: authentication/heavyai-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/heavyai/refs/heads/main/lifecycle/heavyai-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/heavyai-lifecycle.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/heavyai/refs/heads/main/well-known/heavyai-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/heavyai-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/heavyai/refs/heads/main/security/heavyai-domain-security.yml
  title: ''
  type: DomainSecurity
