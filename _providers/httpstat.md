...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/httpstat/refs/heads/main/agentic-access/httpstat-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/httpstat-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/httpstat/refs/heads/main/security/httpstat-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Httpstat.us publishes 2 APIs on the [APIs.io](https://apis.io/) network: Httpstat API and Random API. Tagged areas include HTTP, Status-Codes, Testing, and Developer Tools.
