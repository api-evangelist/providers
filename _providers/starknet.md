...
- group: operate
  title: ''
  type: IssueTracker
  url: https://github.com/starkware-libs/starknet-specs/issues
- group: operate
  title: ''
  type: Releases
  url: https://github.com/starkware-libs/starknet-specs/releases
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/starknet/refs/heads/main/agentic-access/starknet-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/starknet-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/starknet/refs/heads/main/security/starknet-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Starknet publishes 13 APIs on the [APIs.io](https://apis.io/) network, including JSON-RPC Specification, JSON RPC API, and 11 more. Tagged areas include Layer 2, Ethereum, Validity Rollup, ZK, and Cairo.


  The Starknet catalog on APIs.io includes 1 event-driven AsyncAPI specification and 1 Spectral governance ruleset.


  Starknet''s developer surface includes documentation, engineering blog, and 14 more developer resources.'
plans:
