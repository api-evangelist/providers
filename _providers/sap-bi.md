...
- collection_type: open
  name: SAP Business Intelligence SAP BusinessObjects BI Platform REST API
  slug: open-sap-bi-businessobjects-platform
- collection_type: open
...
- group: agent
  ...
  title: ''
  type: AgenticAccess
  url: agentic-access/sap-bi-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sap-bi/refs/heads/main/security/sap-bi-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/sap-bi-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sap-bi/refs/heads/main/security/sap-bi-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/sap-bi-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sap-bi/refs/heads/main/authentication/sap-bi-authentication.yml
  title: ''
  type: Authentication
  url: authentication/sap-bi-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sap-bi/refs/heads/main/scopes/sap-bi-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/sap-bi-scopes.yml
- group: build
  title: ''
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/sap-bi/refs/heads/main/openapi/_original/sap-bi-analytics-cloud-openapi.yml
  title: ''
  type: OpenAPI
  url: openapi/_original/sap-bi-analytics-cloud-openapi.yml
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/sap-bi/refs/heads/main/openapi/_original/sap-bi-businessobjects-platform-openapi.yml
  title: ''
  type: OpenAPI
  url: openapi/_original/sap-bi-businessobjects-platform-openapi.yml
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/sap-bi/refs/heads/main/openapi/_original/sap-bi-bw4hana-odata-openapi.yml
  title: ''
  type: OpenAPI
  url: openapi/_original/sap-bi-bw4hana-odata-openapi.yml
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/sap-bi/refs/heads/main/openapi/_original/sap-bi-datasphere-openapi.yml
  title: ''
  type: OpenAPI
  url: openapi/_original/sap-bi-datasphere-openapi.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sap-bi/refs/heads/main/json-ld/sap-bi-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/sap-bi-context.jsonld
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/sap-bi/refs/heads/main/json-schema/sap-bi-story-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/sap-bi-story-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/sap-bi/refs/heads/main/json-schema/sap-bi-report-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/sap-bi-report-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/sap-bi/refs/heads/main/json-schema/sap-bi-data-source-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/sap-bi-data-source-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sap-bi/refs/heads/main/json-structure/sap-bi-story-structure.json
  title: ''
  type: JSONStructure
  url: json-structure/sap-bi-story-structure.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sap-bi/refs/heads/main/json-structure/sap-bi-space-structure.json
  title: ''
  type: JSONStructure
  url: json-structure/sap-bi-space-structure.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sap-bi/refs/heads/main/rules/sap-bi-rules.yml
  title: ''
  type: SpectralRules
  url: rules/sap-bi-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sap-bi/refs/heads/main/vocabulary/sap-bi-vocabulary.yml
  title: ''
  type: Vocabulary
...
examples:
- key_count: 2
  name: Sap Bi List Spaces Example
  slug: sap-bi-list-spaces-example
- key_count: 2
  name: Sap Bi List Stories Example
  slug: sap-bi-list-stories-example
finops:
- name: Sap Bi Finops
...
- name: BOBJUser
  property_count: 6
  slug: sap-bi-bobjuser
- name: BwDimension
  property_count: 4
  slug: sap-bi-bwdimension
- name: BwDimensionCollection
  property_count: 1
  slug: sap-bi-bwdimensioncollection
- name: BwQuery
  property_count: 5
  slug: sap-bi-bwquery
- name: CatalogAsset
  property_count: 8
  slug: sap-bi-catalogasset
- name: CatalogAssetCollection
  property_count: 2
  slug: sap-bi-catalogassetcollection
- name: CatalogEntry
  property_count: 5
  slug: sap-bi-catalogentry
- name: CatalogEntryCollection
  property_count: 1
  slug: sap-bi-catalogentrycollection
- name: Connection
  property_count: 6
  slug: sap-bi-connection
- name: ConnectionCollection
  property_count: 1
  slug: sap-bi-connectioncollection
- name: CreateConnectionRequest
  property_count: 4
  slug: sap-bi-createconnectionrequest
- name: CreateImportJobRequest
  property_count: 2
  slug: sap-bi-createimportjobrequest
- name: CreateModelRequest
  property_count: 3
  slug: sap-bi-createmodelrequest
- name: CreateScheduleRequest
  property_count: 5
  slug: sap-bi-createschedulerequest
- name: CreateSpaceRequest
  property_count: 4
  slug: sap-bi-createspacerequest
- name: CreateStoryRequest
  property_count: 3
  slug: sap-bi-createstoryrequest
- name: SAP BI Data Source
  property_count: 16
  slug: sap-bi-data-source
- name: DataFlow
  property_count: 9
  slug: sap-bi-dataflow
- name: DataFlowCollection
  property_count: 1
  slug: sap-bi-dataflowcollection
- name: DataProvider
  property_count: 4
  slug: sap-bi-dataprovider
- name: DataProviderCollection
  property_count: 1
  slug: sap-bi-dataprovidercollection
- name: DataStoreObject
  property_count: 6
  slug: sap-bi-datastoreobject
- name: DataStoreObjectCollection
  property_count: 1
  slug: sap-bi-datastoreobjectcollection
- name: Dimension
  property_count: 4
  slug: sap-bi-dimension
- name: DimensionCollection
  property_count: 1
  slug: sap-bi-dimensioncollection
- name: Folder
  property_count: 6
  slug: sap-bi-folder
- name: FolderCollection
  property_count: 2
  slug: sap-bi-foldercollection
- name: ImportJob
  property_count: 7
  slug: sap-bi-importjob
- name: ImportJobCollection
  property_count: 1
  slug: sap-bi-importjobcollection
- name: InfoObject
  property_count: 9
  slug: sap-bi-infoobject
- name: InfoObjectCollection
  property_count: 2
  slug: sap-bi-infoobjectcollection
- name: InfoProvider
  property_count: 8
  slug: sap-bi-infoprovider
- name: InfoProviderCollection
  property_count: 1
  slug: sap-bi-infoprovidercollection
- name: Instance
  property_count: 6
  slug: sap-bi-instance
- name: InstanceCollection
  property_count: 2
  slug: sap-bi-instancecollection
- name: KeyFigure
  property_count: 5
  slug: sap-bi-keyfigure
- name: KeyFigureCollection
  property_count: 1
  slug: sap-bi-keyfigurecollection
- name: LogonRequest
  property_count: 3
  slug: sap-bi-logonrequest
- name: LogonResponse
  property_count: 1
  slug: sap-bi-logonresponse
- name: Measure
  property_count: 4
  slug: sap-bi-measure
- name: MeasureCollection
  property_count: 1
  slug: sap-bi-measurecollection
- name: Model
  property_count: 9
  slug: sap-bi-model
- name: ModelCollection
  property_count: 2
  slug: sap-bi-modelcollection
- name: Page
  property_count: 3
  slug: sap-bi-page
- name: Parameter
  property_count: 6
  slug: sap-bi-parameter
- name: ParameterCollection
  property_count: 1
  slug: sap-bi-parametercollection
- name: ProcessChain
  property_count: 5
  slug: sap-bi-processchain
- name: ProcessChainCollection
  property_count: 1
  slug: sap-bi-processchaincollection
- name: ProcessChainRun
  property_count: 3
  slug: sap-bi-processchainrun
- name: QueryCollection
  property_count: 1
  slug: sap-bi-querycollection
- name: QueryExecutionRequest
  property_count: 1
  slug: sap-bi-queryexecutionrequest
- name: QueryResult
  property_count: 1
  slug: sap-bi-queryresult
- name: SAP BusinessObjects Report
  property_count: 12
  slug: sap-bi-report
- name: Schedule
  property_count: 6
  slug: sap-bi-schedule
- name: ScheduleCollection
  property_count: 1
  slug: sap-bi-schedulecollection
- name: Server
  property_count: 7
  slug: sap-bi-server
- name: ServerCollection
  property_count: 1
  slug: sap-bi-servercollection
- name: Space
  property_count: 10
  slug: sap-bi-space
- name: SpaceCollection
  property_count: 2
  slug: sap-bi-spacecollection
- name: SpaceMember
  property_count: 2
  slug: sap-bi-spacemember
- name: SAP Analytics Cloud Story
  property_count: 10
  slug: sap-bi-story
- name: StoryCollection
  property_count: 2
  slug: sap-bi-storycollection
- name: TaskRun
  property_count: 7
  slug: sap-bi-taskrun
- name: TaskRunCollection
  property_count: 2
  slug: sap-bi-taskruncollection
- name: UpdateInfoObjectRequest
  property_count: 2
  slug: sap-bi-updateinfoobjectrequest
- name: UpdateModelRequest
  property_count: 2
  slug: sap-bi-updatemodelrequest
- name: UpdateSpaceRequest
  property_count: 4
  slug: sap-bi-updatespacerequest
- name: UpdateStoryRequest
  property_count: 3
  slug: sap-bi-updatestoryrequest
- name: User
  property_count: 7
  slug: sap-bi-user
- name: UserCollection
  property_count: 2
  slug: sap-bi-usercollection
- name: View
  property_count: 9
  slug: sap-bi-view
- name: ViewCollection
  property_count: 1
  slug: sap-bi-viewcollection
- name: ViewColumn
  property_count: 4
  slug: sap-bi-viewcolumn
- name: Widget
  property_count: 4
  slug: sap-bi-widget
json_structures:
- name: Sap Bi Space Structure
  property_count: 0
  slug: sap-bi-space-structure
- name: Sap Bi Story Structure
  property_count: 0
  slug: sap-bi-story-structure
- name: Sap Bi Structure
  property_count: 0
  slug: sap-bi-structure
jsonld:
- class_count: 0
  name: Sap Bi Context
  property_count: 9
...
- kind: vulnerability-disclosure
  name: Sap Bi Vulnerability Disclosure
  slug: sap-bi-vulnerability-disclosure
