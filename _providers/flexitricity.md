...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/flexitricity/refs/heads/main/security/flexitricity-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/flexitricity-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/flexitricity/refs/heads/main/llms/flexitricity-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/flexitricity-llms.txt
- group: company
  title: ''
  type: Website
  url: https://www.flexitricity.com/
- group: company
  title: ''
  type: About
  url: https://www.flexitricity.com/about
- group: other
  title: ''
  type: OurStory
  url: https://www.flexitricity.com/about/our-story
- group: other
  title: ''
  type: Team
  url: https://www.flexitricity.com/about/our-team
- group: other
  title: ''
  type: Services
  url: https://www.flexitricity.com/services
- group: operate
  title: ''
  type: Contact
  url: https://www.flexitricity.com/contact
- group: other
  title: ''
  type: Product
  url: https://flexgo.energy/
- group: start
  title: ''
  type: Portal
  url: https://portal.flexitricity.com/
- group: start
  title: ''
  type: Login
  url: https://portal.flexitricity.com/login
- group: company
  title: ''
  type: Blog
  url: https://www.flexitricity.com/blog
- group: other
  title: ''
  type: Resources
  url: https://www.flexitricity.com/resources/brochures-white-papers
- group: learn
  title: ''
  type: Videos
  url: https://www.flexitricity.com/videos
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://www.flexitricity.com/legal/privacy-policy
- group: commercial
  title: ''
  type: TermsOfService
  url: https://www.flexitricity.com/legal/terms-conditions
- group: auth
  title: ''
  type: Compliance
  url: https://www.flexitricity.com/legal/license-conditions
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/flexitricity/
- group: learn
  title: ''
  type: YouTube
  url: https://www.youtube.com/user/FlexitricityLtd
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/Flexitricity
created: '2026-07-27'
description: 'Flexitricity Limited is an Edinburgh-based energy flexibility aggregator and licensed electricity supplier operating what it describes as the first, largest and most advanced demand response portfolio in Great Britain — a virtual power plant exceeding 1GW. Founded in 2004 by Dr Alastair Martin, acquired by Alpiq in 2014, merged with Quinbrook''s Velox Power in 2022, and per the company''s own timeline acquired by Drax in 2026, it sits in the value chain between commercial, industrial and aggregated domestic energy assets and the GB wholesale and balancing markets. It routes customer assets — batteries, standby generation, industrial load, hydrogen electrolysers, co-located sites and, through its FlexGO product, residential EV charging — into the Balancing Mechanism, Capacity Market, frequency response, reserve services, the Demand Flexibility Service, DNO flexibility markets and wholesale trading. Its API posture is closed: Flexitricity publishes no developer portal, no documented
...
image: https://cms.flexitricity.com/uploads/icon_fb9283d967.png
layout: provider
modified: '2026-07-27'
name: Flexitricity
nav: Providers
network: true
overview: 'Flexitricity is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Energy, United Kingdom, Utilities, Electricity, and Demand Response.
