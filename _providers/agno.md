...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/agno/refs/heads/main/agentic-access/agno-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/agno-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/agno/refs/heads/main/security/agno-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/agno-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/agno/refs/heads/main/authentication/agno-authentication.yml
  title: ''
  type: Authentication
  url: authentication/agno-authentication.yml
- group: company
  title: ''
  type: Website
...
examples:
- key_count: 4
  name: Agno Agentos Api Examples
  slug: agno-agentos-api-examples
finops:
- name: Agno Finops
  service_category: ''
  slug: agno-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/agno.png
json_schemas:
- name: AgentResponse
  property_count: 22
  slug: agno-agent-response
- name: AgentSessionDetailSchema
  property_count: 14
  slug: agno-agent-session
...
- name: TraceDetail
  property_count: 19
  slug: agno-trace-detail
- name: UserMemorySchema
  property_count: 7
  slug: agno-user-memory
jsonld:
- class_count: 14
  name: Agno Context
  property_count: 37
