...
- acting_count: 49
  ...
  summary_line: 142 operations · 49 acting · 6 human-in-the-loop
api_count: 2
apis:
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/mexc/refs/heads/main/agentic-access/mexc-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/mexc-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mexc/refs/heads/main/security/mexc-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/mexc-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mexc/refs/heads/main/authentication/mexc-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/mexc/refs/heads/main/plans/mexc-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/mexc-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/mexc/refs/heads/main/rate-limits/mexc-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/mexc-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/mexc/refs/heads/main/finops/mexc-finops.yml
  title: ''
  type: FinOps
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mexc/refs/heads/main/json-ld/mexc-jsonld.json
  title: ''
  type: JSONLD
  url: json-ld/mexc-jsonld.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mexc/refs/heads/main/vocabulary/mexc-vocabulary.json
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'MEXC publishes 12 APIs on the [APIs.io](https://apis.io/) network, including Accounts and Transactions API, EFT API, Margin API, and 9 more. Tagged areas include Cryptocurrency, Exchange, Trading, Futures, and Market Data.


  The MEXC catalog on APIs.io includes 1 Spectral governance ruleset.


  MEXC''s developer surface includes authentication, developer portal, documentation, getting-started guide, status page, support, and 12 more developer resources.'
plans:
