...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/capabilities/dosespot-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/dosespot-capability-edges.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/overlays/dosespot-jumpstart-epcs-v2-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/dosespot-jumpstart-epcs-v2-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/agentic-access/dosespot-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/dosespot-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/security/dosespot-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/dosespot-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/authentication/dosespot-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/plans/dosespot-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/dosespot-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/rate-limits/dosespot-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/dosespot-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/finops/dosespot-finops.yml
  title: ''
  type: FinOps
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/conventions/dosespot-conventions.yml
  title: ''
  type: Conventions
  url: conventions/dosespot-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/errors/dosespot-error-codes.yml
  title: ''
  type: ErrorCatalog
  url: errors/dosespot-error-codes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/lifecycle/dosespot-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/conformance/dosespot-conformance.yml
  title: ''
  type: Conformance
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/security/dosespot-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/dosespot-trust-center.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/data-model/dosespot-data-model.yml
  title: ''
  type: DataModel
  url: data-model/dosespot-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/vocabulary/dosespot-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/dosespot-vocabulary.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/sandbox/dosespot-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/dosespot-sandbox.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/asyncapi/dosespot-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/dosespot-webhooks.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/mcp/dosespot-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/dosespot-mcp.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/packages/dosespot-packages.yml
  title: ''
  type: Packages
  url: packages/dosespot-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/dosespot/refs/heads/main/overlays/dosespot-full-epcs-v2-overlay.yaml
  title: ''
  type: Overlay
