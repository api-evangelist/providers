...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/boundless-bio/refs/heads/main/overlays/boundless-bio-content-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/boundless-bio-content-overlay.yaml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/boundless-bio/refs/heads/main/security/boundless-bio-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/boundless-bio/refs/heads/main/packages/boundless-bio-packages.yml
  title: ''
  type: Packages
  url: packages/boundless-bio-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/boundless-bio/refs/heads/main/llms/boundless-bio-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/boundless-bio-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/boundless-bio/refs/heads/main/well-known/boundless-bio-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/boundless-bio-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/boundless-bio/refs/heads/main/authentication/boundless-bio-authentication.yml
  title: ''
  type: Authentication
  url: authentication/boundless-bio-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/boundless-bio/refs/heads/main/conventions/boundless-bio-conventions.yml
  title: ''
  type: Conventions
  url: conventions/boundless-bio-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/boundless-bio/refs/heads/main/conformance/boundless-bio-conformance.yml
  title: ''
  type: Conformance
  url: conformance/boundless-bio-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/boundless-bio/refs/heads/main/lifecycle/boundless-bio-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/boundless-bio-lifecycle.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/boundless-bio/refs/heads/main/agentic-access/boundless-bio-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/boundless-bio-agentic-access.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/boundless-bio/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
