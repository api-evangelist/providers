...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/bithumb/refs/heads/main/agentic-access/bithumb-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/bithumb-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bithumb/refs/heads/main/security/bithumb-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/bithumb-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bithumb/refs/heads/main/authentication/bithumb-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Bithumb publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Account API, General API, Market Data API, and 3 more. Tagged areas include Cryptocurrency, Exchange, Trading, South Korea, and KRW.
