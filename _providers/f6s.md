...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/f6s/refs/heads/main/security/f6s-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/f6s-domain-security.yml
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/f6s
- group: company
  title: ''
  type: Website
...
- group: company
  title: ''
  type: About
  url: https://www.f6s.com/about
- group: docs
  title: ''
  type: Documentation
  url: https://developers.f6s.com/
- group: start
  title: ''
  type: Portal
...
- group: start
  title: ''
  type: Signup
  url: https://www.f6s.com/register
- group: start
  title: ''
  type: Login
  url: https://www.f6s.com/login
- group: commercial
  title: ''
  type: TermsOfService
  url: https://www.f6s.com/terms-of-service
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://www.f6s.com/privacy-policy
- group: company
  title: ''
  type: Blog
  url: https://www.f6s.com/blog
- group: other
  title: ''
  type: X
  url: https://twitter.com/f6s
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/f6s
- group: company
  title: ''
  type: Facebook
  url: https://www.facebook.com/p/F6S-100063671786141/
created: '2026-03-24'
...
- name: F6S Finops
  ...
  slug: f6s-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/f6s.png
layout: provider
modified: '2026-04-28'
name: F6S
nav: Providers
