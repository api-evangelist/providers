...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/returnly/refs/heads/main/security/returnly-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: Returnly is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Fintech, E-Commerce, Returns, and Exchange.
random_paper: 21
score:
  band: minimal
  composite: 1.5
