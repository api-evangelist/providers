...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-play/refs/heads/main/agentic-access/google-play-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-play-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-play/refs/heads/main/security/google-play-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-play-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-play/refs/heads/main/security/google-play-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/google-play-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-play/refs/heads/main/authentication/google-play-authentication.yml
  title: ''
  type: Authentication
  url: authentication/google-play-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-play/refs/heads/main/scopes/google-play-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-play/refs/heads/main/json-ld/json-ld.yml
  title: ''
  type: JSONLD
...
overview: 'Google Play Developer publishes 1 API on the [APIs.io](https://apis.io/) network: Androidpublisher API. Tagged areas include Android, Application, Google Play, In-App Purchases, and Mobile.
  ...
  Google Play Developer''s developer surface includes authentication, getting-started guide, pricing, and 8 more developer resources.'
plans:
