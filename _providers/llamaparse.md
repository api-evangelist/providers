...
- group: build
  ...
  url: https://www.postman.com/kinlaneapi/llamaparse/overview
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/llamaparse/refs/heads/main/agentic-access/llamaparse-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/llamaparse-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/llamaparse/refs/heads/main/security/llamaparse-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/llamaparse-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/llamaparse/refs/heads/main/authentication/llamaparse-authentication.yml
  title: ''
  type: Authentication
  url: authentication/llamaparse-authentication.yml
- group: company
  title: ''
  type: Website
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/llamaparse/refs/heads/main/plans/llamaparse-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/llamaparse-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/llamaparse/refs/heads/main/rate-limits/llamaparse-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/llamaparse-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/llamaparse/refs/heads/main/finops/llamaparse-finops.yml
  title: ''
  type: FinOps
  url: finops/llamaparse-finops.yml
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/llamaparse/refs/heads/main/openapi/_original/llamaparse-llamacloud-openapi.yml
  title: ''
  type: OpenAPI
  url: openapi/_original/llamaparse-llamacloud-openapi.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/llamaparse/refs/heads/main/vocabulary/llamaparse-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/llamaparse-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/llamaparse/refs/heads/main/json-ld/llamaparse-context.jsonld
  title: ''
  type: JSONLDContext
...
examples:
- key_count: 4
  name: Llamaparse Classify Job Response
  slug: llamaparse-classify-job-response
- key_count: 4
  name: Llamaparse Extract Job Request
  slug: llamaparse-extract-job-request
- key_count: 5
  name: Llamaparse Parse Upload Request
  slug: llamaparse-parse-upload-request
finops:
- name: Llamaparse Finops
  service_category: ''
  slug: llamaparse-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/llamaparse.png
json_schemas:
- name: BatchJobCreateRequest
  property_count: 5
  slug: llamaparse-batchjobcreaterequest
- name: BatchJobResponse
  property_count: 17
  slug: llamaparse-batchjobresponse
- name: Body_upload_file_api_v1_parsing_upload_post
  property_count: 113
  slug: llamaparse-body-upload-file-api-v1-parsing-upload-post
- name: ClassifyJob
  property_count: 12
  slug: llamaparse-classifyjob
- name: ClassifyJobCreate
  property_count: 5
  slug: llamaparse-classifyjobcreate
- name: ClassifyJobResults
  property_count: 3
  slug: llamaparse-classifyjobresults
- name: ExtractJob
  property_count: 6
  slug: llamaparse-extractjob
- name: ExtractJobCreate
  property_count: 6
  slug: llamaparse-extractjobcreate
- name: ExtractResultset
  property_count: 4
  slug: llamaparse-extractresultset
- name: SplitCreateRequest
  property_count: 3
  slug: llamaparse-splitcreaterequest
- name: SplitJobResponse
  property_count: 11
  slug: llamaparse-splitjobresponse
- name: SplitResultResponse
  property_count: 1
  slug: llamaparse-splitresultresponse
jsonld:
- class_count: 47
  name: Llamaparse Context
  property_count: 21
  slug: llamaparse-context
layout: provider
modified: '2026-06-12'
name: LlamaParse
nav: Providers
network: true
overview: 'LlamaParse publishes 34 APIs on the [APIs.io](https://apis.io/) network, including Agent Data API, Batch Processing API, Batches API, and 31 more. Tagged areas include Document Parsing, OCR, PDF, LLM, and RAG.
