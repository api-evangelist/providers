...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/overlays/immutable-zkevm-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/immutable-zkevm-overlay.yaml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/overlays/immutable-audience-overlay.yaml
  title: ''
  type: Overlay
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/lifecycle/immutable-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/immutable-lifecycle.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/changelog/immutable-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/immutable-changelog.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/packages/immutable-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/immutable-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/mcp/immutable-mcp.yml
  title: ''
  type: MCPServer
  url: mcp/immutable-mcp.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/mcp/immutable-tool-crosswalk.yml
  title: ''
  type: ToolCrosswalk
  url: mcp/immutable-tool-crosswalk.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/a2a/immutable-a2a.yml
  title: ''
  type: AgentCard
  url: a2a/immutable-a2a.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/llms/immutable-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/immutable-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/well-known/immutable-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/immutable-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/authentication/immutable-authentication.yml
  title: ''
  type: Authentication
  url: authentication/immutable-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/scopes/immutable-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/immutable-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/conventions/immutable-conventions.yml
  title: ''
  type: Conventions
...
- group: design
  ...
  url: conventions/immutable-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/errors/immutable-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/immutable-problem-types.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/rate-limits/immutable-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/immutable-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/plans/immutable-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/immutable-plans-pricing.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/asyncapi/immutable-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/immutable-webhooks.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/sandbox/immutable-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/immutable-sandbox.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/data-model/immutable-data-model.yml
  title: ''
  type: DataModel
  url: data-model/immutable-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/conformance/immutable-conformance.yml
  title: ''
  type: Conformance
...
- group: auth
  ...
  url: conformance/immutable-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/components/immutable-components.yml
  title: ''
  type: Components
  url: components/immutable-components.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/security/immutable-vulnerability-disclosure.yml
  title: ''
  type: Security
...
- group: auth
  ...
  url: security/immutable-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/security/immutable-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/immutable-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/immutable/refs/heads/main/security/immutable-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Immutable publishes 17 APIs on the [APIs.io](https://apis.io/) network, including Activities API, Chains API, Collections API, and 14 more. Tagged areas include Company, Gaming, Blockchain, NFT, and Web3.
