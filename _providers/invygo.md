...
- group: company
  title: ''
  type: Website
  url: https://invygo.com
- group: company
  title: ''
  type: Blog
  url: https://www.invygo.com/default/blog
- group: operate
  title: ''
  type: Support
  url: https://www.invygo.com/default/faq
- group: commercial
  title: ''
  type: Pricing
  url: https://www.invygo.com/en-ae/monthly-subscription
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://www.invygo.com/default/privacy
- group: commercial
  title: ''
  type: TermsOfService
  url: https://www.invygo.com/default/tc
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/invygo/refs/heads/main/security/invygo-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/invygo-domain-security.yml
created: '2026-07-17'
description: Invygo is a car subscription and flexible rental platform founded in 2018 in Dubai, offering an alternative to traditional car ownership across the UAE, Saudi Arabia, and Qatar. Through its iOS and Android apps, customers subscribe to a car on a weekly or monthly basis, or enroll in a 36-month, Sharia-compliant "Subscribe to Own" plan, with insurance, maintenance, registration, and roadside assistance bundled into an all-inclusive fee and no deposit, salary certificate, or bank loan required. Invygo reports 20,000+ active subscriptions across 15+ cities in the GCC. There is no public developer API, OpenAPI, or developer portal at this time; this profile captures the company identity and its public web, legal, and security surface.
image: https://www.invygo.com/assets/images/new/favicon.png
layout: provider
modified: '2026-07-19'
name: Invygo
nav: Providers
network: true
overview: 'Invygo is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Car Subscription, Car Rental, Mobility, and Automotive.
...
- kind: domain-security
  name: Invygo Domain Security
  slug: invygo-domain-security
