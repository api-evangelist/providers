...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/beigene/refs/heads/main/security/beigene-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: BeiGene is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Biotechnology, Pharmaceuticals, Oncology, and Healthcare.
random_paper: 15
score:
  band: minimal
  composite: 3.7
