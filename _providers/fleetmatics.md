...
- group: other
  title: ''
  type: ParentCompany
  url: https://apis.io/providers/verizon/
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/fleetmatics/refs/heads/main/security/fleetmatics-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/fleetmatics/refs/heads/main/llms/fleetmatics-llms.txt
  title: ''
  type: LLMsTxt
...
overview: 'Fleetmatics publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Fleet Management, Telematics, GPS Tracking, Vehicle Tracking, and Fleet Tracking.
  ...
  Fleetmatics'' developer surface includes documentation, API reference, support, and 5 more developer resources.'
random_paper: 3
score:
  band: emerging
  composite: 13.8
