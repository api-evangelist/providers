...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/telefono/refs/heads/main/agentic-access/telefono-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/telefono-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/telefono/refs/heads/main/authentication/telefono-authentication.yml
  title: ''
  type: Authentication
...
overview: 'Telefono publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Batch API, Carrier API, Format API, and 1 more. Tagged areas include Carrier Lookup, Data Enrichment, Fraud Prevention, Number Intelligence, and Number Verification.
  ...
  Telefono''s developer surface includes authentication, getting-started guide, signup flow, pricing, support, GitHub presence, and 7 more developer resources.'
plans:
