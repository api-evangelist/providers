...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/anomaly-detection/refs/heads/main/agentic-access/anomaly-detection-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/anomaly-detection-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/anomaly-detection/refs/heads/main/security/anomaly-detection-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/anomaly-detection-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/anomaly-detection/refs/heads/main/security/anomaly-detection-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/anomaly-detection-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/anomaly-detection/refs/heads/main/authentication/anomaly-detection-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Anomaly Detection publishes 8 APIs on the [APIs.io](https://apis.io/) network, including ChangePoint API, Multivariate API, Univariate API, and 5 more. Tagged areas include Anomaly Detection, Artificial Intelligence, Data Science, Fraud Prevention, and Machine Learning.
