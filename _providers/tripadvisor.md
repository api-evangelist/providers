...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/tripadvisor/refs/heads/main/capabilities/tripadvisor-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/tripadvisor-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/tripadvisor/refs/heads/main/agentic-access/tripadvisor-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/tripadvisor-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tripadvisor/refs/heads/main/security/tripadvisor-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/tripadvisor-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tripadvisor/refs/heads/main/authentication/tripadvisor-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tripadvisor/refs/heads/main/json-ld/tripadvisor-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/tripadvisor-context.jsonld
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/tripadvisor/refs/heads/main/json-schema/tripadvisor-location-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/tripadvisor-location-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/tripadvisor/refs/heads/main/json-schema/tripadvisor-review-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/tripadvisor-review-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/tripadvisor/refs/heads/main/json-schema/tripadvisor-hotel-availability-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/tripadvisor-hotel-availability-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tripadvisor/refs/heads/main/rules/tripadvisor-rules.yml
  title: ''
  type: SpectralRules
  url: rules/tripadvisor-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tripadvisor/refs/heads/main/vocabulary/tripadvisor-vocabulary.yml
  title: ''
  type: Vocabulary
...
overview: 'Tripadvisor publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Availability API, Configuration API, Hotel Inventory API, and 4 more. Tagged areas include Attractions, Hotels, Hospitality, Restaurant, and Reviews.
  ...
  Tripadvisor''s developer surface includes authentication, engineering blog, documentation, signup flow, and 16 more developer resources.'
plans:
