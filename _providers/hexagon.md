...
nav: Providers
network: true
overview: 'Hexagon publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Nexus API, and 4 more. Tagged areas include Manufacturing, Metrology, Quality Inspection, Digital Factory, and Production Monitoring.
