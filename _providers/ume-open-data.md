...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ume-open-data/refs/heads/main/security/ume-open-data-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/ume-open-data-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ume-open-data/refs/heads/main/security/ume-open-data-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: Umeå Open Data publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Open Data, Public APIs, and Sweden.
random_paper: 7
score:
  band: minimal
  composite: 7.7
