...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/wepay/refs/heads/main/security/wepay-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: WePay is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Payments, Payment Processing, Platform Payments, Marketplace, and Fintech.
random_paper: 0
score:
  band: minimal
  composite: 1.5
