...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ticketspice/refs/heads/main/agentic-access/ticketspice-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/ticketspice-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ticketspice/refs/heads/main/security/ticketspice-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/ticketspice-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ticketspice/refs/heads/main/authentication/ticketspice-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/ticketspice/refs/heads/main/plans/ticketspice-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/ticketspice-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/ticketspice/refs/heads/main/rate-limits/ticketspice-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/ticketspice-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/ticketspice/refs/heads/main/finops/ticketspice-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'TicketSpice publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Coupons API, Customers API, Forms API, and 7 more. Tagged areas include Event Ticketing, Ticketing, Event, Registration, and Payments.
