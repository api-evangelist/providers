...
- group: company
  title: ''
  type: Website
  url: https://www.octo.travel/
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/octo/refs/heads/main/agentic-access/octo-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/octo-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/octo/refs/heads/main/security/octo-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/octo-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/octo/refs/heads/main/authentication/octo-authentication.yml
  title: ''
  type: Authentication
...
overview: 'Open Connectivity for Tours, Activities, and Attractions publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Availability API, Bookings API, Products API, and 1 more. Tagged areas include Activities, Attractions, Open Standard, Tours, and Travel.
  ...
  Open Connectivity for Tours, Activities, and Attractions'' developer surface includes authentication, documentation, getting-started guide, support, and 6 more developer resources.'
plans:
