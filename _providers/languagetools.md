...
nav: Providers
network: true
overview: 'LanguageTool publishes 3 APIs on the [APIs.io](https://apis.io/) network: Check API, Languages API, and Words API. Tagged areas include Grammar, Spell Check, Styles, Proofreading, and NLP.
