...
access_model:
  ...
  source:
  - plans
  - '{''url'': ''https://www.ansys.com'', ''status'': 301, ''note'': ''declared website redirects to https://ansys.synopsys.com/ — a different registrable domain (ansys.com -> synopsys.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ansys/refs/heads/main/security/ansys-domain-security.yml
  title: ''
  type: DomainSecurity
