...
- acting_count: 6
  ...
  summary_line: 81 operations · 6 acting · 6 human-in-the-loop
api_count: 1
apis:
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/chainlens/refs/heads/main/agentic-access/chainlens-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/chainlens-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/chainlens/refs/heads/main/security/chainlens-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/chainlens-domain-security.yml
- group: company
  title: ''
  type: Website
...
- group: agent
  title: ''
  type: LlmsText
  url: https://docs.chainlens.com/llms.txt
created: '2024-11-07'
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/chainlens.png
integrations:
- name: Ethereum
...
nav: Providers
network: true
overview: 'Chainlens publishes 38 APIs on the [APIs.io](https://apis.io/) network, including Account-Controller API, Account-Mapping-Controller API, Account-Tokens-Controller API, and 35 more. Tagged areas include Analytics, Blockchain, Block Explorer, Cryptocurrencies, and DeFi.


  Chainlens'' developer surface includes documentation, getting-started guide, signup flow, pricing, engineering blog, GitHub presence, and 10 more developer resources.'
plans:
