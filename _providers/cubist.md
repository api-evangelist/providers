...
- group: docs
  title: ''
  type: Documentation
  url: https://cubist.dev/product-suite
- group: company
  title: ''
  type: Blog
  url: https://cubist.dev/blog
- group: operate
  title: ''
  type: Support
  url: https://cubist.dev/contact
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/cubist-labs
- group: commercial
  title: ''
  type: TermsOfService
  url: https://cubist.dev/legal/terms-and-conditions
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://cubist.dev/legal/privacy-policy
- group: auth
  title: ''
  type: Security
  url: https://cubist.dev/legal/responsible-disclosure
- group: auth
  title: ''
  type: Compliance
  url: https://cubist.dev/product-security
- group: auth
  title: ''
  type: TrustCenter
...
- kind: vulnerability-disclosure
  name: Cubist Vulnerability Disclosure
  slug: cubist-vulnerability-disclosure
