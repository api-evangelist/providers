...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/level-3-communications/refs/heads/main/security/level-3-communications-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/level-3-communications-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/level-3-communications
- group: company
  title: ''
  type: Website
...
- group: company
  title: ''
  type: About
  url: https://en.wikipedia.org/wiki/Level_3_Communications
created: '2026-03-24'
description: Level 3 Communications was a multinational telecommunications and Internet service provider that operated one of the largest fiber networks in the world, delivering Tier-1 IP transit, managed services, and content delivery. In 2017 it was acquired by CenturyLink, which later rebranded the combined company as Lumen Technologies. No public API program is documented under the legacy Level 3 brand.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/level-3-communications.png
layout: provider
modified: '2026-04-28'
