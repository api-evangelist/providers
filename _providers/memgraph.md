...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/memgraph/refs/heads/main/agentic-access/memgraph-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/memgraph-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/memgraph/refs/heads/main/security/memgraph-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/memgraph/refs/heads/main/plans/memgraph-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/memgraph-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/memgraph/refs/heads/main/rate-limits/memgraph-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/memgraph-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/memgraph/refs/heads/main/finops/memgraph-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Memgraph publishes 3 APIs on the [APIs.io](https://apis.io/) network, including Monitoring API, and 2 more. Tagged areas include Graph Database, In-Memory, Cypher, Bolt, and Real-Time.
