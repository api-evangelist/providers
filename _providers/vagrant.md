...
access_model:
  ...
  - authentication
  - security
  - '{''url'': ''https://www.vagrantup.com/'', ''status'': 308, ''note'': ''declared website redirects to https://developer.hashicorp.com/vagrant — a different registrable domain (vagrantup.com -> hashicorp.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: true
agent_readiness:
  band: agent-aware
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/vagrant/refs/heads/main/agentic-access/vagrant-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/vagrant-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/vagrant/refs/heads/main/security/vagrant-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/vagrant-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/vagrant/refs/heads/main/authentication/vagrant-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Vagrant publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Boxes API, Providers API, Registries API, and 4 more. Tagged areas include DevOps, Virtualization, Development Environments, Box, and Cloud.
