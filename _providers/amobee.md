...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/amobee/refs/heads/main/security/amobee-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/amobee-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/amobee/refs/heads/main/security/amobee-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: auth
  ...
  url: security/amobee-vulnerability-disclosure.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/amobee/refs/heads/main/well-known/amobee-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/amobee-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/amobee/refs/heads/main/well-known/amobee-security.txt
  title: ''
  type: SecurityTxt
  url: well-known/amobee-security.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/amobee/refs/heads/main/authentication/amobee-authentication.yml
  title: ''
  type: Authentication
  url: authentication/amobee-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/amobee/refs/heads/main/conventions/amobee-conventions.yml
  title: ''
  type: Conventions
  url: conventions/amobee-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/amobee/refs/heads/main/errors/amobee-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/amobee-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/amobee/refs/heads/main/lifecycle/amobee-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/amobee-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/amobee/refs/heads/main/conformance/amobee-conformance.yml
  title: ''
  type: Conformance
...
- group: auth
  ...
  url: conformance/amobee-conformance.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/amobee/refs/heads/main/packages/amobee-packages.yml
  title: ''
  type: Packages
  url: packages/amobee-packages.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/amobee/refs/heads/main/overlays/amobee-services-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/amobee-services-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/amobee/refs/heads/main/llms/amobee-llms.txt
  title: ''
  type: LLMsTxt
...
nav: Providers
network: true
overview: 'Amobee publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Env Vars Test Controller API, Gateway Swagger Controller API, Health Check API, and 3 more. Tagged areas include Digital Advertising, DSP, Programmatic, Campaign Management, and Audience Targeting.
