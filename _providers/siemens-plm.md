...
nav: Providers
network: true
overview: 'Siemens PLM publishes 49 APIs on the [APIs.io](https://apis.io/) network, including Account API, Administration API, Basic API, and 46 more. Tagged areas include PLM, Product Lifecycle Management, Teamcenter, NX, and Solid Edge.
