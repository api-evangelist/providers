...
api_count: 3
apis:
- description: Suite of APIs for the Siemens Insights Hub (formerly MindSphere) Industrial IoT platform providing access to time series data, asset management, event management, Opcenter Intelligence, and manufactur
  name: Insights Hub and Industrial IoT APIs
  slug: insights-hub-industrial-iot
...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/siemens-plm/refs/heads/main/capabilities/siemens-plm-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/siemens-plm-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/siemens-plm/refs/heads/main/agentic-access/siemens-plm-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/siemens-plm-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/siemens-plm/refs/heads/main/security/siemens-plm-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/siemens-plm-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/siemens-plm/refs/heads/main/security/siemens-plm-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/siemens-plm-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/siemens-plm/refs/heads/main/authentication/siemens-plm-authentication.yml
  title: ''
  type: Authentication
  url: authentication/siemens-plm-authentication.yml
- group: company
  title: ''
  type: Website
  url: https://www.plm.automation.siemens.com/global/en/
- group: docs
  title: ''
  type: Documentation
  url: https://developer.siemens.com/docs.html
- group: build
  title: ''
  type: GitHubOrg
...
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/siemens-plm
- group: company
  title: ''
  type: Blog
...
- group: commercial
  title: ''
  type: Pricing
  url: https://www.siemens.com/en-us/products/teamcenter/teamcenter-x-cloud-plm/teamcenter-x-plans-and-pricing/
- group: other
  title: ''
  type: X
  url: https://x.com/SiemensSoftware
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/siemens-plm/refs/heads/main/plans/siemens-plm-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/siemens-plm-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/siemens-plm/refs/heads/main/rate-limits/siemens-plm-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/siemens-plm-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/siemens-plm/refs/heads/main/finops/siemens-plm-finops.yml
  title: ''
  type: FinOps
  url: finops/siemens-plm-finops.yml
- group: build
  title: ''
  type: PostmanWorkspace
  url: https://www.postman.com/siemens-ag/siemens-xcelerator-developer-portal/overview
- group: other
  title: ''
  type: APIWorld
  url: https://xcelerator.siemens.com/global/en/api-world.html
- group: start
  title: ''
  type: DeveloperPortal
  url: https://developer.siemens.com/
created: 2026-06-13
description: Siemens PLM is Siemens Digital Industries Software's product lifecycle management platform offering REST APIs for Teamcenter (PDM/PLM), Polarion (ALM), Insights Hub (Industrial IoT), SiGREEN (sustainability), and the broader Siemens Xcelerator portfolio for digital manufacturing, simulation via Simcenter, and CAD/CAM tooling including NX and Solid Edge. The Siemens Xcelerator Developer Portal provides OpenAPI specifications, SDKs, Postman collections, and sandbox access for developers integrating with these industrial platforms.
examples:
- key_count: 5
  name: Product Information Api
  slug: product-information-api
- key_count: 4
  name: Teamcenter Product Cost Management
  slug: teamcenter-product-cost-management
finops:
- name: Siemens Plm Finops
  service_category: ''
  slug: siemens-plm-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/siemens-plm.png
json_schemas:
- name: Polarion REST API Schemas
  property_count: 0
  slug: polarion-rest-api
- name: Product Information API Schemas
  property_count: 0
  slug: product-information-api
- name: TcPCM Gateway API Schemas
  property_count: 0
  slug: teamcenter-product-cost-management
jsonld:
- class_count: 0
  name: Siemens Plm Context
  property_count: 0
  slug: siemens-plm
layout: provider
modified: 2026-06-13
...
overview: 'Siemens PLM publishes 49 APIs on the [APIs.io](https://apis.io/) network, including Account API, Administration API, Basic API, and 46 more. Tagged areas include PLM, Teamcenter, NX, Solid Edge, and Simcenter.
  ...
  Siemens PLM''s developer surface includes authentication, documentation, engineering blog, pricing, and 14 more developer resources.'
plans:
...
- kind: vulnerability-disclosure
  name: Siemens Plm Vulnerability Disclosure
  slug: siemens-plm-vulnerability-disclosure
