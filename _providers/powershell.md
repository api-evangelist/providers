...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/powershell/refs/heads/main/agentic-access/powershell-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/powershell-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/powershell/refs/heads/main/security/powershell-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/powershell-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/powershell/refs/heads/main/security/powershell-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/powershell-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/powershell/refs/heads/main/security/powershell-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/powershell-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/powershell/refs/heads/main/authentication/powershell-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'PowerShell publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Metadata API, Packages API, Search API, and 4 more. Tagged areas include Automation, Command Line, Cross-Platform, Scripting, and Shell.
