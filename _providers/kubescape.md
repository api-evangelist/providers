...
- acting_count: 8
  ...
  summary_line: 23 operations · 8 acting · 2 human-in-the-loop
api_count: 1
apis:
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/kubescape/refs/heads/main/agentic-access/kubescape-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/kubescape-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/kubescape/refs/heads/main/security/kubescape-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/kubescape-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/kubescape/refs/heads/main/authentication/kubescape-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/kubescape/refs/heads/main/plans/kubescape-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/kubescape-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/kubescape/refs/heads/main/rate-limits/kubescape-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/kubescape-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/kubescape/refs/heads/main/finops/kubescape-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Kubescape publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Access Keys API, Network Policies API, Posture & Compliance API, and 4 more. Tagged areas include Kubernetes Security, Cloud Native Security, Container Security, DevSecOps, and Kubernetes.
