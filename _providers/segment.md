...
access_model:
  ...
  - authentication
  - security
  - '{''url'': ''https://segment.com'', ''status'': 302, ''note'': ''declared website redirects to https://www.twilio.com/en-us/segment — a different registrable domain (segment.com -> twilio.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: true
agent_readiness:
  band: agent-aware
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/segment/refs/heads/main/agentic-access/segment-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/segment-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/segment/refs/heads/main/security/segment-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/segment-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/segment/refs/heads/main/authentication/segment-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/segment/refs/heads/main/json-ld/segment-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/segment-context.jsonld
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/segment/refs/heads/main/json-schema/segment-event-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/segment-event-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/segment/refs/heads/main/json-schema/segment-source-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/segment-source-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/segment/refs/heads/main/json-schema/segment-destination-schema.json
  title: ''
  type: JSONSchema
