...
overview: 'Google Cloud Artifact Registry publishes 1 API on the [APIs.io](https://apis.io/) network: Projects API. Tagged areas include Artifacts, Containers, Docker, Google Cloud, and Packages.
  ...
  Google Cloud Artifact Registry''s developer surface includes developer portal, getting-started guide, documentation, authentication, pricing, support, engineering blog, and 8 more developer resources.'
plans:
