...
- group: company
  title: ''
  type: Website
  url: https://herbieplan.com
- group: commercial
  title: ''
  type: Pricing
  url: https://herbieplan.com/pricing
- group: company
  title: ''
  type: Blog
  url: https://herbieplan.com/resources
- group: start
  title: ''
  type: SignUp
  url: https://app.herbieplan.com/auth/signup
- group: commercial
  title: ''
  type: TermsOfService
  url: https://herbieplan.com/terms-of-use
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://herbieplan.com/privacy-policy
- group: operate
  title: ''
  type: Support
  url: https://herbieplan.com/partnerform
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/herbie-herbie-plan/refs/heads/main/security/herbie-herbie-plan-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/herbie-herbie-plan-domain-security.yml
created: '2026-07-17'
...
nav: Providers
network: true
overview: 'Herbie is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Estate Planning, Legal Tech, Wills And Trusts, and Artificial Intelligence.
