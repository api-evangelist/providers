...
nav: Providers
network: true
overview: 'Mastercard Gateway API publishes 1 API on the [APIs.io](https://apis.io/) network: Merchant API. Tagged areas include Credit Cards, Gateways, Payment Processing, and Payments.
