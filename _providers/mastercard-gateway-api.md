...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/mastercard-gateway-api/refs/heads/main/agentic-access/mastercard-gateway-api-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/mastercard-gateway-api-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mastercard-gateway-api/refs/heads/main/security/mastercard-gateway-api-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/mastercard-gateway-api-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mastercard-gateway-api/refs/heads/main/authentication/mastercard-gateway-api-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Mastercard Gateway API publishes 2 APIs on the [APIs.io](https://apis.io/) network, including Merchant API, and 1 more. Tagged areas include Credit Cards, Gateways, Payment Processing, and Payments.


  Mastercard Gateway API''s developer surface includes authentication, developer portal, signup flow, support, and 8 more developer resources.'
plans:
