...
- acting_count: 59
  ...
  summary_line: 68 operations · 59 acting
api_count: 1
apis:
...
- group: company
  title: ''
  type: Website
  url: https://www.pdf.co/
- group: build
  title: ''
  type: PostmanWorkspace
  url: https://www.postman.com/kinlaneapi/pdfco/overview
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/pdf-co/refs/heads/main/agentic-access/pdf-co-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/pdf-co-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pdf-co/refs/heads/main/security/pdf-co-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/pdf-co-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pdf-co/refs/heads/main/security/pdf-co-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/pdf-co-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pdf-co/refs/heads/main/authentication/pdf-co-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/pdf-co/refs/heads/main/plans/pdf-co-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/pdf-co-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/pdf-co/refs/heads/main/rate-limits/pdf-co-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/pdf-co-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/pdf-co/refs/heads/main/finops/pdf-co-finops.yml
  title: ''
  type: FinOps
  url: finops/pdf-co-finops.yml
created: '2026-05-25'
description: PDF.co is a document-automation API for PDFs. It covers conversion to and from PDF, extraction and parsing of text, tables, invoices and forms, OCR, barcodes, editing, merging and splitting, searching and file management.
examples:
- key_count: 2
...
overview: 'PDF.co publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Barcodes API, Document, File & System API, Editing API, and 7 more. Tagged areas include PDF, Document Automation, Artificial Intelligence, OCR, and Invoice Parsing.
  ...
  PDF.co''s developer surface includes authentication, developer portal, documentation, signup flow, pricing, support, GitHub presence, and 23 more developer resources.'
plans:
