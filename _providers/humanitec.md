...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/humanitec/refs/heads/main/agentic-access/humanitec-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/humanitec-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/humanitec/refs/heads/main/security/humanitec-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Humanitec publishes 3 APIs on the [APIs.io](https://apis.io/) network: Agents API, public API, and User Role API. Tagged areas include Deployment, DevOps, Internal Developer Platform, Platform Engineering, and Platform Orchestrator.
