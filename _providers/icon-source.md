...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/icon-source/refs/heads/main/security/icon-source-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/icon-source-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/icon-source/refs/heads/main/llms/icon-source-llms.txt
  title: ''
  type: LLMsTxt
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/icon-source/refs/heads/main/screenshots/icon-source-2026-09-02T145821.png
security:
