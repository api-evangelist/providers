...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/apache-hive/refs/heads/main/agentic-access/apache-hive-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/apache-hive-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apache-hive/refs/heads/main/security/apache-hive-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/apache-hive-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apache-hive/refs/heads/main/security/apache-hive-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/apache-hive/refs/heads/main/rules/apache-hive-spectral-rules.yml
  title: ''
  type: SpectralRules
  url: rules/apache-hive-spectral-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/apache-hive/refs/heads/main/vocabulary/apache-hive-vocabulary.yaml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'Apache Hive publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Databases API, Jobs API, Tables API, and 1 more. Tagged areas include Apache, Big Data, Data Warehouse, ETL, and Hadoop.


  The Apache Hive catalog on APIs.io includes 1 JSON-LD context and 2 Spectral governance rulesets.


  Apache Hive''s developer surface includes documentation, getting-started guide, and 12 more developer resources.'
plans:
