...
- group: agent
  title: ''
  type: AgenticAccess
  url: agentic-access/crusoe-energy-agentic-access.yml
- group: auth
  title: ''
  type: VulnerabilityDisclosure
  url: security/crusoe-energy-vulnerability-disclosure.yml
- group: auth
  title: ''
  type: DomainSecurity
  url: security/crusoe-energy-domain-security.yml
- group: company
  title: ''
  type: Website
  url: https://crusoe.ai/
...
- kind: vulnerability-disclosure
  name: Crusoe Energy Vulnerability Disclosure
  slug: crusoe-energy-vulnerability-disclosure
