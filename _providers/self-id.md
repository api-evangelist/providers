...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/self-id/refs/heads/main/agentic-access/self-id-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/self-id-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/self-id/refs/heads/main/security/self-id-domain-security.yml
  title: ''
  type: DomainSecurity
