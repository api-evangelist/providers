...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/docusaurus/refs/heads/main/security/docusaurus-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/docusaurus-domain-security.yml
- group: company
  title: ''
  type: Website
...
- group: operate
  title: ''
  type: Community
  url: https://docusaurus.io/community/support
- group: other
  title: ''
  type: Showcase
  url: https://docusaurus.io/showcase
created: '2026-03-16'
description: Docusaurus is an open-source static site generator built by Meta for creating documentation websites. Powered by React, it supports MDX, versioning, internationalization, search, and a plugin ecosystem, making it a popular choice for open-source project documentation and developer portals.
finops:
- name: Docusaurus Finops
  service_category: API
  slug: docusaurus-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/docusaurus.png
layout: provider
modified: '2026-04-28'
name: Docusaurus
nav: Providers
...
- name: Docusaurus Plans Pricing
  plan_count: 3
  slug: docusaurus-plans-pricing
random_paper: 2
rate_limits:
- limit_count: 5
  name: Docusaurus Rate Limits
