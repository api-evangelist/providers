...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/architecture-pattern/refs/heads/main/agentic-access/architecture-pattern-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/architecture-pattern-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/architecture-pattern/refs/heads/main/security/architecture-pattern-domain-security.yml
  title: ''
  type: DomainSecurity
