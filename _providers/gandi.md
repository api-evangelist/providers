...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/gandi/refs/heads/main/agentic-access/gandi-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/gandi-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/gandi/refs/heads/main/security/gandi-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/gandi-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/gandi/refs/heads/main/security/gandi-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/gandi-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/gandi/refs/heads/main/authentication/gandi-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Gandi publishes 17 APIs on the [APIs.io](https://apis.io/) network, including Authorization API, Availability API, DNSSEC API, and 14 more. Tagged areas include DNS, Domains, Domain Registrar, Email, and Hosting.
