...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tydo/refs/heads/main/security/tydo-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/tydo/refs/heads/main/llms/tydo-llms.txt
  title: ''
  type: LLMsTxt
...
nav: Providers
network: true
overview: Tydo is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Application, Shopify, E-Commerce, and Audit.
random_paper: 8
score:
  band: minimal
  composite: 5.3
