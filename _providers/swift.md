...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/swift/refs/heads/main/capabilities/swift-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/swift/refs/heads/main/agentic-access/swift-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/swift-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/swift/refs/heads/main/security/swift-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/swift-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/swift/refs/heads/main/authentication/swift-authentication.yml
  title: ''
  type: Authentication
  url: authentication/swift-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/swift/refs/heads/main/scopes/swift-scopes.yml
  title: ''
  type: OAuthScopes
...
nav: Providers
network: true
overview: 'SWIFT publishes 11 APIs on the [APIs.io](https://apis.io/) network, including Account Numbers API, BBANs API, BICs API, and 8 more. Tagged areas include Swift, Banking, Cross-Border Payments, Financial Messaging, and Financial Services.
