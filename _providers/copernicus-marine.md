...
- group: operate
  title: ''
  type: IssueTracker
  url: https://github.com/mercator-ocean/copernicus-marine-toolbox/issues
- group: operate
  title: ''
  type: Releases
  url: https://github.com/mercator-ocean/copernicus-marine-toolbox/releases
- group: commercial
  title: ''
  type: License
  url: https://github.com/mercator-ocean/copernicus-marine-toolbox/blob/main/LICENSE
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/copernicus-marine/refs/heads/main/security/copernicus-marine-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/copernicus-marine/refs/heads/main/plans/copernicus-marine-plans.yml
  title: ''
  type: Plans
  url: plans/copernicus-marine-plans.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/copernicus-marine/refs/heads/main/rate-limits/copernicus-marine-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/copernicus-marine-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/copernicus-marine/refs/heads/main/finops/copernicus-marine-finops.yml
  title: ''
  type: FinOps
...
overview: 'Copernicus Marine publishes 3 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include Ocean, Marine, Oceanography, Sea Level, and Temperature.
  ...
  Copernicus Marine''s developer surface includes documentation, engineering blog, pricing, and 12 more developer resources.'
plans:
