...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/google-shopping/refs/heads/main/capabilities/google-shopping-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-shopping/refs/heads/main/agentic-access/google-shopping-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-shopping-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-shopping/refs/heads/main/security/google-shopping-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-shopping-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-shopping/refs/heads/main/security/google-shopping-domain-security.yml
  title: ''
  type: DomainSecurity
...
overview: 'Google Content API for Shopping publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Accounts API, Datafeeds API, Orders API, and 1 more. Tagged areas include E-Commerce, Google Shopping, Merchant Center, Product Listings, and Retail.
  ...
  Google Content API for Shopping''s developer surface includes developer portal, getting-started guide, documentation, authentication, pricing, support, and 11 more developer resources.'
plans:
