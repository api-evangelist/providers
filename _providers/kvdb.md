...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/kvdb/refs/heads/main/agentic-access/kvdb-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/kvdb-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/kvdb/refs/heads/main/security/kvdb-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/kvdb-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/kvdb/refs/heads/main/authentication/kvdb-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'KVdb publishes 3 APIs on the [APIs.io](https://apis.io/) network: Buckets API, Keys API, and Scripts API. Tagged areas include Database, Key-Value Store, NoSQL, and Serverless.
