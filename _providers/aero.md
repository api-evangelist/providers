...
- group: company
  title: ''
  type: About
  url: https://aero.com/our-story
- group: operate
  title: ''
  type: HelpCenter
  url: https://help.aero.com
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/goaero
- group: company
  title: ''
  type: Careers
  url: https://aero.com/joinaero
- group: other
  title: ''
  type: x-secondary-market-listing
  url: https://equityzen.com/company/aero11d2
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/aero/refs/heads/main/llms/aero-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/aero-llms.txt
- group: other
  title: ''
  type: x-gds-distribution
  url: https://aero.com/travel-advisors
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/aero/refs/heads/main/security/aero-domain-security.yml
  title: ''
  type: DomainSecurity
...
overview: 'Aero is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Travel, Air Travel, Airlines, and Private Aviation.
  ...
  Aero''s developer surface includes support and 11 more developer resources.'
random_paper: 5
score:
  band: minimal
  composite: 7.0
