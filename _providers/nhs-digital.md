...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/nhs-digital/refs/heads/main/capabilities/nhs-digital-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/nhs-digital-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/nhs-digital/refs/heads/main/agentic-access/nhs-digital-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/nhs-digital-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/nhs-digital/refs/heads/main/security/nhs-digital-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/nhs-digital-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/nhs-digital/refs/heads/main/security/nhs-digital-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/nhs-digital-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/nhs-digital/refs/heads/main/authentication/nhs-digital-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'NHS Digital publishes 23 APIs on the [APIs.io](https://apis.io/) network, including Booking API, Communication API, Message API, and 20 more. Tagged areas include NHS, Health, FHIR, United Kingdom, and Patient Demographics.


  The NHS Digital catalog on APIs.io includes 1 JSON-LD context.


  NHS Digital''s developer surface includes authentication, getting-started guide, sandbox, GitHub presence, and 15 more developer resources.'
plans:
- name: Plans
  plan_count: 3
  slug: plans
