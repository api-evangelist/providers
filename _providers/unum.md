...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/unum/refs/heads/main/capabilities/unum-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/unum-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/unum/refs/heads/main/agentic-access/unum-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/unum-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/unum/refs/heads/main/security/unum-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/unum-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/unum/refs/heads/main/authentication/unum-authentication.yml
  title: ''
  type: Authentication
  url: authentication/unum-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/unum/refs/heads/main/scopes/unum-scopes.yml
  title: ''
  type: OAuthScopes
...
nav: Providers
network: true
overview: 'Unum publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Authentication API, Billing API, Eligibility API, and 5 more. Tagged areas include Insurance, Benefits Administration, HR Integration, Disability Insurance, and Life Insurance.
