...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cosmos/refs/heads/main/agentic-access/cosmos-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/cosmos-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cosmos/refs/heads/main/security/cosmos-domain-security.yml
  title: ''
  type: DomainSecurity
...
overview: 'Cosmos publishes 2 APIs on the [APIs.io](https://apis.io/) network: Query API and Service API. Tagged areas include Blockchain, Cosmos, IBC, Staking, and Governance.
  ...
  Cosmos'' developer surface includes documentation, engineering blog, and 18 more developer resources.'
plans:
- name: Plans
  plan_count: 3
  slug: plans
