...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/phantom-space/refs/heads/main/security/phantom-space-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Phantom Space is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Space, Aerospace, Satellite, and Spacecraft.
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/phantom-space/refs/heads/main/screenshots/phantom-space-2026-09-02T151129.png
security:
