...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/capabilities/bluecore-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/bluecore-capability-edges.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/overlays/bluecore-transactional-legacy-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/bluecore-transactional-legacy-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/well-known/bluecore-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/bluecore-well-known.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/well-known/bluecore-openid-configuration.json
  title: ''
  type: OpenIDConnect
  url: well-known/bluecore-openid-configuration.json
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/packages/bluecore-packages.yml
  title: ''
  type: Packages
  url: packages/bluecore-packages.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/plans/bluecore-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/bluecore-plans-pricing.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/components/bluecore-components.yml
  title: ''
  type: Components
  url: components/bluecore-components.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/asyncapi/bluecore-events.yml
  title: ''
  type: EventCatalog
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/llms/bluecore-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/bluecore-llms.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/security/bluecore-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/bluecore-trust-center.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/overlays/bluecore-openapi-overlay.yaml
  title: ''
  type: Overlay
...
- group: start
  ...
  url: https://developers.bluecore.com/
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/authentication/bluecore-authentication.yml
  title: ''
  type: Authentication
  url: authentication/bluecore-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/scopes/bluecore-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/bluecore-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/conventions/bluecore-conventions.yml
  title: ''
  type: Idempotency
...
- group: design
  ...
  url: conventions/bluecore-conventions.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/rate-limits/bluecore-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/bluecore-rate-limits.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/errors/bluecore-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/bluecore-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/data-model/bluecore-data-model.yml
  title: ''
  type: DataModel
  url: data-model/bluecore-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/conformance/bluecore-conformance.yml
  title: ''
  type: Conformance
  url: conformance/bluecore-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/lifecycle/bluecore-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/changelog/bluecore-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/bluecore-changelog.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/mcp/bluecore-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/bluecore-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/arazzo/bluecore-onboard-and-message.arazzo.yml
  title: ''
  type: Arazzo
  url: arazzo/bluecore-onboard-and-message.arazzo.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/agentic-access/bluecore-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/bluecore-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/security/bluecore-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/bluecore-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bluecore/refs/heads/main/security/bluecore-vulnerability-disclosure.yml
  title: ''
...
nav: Providers
network: true
overview: 'Bluecore publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Authn API, CampaignsAPIPublic API, Direct send API, and 6 more. Tagged areas include Company, Retail, Marketing, Customer Data Platform, and Personalization.
