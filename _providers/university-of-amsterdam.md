...
- baseURL: https://login.uva.nl/federationmetadata/2007-06/federationmetadata.xml
  baseurl_source: declared
  description: The Passthrough API from University of Amsterdam — 17 operation(s) for passthrough.
  name: University of Amsterdam Passthrough API
