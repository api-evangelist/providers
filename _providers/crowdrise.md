...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://crowdrise.com'', ''status'': 301, ''note'': ''declared website redirects to https://www.gofundme.com:443/c/crowdrise — a different registrable domain (crowdrise.com -> gofundme.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
- group: other
  title: ''
  type: ParentCompany
  url: https://apis.io/providers/gofundme/
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/crowdrise/refs/heads/main/security/crowdrise-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: CrowdRise is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Crowdfunding, Fundraising, Non-Profit, and Charity.
random_paper: 10
score:
  band: minimal
  composite: 1.5
