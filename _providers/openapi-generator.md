...
- group: other
  ...
  title: ''
  type: VendorFacets
  url: vendor-facets/openapi-generator-vendor-facets.yml
- group: operate
  title: ''
  type: Releases
  url: https://github.com/OpenAPITools/openapi-generator/releases
- group: build
  title: ''
  type: CodeOfConduct
  url: https://github.com/OpenAPITools/openapi-generator/blob/master/CODE_OF_CONDUCT.md
- group: docs
  title: ''
