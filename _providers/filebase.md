...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/filebase/refs/heads/main/security/filebase-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/filebase-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/filebase/refs/heads/main/authentication/filebase-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/filebase/refs/heads/main/plans/filebase-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/filebase-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/filebase/refs/heads/main/rate-limits/filebase-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/filebase-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/filebase/refs/heads/main/finops/filebase-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Filebase publishes 15 APIs on the [APIs.io](https://apis.io/) network, including Buckets API, Data Management API, IPNS API, and 12 more. Tagged areas include Object Storage, IPFS, S3 Compatible, Decentralized Storage, and Pinning.
