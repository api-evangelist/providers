...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cormint/refs/heads/main/security/cormint-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cormint/refs/heads/main/llms/cormint-llms.txt
  title: ''
  type: LLMsTxt
...
nav: Providers
network: true
overview: Cormint is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Data-Center, Power Infrastructure, Energy, and Bitcoin Mining.
plans:
