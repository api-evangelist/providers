...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/apache-http/refs/heads/main/agentic-access/apache-http-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/apache-http-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apache-http/refs/heads/main/security/apache-http-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/apache-http-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apache-http/refs/heads/main/security/apache-http-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/apache-http/refs/heads/main/rules/apache-http-spectral-rules.yml
  title: ''
  type: SpectralRules
  url: rules/apache-http-spectral-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/apache-http/refs/heads/main/vocabulary/apache-http-vocabulary.yaml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'Apache HttpComponents publishes 3 APIs on the [APIs.io](https://apis.io/) network, including Configuration API, Requests API, and 1 more. Tagged areas include Apache, HTTP Client, Java, Open Source, and SDK.


  The Apache HttpComponents catalog on APIs.io includes 1 JSON-LD context and 2 Spectral governance rulesets.


  Apache HttpComponents'' developer surface includes documentation, getting-started guide, engineering blog, and 11 more developer resources.'
plans:
