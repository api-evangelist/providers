...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/genability/refs/heads/main/mcp/genability-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/genability-mcp.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/genability/refs/heads/main/security/genability-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/genability-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/genability/refs/heads/main/agentic-access/genability-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/genability-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/genability/refs/heads/main/authentication/genability-authentication.yml
  title: ''
  type: Authentication
  url: authentication/genability-authentication.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/genability/refs/heads/main/packages/genability-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/genability-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/genability/refs/heads/main/well-known/genability-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/genability-well-known.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/genability/refs/heads/main/llms/genability-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/genability-llms.txt
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/genability/refs/heads/main/overlays/genability-signal-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/genability-signal-overlay.yaml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/genability/refs/heads/main/conformance/genability-conformance.yml
  title: ''
  type: Conformance
  url: conformance/genability-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/genability/refs/heads/main/errors/genability-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/genability-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/genability/refs/heads/main/lifecycle/genability-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/genability/refs/heads/main/conventions/genability-conventions.yml
  title: ''
  type: Conventions
  url: conventions/genability-conventions.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/genability/refs/heads/main/changelog/genability-changelog.yml
  title: ''
  type: ChangeLog
...
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/genability/refs/heads/main/sandbox/genability-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/genability-sandbox.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/genability/refs/heads/main/data-model/genability-data-model.yml
  title: ''
  type: DataModel
  url: data-model/genability-data-model.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/genability/refs/heads/main/security/genability-vulnerability-disclosure.yml
  title: ''
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/genability/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
