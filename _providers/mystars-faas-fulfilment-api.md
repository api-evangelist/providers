...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mystars-faas-fulfilment-api/refs/heads/main/security/mystars-faas-fulfilment-api-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/mystars-faas-fulfilment-api-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mystars-faas-fulfilment-api/refs/heads/main/security/mystars-faas-fulfilment-api-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/mystars-faas-fulfilment-api-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mystars-faas-fulfilment-api/refs/heads/main/authentication/mystars-faas-fulfilment-api-authentication.yml
  title: ''
  type: Authentication
  url: authentication/mystars-faas-fulfilment-api-authentication.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/mystars-faas-fulfilment-api/refs/heads/main/packages/mystars-faas-fulfilment-api-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/mystars-faas-fulfilment-api-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/mystars-faas-fulfilment-api/refs/heads/main/well-known/mystars-faas-fulfilment-api-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/mystars-faas-fulfilment-api-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mystars-faas-fulfilment-api/refs/heads/main/well-known/mystars-faas-fulfilment-api-security.txt
  title: ''
  type: SecurityTxt
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mystars-faas-fulfilment-api/refs/heads/main/errors/mystars-faas-fulfilment-api-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/mystars-faas-fulfilment-api-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mystars-faas-fulfilment-api/refs/heads/main/conventions/mystars-faas-fulfilment-api-conventions.yml
  title: ''
  type: Conventions
...
- group: design
  ...
  url: conventions/mystars-faas-fulfilment-api-conventions.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/mystars-faas-fulfilment-api/refs/heads/main/rate-limits/mystars-faas-fulfilment-api-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/mystars-faas-fulfilment-api-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/mystars-faas-fulfilment-api/refs/heads/main/plans/mystars-faas-fulfilment-api-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/mystars-faas-fulfilment-api-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/mystars-faas-fulfilment-api/refs/heads/main/changelog/mystars-faas-fulfilment-api-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/mystars-faas-fulfilment-api-changelog.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mystars-faas-fulfilment-api/refs/heads/main/lifecycle/mystars-faas-fulfilment-api-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/mystars-faas-fulfilment-api-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mystars-faas-fulfilment-api/refs/heads/main/conformance/mystars-faas-fulfilment-api-conformance.yml
  title: ''
  type: Conformance
  url: conformance/mystars-faas-fulfilment-api-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mystars-faas-fulfilment-api/refs/heads/main/data-model/mystars-faas-fulfilment-api-data-model.yml
  title: ''
  type: DataModel
  url: data-model/mystars-faas-fulfilment-api-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mystars-faas-fulfilment-api/refs/heads/main/asyncapi/mystars-faas-fulfilment-api-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/mystars-faas-fulfilment-api-webhooks.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/mystars-faas-fulfilment-api/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/mystars-faas-fulfilment-api/refs/heads/main/overlays/mystars-faas-fulfilment-api-openapi-overlay.yaml
  title: ''
  type: Overlay
