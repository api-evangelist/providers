...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-chrome/refs/heads/main/agentic-access/google-chrome-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-chrome-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-chrome/refs/heads/main/security/google-chrome-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/google-chrome-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-chrome/refs/heads/main/authentication/google-chrome-authentication.yml
  title: ''
  type: Authentication
  url: authentication/google-chrome-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-chrome/refs/heads/main/scopes/google-chrome-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/google-chrome/refs/heads/main/json-schema/google-chrome-extension-manifest-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/google-chrome-extension-manifest-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-chrome/refs/heads/main/json-ld/google-chrome-context.jsonld
  title: ''
  type: JSONLD
...
nav: Providers
network: true
overview: 'Google Chrome publishes 15 APIs on the [APIs.io](https://apis.io/) network, including App Details API, Reports API, Telemetry Devices API, and 12 more. Tagged areas include Browser, Chrome Extensions, Developer Tools, and Web Platform.
