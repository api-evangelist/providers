...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/absology/refs/heads/main/security/absology-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/absology-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/absology/refs/heads/main/llms/absology-llms.txt
  title: ''
  type: LLMsTxt
...
nav: Providers
network: true
overview: Absology is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Healthcare, Medical Devices, Diagnostics, and In Vitro Diagnostics.
random_paper: 6
score:
  band: minimal
  composite: 3.7
