...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/amazon-mediapackage/refs/heads/main/agentic-access/amazon-mediapackage-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/amazon-mediapackage-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/amazon-mediapackage/refs/heads/main/security/amazon-mediapackage-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/amazon-mediapackage-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/amazon-mediapackage/refs/heads/main/security/amazon-mediapackage-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/amazon-mediapackage-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/amazon-mediapackage/refs/heads/main/security/amazon-mediapackage-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/amazon-mediapackage-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/amazon-mediapackage/refs/heads/main/authentication/amazon-mediapackage-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/amazon-mediapackage/refs/heads/main/rules/amazon-mediapackage-spectral-rules.yml
  title: ''
  type: SpectralRules
  url: rules/amazon-mediapackage-spectral-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/amazon-mediapackage/refs/heads/main/vocabulary/amazon-mediapackage-vocabulary.yaml
  title: ''
  type: Vocabulary
...
overview: 'Amazon MediaPackage publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Channels API, Harvest Jobs API, Origin Endpoints API, and 1 more. Tagged areas include Broadcasting, Media Processing, and Media.
  ...
  Amazon MediaPackage''s developer surface includes authentication, developer portal, documentation, support, engineering blog, developer console, signup flow, and 14 more developer resources.'
plans:
