...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/open-liberty/refs/heads/main/agentic-access/open-liberty-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/open-liberty-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/open-liberty/refs/heads/main/security/open-liberty-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/open-liberty-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/open-liberty/refs/heads/main/authentication/open-liberty-authentication.yml
  title: ''
  type: Authentication
...
- group: docs
  ...
  url: https://openliberty.io/blog/2026/09/08/26.0.0.9.html
created: '2026-03-26'
...
overview: 'Open Liberty publishes 3 APIs on the [APIs.io](https://apis.io/) network: Configuration API, Health API, and Metrics API. Tagged areas include Application Server, Cloud-Native, IBM, Jakarta EE, and Java.
  ...
  Open Liberty''s developer surface includes authentication, documentation, getting-started guide, engineering blog, and 5 more developer resources.'
plans:
