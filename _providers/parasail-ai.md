...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/parasail-ai/refs/heads/main/capabilities/parasail-ai-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/parasail-ai-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/parasail-ai/refs/heads/main/agentic-access/parasail-ai-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/parasail-ai-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/parasail-ai/refs/heads/main/security/parasail-ai-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/parasail-ai-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/parasail-ai/refs/heads/main/authentication/parasail-ai-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/parasail-ai/refs/heads/main/plans/parasail-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/parasail-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/parasail-ai/refs/heads/main/rate-limits/parasail-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/parasail-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/parasail-ai/refs/heads/main/finops/parasail-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Parasail publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Batch API, Chat API, Completions API, and 4 more. Tagged areas include Artificial Intelligence, GPU, Inference, LLM, and Open Source Models.


  The Parasail catalog on APIs.io includes 1 JSON-LD context and 2 Spectral governance rulesets.


  Parasail''s developer surface includes authentication, developer portal, documentation, signup flow, pricing, engineering blog, code examples, and 21 more developer resources.'
plans:
