...
agentic_access:
- acting_count: 213
  human_in_the_loop: 211
  name: Thingsboard Agentic Access
  operation_count: 491
  slug: thingsboard-agentic-access
  summary_line: 491 operations · 213 acting · 211 human-in-the-loop
api_count: 15
apis:
...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/thingsboard/refs/heads/main/capabilities/thingsboard-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/thingsboard/refs/heads/main/agentic-access/thingsboard-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/thingsboard-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/thingsboard/refs/heads/main/security/thingsboard-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/thingsboard-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/thingsboard/refs/heads/main/authentication/thingsboard-authentication.yml
  title: ''
  type: Authentication
  url: authentication/thingsboard-authentication.yml
- group: start
  title: ''
  type: Portal
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/thingsboard/refs/heads/main/plans/thingsboard-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/thingsboard-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/thingsboard/refs/heads/main/rate-limits/thingsboard-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/thingsboard-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/thingsboard/refs/heads/main/finops/thingsboard-finops.yml
  title: ''
  type: FinOps
  url: finops/thingsboard-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/thingsboard/refs/heads/main/vocabulary/thingsboard-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/thingsboard-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/thingsboard/refs/heads/main/rules/thingsboard-rules.yml
  title: ''
  type: SpectralRules
  url: rules/thingsboard-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/thingsboard/refs/heads/main/json-ld/thingsboard-context.jsonld
  title: ''
  type: JSONLD
...
examples:
- key_count: 4
  name: Thingsboard Login Example
  slug: thingsboard-login-example
- key_count: 3
  name: Thingsboard Telemetry Post Example
  slug: thingsboard-telemetry-post-example
features:
...
finops:
- name: Thingsboard Finops
  service_category: ''
  slug: thingsboard-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/thingsboard.png
json_schemas:
- name: ThingsBoard Alarm
  property_count: 22
  slug: thingsboard-alarm
- name: ThingsBoard Asset
  property_count: 10
  slug: thingsboard-asset
- name: ThingsBoard AssetProfile
  property_count: 12
  slug: thingsboard-assetprofile
- name: ThingsBoard Customer
  property_count: 15
  slug: thingsboard-customer
- name: ThingsBoard Dashboard
  property_count: 12
  slug: thingsboard-dashboard
- name: ThingsBoard Device
  property_count: 13
  slug: thingsboard-device
- name: ThingsBoard DeviceProfile
  property_count: 19
  slug: thingsboard-deviceprofile
- name: ThingsBoard EntityRelation
  property_count: 6
  slug: thingsboard-entityrelation
- name: ThingsBoard RuleChain
  property_count: 11
  slug: thingsboard-rulechain
- name: ThingsBoard Tenant
  property_count: 16
  slug: thingsboard-tenant
- name: ThingsBoard User
  property_count: 12
  slug: thingsboard-user
jsonld:
- class_count: 24
  name: Thingsboard Context
  property_count: 16
  slug: thingsboard-context
layout: provider
modified: '2026-05-25'
name: ThingsBoard
nav: Providers
network: true
overview: 'ThingsBoard publishes 58 APIs on the [APIs.io](https://apis.io/) network, including Admin Controller API, AI Model Controller API, Alarm Comment Controller API, and 55 more. Tagged areas include IoT, Device Management, Telemetry, Open Source, and Apache 2.0.
...
- Java
- Spring
website: https://www.thingsboard.io/
---
