...
- collection_type: open
  name: Tax Reporting Templates - TaxJar Sales Tax Categories API
  slug: open-tax-reporting-templates-categories-api
- collection_type: open
  name: Tax Reporting Templates - TaxJar Sales Tax Categories Taxes API
  slug: open-tax-reporting-templates-taxes-api
- collection_type: open
  name: Tax Reporting Templates - TaxJar Sales Tax API
  slug: open-tax-reporting-templates
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/tax-reporting-templates/refs/heads/main/agentic-access/tax-reporting-templates-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/tax-reporting-templates-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tax-reporting-templates/refs/heads/main/security/tax-reporting-templates-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/tax-reporting-templates-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tax-reporting-templates/refs/heads/main/authentication/tax-reporting-templates-authentication.yml
  title: ''
  type: Authentication
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/tax-reporting-templates/refs/heads/main/json-schema/tax-report-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/tax-report-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tax-reporting-templates/refs/heads/main/json-structure/tax-report-structure.json
  title: ''
  type: JSONStructure
  url: json-structure/tax-report-structure.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tax-reporting-templates/refs/heads/main/json-ld/tax-reporting-templates-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/tax-reporting-templates-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tax-reporting-templates/refs/heads/main/vocabulary/tax-reporting-templates-vocabulary.yml
  title: ''
  type: Vocabulary
