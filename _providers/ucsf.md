...
nav: Providers
network: true
overview: 'University of California, San Francisco publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Documents API, Profiles API, and 6 more. Tagged areas include University, Higher Education, Education, United States, and California.
