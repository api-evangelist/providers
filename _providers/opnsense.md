...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/opnsense/refs/heads/main/capabilities/opnsense-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/opnsense-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/opnsense/refs/heads/main/agentic-access/opnsense-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/opnsense-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/opnsense/refs/heads/main/security/opnsense-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/opnsense-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/opnsense/refs/heads/main/authentication/opnsense-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'OPNsense publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Core API, Diagnostics API, Firewall API, and 1 more. Tagged areas include Firewall, Networking, Security, VPN, and Routing.
