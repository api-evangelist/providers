...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/j-quants/refs/heads/main/agentic-access/j-quants-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/j-quants-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/j-quants/refs/heads/main/security/j-quants-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/j-quants-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/j-quants/refs/heads/main/authentication/j-quants-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'J-Quants publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Derivatives API, Equities API, Fins API, and 7 more. Tagged areas include Financial Data, Investment, Japan, and Stock Market.
