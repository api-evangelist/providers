...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/api-stack/refs/heads/main/security/api-stack-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/api-stack-domain-security.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/api-stack/refs/heads/main/conformance/api-stack-conformance.yml
  title: ''
  type: Conformance
  url: conformance/api-stack-conformance.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/api-stack/refs/heads/main/well-known/api-stack-well-known.yml
  title: ''
  type: WellKnownProbe
  url: well-known/api-stack-well-known.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/api-stack/refs/heads/main/packages/api-stack-packages.yml
  title: ''
  type: Packages
  url: packages/api-stack-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/api-stack/refs/heads/main/llms/api-stack-llms.txt
  title: ''
  type: LLMsTxt
