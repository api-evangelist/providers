...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/documenso/refs/heads/main/agentic-access/documenso-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/documenso-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/documenso/refs/heads/main/security/documenso-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/documenso-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/documenso/refs/heads/main/security/documenso-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/documenso-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/documenso/refs/heads/main/authentication/documenso-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/documenso/refs/heads/main/plans/documenso-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/documenso-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/documenso/refs/heads/main/rate-limits/documenso-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/documenso-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/documenso/refs/heads/main/finops/documenso-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Documenso publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Documents API, Fields API, Recipients API, and 2 more. Tagged areas include E-Signature, Documents, Signing, Open Source, and DocuSign Alternative.
