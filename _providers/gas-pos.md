...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/gas-pos/refs/heads/main/security/gas-pos-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Gas POS is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Point-of-Sale, Payments, Fuel, and Convenience Stores.
