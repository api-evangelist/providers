...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/table-format/refs/heads/main/agentic-access/table-format-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/table-format-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/table-format/refs/heads/main/security/table-format-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/table-format-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/table-format/refs/heads/main/security/table-format-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/table-format-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/table-format/refs/heads/main/authentication/table-format-authentication.yml
  title: ''
  type: Authentication
  url: authentication/table-format-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/table-format/refs/heads/main/scopes/table-format-scopes.yml
  title: ''
  type: OAuthScopes
...
nav: Providers
network: true
overview: 'Table Format publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Commits API, Configuration API, Namespaces API, and 5 more. Tagged areas include Data Lakehouse, Open Table Format, Apache Iceberg, Delta Lake, and Apache Hudi.
