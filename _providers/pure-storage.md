...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/pure-storage/refs/heads/main/capabilities/pure-storage-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/pure-storage-capability-edges.yml
- group: operate
  title: ''
  type: IssueTracker
  url: https://github.com/libopenstorage/operator/issues
- group: operate
  title: ''
  type: Releases
  url: https://github.com/libopenstorage/operator/releases
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/pure-storage/refs/heads/main/agentic-access/pure-storage-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/pure-storage-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pure-storage/refs/heads/main/security/pure-storage-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/pure-storage-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pure-storage/refs/heads/main/security/pure-storage-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/pure-storage-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pure-storage/refs/heads/main/authentication/pure-storage-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/pure-storage/refs/heads/main/rules/pure-storage-rules.yml
  title: Pure Storage Spectral Ruleset
  type: SpectralRules
  url: rules/pure-storage-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/pure-storage/refs/heads/main/vocabulary/pure-storage-vocabulary.yml
...
overview: 'Pure Storage publishes 129 APIs on the [APIs.io](https://apis.io/) network, including Active Directory API, Administrators API, Alert Watchers API, and 126 more. Tagged areas include Storage, Data Storage, Flash Storage, Enterprise Storage, and Cloud Storage.
  ...
  Pure Storage''s developer surface includes authentication, documentation, API reference, tooling, CLI, support, engineering blog, and 18 more developer resources.'
plans:
