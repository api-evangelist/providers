...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/whistle/refs/heads/main/security/whistle-domain-security.yml
  title: ''
  type: DomainSecurity
...
examples:
- key_count: 3
  name: Whistle Rule Example
  slug: whistle-rule-example
finops:
- name: Whistle Finops
...
- name: Whistle Rule
  ...
  slug: whistle-rule
json_structures:
- name: Whistle Rule Structure
  property_count: 3
  slug: whistle-rule-structure
jsonld:
- class_count: 9
...
- limit_count: 5
  ...
  slug: whistle-rate-limits
rules:
- effective_rule_count: 5
  extends: []
  name: Whistle API Rules
  rule_count: 5
  severity_counts:
    error: 0
    hint: 0
    info: 1
    warn: 4
  slug: whistle-jsonschema-spectral-rules
score:
  band: thin
  composite: 26.4
  coverage:
