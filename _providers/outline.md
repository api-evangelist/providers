...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/outline/refs/heads/main/agentic-access/outline-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/outline-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/outline/refs/heads/main/security/outline-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/outline-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/outline/refs/heads/main/authentication/outline-authentication.yml
  title: ''
  type: Authentication
  url: authentication/outline-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/outline/refs/heads/main/scopes/outline-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/outline/refs/heads/main/plans/outline-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/outline-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/outline/refs/heads/main/rate-limits/outline-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/outline-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/outline/refs/heads/main/finops/outline-finops.yml
  title: ''
  type: FinOps
...
overview: 'Outline publishes 18 APIs on the [APIs.io](https://apis.io/) network, including AccessRequests API, Attachments API, Auth API, and 15 more. Tagged areas include Knowledge Base, Wiki, Documents, Collaboration, and Open-Source.
  ...
  Outline''s developer surface includes authentication, documentation, changelog, status page, pricing, engineering blog, and 13 more developer resources.'
plans:
