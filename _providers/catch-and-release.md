...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/catch-and-release/refs/heads/main/well-known/catch-and-release-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/catch-and-release-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/catch-and-release/refs/heads/main/security/catch-and-release-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/catch-and-release/refs/heads/main/lifecycle/catch-and-release-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/catch-and-release-lifecycle.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/catch-and-release/refs/heads/main/packages/catch-and-release-packages.yml
  title: ''
  type: Packages
  url: packages/catch-and-release-packages.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/catch-and-release/refs/heads/main/plans/catch-and-release-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/catch-and-release-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/catch-and-release/refs/heads/main/rate-limits/catch-and-release-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/catch-and-release-rate-limits.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/catch-and-release/refs/heads/main/llms/catch-and-release-llms.txt
  title: ''
  type: LLMsTxt
