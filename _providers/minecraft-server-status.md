...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/minecraft-server-status/refs/heads/main/security/minecraft-server-status-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/minecraft-server-status-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/minecraft-server-status/refs/heads/main/security/minecraft-server-status-domain-security.yml
  title: ''
  type: DomainSecurity
