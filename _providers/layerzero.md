...
- baseURL: https://scan.layerzero-api.com/v1
  baseurl_source: declared
  description: The Open API API from LayerZero — 1 operation(s) for open api.
  name: LayerZero Open API
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/layerzero/refs/heads/main/agentic-access/layerzero-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/layerzero-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/layerzero/refs/heads/main/security/layerzero-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/layerzero-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/layerzero/refs/heads/main/authentication/layerzero-authentication.yml
  title: ''
  type: Authentication
