...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/takealot/refs/heads/main/capabilities/takealot-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/takealot-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/takealot/refs/heads/main/agentic-access/takealot-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/takealot-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/takealot/refs/heads/main/security/takealot-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/takealot-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/takealot/refs/heads/main/security/takealot-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/takealot-domain-security.yml
- group: company
  title: ''
  type: Website
...
- group: docs
  title: ''
  type: SellerAPIDocumentation
  url: https://seller-api.takealot.com/api-docs/
- group: other
  title: ''
  type: MrD
  url: https://mrd.co.za
...
- group: other
  title: ''
  type: TakealotFulfilmentServices
  url: https://takealotgroup.com
- group: operate
  title: ''
  type: HelpCentre
  url: https://www.takealot.com/help-centre
- group: company
  title: ''
  type: Careers
  url: https://www.takealotgroup.com/careers
- group: company
  title: ''
  type: Newsroom
  url: https://takealotgroup.com/newsroom
- group: operate
  title: ''
  type: Contact
  url: mailto:contactus@takealot.group
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://www.takealot.com/help-centre/legal/privacy-policy
- group: commercial
  title: ''
  type: TermsAndConditions
  url: https://www.takealot.com/help-centre/legal/website-terms
- group: build
  title: ''
  type: GitHub
  url: https://github.com/TAKEALOT
- group: other
  title: ''
  type: ParentCompany
  url: https://www.naspers.com
- group: other
  title: ''
  type: ProsusGroup
...
- kind: vulnerability-disclosure
  name: Takealot Vulnerability Disclosure
  slug: takealot-vulnerability-disclosure
