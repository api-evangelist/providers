...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lido/refs/heads/main/security/lido-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/lido-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lido/refs/heads/main/security/lido-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Lido publishes 12 APIs on the [APIs.io](https://apis.io/) network, including Finance APR for Eth and stEth API, Finance Estimate API, Finance NFT API, and 9 more. Tagged areas include Liquid Staking, Ethereum, Staking, DeFi, and stETH.
