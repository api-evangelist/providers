...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/vonage/refs/heads/main/capabilities/vonage-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/vonage/refs/heads/main/agentic-access/vonage-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/vonage-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/vonage/refs/heads/main/security/vonage-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/vonage-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/vonage/refs/heads/main/security/vonage-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/vonage-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/vonage/refs/heads/main/authentication/vonage-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Vonage publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Applications API, Messages API, Numbers API, and 3 more. Tagged areas include Communications, Messaging, Telecommunications, Video Conferencing, and Voice.
  ...
  Vonage''s developer surface includes authentication, developer portal, documentation, support, engineering blog, CLI, pricing, and 22 more developer resources.'
plans:
