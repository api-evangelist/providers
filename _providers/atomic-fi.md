...
- acting_count: 12
  ...
  summary_line: 31 operations · 12 acting · 1 human-in-the-loop
api_count: 1
apis:
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/atomic-fi/refs/heads/main/agentic-access/atomic-fi-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/atomic-fi-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/atomic-fi/refs/heads/main/security/atomic-fi-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/atomic-fi-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/atomic-fi/refs/heads/main/authentication/atomic-fi-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/atomic-fi/refs/heads/main/plans/atomic-fi-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/atomic-fi-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/atomic-fi/refs/heads/main/rate-limits/atomic-fi-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/atomic-fi-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/atomic-fi/refs/heads/main/finops/atomic-fi-finops.yml
  title: ''
  type: FinOps
