...
nav: Providers
network: true
overview: 'Chef Software publishes 30 APIs on the [APIs.io](https://apis.io/) network, including ApplicationsService API, Authorization API, Cds API, and 27 more. Tagged areas include Company, DevOps, Infrastructure Automation, Configuration Management, and Compliance.
...
- kind: vulnerability-disclosure
  name: Chef Software Vulnerability Disclosure
  slug: chef-software-vulnerability-disclosure
  summary_line: contact published
- kind: trust-center
  name: Chef Software Trust Center
  slug: chef-software-trust-center
