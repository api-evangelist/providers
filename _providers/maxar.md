...
access_model:
  ...
  - authentication
  - security
  - '{''url'': ''https://www.maxar.com/'', ''status'': 301, ''note'': ''declared website redirects to https://vantor.com/ — a different registrable domain (maxar.com -> vantor.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: true
agent_readiness:
  band: agent-aware
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/maxar/refs/heads/main/agentic-access/maxar-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/maxar-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/maxar/refs/heads/main/security/maxar-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/maxar-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/maxar/refs/heads/main/authentication/maxar-authentication.yml
  title: ''
  type: Authentication
