...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jdbc/refs/heads/main/security/jdbc-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'JDBC is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Database, Java, JDBC, SQL, and Standards.
