...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/isometric/refs/heads/main/capabilities/isometric-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/isometric-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/isometric/refs/heads/main/agentic-access/isometric-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/isometric-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/isometric/refs/heads/main/security/isometric-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/isometric-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/isometric/refs/heads/main/authentication/isometric-authentication.yml
  title: ''
  type: Authentication
  url: authentication/isometric-authentication.yml
- group: start
  title: ''
  type: Portal
...
- group: operate
  title: ''
  type: Contact
  url: mailto:contact@isometric.com
- group: company
  title: ''
  type: Press
  url: mailto:press@isometric.com
- group: company
  title: ''
  type: LinkedIn
...
created: '2026-05-24'
description: Isometric is a London- and New York-based certifier of climate solutions building an AI-native, science-led registry and verification platform for the industrial economy. Founded in 2022 by Eamon Jubbawy (Onfido), Isometric certifies durable carbon dioxide removal (CDR), superpollutant abatement, and related environmental attributes against the public Isometric Standard, a library of peer-reviewed protocols spanning biochar, enhanced weathering, mineralization, direct air capture, marine CDR, biosphere pathways (such as reforestation, mangroves, agroforestry, and improved forest management), and superpollutant abatement (HFC/ODS recovery, landfill methane, rice methane). Buyers, suppliers, and integrators interact with Isometric through three primary platforms — Certify (project design, MRV data ingestion, LCA, GHG statements, validation), Registry (issuances, credit batches, deliveries, transfers, retirements, buffer pools), and Protocols (operationalized scientific methodology)
  — exposed via the Registry API and the Certify (MRV) Data Ingestion API. Both APIs are versioned at /v0, share a unified two-credential model (X-Client-Secret + Bearer JWT), run on sandbox and production hosts, and are accompanied by a hosted MCP server at api.isometric.com/mcp that exposes the Isometric Standard, protocols, modules, and platform documentation to AI clients such as Claude, ChatGPT, Gemini, Cursor, Windsurf, and VS Code Copilot. Customers include Google, Microsoft, Shopify, Frontier-aligned buyers, and Anglo American, and the registry powers credit lifecycle operations for marketplaces, intermediaries, and carbon intelligence platforms.
features:
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/isometric.png
layout: provider
modified: '2026-05-24'
name: Isometric
nav: Providers
network: true
overview: 'Isometric publishes 36 APIs on the [APIs.io](https://apis.io/) network, including Beneficiaries API, Beneficiary API, Biochar Applications API, and 33 more. Tagged areas include Carbon Removal, Carbon Registry, Climate, Climate Tech, and CDR.
