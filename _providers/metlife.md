...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/metlife/refs/heads/main/security/metlife-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/metlife-domain-security.yml
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/MetLife
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/metlife
- group: company
  title: ''
  type: Website
...
- group: agent
  title: ''
  type: LlmsText
  url: https://www.metlife.com/llms.txt
created: '2026-03-21'
description: MetLife is a Fortune 500 insurance and financial services company offering life, auto, home, dental, vision, and other employee benefits. This entry captures publicly available APIs, developer tools, and machine-readable artifacts for MetLife.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/metlife.png
layout: provider
modified: '2026-04-28'
name: MetLife
nav: Providers
...
- kind: domain-security
  name: Metlife Domain Security
  slug: metlife-domain-security
