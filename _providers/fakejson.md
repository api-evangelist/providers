...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://fakejson.com'', ''status'': 301, ''note'': ''declared website redirects to https://rangdebasanti.net/ — a different registrable domain (fakejson.com -> rangdebasanti.net), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/fakejson/refs/heads/main/security/fakejson-domain-security.yml
  title: ''
  type: DomainSecurity
