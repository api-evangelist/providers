...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/trademarknow/refs/heads/main/security/trademarknow-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: TrademarkNow is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Trademarks, Intellectual Property, Legal Tech, and Brand Protection.
random_paper: 19
score:
  band: minimal
  composite: 10.5
