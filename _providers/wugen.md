...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/wugen/refs/heads/main/overlays/wugen-allotera-content-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/wugen-allotera-content-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/wugen/refs/heads/main/agentic-access/wugen-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/wugen-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/wugen/refs/heads/main/security/wugen-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/wugen-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/wugen/refs/heads/main/authentication/wugen-authentication.yml
  title: ''
  type: Authentication
  url: authentication/wugen-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/wugen/refs/heads/main/conventions/wugen-conventions.yml
  title: ''
  type: Conventions
  url: conventions/wugen-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/wugen/refs/heads/main/conformance/wugen-conformance.yml
  title: ''
  type: Conformance
  url: conformance/wugen-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/wugen/refs/heads/main/lifecycle/wugen-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/wugen-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/wugen/refs/heads/main/errors/wugen-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/wugen-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/wugen/refs/heads/main/data-model/wugen-data-model.yml
  title: ''
  type: DataModel
  url: data-model/wugen-data-model.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/wugen/refs/heads/main/examples/wugen-examples.yml
  title: ''
  type: Examples
  url: examples/wugen-examples.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/wugen/refs/heads/main/well-known/wugen-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/wugen-well-known.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/wugen/refs/heads/main/llms/wugen-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/wugen-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/wugen/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
