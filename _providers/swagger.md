...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/swagger/refs/heads/main/vendor-facets/swagger-vendor-facets.yml
  title: ''
  type: VendorFacets
  url: vendor-facets/swagger-vendor-facets.yml
- group: operate
  title: ''
  type: IssueTracker
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/swagger/refs/heads/main/security/swagger-domain-security.yml
  title: ''
  type: DomainSecurity
...
overview: 'Swagger publishes 5 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include API Design, Documentation, Open Source, OpenAPI, and REST.
  ...
  Swagger''s developer surface includes documentation, engineering blog, tooling, and 14 more developer resources.'
plans:
