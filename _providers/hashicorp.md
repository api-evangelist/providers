...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/hashicorp/refs/heads/main/agentic-access/hashicorp-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/hashicorp-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hashicorp/refs/heads/main/security/hashicorp-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'HashiCorp publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Auth API, Identity API, Secrets API, and 6 more. Tagged areas include Cloud, DevOps, Infrastructure, and Platform.


  HashiCorp''s developer surface includes developer portal, getting-started guide, support, engineering blog, and 10 more developer resources.'
plans:
