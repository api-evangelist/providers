...
nav: Providers
network: true
overview: 'Workday Recruiting publishes 12 APIs on the [APIs.io](https://apis.io/) network, including Agent Definition API, Applicants API, Background Checks API, and 9 more. Tagged areas include HCM, Human Resources, Recruiting, Software-as-a-Service, and Talent Acquisition.
