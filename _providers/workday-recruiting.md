...
nav: Providers
network: true
overview: 'Workday Recruiting publishes 12 APIs on the [APIs.io](https://apis.io/) network, including agentDefinition API, Applicants API, Background Checks API, and 9 more. Tagged areas include HCM, Human Resources, Recruiting, SaaS, and Talent Acquisition.
