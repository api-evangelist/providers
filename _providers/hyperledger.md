...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/hyperledger/refs/heads/main/agentic-access/hyperledger-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/hyperledger-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hyperledger/refs/heads/main/security/hyperledger-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Hyperledger publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Eth API, and 4 more. Tagged areas include Blockchain, Distributed Ledger, Enterprise, Linux Foundation, and Smart Contracts.


  The Hyperledger catalog on APIs.io includes 1 Spectral governance ruleset.


  Hyperledger''s developer surface includes documentation, engineering blog, and 8 more developer resources.'
plans:
