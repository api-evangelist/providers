...
- group: start
  ...
  url: https://developer.holidu.com/
- group: docs
  title: ''
  type: Documentation
  url: https://developer.holidu.com/docs
- group: docs
  title: ''
  type: APIReference
  url: https://developer.holidu.com/reference
- group: start
  title: ''
  type: GettingStarted
  url: https://developer.holidu.com/reference/how-to-integrate-with-holidu-capabilities-use-cases
- group: operate
  title: ''
  type: ChangeLog
  url: https://developer.holidu.com/changelog
- group: operate
  title: ''
  type: StatusPage
  url: https://status.holidu.com/
- group: operate
  title: ''
  type: Support
  url: https://developer.holidu.com/discuss
- group: start
  title: ''
  type: SignUp
  url: https://partner.holidu.com/
- group: build
  title: ''
...
- group: docs
  title: ''
  type: OpenAPI
  url: openapi/holidu-affiliate-api.json
- group: docs
  title: ''
  type: OpenAPI
  url: openapi/holidu-connectivity-api.json
- group: auth
  title: ''
  type: Authentication
...
overview: 'Holidu publishes 23 APIs on the [APIs.io](https://apis.io/) network, including Apartment API, Availabilities API, Availability API, and 20 more. Tagged areas include Company, Travel And Leisure, Vacation Rentals, Short-Term Rentals, and Hospitality.
  ...
  Holidu''s developer surface includes documentation, API reference, getting-started guide, changelog, support, signup flow, authentication, and 26 more developer resources.'
random_paper: 5
scopes:
- name: Holidu Scopes
  scope_count: 0
...
- kind: vulnerability-disclosure
  name: Holidu Vulnerability Disclosure
  slug: holidu-vulnerability-disclosure
