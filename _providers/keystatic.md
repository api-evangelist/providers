...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/keystatic/refs/heads/main/security/keystatic-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/keystatic-domain-security.yml
- group: company
  title: ''
  type: Website
...
finops:
- name: Keystatic Finops
  service_category: API
  slug: keystatic-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/keystatic.png
layout: provider
modified: '2026-04-28'
name: Keystatic
nav: Providers
...
- kind: domain-security
  name: Keystatic Domain Security
  slug: keystatic-domain-security
