...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/halliburton/refs/heads/main/security/halliburton-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/halliburton-domain-security.yml
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/Halliburton-Landmark
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/halliburton
- group: company
  title: ''
  type: Website
...
- group: other
  title: ''
  type: Landmark
  url: https://www.landmark.solutions
- group: other
  title: ''
  type: OSDU
  url: https://osduforum.org
created: '2026-03-21'
description: Halliburton delivers advanced products and services to meet the evolving needs of the global energy industry, driving innovation, reliability, and performance. Halliburton operates enterprise software platforms such as DecisionSpace 365, Landmark, and iEnergy, but does not currently publish a public, openly accessible REST API for general developer use.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/halliburton.png
layout: provider
modified: '2026-04-28'
name: Halliburton
nav: Providers
...
- kind: domain-security
  name: Halliburton Domain Security
  slug: halliburton-domain-security
