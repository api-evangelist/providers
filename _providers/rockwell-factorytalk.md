...
nav: Providers
network: true
overview: 'Rockwell FactoryTalk publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Hub API, rockwell-factorytalk Alarms API, rockwell-factorytalk Recipes API, and 3 more. Tagged areas include Automation, Manufacturing, Cloud, and Recipes.
