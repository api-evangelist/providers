...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/big-xyt/refs/heads/main/security/big-xyt-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/big-xyt-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/big-xyt/refs/heads/main/authentication/big-xyt-authentication.yml
  title: ''
  type: Authentication
  url: authentication/big-xyt-authentication.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/big-xyt/refs/heads/main/llms/big-xyt-llms.txt
  title: ''
  type: LLMsTxt
...
nav: Providers
network: true
overview: 'big xyt publishes 3 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include Finance, Market Data, Tick Data, Trading, and Analytics.
