...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://nomadhomes.co/'', ''status'': 301, ''note'': ''declared website redirects to https://www.getremy.ai/ — a different registrable domain (nomadhomes.co -> getremy.ai), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/nomad-homes/refs/heads/main/well-known/nomad-homes-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/nomad-homes-well-known.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/nomad-homes/refs/heads/main/llms/nomad-homes-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/nomad-homes-llms.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/nomad-homes/refs/heads/main/security/nomad-homes-domain-security.yml
  title: ''
  type: DomainSecurity
