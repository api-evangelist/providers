...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/wolverine-world-wide/refs/heads/main/security/wolverine-world-wide-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/wolverine-world-wide-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/wolverineworldwide
- group: company
  title: ''
  type: Website
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/wolverine-world-wide.png
layout: provider
modified: '2026-05-03'
name: Wolverine World Wide
nav: Providers
network: true
overview: 'Wolverine World Wide is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Apparel, Consumer Goods, E-Commerce, Footwear, and Retail.
