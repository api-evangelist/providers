...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/usg/refs/heads/main/security/usg-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/usg-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/usgcorp
- group: company
  title: ''
  type: Website
...
nav: Providers
network: true
overview: 'USG is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Building Materials, Construction, Drywall, Interior Systems, and Manufacturing.
...
- kind: domain-security
  name: Usg Domain Security
  slug: usg-domain-security
