...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/openprise/refs/heads/main/security/openprise-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/openprise-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/openprise/refs/heads/main/security/openprise-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/openprise-domain-security.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/openprise/refs/heads/main/conformance/openprise-conformance.yml
  title: ''
  type: Conformance
  url: conformance/openprise-conformance.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/openprise/refs/heads/main/authentication/openprise-authentication.yml
  title: ''
  type: Authentication
  url: authentication/openprise-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/openprise/refs/heads/main/conventions/openprise-conventions.yml
  title: ''
  type: Conventions
  url: conventions/openprise-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/openprise/refs/heads/main/errors/openprise-error-codes.yml
  title: ''
  type: ErrorCatalog
  url: errors/openprise-error-codes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/openprise/refs/heads/main/lifecycle/openprise-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/openprise-lifecycle.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/openprise/refs/heads/main/changelog/openprise-changelog.yml
  title: ''
  type: ChangeLog
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/openprise/refs/heads/main/plans/openprise-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/openprise-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/openprise/refs/heads/main/rate-limits/openprise-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/openprise-rate-limits.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/openprise/refs/heads/main/packages/openprise-packages.yml
  title: ''
  type: Packages
  url: packages/openprise-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/openprise/refs/heads/main/llms/openprise-llms.txt
  title: ''
  type: LLMsTxt
