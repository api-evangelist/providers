...
nav: Providers
network: true
overview: 'Artera is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Healthcare, Patient Communication, Patient Engagement, and Health IT.
