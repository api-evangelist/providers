...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/jupyter/refs/heads/main/agentic-access/jupyter-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/jupyter-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jupyter/refs/heads/main/security/jupyter-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/jupyter-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jupyter/refs/heads/main/security/jupyter-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Jupyter publishes 12 APIs on the [APIs.io](https://apis.io/) network, including Config API, Contents API, Server REST API, and 9 more. Tagged areas include Data Science, Education, Interactive Computing, Notebooks, and Python.
