...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/envision-healthcare-holdings/refs/heads/main/security/envision-healthcare-holdings-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/envision-healthcare-holdings-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/envision-healthcare
- group: company
  title: ''
  type: Website
  url: https://www.evhc.net/
- group: company
  title: ''
  type: About
  url: https://www.evhc.net/about-us
- group: company
  title: ''
  type: Careers
  url: https://www.evhc.net/careers
- group: company
  title: ''
  type: News
  url: https://www.evhc.net/news
created: '2026-03-24'
description: Envision Healthcare is a leading provider of physician-led services and ambulatory surgery services in the United States, supporting healthcare professionals across emergency, anesthesiology, radiology, women's and children's, and surgery. No public developer APIs have been identified for Envision Healthcare Holdings at this time.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/envision-healthcare-holdings.png
layout: provider
modified: '2026-04-28'
name: Envision Healthcare Holdings
nav: Providers
network: true
overview: 'Envision Healthcare Holdings is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Healthcare, Physician Services, and Ambulatory Surgery.
...
slug: envision-healthcare-holdings
tags:
- Healthcare
- Physician Services
- Ambulatory Surgery
