...
- group: docs
  title: ''
  type: Documentation
  url: https://docs.saffron.finance
- group: start
  title: ''
  type: GettingStarted
  url: https://docs.saffron.finance/introduction/index.md
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/saffron-finance
- group: company
  title: ''
  type: Blog
...
- group: other
  title: ''
  type: Whitepaper
  url: https://docs.saffron.finance/whitepaper/saffron-fixed-income-vault.md
- group: operate
  title: ''
  type: Support
  url: https://docs.saffron.finance/introduction/community.md
- group: company
  title: ''
  type: Twitter
  url: https://x.com/saffron
- group: other
  title: ''
  type: Telegram
  url: https://t.me/saffronfinance
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/saffron-finance/refs/heads/main/llms/saffron-finance-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/saffron-finance-llms.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/saffron-finance/refs/heads/main/security/saffron-finance-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/saffron-finance-domain-security.yml
created: '2026-07-17'
...
nav: Providers
network: true
overview: 'Saffron Finance is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Crypto Web3, DeFi, Yield, and Fixed Income.
