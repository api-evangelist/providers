...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ncbi/refs/heads/main/security/ncbi-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/ncbi-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ncbi/refs/heads/main/authentication/ncbi-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'National Center for Biotechnology Information (NCBI) publishes 18 APIs on the [APIs.io](https://apis.io/) network, including NCBI BLAST URL API, BioSample API, Gene API, and 15 more. Tagged areas include Bioinformatics, Genomics, Life Sciences, PubMed, and Sequences.
  ...
  National Center for Biotechnology Information (NCBI)''s developer surface includes authentication, support, status page, engineering blog, YouTube channel, and 8 more developer resources.'
plans:
- name: Blast
  plan_count: 1
  slug: blast
