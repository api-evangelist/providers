...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/nortech/refs/heads/main/openapi/_original/nortech-openapi-original.json
  title: ''
  type: OpenAPI
  url: openapi/_original/nortech-openapi-original.json
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/nortech/refs/heads/main/packages/nortech-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/nortech-packages.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/nortech/refs/heads/main/authentication/nortech-authentication.yml
  title: ''
  type: Authentication
  url: authentication/nortech-authentication.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/nortech/refs/heads/main/agentic-access/nortech-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/nortech-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/nortech/refs/heads/main/security/nortech-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/nortech-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/nortech/refs/heads/main/mcp/nortech-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/nortech-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/nortech/refs/heads/main/llms/nortech-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/nortech-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/nortech/refs/heads/main/well-known/nortech-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/nortech-well-known.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/nortech/refs/heads/main/overlays/nortech-openapi-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/nortech-openapi-overlay.yaml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/nortech/refs/heads/main/conformance/nortech-conformance.yml
  title: ''
  type: Conformance
  url: conformance/nortech-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/nortech/refs/heads/main/errors/nortech-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/nortech-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/nortech/refs/heads/main/lifecycle/nortech-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/nortech-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/nortech/refs/heads/main/conventions/nortech-conventions.yml
  title: ''
  type: Conventions
  url: conventions/nortech-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/nortech/refs/heads/main/data-model/nortech-data-model.yml
  title: ''
  type: DataModel
  url: data-model/nortech-data-model.yml
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/nortech/refs/heads/main/asyncapi/nortech-live-data-asyncapi.yml
  title: ''
  type: AsyncAPI
...
- group: design
  ...
  url: asyncapi/nortech-live-data-asyncapi.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/nortech/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
