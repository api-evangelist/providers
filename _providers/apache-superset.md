...
- baseURL: http://localhost:8088
  baseurl_source: spec
  description: The SQL Lab API from Apache Superset — 6 operation(s) for sql lab.
  name: Apache Superset SQL Lab API
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/apache-superset/refs/heads/main/agentic-access/apache-superset-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/apache-superset-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apache-superset/refs/heads/main/security/apache-superset-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/apache-superset-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apache-superset/refs/heads/main/security/apache-superset-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Apache Superset publishes 21 APIs on the [APIs.io](https://apis.io/) network, including Annotation Layer API, Assets API, Async Event API, and 18 more. Tagged areas include Analytics, BI, Dashboards, Data Visualization, and SQL.
