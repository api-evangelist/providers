...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/signl4/refs/heads/main/agentic-access/signl4-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/signl4-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/signl4/refs/heads/main/security/signl4-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/signl4-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/signl4/refs/heads/main/security/signl4-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/signl4-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/signl4/refs/heads/main/authentication/signl4-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'SIGNL4 publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Events API, Webhook API, and 2 more. Tagged areas include Alerting, Incident Management, On-Call, Mobile Alerts, and Notification.
