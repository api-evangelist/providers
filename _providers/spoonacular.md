...
- group: operate
  title: ''
  type: IssueTracker
  url: https://github.com/ddsky/spoonacular-api-clients/issues
- group: commercial
  title: ''
  type: License
  url: https://github.com/ddsky/spoonacular-api-clients/blob/master/LICENSE
- group: build
  title: ''
  type: PostmanWorkspace
  url: https://www.postman.com/kinlaneapi/spoonacular/overview
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/spoonacular/refs/heads/main/agentic-access/spoonacular-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/spoonacular-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spoonacular/refs/heads/main/security/spoonacular-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/spoonacular-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spoonacular/refs/heads/main/authentication/spoonacular-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/spoonacular/refs/heads/main/rules/spoonacular-spectral-rules.yml
  title: ''
  type: SpectralRules
  url: rules/spoonacular-spectral-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/spoonacular/refs/heads/main/vocabulary/spoonacular-vocabulary.yaml
  title: ''
  type: Vocabulary
  url: vocabulary/spoonacular-vocabulary.yaml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/spoonacular/refs/heads/main/json-ld/spoonacular-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/spoonacular-context.jsonld
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/spoonacular/refs/heads/main/plans/spoonacular-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/spoonacular-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/spoonacular/refs/heads/main/rate-limits/spoonacular-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/spoonacular-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/spoonacular/refs/heads/main/finops/spoonacular-finops.yml
  title: ''
  type: FinOps
...
overview: 'Spoonacular publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Ingredients API, Meal Planning API, Menu Items API, and 4 more. Tagged areas include Restaurant, Food and Beverage, Recipes, Nutrition, and Meal Planning.
  ...
  Spoonacular''s developer surface includes authentication, engineering blog, developer console, signup flow, pricing, code examples, tooling, and 19 more developer resources.'
plans:
