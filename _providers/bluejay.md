...
- group: company
  title: ''
  type: Website
  url: https://getbluejay.ai
- group: start
  title: ''
  type: DeveloperPortal
  url: https://docs.getbluejay.ai/
- group: docs
  title: ''
  type: Documentation
  url: https://docs.getbluejay.ai/
- group: docs
  title: ''
  type: APIReference
  url: https://docs.getbluejay.ai/api-reference/introduction
- group: start
  title: ''
  type: GettingStarted
  url: https://docs.getbluejay.ai/quickstart
- group: company
  title: ''
  type: Blog
  url: https://getbluejay.ai/blog
- group: commercial
  title: ''
  type: Pricing
  url: https://getbluejay.ai/pricing
- group: start
  title: ''
  type: SignUp
  url: https://app.getbluejay.ai/sign-up
- group: start
  title: ''
  type: Login
  url: https://app.getbluejay.ai/sign-in
- group: commercial
  title: ''
  type: TermsOfService
  url: https://getbluejay.ai/terms-of-service
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://getbluejay.ai/privacy-policy
- group: auth
  title: ''
  type: TrustCenter
...
created: '2026-07-17'
description: Bluejay is the testing, monitoring, and improvement layer for conversational AI agents. Enterprises, startups, and developers use Bluejay to evaluate voice and chat agents, run lifelike simulations with synthetic "digital humans" across voice, chat, SMS, and text channels, load-test and replay production calls, and catch regressions before they reach customers. The platform pairs a simulation engine with production observability - automated evaluation of tone, accuracy, task completion, and custom metrics, plus dashboards and alerts. It exposes a REST API (X-API-Key auth, /v1), a hosted MCP server, event webhooks, a first-party Python SDK, and integrations with Vapi, Retell, ElevenLabs, Bland, LiveKit, Google Dialogflow CX / CES, and Kore.ai. Backed by Homebrew.
...
nav: Providers
network: true
overview: 'Bluejay publishes 61 APIs on the [APIs.io](https://apis.io/) network, including Agents API, Alerts API, Api Keys API, and 58 more. Tagged areas include Company, Artificial Intelligence, AI Agents, Voice AI, and Conversational AI.
