...
access_model:
  ...
  source:
  - plans
  - '{''url'': ''https://www.becn.com/'', ''status'': 301, ''note'': ''declared website redirects to https://www.qxo.com/ — a different registrable domain (becn.com -> qxo.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: agent-aware
