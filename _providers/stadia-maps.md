...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/stadia-maps/refs/heads/main/security/stadia-maps-domain-security.yml
  title: ''
  type: DomainSecurity
...
overview: 'Stadia Maps publishes 11 APIs on the [APIs.io](https://apis.io/) network, including Attributes API, Autocomplete API, Geospatial API, and 8 more. Tagged areas include Mapping, Maps, Geocoding, Routing, and Navigation.
  ...
  Stadia Maps'' developer surface includes developer portal, documentation, API reference, pricing, authentication, engineering blog, and 10 more developer resources.'
plans:
...
- Geospatial
- Location
website: https://www.stadiamaps.com/
---
