...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/the-graph/refs/heads/main/agentic-access/the-graph-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/the-graph-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/the-graph/refs/heads/main/security/the-graph-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/the-graph-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/the-graph/refs/heads/main/security/the-graph-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/the-graph-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/the-graph/refs/heads/main/authentication/the-graph-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/the-graph/refs/heads/main/plans/the-graph-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/the-graph-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/the-graph/refs/heads/main/rate-limits/the-graph-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/the-graph-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/the-graph/refs/heads/main/finops/the-graph-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'The Graph publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Subgraphs API, and 5 more. Tagged areas include Web3, Indexing, GraphQL, Subgraph, and Multi-Chain.
