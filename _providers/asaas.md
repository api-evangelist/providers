...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/asaas/refs/heads/main/security/asaas-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Asaas publishes 20 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include Payments, Billing, Subscription, Pix, and Boleto.
