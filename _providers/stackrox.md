...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/stackrox/refs/heads/main/capabilities/stackrox-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/stackrox/refs/heads/main/agentic-access/stackrox-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/stackrox-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/stackrox/refs/heads/main/security/stackrox-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/stackrox-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/stackrox/refs/heads/main/authentication/stackrox-authentication.yml
  title: ''
  type: Authentication
  url: authentication/stackrox-authentication.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/stackrox
- group: company
  title: ''
  type: Website
...
- group: agent
  title: ''
  type: MCPServer
  url: https://github.com/stackrox/stackrox-mcp
created: '2026-03-26'
...
examples:
- key_count: 4
  name: Stackrox List Alerts Example
  slug: stackrox-list-alerts-example
finops:
- name: Stackrox Finops
  service_category: API
  slug: stackrox-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/stackrox.png
json_schemas:
- name: StackRox Alert
  property_count: 7
  slug: stackrox-alert
- name: StackRox Security Policy
  property_count: 10
  slug: stackrox-policy
json_structures:
- name: Stackrox Alert Structure
  property_count: 0
  slug: stackrox-alert-structure
jsonld:
- class_count: 7
