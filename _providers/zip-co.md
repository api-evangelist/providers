...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/zip-co/refs/heads/main/security/zip-co-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Zip publishes 3 APIs on the [APIs.io](https://apis.io/) network, including Global Merchant API, and 2 more. Tagged areas include Buy Now Pay Later, Digital Wallet, Payments, Fintech, and Checkout.
