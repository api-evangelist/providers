...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/lmnt/refs/heads/main/agentic-access/lmnt-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/lmnt-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lmnt/refs/heads/main/security/lmnt-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/lmnt-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lmnt/refs/heads/main/security/lmnt-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/lmnt-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lmnt/refs/heads/main/authentication/lmnt-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/lmnt/refs/heads/main/plans/lmnt-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/lmnt-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/lmnt/refs/heads/main/rate-limits/lmnt-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/lmnt-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/lmnt/refs/heads/main/finops/lmnt-finops.yml
  title: ''
  type: FinOps
  url: finops/lmnt-finops.yml
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/lmnt/refs/heads/main/openapi/_original/lmnt-speech-openapi.yml
  title: ''
  type: OpenAPI
  url: openapi/_original/lmnt-speech-openapi.yml
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/lmnt/refs/heads/main/json-schema/lmnt-voice-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/lmnt-voice-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/lmnt/refs/heads/main/json-schema/lmnt-speech-synthesis-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/lmnt-speech-synthesis-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/lmnt/refs/heads/main/json-ld/lmnt-context.jsonld
  title: ''
  type: JSONLDContext
  url: json-ld/lmnt-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/lmnt/refs/heads/main/vocabulary/lmnt-vocabulary.yml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'LMNT publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Ai API, Health Check API, Speech API, and 1 more. Tagged areas include Text-to-Speech, Voice Synthesis, Voice Cloning, Audio Streaming, and Conversational AI.
