...
- group: company
  title: ''
  type: Blog
  url: https://www.extole.com/blog/
- group: start
  title: ''
  type: Login
  url: https://my.extole.com/
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/extole
- group: build
  title: ''
  type: Postman
  url: https://www.postman.com/extole-4017592/extole-api/overview
- group: operate
  title: ''
  type: StatusPage
  url: https://status.extole.com/
- group: auth
  title: ''
  type: Compliance
...
nav: Providers
network: true
overview: 'Extole publishes 44 APIs on the [APIs.io](https://apis.io/) network, including Audiences API, Authentication API, Batch Jobs API, and 41 more. Tagged areas include Company, Referral Marketing, Advocacy, Loyalty, and Rewards.
...
- kind: trust-center
  name: Extole Trust Center
  slug: extole-trust-center
