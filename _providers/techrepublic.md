...
- collection_type: open
  name: TechRepublic WordPress REST Authors API
  slug: open-techrepublic-authors-api
- collection_type: open
  name: TechRepublic WordPress REST Authors Categories API
  slug: open-techrepublic-categories-api
- collection_type: open
  name: TechRepublic WordPress REST Authors Media API
  slug: open-techrepublic-media-api
- collection_type: open
  name: TechRepublic WordPress REST Authors Pages API
  slug: open-techrepublic-pages-api
- collection_type: open
  name: TechRepublic WordPress REST Authors Posts API
  slug: open-techrepublic-posts-api
- collection_type: open
  name: TechRepublic WordPress REST Authors Tags API
  slug: open-techrepublic-tags-api
- collection_type: open
  name: TechRepublic WordPress REST API
  slug: open-techrepublic-wordpress-rest-api
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/techrepublic/refs/heads/main/agentic-access/techrepublic-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/techrepublic-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/techrepublic/refs/heads/main/security/techrepublic-domain-security.yml
  title: ''
  type: DomainSecurity
