...
nav: Providers
network: true
overview: 'Spectral publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include API Design, API Linting, API Style Guide, AsyncAPI, and Developer Tools.
