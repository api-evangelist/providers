...
- group: docs
  title: ''
  type: Documentation
  url: https://docs.alokai.com/
- group: docs
  title: ''
  type: APIReference
  url: https://docs.alokai.com/cloud/api/swagger
- group: start
  title: ''
  type: GettingStarted
  url: https://docs.alokai.com/general/starting-new-project
- group: start
  title: ''
...
- group: company
  title: ''
  type: Blog
  url: https://alokai.com/blog
- group: commercial
  title: ''
  type: Pricing
  url: https://alokai.com/pricing
- group: start
  title: ''
  type: SignUp
  url: https://alokai.com/request-demo
- group: operate
  title: ''
  type: Support
  url: https://alokai.com/contact/sales
- group: commercial
  title: ''
  type: TermsOfService
  url: https://alokai.com/legal-directory
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://alokai.com/privacy-policy
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/vuestorefront
- group: operate
  title: ''
  type: StatusPage
...
overview: 'Alokai (formerly Vue Storefront) publishes 18 APIs on the [APIs.io](https://apis.io/) network, including cdn API, deploy_check API, flush_cache API, and 15 more. Tagged areas include Company, Saas, Ecommerce, Composable Commerce, and Headless Commerce.
  ...
  Alokai (formerly Vue Storefront)''s developer surface includes documentation, API reference, getting-started guide, engineering blog, pricing, signup flow, support, and 19 more developer resources.'
random_paper: 46
score:
  band: developing
  composite: 45.1
