...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cyberark-identity/refs/heads/main/agentic-access/cyberark-identity-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/cyberark-identity-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cyberark-identity/refs/heads/main/security/cyberark-identity-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/cyberark-identity-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cyberark-identity/refs/heads/main/security/cyberark-identity-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/cyberark-identity-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cyberark-identity/refs/heads/main/authentication/cyberark-identity-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'CyberArk Identity publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Authentication API, CDirectoryService API, ExtData API, and 5 more. Tagged areas include Identity, Access Management, Identity and Access Management, SSO, and Multi-Factor Authentication.
