...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://www.internationaltrucks.com/'', ''status'': 301, ''note'': ''declared website redirects to https://www.international.com/ — a different registrable domain (internationaltrucks.com -> international.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/navistar-international/refs/heads/main/security/navistar-international-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/navistar-international-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/navistar-inc
- group: company
  title: ''
  type: Website
  url: https://www.internationaltrucks.com/
- group: company
  title: ''
  type: Website
  url: https://www.navistar.com/
created: '2026-03-24'
description: Navistar International is a holding company that produces International brand commercial and military trucks, proprietary diesel engines, and IC Bus brand school and commercial buses. The company is now part of Traton Group (a Volkswagen Group subsidiary). No public APIs have been identified at this time; the legacy navistar-international.com domain currently redirects to a parts marketplace.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/navistar-international.png
layout: provider
modified: '2026-04-28'
