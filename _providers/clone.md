...
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/clone/refs/heads/main/packages/clone-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/clone-packages.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/clone/refs/heads/main/grpc/_index.yml
  title: ''
  type: Protobuf
  url: grpc/_index.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/clone/refs/heads/main/data-model/clone-data-model.yml
  title: ''
  type: DataModel
  url: data-model/clone-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/clone/refs/heads/main/errors/clone-error-codes.yml
  title: ''
  type: ErrorCatalog
  url: errors/clone-error-codes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/clone/refs/heads/main/conventions/clone-conventions.yml
  title: ''
  type: Conventions
  url: conventions/clone-conventions.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/clone/refs/heads/main/security/clone-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/clone-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/clone/refs/heads/main/llms/clone-llms.txt
  title: ''
  type: LLMsTxt
