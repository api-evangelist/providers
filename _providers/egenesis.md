...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/egenesis/refs/heads/main/security/egenesis-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: company
  title: ''
  type: Website
  url: https://egenesisbio.com
- group: company
  title: ''
  type: About
  url: https://egenesisbio.com/about
- group: company
  title: ''
  type: Blog
  url: https://egenesisbio.com/news-media
- group: operate
  title: ''
  type: Support
  url: https://egenesisbio.com/contact
- group: commercial
  title: ''
  type: TermsOfService
  url: https://egenesisbio.com/terms-of-use
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://egenesisbio.com/privacy-policy
- group: other
  title: ''
  type: X-Science
  url: https://egenesisbio.com/science
- group: other
  title: ''
  type: X-Pipeline
  url: https://egenesisbio.com/pipeline
- group: company
  title: ''
  type: X-Careers
  url: https://egenesisbio.com/careers
- group: company
  title: ''
  type: LinkedIn
...
nav: Providers
network: true
overview: 'eGenesis is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Biotechnology, Xenotransplantation, Gene Editing, and Genome Engineering.
