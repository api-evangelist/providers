...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mango-medical-inc/refs/heads/main/security/mango-medical-inc-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: Mango Medical Inc is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Healthcare, Medical, Startups, and Y Combinator.
random_paper: 3
score:
  band: minimal
  composite: 3.3
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/mango-medical-inc/refs/heads/main/screenshots/mango-medical-inc-2026-07-25T230041.png
security:
