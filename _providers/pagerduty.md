...
- group: commercial
  title: ''
  type: Pricing
  url: https://www.pagerduty.com/pricing/incident-management/
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/pagerduty/refs/heads/main/plans/pagerduty-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/pagerduty-plans-pricing.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/pagerduty/refs/heads/main/capabilities/pagerduty-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/pagerduty/refs/heads/main/agentic-access/pagerduty-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/pagerduty-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pagerduty/refs/heads/main/security/pagerduty-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/pagerduty-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pagerduty/refs/heads/main/authentication/pagerduty-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'PagerDuty publishes 38 APIs on the [APIs.io](https://apis.io/) network, including Events API, Abilities API, Add-Ons API, and 35 more. Tagged areas include Alerting, DevOps, Incident Management, On-Call Management, and pagerduty.


  The PagerDuty catalog on APIs.io includes 1 event-driven AsyncAPI specification and 1 Spectral governance ruleset.


  PagerDuty''s developer surface includes pricing, authentication, developer portal, documentation, getting-started guide, signup flow, engineering blog, and 17 more developer resources.'
plans:
- name: Pagerduty Plans Pricing
  plan_count: 11
  slug: pagerduty-plans-pricing
- name: Pagerduty Price Estimates
  plan_count: 0
  slug: pagerduty-price-estimates
random_paper: 13
rate_limits:
- limit_count: 3
