...
- acting_count: 40
  ...
  summary_line: 63 operations · 40 acting
api_count: 2
apis:
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/fiware/refs/heads/main/agentic-access/fiware-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/fiware-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/fiware/refs/heads/main/security/fiware-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'FIWARE publishes 12 APIs on the [APIs.io](https://apis.io/) network, including API Entry Point API, Attribute Value API, Attributes API, and 9 more. Tagged areas include Context Information, Devices, IoT, Linked Data, and NGSI.
