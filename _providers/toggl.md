...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/toggl/refs/heads/main/agentic-access/toggl-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/toggl-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/toggl/refs/heads/main/security/toggl-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/toggl-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/toggl/refs/heads/main/authentication/toggl-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Toggl Track publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Me API, Reports API, Time Entries API, and 3 more. Tagged areas include Time Tracking, Productivity, Project Management, Billing, and Reporting.
