...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/routific/refs/heads/main/capabilities/routific-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/routific/refs/heads/main/agentic-access/routific-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/routific-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/routific/refs/heads/main/security/routific-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/routific-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/routific/refs/heads/main/authentication/routific-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/routific/refs/heads/main/plans/routific-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/routific-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/routific/refs/heads/main/rate-limits/routific-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/routific-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/routific/refs/heads/main/finops/routific-finops.yml
  title: ''
  type: FinOps
  url: finops/routific-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/routific/refs/heads/main/vocabulary/routific-vocabulary.yml
  title: ''
  type: Vocabulary
...
overview: 'Routific publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Fix API, Jobs API, PDP API, and 1 more. Tagged areas include Route Optimization, VRP, Pickup and Delivery, Logistics, and Last Mile Delivery.
  ...
  Routific''s developer surface includes authentication, GitHub presence, developer portal, signup flow, documentation, support, engineering blog, and 18 more developer resources.'
plans:
