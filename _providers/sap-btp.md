...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sap-btp/refs/heads/main/security/sap-btp-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/sap-btp-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sap-btp/refs/heads/main/security/sap-btp-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sap-btp/refs/heads/main/plans/sap-btp-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/sap-btp-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/sap-btp/refs/heads/main/rate-limits/sap-btp-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/sap-btp-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sap-btp/refs/heads/main/finops/sap-btp-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'SAP Business Technology Platform publishes 7 APIs on the [APIs.io](https://apis.io/) network, including SAP BTP Core Services API, and 6 more. Tagged areas include SAP, Cloud Platform, Integration, Artificial Intelligence, and Data Management.
