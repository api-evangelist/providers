...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/vauto/refs/heads/main/security/vauto-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/vauto-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/vauto/refs/heads/main/security/vauto-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/vauto/refs/heads/main/plans/vauto-plans-pricing.yml
  title: ''
  type: Plans
...
nav: Providers
network: true
overview: 'vAuto publishes 2 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include Automotive, Dealership, Inventory, Appraisal, and Vehicle Pricing.
