...
nav: Providers
network: true
overview: 'Macaroon Network publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Agent Services API, and 3 more. Tagged areas include Agents, Agentic Commerce, A2A, MCP, and x402.
