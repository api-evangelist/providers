...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://gyant.com/'', ''status'': 301, ''note'': ''declared website redirects to https://www.fabrichealth.com/ — a different registrable domain (gyant.com -> fabrichealth.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/gyant/refs/heads/main/security/gyant-domain-security.yml
  title: ''
  type: DomainSecurity
