...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/context7/refs/heads/main/agentic-access/context7-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/context7-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/context7/refs/heads/main/security/context7-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/context7-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/context7/refs/heads/main/security/context7-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/context7-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/context7/refs/heads/main/authentication/context7-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Context7 publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Add API, Context API, Libs API, and 4 more. Tagged areas include Artificial Intelligence, Context, Documentation, LLM, and MCP.
