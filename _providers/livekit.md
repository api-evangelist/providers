...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/livekit/refs/heads/main/security/livekit-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/livekit-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/livekit/refs/heads/main/security/livekit-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/livekit/refs/heads/main/plans/livekit-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/livekit-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/livekit/refs/heads/main/rate-limits/livekit-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/livekit-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/livekit/refs/heads/main/finops/livekit-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'LiveKit publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Signaling Protocol (WebSocket), and 5 more. Tagged areas include Real-Time, WebRTC, Audio, Video, and Open Source.
