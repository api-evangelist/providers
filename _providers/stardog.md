...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/stardog/refs/heads/main/agentic-access/stardog-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/stardog-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/stardog/refs/heads/main/security/stardog-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/stardog-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/stardog/refs/heads/main/security/stardog-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/stardog-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/stardog-union
- group: company
  title: ''
  type: Website
...
- group: company
  title: ''
  type: Blog
  url: https://www.stardog.com/blog/
created: '2026-05-11'
description: Stardog is an enterprise knowledge graph platform that unifies data across silos using a semantic data layer combining knowledge graphs, virtualization, inference, and AI. The platform enables organizations to query data via SPARQL, GraphQL, and natural language while supporting RDF, OWL reasoning, and virtual graphs over relational sources. Stardog exposes a comprehensive HTTP API for database, query, transaction, and admin operations using HTTP Basic or OAuth Bearer authentication.
graphqls:
- description: ''
  name: Stardog GraphQL API
  slug: stardog-graphql
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/stardog.png
layout: provider
modified: '2026-05-11'
name: Stardog
nav: Providers
network: true
overview: 'Stardog publishes 24 APIs on the [APIs.io](https://apis.io/) network, including Checkpoints API, Cluster Admin API, Data Caching API, and 21 more. Tagged areas include Knowledge Graph, Graph Database, Semantic Web, SPARQL, and Data Virtualization.
...
- kind: trust-center
  name: Stardog Trust Center
  slug: stardog-trust-center
  summary_line: SOC 2
slug: stardog
tags:
- Knowledge Graph
