...
common:
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/zai/refs/heads/main/rate-limits/zai-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/zai-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/zai/refs/heads/main/plans/zai-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/zai-plans-pricing.yml
- group: other
...
overview: 'Zai publishes 26 APIs on the [APIs.io](https://apis.io/) network, including Addresses API, Authentication API, Bank Accounts API, and 23 more. Tagged areas include Payments, Australia, Payment Gateway, Payment Processing, and Marketplace Payments.
  ...
  Zai''s developer surface includes authentication, documentation, API reference, getting-started guide, pricing, engineering blog, support, and 36 more developer resources.'
plans:
- name: Zai Plans Pricing
  plan_count: 3
  slug: zai-plans-pricing
- name: Zai Price Estimates
  plan_count: 0
  slug: zai-price-estimates
random_paper: 16
rate_limits:
- limit_count: 0
  name: Zai Rate Limits
  slug: zai-rate-limits
scopes:
- name: Zai Scopes
  scope_count: 0
  slug: zai-scopes
