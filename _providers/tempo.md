...
- group: operate
  title: ''
  type: IssueTracker
  url: https://github.com/grafana/tempo/issues
- group: build
  title: ''
  type: CodeOfConduct
  url: https://github.com/grafana/tempo/blob/main/CODE_OF_CONDUCT.md
- group: docs
  title: ''
  type: ContributionGuide
  url: https://github.com/grafana/tempo/blob/main/CONTRIBUTING.md
- group: commercial
  title: ''
  type: License
  url: https://github.com/grafana/tempo/blob/main/LICENSE
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/tempo/refs/heads/main/agentic-access/tempo-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/tempo-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tempo/refs/heads/main/security/tempo-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/tempo-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tempo/refs/heads/main/security/tempo-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/tempo/refs/heads/main/openapi/_original/tempo-openapi.yml
  title: ''
  type: OpenAPI
  url: openapi/_original/tempo-openapi.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tempo/refs/heads/main/json-ld/tempo-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/tempo-context.jsonld
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/tempo/refs/heads/main/json-schema/tempo-trace-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/tempo-trace-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tempo/refs/heads/main/json-structure/tempo-trace-structure.json
  title: ''
  type: JSONStructure
  url: json-structure/tempo-trace-structure.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tempo/refs/heads/main/rules/tempo-rules.yml
  title: ''
  type: SpectralRules
  url: rules/tempo-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tempo/refs/heads/main/vocabulary/tempo-vocabulary.yml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'Tempo publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Health API, Metrics API, Search API, and 3 more. Tagged areas include Distributed Tracing, Observability, OpenTelemetry, Grafana, and Monitoring.
