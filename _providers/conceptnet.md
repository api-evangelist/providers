...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/conceptnet/refs/heads/main/agentic-access/conceptnet-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/conceptnet-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/conceptnet/refs/heads/main/security/conceptnet-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/conceptnet/refs/heads/main/plans/conceptnet-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/conceptnet-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/conceptnet/refs/heads/main/rate-limits/conceptnet-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/conceptnet-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/conceptnet/refs/heads/main/finops/conceptnet-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'ConceptNet publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Concepts API, Edges API, Query API, and 5 more. Tagged areas include Knowledge Graph, NLP, Semantic Web, Common Sense, and Multilingual.
