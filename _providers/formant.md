...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/formant/refs/heads/main/agentic-access/formant-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/formant-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/formant/refs/heads/main/security/formant-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/formant-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/formant/refs/heads/main/authentication/formant-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Formant publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Authentication API, Commands API, Data Access API, and 4 more. Tagged areas include Robotics, Robot Fleet Management, Teleoperation, Observability, and Telemetry.
