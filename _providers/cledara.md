...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cledara/refs/heads/main/security/cledara-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cledara/refs/heads/main/conformance/cledara-conformance.yml
  title: ''
  type: Compliance
...
- group: design
  ...
  url: conformance/cledara-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cledara/refs/heads/main/lifecycle/cledara-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/cledara-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cledara/refs/heads/main/conventions/cledara-conventions.yml
  title: ''
  type: Conventions
  url: conventions/cledara-conventions.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cledara/refs/heads/main/authentication/cledara-authentication.yml
  title: ''
  type: Authentication
  url: authentication/cledara-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cledara/refs/heads/main/scopes/cledara-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/cledara-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cledara/refs/heads/main/errors/cledara-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/cledara-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cledara/refs/heads/main/data-model/cledara-data-model.yml
  title: ''
  type: DataModel
  url: data-model/cledara-data-model.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/cledara/refs/heads/main/rate-limits/cledara-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/cledara-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/cledara/refs/heads/main/plans/cledara-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/cledara-plans-pricing.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/cledara/refs/heads/main/packages/cledara-packages.yml
  title: ''
  type: Packages
  url: packages/cledara-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cledara/refs/heads/main/llms/cledara-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/cledara-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cledara/refs/heads/main/well-known/cledara-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/cledara-well-known.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cledara/refs/heads/main/mcp/cledara-mcp.yml
  title: ''
  type: MCPServer
  url: mcp/cledara-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cledara/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/cledara/refs/heads/main/openapi/cledara-api-openapi.json
  title: ''
  type: OpenAPI
  url: openapi/cledara-api-openapi.json
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/cledara/refs/heads/main/overlays/cledara-api-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/cledara-api-overlay.yaml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/cledara/refs/heads/main/changelog/cledara-changelog.yml
  title: ''
  type: ChangeLog
