...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-video-intelligence/refs/heads/main/agentic-access/google-cloud-video-intelligence-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-cloud-video-intelligence-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-video-intelligence/refs/heads/main/security/google-cloud-video-intelligence-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-cloud-video-intelligence-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-video-intelligence/refs/heads/main/security/google-cloud-video-intelligence-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-video-intelligence/refs/heads/main/json-ld/context.jsonld
  title: ''
  type: JSONLD
...
overview: 'Google Cloud Video Intelligence publishes 2 APIs on the [APIs.io](https://apis.io/) network: Operations API and Videos:annotate API. Tagged areas include Content Moderation, Google Cloud, Machine Learning, Object Detection, and Video Analysis.
  ...
  Google Cloud Video Intelligence''s developer surface includes developer portal, getting-started guide, documentation, authentication, pricing, support, engineering blog, and 10 more developer resources.'
plans:
