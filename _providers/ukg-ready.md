...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ukg-ready/refs/heads/main/agentic-access/ukg-ready-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/ukg-ready-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ukg-ready/refs/heads/main/security/ukg-ready-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/ukg-ready-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ukg-ready/refs/heads/main/authentication/ukg-ready-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'UKG Ready publishes 3 APIs on the [APIs.io](https://apis.io/) network: Authentication API, Content API, and Groups API. Tagged areas include HCM, Payroll, Workforce Management, Time and Attendance, and Human Resources.
