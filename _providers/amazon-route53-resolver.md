...
overview: 'Amazon Route 53 Resolver publishes 63 APIs on the [APIs.io](https://apis.io/) network, including #X Amz Target=Route53Resolver.AssociateFirewallRuleGroup API, #X Amz Target=Route53Resolver.AssociateResolverEndpointIpAddress API, #X Amz Target=Route53Resolver.AssociateResolverQueryLogConfig API, and 60 more. Tagged areas include DNS, Hybrid Cloud, and Networking.
  ...
  Amazon Route 53 Resolver''s developer surface includes authentication, developer portal, documentation, support, signup flow, code examples, and 660 more developer resources.'
plans:
