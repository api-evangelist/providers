...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-memorystore/refs/heads/main/agentic-access/google-cloud-memorystore-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-cloud-memorystore-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-memorystore/refs/heads/main/security/google-cloud-memorystore-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-cloud-memorystore-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-memorystore/refs/heads/main/security/google-cloud-memorystore-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/google-cloud-memorystore-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-memorystore/refs/heads/main/authentication/google-cloud-memorystore-authentication.yml
  title: ''
  type: Authentication
  url: authentication/google-cloud-memorystore-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-memorystore/refs/heads/main/scopes/google-cloud-memorystore-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-memorystore/refs/heads/main/json-ld/google-cloud-memorystore-context.jsonld
  title: ''
  type: JSONLD
...
overview: 'Google Cloud Memorystore publishes 1 API on the [APIs.io](https://apis.io/) network: Instances API. Tagged areas include Cache, Google Cloud, In-Memory, Memcached, and Redis.
  ...
  Google Cloud Memorystore''s developer surface includes authentication, developer portal, getting-started guide, documentation, pricing, support, and 12 more developer resources.'
plans:
