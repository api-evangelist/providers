...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/health-net/refs/heads/main/security/health-net-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/health-net-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/health-net
- group: company
  title: ''
  type: Website
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/health-net.png
layout: provider
modified: '2026-04-28'
name: Health Net
nav: Providers
