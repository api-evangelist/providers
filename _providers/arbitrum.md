...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/arbitrum/refs/heads/main/agentic-access/arbitrum-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/arbitrum-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/arbitrum/refs/heads/main/security/arbitrum-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Arbitrum publishes 10 APIs on the [APIs.io](https://apis.io/) network, including One JSON-RPC, Nova JSON-RPC, Sepolia JSON-RPC, and 7 more. Tagged areas include Layer 2, Ethereum, Rollup, JSON-RPC, and Stylus.
