...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/royal-mail/refs/heads/main/agentic-access/royal-mail-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/royal-mail-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/royal-mail/refs/heads/main/security/royal-mail-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/royal-mail-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/royal-mail/refs/heads/main/authentication/royal-mail-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Royal Mail publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Labels API, Manifests API, Orders API, and 7 more. Tagged areas include Shipping, Postal Services, Labels, Tracking, and Logistics.
