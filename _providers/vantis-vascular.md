...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/vantis-vascular/refs/heads/main/security/vantis-vascular-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: Vantis Vascular is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Medical Devices, Healthcare, Cardiovascular, and Interventional Cardiology.
random_paper: 9
score:
  band: minimal
  composite: 2.9
