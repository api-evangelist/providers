...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/linden-lab/refs/heads/main/security/linden-lab-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/linden-lab/refs/heads/main/changelog/linden-lab-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/linden-lab-changelog.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/linden-lab/refs/heads/main/packages/linden-lab-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/linden-lab-packages.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/linden-lab/refs/heads/main/authentication/linden-lab-authentication.yml
  title: ''
  type: Authentication
  url: authentication/linden-lab-authentication.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/linden-lab/refs/heads/main/rate-limits/linden-lab-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/linden-lab-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/linden-lab/refs/heads/main/plans/linden-lab-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/linden-lab-plans-pricing.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/linden-lab/refs/heads/main/errors/linden-lab-error-codes.yml
  title: ''
  type: ErrorCatalog
  url: errors/linden-lab-error-codes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/linden-lab/refs/heads/main/lifecycle/linden-lab-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/linden-lab-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/linden-lab/refs/heads/main/conventions/linden-lab-conventions.yml
  title: ''
  type: Conventions
  url: conventions/linden-lab-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/linden-lab/refs/heads/main/conformance/linden-lab-conformance.yml
  title: ''
  type: Conformance
  url: conformance/linden-lab-conformance.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/linden-lab/refs/heads/main/sandbox/linden-lab-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/linden-lab-sandbox.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/linden-lab/refs/heads/main/components/linden-lab-components.yml
  title: ''
  type: Components
  url: components/linden-lab-components.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/linden-lab/refs/heads/main/data-model/linden-lab-data-model.yml
  title: ''
  type: DataModel
  url: data-model/linden-lab-data-model.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/linden-lab/refs/heads/main/examples/linden-lab-examples.yml
  title: ''
  type: Examples
  url: examples/linden-lab-examples.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/linden-lab/refs/heads/main/asyncapi/linden-lab-ans-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/linden-lab-ans-webhooks.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/linden-lab/refs/heads/main/llms/linden-lab-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/linden-lab-llms.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/linden-lab/refs/heads/main/security/linden-lab-vulnerability-disclosure.yml
  title: ''
  type: Security
