...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/capabilities/auth0-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/auth0-capability-edges.yml
- group: operate
  title: ''
  type: IssueTracker
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/agentic-access/auth0-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/auth0-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/security/auth0-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/auth0-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/security/auth0-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/auth0-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/security/auth0-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/auth0-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/authentication/auth0-authentication.yml
  title: ''
  type: Authentication
  url: authentication/auth0-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/scopes/auth0-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/arazzo/auth0-create-client-create-connection-enable-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/auth0-create-client-create-connection-enable-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/arazzo/auth0-create-client-grant-to-api-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/auth0-create-client-grant-to-api-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/arazzo/auth0-create-connection-enable-client-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/auth0-create-connection-enable-client-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/arazzo/auth0-create-org-add-connection-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/auth0-create-org-add-connection-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/arazzo/auth0-create-org-add-members-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/auth0-create-org-add-members-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/arazzo/auth0-create-org-assign-member-roles-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/auth0-create-org-assign-member-roles-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/arazzo/auth0-create-org-connection-and-invite-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/auth0-create-org-connection-and-invite-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/arazzo/auth0-create-resource-server-role-permissions-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/auth0-create-resource-server-role-permissions-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/arazzo/auth0-create-role-add-permissions-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/auth0-create-role-add-permissions-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/arazzo/auth0-create-role-assign-to-user-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/auth0-create-role-assign-to-user-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/arazzo/auth0-create-user-add-to-org-with-roles-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/auth0-create-user-add-to-org-with-roles-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/arazzo/auth0-create-user-assign-permissions-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/auth0-create-user-assign-permissions-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/arazzo/auth0-create-user-assign-roles-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/auth0-create-user-assign-roles-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/arazzo/auth0-find-role-assign-users-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/auth0-find-role-assign-users-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/arazzo/auth0-find-user-add-to-org-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/auth0-find-user-add-to-org-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/arazzo/auth0-find-user-assign-role-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/auth0-find-user-assign-role-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/arazzo/auth0-invite-user-to-org-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/auth0-invite-user-to-org-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/arazzo/auth0-offboard-user-revoke-grants-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/auth0-offboard-user-revoke-grants-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/arazzo/auth0-provision-m2m-app-workflow.yml
  title: ''
  type: Arazzo
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/plans/auth0-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/auth0-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/rate-limits/auth0-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/auth0-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/finops/auth0-finops.yml
  title: ''
  type: FinOps
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/vocabulary/auth0-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/auth0-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/auth0/refs/heads/main/json-ld/auth0-context.jsonld
  title: ''
  type: JSONLD
...
overview: 'Auth0 publishes 73 APIs on the [APIs.io](https://apis.io/) network, including actions API, anomaly API, Assertions API, and 70 more. Tagged areas include AI Agents, Authentication, Authorization, FGA, and Identity Management.
  ...
  Auth0''s developer surface includes authentication, documentation, getting-started guide, engineering blog, signup flow, pricing, support, and 49 more developer resources.'
plans:
