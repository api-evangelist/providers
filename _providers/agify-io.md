...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/agify-io/refs/heads/main/agentic-access/agify-io-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/agify-io-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/agify-io/refs/heads/main/security/agify-io-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Agify.io publishes 2 APIs on the [APIs.io](https://apis.io/) network, including Age Prediction API, and 1 more. Tagged areas include Age Prediction, Name Analysis, Demographics, and REST API.
