...
- group: company
  title: ''
  type: Website
  url: https://www.pixelixe.com/
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/pixelixe/refs/heads/main/agentic-access/pixelixe-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/pixelixe-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pixelixe/refs/heads/main/security/pixelixe-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/pixelixe-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pixelixe/refs/heads/main/authentication/pixelixe-authentication.yml
  title: ''
  type: Authentication
...
overview: 'Pixelixe publishes 3 APIs on the [APIs.io](https://apis.io/) network: Authentication API, Document API, and Graphic API. Tagged areas include Graphics and Image.
  ...
  Pixelixe''s developer surface includes authentication, engineering blog, and 5 more developer resources.'
plans:
...
- Graphics
- Image
website: https://www.pixelixe.com/
---
