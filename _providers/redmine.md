...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/redmine/refs/heads/main/agentic-access/redmine-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/redmine-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/redmine/refs/heads/main/security/redmine-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/redmine-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/redmine/refs/heads/main/authentication/redmine-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Redmine publishes 18 APIs on the [APIs.io](https://apis.io/) network, including Attachments API, Custom Fields.json API, Groups.json API, and 15 more. Tagged areas include Project Management, Issue Tracking, Open Source, Ruby on Rails, and Bug Tracking.
