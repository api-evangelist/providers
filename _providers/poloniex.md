...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/poloniex/refs/heads/main/security/poloniex-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Poloniex publishes 1 API on the [APIs.io](https://apis.io/) network: Poloniex. Tagged areas include Cryptocurrency, Public APIs, and Real-Time.
