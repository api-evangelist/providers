...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/telefonie/refs/heads/main/capabilities/telefonie-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/telefonie/refs/heads/main/agentic-access/telefonie-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/telefonie-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/telefonie/refs/heads/main/authentication/telefonie-authentication.yml
  title: ''
  type: Authentication
...
overview: 'Telefonie publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Available Numbers API, Calls API, Conferences API, and 3 more. Tagged areas include Call Recording, CPaaS, Messaging, Number Provisioning, and SMS.
  ...
  Telefonie''s developer surface includes authentication, getting-started guide, signup flow, engineering blog, pricing, changelog, GitHub presence, and 11 more developer resources.'
plans:
