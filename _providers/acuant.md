...
access_model:
  ...
  - authentication
  - security
  - '{''url'': ''https://www.acuant.com'', ''status'': 301, ''note'': ''declared website redirects to https://www.gbg.com/en-us/ — a different registrable domain (acuant.com -> gbg.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: agent-aware
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/acuant/refs/heads/main/agentic-access/acuant-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/acuant-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/acuant/refs/heads/main/security/acuant-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/acuant-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/acuant/refs/heads/main/authentication/acuant-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/acuant/refs/heads/main/plans/acuant-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/acuant-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/acuant/refs/heads/main/rate-limits/acuant-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/acuant-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/acuant/refs/heads/main/finops/acuant-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Acuant publishes 13 APIs on the [APIs.io](https://apis.io/) network, including Authentication API, Chip Data API, Document Data API, and 10 more. Tagged areas include Identity Verification, Document Authentication, Biometrics, Face Matching, and Liveness Detection.
