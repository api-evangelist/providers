...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/raml/refs/heads/main/security/raml-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/raml/refs/heads/main/json-ld/raml-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/raml-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/raml/refs/heads/main/vocabulary/raml-vocabulary.yml
  title: ''
  type: Vocabulary
...
overview: 'RAML publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include API Design, Specification Language, Standards, YAML, and REST.
  ...
  RAML''s developer surface includes documentation and 14 more developer resources.'
plans:
