...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ritas-italian-ice/refs/heads/main/security/ritas-italian-ice-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: Rita's Italian Ice is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Restaurant, Food and Beverage, Frozen Desserts, Franchise, and Quick Service Restaurant.
random_paper: 8
score:
  band: minimal
  composite: 9.7
