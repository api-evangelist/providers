...
- description: Hosted MCP server exposing 11 tools for news search, ticker news, trending, actionable-now, insider news, pair analysis, article retrieval, tickers, and alert management. OAuth 2.1 with RFC 7591 dynam
