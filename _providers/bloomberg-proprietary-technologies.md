...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bloomberg-proprietary-technologies/refs/heads/main/security/bloomberg-proprietary-technologies-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Bloomberg Proprietary Technologies publishes 3 APIs on the [APIs.io](https://apis.io/) network, including Bloomberg FIGI API, and 2 more. Tagged areas include Proprietary Technology, BLPAPI, BQL, FIGI, and B-PIPE.
