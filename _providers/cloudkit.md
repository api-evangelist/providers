...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/agentic-access/cloudkit-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/cloudkit-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/security/cloudkit-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/cloudkit-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/authentication/cloudkit-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/json-ld/cloudkit-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/cloudkit-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/rules/cloudkit-rules.yml
  title: ''
  type: Spectral
  url: rules/cloudkit-rules.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/packages/cloudkit-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/cloudkit-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/well-known/cloudkit-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/cloudkit-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/well-known/cloudkit-security.txt
  title: ''
  type: SecurityTxt
  url: well-known/cloudkit-security.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/mcp/cloudkit-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/cloudkit-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/llms/cloudkit-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/cloudkit-llms.txt
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/conformance/cloudkit-conformance.yml
  title: ''
  type: Conformance
...
- group: auth
  ...
  url: conformance/cloudkit-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/errors/cloudkit-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/cloudkit-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/lifecycle/cloudkit-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: operate
  ...
  url: lifecycle/cloudkit-lifecycle.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/security/cloudkit-vulnerability-disclosure.yml
  title: ''
...
- group: auth
  ...
  url: security/cloudkit-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/security/cloudkit-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/cloudkit-trust-center.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/sandbox/cloudkit-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/cloudkit-sandbox.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/conventions/cloudkit-conventions.yml
  title: ''
  type: Conventions
  url: conventions/cloudkit-conventions.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/changelog/cloudkit-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/cloudkit-changelog.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/cli/cloudkit-cli.yml
  title: ''
  type: CLI
  url: cli/cloudkit-cli.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/data-model/cloudkit-data-model.yml
  title: ''
  type: DataModel
  url: data-model/cloudkit-data-model.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/plans/cloudkit-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/cloudkit-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/rate-limits/cloudkit-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/cloudkit-rate-limits.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cloudkit/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
...
nav: Providers
network: true
overview: 'Apple CloudKit publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Assets API, Changes API, Records API, and 7 more. Tagged areas include Apple, Cloud Storage, CloudKit, Database, and iCloud.
