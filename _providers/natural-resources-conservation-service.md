...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/natural-resources-conservation-service/refs/heads/main/agentic-access/natural-resources-conservation-service-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/natural-resources-conservation-service-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/natural-resources-conservation-service/refs/heads/main/security/natural-resources-conservation-service-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Natural Resources Conservation Service publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Query API, SOAP API, Spatial API, and 1 more. Tagged areas include Federal Government, Agriculture, Conservation, Soil, and Natural Resources.
