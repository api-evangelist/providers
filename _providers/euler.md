...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/euler/refs/heads/main/agentic-access/euler-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/euler-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/euler/refs/heads/main/security/euler-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/euler-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/euler/refs/heads/main/security/euler-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/euler-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/euler/refs/heads/main/authentication/euler-authentication.yml
  title: ''
  type: Authentication
...
overview: 'Euler Finance publishes 21 APIs on the [APIs.io](https://apis.io/) network, including Accounts API, APYs API, Auth API, and 18 more. Tagged areas include DeFi, Lending, Borrowing, Finance, and Ethereum.
  ...
  Euler Finance''s developer surface includes authentication, documentation, engineering blog, and 15 more developer resources.'
plans:
- name: Plans
  plan_count: 2
  slug: plans
