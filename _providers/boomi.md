...
nav: Providers
network: true
overview: 'Boomi publishes 20 APIs on the [APIs.io](https://apis.io/) network, including Atoms API, Components API, Deployments API, and 17 more. Tagged areas include AI Agents, Automation, B2B, Data Integration, and EDI.
  ...
  Boomi''s developer surface includes getting-started guide, authentication, GitHub presence, pricing, signup flow, engineering blog, training material, and 73 more developer resources.'
plans:
