...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/shazam/refs/heads/main/agentic-access/shazam-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/shazam-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/shazam/refs/heads/main/security/shazam-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/shazam-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/shazam/refs/heads/main/authentication/shazam-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Shazam publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Albums API, Artists API, Charts API, and 4 more. Tagged areas include Music, Audio Recognition, Song Identification, Charts, and Artists.
