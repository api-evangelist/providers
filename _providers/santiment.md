...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/santiment/refs/heads/main/security/santiment-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Santiment publishes 2 APIs on the [APIs.io](https://apis.io/) network, including SanAPI, and 1 more. Tagged areas include Crypto, Blockchain, Market Intelligence, On-Chain Metrics, and Social Sentiment.
