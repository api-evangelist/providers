...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/codecombat/refs/heads/main/capabilities/codecombat-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/codecombat-capability-edges.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/codecombat/refs/heads/main/security/codecombat-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/codecombat-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/codecombat/refs/heads/main/authentication/codecombat-authentication.yml
  title: ''
  type: Authentication
...
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/codecombat/refs/heads/main/packages/codecombat-packages.yml
  title: ''
  type: Packages
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/codecombat/refs/heads/main/mcp/codecombat-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/codecombat-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/codecombat/refs/heads/main/llms/codecombat-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/codecombat-llms.txt
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/codecombat/refs/heads/main/overlays/codecombat-openapi-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/codecombat-openapi-overlay.yaml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/codecombat/refs/heads/main/conformance/codecombat-conformance.yml
  title: ''
  type: Conformance
  url: conformance/codecombat-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/codecombat/refs/heads/main/conventions/codecombat-conventions.yml
  title: ''
  type: Conventions
  url: conventions/codecombat-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/codecombat/refs/heads/main/data-model/codecombat-data-model.yml
  title: ''
  type: DataModel
  url: data-model/codecombat-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/codecombat/refs/heads/main/lifecycle/codecombat-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/codecombat-lifecycle.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/codecombat/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
