...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/base-l2/refs/heads/main/agentic-access/base-l2-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/base-l2-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/base-l2/refs/heads/main/security/base-l2-domain-security.yml
  title: ''
  type: DomainSecurity
