...
common:
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/planradar/refs/heads/main/plans/planradar-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/planradar-plans-pricing.yml
- group: other
...
- group: start
  ...
  url: https://help.planradar.com/hc/en-gb/categories/15480406372381
- group: docs
  title: ''
  type: Documentation
  url: https://help.planradar.com/hc/en-gb/articles/15480453097373-Open-API-Overview
- group: docs
  title: ''
  type: APIReference
  url: https://www.planradar.com/api-docs/index.html
- group: start
  title: ''
  type: GettingStarted
  url: https://www.planradar.com/quick-start-guides/welcome/
- group: operate
  title: ''
  type: Support
  url: https://help.planradar.com/hc
- group: company
  title: ''
  type: Blog
...
- group: commercial
  title: ''
  type: Pricing
  url: https://www.planradar.com/pricing/
- group: start
  title: ''
  type: SignUp
  url: https://www.planradar.com/registration/
- group: start
  title: ''
  type: Login
  url: https://planradar.com/login
- group: commercial
  title: ''
  type: TermsOfService
  url: https://www.planradar.com/terms-of-service/
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://www.planradar.com/privacy-policy/
- group: operate
  title: ''
  type: ChangeLog
...
overview: 'PlanRadar publishes 36 APIs on the [APIs.io](https://apis.io/) network, including Approval Requests V2 API, Approval Workflows V2 API, Components-Plans API, and 33 more. Tagged areas include Company, Construction, Real Estate, Project Management, and Documentation.
  ...
  PlanRadar''s developer surface includes authentication, documentation, API reference, getting-started guide, support, engineering blog, pricing, and 23 more developer resources.'
plans:
- name: Planradar Plans Pricing
  plan_count: 4
  slug: planradar-plans-pricing
- name: Planradar Price Estimates
  plan_count: 0
  slug: planradar-price-estimates
random_paper: 3
score:
  band: developing
  composite: 51.4
