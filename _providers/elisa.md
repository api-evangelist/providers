...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/elisa/refs/heads/main/openapi/_original/elisa-events-calendar-openapi.json
  title: ''
  type: OpenAPI
  url: openapi/_original/elisa-events-calendar-openapi.json
- group: other
...
overview: 'ELISA publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Categories API, Doc API, Events API, and 3 more. Tagged areas include Embedded, Linux, Linux Foundation, Safety, and Functional Safety.
  ...
  ELISA''s developer surface includes documentation, API reference, getting-started guide, support, engineering blog, signup flow, pricing, and 28 more developer resources.'
plans:
