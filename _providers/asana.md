...
- name: Asana Finops
  ...
  slug: asana-finops
graphqls:
- description: Asana does not offer a public native GraphQL endpoint. The Asana platform exposes its capabilities exclusively through a REST API available at `https://app.asana.com/api/1.0`. The schema in `asana-sch
  name: Asana GraphQL
  slug: asana-graphql
