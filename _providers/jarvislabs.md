...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/jarvislabs/refs/heads/main/capabilities/jarvislabs-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/jarvislabs-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/jarvislabs/refs/heads/main/agentic-access/jarvislabs-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/jarvislabs-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jarvislabs/refs/heads/main/security/jarvislabs-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/jarvislabs-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jarvislabs/refs/heads/main/authentication/jarvislabs-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/jarvislabs/refs/heads/main/plans/jarvislabs-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/jarvislabs-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/jarvislabs/refs/heads/main/rate-limits/jarvislabs-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/jarvislabs-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/jarvislabs/refs/heads/main/finops/jarvislabs-finops.yml
  title: ''
  type: FinOps
...
overview: 'JarvisLabs publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Account API, Filesystems API, GPU Types API, and 2 more. Tagged areas include Artificial Intelligence, GPU, Cloud, Infrastructure, and Compute.
  ...
  JarvisLabs'' developer surface includes pricing, authentication, documentation, and 9 more developer resources.'
plans:
