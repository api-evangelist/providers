...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/discovery-communications/refs/heads/main/security/discovery-communications-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/discovery-communications-domain-security.yml
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/discovery
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/discoveryinc
- group: company
  title: ''
  type: Website
...
- group: company
  title: ''
  type: Website
  url: https://www.discovery-communications.com
- group: company
  title: ''
  type: Blog
  url: https://www.wbd.com/newsroom
created: '2026-03-24'
description: Discovery Communications was a global media company providing original and purchased programming across multiple distribution platforms before merging with WarnerMedia in 2022 to form Warner Bros. Discovery (WBD), a leading global media and entertainment company whose portfolio spans HBO Max, Discovery Channel, CNN, Warner Bros. film studios, DC, Food Network, HGTV, and other television, film, and streaming brands. No public developer APIs are documented at the corporate level; technical and partnership inquiries are handled at the individual brand or business-unit level.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/discovery-communications.png
layout: provider
modified: '2026-04-28'
name: Discovery Communications
nav: Providers
network: true
overview: 'Discovery Communications is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Media, Entertainment, Television, Streaming, and Fortune 500.
