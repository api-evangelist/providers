...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/agentic-access/sensible-so-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/sensible-so-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/security/sensible-so-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/sensible-so-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/security/sensible-so-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/sensible-so-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/security/sensible-so-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/sensible-so-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/authentication/sensible-so-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/arazzo/sensible-so-classify-then-extract-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/sensible-so-classify-then-extract-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/arazzo/sensible-so-config-versions-then-get-by-version-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/sensible-so-config-versions-then-get-by-version-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/arazzo/sensible-so-create-document-type-and-configuration-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/sensible-so-create-document-type-and-configuration-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/arazzo/sensible-so-create-reference-document-and-list-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/sensible-so-create-reference-document-and-list-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/arazzo/sensible-so-extract-from-url-and-poll-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/sensible-so-extract-from-url-and-poll-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/arazzo/sensible-so-extract-from-url-poll-then-csv-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/sensible-so-extract-from-url-poll-then-csv-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/arazzo/sensible-so-extract-reference-text-then-list-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/sensible-so-extract-reference-text-then-list-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/arazzo/sensible-so-get-document-type-then-list-configurations-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/sensible-so-get-document-type-then-list-configurations-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/arazzo/sensible-so-list-configurations-then-get-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/sensible-so-list-configurations-then-get-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/arazzo/sensible-so-list-document-types-then-extract-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/sensible-so-list-document-types-then-extract-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/arazzo/sensible-so-list-extractions-then-retrieve-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/sensible-so-list-extractions-then-retrieve-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/arazzo/sensible-so-portfolio-extract-from-url-and-poll-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/sensible-so-portfolio-extract-from-url-and-poll-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/arazzo/sensible-so-portfolio-upload-url-and-poll-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/sensible-so-portfolio-upload-url-and-poll-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/arazzo/sensible-so-sync-extract-then-spreadsheet-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/sensible-so-sync-extract-then-spreadsheet-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/arazzo/sensible-so-upload-url-extract-and-poll-workflow.yml
  title: ''
  type: Arazzo
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/plans/sensible-so-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/sensible-so-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/rate-limits/sensible-so-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/sensible-so-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/finops/sensible-so-finops.yml
  title: ''
  type: FinOps
  url: finops/sensible-so-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/vocabulary/sensible-so-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/sensible-so-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sensible-so/refs/heads/main/rules/sensible-so-rules.yml
  title: ''
  type: SpectralRules
...
overview: 'Sensible publishes 7 APIs on the [APIs.io](https://apis.io/) network, including sensible-so Configuration API, sensible-so Document API, sensible-so Document type API, and 4 more.
  ...
  Sensible''s developer surface includes authentication, developer portal, documentation, changelog, getting-started guide, signup flow, pricing, and 42 more developer resources.'
plans:
