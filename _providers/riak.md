...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/riak/refs/heads/main/agentic-access/riak-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/riak-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/riak/refs/heads/main/security/riak-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/riak-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/riak/refs/heads/main/authentication/riak-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Riak KV publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Mapred API, Ping API, Riak KV HTTP API, and 5 more. Tagged areas include Database, NoSQL, Key-Value Store, Distributed Systems, and Open Source.
