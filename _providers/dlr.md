...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/dlr/refs/heads/main/agentic-access/dlr-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/dlr-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/dlr/refs/heads/main/security/dlr-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/dlr-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/dlr/refs/heads/main/security/dlr-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'DLR publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Capabilities API, Data API, STAC API, and 7 more. Tagged areas include Earth Observation, Remote Sensing, Satellite Data, Geospatial, and Aerospace.
