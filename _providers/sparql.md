...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/sparql/refs/heads/main/agentic-access/sparql-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/sparql-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sparql/refs/heads/main/security/sparql-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: SPARQL publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Query API, Graph API, and 4 more. Tagged areas include Linked Data, Query Language, RDF, Semantic Web, and SPARQL.
plans:
