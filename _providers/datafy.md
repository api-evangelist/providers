...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/datafy/refs/heads/main/security/datafy-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/datafy-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/datafy/refs/heads/main/authentication/datafy-authentication.yml
  title: ''
  type: Authentication
  url: authentication/datafy-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/datafy/refs/heads/main/conventions/datafy-conventions.yml
  title: ''
  type: Conventions
  url: conventions/datafy-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/datafy/refs/heads/main/lifecycle/datafy-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/datafy-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/datafy/refs/heads/main/errors/datafy-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/datafy-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/datafy/refs/heads/main/data-model/datafy-data-model.yml
  title: ''
  type: DataModel
  url: data-model/datafy-data-model.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/datafy/refs/heads/main/rate-limits/datafy-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/datafy-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/datafy/refs/heads/main/plans/datafy-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/datafy-plans-pricing.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/datafy/refs/heads/main/conformance/datafy-conformance.yml
  title: ''
  type: Conformance
...
- group: auth
  ...
  url: conformance/datafy-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/datafy/refs/heads/main/components/datafy-components.yml
  title: ''
  type: Components
  url: components/datafy-components.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/datafy/refs/heads/main/llms/datafy-llms.txt
  title: ''
  type: LLMsTxt
