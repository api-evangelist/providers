...
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/synthesized/refs/heads/main/packages/synthesized-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/synthesized-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/synthesized/refs/heads/main/llms/synthesized-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/synthesized-llms.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/synthesized/refs/heads/main/authentication/synthesized-authentication.yml
  title: ''
  type: Authentication
  url: authentication/synthesized-authentication.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/synthesized/refs/heads/main/changelog/synthesized-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/synthesized-changelog.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/synthesized/refs/heads/main/lifecycle/synthesized-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: operate
  ...
  url: lifecycle/synthesized-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/synthesized/refs/heads/main/conventions/synthesized-conventions.yml
  title: ''
  type: Conventions
  url: conventions/synthesized-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/synthesized/refs/heads/main/conformance/synthesized-conformance.yml
  title: ''
  type: Conformance
  url: conformance/synthesized-conformance.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/synthesized/refs/heads/main/cli/synthesized-cli.yml
  title: ''
  type: CLI
  url: cli/synthesized-cli.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/synthesized/refs/heads/main/mcp/synthesized-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/synthesized-mcp.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/synthesized/refs/heads/main/security/synthesized-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Synthesized publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Test Data, Synthetic Data, Data Masking, and Privacy.
