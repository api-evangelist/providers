...
- baseURL: https://developer.egym.com/mcp
  baseurl_source: declared
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/egym/refs/heads/main/openapi/_original/egym-mms-api-v2-openapi.yml
  title: ''
  type: OpenAPI
  url: openapi/_original/egym-mms-api-v2-openapi.yml
created: '2026-08-12'
...
nav: Providers
network: true
overview: 'EGYM publishes 38 APIs on the [APIs.io](https://apis.io/) network, including 1. Cardio Measurements API, 2. Workouts API, Alive API, and 35 more. Tagged areas include Company, Fitness, Health, Wellness, and Corporate Wellness.
