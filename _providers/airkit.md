...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''http://www.airkit.com'', ''status'': 301, ''note'': ''declared website redirects to https://www.salesforce.com/agentforce/?bc=DB — a different registrable domain (airkit.com -> salesforce.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/airkit/refs/heads/main/security/airkit-domain-security.yml
  title: ''
  type: DomainSecurity
