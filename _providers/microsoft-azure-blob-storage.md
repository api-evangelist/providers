...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/microsoft-azure-blob-storage/refs/heads/main/agentic-access/microsoft-azure-blob-storage-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/microsoft-azure-blob-storage-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/microsoft-azure-blob-storage/refs/heads/main/security/microsoft-azure-blob-storage-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/microsoft-azure-blob-storage-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/microsoft-azure-blob-storage/refs/heads/main/authentication/microsoft-azure-blob-storage-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Azure Blob Storage publishes 12 APIs on the [APIs.io](https://apis.io/) network, including Append Blobs API, Azure Blob Storage REST API, Blobs API, and 9 more. Tagged areas include Azure, Blobs, Cloud Storage, Microsoft, and Object Storage.
