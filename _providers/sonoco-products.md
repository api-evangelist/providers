...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sonoco-products/refs/heads/main/security/sonoco-products-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/sonoco-products-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/sonoco
- group: company
  title: ''
  type: Website
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/sonoco-products.png
layout: provider
modified: '2026-05-02'
name: Sonoco Products
nav: Providers
network: true
overview: 'Sonoco Products is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Packaging, Manufacturing, Consumer Goods, Industrial, and Sustainability.
