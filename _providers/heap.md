...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/heap/refs/heads/main/agentic-access/heap-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/heap-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/heap/refs/heads/main/security/heap-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/heap-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/heap/refs/heads/main/security/heap-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Heap publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Add Account Properties API, Add User Properties API, Identify API, and 7 more. Tagged areas include Analytics, Autocapture, Digital Analytics, Product Analytics, and Session Replay.
