...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/lenovo/refs/heads/main/agentic-access/lenovo-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/lenovo-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lenovo/refs/heads/main/security/lenovo-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/lenovo-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lenovo/refs/heads/main/authentication/lenovo-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Lenovo publishes 3 APIs on the [APIs.io](https://apis.io/) network, including Inventory API, Sessions API, and 1 more. Tagged areas include Data Center, Hardware, Infrastructure, Personal Computers, and Servers.
