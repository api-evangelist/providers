...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/sana-labs/refs/heads/main/capabilities/sana-labs-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/sana-labs-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/sana-labs/refs/heads/main/agentic-access/sana-labs-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/sana-labs-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sana-labs/refs/heads/main/security/sana-labs-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/sana-labs-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sana-labs/refs/heads/main/authentication/sana-labs-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sana-labs/refs/heads/main/plans/sana-labs-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/sana-labs-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/sana-labs/refs/heads/main/rate-limits/sana-labs-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/sana-labs-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sana-labs/refs/heads/main/finops/sana-labs-finops.yml
  title: ''
  type: FinOps
...
overview: 'Sana publishes 11 APIs on the [APIs.io](https://apis.io/) network, including Assignments API, Authentication API, Courses API, and 8 more. Tagged areas include Artificial Intelligence, Knowledge, Learning, LMS, and Agents.
  ...
  Sana''s developer surface includes authentication, documentation, and 9 more developer resources.'
plans:
