...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/guru/refs/heads/main/agentic-access/guru-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/guru-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/guru/refs/heads/main/security/guru-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/guru-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/guru/refs/heads/main/authentication/guru-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Guru publishes 18 APIs on the [APIs.io](https://apis.io/) network, including Analytics API, Announcements API, Answers API, and 15 more. Tagged areas include Knowledge Management, Enterprise Search, AI Knowledge Base, Internal Wiki, and Verified Knowledge.
