...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/floward/refs/heads/main/security/floward-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Floward is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Flowers, Gifting, E-Commerce, and Retail.
