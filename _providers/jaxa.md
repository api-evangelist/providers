...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jaxa/refs/heads/main/security/jaxa-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'JAXA publishes 8 APIs on the [APIs.io](https://apis.io/) network, including CSW API, WCS API, WMS API, and 5 more. Tagged areas include Space, Satellite, Earth Observation, Remote Sensing, and Geospatial.
