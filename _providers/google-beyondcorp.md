...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-beyondcorp/refs/heads/main/agentic-access/google-beyondcorp-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-beyondcorp-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-beyondcorp/refs/heads/main/security/google-beyondcorp-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-beyondcorp-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-beyondcorp/refs/heads/main/security/google-beyondcorp-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/google-beyondcorp-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-beyondcorp/refs/heads/main/authentication/google-beyondcorp-authentication.yml
  title: ''
  type: Authentication
  url: authentication/google-beyondcorp-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-beyondcorp/refs/heads/main/scopes/google-beyondcorp-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-beyondcorp/refs/heads/main/json-ld/google-beyondcorp-context.jsonld
  title: ''
  type: JSONLD
...
overview: 'Google BeyondCorp publishes 3 APIs on the [APIs.io](https://apis.io/) network: AppConnections API, AppConnectors API, and SecurityGateways API. Tagged areas include Access Control, Enterprise Security, Identity, Security, and VPN Alternative.
  ...
  Google BeyondCorp''s developer surface includes authentication, getting-started guide, pricing, and 7 more developer resources.'
plans:
