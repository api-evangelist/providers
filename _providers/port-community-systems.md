...
- description: The International Port Community Systems Association (IPCSA) represents Port Community System operators and Maritime Single Window operators worldwide. Member PCS platforms provide APIs for customs de
  ...
  slug: ipcsa
- baseURL: https://api.portbase.com/v1
  baseurl_source: spec
...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/port-community-systems/refs/heads/main/capabilities/port-community-systems-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/port-community-systems-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/port-community-systems/refs/heads/main/agentic-access/port-community-systems-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/port-community-systems-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/port-community-systems/refs/heads/main/security/port-community-systems-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/port-community-systems-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/port-community-systems/refs/heads/main/authentication/port-community-systems-authentication.yml
  title: ''
  type: Authentication
  url: authentication/port-community-systems-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/port-community-systems/refs/heads/main/scopes/port-community-systems-scopes.yml
  title: ''
  type: OAuthScopes
...
nav: Providers
network: true
overview: 'Port Community Systems publishes 5 APIs on the [APIs.io](https://apis.io/) network, including CargoManifests API, Containers API, CustomsDeclarations API, and 2 more. Tagged areas include Maritime, Ports, Logistics, Customs, and Cargo.
