...
- collection_type: open
  name: Argo CD AccountService API
  slug: open-argo-cd-accountservice-api
- collection_type: open
  name: Argo CD AccountService ApplicationService API
  slug: open-argo-cd-applicationservice-api
- collection_type: open
  name: Argo CD AccountService ApplicationSetService API
  slug: open-argo-cd-applicationsetservice-api
- collection_type: open
  name: Argo CD AccountService CertificateService API
  slug: open-argo-cd-certificateservice-api
- collection_type: open
  name: Argo CD AccountService ClusterService API
  slug: open-argo-cd-clusterservice-api
- collection_type: open
  name: Argo CD AccountService GPGKeyService API
  slug: open-argo-cd-gpgkeyservice-api
- collection_type: open
  name: Argo CD AccountService NotificationService API
  slug: open-argo-cd-notificationservice-api
- collection_type: open
  name: Argo CD AccountService ProjectService API
  slug: open-argo-cd-projectservice-api
- collection_type: open
  name: Argo CD AccountService RepoCredsService API
  slug: open-argo-cd-repocredsservice-api
- collection_type: open
  name: Argo CD AccountService RepositoryService API
  slug: open-argo-cd-repositoryservice-api
- collection_type: open
  name: Argo CD AccountService SessionService API
  slug: open-argo-cd-sessionservice-api
- collection_type: open
  name: Argo CD AccountService SettingsService API
  slug: open-argo-cd-settingsservice-api
- collection_type: open
  name: Argo CD AccountService VersionService API
  slug: open-argo-cd-versionservice-api
- collection_type: open
  name: Argo CD
  slug: open-argo-cd
common:
