...
- group: company
  ...
  url: https://cuein.ai/
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/cuein/refs/heads/main/capabilities/cuein-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/cuein-capability-edges.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/cuein/refs/heads/main/overlays/cuein-answers-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/cuein-answers-overlay.yaml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cuein/refs/heads/main/security/cuein-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/cuein-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cuein/refs/heads/main/agentic-access/cuein-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/cuein-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cuein/refs/heads/main/authentication/cuein-authentication.yml
  title: ''
  type: Authentication
  url: authentication/cuein-authentication.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cuein/refs/heads/main/llms/cuein-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/cuein-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cuein/refs/heads/main/mcp/cuein-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/cuein-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cuein/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cuein/refs/heads/main/conventions/cuein-conventions.yml
  title: ''
  type: Conventions
  url: conventions/cuein-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cuein/refs/heads/main/errors/cuein-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/cuein-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cuein/refs/heads/main/data-model/cuein-data-model.yml
  title: ''
  type: DataModel
  url: data-model/cuein-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cuein/refs/heads/main/conformance/cuein-conformance.yml
  title: ''
  type: Conformance
  url: conformance/cuein-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cuein/refs/heads/main/lifecycle/cuein-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/cuein-lifecycle.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cuein/refs/heads/main/security/cuein-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/cuein-trust-center.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/cuein/refs/heads/main/overlays/cuein-insights-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/cuein-insights-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cuein/refs/heads/main/well-known/cuein-well-known.yml
  title: ''
  type: WellKnown
...
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/cuein/refs/heads/main/packages/cuein-packages.yml
  title: ''
  type: Packages
  url: packages/cuein-packages.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/cuein/refs/heads/main/plans/cuein-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/cuein-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/cuein/refs/heads/main/rate-limits/cuein-rate-limits.yml
  title: ''
  type: RateLimits
