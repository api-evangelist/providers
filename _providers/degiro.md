...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/degiro/refs/heads/main/agentic-access/degiro-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/degiro-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/degiro/refs/heads/main/security/degiro-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/degiro-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/degiro/refs/heads/main/authentication/degiro-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'DEGIRO publishes 11 APIs on the [APIs.io](https://apis.io/) network, including Product Search API, Reporting API, Config API, and 8 more. Tagged areas include Trading, Brokerage, Stocks, ETFs, and Portfolio.
