...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/kafka/refs/heads/main/security/kafka-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/kafka-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/kafka/refs/heads/main/security/kafka-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Apache Kafka publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Kafka Producer API, Kafka Consumer API, and 3 more. Tagged areas include Distributed Systems, Event-Driven, Messaging, Real-Time, and Streaming.
