...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/hyperverge/refs/heads/main/agentic-access/hyperverge-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/hyperverge-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hyperverge/refs/heads/main/security/hyperverge-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/hyperverge-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hyperverge/refs/heads/main/authentication/hyperverge-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/hyperverge/refs/heads/main/plans/hyperverge-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/hyperverge-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/hyperverge/refs/heads/main/rate-limits/hyperverge-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/hyperverge-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/hyperverge/refs/heads/main/finops/hyperverge-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'HyperVerge publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Database Verification API, Face Match API, Input Validation API, and 3 more. Tagged areas include Identity Verification, KYC, Face Authentication, Liveness, and Document Verification.
