...
- description: 'REST API for backend integrations: list users and wallets, manage policies, validate JWTs, fetch auth events, manage environments.'
  ...
  slug: backend-api
- description: REST API to provision, sign, and manage server-controlled wallets across EVM, Solana, and other chains.
...
- group: other
  title: ''
  type: CapabilityMap
  url: capabilities/dynamic-xyz-capability-edges.yml
- group: agent
  title: ''
  type: AgenticAccess
  url: agentic-access/dynamic-xyz-agentic-access.yml
- group: auth
  title: ''
  type: TrustCenter
  url: security/dynamic-xyz-trust-center.yml
- group: auth
  title: ''
  type: VulnerabilityDisclosure
  url: security/dynamic-xyz-vulnerability-disclosure.yml
- group: auth
  title: ''
  type: DomainSecurity
  url: security/dynamic-xyz-domain-security.yml
- group: auth
  title: ''
  type: Authentication
  url: authentication/dynamic-xyz-authentication.yml
- group: build
  title: ''
...
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/dynamiclabs
- group: company
  title: ''
  type: Website
...
- group: commercial
  title: ''
  type: Plans
  url: plans/dynamic-xyz-plans-pricing.yml
- group: operate
  title: ''
  type: RateLimits
  url: rate-limits/dynamic-xyz-rate-limits.yml
- group: commercial
  title: ''
  type: FinOps
  url: finops/dynamic-xyz-finops.yml
created: '2026-05-08'
description: Dynamic is a wallet and authentication platform offering embedded wallets, social/email/passkey login, MPC signers, and a Backend / Admin REST API for managing users, wallets, and sessions. Provides SDKs across Web, React, React Native, Flutter, Swift, Kotlin, Node.js, Unity.
finops:
- name: Dynamic Xyz Finops
  service_category: Web3
  slug: dynamic-xyz-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/dynamic-xyz.png
layout: provider
modified: '2026-05-08'
name: Dynamic
nav: Providers
network: true
overview: 'Dynamic publishes 37 APIs on the [APIs.io](https://apis.io/) network, including Allowlists API, Analytics API, Chainalysis API, and 34 more. Tagged areas include Web3, Wallets, Authentication, Embedded Wallets, and MPC.


  Dynamic''s developer surface includes authentication and 11 more developer resources.'
plans:
...
- kind: vulnerability-disclosure
  name: Dynamic Xyz Vulnerability Disclosure
  slug: dynamic-xyz-vulnerability-disclosure
  summary_line: Bugcrowd
- kind: trust-center
  name: Dynamic Xyz Trust Center
  slug: dynamic-xyz-trust-center
  summary_line: SOC 2
slug: dynamic-xyz
tags:
- Web3
