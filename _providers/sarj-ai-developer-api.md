...
- acting_count: 70
  human_in_the_loop: 2
  name: Sarj Ai Developer Api Agentic Access
  operation_count: 118
...
- group: docs
  title: ''
  type: APIReference
  url: https://platform-docs.sarj.ai/api-reference
- group: start
  title: ''
  type: GettingStarted
...
- group: operate
  title: ''
  type: Support
  url: mailto:support@sarj.ai
- group: start
  title: ''
  type: SignUp
  url: https://platform.sarj.ai/sign-in
- group: build
  title: ''
...
- group: agent
  title: ''
  type: LLMSTxt
  url: llms/sarj-ai-developer-api-llms.txt
- group: other
  title: ''
  type: AgentCard
  url: a2a/sarj-ai-developer-api-a2a.yml
- group: agent
  title: ''
  type: AgentSkill
...
- group: agent
  title: ''
  type: MCPServer
  url: mcp/sarj-ai-developer-api-mcp.yml
- group: build
  title: ''
  type: ToolCrosswalk
  url: mcp/sarj-ai-developer-api-tool-crosswalk.yml
- group: build
  title: ''
  type: Packages
  url: packages/sarj-ai-developer-api-packages.yml
- group: build
  title: ''
  type: SDKs
  url: packages/sarj-ai-developer-api-packages.yml
- group: agent
  title: ''
  type: WellKnown
  url: well-known/sarj-ai-developer-api-well-known.yml
- group: auth
  title: ''
  type: Authentication
  url: authentication/sarj-ai-developer-api-authentication.yml
- group: auth
  title: ''
  type: OAuthScopes
  url: scopes/sarj-ai-developer-api-scopes.yml
- group: auth
  title: ''
  type: DomainSecurity
  url: security/sarj-ai-developer-api-domain-security.yml
- group: design
  title: ''
  type: Conformance
  url: conformance/sarj-ai-developer-api-conformance.yml
- group: design
  title: ''
  type: ErrorCatalog
  url: errors/sarj-ai-developer-api-problem-types.yml
- group: design
  title: ''
  type: Lifecycle
  url: lifecycle/sarj-ai-developer-api-lifecycle.yml
- group: design
  title: ''
  type: Conventions
  url: conventions/sarj-ai-developer-api-conventions.yml
- group: design
  title: ''
  type: Webhooks
  url: asyncapi/sarj-ai-developer-api-webhooks.yml
- group: design
  title: ''
  type: DataModel
  url: data-model/sarj-ai-developer-api-data-model.yml
- group: agent
  title: ''
  type: AgenticAccess
  url: agentic-access/sarj-ai-developer-api-agentic-access.yml
created: '2026-08-04'
description: Sarj.ai is a voice and chat AI agent platform built for Arabic, English and Urdu, focused on the Saudi and wider MENA market. The public developer surface is a REST API for outbound voice calls — place a call against a saved scenario, then retrieve its status, signed recording URL, transcript and asynchronous post-call outcome report. Alongside the call API, Sarj publishes two OpenAI-compatible speech APIs (Speech-to-Text with streaming, and Text-to-Speech with voice cloning), a hosted MCP server exposing createCall and getCall as native agent tools, an A2A agent card, a published Agent Skill, an llms.txt, webhook push notifications for call completion, and an official Python SDK.
image: https://www.sarj.ai/og-image.png
layout: provider
mcp_servers:
- description: ''
...
overview: 'Sarj AI Developer API publishes 27 APIs on the [APIs.io](https://apis.io/) network, including Admin API, Agent Profiles API, Analytics API, and 24 more. Tagged areas include Voice AI, Voice Agents, Conversational AI, Arabic AI, and Outbound Calls.
  ...
  Sarj AI Developer API''s developer surface includes documentation, API reference, getting-started guide, support, signup flow, authentication, and 21 more developer resources.'
random_paper: 12
scopes:
...
- kind: authentication
  ...
  slug: sarj-ai-developer-api-authentication
  summary_line: http/oauth2 · 3 schemes
- kind: domain-security
  name: Sarj Ai Developer Api Domain Security
  slug: sarj-ai-developer-api-domain-security
