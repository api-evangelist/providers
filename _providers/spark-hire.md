...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/spark-hire/refs/heads/main/agentic-access/spark-hire-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/spark-hire-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spark-hire/refs/heads/main/security/spark-hire-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/spark-hire-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spark-hire/refs/heads/main/authentication/spark-hire-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/spark-hire/refs/heads/main/plans/spark-hire-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/spark-hire-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/spark-hire/refs/heads/main/rate-limits/spark-hire-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/spark-hire-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/spark-hire/refs/heads/main/finops/spark-hire-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Spark Hire publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Account API, Interview Questions API, Interviews API, and 4 more. Tagged areas include Video Interviewing, Recruiting, Hiring, Human Resources, and Talent Assessment.
