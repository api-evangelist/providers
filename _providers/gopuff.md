...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/gopuff/refs/heads/main/capabilities/gopuff-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/gopuff-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/gopuff/refs/heads/main/agentic-access/gopuff-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/gopuff-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/gopuff/refs/heads/main/security/gopuff-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/gopuff-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/gopuff/refs/heads/main/authentication/gopuff-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/gopuff/refs/heads/main/json-ld/gopuff-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/gopuff-context.jsonld
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/gopuff/refs/heads/main/json-schema/gopuff-delivery-zone-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/gopuff-delivery-zone-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/gopuff/refs/heads/main/json-schema/gopuff-product-availability-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/gopuff-product-availability-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/gopuff/refs/heads/main/json-schema/gopuff-order-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/gopuff-order-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/gopuff/refs/heads/main/vocabulary/gopuff-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/gopuff-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/gopuff/refs/heads/main/rules/gopuff-fulfillment-rules.yml
  title: ''
  type: SpectralRuleset
  url: rules/gopuff-fulfillment-rules.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/gopuff/refs/heads/main/plans/gopuff-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/gopuff-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/gopuff/refs/heads/main/rate-limits/gopuff-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/gopuff-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/gopuff/refs/heads/main/finops/gopuff-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Gopuff publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Availability API, Orders API, Rates API, and 3 more. Tagged areas include Quick Commerce, Instant Delivery, Last Mile Delivery, Grocery, and Fulfillment.
