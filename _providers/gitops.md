...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/gitops/refs/heads/main/security/gitops-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'GitOps is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Automation, Continuous Deployment, Developer Tools, DevOps, and Infrastructure as Code.
