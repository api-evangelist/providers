...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/whiting-petroleum/refs/heads/main/security/whiting-petroleum-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/whiting-petroleum-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/whiting-petroleum-corporation
- group: company
  title: ''
  type: Website
  url: https://www.chordenergy.com
- group: company
  title: ''
  type: Website
  url: https://www.whiting.com
- group: other
  title: ''
  type: Wikipedia
  url: https://en.wikipedia.org/wiki/Chord_Energy
- group: company
  title: ''
  type: InvestorRelations
  url: https://ir.chordenergy.com
- group: other
  title: ''
  type: SECFilings
  url: https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001255474&type=10-K
- group: agent
  title: ''
  type: LlmsText
  url: https://whiting.com/llms.txt
created: '2026-03-24'
description: Whiting Petroleum was an independent oil and gas company engaged in the exploration, development, and production of crude oil, natural gas, and natural gas liquids primarily in the Williston Basin (Bakken Shale) in North Dakota and Montana. In July 2022, Whiting Petroleum merged with Oasis Petroleum to form Chord Energy Corporation, which trades on NASDAQ under the ticker symbol CHRD.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/whiting-petroleum.png
jsonld:
- class_count: 9
  name: Whiting Petroleum Context
  property_count: 7
  slug: whiting-petroleum-context
layout: provider
modified: '2026-05-03'
