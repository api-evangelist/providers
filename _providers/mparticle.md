...
nav: Providers
network: true
overview: 'mParticle publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Data Plan API, Data Plan Version API, Events API, and 4 more. Tagged areas include Customer Data Platform, CDP, Analytics, Identity Resolution, and Audiences.
