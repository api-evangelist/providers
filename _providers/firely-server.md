...
- baseURL: https://packages.simplifier.net/
  ...
  name: Firely Simplifier.net FHIR Package API
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/firely-server/refs/heads/main/agentic-access/firely-server-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/firely-server-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/firely-server/refs/heads/main/security/firely-server-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Firely publishes 3 APIs on the [APIs.io](https://apis.io/) network, including Catalog API, Simplifier.net FHIR Package API, and 1 more. Tagged areas include FHIR, HL7, Healthcare, Health IT, and Interoperability.
