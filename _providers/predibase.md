...
access_model:
  ...
  - plans
  - authentication
  - '{''url'': ''https://predibase.com'', ''status'': 301, ''note'': ''declared website redirects to https://www.rubrik.com/products/rubrik-agent-cloud — a different registrable domain (predibase.com -> rubrik.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: true
agent_readiness:
  band: agent-aware
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/predibase/refs/heads/main/agentic-access/predibase-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/predibase-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/predibase/refs/heads/main/security/predibase-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/predibase-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/predibase/refs/heads/main/authentication/predibase-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/predibase/refs/heads/main/plans/predibase-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/predibase-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/predibase/refs/heads/main/rate-limits/predibase-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/predibase-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/predibase/refs/heads/main/finops/predibase-finops.yml
  title: ''
  type: FinOps
