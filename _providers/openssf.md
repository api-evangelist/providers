...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/openssf/refs/heads/main/agentic-access/openssf-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/openssf-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/openssf/refs/heads/main/security/openssf-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'OpenSSF publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Projects API, Query API, Querybatch API, and 4 more. Tagged areas include Linux Foundation, Open Source, Security, Supply Chain, and Vulnerabilities.
