...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/coco/refs/heads/main/security/coco-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/coco-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/coco/refs/heads/main/llms/coco-llms.txt
  title: ''
  type: LLMsTxt
...
nav: Providers
network: true
overview: 'Coco Robotics is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Robotics, Delivery, Logistics, and Last Mile Delivery.
