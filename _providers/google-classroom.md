...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/google-classroom/refs/heads/main/capabilities/google-classroom-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-classroom/refs/heads/main/agentic-access/google-classroom-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-classroom-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-classroom/refs/heads/main/security/google-classroom-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-classroom-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-classroom/refs/heads/main/security/google-classroom-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-classroom/refs/heads/main/json-ld/json-ld.jsonld
  title: ''
  type: JSONLD
...
overview: 'Google Classroom publishes 3 APIs on the [APIs.io](https://apis.io/) network: Courses API, Invitations API, and User Profiles API. Tagged areas include Assignments, Classroom, Courses, Education, and Google.
  ...
  Google Classroom''s developer surface includes developer portal, getting-started guide, authentication, pricing, support, engineering blog, and 11 more developer resources.'
plans:
