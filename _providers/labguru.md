...
nav: Providers
network: true
overview: 'Labguru publishes 69 APIs on the [APIs.io](https://apis.io/) network, including Antibodies API, Attachments API, Authentication API, and 66 more. Tagged areas include Electronic Lab Notebook, ELN, LIMS, Laboratory Information Management, and Biotech.
