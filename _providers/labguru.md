...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/labguru/refs/heads/main/capabilities/labguru-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/labguru-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/labguru/refs/heads/main/agentic-access/labguru-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/labguru-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/labguru/refs/heads/main/security/labguru-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/labguru-domain-security.yml
- group: company
  title: ''
  type: Website
...
- group: docs
  title: ''
  type: Documentation
  url: https://help.labguru.com/en/collections/14641439-development-tools
- group: build
  title: ''
  type: GitHubOrg
  url: https://github.com/BioData
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/labguru/
- group: company
  title: ''
  type: Blog
  url: https://www.labguru.com/blog
- group: commercial
  title: ''
  type: Pricing
...
- group: other
  title: ''
  type: X
  url: https://twitter.com/labguru
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/labguru/refs/heads/main/plans/labguru-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/labguru-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/labguru/refs/heads/main/rate-limits/labguru-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/labguru-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/labguru/refs/heads/main/finops/labguru-finops.yml
  title: ''
  type: FinOps
  url: finops/labguru-finops.yml
created: '2026-06-13'
description: Labguru is an electronic laboratory notebook (ELN) and biotech data management platform that provides a unified REST and GraphQL API for managing experiments, protocols, milestones, inventory, equipment, and research project data. The platform serves biotech, pharma, CRO, food tech, and academic organizations with cloud-based lab operations, LIMS, workflow automation, and data analytics capabilities.
examples:
- key_count: 2
  name: Labguru Api Examples
  slug: labguru-api-examples
finops:
- name: Labguru Finops
  service_category: ''
  slug: labguru-finops
graphqls:
- description: Labguru is an electronic laboratory notebook (ELN) and biotech data management platform for life sciences organizations including biotech, pharma, CRO, food tech, and academic institutions. The platfo
  name: Labguru GraphQL API
  slug: labguru-graphql
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/labguru.png
json_schemas:
- name: AntibodyBaseRequest
  property_count: 2
  slug: AntibodyBaseRequest
- name: BacteriumBaseRequest
  property_count: 2
  slug: BacteriumBaseRequest
- name: BoxBaseRequest
  property_count: 2
  slug: BoxBaseRequest
- name: CellLineBaseRequest
  property_count: 2
  slug: CellLineBaseRequest
- name: CompanyBaseRequest
  property_count: 2
  slug: CompanyBaseRequest
- name: CompoundBaseRequest
  property_count: 3
  slug: CompoundBaseRequest
- name: DocumentBaseRequest
  property_count: 2
  slug: DocumentBaseRequest
- name: EquipmentBaseRequest
  property_count: 2
  slug: EquipmentBaseRequest
- name: EventBaseRequest
  property_count: 2
  slug: EventBaseRequest
- name: ExperimentBaseRequest
  property_count: 2
  slug: ExperimentBaseRequest
- name: FlagBaseRequest
  property_count: 2
  slug: FlagBaseRequest
- name: FlyBaseRequest
  property_count: 2
  slug: FlyBaseRequest
- name: FungusBaseRequest
  property_count: 2
  slug: FungusBaseRequest
- name: GeneBaseRequest
  property_count: 2
  slug: GeneBaseRequest
- name: GenericItemBaseRequest
  property_count: 2
  slug: GenericItemBaseRequest
- name: InternalServerError
  property_count: 2
  slug: InternalServerError
- name: InvalidRequestError
  property_count: 2
  slug: InvalidRequestError
- name: LinkBaseRequest
  property_count: 2
  slug: LinkBaseRequest
- name: LipidBaseRequest
  property_count: 2
  slug: LipidBaseRequest
- name: MaintenanceEventBaseRequest
  property_count: 2
  slug: MaintenanceEventBaseRequest
- name: MaintenanceTemplateBaseRequest
  property_count: 2
  slug: MaintenanceTemplateBaseRequest
- name: MaterialBaseRequest
  property_count: 2
  slug: MaterialBaseRequest
- name: NotFound
  property_count: 1
  slug: NotFound
- name: NoteBaseRequest
  property_count: 2
  slug: NoteBaseRequest
- name: OK
  property_count: 2
  slug: OK
- name: PaperBaseRequest
  property_count: 2
  slug: PaperBaseRequest
- name: PlantBaseRequest
  property_count: 2
  slug: PlantBaseRequest
- name: PlasmidBaseRequest
  property_count: 2
  slug: PlasmidBaseRequest
- name: PrimerBaseRequest
  property_count: 2
  slug: PrimerBaseRequest
- name: ProjectBaseRequest
  property_count: 2
  slug: ProjectBaseRequest
- name: ProteinBaseRequest
  property_count: 2
  slug: ProteinBaseRequest
- name: ReportBaseRequest
  property_count: 2
  slug: ReportBaseRequest
- name: RodentCageBaseRequest
  property_count: 2
  slug: RodentCageBaseRequest
- name: RodentSpecimenBaseRequest
  property_count: 2
  slug: RodentSpecimenBaseRequest
- name: RodentStrainBaseRequest
  property_count: 2
  slug: RodentStrainBaseRequest
- name: SOPBaseRequest
  property_count: 2
  slug: SOPBaseRequest
- name: SeedBaseRequest
  property_count: 2
  slug: SeedBaseRequest
- name: SequenceBaseRequest
  property_count: 2
  slug: SequenceBaseRequest
- name: StockBaseRequest
  property_count: 2
  slug: StockBaseRequest
- name: StorageBaseRequest
  property_count: 2
  slug: StorageBaseRequest
- name: TaskBaseRequest
  property_count: 2
  slug: TaskBaseRequest
- name: TissueBaseRequest
  property_count: 2
  slug: TissueBaseRequest
- name: Unauthorized
  property_count: 1
  slug: Unauthorized
...
- name: VirusBaseRequest
  property_count: 2
  slug: VirusBaseRequest
- name: WormBaseRequest
  property_count: 2
  slug: WormBaseRequest
- name: YeastBaseRequest
  property_count: 2
  slug: YeastBaseRequest
- name: acceptRequest
  property_count: 2
  slug: acceptRequest
- name: addAnExperimentSectionToReport
  property_count: 2
  slug: addAnExperimentSectionToReport
- name: addCoverToReport
  property_count: 2
  slug: addCoverToReport
...
- name: Add item
  property_count: 2
  slug: addItem
- name: Add plate element
  property_count: 2
  slug: addPlateElement
- name: addVisualization
  property_count: 2
  slug: addVisualization
- name: approvedRequest
  property_count: 2
  slug: approvedRequest
- name: assignItemToDataset
  property_count: 2
  slug: assignItemToDataset
- name: createAntibody
  property_count: 0
  slug: createAntibody
- name: createAttachment
  property_count: 5
  slug: createAttachment
- name: createBacterium
  property_count: 0
  slug: createBacterium
- name: createBox
  property_count: 0
  slug: createBox
- name: createCellLine
...
- name: createCompound
  property_count: 0
  slug: createCompound
- name: Create consume sample pooling event
  property_count: 2
  slug: createConsumeSamplePoolingEvent
- name: Create custom sample pooling event
  property_count: 2
  slug: createCustomSamplePoolingEvent
- name: createDataset
  property_count: 2
  slug: createDataset
- name: createDocument
...
- name: createEquipment
  property_count: 0
  slug: createEquipment
- name: createEvent
  property_count: 0
  slug: createEvent
- name: Create fixed sample pooling event
  property_count: 2
  slug: createFixedSamplePoolingEvent
- name: createFlag
  property_count: 0
  slug: createFlag
- name: createFly
...
- name: createMaintenance
  property_count: 2
  slug: createMaintenance
- name: createMaintenanceEvent
  property_count: 0
  slug: createMaintenanceEvent
- name: createMaintenanceTemplate
  property_count: 0
  slug: createMaintenanceTemplate
- name: createMaintenanceType
  property_count: 2
  slug: createMaintenanceType
- name: createMaterial
  property_count: 0
  slug: createMaterial
- name: createNote
...
- name: createRequestTemplate
  property_count: 2
  slug: createRequestTemplate
- name: createRodentCage
  property_count: 0
  slug: createRodentCage
- name: createRodentSpecimen
  property_count: 0
  slug: createRodentSpecimen
- name: createRodentStrain
  property_count: 0
  slug: createRodentStrain
- name: createSOP
  property_count: 0
  slug: createSOP
- name: createSection
...
- name: indexFiltering
  property_count: 2
  slug: indexFiltering
- name: Labguru API Schemas
  property_count: 0
  slug: labguru-schemas
- name: moveSection
  property_count: 4
  slug: moveSection
- name: selectPerformer
  property_count: 2
  slug: selectPerformer
- name: startRequest
  property_count: 2
  slug: startRequest
- name: submitRequest
...
- name: updateAttachment
  property_count: 2
  slug: updateAttachment
- name: updateBacterium
  property_count: 0
  slug: updateBacterium
- name: updateBox
  property_count: 0
  slug: updateBox
- name: updateCellLine
...
- name: updateEquipment
  property_count: 0
  slug: updateEquipment
- name: updateEvent
  property_count: 0
  slug: updateEvent
- name: updateExperiment
  property_count: 0
  slug: updateExperiment
- name: updateFlag
  property_count: 0
  slug: updateFlag
- name: updateFly
...
- name: updateFolder
  property_count: 2
  slug: updateFolder
- name: Update form element
  property_count: 2
  slug: updateFormElement
- name: updateFungus
  property_count: 0
  slug: updateFungus
- name: updateGene
...
- name: updateMaintenance
  property_count: 2
  slug: updateMaintenance
- name: updateMaintenanceEvent
  property_count: 0
  slug: updateMaintenanceEvent
- name: updateMaintenanceTemplate
  property_count: 0
  slug: updateMaintenanceTemplate
- name: updateMaintenanceType
  property_count: 2
  slug: updateMaintenanceType
- name: updateMaterial
  property_count: 0
  slug: updateMaterial
- name: updateNote
...
- name: updateRequestTemplate
  property_count: 2
  slug: updateRequestTemplate
- name: updateRodentCage
  property_count: 0
  slug: updateRodentCage
- name: updateRodentSpecimen
  property_count: 0
  slug: updateRodentSpecimen
- name: updateRodentStrain
  property_count: 0
  slug: updateRodentStrain
- name: updateSOP
  property_count: 0
  slug: updateSOP
- name: updateSection
...
- name: updateStock
  property_count: 0
  slug: updateStock
- name: updateStockAmountInSampleElement
  property_count: 7
  slug: updateStockAmountInSampleElement
- name: updateStorage
  property_count: 0
  slug: updateStorage
- name: updateTask
  property_count: 0
  slug: updateTask
- name: Update text element
  property_count: 2
  slug: updateTextElement
- name: updateTissue
  property_count: 0
  slug: updateTissue
- name: updateVector
...
jsonld:
- class_count: 0
  name: Labguru Api Context
  property_count: 0
  slug: labguru-api
- class_count: 9
  name: Labguru Context
  property_count: 19
  slug: labguru-context
layout: provider
modified: '2026-06-13'
name: Labguru
nav: Providers
network: true
overview: 'Labguru publishes 69 APIs on the [APIs.io](https://apis.io/) network, including Antibodies API, Attachments API, Authentication API, and 66 more. Tagged areas include Electronic Lab Notebook, ELN, LIMS, Laboratory Information Management, and Biotechnology.
...
- limit_count: 3
  ...
  slug: labguru-rate-limits
rules:
- effective_rule_count: 6
  extends: []
  name: Labguru API Rules
  rule_count: 6
  severity_counts:
    error: 0
    hint: 0
