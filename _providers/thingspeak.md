...
nav: Providers
network: true
overview: 'ThingSpeak publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Channels API, Update API, MQTT API, and 2 more. Tagged areas include IoT, Analytics, Time Series, MQTT, and MATLAB.
