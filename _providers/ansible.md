...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ansible/refs/heads/main/agentic-access/ansible-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/ansible-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ansible/refs/heads/main/security/ansible-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/ansible-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ansible/refs/heads/main/security/ansible-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/ansible-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ansible/refs/heads/main/authentication/ansible-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Ansible publishes 16 APIs on the [APIs.io](https://apis.io/) network, including Auth API, Credentials API, Hosts API, and 13 more. Tagged areas include Ansible, Automation, Configuration Management, DevOps, and Infrastructure as Code.
