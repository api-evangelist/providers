...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/digital-ocean/refs/heads/main/capabilities/digital-ocean-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/digital-ocean/refs/heads/main/security/digital-ocean-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/digital-ocean-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/digital-ocean/refs/heads/main/security/digital-ocean-domain-security.yml
  title: ''
  type: DomainSecurity
...
overview: 'Digital Ocean publishes 37 APIs on the [APIs.io](https://apis.io/) network, including 1-Click Applications API, Account API, Actions API, and 34 more. Tagged areas include Cloud, Compute, Servers, and Infrastructure.
  ...
  Digital Ocean''s developer surface includes documentation, support, engineering blog, pricing, GitHub presence, signup flow, and 18 more developer resources.'
plans:
