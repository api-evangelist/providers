...
- group: agent
  title: ''
  type: AgenticAccess
  url: agentic-access/the-movie-database-agentic-access.yml
- group: auth
  title: ''
  type: DomainSecurity
  url: security/the-movie-database-domain-security.yml
- group: auth
  title: ''
  type: Authentication
  url: authentication/the-movie-database-authentication.yml
- group: company
  title: ''
  type: Website
...
examples:
- key_count: 2
  name: The Movie Database Getmoviedetails Example
  slug: the-movie-database-getMovieDetails-example
- key_count: 2
  name: The Movie Database Gettrending Example
  slug: the-movie-database-getTrending-example
- key_count: 2
  name: The Movie Database Searchmovie Example
  slug: the-movie-database-searchMovie-example
finops:
- name: The Movie Database Finops
  service_category: API
  slug: the-movie-database-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/the-movie-database.png
json_schemas:
- name: TMDB Movie
  property_count: 24
  slug: the-movie-database-movie
- name: TMDB TV Series
  property_count: 25
  slug: the-movie-database-tv-series
json_structures:
- name: The Movie Database Search Response Structure
  property_count: 0
  slug: the-movie-database-search-response-structure
jsonld:
- class_count: 0
...
nav: Providers
network: true
overview: 'The Movie Database publishes 21 APIs on the [APIs.io](https://apis.io/) network, including Account API, Authentication API, Certification API, and 18 more. Tagged areas include Entertainment, Movies, and Television.
