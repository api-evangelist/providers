...
- group: commercial
  title: ''
  type: Pricing
  url: https://universe.development.scalapay.com/pricing-table-shortcode/
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/scalapay/refs/heads/main/plans/scalapay-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/scalapay-plans-pricing.yml
- group: other
...
nav: Providers
network: true
overview: 'Scalapay publishes 3 APIs on the [APIs.io](https://apis.io/) network: Instore API, Orders API, and Reporting API. Tagged areas include Payments, Buy Now Pay Later, Instalments, E-Commerce, and Checkout.


  The Scalapay catalog on APIs.io includes 1 event-driven AsyncAPI specification.


  Scalapay''s developer surface includes pricing, documentation, API reference, getting-started guide, support, signup flow, authentication, and 29 more developer resources.'
plans:
- name: Scalapay Plans Pricing
  plan_count: 3
  slug: scalapay-plans-pricing
- name: Scalapay Price Estimates
  plan_count: 0
  slug: scalapay-price-estimates
random_paper: 10
score:
  band: strong
  composite: 57.2
