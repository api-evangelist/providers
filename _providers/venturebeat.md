...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/venturebeat/refs/heads/main/security/venturebeat-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/venturebeat-domain-security.yml
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/VentureBeat
- group: company
  title: ''
  type: Website
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/venturebeat.png
json_schemas:
- name: VentureBeat Article
  property_count: 8
  slug: venturebeat-article
json_structures:
- name: Venturebeat Article Structure
  property_count: 0
  slug: venturebeat-article-structure
jsonld:
- class_count: 25
  name: Venturebeat Context
  property_count: 4
  slug: venturebeat-context
layout: provider
modified: '2026-05-03'
name: VentureBeat
nav: Providers
network: true
overview: 'VentureBeat is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Artificial Intelligence, Enterprise, Media, Technology News, and Content.
...
- kind: domain-security
  ...
  slug: venturebeat-domain-security
