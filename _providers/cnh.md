...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/cnh/refs/heads/main/capabilities/cnh-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/cnh-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cnh/refs/heads/main/agentic-access/cnh-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/cnh-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cnh/refs/heads/main/security/cnh-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/cnh-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cnh/refs/heads/main/authentication/cnh-authentication.yml
  title: ''
  type: Authentication
  url: authentication/cnh-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cnh/refs/heads/main/scopes/cnh-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/cnh/refs/heads/main/openapi/_original/cnh-fieldops-openapi.yml
  title: ''
  type: OpenAPI
  url: openapi/_original/cnh-fieldops-openapi.yml
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/cnh/refs/heads/main/json-schema/cnh-equipment-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/cnh-equipment-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/cnh/refs/heads/main/json-schema/cnh-telemetry-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/cnh-telemetry-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cnh/refs/heads/main/json-ld/cnh-context.jsonld
  title: ''
  type: JSONLDContext
  url: json-ld/cnh-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cnh/refs/heads/main/rules/cnh-rules.yml
  title: ''
...
nav: Providers
network: true
overview: 'CNH publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Equipment API, Farm Setup API, Operations API, and 5 more. Tagged areas include Agriculture, Construction, Telematics, Equipment, and FieldOps.
