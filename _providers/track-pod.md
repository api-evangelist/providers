...
- baseURL: https://api.track-pod.com
  baseurl_source: declared
  description: The Reject Reason API from Track-POD — 1 operation(s) for reject reason.
  name: Track-POD Reject Reason API
...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/track-pod/refs/heads/main/capabilities/track-pod-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/track-pod/refs/heads/main/agentic-access/track-pod-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/track-pod-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/track-pod/refs/heads/main/security/track-pod-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/track-pod-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/track-pod/refs/heads/main/authentication/track-pod-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/track-pod/refs/heads/main/plans/track-pod-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/track-pod-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/track-pod/refs/heads/main/rate-limits/track-pod-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/track-pod-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/track-pod/refs/heads/main/finops/track-pod-finops.yml
  title: ''
  type: FinOps
