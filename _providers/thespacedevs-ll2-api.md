...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/thespacedevs-ll2-api/refs/heads/main/security/thespacedevs-ll2-api-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/thespacedevs-ll2-api-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/the-space-devs
- group: company
  title: ''
  type: Website
...
description: TheSpaceDevs LL2 API is the Launch Library 2, a comprehensive space launch and events database delivering data on rocket launches, space events, astronauts, spacecraft, space stations, and crewed spaceflight missions worldwide. Provides real-time updates on launch schedules, mission timelines, and spacecraft operations.
examples:
- key_count: 2
  name: Thespacedevs List Astronauts Example
  slug: thespacedevs-list-astronauts-example
- key_count: 2
  name: Thespacedevs List Upcoming Launches Example
  slug: thespacedevs-list-upcoming-launches-example
finops:
- name: Thespacedevs Ll2 Api Finops
  service_category: API
  slug: thespacedevs-ll2-api-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/thespacedevs-ll2-api.png
json_schemas:
- name: Space Launch Record
  property_count: 11
  slug: thespacedevs-launch
json_structures:
- name: Thespacedevs Structure
  property_count: 0
  slug: thespacedevs-structure
jsonld:
- class_count: 0
...
overview: 'TheSpaceDevs LL2 API publishes 36 APIs on the [APIs.io](https://apis.io/) network, including Agencies API, Agency API, Astronaut API, and 33 more. Tagged areas include Space, Satellite, Launches, Rockets, and Astronauts.
  ...
  TheSpaceDevs LL2 API''s developer surface includes documentation, support, and 5 more developer resources.'
plans:
