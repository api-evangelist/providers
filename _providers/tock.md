...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tock/refs/heads/main/security/tock-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/tock-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tock/refs/heads/main/authentication/tock-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/tock/refs/heads/main/plans/tock-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/tock-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/tock/refs/heads/main/rate-limits/tock-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/tock-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/tock/refs/heads/main/finops/tock-finops.yml
  title: ''
  type: FinOps
  url: finops/tock-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tock/refs/heads/main/vocabulary/tock-vocabulary.yaml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'Tock publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Reservation API, Guest API, and 4 more. Tagged areas include Hospitality, Reservations, Restaurant, Wineries, and Ticketed Events.
