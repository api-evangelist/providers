...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/epo/refs/heads/main/security/epo-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'EPO publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Patents and Public APIs.
