...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/paraswap/refs/heads/main/agentic-access/paraswap-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/paraswap-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/paraswap/refs/heads/main/security/paraswap-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'ParaSwap publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Prices API, Tokens API, Transactions API, and 3 more. Tagged areas include DeFi, DEX Aggregator, Token Swaps, Blockchain, and EVM.
