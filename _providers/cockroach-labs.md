...
- baseURL: https://cockroachlabs.cloud
  ...
  name: Cockroach Labs API Keys API
...
- baseURL: https://cockroachlabs.cloud
  ...
  name: Cockroach Labs Audit Logs API
...
- baseURL: https://cockroachlabs.cloud
  ...
  name: Cockroach Labs Backup Restore API
...
- baseURL: https://cockroachlabs.cloud
  ...
  name: Cockroach Labs Maintenance Windows API
...
- baseURL: https://cockroachlabs.cloud
  ...
  name: Cockroach Labs Private Endpoints API
...
- baseURL: https://cockroachlabs.cloud
  ...
  name: Cockroach Labs Role Management API
...
- baseURL: https://cockroachlabs.cloud
  ...
  name: Cockroach Labs Service Accounts API
...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/cockroach-labs/refs/heads/main/capabilities/cockroach-labs-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/cockroach-labs-capability-edges.yml
- group: build
  title: ''
  type: PostmanWorkspace
  url: https://www.postman.com/kinlaneapi/cockroach-labs/overview
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cockroach-labs/refs/heads/main/agentic-access/cockroach-labs-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/cockroach-labs-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cockroach-labs/refs/heads/main/security/cockroach-labs-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/cockroach-labs-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cockroach-labs/refs/heads/main/security/cockroach-labs-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/cockroach-labs-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cockroach-labs/refs/heads/main/security/cockroach-labs-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/cockroach-labs-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cockroach-labs/refs/heads/main/authentication/cockroach-labs-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cockroach-labs/refs/heads/main/json-ld/cockroach-labs-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/cockroach-labs-context.jsonld
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/cockroach-labs/refs/heads/main/json-schema/cockroach-labs-cluster-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/cockroach-labs-cluster-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cockroach-labs/refs/heads/main/rules/cockroach-labs-rules.yml
  title: ''
  type: Spectral
...
nav: Providers
network: true
overview: 'Cockroach Labs publishes 26 APIs on the [APIs.io](https://apis.io/) network, including Auth API, Billing API, Clusters API, and 23 more. Tagged areas include Cluster Management, Cloud, Database, Distributed SQL, and Infrastructure.


  The Cockroach Labs catalog on APIs.io includes 1 JSON-LD context and 2 Spectral governance rulesets.


  Cockroach Labs'' developer surface includes authentication, documentation, pricing, engineering blog, developer console, support, GitHub presence, and 19 more developer resources.'
plans:
