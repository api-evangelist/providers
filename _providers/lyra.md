...
nav: Providers
network: true
overview: 'Lyra publishes 3 APIs on the [APIs.io](https://apis.io/) network, including Public REST API, and 2 more. Tagged areas include Options, AMM, DeFi, Derivatives, and Implied Volatility.
