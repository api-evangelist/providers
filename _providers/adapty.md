...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/adapty/refs/heads/main/agentic-access/adapty-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/adapty-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/adapty/refs/heads/main/security/adapty-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/adapty-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/adapty/refs/heads/main/authentication/adapty-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/adapty/refs/heads/main/plans/adapty-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/adapty-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/adapty/refs/heads/main/rate-limits/adapty-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/adapty-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/adapty/refs/heads/main/finops/adapty-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Adapty publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Access Levels API, Integrations API, Paywalls API, and 3 more. Tagged areas include Mobile, Subscription, In-App Purchases, Paywalls, and Analytics.
