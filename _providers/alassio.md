...
nav: Providers
network: true
overview: Alassio is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Financial-Services, Payroll, Human Resources, and Payroll Software.
random_paper: 0
score:
  band: minimal
  composite: 5.0
