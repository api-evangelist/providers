...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/trustpilot/refs/heads/main/agentic-access/trustpilot-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/trustpilot-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/trustpilot/refs/heads/main/security/trustpilot-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/trustpilot-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/trustpilot/refs/heads/main/security/trustpilot-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/trustpilot-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/trustpilot/refs/heads/main/authentication/trustpilot-authentication.yml
  title: ''
  type: Authentication
  url: authentication/trustpilot-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/trustpilot/refs/heads/main/scopes/trustpilot-scopes.yml
  title: ''
  type: OAuthScopes
...
nav: Providers
network: true
overview: 'Trustpilot publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Business Units API, Conversations API, Images API, and 6 more. Tagged areas include Consumer Reviews, Reviews, Trust, Ratings, and Business Profiles.
