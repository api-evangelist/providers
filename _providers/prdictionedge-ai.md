...
nav: Providers
network: true
overview: 'AUX by PrdictionEdge publishes 2 APIs on the [APIs.io](https://apis.io/) network, including AUX Evidence and Certification API, and 1 more. Tagged areas include Company, Counterparty Verification, Sanctions Screening, Legal Entity Identifier, and KYB.
