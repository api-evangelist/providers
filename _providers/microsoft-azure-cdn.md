...
nav: Providers
network: true
overview: 'Microsoft Azure Cdn publishes 2 APIs on the [APIs.io](https://apis.io/) network: microsoft-azure-cdn Operations API and microsoft-azure-cdn Profiles API.


  Microsoft Azure Cdn''s developer surface includes authentication, developer portal, pricing, support, engineering blog, and 7 more developer resources.'
plans:
