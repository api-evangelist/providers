...
layout: provider
mcp_servers:
- description: Official hosted, remote MCP server that gives any MCP-compatible client (Claude, Cursor, etc.) natural-language discovery and pay-per-call execution across Orthogonal's catalog of 40+ third-party APIs
  name: Orthogonal
  slug: orthogonal
modified: '2026-08-14'
name: Orthogonal
