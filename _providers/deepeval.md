...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/deepeval/refs/heads/main/security/deepeval-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'DeepEval is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include LLM Evaluation, LLM Testing, Evaluation Framework, Evaluation Metrics, and LLM Observability.
