...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://hex.co'', ''status'': 301, ''note'': ''declared website redirects to https://www.parameter.ai/?from=hex — a different registrable domain (hex.co -> parameter.ai), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hex-security/refs/heads/main/security/hex-security-domain-security.yml
  title: ''
  type: DomainSecurity
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/hex-security/refs/heads/main/screenshots/hex-security-2026-07-25T221129.png
security:
