...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/oncolens/refs/heads/main/security/oncolens-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/oncolens-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/oncolens/refs/heads/main/security/oncolens-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/oncolens/refs/heads/main/conformance/oncolens-conformance.yml
  title: ''
  type: Compliance
...
- group: design
  ...
  url: conformance/oncolens-conformance.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/oncolens/refs/heads/main/llms/oncolens-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/oncolens-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/oncolens/refs/heads/main/well-known/oncolens-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/oncolens-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/oncolens/refs/heads/main/authentication/oncolens-authentication.yml
  title: ''
  type: Authentication
  url: authentication/oncolens-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/oncolens/refs/heads/main/scopes/oncolens-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/oncolens-scopes.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/oncolens/refs/heads/main/well-known/oncolens-login-openid-configuration.json
  title: ''
  type: OpenIDConnect
  url: well-known/oncolens-login-openid-configuration.json
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/oncolens/refs/heads/main/plans/oncolens-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/oncolens-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/oncolens/refs/heads/main/rate-limits/oncolens-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/oncolens-rate-limits.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/oncolens/refs/heads/main/lifecycle/oncolens-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/oncolens-lifecycle.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/oncolens/refs/heads/main/packages/oncolens-packages.yml
  title: ''
  type: Packages
  url: packages/oncolens-packages.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/oncolens/refs/heads/main/conventions/oncolens-conventions.yml
  title: ''
  type: Conventions
