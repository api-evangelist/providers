...
- group: other
  title: ''
  type: ParentCompany
  url: https://corporate.exxonmobil.com/locations/united-states/denbury
- group: other
  title: ''
  type: ExxonMobilLowCarbon
  url: https://corporate.exxonmobil.com/what-we-do/delivering-industrial-solutions/lowcarbon-solutions
- group: other
  title: ''
  type: SECFilings
  url: https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001127355
- group: other
  title: ''
  type: Notes
  url: https://en.wikipedia.org/wiki/Denbury_Resources
created: '2024-12-03'
description: Denbury Resources (now Denbury Inc.) was an independent oil and natural gas company focused on enhanced oil recovery (EOR) using carbon dioxide injection in mature oil fields. Denbury was acquired by ExxonMobil in November 2023 and operates as a subsidiary inside ExxonMobil's Low Carbon Solutions business. Denbury does not publish public APIs; this profile is preserved as a corporate-history index.
...
nav: Providers
network: true
overview: Denbury Resources is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Acquired, Carbon Capture, CO2 EOR, Energy, and Enhanced Oil Recovery.
press:
- date: '2026-05-25'
