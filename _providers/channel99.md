...
nav: Providers
network: true
overview: 'Channel99 is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Marketing, Analytics, Attribution, and B2B.
