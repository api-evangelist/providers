...
- description: The Scalar CLI is a command-line interface for managing OpenAPI files, generating documentation, running mock servers, validating specs, and publishing to the Scalar Registry. Enables CI/CD integratio
  name: Scalar CLI
  slug: scalar-cli
- description: The access-groups API from Scalar — 5 operation(s) for access-groups.
  name: Scalar access-groups API
  slug: scalar-access-groups-api
- description: The analytics API from Scalar — 4 operation(s) for analytics.
  name: Scalar analytics API
  slug: scalar-analytics-api
- description: The api-docs API from Scalar — 13 operation(s) for api-docs.
  name: Scalar api-docs API
  slug: scalar-api-docs-api
- description: The auth API from Scalar — 27 operation(s) for auth.
  name: Scalar auth API
  slug: scalar-auth-api
- description: The docs API from Scalar — 6 operation(s) for docs.
  name: Scalar docs API
  slug: scalar-docs-api
- description: The Docs Projects API from Scalar — 9 operation(s) for docs projects.
  name: Scalar Docs Projects API
  slug: scalar-docs-projects-api
- description: The Forgejo API from Scalar — 1 operation(s) for forgejo.
  name: Scalar Forgejo API
  slug: scalar-forgejo-api
- description: The github API from Scalar — 16 operation(s) for github.
  name: Scalar github API
  slug: scalar-github-api
- description: The Internal API from Scalar — 1 operation(s) for internal.
  name: Scalar Internal API
  slug: scalar-internal-api
- description: The login-portals API from Scalar — 3 operation(s) for login-portals.
  name: Scalar login-portals API
  slug: scalar-login-portals-api
- description: The payment API from Scalar — 6 operation(s) for payment.
  name: Scalar payment API
  slug: scalar-payment-api
- description: The publish API from Scalar — 11 operation(s) for publish.
  name: Scalar publish API
  slug: scalar-publish-api
- description: The pubsub API from Scalar — 7 operation(s) for pubsub.
  name: Scalar pubsub API
  slug: scalar-pubsub-api
- description: The rules API from Scalar — 6 operation(s) for rules.
  name: Scalar rules API
...
- description: The signup API from Scalar — 1 operation(s) for signup.
  name: Scalar signup API
  slug: scalar-signup-api
- description: The team API from Scalar — 36 operation(s) for team.
  name: Scalar team API
  slug: scalar-team-api
- description: The themes API from Scalar — 4 operation(s) for themes.
  name: Scalar themes API
  slug: scalar-themes-api
- description: The utility API from Scalar — 3 operation(s) for utility.
  name: Scalar utility API
  slug: scalar-utility-api
- description: The vcs API from Scalar — 6 operation(s) for vcs.
  name: Scalar vcs API
  slug: scalar-vcs-api
- description: The waitlist API from Scalar — 1 operation(s) for waitlist.
  name: Scalar waitlist API
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/scalar/refs/heads/main/agentic-access/scalar-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/scalar-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/scalar/refs/heads/main/security/scalar-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/scalar-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/scalar/refs/heads/main/security/scalar-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/scalar-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/scalar/refs/heads/main/security/scalar-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/scalar-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/scalar/refs/heads/main/authentication/scalar-authentication.yml
  title: ''
  type: Authentication
  url: authentication/scalar-authentication.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/scalar
- group: company
  title: ''
  type: Website
...
examples:
- key_count: 1
  name: Scalar Api Reference Config Example
  slug: scalar-api-reference-config-example
- key_count: 1
  name: Scalar Registry Publish Example
  slug: scalar-registry-publish-example
- key_count: 1
  name: Scalar Sdk Generation Example
  slug: scalar-sdk-generation-example
finops:
- name: Scalar Finops
  service_category: API
  slug: scalar-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/scalar.png
json_schemas:
- name: Scalar OpenAPI Document Reference
  property_count: 12
  slug: scalar-openapi-document
json_structures:
- name: Scalar Openapi Document Structure
  property_count: 0
  slug: scalar-openapi-document-structure
jsonld:
- class_count: 34
  name: Scalar Context
  property_count: 1
...
- kind: vulnerability-disclosure
  name: Scalar Vulnerability Disclosure
  slug: scalar-vulnerability-disclosure
