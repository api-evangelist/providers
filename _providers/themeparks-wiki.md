...
- collection_type: open
  name: ThemeParks.wiki Destinations API
  slug: open-themeparks-wiki-destinations-api
- collection_type: open
  name: ThemeParks.wiki Destinations Entities API
  slug: open-themeparks-wiki-entities-api
- collection_type: open
  name: ThemeParks.wiki API
  slug: open-themeparks-wiki
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/themeparks-wiki/refs/heads/main/agentic-access/themeparks-wiki-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/themeparks-wiki-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/themeparks-wiki/refs/heads/main/security/themeparks-wiki-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/themeparks-wiki/refs/heads/main/rules/themeparks-wiki-spectral-rules.yml
  title: ThemeParks.wiki Spectral Rules
  type: SpectralRules
  url: rules/themeparks-wiki-spectral-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/themeparks-wiki/refs/heads/main/vocabulary/themeparks-wiki-vocabulary.yml
