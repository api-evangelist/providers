...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/nilo-health/refs/heads/main/security/nilo-health-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/nilo-health/refs/heads/main/security/nilo-health-trust-center.yml
  title: ''
  type: TrustCenter
...
nav: Providers
network: true
overview: 'Nilo Health is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Mental Health, Health, Human Resources, and Employee Benefits.
