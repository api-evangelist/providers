...
nav: Providers
network: true
overview: 'CanFly publishes 3 APIs on the [APIs.io](https://apis.io/) network, including CanFly.ai Agent Skill Marketplace API, and 2 more. Tagged areas include Agents, AI Agents, Agentic Commerce, Marketplace, and A2A.
