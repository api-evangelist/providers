...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/openmetadata/refs/heads/main/capabilities/openmetadata-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/openmetadata-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/openmetadata/refs/heads/main/agentic-access/openmetadata-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/openmetadata-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/openmetadata/refs/heads/main/security/openmetadata-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/openmetadata-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/openmetadata/refs/heads/main/authentication/openmetadata-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/openmetadata/refs/heads/main/plans/openmetadata-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/openmetadata-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/openmetadata/refs/heads/main/rate-limits/openmetadata-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/openmetadata-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/openmetadata/refs/heads/main/finops/openmetadata-finops.yml
  title: ''
  type: FinOps
...
overview: 'OpenMetadata publishes 89 APIs on the [APIs.io](https://apis.io/) network, including Agent Executions API, AI Applications API, AI Governance Policies API, and 86 more. Tagged areas include Data Catalog, Metadata, Data Governance, Data Lineage, and Data Quality.
  ...
  OpenMetadata''s developer surface includes authentication, documentation, GitHub presence, engineering blog, pricing, YouTube channel, release notes, and 13 more developer resources.'
plans:
