...
- description: Cloud-based API for Maya through Autodesk Platform Services (APS), providing web service integration, OAuth authentication, and cloud workflow capabilities for Maya development.
  ...
  slug: autodesk-platform-services-maya-api
artifact_total: 12
common:
- group: start
  title: ''
...
nav: Providers
network: true
overview: Maya publishes 9 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include 3D, Animation, Autodesk, CGI, and Modeling.
plans:
