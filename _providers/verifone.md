...
- group: company
  title: ''
  type: Website
  url: https://verifone.com
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/verifone/refs/heads/main/agentic-access/verifone-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/verifone-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/verifone/refs/heads/main/security/verifone-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/verifone-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/verifone/refs/heads/main/authentication/verifone-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Verifone publishes 27 APIs on the [APIs.io](https://apis.io/) network, including 3DS Authentication API, Batch API, Billing Agreement API, and 24 more. Tagged areas include Payments, Point-of-Sale, Terminal Management, E-Commerce, and Fintech.


  The Verifone catalog on APIs.io includes 1 JSON-LD context and 1 Spectral governance ruleset.


  Verifone''s developer surface includes authentication, developer portal, documentation, API reference, getting-started guide, sandbox, engineering blog, and 7 more developer resources.'
plans:
- name: Plans
  plan_count: 4
  slug: plans
