...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/tuya/refs/heads/main/agentic-access/tuya-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/tuya-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tuya/refs/heads/main/security/tuya-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/tuya-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tuya/refs/heads/main/authentication/tuya-authentication.yml
  title: ''
  type: Authentication
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/tuya/refs/heads/main/openapi/_original/tuya-device-management-openapi.yml
  title: ''
  type: OpenAPI
  url: openapi/_original/tuya-device-management-openapi.yml
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/tuya/refs/heads/main/json-schema/tuya-device-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/tuya-device-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/tuya/refs/heads/main/json-schema/tuya-command-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/tuya-command-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tuya/refs/heads/main/json-ld/tuya-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/tuya-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tuya/refs/heads/main/rules/tuya-rules.yml
  title: ''
  type: SpectralRules
  url: rules/tuya-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tuya/refs/heads/main/vocabulary/tuya-vocabulary.yml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'Tuya publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Device Control API, Device Logs API, Device Users API, and 6 more. Tagged areas include IoT, Smart Home, Devices, Cloud Platform, and Automation.
