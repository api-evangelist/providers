...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/dev-to/refs/heads/main/agentic-access/dev-to-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/dev-to-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/dev-to/refs/heads/main/security/dev-to-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/dev-to-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/dev-to/refs/heads/main/authentication/dev-to-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/dev-to/refs/heads/main/json-ld/dev-to-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/dev-to-context.jsonld
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/dev-to/refs/heads/main/json-schema/dev-to-article-schema.json
  title: ''
  type: JSONSchema
