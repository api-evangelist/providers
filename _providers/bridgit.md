...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/bridgit/refs/heads/main/capabilities/bridgit-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/bridgit-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/bridgit/refs/heads/main/agentic-access/bridgit-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/bridgit-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bridgit/refs/heads/main/security/bridgit-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/bridgit-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bridgit/refs/heads/main/security/bridgit-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/bridgit-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bridgit/refs/heads/main/authentication/bridgit-authentication.yml
  title: ''
  type: Authentication
  url: authentication/bridgit-authentication.yml
- group: company
  title: ''
  type: Website
  url: https://gobridgit.com
- group: other
  title: ''
  type: Product
  url: https://gobridgit.com/bridgit-bench/
- group: other
  title: ''
  type: GeneralContractors
  url: https://gobridgit.com/general-contractors/
- group: other
  title: ''
  type: Subcontractors
  url: https://gobridgit.com/subcontractors/
- group: docs
  title: ''
  type: Documentation
  url: https://gobridgit.com/bridgit-bench-api-documentation/
- group: docs
  title: ''
  type: Swagger
...
- group: operate
  title: ''
  type: Support
  url: https://help.gobridgit.com
- group: company
  title: ''
  type: Blog
  url: https://gobridgit.com/blog/
- group: other
  title: ''
  type: Customers
  url: https://gobridgit.com/customers/
- group: company
  title: ''
  type: About
  url: https://gobridgit.com/about/
- group: company
  title: ''
  type: Careers
  url: https://gobridgit.com/careers/
- group: operate
  title: ''
  type: Contact
  url: https://gobridgit.com/contact/
- group: start
  title: ''
  type: Login
...
- group: build
  title: ''
  type: GitHub
  url: https://github.com/Bridgit
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/bridgit
- group: company
  title: ''
  type: Twitter
  url: https://twitter.com/gobridgit
- group: learn
  title: ''
  type: YouTube
  url: https://www.youtube.com/@Gobridgit
created: '2026-05-25'
description: Bridgit is a Kitchener, Ontario-based construction technology company founded in 2012 by Mallorie Brodie and Lauren Lake. Its flagship product is Bridgit Bench, an AI-first workforce planning platform built exclusively for construction general contractors and subcontractors. Bench centralizes project staffing, role assignments, forecasting, utilization, time-off, internal resumes, and certifications, replacing the spreadsheets most contractors still use to plan their people across pursuits and active projects. Bridgit is trusted by nearly 40% of the ENR 400 and serves customers across North America, the United Kingdom, Australia, and New Zealand. The company has raised over $35M USD from investors including Autodesk, Salesforce Ventures, Sands Capital, BDC Capital, and Camber Creek. Bridgit Bench exposes a documented REST API (OpenAPI 3.0) for managing accounts, projects, people, roles, allocations, certifications, and groupings, and ships pre-built integrations across CRM (Salesforce,
  HubSpot, Microsoft Dynamics, Unanet, Zoho, Pipedrive), HRIS/ERP (Workday, BambooHR, UKG, Oracle, ADP, Namely), project management (Procore, Autodesk Build, CMiC, Trimble), and data warehouses (Snowflake, Office 365).
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/bridgit.png
layout: provider
modified: '2026-05-25'
name: Bridgit
nav: Providers
...
- kind: vulnerability-disclosure
  name: Bridgit Vulnerability Disclosure
  slug: bridgit-vulnerability-disclosure
