...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/skupos/refs/heads/main/security/skupos-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Skupos is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Retail Technology, Convenience Stores, Scan Data, and Loyalty.
