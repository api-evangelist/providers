...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/qantas/refs/heads/main/security/qantas-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/qantas-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/qantas/refs/heads/main/security/qantas-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/qantas/refs/heads/main/well-known/qantas-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/qantas-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/qantas/refs/heads/main/well-known/qantas-security.txt
  title: ''
  type: SecurityTxt
...
- group: auth
  ...
  url: https://www.qantas.com/.well-known/security.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/qantas/refs/heads/main/llms/qantas-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/qantas-llms.txt
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/qantas/refs/heads/main/conformance/qantas-conformance.yml
  title: ''
  type: Conformance
  url: conformance/qantas-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/qantas/refs/heads/main/lifecycle/qantas-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/qantas-lifecycle.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/qantas/refs/heads/main/changelog/qantas-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/qantas-changelog.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/qantas/refs/heads/main/rate-limits/qantas-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/qantas-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/qantas/refs/heads/main/plans/qantas-plans.yml
  title: ''
  type: Plans
  url: plans/qantas-plans.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/qantas/refs/heads/main/conventions/qantas-conventions.yml
  title: ''
  type: Conventions
  url: conventions/qantas-conventions.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/qantas/refs/heads/main/packages/qantas-packages.yml
  title: ''
  type: Packages
...
nav: Providers
network: true
overview: 'Qantas publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Travel, Australia, Aviation, Airlines, and Distribution.
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/qantas/refs/heads/main/screenshots/qantas-2026-09-02T152513.png
security:
