...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/national-endowment-for-the-arts/refs/heads/main/security/national-endowment-for-the-arts-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/national-endowment-for-the-arts-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/national-endowment-for-the-arts
- group: company
  title: ''
  type: Website
...
- group: other
  title: ''
  type: Research
  url: https://www.arts.gov/impact/research
- group: company
  title: ''
  type: PartnerData
  url: https://www.bea.gov/data/special-topics/arts-and-cultural
- group: operate
  title: ''
  type: Contact
  url: https://www.arts.gov/about/contact-us
- group: company
  title: ''
  type: Blog
  url: https://www.arts.gov/rss.xml
created: '2024-12-03'
description: The National Endowment for the Arts is an independent federal agency that funds, promotes, and strengthens the creative capacity of our communities by providing all Americans with diverse opportunities for arts participation. NEA does not currently expose a documented public REST API; arts and culture data is available through partner programs such as the Arts and Cultural Production Satellite Account (with BEA) and the Survey of Public Participation in the Arts (with the U.S. Census Bureau).
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/national-endowment-for-the-arts.png
layout: provider
modified: '2026-04-28'
