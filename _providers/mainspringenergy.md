...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mainspringenergy/refs/heads/main/security/mainspringenergy-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/mainspringenergy-trust-center.yml
- group: auth
  title: ''
  type: Compliance
  url: https://app.drata.com/trust/cd627a7d-b3f0-496c-81b8-b3c69cde90da
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mainspringenergy/refs/heads/main/security/mainspringenergy-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/mainspringenergy-domain-security.yml
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://www.mainspringenergy.com/privacy-policy
- group: commercial
  title: ''
  type: TermsOfService
  url: https://www.mainspringenergy.com/terms-of-use
- group: company
  title: ''
  type: Blog
  url: https://www.mainspringenergy.com/news-perspectives
- group: company
  title: ''
  type: LinkedIn
...
- kind: domain-security
  name: Mainspringenergy Domain Security
  slug: mainspringenergy-domain-security
  summary_line: TLSv1.3 · HSTS · DMARC
- kind: trust-center
  name: Mainspringenergy Trust Center
  slug: mainspringenergy-trust-center
