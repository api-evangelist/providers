...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://www.hillrom.com'', ''status'': 301, ''note'': ''declared website redirects to https://pro.baxter.com/ — a different registrable domain (hillrom.com -> baxter.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hill-rom-holdings/refs/heads/main/security/hill-rom-holdings-domain-security.yml
  title: ''
  type: DomainSecurity
