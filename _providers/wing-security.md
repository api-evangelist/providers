...
access_model:
  ...
  source:
  - plans
  - '{''url'': ''https://www.wing.security'', ''status'': 308, ''note'': ''declared website redirects to https://withwings.ai/ — a different registrable domain (wing.security -> withwings.ai), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/wing-security/refs/heads/main/security/wing-security-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/wing-security-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/wing-security/refs/heads/main/security/wing-security-domain-security.yml
  title: ''
  type: DomainSecurity
