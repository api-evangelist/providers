...
- group: other
  title: ''
  type: ParentCompany
  url: https://apis.io/providers/unilever/
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/dollar-shave/refs/heads/main/security/dollar-shave-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/dollar-shave-domain-security.yml
- group: company
  title: ''
  type: Website
...
- group: company
  title: ''
  type: Blog
  url: https://us.dollarshaveclub.com/blogs/club-chronicles
- group: operate
  title: ''
  type: HelpCenter
  url: https://ask.dollarshaveclub.com/
- group: operate
  title: ''
  type: Support
  url: https://ask.dollarshaveclub.com/en-US/how-do-i-contact-you-192340
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://ask.dollarshaveclub.com/en-US/privacy-policy-195939
- group: commercial
  title: ''
  type: TermsOfService
  url: https://ask.dollarshaveclub.com/en-US/terms-of-service-195938
- group: start
  title: ''
  type: Login
  url: https://us.dollarshaveclub.com/account/login
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/dollar-shave/refs/heads/main/well-known/dollar-shave-well-known.yml
  title: ''
  type: WellKnown
...
- kind: domain-security
  name: Dollar Shave Domain Security
  slug: dollar-shave-domain-security
