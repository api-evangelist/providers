...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tu-wien/refs/heads/main/security/tu-wien-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/tu-wien-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tu-wien/refs/heads/main/security/tu-wien-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/tu-wien-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tu-wien/refs/heads/main/authentication/tu-wien-authentication.yml
  title: ''
  type: Authentication
  url: authentication/tu-wien-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tu-wien/refs/heads/main/scopes/tu-wien-scopes.yml
  title: ''
  type: Scopes
  url: scopes/tu-wien-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tu-wien/refs/heads/main/errors/tu-wien-errors.yml
  title: ''
  type: Errors
  url: errors/tu-wien-errors.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tu-wien/refs/heads/main/conformance/tu-wien-education-standards.yml
  title: ''
  type: Conformance
  url: conformance/tu-wien-education-standards.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tu-wien/refs/heads/main/lifecycle/tu-wien-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/tu-wien-lifecycle.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/tu-wien/refs/heads/main/examples/tu-wien-examples.yml
  title: ''
  type: Examples
  url: examples/tu-wien-examples.yml
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/tu-wien/refs/heads/main/json-schema/tu-wien-fundify-funding.json
  title: ''
  type: JSONSchema
  url: json-schema/tu-wien-fundify-funding.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tu-wien/refs/heads/main/rules/tu-wien-spectral.yml
  title: ''
  type: Rules
  url: rules/tu-wien-spectral.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tu-wien/refs/heads/main/vocabulary/tu-wien-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/tu-wien-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tu-wien/refs/heads/main/json-ld/tu-wien-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/tu-wien-context.jsonld
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/tu-wien/refs/heads/main/plans/tu-wien-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/tu-wien-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/tu-wien/refs/heads/main/rate-limits/tu-wien-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/tu-wien-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/tu-wien/refs/heads/main/finops/tu-wien-finops.yml
  title: ''
  type: FinOps
  url: finops/tu-wien-finops.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/tu-wien/refs/heads/main/review.yml
  title: ''
  type: Review
  url: review.yml
created: '2026-06-03'
