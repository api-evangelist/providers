...
- baseURL: https://api.ctpx.secureworks.com
  baseurl_source: declared
  description: The Graph QL API from Secureworks — 1 operation(s) for graph ql.
  name: Secureworks Graph QL API
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/secureworks/refs/heads/main/agentic-access/secureworks-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/secureworks-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/secureworks/refs/heads/main/security/secureworks-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/secureworks-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/secureworks/refs/heads/main/authentication/secureworks-authentication.yml
  title: ''
  type: Authentication
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/secureworks/refs/heads/main/json-schema/secureworks-alert-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/secureworks-alert-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/secureworks/refs/heads/main/json-structure/secureworks-investigation-structure.json
  title: ''
  type: JSONStructure
  url: json-structure/secureworks-investigation-structure.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/secureworks/refs/heads/main/json-ld/secureworks-context.jsonld
  title: ''
  type: JSONLDContext
  url: json-ld/secureworks-context.jsonld
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/secureworks/refs/heads/main/examples/secureworks-query-alerts-example.json
  title: ''
  type: Examples
  url: examples/secureworks-query-alerts-example.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/secureworks/refs/heads/main/rules/secureworks-rules.yml
  title: ''
  type: SpectralRuleset
  url: rules/secureworks-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/secureworks/refs/heads/main/vocabulary/secureworks-vocabulary.yml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'Secureworks publishes 3 APIs on the [APIs.io](https://apis.io/) network: Authentication API, System API, and Graph QL API. Tagged areas include Cybersecurity, XDR, Threat Detection, Security Operations, and Incident Response.
