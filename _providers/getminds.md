...
nav: Providers
network: true
overview: 'Minds publishes 1 API on the [APIs.io](https://apis.io/) network: Public API. Tagged areas include Synthetic Research, Market Research, Surveys, User Research, and Marketing Analytics.
