...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/juniper/refs/heads/main/capabilities/juniper-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/juniper-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/juniper/refs/heads/main/agentic-access/juniper-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/juniper-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/juniper/refs/heads/main/security/juniper-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/juniper-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/juniper/refs/heads/main/authentication/juniper-authentication.yml
  title: ''
  type: Authentication
  url: authentication/juniper-authentication.yml
- group: company
  title: ''
  type: LinkedIn
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/juniper/refs/heads/main/json-ld/juniper-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/juniper-context.jsonld
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/juniper/refs/heads/main/json-schema/juniper-network-device.json
  title: ''
  type: JSONSchema
  url: json-schema/juniper-network-device.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/juniper/refs/heads/main/json-schema/juniper-virtual-network.json
  title: ''
  type: JSONSchema
  url: json-schema/juniper-virtual-network.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/juniper/refs/heads/main/json-schema/juniper-security-threat.json
  title: ''
  type: JSONSchema
  url: json-schema/juniper-security-threat.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/juniper/refs/heads/main/json-schema/juniper-site.json
  title: ''
  type: JSONSchema
  url: json-schema/juniper-site.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/juniper/refs/heads/main/json-schema/juniper-blueprint.json
  title: ''
  type: JSONSchema
...
- name: AnalysisResult
  property_count: 12
  slug: juniper-analysisresult
- name: Anomaly
  property_count: 8
  slug: juniper-anomaly
- name: ApiToken
  property_count: 5
  slug: juniper-apitoken
- name: AsnPool
  property_count: 6
  slug: juniper-asnpool
- name: AuditEvent
  property_count: 6
  slug: juniper-auditevent
- name: BgpPeer
  property_count: 10
  slug: juniper-bgppeer
- name: Blueprint
  property_count: 10
...
- name: BlueprintNode
  property_count: 7
  slug: juniper-blueprintnode
- name: ChassisModule
  property_count: 7
  slug: juniper-chassismodule
- name: ClientStats
  property_count: 16
  slug: juniper-clientstats
- name: ConfigFile
  property_count: 5
  slug: juniper-configfile
- name: Configlet
  property_count: 3
  slug: juniper-configlet
- name: ConnectivityTemplate
  property_count: 4
  slug: juniper-connectivitytemplate
- name: DesignTemplate
  property_count: 7
  slug: juniper-designtemplate
- name: Device
  property_count: 11
  slug: juniper-device
- name: DeviceStats
  property_count: 11
  slug: juniper-devicestats
- name: DomainReputation
  property_count: 6
  slug: juniper-domainreputation
- name: EnrolledDevice
  property_count: 9
  slug: juniper-enrolleddevice
- name: Error
  property_count: 1
  slug: juniper-error
- name: FileVerdict
  property_count: 8
  slug: juniper-fileverdict
- name: IbaDashboard
  property_count: 6
  slug: juniper-ibadashboard
- name: IdPerms
  property_count: 6
  slug: juniper-idperms
- name: Indicator
  property_count: 9
  slug: juniper-indicator
- name: InterfaceMap
  property_count: 5
  slug: juniper-interfacemap
- name: InventoryDevice
  property_count: 10
  slug: juniper-inventorydevice
- name: IpPool
  property_count: 6
  slug: juniper-ippool
- name: IpReputation
  property_count: 7
  slug: juniper-ipreputation
- name: Job
  property_count: 7
  slug: juniper-job
- name: ListEntry
  property_count: 6
  slug: juniper-listentry
- name: LldpNeighbor
  property_count: 5
  slug: juniper-lldpneighbor
- name: LogicalDevice
  property_count: 3
  slug: juniper-logicaldevice
- name: ManagedSystem
  property_count: 7
  slug: juniper-managedsystem
- name: Map
  property_count: 10
  slug: juniper-map
...
- name: NetworkIpam
  property_count: 5
  slug: juniper-networkipam
- name: NetworkPolicy
  property_count: 4
  slug: juniper-networkpolicy
- name: Organization
  property_count: 7
  slug: juniper-organization
- name: OrgStats
  property_count: 5
  slug: juniper-orgstats
- name: PhysicalInterface
  property_count: 10
  slug: juniper-physicalinterface
- name: Privilege
  property_count: 5
  slug: juniper-privilege
- name: Project
  property_count: 5
  slug: juniper-project
- name: RackType
  property_count: 6
  slug: juniper-racktype
- name: ResourceRef
  property_count: 3
  slug: juniper-resourceref
- name: RfTemplate
  property_count: 6
  slug: juniper-rftemplate
- name: Role
  property_count: 3
  slug: juniper-role
- name: RouteTable
  property_count: 5
  slug: juniper-routetable
- name: Script
  property_count: 5
  slug: juniper-script
...
- name: SecurityGroup
  property_count: 4
  slug: juniper-securitygroup
- name: SecurityZone
  property_count: 7
  slug: juniper-securityzone
- name: ServiceInstance
  property_count: 5
  slug: juniper-serviceinstance
- name: Site
  property_count: 11
  slug: juniper-site
- name: Juniper Site
...
- name: SiteGroup
  property_count: 6
  slug: juniper-sitegroup
- name: SiteInsights
  property_count: 2
  slug: juniper-siteinsights
- name: SiteStats
  property_count: 5
  slug: juniper-sitestats
- name: SoftwarePackage
  property_count: 6
  slug: juniper-softwarepackage
- name: SystemAgent
  property_count: 8
  slug: juniper-systemagent
- name: Tag
  property_count: 4
  slug: juniper-tag
- name: ThreatFeed
  property_count: 7
  slug: juniper-threatfeed
- name: ThreatReport
  property_count: 4
  slug: juniper-threatreport
- name: UrlReputation
  property_count: 5
  slug: juniper-urlreputation
- name: User
  property_count: 6
  slug: juniper-user
...
- name: VirtualNetwork
  property_count: 10
  slug: juniper-virtualnetwork
- name: VniPool
  property_count: 6
  slug: juniper-vnipool
- name: VnUve
  property_count: 1
  slug: juniper-vnuve
- name: WanEdge
  property_count: 8
  slug: juniper-wanedge
- name: Webhook
  property_count: 11
  slug: juniper-webhook
- name: Wlan
  property_count: 13
  slug: juniper-wlan
json_structures:
- name: Juniper Structure
  property_count: 0
  slug: juniper-structure
jsonld:
- class_count: 0
...
nav: Providers
network: true
overview: 'Juniper Networks publishes 47 APIs on the [APIs.io](https://apis.io/) network, including Allowlists and Blocklists API, Analytics API, Audit Logs API, and 44 more. Tagged areas include Artificial Intelligence, Automation, Cloud, Enterprise, and Networking.
