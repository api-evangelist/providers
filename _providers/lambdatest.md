...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lambdatest/refs/heads/main/security/lambdatest-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/lambdatest-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lambdatest/refs/heads/main/security/lambdatest-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/lambdatest-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lambdatest/refs/heads/main/authentication/lambdatest-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/lambdatest/refs/heads/main/plans/lambdatest-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/lambdatest-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/lambdatest/refs/heads/main/rate-limits/lambdatest-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/lambdatest-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/lambdatest/refs/heads/main/finops/lambdatest-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'LambdaTest publishes 20 APIs on the [APIs.io](https://apis.io/) network, including Autoheal Command Logs API, Build API, Extensions API, and 17 more. Tagged areas include Testing, Cross-Browser Testing, Selenium, Cypress, and Playwright.
