...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/dish-network/refs/heads/main/security/dish-network-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/dish-network-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/dish-network/refs/heads/main/security/dish-network-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/dish-network-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/dish-network
- group: company
  title: ''
  type: Website
...
- group: company
  title: ''
  type: Website
  url: https://about.echostar.com
created: '2026-03-24'
description: DISH Network is a U.S. television provider offering satellite and streaming TV services, as well as wireless services through its Boost Mobile and DISH Wireless brands. DISH is now part of EchoStar following the 2024 merger that brought DISH and Hughes back together under one parent. No public consumer-facing developer APIs are documented; the Boost Mobile and DISH Wireless networks are operated on a 5G Open RAN architecture.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/dish-network.png
layout: provider
modified: '2026-04-28'
name: DISH Network
nav: Providers
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/dish-network/refs/heads/main/screenshots/dish-network-2026-06-20T180047.png
security:
...
- kind: vulnerability-disclosure
  name: Dish Network Vulnerability Disclosure
  slug: dish-network-vulnerability-disclosure
