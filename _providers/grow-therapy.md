...
- group: company
  title: ''
  type: AboutUs
  url: https://growtherapy.com/about-us/
- group: company
  title: ''
  type: Blog
  url: https://growtherapy.com/blog/
- group: operate
  title: ''
  type: HelpCenter
  url: https://help.growtherapy.com/clients/en/
- group: operate
  title: ''
  type: Support
  url: https://growtherapy.jotform.com/grow-support/contact-us
- group: start
  title: ''
  type: Login
  url: https://provider.growtherapy.com/login
- group: commercial
  title: ''
  type: TermsOfService
  url: https://growtherapy.com/legal/terms-of-service/
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://growtherapy.com/legal/privacy-policies/
- group: operate
  title: ''
  type: StatusPage
  url: https://status.growtherapy.com
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/grow-therapy/refs/heads/main/lifecycle/grow-therapy-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/grow-therapy-lifecycle.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/grow-therapy/refs/heads/main/security/grow-therapy-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/grow-therapy-domain-security.yml
created: '2026-07-17'
...
nav: Providers
network: true
overview: 'Grow Therapy is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Mental Health, Telehealth, Healthcare, and Therapy.
