...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/keycorp/refs/heads/main/capabilities/keycorp-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/keycorp-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/keycorp/refs/heads/main/skills/keycorp-originate-ach-payment.md
  title: ''
  type: AgentSkill
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/keycorp/refs/heads/main/agentic-access/keycorp-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/keycorp-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/keycorp/refs/heads/main/security/keycorp-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/keycorp-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/keycorp/refs/heads/main/authentication/keycorp-authentication.yml
  title: ''
  type: Authentication
  url: authentication/keycorp-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/keycorp/refs/heads/main/conventions/keycorp-conventions.yml
  title: ''
  type: Conventions
...
- group: design
  ...
  url: conventions/keycorp-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/keycorp/refs/heads/main/errors/keycorp-error-codes.yml
  title: ''
  type: ErrorCatalog
  url: errors/keycorp-error-codes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/keycorp/refs/heads/main/conformance/keycorp-conformance.yml
  title: ''
  type: Conformance
  url: conformance/keycorp-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/keycorp/refs/heads/main/lifecycle/keycorp-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/keycorp-lifecycle.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/keycorp/refs/heads/main/sandbox/keycorp-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/keycorp-sandbox.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/keycorp/refs/heads/main/data-model/keycorp-data-model.yml
  title: ''
  type: DataModel
  url: data-model/keycorp-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/keycorp/refs/heads/main/asyncapi/keycorp-payment-alerts-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/keycorp-payment-alerts-webhooks.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/keycorp/refs/heads/main/mcp/keycorp-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/keycorp-mcp.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/keycorp/refs/heads/main/mcp/keycorp-tool-crosswalk.yml
  title: ''
  type: ToolCrosswalk
  url: mcp/keycorp-tool-crosswalk.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/keycorp/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkills
  url: skills/_index.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/keycorp/refs/heads/main/overlays/keycorp-ach-originations-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/keycorp-ach-originations-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/keycorp/refs/heads/main/llms/keycorp-llms.txt
  title: ''
  type: LLMsTxt
