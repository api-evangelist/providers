...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/sei/refs/heads/main/agentic-access/sei-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/sei-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sei/refs/heads/main/security/sei-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sei/refs/heads/main/finops/sei-finops.md
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Sei publishes 10 APIs on the [APIs.io](https://apis.io/) network, including ABCI API, Events API, Evidence API, and 7 more. Tagged areas include Blockchain, Layer 1, EVM, DeFi, and DEX.
