...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-security-command-center/refs/heads/main/agentic-access/google-cloud-security-command-center-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-cloud-security-command-center-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-security-command-center/refs/heads/main/security/google-cloud-security-command-center-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-cloud-security-command-center-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-security-command-center/refs/heads/main/security/google-cloud-security-command-center-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/google-cloud-security-command-center-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-security-command-center/refs/heads/main/authentication/google-cloud-security-command-center-authentication.yml
  title: ''
  type: Authentication
  url: authentication/google-cloud-security-command-center-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-security-command-center/refs/heads/main/scopes/google-cloud-security-command-center-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-security-command-center/refs/heads/main/json-ld/google-cloud-security-command-center-context.jsonld
  title: ''
  type: JSONLD
...
overview: 'Google Cloud Security Command Center publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Assets API, Findings API, NotificationConfigs API, and 1 more. Tagged areas include Cloud Security, Compliance, Risk Management, Security, and Threat Detection.
  ...
  Google Cloud Security Command Center''s developer surface includes authentication, developer portal, getting-started guide, documentation, pricing, support, engineering blog, and 12 more developer resources.'
plans:
