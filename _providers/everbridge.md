...
access_model:
  confidence: high
  label: Enterprise · Sales-gated · Public docs and specs
  onboarding: unknown
  pricing: enterprise
  public: true
  source:
...
- acting_count: 238
  ...
  summary_line: 473 operations · 238 acting · 11 human-in-the-loop
api_count: 13
apis:
...
- group: docs
  title: ''
  type: APIReference
  url: https://developers.everbridge.net/home/reference
- group: start
  title: ''
  type: GettingStarted
...
- group: operate
  title: ''
  type: Community
  url: https://developers.everbridge.net/home/discuss
- group: company
  title: ''
  type: Blog
...
- group: start
  title: ''
  type: SignUp
  url: https://www.everbridge.com/demo/
- group: operate
  title: ''
  type: Contact
  url: https://www.everbridge.com/contact-us/
- group: commercial
  title: ''
  type: TermsOfService
...
description: 'Everbridge is a global critical event management (CEM) software company whose platform helps organizations anticipate, manage and respond to disruption — unifying risk intelligence, mass communication and coordinated response across people, assets, operations and public safety environments. The Everbridge 360 platform serves over 6,500 customers across business services, energy and utilities, federal and local government, healthcare, financial services, higher education, manufacturing and transportation. Its API estate is published on a public ReadMe developer hub as thirteen OpenAPI documents covering roughly 473 operations: the EB Suite REST API (contacts, groups, users, incidents, notifications, scheduling, calendars, locations, conference bridges, custom roles), a Communications API with native OASIS Common Alerting Protocol and FEMA IPAWS delivery, a GraphQL CEM Alerts query and subscription stream, asset management and query, digital apps for mobile and desktop notification,
  travel risk intelligence, safety devices, risk events, and the SnapComms internal-communications API.'
finops:
- name: Everbridge Finops
  service_category: API
  slug: everbridge-finops
graphqls:
- description: 'generated: ''2026-08-27'''
  name: Everbridge CEM Alerts GraphQL API
  slug: everbridge-graphql
image: https://www.everbridge.com/wp-content/uploads/2021/01/everbridge-logo.svg
layout: provider
mcp_servers:
- description: Everbridge serves a Model Context Protocol endpoint from its own developer hub host, developers.everbridge.net/mcp. A JSON-RPC POST of tools/list and of initialize both return HTTP 401 with {"jsonrpc"
  name: Everbridge API Developer Hub MCP Server
  slug: everbridge-api-developer-hub-mcp-server
modified: '2026-08-27'
name: Everbridge
nav: Providers
network: true
...
- kind: vulnerability-disclosure
  name: Everbridge Vulnerability Disclosure
  slug: everbridge-vulnerability-disclosure
  summary_line: Hackerone
- kind: trust-center
  name: Everbridge Trust Center
  slug: everbridge-trust-center
  summary_line: SOC 2, SOC 3, ISO/IEC 27001, ISO/IEC 27001 Statement of Applicability, ISO/IEC 27701, ISO/IEC 27701 Statement of Applicability, ISO 22301, ISO/IEC 42001:2023, FedRAMP Moderate, TX-RAMP, G-Cloud, Cyber Essentials, C5, HIPAA, GDPR, CCPA, DORA, EU-US Data Privacy Framework, TruSight, VPAT
slug: everbridge
tags:
