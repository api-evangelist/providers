...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-photos/refs/heads/main/agentic-access/google-photos-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-photos-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-photos/refs/heads/main/security/google-photos-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-photos-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-photos/refs/heads/main/security/google-photos-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/google-photos-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-photos/refs/heads/main/authentication/google-photos-authentication.yml
  title: ''
  type: Authentication
  url: authentication/google-photos-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-photos/refs/heads/main/scopes/google-photos-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-photos/refs/heads/main/json-ld/photos.jsonld
  title: ''
  type: JSONLD
...
overview: 'Google Photos Library publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Albums API, MediaItems:search API, SharedAlbums API, and 1 more. Tagged areas include Albums, Google, Image, Media, and Photos.
  ...
  Google Photos Library''s developer surface includes authentication, getting-started guide, pricing, and 8 more developer resources.'
plans:
