...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/saleor/refs/heads/main/agentic-access/saleor-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/saleor-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/saleor/refs/heads/main/security/saleor-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/saleor-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/saleor/refs/heads/main/authentication/saleor-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Saleor publishes 9 APIs on the [APIs.io](https://apis.io/) network, including GraphQL API, and 8 more. Tagged areas include Commerce, Headless, E-Commerce, GraphQL, and Open Source.
