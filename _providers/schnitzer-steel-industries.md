...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/schnitzer-steel-industries/refs/heads/main/security/schnitzer-steel-industries-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/schnitzer-steel-industries-domain-security.yml
- group: company
  title: ''
  type: Website
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/schnitzer-steel-industries.png
jsonld:
- class_count: 29
  name: Schnitzer Steel Industries Context
  property_count: 0
  slug: schnitzer-steel-industries-context
layout: provider
modified: '2026-05-02'
name: Schnitzer Steel Industries
nav: Providers
network: true
overview: 'Schnitzer Steel Industries is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Recycling, Steel Manufacturing, Metals, Circular Economy, and Fortune 500.
...
slug: schnitzer-steel-industries
tags:
- Recycling
- Steel Manufacturing
- Metals
