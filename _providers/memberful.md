...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/memberful/refs/heads/main/security/memberful-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/memberful-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/memberful/refs/heads/main/security/memberful-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/memberful/refs/heads/main/plans/memberful-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/memberful-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/memberful/refs/heads/main/rate-limits/memberful-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/memberful-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/memberful/refs/heads/main/finops/memberful-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Memberful publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Members API, Subscriptions API, Plans and Passes API, and 2 more. Tagged areas include Membership, Subscription, Payments, Creators, and GraphQL.
