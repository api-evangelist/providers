...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/apache-mesos/refs/heads/main/agentic-access/apache-mesos-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/apache-mesos-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apache-mesos/refs/heads/main/security/apache-mesos-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/apache-mesos-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apache-mesos/refs/heads/main/security/apache-mesos-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Apache Mesos publishes 2 APIs on the [APIs.io](https://apis.io/) network, including Apache Mesos Operator HTTP API, and 1 more. Tagged areas include Cluster Management, Distributed Systems, Resource Management, Scheduling, and Retired.
