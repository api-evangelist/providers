...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/behaviosec/refs/heads/main/security/behaviosec-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/behaviosec-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/behaviosec/refs/heads/main/llms/behaviosec-llms.txt
  title: ''
  type: LLMsTxt
...
nav: Providers
network: true
overview: BehavioSec is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Enterprise, Behavioral Biometrics, Fraud Prevention, and Authentication.
random_paper: 15
score:
  band: minimal
  composite: 4.1
