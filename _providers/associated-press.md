...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/associated-press/refs/heads/main/capabilities/associated-press-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/associated-press-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/associated-press/refs/heads/main/agentic-access/associated-press-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/associated-press-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/associated-press/refs/heads/main/security/associated-press-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/associated-press-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/associated-press/refs/heads/main/authentication/associated-press-authentication.yml
  title: ''
  type: Authentication
...
overview: 'Associated Press publishes 3 APIs on the [APIs.io](https://apis.io/) network: Account API, Content API, and Monitors and Alerts API. Tagged areas include Elections, Journalism, Media, News, and Content.
  ...
  Associated Press'' developer surface includes authentication, developer portal, documentation, and 7 more developer resources.'
plans:
