...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jabil/refs/heads/main/security/jabil-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/jabil-domain-security.yml
- group: build
  title: ''
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/jabil.png
layout: provider
modified: '2026-04-28'
name: Jabil
nav: Providers
network: true
overview: 'Jabil is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Fortune 500, Manufacturing, and Supply Chain.
