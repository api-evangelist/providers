...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/alif-semiconductor/refs/heads/main/security/alif-semiconductor-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/alif-semiconductor-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/alif-semiconductor/refs/heads/main/well-known/alif-semiconductor-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/alif-semiconductor-well-known.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/alif-semiconductor/refs/heads/main/llms/alif-semiconductor-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/alif-semiconductor-llms.txt
- group: company
  title: ''
  type: Website
  url: https://alifsemi.com
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/alifsemi
- group: docs
  title: ''
  type: Documentation
  url: https://alifsemi.com/support/reference-manuals/view-all/
- group: operate
  title: ''
  type: Support
  url: https://alifsemi.com/support/technical-support/
- group: company
  title: ''
  type: Blog
  url: https://alifsemi.com/blog/
- group: start
  title: ''
  type: Login
  url: https://alifsemi.com/account/
- group: commercial
  title: ''
  type: TermsOfService
  url: https://alifsemi.com/terms-of-use/
- group: commercial
  title: ''
  type: PrivacyPolicy
