...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/anilist/refs/heads/main/agentic-access/anilist-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/anilist-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/anilist/refs/heads/main/security/anilist-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/anilist-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/anilist/refs/heads/main/authentication/anilist-authentication.yml
  title: ''
  type: Authentication
  url: authentication/anilist-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/anilist/refs/heads/main/scopes/anilist-scopes.yml
  title: ''
  type: OAuthScopes
...
nav: Providers
network: true
overview: 'AniList publishes 2 APIs on the [APIs.io](https://apis.io/) network: O Auth2 API and Graph QL API. Tagged areas include Anime, Manga, Entertainment, Media, and Social.
