...
- group: build
  title: ''
  type: Packages
  url: packages/fortify-software-packages.yml
- group: build
  title: ''
  type: SDKs
  url: packages/fortify-software-packages.yml
- group: build
  title: ''
  type: CLI
  url: cli/fortify-software-cli.yml
- group: agent
  title: ''
  type: WellKnown
  url: well-known/fortify-software-well-known.yml
- group: auth
  title: ''
  type: SecurityTxt
  url: well-known/fortify-software-well-known.yml
- group: agent
  title: ''
  type: LLMsTxt
  url: llms/fortify-software-llms.txt
- group: design
  title: ''
  type: Conformance
  url: conformance/fortify-software-conformance.yml
- group: design
  title: ''
  type: Lifecycle
  url: lifecycle/fortify-software-lifecycle.yml
- group: operate
  title: ''
  type: StatusPage
...
- group: auth
  title: ''
  type: DomainSecurity
  url: security/fortify-software-domain-security.yml
- group: auth
  title: ''
  type: VulnerabilityDisclosure
  url: security/fortify-software-vulnerability-disclosure.yml
- group: auth
  title: ''
  type: Security
...
- group: design
  title: ''
  type: Conventions
  url: conventions/fortify-software-conventions.yml
- group: operate
  title: ''
  type: ChangeLog
  url: changelog/fortify-software-changelog.yml
- group: agent
  title: ''
  type: AgentSkill
...
- kind: vulnerability-disclosure
  name: Fortify Software Vulnerability Disclosure
  slug: fortify-software-vulnerability-disclosure
  summary_line: security.txt · contact published
slug: fortify-software
tags:
- Company
- Security
