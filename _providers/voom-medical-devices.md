...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/voom-medical-devices/refs/heads/main/security/voom-medical-devices-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/voom-medical-devices/refs/heads/main/conformance/voom-medical-devices-conformance.yml
  title: ''
  type: Conformance
  url: conformance/voom-medical-devices-conformance.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/voom-medical-devices/refs/heads/main/llms/voom-medical-devices-llms.txt
  title: ''
  type: LLMsTxt
...
nav: Providers
network: true
overview: 'Voom Medical Devices is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Medical Devices, Healthcare, Orthopedics, and Surgery.
