...
- group: other
  title: ''
  type: European Data Protection Board
  url: https://www.edpb.europa.eu
- group: start
  title: ''
  type: European Commission GDPR Portal
  url: https://commission.europa.eu/law/law-topic/data-protection_en
- group: start
  title: ''
  type: GDPR.eu Resource Portal
  url: https://gdpr.eu
- group: auth
  title: ''
...
- group: auth
  title: ''
  type: GDPR FAQ
  url: https://gdpr.eu/faq/
created: '2025-01-01'
description: The General Data Protection Regulation (GDPR) is a comprehensive data privacy law enacted by the European Union that governs how organizations collect, process, and store personal data of EU residents. It grants individuals significant rights over their data and imposes strict obligations on organizations, with substantial penalties for non-compliance.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/gdpr.png
layout: provider
modified: '2026-04-28'
name: GDPR
nav: Providers
