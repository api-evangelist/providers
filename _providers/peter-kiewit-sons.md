...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/peter-kiewit-sons/refs/heads/main/security/peter-kiewit-sons-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/peter-kiewit-sons-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/kiewit
- group: company
  title: ''
  type: Website
...
- group: company
  title: ''
  type: Careers
  url: https://www.kiewit.com/careers/
- group: company
  title: ''
  type: About
  url: https://www.kiewit.com/about/
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://www.kiewit.com/privacy/
- group: agent
  title: ''
  type: LlmsText
  url: https://www.kiewit.com/llms.txt
created: '2026-03-21'
description: Peter Kiewit Sons' (Kiewit Corporation) is one of North America's largest and most respected construction and engineering organizations, working on projects in transportation, water, oil, gas, power, and building markets. This repository tracks any publicly available APIs, SDKs, and developer resources for Kiewit.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/peter-kiewit-sons.png
layout: provider
modified: '2026-04-28'
