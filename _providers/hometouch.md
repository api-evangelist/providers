...
- group: auth
  title: ''
  type: DomainSecurity
  url: security/hometouch-domain-security.yml
- group: company
  title: ''
  type: Website
...
- group: company
  title: ''
  type: Blog
  url: https://myhometouch.com/articles
- group: commercial
  title: ''
  type: Pricing
  url: https://myhometouch.com/pricing
- group: operate
  title: ''
  type: Support
  url: https://myhometouch.com/faqs
- group: start
  title: ''
  type: SignUp
  url: https://myhometouch.com/find-a-carer
- group: commercial
  title: ''
  type: TermsOfService
  url: https://myhometouch.com/managed-care-terms
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://myhometouch.com/privacy
created: '2026-07-17'
...
nav: Providers
network: true
overview: 'HomeTouch is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Health Care, Home Care, Elderly Care, and Dementia Care.


  HomeTouch''s developer surface includes engineering blog, pricing, support, signup flow, and 4 more developer resources.'
random_paper: 12
score:
  band: emerging
  composite: 15.2
