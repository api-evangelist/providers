...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/archimate/refs/heads/main/agentic-access/archimate-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/archimate-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/archimate/refs/heads/main/security/archimate-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/archimate-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/archimate/refs/heads/main/authentication/archimate-authentication.yml
  title: ''
  type: Authentication
...
overview: 'ArchiMate publishes 3 APIs on the [APIs.io](https://apis.io/) network: Elements API, Models API, and Relationships API. Tagged areas include Enterprise Architecture, Architecture Framework, Modeling Language, Business Architecture, and Technology Architecture.
  ...
  ArchiMate''s developer surface includes authentication, developer portal, documentation, getting-started guide, support, engineering blog, training material, and 7 more developer resources.'
plans:
