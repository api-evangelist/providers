...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/redwood-bank/refs/heads/main/security/redwood-bank-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/redwood-bank-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/redwood-bank/refs/heads/main/well-known/redwood-bank-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/redwood-bank-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/redwood-bank/refs/heads/main/authentication/redwood-bank-authentication.yml
  title: ''
  type: Authentication
  url: authentication/redwood-bank-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/redwood-bank/refs/heads/main/conformance/redwood-bank-conformance.yml
  title: ''
  type: Conformance
...
nav: Providers
network: true
overview: 'Redwood Bank publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Financial Services, Banking, Business Banking, Small Business, and Savings.
