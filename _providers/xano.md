...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/xano/refs/heads/main/agentic-access/xano-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/xano-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/xano/refs/heads/main/security/xano-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/xano-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/xano/refs/heads/main/security/xano-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/xano-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/xano/refs/heads/main/security/xano-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/xano-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/xano/refs/heads/main/authentication/xano-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/xano/refs/heads/main/plans/xano-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/xano-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/xano/refs/heads/main/rate-limits/xano-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/xano-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/xano/refs/heads/main/finops/xano-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Xano publishes 7 APIs on the [APIs.io](https://apis.io/) network, including API Groups API, Auth API, Content API, and 4 more. Tagged areas include No-Code, Backend-as-a-Service, API Builder, Database, and Serverless.
