...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/gainsight/refs/heads/main/capabilities/gainsight-capability-edges.yml
  title: ''
  type: CapabilityMap
...
overview: 'Gainsight publishes 29 APIs on the [APIs.io](https://apis.io/) network, including Accounts API, Activities API, Activity Types API, and 26 more.
  ...
  Gainsight''s developer surface includes authentication, developer portal, release notes, engineering blog, and 23 more developer resources.'
plans:
