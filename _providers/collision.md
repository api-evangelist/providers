...
- group: company
  title: ''
  type: News
  url: https://websummit.com/blog/news/web-summit-vancouver-collision-toronto/
- group: company
  title: ''
  type: Blog
  url: https://collisionconf.com/blog
- group: company
  title: ''
  type: Newsletter
  url: https://collisionconf.com/newsletter-signup
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://collisionconf.com/privacy
- group: operate
  title: ''
  type: Support
  url: https://support.collisionconf.com/support/home
- group: start
  title: ''
  type: Portal
  url: https://speakers.collisionconf.com/
- group: start
  title: ''
  type: Portal
  url: https://partners.collisionconf.com/
- group: other
  title: ''
  type: X
...
nav: Providers
network: true
overview: 'Collision (now Web Summit Vancouver) is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Conferences, Events, Historical, Rebrand, and Startups.
