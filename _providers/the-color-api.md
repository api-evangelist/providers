...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/the-color-api/refs/heads/main/agentic-access/the-color-api-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/the-color-api-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/the-color-api/refs/heads/main/security/the-color-api-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'The Color API publishes 2 APIs on the [APIs.io](https://apis.io/) network: Colors API and Schemes API. Tagged areas include Colors, Design, and Developer Tools.
