...
- description: Clicklane is Asbury Automotive's proprietary online vehicle purchase platform that enables customers to complete the full car buying process digitally, including vehicle selection, financing, trade-in
  ...
  slug: clicklane-platform
artifact_total: 13
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/asbury-automotive/refs/heads/main/security/asbury-automotive-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/asbury-automotive-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/asbury-automotive-group
- group: start
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/asbury-automotive.png
integrations:
...
plans:
- name: Asbury Automotive Plans Pricing
  plan_count: 1
