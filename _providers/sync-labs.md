...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/sync-labs/refs/heads/main/capabilities/sync-labs-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/sync-labs-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/sync-labs/refs/heads/main/agentic-access/sync-labs-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/sync-labs-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sync-labs/refs/heads/main/security/sync-labs-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/sync-labs-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sync-labs/refs/heads/main/authentication/sync-labs-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Sync Labs publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Assets API, Batch API, Generate API, and 3 more. Tagged areas include Artificial Intelligence, Content Localization, Dubbing, Lip Sync, and Media.
