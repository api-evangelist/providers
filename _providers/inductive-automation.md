...
common:
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/inductive-automation/refs/heads/main/plans/inductive-automation-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/inductive-automation-plans-pricing.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/inductive-automation/refs/heads/main/capabilities/inductive-automation-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/inductive-automation-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/inductive-automation/refs/heads/main/agentic-access/inductive-automation-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/inductive-automation-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/inductive-automation/refs/heads/main/security/inductive-automation-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/inductive-automation-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/inductive-automation/refs/heads/main/security/inductive-automation-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/inductive-automation-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/inductive-automation/refs/heads/main/security/inductive-automation-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/inductive-automation-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/inductive-automation/refs/heads/main/authentication/inductive-automation-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Inductive Automation publishes 88 APIs on the [APIs.io](https://apis.io/) network, including Access Control API, Agent Group API, Agent Management API, and 85 more. Tagged areas include SCADA, HMI, Manufacturing, Industrial IoT, and Industrial Automation.


  The Inductive Automation catalog on APIs.io includes 1 JSON-LD context and 2 Spectral governance rulesets.


  Inductive Automation''s developer surface includes authentication, documentation, developer portal, engineering blog, YouTube channel, pricing, support, and 11 more developer resources.'
plans:
- name: Inductive Automation Plans Pricing
  plan_count: 4
  slug: inductive-automation-plans-pricing
- name: Inductive Automation Price Estimates
  plan_count: 0
  slug: inductive-automation-price-estimates
random_paper: 15
rules:
