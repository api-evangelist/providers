...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/test-cases/refs/heads/main/agentic-access/test-cases-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/test-cases-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/test-cases/refs/heads/main/security/test-cases-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/test-cases-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/test-cases/refs/heads/main/security/test-cases-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/test-cases-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/test-cases/refs/heads/main/security/test-cases-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/test-cases-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/test-cases/refs/heads/main/authentication/test-cases-authentication.yml
  title: ''
  type: Authentication
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/test-cases/refs/heads/main/json-schema/test-cases-test-case-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/test-cases-test-case-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/test-cases/refs/heads/main/json-schema/test-cases-test-step-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/test-cases-test-step-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/test-cases/refs/heads/main/json-schema/test-cases-test-result-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/test-cases-test-result-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/test-cases/refs/heads/main/json-schema/test-cases-test-suite-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/test-cases-test-suite-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/test-cases/refs/heads/main/json-ld/test-cases-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/test-cases-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/test-cases/refs/heads/main/vocabulary/test-cases-vocabulary.yml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'Test Cases publishes 3 APIs on the [APIs.io](https://apis.io/) network: Collections API, Environments API, and Mocks API. Tagged areas include API Testing, Automation, Developer Tools, Quality Assurance, and Software Development.
