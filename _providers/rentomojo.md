...
- group: build
  ...
  url: https://github.com/RentoMojo
- group: company
  title: ''
  type: Blog
  url: https://www.rentomojo.com/blog/
- group: operate
  title: ''
  type: Support
  url: https://www.rentomojo.com/contact
- group: commercial
  title: ''
  type: TermsOfService
  url: https://www.rentomojo.com/terms-and-conditions
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://www.rentomojo.com/privacy-policy
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/rentomojo/refs/heads/main/security/rentomojo-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/rentomojo-domain-security.yml
created: '2026-07-17'
...
nav: Providers
network: true
overview: 'Rentomojo is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Consumer, Furniture Rental, Appliance Rental, and Subscription.
