...
- description: ART (Adversarial Robustness Toolbox) provides tools for evaluating and defending machine learning models against adversarial threats.
  ...
  slug: adversarial-robustness-toolbox
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lf-ai-and-data/refs/heads/main/security/lf-ai-and-data-domain-security.yml
  title: ''
  type: DomainSecurity
...
- limit_count: 5
  ...
  slug: lf-ai-and-data-rate-limits
score:
  band: emerging
  composite: 25.4
  coverage:
