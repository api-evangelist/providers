...
- baseURL: https://api.pinterest.com/v5
  baseurl_source: declared
  description: The Boards API from Pinterest — 1 operation(s) for boards.
...
- baseURL: https://api.pinterest.com/v5
  baseurl_source: declared
  description: The Keywords API from Pinterest — 3 operation(s) for keywords.
...
- baseURL: https://api.pinterest.com/v5
  baseurl_source: declared
  description: The Product API from Pinterest — 10 operation(s) for product.
...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/pinterest/refs/heads/main/capabilities/pinterest-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/pinterest-capability-edges.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pinterest/refs/heads/main/security/pinterest-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/pinterest-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/pinterest
- group: docs
  title: ''
  type: Guidelines
...
- group: agent
  title: ''
  type: LlmsText
  url: https://developers.pinterest.com/llms.txt
created: '2023-11-23'
...
graphqls:
- description: 'This document describes a conceptual GraphQL schema for the Pinterest API v5. Pinterest is a visual discovery platform enabling users to save, organize, and discover ideas through images, videos, and '
  name: Pinterest GraphQL Schema
  slug: pinterest-graphql
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/pinterest.png
layout: provider
modified: '2026-05-30'
name: Pinterest
nav: Providers
