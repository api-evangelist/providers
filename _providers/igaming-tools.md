...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/igaming-tools/refs/heads/main/llms/igaming-tools-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/igaming-tools-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/igaming-tools/refs/heads/main/llms/igaming-tools-docs-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/igaming-tools-docs-llms.txt
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/igaming-tools/refs/heads/main/plans/igaming-tools-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/igaming-tools-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/igaming-tools/refs/heads/main/rate-limits/igaming-tools-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/igaming-tools-rate-limits.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/igaming-tools/refs/heads/main/conventions/igaming-tools-conventions.yml
  title: ''
  type: Conventions
  url: conventions/igaming-tools-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/igaming-tools/refs/heads/main/lifecycle/igaming-tools-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/igaming-tools-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/igaming-tools/refs/heads/main/conformance/igaming-tools-conformance.yml
  title: ''
  type: Conformance
  url: conformance/igaming-tools-conformance.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/igaming-tools/refs/heads/main/security/igaming-tools-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/igaming-tools-domain-security.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/igaming-tools/refs/heads/main/packages/igaming-tools-packages.yml
  title: ''
  type: Packages
  url: packages/igaming-tools-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/igaming-tools/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
