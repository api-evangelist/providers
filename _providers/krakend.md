...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/krakend/refs/heads/main/agentic-access/krakend-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/krakend-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/krakend/refs/heads/main/security/krakend-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/krakend/refs/heads/main/json-schema/service-config.json
  title: ''
  type: JSONSchema
  url: json-schema/service-config.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/krakend/refs/heads/main/json-ld/krakend-context.jsonld
  title: ''
  type: JSONLD
...
nav: Providers
network: true
overview: 'KrakenD publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Debug API, Health API, Metrics API, and 2 more. Tagged areas include Aggregation, API Gateway, Go, and Open Source.
