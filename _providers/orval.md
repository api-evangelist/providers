...
- group: build
  title: ''
  type: CodeOfConduct
  url: https://github.com/orval-labs/orval/blob/master/CODE_OF_CONDUCT.md
- group: docs
  title: ''
...
overview: 'Orval publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Code Generation, OpenAPI, Swagger, SDK, and TypeScript.
  ...
  Orval''s developer surface includes documentation, API reference, getting-started guide, support, code examples, CLI, changelog, and 22 more developer resources.'
plans:
