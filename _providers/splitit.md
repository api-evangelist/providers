...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/splitit/refs/heads/main/agentic-access/splitit-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/splitit-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/splitit/refs/heads/main/security/splitit-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/splitit-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/splitit/refs/heads/main/authentication/splitit-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Splitit publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Authentication API, Eligibility API, Installment Plans API, and 7 more. Tagged areas include Payments, Installments, Buy Now Pay Later, Credit Cards, and Fintech.


  The Splitit catalog on APIs.io includes 1 JSON-LD context and 1 Spectral governance ruleset.


  Splitit''s developer surface includes authentication, developer portal, signup flow, documentation, getting-started guide, pricing, and 19 more developer resources.'
plans:
- name: Plans
  plan_count: 4
  slug: plans
