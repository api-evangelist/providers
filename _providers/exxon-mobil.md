...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/exxon-mobil/refs/heads/main/security/exxon-mobil-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/exxon-mobil-domain-security.yml
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/ExxonMobil
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/exxonmobil
- group: company
  title: ''
  type: Website
...
- group: company
  ...
  url: https://corporate.exxonmobil.com/news
created: '2026-03-21'
description: Exxon Mobil Corporation is one of the world's largest publicly traded international energy companies, exploring for, producing, and refining oil and natural gas and manufacturing petroleum and chemical products. This repository tracks any APIs, developer tools, and machine-readable artifacts associated with Exxon Mobil.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/exxon-mobil.png
layout: provider
modified: '2026-04-28'
name: Exxon Mobil
nav: Providers
network: true
overview: 'Exxon Mobil is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Chemicals, Energy, Fortune 500, Natural Gas, and Oil.
...
- kind: domain-security
  name: Exxon Mobil Domain Security
  slug: exxon-mobil-domain-security
