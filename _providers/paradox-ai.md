...
- description: Dynamic, 24/7 conversational career sites that surface relevant jobs and capture candidate interest through chat.
  name: Paradox Conversational Career Sites
  slug: conversational-career-sites
...
nav: Providers
network: true
overview: 'Paradox publishes 11 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include Conversational AI, Recruiting Automation, High-Volume Hiring, Chatbot, and ATS.
