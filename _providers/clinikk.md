...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/clinikk/refs/heads/main/security/clinikk-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/clinikk/refs/heads/main/llms/clinikk-llms.txt
  title: ''
  type: LLMsTxt
...
nav: Providers
network: true
overview: 'Clinikk is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Healthcare, Primary Care, Health Insurance, and Telehealth.
