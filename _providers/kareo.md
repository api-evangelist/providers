...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/kareo/refs/heads/main/security/kareo-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/kareo-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/kareo/refs/heads/main/security/kareo-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/kareo/refs/heads/main/plans/kareo-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/kareo-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/kareo/refs/heads/main/rate-limits/kareo-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/kareo-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/kareo/refs/heads/main/finops/kareo-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Kareo publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Administrative API, Appointments API, Billing API, and 5 more. Tagged areas include Healthcare, Medical Software, EHR, Practice Management, and Medical Billing.
