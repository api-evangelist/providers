...
nav: Providers
network: true
overview: 'Factorial publishes 2 APIs on the [APIs.io](https://apis.io/) network: Core::Employees::V2 API and Core::Me API. Tagged areas include HR, Human Resources, Payroll, Time Off, and Time Tracking.
