...
nav: Providers
network: true
overview: 'Polygon ID publishes 17 APIs on the [APIs.io](https://apis.io/) network, including Agent API, Auth API, Config API, and 14 more. Tagged areas include Identity, Verifiable Credentials, Zero-Knowledge Proofs, Self-Sovereign Identity, and Decentralized Identity.
