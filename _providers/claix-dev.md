...
nav: Providers
network: true
overview: 'Claix publishes 3 APIs on the [APIs.io](https://apis.io/) network, including Document Intelligence API, and 2 more. Tagged areas include Document Processing, Data Extraction, Document Intelligence, PDF, and Excel.
