...
- collection_type: open
  name: Apache Cassandra REST API (via Stargate) Columns API
  slug: open-cassandra-columns-api
- collection_type: open
  name: Apache Cassandra REST API (via Stargate) Columns Indexes API
  slug: open-cassandra-indexes-api
- collection_type: open
  name: Apache Cassandra REST API (via Stargate) Columns Keyspaces API
  slug: open-cassandra-keyspaces-api
- collection_type: open
  name: Apache Cassandra REST API (via Stargate) Columns Rows API
  slug: open-cassandra-rows-api
- collection_type: open
  name: Apache Cassandra REST API (via Stargate) Columns Tables API
  slug: open-cassandra-tables-api
- collection_type: open
  name: Apache Cassandra REST API (via Stargate) Columns Types API
  slug: open-cassandra-types-api
- collection_type: open
...
- group: auth
  title: ''
  type: SecurityPolicy
  url: https://github.com/apache/cassandra/blob/trunk/SECURITY.md
- group: build
  title: ''
  type: CodeOfConduct
...
- group: docs
  ...
  url: https://github.com/apache/cassandra/blob/trunk/CONTRIBUTING.md
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cassandra/refs/heads/main/agentic-access/cassandra-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/cassandra-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cassandra/refs/heads/main/security/cassandra-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/cassandra-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cassandra/refs/heads/main/security/cassandra-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/cassandra-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cassandra/refs/heads/main/authentication/cassandra-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Apache Cassandra publishes 12 APIs on the [APIs.io](https://apis.io/) network, including Cassandra REST API (Stargate), Columns API, Indexes API, and 9 more. Tagged areas include Apache, Big Data, Database, Distributed, and NoSQL.


  Apache Cassandra''s developer surface includes authentication, documentation, getting-started guide, GitHub presence, engineering blog, Stack Overflow tag, YouTube channel, and 24 more developer resources.'
plans:
