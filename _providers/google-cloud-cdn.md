...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-cdn/refs/heads/main/capabilities/google-cloud-cdn-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-cdn/refs/heads/main/agentic-access/google-cloud-cdn-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-cloud-cdn-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-cdn/refs/heads/main/security/google-cloud-cdn-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-cloud-cdn-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-cdn/refs/heads/main/security/google-cloud-cdn-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/google-cloud-cdn-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-cdn/refs/heads/main/authentication/google-cloud-cdn-authentication.yml
  title: ''
  type: Authentication
  url: authentication/google-cloud-cdn-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-cdn/refs/heads/main/scopes/google-cloud-cdn-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-cdn/refs/heads/main/json-ld/cdn-context.jsonld
  title: ''
  type: JSONLD
...
overview: 'Google Cloud CDN publishes 3 APIs on the [APIs.io](https://apis.io/) network: BackendServices API, Cache Invalidation API, and URL maps API. Tagged areas include Caching, CDN, Content Delivery, Google Cloud, and Networking.
  ...
  Google Cloud CDN''s developer surface includes authentication, developer portal, getting-started guide, documentation, pricing, support, and 13 more developer resources.'
plans:
