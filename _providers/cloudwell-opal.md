...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cloudwell-opal/refs/heads/main/security/cloudwell-opal-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Cloudwell is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include AppSource, Calendar Overlay, Microsoft-365, Microsoft Partner, and Org Chart.
