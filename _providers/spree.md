...
- group: agent
  title: ''
  type: AgenticAccess
  url: agentic-access/spree-agentic-access.yml
- group: auth
  title: ''
  type: DomainSecurity
  url: security/spree-domain-security.yml
- group: auth
  title: ''
  type: Authentication
  url: authentication/spree-authentication.yml
- group: agent
  title: ''
  type: AgentSkills
  url: https://github.com/spree/agent-skills
- group: company
  title: ''
  type: Website
...
examples:
- key_count: 4
  name: Spree Admin Api Examples
  slug: spree-admin-api-examples
- key_count: 4
  name: Spree Store Api Examples
  slug: spree-store-api-examples
finops:
- name: Spree Finops
  service_category: ''
  slug: spree-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/spree.png
json_schemas:
- name: Spree Admin API Schemas
  property_count: 0
  slug: spree-admin-api-schemas
- name: Spree Store API Schemas
  property_count: 0
  slug: spree-store-api-schemas
jsonld:
- class_count: 0
  name: Spree Api Context
  property_count: 857
  slug: spree-api-context
layout: provider
modified: '2026-06-13'
name: Spree Commerce
nav: Providers
...
- limit_count: 2
  ...
  slug: spree-rate-limits
rules:
- effective_rule_count: 6
  extends: []
  name: Spree Commerce API Rules
  rule_count: 6
  severity_counts:
    error: 0
    hint: 0
...
- name: spree-customization
  slug: spree-customization
- name: spree-data-model
  slug: spree-data-model
- name: spree-decorators
  slug: spree-decorators
- name: spree-dependencies
  slug: spree-dependencies
- name: spree-deployment
  slug: spree-deployment
- name: spree-events-webhooks
  slug: spree-events-webhooks
- name: spree-extensions
  slug: spree-extensions
- name: spree-i18n
  slug: spree-i18n
- name: spree-legacy-api-v2
  slug: spree-legacy-api-v2
- name: spree-payments
  slug: spree-payments
- name: spree-performance
  slug: spree-performance
- name: spree-pricing
  slug: spree-pricing
- name: spree-project
  slug: spree-project
- name: spree-promotions
  slug: spree-promotions
- name: spree-resource
  slug: spree-resource
- name: spree-security
  slug: spree-security
- name: spree-shipping-fulfillment
  slug: spree-shipping-fulfillment
- name: spree-storefront
  slug: spree-storefront
- name: spree-testing
  slug: spree-testing
- name: spree-typescript-sdk
  slug: spree-typescript-sdk
slug: spree
tags:
- E-Commerce
- Headless Commerce
