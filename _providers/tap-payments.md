...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/tap-payments/refs/heads/main/agentic-access/tap-payments-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/tap-payments-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tap-payments/refs/heads/main/security/tap-payments-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/tap-payments-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tap-payments/refs/heads/main/authentication/tap-payments-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/tap-payments/refs/heads/main/plans/tap-payments-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/tap-payments-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/tap-payments/refs/heads/main/rate-limits/tap-payments-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/tap-payments-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/tap-payments/refs/heads/main/finops/tap-payments-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Tap Payments publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Authorize API, Business API, Cards API, and 7 more. Tagged areas include Payments, Fintech, Payment Gateway, MENA, and Middle East.
