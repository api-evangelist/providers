...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/nexthop-ai/refs/heads/main/security/nexthop-ai-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/nexthop-ai-domain-security.yml
- group: company
  title: ''
  type: Website
...
- group: company
  title: ''
  type: News
  url: https://nexthop.ai/news-events/
- group: operate
  title: ''
  type: Support
...
nav: Providers
network: true
overview: 'Nexthop AI is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Artificial Intelligence, Networking, Infrastructure, and Switches.
