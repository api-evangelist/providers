...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/microsoft-windows-server/refs/heads/main/agentic-access/microsoft-windows-server-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/microsoft-windows-server-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/microsoft-windows-server/refs/heads/main/security/microsoft-windows-server-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/microsoft-windows-server-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/microsoft-windows-server/refs/heads/main/authentication/microsoft-windows-server-authentication.yml
  title: ''
  type: Authentication
