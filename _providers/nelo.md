...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/nelo/refs/heads/main/security/nelo-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Nelo is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Fintech, Buy Now Pay Later, Consumer Credit, and Payments.
