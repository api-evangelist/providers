...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/vellum/refs/heads/main/agentic-access/vellum-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/vellum-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/vellum/refs/heads/main/security/vellum-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/vellum-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/vellum/refs/heads/main/authentication/vellum-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Vellum AI publishes 16 APIs on the [APIs.io](https://apis.io/) network, including Default API, Subpackage Deployments API, Subpackage Document Indexes API, and 13 more. Tagged areas include LLM Platform, Prompt Engineering, Workflows, Evaluation, and LLMOps.
