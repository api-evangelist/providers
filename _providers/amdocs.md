...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/amdocs/refs/heads/main/capabilities/amdocs-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/amdocs-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/amdocs/refs/heads/main/agentic-access/amdocs-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/amdocs-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/amdocs/refs/heads/main/security/amdocs-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/amdocs-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/amdocs/refs/heads/main/authentication/amdocs-authentication.yml
  title: ''
  type: Authentication
  url: authentication/amdocs-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/amdocs/refs/heads/main/scopes/amdocs-scopes.yml
  title: ''
  type: OAuthScopes
...
nav: Providers
network: true
overview: 'Amdocs publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Billing API, Customers API, Products API, and 3 more. Tagged areas include Telecommunications, BSS, OSS, Billing, and Customer Management.
