...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/casdoor/refs/heads/main/agentic-access/casdoor-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/casdoor-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/casdoor/refs/heads/main/security/casdoor-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/casdoor-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/casdoor/refs/heads/main/authentication/casdoor-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Casdoor publishes 15 APIs on the [APIs.io](https://apis.io/) network, including REST API, Applications API, Authentication API, and 12 more. Tagged areas include Authentication, Authorization, Identity and Access Management, Identity, and LDAP.
