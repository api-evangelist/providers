...
api_count: 2
apis:
- baseURL: https://api.datavant.io/v2
...
- group: docs
  ...
  url: https://developer.datavant.com/docs
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/datavant/refs/heads/main/openapi/_original/datavant-rest-api-openapi.yml
  title: ''
  type: OpenAPI
  url: openapi/_original/datavant-rest-api-openapi.yml
- group: operate
  title: ''
  type: Support
...
nav: Providers
network: true
overview: 'Datavant publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Configuration API, Documents API, Order Queries API, and 5 more. Tagged areas include Healthcare, United States, Interoperability, Health Data, and De-Identification.
