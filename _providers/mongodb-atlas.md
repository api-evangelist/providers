...
- collection_type: open
  name: MongoDB Atlas Administration Clusters API
  slug: open-mongodb-atlas-clusters-api
- collection_type: open
  name: MongoDB Atlas Administration Clusters Database Users API
  slug: open-mongodb-atlas-database-users-api
- collection_type: open
  name: MongoDB Atlas Administration Clusters Organizations API
  slug: open-mongodb-atlas-organizations-api
- collection_type: open
  name: MongoDB Atlas Administration Clusters Projects API
  slug: open-mongodb-atlas-projects-api
- collection_type: open
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mongodb-atlas/refs/heads/main/security/mongodb-atlas-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/mongodb-atlas-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mongodb-atlas/refs/heads/main/security/mongodb-atlas-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/mongodb-atlas-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mongodb-atlas/refs/heads/main/security/mongodb-atlas-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/mongodb-atlas-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mongodb-atlas/refs/heads/main/authentication/mongodb-atlas-authentication.yml
  title: ''
  type: Authentication
