...
- baseURL: https://stg.integration-graph.apteansharedservices.com
  baseurl_source: declared
  description: The Event Definitions API from Aptean — 2 operation(s) for event definitions.
  name: Aptean Event Definitions API
  slug: aptean-event-definitions-api
- baseURL: https://stg.integration-graph.apteansharedservices.com
  baseurl_source: declared
  description: The Public Keys API from Aptean — 1 operation(s) for public keys.
  name: Aptean Public Keys API
...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/aptean/refs/heads/main/overlays/aptean-integration-platform-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/aptean-integration-platform-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/aptean/refs/heads/main/agentic-access/aptean-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/aptean-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/aptean/refs/heads/main/authentication/aptean-authentication.yml
  title: ''
  type: Authentication
  url: authentication/aptean-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/aptean/refs/heads/main/security/aptean-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/aptean-domain-security.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aptean/refs/heads/main/conventions/aptean-conventions.yml
  title: ''
  type: Conventions
  url: conventions/aptean-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aptean/refs/heads/main/lifecycle/aptean-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/aptean-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aptean/refs/heads/main/conformance/aptean-conformance.yml
  title: ''
  type: Conformance
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/aptean/refs/heads/main/security/aptean-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/aptean-trust-center.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aptean/refs/heads/main/asyncapi/aptean-events-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/aptean-events-webhooks.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/aptean/refs/heads/main/mcp/aptean-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/aptean-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/aptean/refs/heads/main/llms/aptean-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/aptean-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/aptean/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/aptean/refs/heads/main/sandbox/aptean-sandbox.yml
  title: ''
  type: Sandbox
...
nav: Providers
network: true
overview: 'Aptean publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Consumers API, Events API, Producers API, and 2 more. Tagged areas include Company, Manufacturing, ERP, Supply Chain, and Integration.
