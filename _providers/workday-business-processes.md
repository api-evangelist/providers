...
nav: Providers
network: true
overview: 'Workday Business Processes publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Approvals API, Business Process Definitions API, Inbox Items API, and 3 more. Tagged areas include Business Processes, Workflows, Approvals, Human Resources, and Enterprise.
