...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/examedi/refs/heads/main/security/examedi-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/examedi-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/examedi/refs/heads/main/llms/examedi-llms.txt
  title: ''
  type: LLMsTxt
...
nav: Providers
network: true
overview: Examedi publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Health, Healthcare, Health Tech, and Diagnostics.
random_paper: 7
score:
  band: minimal
  composite: 5.9
