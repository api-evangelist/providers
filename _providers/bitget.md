...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bitget/refs/heads/main/security/bitget-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/bitget/refs/heads/main/rate-limits/rate-limits.md
  title: ''
  type: RateLimits
  url: /rate-limits/rate-limits.md
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/bitget/refs/heads/main/plans/plans.md
  title: ''
  type: Plans
  url: /plans/plans.md
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/bitget/refs/heads/main/finops/finops.md
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Bitget publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Spot Trading API, and 6 more. Tagged areas include Cryptocurrency, Exchange, Spot Trading, Futures, and Perpetual Contracts.
