...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/too-good-to-go/refs/heads/main/security/too-good-to-go-trust-center.yml
  title: ''
  type: TrustCenter
...
- group: auth
  ...
  url: security/too-good-to-go-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/too-good-to-go/refs/heads/main/security/too-good-to-go-vulnerability-disclosure.yml
  title: ''
  type: Security
...
- group: auth
  ...
  url: security/too-good-to-go-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/too-good-to-go/refs/heads/main/security/too-good-to-go-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/too-good-to-go/refs/heads/main/well-known/too-good-to-go-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/too-good-to-go-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/too-good-to-go/refs/heads/main/well-known/too-good-to-go-security.txt
  title: ''
  type: SecurityTxt
  url: well-known/too-good-to-go-security.txt
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/too-good-to-go/refs/heads/main/lifecycle/too-good-to-go-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/too-good-to-go-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/too-good-to-go/refs/heads/main/conformance/too-good-to-go-conformance.yml
  title: ''
  type: Conformance
  url: conformance/too-good-to-go-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/too-good-to-go/refs/heads/main/errors/too-good-to-go-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/too-good-to-go-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/too-good-to-go/refs/heads/main/conventions/too-good-to-go-conventions.yml
  title: ''
  type: Conventions
  url: conventions/too-good-to-go-conventions.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/too-good-to-go/refs/heads/main/packages/too-good-to-go-packages.yml
  title: ''
  type: Packages
  url: packages/too-good-to-go-packages.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/too-good-to-go/refs/heads/main/plans/too-good-to-go-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/too-good-to-go-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/too-good-to-go/refs/heads/main/rate-limits/too-good-to-go-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/too-good-to-go-rate-limits.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/too-good-to-go/refs/heads/main/llms/too-good-to-go-llms.txt
  title: ''
  type: LLMsTxt
