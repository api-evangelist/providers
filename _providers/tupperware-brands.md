...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://www.tupperwarebrands.com'', ''status'': 302, ''note'': ''declared website redirects to https://www.tupperware.com:443/pages/countries — a different registrable domain (tupperwarebrands.com -> tupperware.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tupperware-brands/refs/heads/main/security/tupperware-brands-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/tupperware-brands-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/tupperware-brands
- group: company
  title: ''
  type: Website
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/tupperware-brands.png
layout: provider
modified: '2026-05-03'
...
- kind: domain-security
  name: Tupperware Brands Domain Security
  slug: tupperware-brands-domain-security
  summary_line: TLSv1.2 · HSTS
slug: tupperware-brands
tags:
- Consumer Goods
- Direct Sales
- Kitchen Products
...
- Storage Products
- Fortune 1000
website: https://www.tupperwarebrands.com
---
