...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pubmatic/refs/heads/main/security/pubmatic-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/pubmatic/refs/heads/main/mcp/pubmatic-mcp.yml
  title: ''
  type: MCPServer
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/pubmatic/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/pubmatic/refs/heads/main/llms/pubmatic-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/pubmatic-llms.txt
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/pubmatic/refs/heads/main/packages/pubmatic-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/pubmatic-packages.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pubmatic/refs/heads/main/authentication/pubmatic-authentication.yml
  title: ''
  type: Authentication
  url: authentication/pubmatic-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/pubmatic/refs/heads/main/conventions/pubmatic-conventions.yml
  title: ''
  type: Conventions
  url: conventions/pubmatic-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/pubmatic/refs/heads/main/errors/pubmatic-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/pubmatic-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/pubmatic/refs/heads/main/conformance/pubmatic-conformance.yml
  title: ''
  type: Conformance
  url: conformance/pubmatic-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/pubmatic/refs/heads/main/lifecycle/pubmatic-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/pubmatic-lifecycle.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/pubmatic/refs/heads/main/changelog/pubmatic-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/pubmatic-changelog.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/pubmatic/refs/heads/main/plans/pubmatic-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/pubmatic-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/pubmatic/refs/heads/main/rate-limits/pubmatic-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/pubmatic-rate-limits.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/pubmatic/refs/heads/main/data-model/pubmatic-data-model.yml
  title: ''
  type: DataModel
...
nav: Providers
network: true
overview: 'PubMatic publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Advertising, AdTech, Programmatic Advertising, Supply Side Platform, and Header Bidding.
