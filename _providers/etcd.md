...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/etcd/refs/heads/main/agentic-access/etcd-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/etcd-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/etcd/refs/heads/main/security/etcd-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/etcd-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/etcd/refs/heads/main/authentication/etcd-authentication.yml
  title: ''
  type: Authentication
  url: authentication/etcd-authentication.yml
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/etcd/refs/heads/main/json-schema/etcd-key-value-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/etcd-key-value-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/etcd/refs/heads/main/json-ld/etcd-context.jsonld
  title: ''
  type: JSONLD
...
nav: Providers
network: true
overview: 'Etcd publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Auth API, Cluster API, KV API, and 7 more. Tagged areas include Cloud-Native, Consensus, Distributed Systems, Graduated, and Key-Value Store.
