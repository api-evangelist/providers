...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/memfault/refs/heads/main/agentic-access/memfault-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/memfault-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/memfault/refs/heads/main/security/memfault-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/memfault-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/memfault/refs/heads/main/authentication/memfault-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Memfault publishes 15 APIs on the [APIs.io](https://apis.io/) network, including Auth API, Chunks Ingestion API, Cohorts API, and 12 more. Tagged areas include Alerts, Android, Crash Reporting, Device Management, and Embedded.
