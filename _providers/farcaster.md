...
- baseURL: https://snapchain.farcaster.xyz
  baseurl_source: declared
  description: The On Chain API from Farcaster — 4 operation(s) for on chain.
  name: Farcaster On Chain API
  slug: farcaster-on-chain-api
- baseURL: https://snapchain.farcaster.xyz
  baseurl_source: declared
  description: The User Data API from Farcaster — 4 operation(s) for user data.
  name: Farcaster User Data API
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/farcaster/refs/heads/main/agentic-access/farcaster-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/farcaster-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/farcaster/refs/heads/main/security/farcaster-domain-security.yml
  title: ''
  type: DomainSecurity
