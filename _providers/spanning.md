...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/spanning/refs/heads/main/agentic-access/spanning-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/spanning-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spanning/refs/heads/main/security/spanning-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/spanning-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spanning/refs/heads/main/authentication/spanning-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Spanning publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Exports API, Shared Drives API, Users API, and 1 more. Tagged areas include Data Protection, SaaS Backup, Cloud Backup, Microsoft 365, and Google Workspace.
