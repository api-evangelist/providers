...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://octo.ai'', ''status'': 301, ''note'': ''declared website redirects to https://www.nvidia.com/en-us/#referrer=octoai/ — a different registrable domain (octo.ai -> nvidia.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/octoai/refs/heads/main/security/octoai-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: OctoAI publishes 5 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include Acquired, Defunct, Inference, Generative AI, and LLM.
random_paper: 1
score:
  band: minimal
  composite: 0.0
