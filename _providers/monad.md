...
- collection_type: open
  name: Monad JSON-RPC Monad JSON RPC API API
  slug: open-monad-monad-json-rpc-api-api
- collection_type: open
  name: Monad JSON-RPC API
  slug: open-monad
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/monad/refs/heads/main/agentic-access/monad-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/monad-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/monad/refs/heads/main/security/monad-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Monad publishes 13 APIs on the [APIs.io](https://apis.io/) network, including JSON RPC API, and 12 more. Tagged areas include Blockchain, Layer 1, EVM, High Performance, and Parallel Execution.
