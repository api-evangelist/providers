...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/rss-feed-to-json/refs/heads/main/security/rss-feed-to-json-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/rss-feed-to-json-domain-security.yml
- group: company
  title: ''
  type: Website
...
created: '2026-05-28'
description: Returns RSS feed in JSON format using feed URL
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/rss-feed-to-json.png
layout: provider
modified: '2026-05-28'
name: RSS feed to JSON
nav: Providers
