...
nav: Providers
network: true
overview: 'Agoragentic publishes 3 APIs on the [APIs.io](https://apis.io/) network, including Agent OS and Marketplace Router API, and 2 more. Tagged areas include Agents, Agentic Commerce, Agent Runtime, Marketplace, and A2A.
