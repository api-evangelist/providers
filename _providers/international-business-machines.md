...
- collection_type: open
  name: International Business Machines IBM Cloud Kubernetes Service API
  slug: open-ibm-kubernetes-service
- collection_type: open
  name: International Business Machines IBM Natural Language Understanding API
  slug: open-ibm-natural-language-understanding
- collection_type: open
  name: International Business Machines IBM Speech to Text API
  slug: open-ibm-speech-to-text
- collection_type: open
  name: International Business Machines IBM Text to Speech API
  slug: open-ibm-text-to-speech
- collection_type: open
  name: International Business Machines IBM Cloud VPC API
  slug: open-ibm-vpc
- collection_type: open
  name: International Business Machines IBM watsonx.ai API
  slug: open-ibm-watsonx-ai
- collection_type: open
...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/international-business-machines/refs/heads/main/capabilities/international-business-machines-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/international-business-machines-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/international-business-machines/refs/heads/main/agentic-access/international-business-machines-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/international-business-machines-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/international-business-machines/refs/heads/main/security/international-business-machines-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/international-business-machines-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/international-business-machines/refs/heads/main/security/international-business-machines-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/international-business-machines-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/international-business-machines/refs/heads/main/authentication/international-business-machines-authentication.yml
  title: ''
  type: Authentication
  url: authentication/international-business-machines-authentication.yml
- group: company
  title: ''
  type: LinkedIn
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/international-business-machines.png
json_schemas:
...
nav: Providers
network: true
overview: 'International Business Machines publishes 22 APIs on the [APIs.io](https://apis.io/) network, including Analyze API, Buckets API, Clusters API, and 19 more. Tagged areas include Artificial Intelligence, Cloud, Enterprise, and IBM.
...
- kind: vulnerability-disclosure
  name: International Business Machines Vulnerability Disclosure
  slug: international-business-machines-vulnerability-disclosure
