...
- acting_count: 16
  ...
  summary_line: 50 operations · 16 acting · 2 human-in-the-loop
api_count: 4
apis:
...
nav: Providers
network: true
overview: 'XGuard publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Universal Paid AI Agent + Secretless Gateway API, Reconcile API, and 2 more. Tagged areas include Agents, Agentic Commerce, x402, MCP, and A2A.
