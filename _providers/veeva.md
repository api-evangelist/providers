...
overview: 'veeva publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Authentication API, Documents API, Objects API, and 3 more.
  ...
  veeva''s developer surface includes authentication, developer portal, documentation, getting-started guide, changelog, support, and 12 more developer resources.'
plans:
