...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/unitedhealthcare/refs/heads/main/capabilities/unitedhealthcare-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/unitedhealthcare-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/unitedhealthcare/refs/heads/main/agentic-access/unitedhealthcare-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/unitedhealthcare-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/unitedhealthcare/refs/heads/main/security/unitedhealthcare-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/unitedhealthcare-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/unitedhealthcare/refs/heads/main/authentication/unitedhealthcare-authentication.yml
  title: ''
  type: Authentication
...
overview: 'UnitedHealthcare publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Claims API, Eligibility API, Formulary API, and 4 more. Tagged areas include Health Insurance, Healthcare, FHIR, Claims, and Eligibility.
  ...
  UnitedHealthcare''s developer surface includes authentication and 5 more developer resources.'
plans:
