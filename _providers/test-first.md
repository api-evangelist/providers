...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/test-first/refs/heads/main/security/test-first-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/test-first/refs/heads/main/json-schema/test-first-specification-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/test-first-specification-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/test-first/refs/heads/main/json-schema/test-first-contract-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/test-first-contract-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/test-first/refs/heads/main/json-schema/test-first-mock-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/test-first-mock-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/test-first/refs/heads/main/json-ld/test-first-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/test-first-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/test-first/refs/heads/main/vocabulary/test-first-vocabulary.yml
  title: ''
  type: Vocabulary
