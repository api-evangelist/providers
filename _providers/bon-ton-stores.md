...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bon-ton-stores/refs/heads/main/security/bon-ton-stores-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/bon-ton-stores-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/the-bonton
- group: company
  title: ''
  type: Website
  url: https://www.bonton.com
- group: company
  title: ''
  type: About
  url: https://en.wikipedia.org/wiki/Bon-Ton
- group: other
  title: ''
  type: Properties
  url: ''
created: '2024-01-01'
description: The Bon-Ton Stores was a regional department store chain in the United States that operated stores across the Midwest, Northeast, and upper Great Plains. Founded in 1898 in York, Pennsylvania, the company sold apparel, accessories, cosmetics, home furnishings, and other merchandise under banners including Bon-Ton, Bergner's, Boston Store, Carson's, Elder-Beerman, Herberger's, and Younkers. The company filed for bankruptcy and ceased operations in 2018.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/bon-ton-stores.png
layout: provider
modified: '2026-09-15'
name: Bon-Ton Stores
nav: Providers
...
- kind: domain-security
  name: Bon Ton Stores Domain Security
  slug: bon-ton-stores-domain-security
