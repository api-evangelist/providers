...
- group: auth
  ...
  url: https://brand.ai/security/
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/brandai/refs/heads/main/security/brandai-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/brandai-trust-center.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/brandai/refs/heads/main/lifecycle/brandai-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: operate
  ...
  url: lifecycle/brandai-lifecycle.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/brandai/refs/heads/main/security/brandai-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/brandai-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/brandai/refs/heads/main/llms/brandai-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/brandai-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/brandai/refs/heads/main/mcp/brandai-mcp.yml
  title: ''
  type: MCPServer
  url: mcp/brandai-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/brandai/refs/heads/main/well-known/brandai-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/brandai-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/brandai/refs/heads/main/authentication/brandai-authentication.yml
  title: ''
  type: Authentication
  url: authentication/brandai-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/brandai/refs/heads/main/scopes/brandai-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/brandai-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/brandai/refs/heads/main/conformance/brandai-conformance.yml
  title: ''
  type: Conformance
  url: conformance/brandai-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/brandai/refs/heads/main/errors/brandai-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/brandai-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/brandai/refs/heads/main/conventions/brandai-conventions.yml
  title: ''
  type: Conventions
  url: conventions/brandai-conventions.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/brandai/refs/heads/main/packages/brandai-packages.yml
  title: ''
  type: Packages
  url: packages/brandai-packages.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/brandai/refs/heads/main/plans/brandai-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/brandai-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/brandai/refs/heads/main/rate-limits/brandai-rate-limits.yml
  title: ''
  type: RateLimits
