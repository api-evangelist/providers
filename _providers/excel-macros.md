...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/excel-macros/refs/heads/main/security/excel-macros-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/excel-macros-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/excel-macros/refs/heads/main/security/excel-macros-domain-security.yml
  title: ''
  type: DomainSecurity
...
overview: 'Excel Macros publishes 3 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include Automation, Excel, Macros, Microsoft Office, and VBA.
  ...
  Excel Macros'' developer surface includes documentation, developer portal, and 7 more developer resources.'
plans:
