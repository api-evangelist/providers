...
- baseURL: https://dev.to/api
  baseurl_source: declared
  description: The Reading List API from DEV Community — 2 operation(s) for reading list.
  name: DEV Community Reading List API
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/devto/refs/heads/main/agentic-access/devto-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/devto-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/devto/refs/heads/main/security/devto-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/devto-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/devto/refs/heads/main/security/devto-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/devto-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/devto/refs/heads/main/authentication/devto-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/devto/refs/heads/main/plans/devto-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/devto-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/devto/refs/heads/main/rate-limits/devto-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/devto-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/devto/refs/heads/main/finops/devto-finops.yml
  title: ''
  type: FinOps
