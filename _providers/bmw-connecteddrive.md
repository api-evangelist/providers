...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/bmw-connecteddrive/refs/heads/main/capabilities/bmw-connecteddrive-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/bmw-connecteddrive-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/bmw-connecteddrive/refs/heads/main/agentic-access/bmw-connecteddrive-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/bmw-connecteddrive-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bmw-connecteddrive/refs/heads/main/security/bmw-connecteddrive-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/bmw-connecteddrive-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bmw-connecteddrive/refs/heads/main/authentication/bmw-connecteddrive-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'BMW ConnectedDrive publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Containers API, Vehicles API, and 2 more. Tagged areas include Automotive, Connected Vehicles, Telematics, Vehicle Data, and CarData.
