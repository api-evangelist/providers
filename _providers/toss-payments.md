...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/toss-payments/refs/heads/main/agentic-access/toss-payments-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/toss-payments-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/toss-payments/refs/heads/main/security/toss-payments-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/toss-payments-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/toss-payments/refs/heads/main/authentication/toss-payments-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/toss-payments/refs/heads/main/plans/toss-payments-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/toss-payments-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/toss-payments/refs/heads/main/rate-limits/toss-payments-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/toss-payments-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/toss-payments/refs/heads/main/finops/toss-payments-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Toss Payments publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Billing API, Cash Receipts API, and 6 more. Tagged areas include Payments, Payment Gateway, South Korea, Cards, and Easy Pay.
