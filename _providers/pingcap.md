...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/capabilities/pingcap-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/overlays/pingcap-ossinsight-overlay.yaml
  title: ''
  type: Overlay
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/agentic-access/pingcap-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/pingcap-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/security/pingcap-trust-center.yml
  title: ''
  type: TrustCenter
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/llms/pingcap-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/pingcap-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/well-known/pingcap-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/pingcap-well-known.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/packages/pingcap-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/pingcap-packages.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/cli/pingcap-cli.yml
  title: ''
  type: CLI
  url: cli/pingcap-cli.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/sandbox/pingcap-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/pingcap-sandbox.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/mcp/pingcap-mcp.yml
  title: ''
  type: MCPServer
  url: mcp/pingcap-mcp.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/mcp/pingcap-tool-crosswalk.yml
  title: ''
  type: ToolCrosswalk
  url: mcp/pingcap-tool-crosswalk.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/authentication/pingcap-authentication.yml
  title: ''
  type: Authentication
  url: authentication/pingcap-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/conventions/pingcap-conventions.yml
  title: ''
  type: Conventions
  url: conventions/pingcap-conventions.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/rate-limits/pingcap-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/pingcap-rate-limits.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/errors/pingcap-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/pingcap-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/errors/pingcap-error-codes.yml
  title: ''
  type: ErrorCodes
  url: errors/pingcap-error-codes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/lifecycle/pingcap-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/pingcap-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/conformance/pingcap-conformance.yml
  title: ''
  type: Conformance
  url: conformance/pingcap-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/data-model/pingcap-data-model.yml
  title: ''
  type: DataModel
  url: data-model/pingcap-data-model.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/security/pingcap-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/pingcap-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/security/pingcap-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/pingcap-vulnerability-disclosure.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/pingcap/refs/heads/main/changelog/pingcap-changelog.yml
  title: ''
  type: ChangeLog
...
nav: Providers
network: true
overview: 'PingCAP publishes 45 APIs on the [APIs.io](https://apis.io/) network, including API Key API, Audit Log API, Backup API, and 42 more. Tagged areas include Distributed SQL, Database, tidb, HTAP, and MySQL Compatible.
