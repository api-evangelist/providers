...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-ad-manager/refs/heads/main/agentic-access/google-ad-manager-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-ad-manager-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-ad-manager/refs/heads/main/security/google-ad-manager-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-ad-manager-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-ad-manager/refs/heads/main/security/google-ad-manager-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/google-ad-manager-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-ad-manager/refs/heads/main/authentication/google-ad-manager-authentication.yml
  title: ''
  type: Authentication
  url: authentication/google-ad-manager-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-ad-manager/refs/heads/main/scopes/google-ad-manager-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-ad-manager/refs/heads/main/json-ld/json-ld.yml
  title: ''
  type: JSONLD
...
overview: 'Google Ad Manager publishes 5 APIs on the [APIs.io](https://apis.io/) network, including adUnits API, Companies API, Networks API, and 2 more. Tagged areas include Ad Manager, Ad Operations, Ad Serving, Creatives, and Line Items.
  ...
  Google Ad Manager''s developer surface includes authentication, getting-started guide, pricing, and 8 more developer resources.'
plans:
