...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/buildxact/refs/heads/main/capabilities/buildxact-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/buildxact-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/buildxact/refs/heads/main/agentic-access/buildxact-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/buildxact-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/buildxact/refs/heads/main/security/buildxact-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/buildxact-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/buildxact/refs/heads/main/security/buildxact-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/buildxact-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/buildxact/refs/heads/main/authentication/buildxact-authentication.yml
  title: ''
  type: Authentication
...
overview: 'Buildxact publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Webhooks, Authentication API, Estimate Items API, and 2 more. Tagged areas include Construction, Residential Construction, Construction Management, Estimating, and Takeoffs.
  ...
  Buildxact''s developer surface includes authentication, pricing, engineering blog, GitHub presence, and 20 more developer resources.'
plans:
