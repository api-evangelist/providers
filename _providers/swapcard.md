...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/swapcard/refs/heads/main/security/swapcard-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/swapcard-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/swapcard/refs/heads/main/authentication/swapcard-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/swapcard/refs/heads/main/plans/swapcard-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/swapcard-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/swapcard/refs/heads/main/rate-limits/swapcard-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/swapcard-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/swapcard/refs/heads/main/finops/swapcard-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Swapcard publishes 3 APIs on the [APIs.io](https://apis.io/) network, including Content API, Exhibitor Leads API, and 1 more. Tagged areas include Event, Event Management, Community, Networking, and Event Platform.
