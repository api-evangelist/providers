...
common:
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/scalable-infrastructure/refs/heads/main/rate-limits/scalable-infrastructure-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/scalable-infrastructure-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/scalable-infrastructure/refs/heads/main/plans/scalable-infrastructure-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/scalable-infrastructure-plans-pricing.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/scalable-infrastructure/refs/heads/main/capabilities/scalable-infrastructure-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/scalable-infrastructure-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/scalable-infrastructure/refs/heads/main/agentic-access/scalable-infrastructure-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/scalable-infrastructure-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/scalable-infrastructure/refs/heads/main/authentication/scalable-infrastructure-authentication.yml
  title: ''
  type: Authentication
...
overview: 'Scalable Infrastructure publishes 1 API on the [APIs.io](https://apis.io/) network: EC2 API. Tagged areas include Cloud Infrastructure, Compute, DevOps, Infrastructure as Code, and Kubernetes.
  ...
  Scalable Infrastructure''s developer surface includes authentication, engineering blog, and 10 more developer resources.'
plans:
- name: Scalable Infrastructure Plans Pricing
  plan_count: 11
  slug: scalable-infrastructure-plans-pricing
- name: Scalable Infrastructure Price Estimates
  plan_count: 0
  slug: scalable-infrastructure-price-estimates
random_paper: 7
rate_limits:
- limit_count: 10
