...
- group: commercial
  title: ''
  type: License
  url: https://github.com/spruceid/siwe/blob/main/LICENSE
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/spruceid/refs/heads/main/agentic-access/spruceid-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/spruceid-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spruceid/refs/heads/main/security/spruceid-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'SpruceID publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Credentials API, Health API, Identifiers API, and 7 more. Tagged areas include Decentralized Identity, Verifiable Credentials, DIDs, Sign-In with Ethereum, and Identity Wallet.
