...
nav: Providers
network: true
overview: 'Coin Railz publishes 2 APIs on the [APIs.io](https://apis.io/) network: Agent Payment API and x402 Micropayment Services. Tagged areas include Company, Payments, Agents, x402, and Micropayments.
