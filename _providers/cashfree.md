...
- acting_count: 20
  ...
  summary_line: 40 operations · 20 acting · 1 human-in-the-loop
api_count: 3
apis:
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cashfree/refs/heads/main/agentic-access/cashfree-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/cashfree-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cashfree/refs/heads/main/security/cashfree-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/cashfree-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cashfree/refs/heads/main/authentication/cashfree-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/cashfree/refs/heads/main/plans/cashfree-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/cashfree-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/cashfree/refs/heads/main/rate-limits/cashfree-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/cashfree-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/cashfree/refs/heads/main/finops/cashfree-finops.yml
  title: ''
  type: FinOps
  url: finops/cashfree-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cashfree/refs/heads/main/vocabulary/cashfree-vocabulary.json
  title: ''
  type: Vocabulary
  url: vocabulary/cashfree-vocabulary.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/cashfree/refs/heads/main/json-schema/cashfree-payment-gateway-schemas.json
  title: ''
  type: JSONSchema
  url: json-schema/cashfree-payment-gateway-schemas.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/cashfree/refs/heads/main/json-schema/cashfree-payouts-schemas.json
  title: ''
  type: JSONSchema
  url: json-schema/cashfree-payouts-schemas.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/cashfree/refs/heads/main/json-schema/cashfree-verification-schemas.json
  title: ''
  type: JSONSchema
  url: json-schema/cashfree-verification-schemas.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cashfree/refs/heads/main/json-ld/cashfree-provider.jsonld
  title: ''
  type: JSONLD
...
nav: Providers
network: true
overview: 'Cashfree Payments publishes 23 APIs on the [APIs.io](https://apis.io/) network, including Authorize API, Beneficiary v2 API, CreateCashgram API, and 20 more. Tagged areas include Payments, Payouts, UPI, India, and Payment Gateway.
