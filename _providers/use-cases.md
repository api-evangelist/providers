...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/use-cases/refs/heads/main/json-ld/use-cases-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/use-cases-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/use-cases/refs/heads/main/vocabulary/use-cases-vocabulary.yml
  title: ''
  type: Vocabulary
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/use-cases.png
jsonld:
- class_count: 48
  name: Use Cases Context
  property_count: 2
  slug: use-cases-context
layout: provider
modified: '2026-05-03'
name: Use Cases
nav: Providers
network: true
overview: 'Use Cases is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include API Design, Application, Best Practices, Example, and Implementation.
