...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://lunapark.com'', ''status'': 301, ''note'': ''declared website redirects to https://meetquinn.ai/ — a different registrable domain (lunapark.com -> meetquinn.ai), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/luna-park/refs/heads/main/security/luna-park-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: Luna Park is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Consumer, GV, Portfolio, and Artificial Intelligence.
random_paper: 5
score:
  band: minimal
  composite: 5.0
