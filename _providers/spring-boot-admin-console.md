...
- collection_type: open
  name: Spring Boot Admin Server Applications API
  slug: open-spring-boot-admin-console-applications-api
- collection_type: open
  name: Spring Boot Admin Server Applications Events API
  slug: open-spring-boot-admin-console-events-api
- collection_type: open
  name: Spring Boot Admin Server Applications Instances API
  slug: open-spring-boot-admin-console-instances-api
- collection_type: open
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/spring-boot-admin-console/refs/heads/main/agentic-access/spring-boot-admin-console-agentic-access.yml
  title: ''
  type: AgenticAccess
...
nav: Providers
network: true
overview: 'Spring Boot Admin Console publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Applications API, Events API, Instances API, and 4 more. Tagged areas include Actuators, Administration, Java, Microservices, and Monitoring.
