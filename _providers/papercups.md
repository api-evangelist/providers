...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/papercups/refs/heads/main/agentic-access/papercups-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/papercups-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/papercups/refs/heads/main/security/papercups-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/papercups-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/papercups/refs/heads/main/authentication/papercups-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/papercups/refs/heads/main/plans/papercups-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/papercups-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/papercups/refs/heads/main/rate-limits/papercups-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/papercups-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/papercups/refs/heads/main/finops/papercups-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Papercups publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Realtime Chat API (WebSocket / Phoenix Channels), Conversations API, Customers API, and 4 more. Tagged areas include Customer Messaging, Live Chat, Open Source, Support, and Intercom Alternative.
