...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/tikv/refs/heads/main/agentic-access/tikv-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/tikv-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tikv/refs/heads/main/security/tikv-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'TiKV publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Configuration API, Debug API, Metrics API, and 5 more. Tagged areas include ACID, CNCF, Database, Distributed Systems, and Key-Value Store.
