...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/eod-historical/refs/heads/main/agentic-access/eod-historical-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/eod-historical-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/eod-historical/refs/heads/main/security/eod-historical-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/eod-historical-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/eod-historical/refs/heads/main/authentication/eod-historical-authentication.yml
  title: ''
  type: Authentication
  url: authentication/eod-historical-authentication.yml
- group: start
  title: ''
  type: Portal
  url: https://eodhd.com/
...
- group: operate
  title: ''
  type: Support
  url: https://eodhd.com/support/
- group: commercial
  title: ''
  type: TermsOfService
  url: https://eodhd.com/financial-apis/terms-and-conditions/
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://eodhd.com/financial-apis/privacy-policy/
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/eod-historical/refs/heads/main/plans/eod-historical-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/eod-historical-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/eod-historical/refs/heads/main/rate-limits/eod-historical-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/eod-historical-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/eod-historical/refs/heads/main/finops/eod-historical-finops.yml
  title: ''
  type: FinOps
  url: finops/eod-historical-finops.yml
created: '2026-06-13'
description: EOD Historical Data (EODHD) provides institutional-grade financial data through a REST API at https://eodhd.com/api covering 150,000+ tickers across 60+ global exchanges. The API spans end-of-day historical prices (30+ years), real-time OHLCV, intraday bars, fundamentals (income statements, balance sheets, cash flows), ETF and mutual fund data, options chains with Greeks, dividends, splits, corporate actions, technical indicators, financial news with sentiment, insider transactions, macroeconomic indicators, ESG data, and WebSocket streaming. Authentication is via api_token query parameter; output is JSON, CSV, or XML.
examples:
- key_count: 11
  name: Real Time Response
  slug: real-time-response
finops:
- name: Eod Historical Finops
  service_category: Fintech
  slug: eod-historical-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/eod-historical.png
json_schemas:
- name: EOD Price
  property_count: 7
  slug: eod-price
- name: Insider Transaction
  property_count: 15
  slug: insider-transaction
- name: Options Contract
  property_count: 22
  slug: options-contract
- name: Search Result
  property_count: 9
  slug: search-result
jsonld:
- class_count: 0
  name: Eod Historical Context
  property_count: 0
  slug: eod-historical
layout: provider
modified: '2026-06-13'
