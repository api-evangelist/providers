...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-transfer-service/refs/heads/main/agentic-access/google-cloud-transfer-service-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-cloud-transfer-service-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-transfer-service/refs/heads/main/security/google-cloud-transfer-service-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-cloud-transfer-service-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-transfer-service/refs/heads/main/security/google-cloud-transfer-service-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/google-cloud-transfer-service-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-transfer-service/refs/heads/main/authentication/google-cloud-transfer-service-authentication.yml
  title: ''
  type: Authentication
  url: authentication/google-cloud-transfer-service-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-transfer-service/refs/heads/main/scopes/google-cloud-transfer-service-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-transfer-service/refs/heads/main/json-ld/google-cloud-transfer-service-context.jsonld
  title: ''
  type: JSONLD
...
overview: 'Google Cloud Transfer Service publishes 3 APIs on the [APIs.io](https://apis.io/) network: AgentPools API, TransferJobs API, and TransferOperations API. Tagged areas include Azure, Cloud Storage, Data Transfer, Migration, and S3.
  ...
  Google Cloud Transfer Service''s developer surface includes authentication, getting-started guide, pricing, engineering blog, and 7 more developer resources.'
plans:
