...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/virustotal/refs/heads/main/capabilities/virustotal-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/virustotal-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/virustotal/refs/heads/main/agentic-access/virustotal-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/virustotal-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/virustotal/refs/heads/main/security/virustotal-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/virustotal-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/virustotal/refs/heads/main/authentication/virustotal-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/virustotal/refs/heads/main/plans/virustotal-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/virustotal-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/virustotal/refs/heads/main/rate-limits/virustotal-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/virustotal-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/virustotal/refs/heads/main/finops/virustotal-finops.yml
  title: ''
  type: FinOps
  url: finops/virustotal-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/virustotal/refs/heads/main/rules/virustotal-rules.yml
  title: ''
  type: SpectralRuleset
  url: rules/virustotal-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/virustotal/refs/heads/main/vocabulary/virustotal-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/virustotal-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/virustotal/refs/heads/main/json-ld/virustotal-context.jsonld
  title: ''
  type: JSONLDContext
...
nav: Providers
network: true
overview: 'VirusTotal publishes 35 APIs on the [APIs.io](https://apis.io/) network, including Access Control - Group Management API, Access Control - Quota Management API, Access Control - Service Account Management API, and 32 more. Tagged areas include Anti Malware, Threat Intelligence, Security, File Analysis, and URL Analysis.
