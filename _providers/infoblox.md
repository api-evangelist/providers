...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/infoblox/refs/heads/main/capabilities/infoblox-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/infoblox/refs/heads/main/agentic-access/infoblox-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/infoblox-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/infoblox/refs/heads/main/security/infoblox-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/infoblox-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/infoblox/refs/heads/main/security/infoblox-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/infoblox-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/infoblox/refs/heads/main/authentication/infoblox-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Infoblox publishes 21 APIs on the [APIs.io](https://apis.io/) network, including DHCP API, DNS Records API, DNS Zones API, and 18 more. Tagged areas include Cloud, DDI, DHCP, DNS, and IPAM.
