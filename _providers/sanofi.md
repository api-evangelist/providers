...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sanofi/refs/heads/main/security/sanofi-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sanofi/refs/heads/main/vocabulary/sanofi-vocabulary.yml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: Sanofi is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Pharmaceuticals, Healthcare, Vaccines, and Biotechnology.
random_paper: 2
score:
  band: minimal
  composite: 5.8
