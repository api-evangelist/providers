...
nav: Providers
network: true
overview: 'systemd publishes 34 APIs on the [APIs.io](https://apis.io/) network, including Boot API, Cache API, Cgroups API, and 31 more. Tagged areas include Boot, Cgroups, Containers, D-Bus, and Init.
