...
- acting_count: 73
  ...
  summary_line: 100 operations · 73 acting · 10 human-in-the-loop
api_count: 7
apis:
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/systemd/refs/heads/main/agentic-access/systemd-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/systemd-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/systemd/refs/heads/main/security/systemd-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/systemd/refs/heads/main/vocabulary/systemd-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/systemd-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/systemd/refs/heads/main/json-ld/systemd-context.jsonld
  title: ''
  type: JSONLD
...
nav: Providers
network: true
overview: 'systemd publishes 25 APIs on the [APIs.io](https://apis.io/) network, including Boot API, Cache API, Cgroups API, and 22 more. Tagged areas include Boot, Cgroups, Containers, D-Bus, and Init.
