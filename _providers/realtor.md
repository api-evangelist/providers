...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/realtor/refs/heads/main/agentic-access/realtor-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/realtor-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/realtor/refs/heads/main/security/realtor-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/realtor-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/realtor/refs/heads/main/authentication/realtor-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/realtor/refs/heads/main/json-ld/realtor-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/realtor-context.jsonld
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/realtor/refs/heads/main/json-schema/realtor-lead-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/realtor-lead-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/realtor/refs/heads/main/json-schema/realtor-property-schema.json
  title: ''
  type: JSONSchema
...
overview: 'Realtor publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Realtor.com Connections Plus API, Realtor.com Lead Delivery API, Agents API, and 3 more. Tagged areas include Agents, Real-Estate, Brokers, CRM, and Delivery.
  ...
  Realtor''s developer surface includes authentication, engineering blog, and 7 more developer resources.'
plans:
