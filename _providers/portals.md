...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/portals/refs/heads/main/security/portals-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: Portals is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Consumer, Play, Collect, and Creators.
random_paper: 3
score:
  band: minimal
  composite: 5.0
