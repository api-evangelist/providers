...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/appmixer/refs/heads/main/agentic-access/appmixer-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/appmixer-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/appmixer/refs/heads/main/security/appmixer-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/appmixer-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/appmixer/refs/heads/main/authentication/appmixer-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/appmixer/refs/heads/main/arazzo/appmixer-authenticate-and-list-flows-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/appmixer-authenticate-and-list-flows-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/appmixer/refs/heads/main/arazzo/appmixer-clone-flow-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/appmixer-clone-flow-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/appmixer/refs/heads/main/arazzo/appmixer-create-and-start-flow-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/appmixer-create-and-start-flow-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/appmixer/refs/heads/main/arazzo/appmixer-disconnect-invalid-account-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/appmixer-disconnect-invalid-account-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/appmixer/refs/heads/main/arazzo/appmixer-onboard-user-and-create-flow-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/appmixer-onboard-user-and-create-flow-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/appmixer/refs/heads/main/arazzo/appmixer-reprocess-unprocessed-message-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/appmixer-reprocess-unprocessed-message-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/appmixer/refs/heads/main/arazzo/appmixer-restart-flow-and-inspect-logs-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/appmixer-restart-flow-and-inspect-logs-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/appmixer/refs/heads/main/arazzo/appmixer-stop-and-delete-flow-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/appmixer-stop-and-delete-flow-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/appmixer/refs/heads/main/arazzo/appmixer-update-running-flow-workflow.yml
  title: ''
  type: Arazzo
