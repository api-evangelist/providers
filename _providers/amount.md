...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://amount.com'', ''status'': 301, ''note'': ''declared website redirects to https://www.fisglobal.com/products/fis-origination-suite — a different registrable domain (amount.com -> fisglobal.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/amount/refs/heads/main/security/amount-domain-security.yml
  title: ''
  type: DomainSecurity
