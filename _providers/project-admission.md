...
- group: operate
  ...
  url: https://help.pa.exchange/
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/project-admission/refs/heads/main/security/project-admission-vulnerability-disclosure.yml
  title: ''
  type: Security
...
- group: auth
  ...
  url: security/project-admission-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/project-admission/refs/heads/main/security/project-admission-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/project-admission-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/project-admission/refs/heads/main/well-known/project-admission-security.txt
  title: ''
  type: SecurityTxt
  url: well-known/project-admission-security.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/project-admission/refs/heads/main/well-known/project-admission-well-known.yml
  title: ''
  type: WellKnown
