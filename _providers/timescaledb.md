...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/timescaledb/refs/heads/main/agentic-access/timescaledb-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/timescaledb-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/timescaledb/refs/heads/main/security/timescaledb-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/timescaledb-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/timescaledb/refs/heads/main/security/timescaledb-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/timescaledb-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/timescaledb/refs/heads/main/security/timescaledb-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/timescaledb/refs/heads/main/plans/timescaledb-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/timescaledb-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/timescaledb/refs/heads/main/rate-limits/timescaledb-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/timescaledb-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/timescaledb/refs/heads/main/finops/timescaledb-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'TimescaleDB / Tiger Data publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Analytics API, Auth API, Read Replica Sets API, and 3 more. Tagged areas include Database, Time Series, PostgreSQL, Open Source, and Cloud.
