...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/ease/refs/heads/main/overlays/ease-content-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/ease-content-overlay.yaml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/ease/refs/heads/main/overlays/ease-status-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/ease-status-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ease/refs/heads/main/mcp/ease-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/ease-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ease/refs/heads/main/agentic-access/ease-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/ease-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ease/refs/heads/main/authentication/ease-authentication.yml
  title: ''
  type: Authentication
  url: authentication/ease-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ease/refs/heads/main/security/ease-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/ease-domain-security.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ease/refs/heads/main/conventions/ease-conventions.yml
  title: ''
  type: Conventions
  url: conventions/ease-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ease/refs/heads/main/errors/ease-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/ease-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ease/refs/heads/main/lifecycle/ease-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ease/refs/heads/main/conformance/ease-conformance.yml
  title: ''
  type: Conformance
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ease/refs/heads/main/security/ease-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/ease-trust-center.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ease/refs/heads/main/data-model/ease-data-model.yml
  title: ''
  type: DataModel
  url: data-model/ease-data-model.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ease/refs/heads/main/well-known/ease-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/ease-well-known.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ease/refs/heads/main/asyncapi/ease-status-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/ease-status-webhooks.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ease/refs/heads/main/llms/ease-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/ease-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ease/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/ease/refs/heads/main/examples/ease-partners.json
  title: ''
  type: Examples
