...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://buddymedia.com/'', ''status'': 301, ''note'': ''declared website redirects to https://www.salesforce.com/marketing/?mc=buddymedia&bc=DB — a different registrable domain (buddymedia.com -> salesforce.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/buddy-media/refs/heads/main/security/buddy-media-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/buddy-media-domain-security.yml
- group: company
  title: ''
  type: Website
  url: https://buddymedia.com/
created: '2026-07-17'
...
- kind: domain-security
  name: Buddy Media Domain Security
  slug: buddy-media-domain-security
