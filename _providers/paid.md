...
- baseURL: https://api.agentpaid.io/api/v2
  ...
  name: Paid Analytics Experimental API
...
- baseURL: https://api.agentpaid.io/api/v2
  ...
  name: Paid Custom Views Experimental API
...
- group: docs
  title: ''
  type: APIReference
  url: https://docs.paid.ai/api-reference/api-reference
- group: start
  title: ''
  type: GettingStarted
  url: https://docs.paid.ai/documentation/getting-started/quickstart
- group: start
  title: ''
  type: SignUp
  url: https://app.paid.ai
- group: commercial
  title: ''
  type: Pricing
...
- group: company
  title: ''
  type: Blog
  url: https://paid.ai/blog
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/paid-ai
- group: commercial
  title: ''
  type: TermsOfService
...
created: '2026-07-17'
description: Paid (paid.ai) is the monetization platform for AI agents. It gives teams that build and sell AI agents the pricing, billing, and margin infrastructure to charge with flexible models — credits, usage-based, seat-based, and outcome-based pricing — while tracking the AI costs and delivered value behind every customer. Paid exposes a REST API (v1 and v2 on api.agentpaid.io), first-party SDKs for Node, Python, Go, and Java, a CLI, embeddable UI components, billing webhooks, an agent skill, and a hosted MCP server. Backed by EQT Ventures, Lightspeed Venture Partners, Seedcamp, and Techstars.
...
nav: Providers
network: true
overview: 'Paid publishes 22 APIs on the [APIs.io](https://apis.io/) network, including Agents API, Analytics Experimental API, Checkouts API, and 19 more. Tagged areas include Company, Artificial Intelligence, Billing, Monetization, and Payments.
