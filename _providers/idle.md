...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/idle/refs/heads/main/agentic-access/idle-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/idle-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/idle/refs/heads/main/security/idle-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/idle-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/idle/refs/heads/main/authentication/idle-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Idle Finance publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Pools API, Rates API, TVL API, and 2 more. Tagged areas include DeFi, Yield Optimization, Finance, Crypto, and Staking.
