...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/push-doctor/refs/heads/main/security/push-doctor-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Push Doctor is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Healthcare, Telehealth, Online GP, and Digital Health.
