...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/software-development-lifecycle/refs/heads/main/security/software-development-lifecycle-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/software-development-lifecycle-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/software-development-lifecycle/refs/heads/main/security/software-development-lifecycle-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Software Development Lifecycle publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Code and Review APIs, and 6 more. Tagged areas include Development Process, Project Management, Quality Assurance, Software Engineering, and DevOps.
