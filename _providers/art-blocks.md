...
- description: ''
  name: Art Blocks MCP Server
  slug: art-blocks-mcp-server
modified: '2026-06-13'
name: Art Blocks
nav: Providers
network: true
overview: 'Art Blocks publishes 2 APIs on the [APIs.io](https://apis.io/) network: Generator API and Media API. Tagged areas include Generative Art, NFT, On-Chain Art, Blockchain, and Ethereum.
