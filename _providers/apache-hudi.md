...
- group: operate
  title: ''
  type: Releases
  url: https://github.com/apache/hudi/releases
- group: build
  title: ''
  type: CodeOfConduct
...
- group: commercial
  title: ''
  type: License
  url: https://github.com/apache/hudi/blob/master/LICENSE
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/apache-hudi/refs/heads/main/agentic-access/apache-hudi-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/apache-hudi-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apache-hudi/refs/heads/main/security/apache-hudi-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/apache-hudi-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apache-hudi/refs/heads/main/security/apache-hudi-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/apache-hudi/refs/heads/main/rules/apache-hudi-spectral-rules.yml
  title: ''
  type: SpectralRules
  url: rules/apache-hudi-spectral-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/apache-hudi/refs/heads/main/vocabulary/apache-hudi-vocabulary.yaml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'Apache Hudi publishes 3 APIs on the [APIs.io](https://apis.io/) network, including Tables API, Timeline API, and 1 more. Tagged areas include ACID, Apache, Big Data, Data Lake, and Incremental Processing.


  The Apache Hudi catalog on APIs.io includes 1 JSON-LD context and 2 Spectral governance rulesets.


  Apache Hudi''s developer surface includes documentation, getting-started guide, engineering blog, and 13 more developer resources.'
plans:
