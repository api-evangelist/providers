...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/mercado-pago/refs/heads/main/agentic-access/mercado-pago-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/mercado-pago-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mercado-pago/refs/heads/main/security/mercado-pago-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/mercado-pago-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mercado-pago/refs/heads/main/authentication/mercado-pago-authentication.yml
  title: ''
  type: Authentication
  url: authentication/mercado-pago-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mercado-pago/refs/heads/main/scopes/mercado-pago-scopes.yml
  title: ''
  type: OAuthScopes
...
nav: Providers
network: true
overview: 'Mercado Pago publishes 44 APIs on the [APIs.io](https://apis.io/) network, including Webhooks / Notifications, Authentication API, Cards API, and 41 more. Tagged areas include Payments, Checkout, Subscription, Point-of-Sale, and QR.
