...
- group: operate
  title: ''
  type: Releases
  url: https://github.com/vendurehq/vendure/releases
- group: auth
  title: ''
  type: SecurityPolicy
  url: https://github.com/vendurehq/vendure/blob/master/SECURITY.md
- group: build
  title: ''
  type: CodeOfConduct
  url: https://github.com/vendurehq/vendure/blob/master/.github/CODE_OF_CONDUCT.md
- group: docs
  title: ''
  type: ContributionGuide
  url: https://github.com/vendurehq/vendure/blob/master/CONTRIBUTING.md
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/vendure/refs/heads/main/agentic-access/vendure-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/vendure-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/vendure/refs/heads/main/security/vendure-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/vendure-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/vendure/refs/heads/main/authentication/vendure-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/vendure/refs/heads/main/plans/vendure-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/vendure-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/vendure/refs/heads/main/rate-limits/vendure-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/vendure-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/vendure/refs/heads/main/finops/vendure-finops.yml
  title: ''
  type: FinOps
  url: finops/vendure-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/vendure/refs/heads/main/json-ld/vendure-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/vendure-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/vendure/refs/heads/main/vocabulary/vendure-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/vendure-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/vendure/refs/heads/main/rules/vendure-rules.yml
  title: ''
  type: Rules
...
overview: 'Vendure publishes 3 APIs on the [APIs.io](https://apis.io/) network: Assets API, Vendure Admin API API, and Vendure Shop API API. Tagged areas include Commerce, Headless Commerce, E-Commerce, GraphQL, and Open-Source.
  ...
  Vendure''s developer surface includes authentication, documentation, GitHub presence, pricing, engineering blog, and 22 more developer resources.'
plans:
