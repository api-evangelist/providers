...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/expensify/refs/heads/main/agentic-access/expensify-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/expensify-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/expensify/refs/heads/main/security/expensify-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Expensify publishes 2 APIs on the [APIs.io](https://apis.io/) network, including Integrations API, and 1 more. Tagged areas include Expense Management, Expense Reporting, Receipt Scanning, Corporate Cards, and Bill Pay.
