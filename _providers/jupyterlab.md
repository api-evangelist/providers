...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/jupyterlab/refs/heads/main/agentic-access/jupyterlab-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/jupyterlab-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jupyterlab/refs/heads/main/security/jupyterlab-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/jupyterlab-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jupyterlab/refs/heads/main/security/jupyterlab-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/jupyterlab-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jupyterlab/refs/heads/main/authentication/jupyterlab-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'JupyterLab publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Licenses API, Listings API, Settings API, and 3 more. Tagged areas include Data Science, Developer Tools, Extensions, IDE, and Interactive Computing.
