...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://appneta.com'', ''status'': 301, ''note'': ''declared website redirects to https://www.broadcom.com/products/software/network-management/appneta — a different registrable domain (appneta.com -> broadcom.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
- group: company
  title: ''
  type: Website
  url: https://appneta.com
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/tracelytics
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/tracelytics/refs/heads/main/packages/tracelytics-packages.yml
  title: ''
  type: Packages
  url: packages/tracelytics-packages.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/tracelytics/refs/heads/main/packages/tracelytics-packages.yml
  title: ''
  type: SDKs
  url: packages/tracelytics-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/tracelytics/refs/heads/main/llms/tracelytics-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/tracelytics-llms.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tracelytics/refs/heads/main/security/tracelytics-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/tracelytics-domain-security.yml
created: '2026-07-17'
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/tracelytics/refs/heads/main/screenshots/tracelytics-2026-09-02T164028.png
security:
