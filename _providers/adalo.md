...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/adalo/refs/heads/main/security/adalo-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Adalo publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include No-Code, App Builder, Mobile Development, Web App Development, and Low-Code.
