...
- collection_type: open
  name: Dialogflow ES Projects API
  slug: open-google-dialogflow-projects-api
- collection_type: open
...
overview: 'Google Dialogflow publishes 1 API on the [APIs.io](https://apis.io/) network: Projects API. Tagged areas include Artificial Intelligence, Chatbots, Conversational AI, Machine-Learning, and Natural Language Processing.
  ...
  Google Dialogflow''s developer surface includes authentication, developer portal, documentation, engineering blog, support, and 10 more developer resources.'
plans:
