...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/evolutionaryscale/refs/heads/main/agentic-access/evolutionaryscale-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/evolutionaryscale-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/evolutionaryscale/refs/heads/main/security/evolutionaryscale-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/evolutionaryscale-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/evolutionaryscale/refs/heads/main/authentication/evolutionaryscale-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'EvolutionaryScale publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Embeddings API, Encoding API, Generation API, and 4 more. Tagged areas include Artificial Intelligence, Biology, Bioinformatics, Computational Biology, and Drug Discovery.


  The EvolutionaryScale catalog on APIs.io includes 1 JSON-LD context and 2 Spectral governance rulesets.


  EvolutionaryScale''s developer surface includes authentication and 5 more developer resources.'
plans:
