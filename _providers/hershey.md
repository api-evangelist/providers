...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://www.hershey.com'', ''status'': 301, ''note'': ''declared website redirects to https://www.hersheyland.com/ — a different registrable domain (hershey.com -> hersheyland.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
nav: Providers
network: true
overview: Hershey is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Fortune 500.
press:
- date: '2026-05-25'
