...
created: '2026-05-28'
description: AI/ML engineering job aggregator with REST, RSS, and MCP endpoints
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/ai-dev-jobs.png
layout: provider
modified: '2026-05-28'
name: AI Dev Jobs
nav: Providers
...
overview: 'AI Dev Jobs publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Jobs and Public APIs.
  ...
  AI Dev Jobs'' developer surface includes engineering blog and 4 more developer resources.'
random_paper: 21
score:
  band: minimal
  composite: 7.2
