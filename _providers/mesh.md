...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/mesh/refs/heads/main/overlays/mesh-integration-api-overlay.yaml
  title: ''
  type: Overlay
...
- group: auth
  ...
  url: https://www.meshpay.com/security
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mesh/refs/heads/main/authentication/mesh-authentication.yml
  title: ''
  type: Authentication
  url: authentication/mesh-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mesh/refs/heads/main/conventions/mesh-conventions.yml
  title: ''
  type: Conventions
  url: conventions/mesh-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mesh/refs/heads/main/errors/mesh-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/mesh-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mesh/refs/heads/main/lifecycle/mesh-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/mesh-lifecycle.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/mesh/refs/heads/main/changelog/mesh-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/mesh-changelog.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mesh/refs/heads/main/conformance/mesh-conformance.yml
  title: ''
  type: Conformance
  url: conformance/mesh-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mesh/refs/heads/main/data-model/mesh-data-model.yml
  title: ''
  type: DataModel
  url: data-model/mesh-data-model.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/mesh/refs/heads/main/sandbox/mesh-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/mesh-sandbox.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mesh/refs/heads/main/asyncapi/mesh-transfers-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/mesh-transfers-webhooks.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/mesh/refs/heads/main/mcp/mesh-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/mesh-mcp.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/mesh/refs/heads/main/packages/mesh-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/mesh-packages.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mesh/refs/heads/main/components/mesh-components.yml
  title: ''
  type: Components
  url: components/mesh-components.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/mesh/refs/heads/main/llms/mesh-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/mesh-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/mesh/refs/heads/main/well-known/mesh-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/mesh-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mesh/refs/heads/main/security/mesh-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/mesh-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/mesh/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
