...
access_model:
  ...
  - plans
  - authentication
  - '{''url'': ''https://www.trelica.com'', ''status'': 301, ''note'': ''declared website redirects to https://1password.com/product/saas-manager — a different registrable domain (trelica.com -> 1password.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: true
agent_readiness:
  band: agent-aware
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/trelica/refs/heads/main/agentic-access/trelica-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/trelica-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/trelica/refs/heads/main/security/trelica-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/trelica-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/trelica/refs/heads/main/authentication/trelica-authentication.yml
  title: ''
  type: Authentication
  url: authentication/trelica-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/trelica/refs/heads/main/scopes/trelica-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/trelica/refs/heads/main/json-schema/trelica-application-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/trelica-application-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/trelica/refs/heads/main/json-schema/trelica-person-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/trelica-person-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/trelica/refs/heads/main/json-schema/trelica-contract-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/trelica-contract-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/trelica/refs/heads/main/json-structure/trelica-application-structure.json
  title: ''
  type: JSONStructure
  url: json-structure/trelica-application-structure.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/trelica/refs/heads/main/json-ld/trelica-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/trelica-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/trelica/refs/heads/main/rules/trelica-spectral-rules.yml
  title: ''
  type: SpectralRules
  url: rules/trelica-spectral-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/trelica/refs/heads/main/vocabulary/trelica-vocabulary.yml
  title: ''
  type: Vocabulary
