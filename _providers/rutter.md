...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/rutter/refs/heads/main/agentic-access/rutter-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/rutter-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/rutter/refs/heads/main/security/rutter-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/rutter-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/rutter/refs/heads/main/authentication/rutter-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Rutter publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Accounting API, Ads API, Banking API, and 6 more. Tagged areas include Accounting, B2B, Commerce, Financial Data, and Payments.
