...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/knote/refs/heads/main/security/knote-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: Knote is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Startups, Knowledge-Management, Notes, and Productivity.
random_paper: 17
score:
  band: minimal
  composite: 5.0
