...
- collection_type: open
  name: Buzzsprout Episodes API
  slug: open-buzzsprout-episodes-api
- collection_type: open
  name: Buzzsprout Episodes Podcasts API
  slug: open-buzzsprout-podcasts-api
- collection_type: open
  name: Buzzsprout API
  slug: open-buzzsprout
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/buzzsprout/refs/heads/main/agentic-access/buzzsprout-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/buzzsprout-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/buzzsprout/refs/heads/main/security/buzzsprout-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/buzzsprout-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/buzzsprout/refs/heads/main/authentication/buzzsprout-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/buzzsprout/refs/heads/main/plans/buzzsprout-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/buzzsprout-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/buzzsprout/refs/heads/main/rate-limits/buzzsprout-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/buzzsprout-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/buzzsprout/refs/heads/main/finops/buzzsprout-finops.yml
  title: ''
  type: FinOps
