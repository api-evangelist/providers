...
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/be-aerospace
- group: docs
  title: ''
  type: Documentation
...
- group: build
  ...
  url: https://github.com/CollinsAerospace
created: '2024-01-01'
description: B/E Aerospace was a manufacturer of aircraft cabin interior products and a provider of aerospace services for commercial aircraft and business jets. The company was acquired by Rockwell Collins in 2017 and subsequently merged into Collins Aerospace (a Raytheon Technologies subsidiary) in 2020. B/E Aerospace products included seating, food and beverage preparation equipment, lighting systems, and oxygen systems for commercial and business aviation.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/b-e-aerospace.png
layout: provider
modified: '2026-04-19'
name: B/E Aerospace
nav: Providers
network: true
overview: 'B/E Aerospace is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Aerospace, Aircraft Cabin Interiors, Aviation, Business Jets, and Collins Aerospace.


  B/E Aerospace''s developer surface includes documentation and 2 more developer resources.'
press:
- date: '2026-05-25'
