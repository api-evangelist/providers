...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/firebolt/refs/heads/main/agentic-access/firebolt-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/firebolt-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/firebolt/refs/heads/main/security/firebolt-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/firebolt-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/firebolt/refs/heads/main/security/firebolt-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/firebolt-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/firebolt/refs/heads/main/security/firebolt-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/firebolt-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/firebolt/refs/heads/main/authentication/firebolt-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/firebolt/refs/heads/main/plans/firebolt-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/firebolt-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/firebolt/refs/heads/main/rate-limits/firebolt-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/firebolt-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/firebolt/refs/heads/main/finops/firebolt-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Firebolt publishes 5 APIs on the [APIs.io](https://apis.io/) network, including REST API, Query API, Web API, and 2 more. Tagged areas include Data Warehouse, Cloud, SQL, and Analytics.
