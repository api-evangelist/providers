...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/stack-overflow/refs/heads/main/vendor-facets/stack-overflow-vendor-facets.yml
  title: ''
  type: VendorFacets
  url: vendor-facets/stack-overflow-vendor-facets.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/stack-overflow/refs/heads/main/agentic-access/stack-overflow-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/stack-overflow-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/stack-overflow/refs/heads/main/security/stack-overflow-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/stack-overflow-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/stack-overflow/refs/heads/main/authentication/stack-overflow-authentication.yml
  title: ''
  type: Authentication
  url: authentication/stack-overflow-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/stack-overflow/refs/heads/main/scopes/stack-overflow-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/stack-overflow/refs/heads/main/json-ld/stack-overflow-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/stack-overflow-context.jsonld
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/stack-overflow/refs/heads/main/json-schema/stack-overflow-question-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/stack-overflow-question-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/stack-overflow/refs/heads/main/vocabulary/stack-overflow-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/stack-overflow-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/stack-overflow/refs/heads/main/rules/stack-overflow-rules.yml
  title: ''
  type: SpectralRules
...
overview: 'Stack Overflow publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Answers API, Articles API, Badges API, and 7 more. Tagged areas include Answers, Code, Developer Community, Developer Tools, and Knowledge Base.
  ...
  Stack Overflow''s developer surface includes authentication, engineering blog, signup flow, and 13 more developer resources.'
plans:
