...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/openapi/refs/heads/main/security/openapi-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/openapi-domain-security.yml
- group: company
  title: ''
  type: Website
...
- name: Openapi Finops
  ...
  slug: openapi-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/openapi.png
json_schemas:
...
nav: Providers
network: true
overview: 'OpenAPI publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Documentation, REST, and Specification.


  The OpenAPI catalog on APIs.io includes 1 JSON-LD context and 1 Spectral governance ruleset.


  OpenAPI''s developer surface includes documentation, engineering blog, and 4 more developer resources.'
plans:
...
- limit_count: 5
  ...
  slug: openapi-rate-limits
rules:
- effective_rule_count: 5
  extends: []
  name: OpenAPI API Rules
  rule_count: 5
  severity_counts:
    error: 0
    hint: 0
