...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/rippling/refs/heads/main/agentic-access/rippling-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/rippling-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/rippling/refs/heads/main/security/rippling-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/rippling-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/rippling/refs/heads/main/authentication/rippling-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/rippling/refs/heads/main/plans/rippling-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/rippling-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/rippling/refs/heads/main/rate-limits/rippling-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/rippling-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/rippling/refs/heads/main/finops/rippling-finops.yml
  title: ''
  type: FinOps
...
- group: docs
  ...
  url: https://developer.rippling.com/documentation/mcp
created: '2026-05-08'
...
overview: 'Rippling publishes 3 APIs on the [APIs.io](https://apis.io/) network, including Platform API, Webhooks API, and 1 more. Tagged areas include Human Resources, HCM, Payroll, IT, and Identity.
  ...
  Rippling''s developer surface includes authentication, documentation, API reference, pricing, engineering blog, support, and 14 more developer resources.'
plans:
