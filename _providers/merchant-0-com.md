...
- acting_count: 35
  ...
  summary_line: 95 operations · 35 acting · 4 human-in-the-loop
api_count: 1
apis:
...
nav: Providers
network: true
overview: 'Merchant-0 publishes 2 APIs on the [APIs.io](https://apis.io/) network, including A2A Protocol Server API, and 1 more. Tagged areas include Agents, Agentic Commerce, A2A, AP2, and Universal Commerce Protocol.
