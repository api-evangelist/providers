...
nav: Providers
network: true
overview: 'Triton Inference Server publishes 12 APIs on the [APIs.io](https://apis.io/) network, including CUDA Shared Memory API, Health API, Inference API, and 9 more. Tagged areas include Artificial Intelligence, Deep Learning, Inference, Machine Learning, and Model Serving.
