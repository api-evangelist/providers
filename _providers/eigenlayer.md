...
access_model:
  ...
  source:
  - plans
  - '{''url'': ''https://www.eigenlayer.xyz/'', ''status'': 302, ''note'': ''declared website redirects to https://www.eigencloud.xyz/ — a different registrable domain (eigenlayer.xyz -> eigencloud.xyz), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: agent-aware
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/eigenlayer/refs/heads/main/security/eigenlayer-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'EigenLayer publishes 7 APIs on the [APIs.io](https://apis.io/) network, including EigenDA, and 6 more. Tagged areas include Restaking, AVS, Ethereum, Data Availability, and Verifiable Compute.
