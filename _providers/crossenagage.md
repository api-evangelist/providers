...
- description: CrossEngage REST API for managing users/customer profiles (User Management v1.0 and v2.0), product feeds, file attachments, data export, and campaign statistics. Served from api.crossengage.io.
  name: CrossEngage API
  slug: crossengage-api
artifact_total: 4
common:
- group: auth
  title: ''
...
- group: docs
  title: ''
  type: APIReference
  url: https://api.documentation.crossengage.io/user-management-v2/
- group: start
  title: ''
  type: Login
...
- group: operate
  title: ''
  type: Support
  url: https://spotler.com/en-de/support
- group: operate
  title: ''
  type: HelpCenter
...
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://spotler.com/en-de/privacy-statement
- group: operate
  title: ''
  type: StatusPage
  url: https://status.spotler.com/
- group: auth
  title: ''
  type: TrustCenter
...
nav: Providers
network: true
overview: 'CrossEngage publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Customer Data Platform, Marketing, Customer Engagement, and Marketing Automation.
