...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/spring-integration/refs/heads/main/agentic-access/spring-integration-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/spring-integration-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spring-integration/refs/heads/main/security/spring-integration-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/spring-integration-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spring-integration/refs/heads/main/security/spring-integration-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Spring Integration publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Adapters API, Channels API, Control API, and 7 more. Tagged areas include AMQP, Enterprise Integration, Event-Driven, Integration Patterns, and Java.
