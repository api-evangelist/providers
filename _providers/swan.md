...
- group: auth
  ...
  url: https://trust.swan.io/
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/swan/refs/heads/main/packages/swan-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/swan-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/swan/refs/heads/main/well-known/swan-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/swan-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/swan/refs/heads/main/authentication/swan-authentication.yml
  title: ''
  type: Authentication
  url: authentication/swan-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/swan/refs/heads/main/scopes/swan-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/swan-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/swan/refs/heads/main/conventions/swan-conventions.yml
  title: ''
  type: Conventions
  url: conventions/swan-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/swan/refs/heads/main/asyncapi/swan-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/swan-webhooks.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/swan/refs/heads/main/errors/swan-error-codes.yml
  title: ''
  type: ErrorCatalog
  url: errors/swan-error-codes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/swan/refs/heads/main/lifecycle/swan-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: operate
  ...
  url: lifecycle/swan-lifecycle.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/swan/refs/heads/main/changelog/swan-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/swan-changelog.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/swan/refs/heads/main/sandbox/swan-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/swan-sandbox.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/swan/refs/heads/main/components/swan-components.yml
  title: ''
  type: Components
  url: components/swan-components.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/swan/refs/heads/main/conformance/swan-conformance.yml
  title: ''
  type: Conformance
  url: conformance/swan-conformance.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/swan/refs/heads/main/security/swan-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/swan-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/swan/refs/heads/main/mcp/swan-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/swan-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/swan/refs/heads/main/llms/swan-llms.txt
  title: ''
  type: LLMsTxt
