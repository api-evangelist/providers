...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/mercoa/refs/heads/main/agentic-access/mercoa-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/mercoa-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mercoa/refs/heads/main/security/mercoa-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/mercoa-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mercoa/refs/heads/main/authentication/mercoa-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Mercoa publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Entities API, Entity Groups API, Invoice Templates API, and 7 more. Tagged areas include Mercoa, Embedded Finance, Accounts Payable, Accounts Receivable, and Bill Pay.
