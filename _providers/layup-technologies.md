...
- group: start
  ...
  url: https://documentation.layup.co.za/
- group: docs
  title: ''
  type: Documentation
  url: https://documentation.layup.co.za/
- group: docs
  title: ''
  type: APIReference
  url: https://api-documentation.layup.co.za/
- group: start
  title: ''
  type: GettingStarted
  url: https://documentation.layup.co.za/#how-to-use-layup
- group: company
  title: ''
  type: Blog
  url: https://blogs.layup.co.za/
- group: commercial
  title: ''
  type: Pricing
  url: https://layup.co.za/business/pricing
- group: start
  title: ''
  type: SignUp
  url: https://merchant.layup.co.za/
- group: start
  title: ''
  type: Login
  url: https://app.layup.co.za/
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://layup.co.za/privacy-policy
- group: operate
  title: ''
  type: Support
  url: https://layup.co.za/contact-us
- group: build
  title: ''
...
- group: docs
  title: ''
  type: OpenAPI
  url: openapi/layup-technologies-openapi-original.json
- group: build
  title: ''
  type: Packages
...
mcp_servers:
- description: ''
  name: layup-technologies-mcp.yml
  slug: layup-technologies-mcpyml
modified: '2026-07-20'
name: LayUp Technologies
nav: Providers
network: true
overview: 'LayUp Technologies publishes 29 APIs on the [APIs.io](https://apis.io/) network, including AbsaDebiCheckService API, AbsaEftService API, authService API, and 26 more. Tagged areas include Payments, Lay-By, Save Now Buy Later, BNPL, and Instalments.
