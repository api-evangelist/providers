...
- collection_type: open
  ...
  slug: open-bird-gbfs
- collection_type: open
  name: Bird GBFS Feed Discovery API
  slug: open-bird-rides-discovery-api
- collection_type: open
  name: Bird GBFS Feed Discovery Geofencing API
  slug: open-bird-rides-geofencing-api
- collection_type: open
  name: Bird GBFS Feed Discovery Pricing API
  slug: open-bird-rides-pricing-api
- collection_type: open
  name: Bird GBFS Feed Discovery Realtime API
  slug: open-bird-rides-realtime-api
- collection_type: open
  name: Bird GBFS Feed Discovery Stations API
  slug: open-bird-rides-stations-api
- collection_type: open
  name: Bird GBFS Feed Discovery System API
  slug: open-bird-rides-system-api
- collection_type: open
  name: Bird GBFS Feed Discovery Vehicles API
  slug: open-bird-rides-vehicles-api
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/bird-rides/refs/heads/main/capabilities/bird-rides-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/bird-rides-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/bird-rides/refs/heads/main/agentic-access/bird-rides-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/bird-rides-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bird-rides/refs/heads/main/security/bird-rides-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/bird-rides/refs/heads/main/plans/bird-rides-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/bird-rides-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/bird-rides/refs/heads/main/rate-limits/bird-rides-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/bird-rides-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/bird-rides/refs/heads/main/finops/bird-rides-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Bird publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Discovery API, Geofencing API, Pricing API, and 7 more. Tagged areas include Micromobility, Shared Mobility, Electric Scooters, E-Scooter, and E-Bikes.
