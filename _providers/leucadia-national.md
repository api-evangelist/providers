...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/leucadia-national/refs/heads/main/security/leucadia-national-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/leucadia-national-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/leucadia-national-corporation
- group: company
  title: ''
  type: Website
...
- group: company
  title: ''
  type: About
  url: https://en.wikipedia.org/wiki/Jefferies_Financial_Group
created: '2026-03-24'
description: Leucadia National Corporation was a diversified holding company engaged in a variety of businesses, including investment banking, beef processing, manufacturing, telecommunications, and real estate. In 2018 it was renamed Jefferies Financial Group following the merger with Jefferies Group LLC. No public API program is documented under the legacy Leucadia National brand.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/leucadia-national.png
layout: provider
modified: '2026-04-28'
