...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-chronicle/refs/heads/main/agentic-access/google-cloud-chronicle-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-cloud-chronicle-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-chronicle/refs/heads/main/security/google-cloud-chronicle-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-cloud-chronicle-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-chronicle/refs/heads/main/security/google-cloud-chronicle-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/google-cloud-chronicle-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-chronicle/refs/heads/main/authentication/google-cloud-chronicle-authentication.yml
  title: ''
  type: Authentication
  url: authentication/google-cloud-chronicle-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-chronicle/refs/heads/main/scopes/google-cloud-chronicle-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-chronicle/refs/heads/main/json-ld/google-cloud-chronicle-context.jsonld
  title: ''
  type: JSONLD
...
overview: 'Google Cloud Chronicle publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Alerts API, Feeds API, ReferenceLists API, and 1 more. Tagged areas include Incident Response, Log Management, Security Analytics, Security Operations, and SIEM.
  ...
  Google Cloud Chronicle''s developer surface includes authentication, developer portal, getting-started guide, documentation, pricing, support, and 13 more developer resources.'
plans:
