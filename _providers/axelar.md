...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/axelar/refs/heads/main/agentic-access/axelar-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/axelar-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/axelar/refs/heads/main/security/axelar-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/axelar/refs/heads/main/plans/axelar-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/axelar-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/axelar/refs/heads/main/rate-limits/axelar-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/axelar-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/axelar/refs/heads/main/finops/axelar-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Axelar publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Chains API, Contracts API, Health API, and 6 more. Tagged areas include Blockchain, Cross-Chain, Interoperability, Web3, and General Message Passing.
