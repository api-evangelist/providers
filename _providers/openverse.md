...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/openverse/refs/heads/main/capabilities/openverse-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/openverse-capability-edges.yml
- group: operate
  title: ''
  type: IssueTracker
...
- group: operate
  title: ''
  type: Releases
  url: https://github.com/WordPress/openverse/releases
- group: build
  title: ''
  type: CodeOfConduct
  url: https://github.com/WordPress/.github/blob/trunk/CODE_OF_CONDUCT.md
- group: docs
  title: ''
  type: ContributionGuide
  url: https://github.com/WordPress/openverse/blob/main/CONTRIBUTING.md
- group: commercial
  title: ''
  type: License
  url: https://github.com/WordPress/openverse/blob/main/LICENSE
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/openverse/refs/heads/main/agentic-access/openverse-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/openverse-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/openverse/refs/heads/main/security/openverse-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/openverse-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/openverse/refs/heads/main/authentication/openverse-authentication.yml
  title: ''
  type: Authentication
...
overview: 'Openverse publishes 3 APIs on the [APIs.io](https://apis.io/) network: audio API, auth API, and images API. Tagged areas include Image, Audio, Creative Commons, Open Media, and Search.
  ...
  Openverse''s developer surface includes authentication, engineering blog, and 8 more developer resources.'
plans:
- name: Plans
  plan_count: 3
  slug: plans
