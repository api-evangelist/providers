...
- acting_count: 6
  ...
  summary_line: 186 operations · 6 acting
api_count: 1
apis:
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/major-league-baseball/refs/heads/main/agentic-access/major-league-baseball-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/major-league-baseball-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/major-league-baseball/refs/heads/main/security/major-league-baseball-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/major-league-baseball-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/major-league-baseball/refs/heads/main/security/major-league-baseball-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Major League Baseball publishes 34 APIs on the [APIs.io](https://apis.io/) network, including Analytics API, Attendance API, Awards API, and 31 more. Tagged areas include Analytics, Baseball, Entertainment, Media, and Sports.
