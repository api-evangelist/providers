...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/jupyter-server/refs/heads/main/agentic-access/jupyter-server-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/jupyter-server-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jupyter-server/refs/heads/main/security/jupyter-server-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/jupyter-server-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jupyter-server/refs/heads/main/authentication/jupyter-server-authentication.yml
  title: ''
  type: Authentication
