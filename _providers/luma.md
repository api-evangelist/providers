...
- group: company
  title: ''
  type: Website
  url: https://www.luma.com/
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/luma/refs/heads/main/agentic-access/luma-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/luma-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/luma/refs/heads/main/security/luma-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/luma-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/luma/refs/heads/main/security/luma-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/luma-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/luma/refs/heads/main/authentication/luma-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Luma publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Calendars API, Events API, Memberships API, and 4 more. Tagged areas include Event, Event Management, Ticketing, Community, and Calendars.


  The Luma catalog on APIs.io includes 2 JSON-LD contexts and 1 Spectral governance ruleset.


  Luma''s developer surface includes authentication, developer portal, documentation, pricing, and 10 more developer resources.'
plans:
- name: Plans
  plan_count: 3
  slug: plans
