...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/statuspage/refs/heads/main/agentic-access/statuspage-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/statuspage-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/statuspage/refs/heads/main/security/statuspage-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/statuspage-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/statuspage/refs/heads/main/security/statuspage-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/statuspage-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/statuspage/refs/heads/main/security/statuspage-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/statuspage-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/statuspage/refs/heads/main/authentication/statuspage-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Statuspage publishes 2 APIs on the [APIs.io](https://apis.io/) network: Webhook Notifications and Pages API. Tagged areas include Status Pages, Incident Communication, Incident Management, Uptime, and Reliability.
