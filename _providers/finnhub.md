...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/finnhub/refs/heads/main/agentic-access/finnhub-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/finnhub-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/finnhub/refs/heads/main/security/finnhub-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/finnhub-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/finnhub/refs/heads/main/authentication/finnhub-authentication.yml
  title: ''
  type: Authentication
...
- group: build
  ...
  url: packages/finnhub-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/finnhub/refs/heads/main/mcp/finnhub-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/finnhub-mcp.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/finnhub/refs/heads/main/mcp/finnhub-tool-crosswalk.yml
  title: ''
  type: ToolCrosswalk
  url: mcp/finnhub-tool-crosswalk.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/finnhub/refs/heads/main/llms/finnhub-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/finnhub-llms.txt
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/finnhub/refs/heads/main/overlays/finnhub-swagger-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/finnhub-swagger-overlay.yaml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/finnhub/refs/heads/main/conformance/finnhub-conformance.yml
  title: ''
  type: Conformance
  url: conformance/finnhub-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/finnhub/refs/heads/main/errors/finnhub-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/finnhub-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/finnhub/refs/heads/main/lifecycle/finnhub-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/finnhub-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/finnhub/refs/heads/main/conventions/finnhub-conventions.yml
  title: ''
  type: Conventions
  url: conventions/finnhub-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/finnhub/refs/heads/main/data-model/finnhub-data-model.yml
  title: ''
  type: DataModel
  url: data-model/finnhub-data-model.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/finnhub/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/finnhub/refs/heads/main/rate-limits/finnhub-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/finnhub-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/finnhub/refs/heads/main/plans/finnhub-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/finnhub-plans-pricing.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/finnhub/refs/heads/main/finops/finnhub-finops.yml
  title: ''
  type: FinOps
  url: finops/finnhub-finops.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/finnhub/refs/heads/main/collections/finnhub.postman_collection.json
  title: ''
  type: Postman
