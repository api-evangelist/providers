...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/sterling-check/refs/heads/main/agentic-access/sterling-check-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/sterling-check-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sterling-check/refs/heads/main/security/sterling-check-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/sterling-check-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sterling-check/refs/heads/main/authentication/sterling-check-authentication.yml
  title: ''
  type: Authentication
  url: authentication/sterling-check-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sterling-check/refs/heads/main/scopes/sterling-check-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sterling-check/refs/heads/main/plans/sterling-check-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/sterling-check-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/sterling-check/refs/heads/main/rate-limits/sterling-check-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/sterling-check-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sterling-check/refs/heads/main/finops/sterling-check-finops.yml
  title: ''
  type: FinOps
