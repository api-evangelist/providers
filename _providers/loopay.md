...
- baseURL: https://api.loopay.com
  baseurl_source: declared
  description: The Document type API from Loopay — 1 operation(s) for document type.
  name: Loopay Document type API
...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/loopay/refs/heads/main/capabilities/loopay-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/loopay-capability-edges.yml
- group: start
  title: ''
...
- group: docs
  ...
  url: https://api.loopay.com/explorer
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/loopay/refs/heads/main/authentication/loopay-authentication.yml
  title: ''
  type: Authentication
  url: authentication/loopay-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/loopay/refs/heads/main/conventions/loopay-conventions.yml
  title: ''
  type: Conventions
  url: conventions/loopay-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/loopay/refs/heads/main/data-model/loopay-data-model.yml
  title: ''
  type: DataModel
  url: data-model/loopay-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/loopay/refs/heads/main/conformance/loopay-conformance.yml
  title: ''
  type: Conformance
  url: conformance/loopay-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/loopay/refs/heads/main/lifecycle/loopay-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/loopay-lifecycle.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/loopay/refs/heads/main/sandbox/loopay-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/loopay-sandbox.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/loopay/refs/heads/main/mcp/loopay-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/loopay-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/loopay/refs/heads/main/llms/loopay-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/loopay-llms.txt
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/loopay/refs/heads/main/overlays/loopay-openapi-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/loopay-openapi-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/loopay/refs/heads/main/well-known/loopay-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/loopay-well-known.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/loopay/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/loopay/refs/heads/main/agentic-access/loopay-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/loopay-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/loopay/refs/heads/main/security/loopay-domain-security.yml
  title: ''
  type: DomainSecurity
...
overview: 'Loopay publishes 15 APIs on the [APIs.io](https://apis.io/) network, including Affiliate API, Bank API, Company API, and 12 more. Tagged areas include Company, Payments, Fintech, Banking as a Service, and Cross-Border Payments.
  ...
  Loopay''s developer surface includes documentation, API reference, authentication, sandbox, engineering blog, support, signup flow, and 18 more developer resources.'
random_paper: 0
score:
  band: thin
  composite: 34.4
