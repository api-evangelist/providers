...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/sigstore/refs/heads/main/agentic-access/sigstore-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/sigstore-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sigstore/refs/heads/main/security/sigstore-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Sigstore publishes 6 APIs on the [APIs.io](https://apis.io/) network, including CA API, Entries API, Index API, and 3 more. Tagged areas include Certificate Authority, Code Signing, Containers, Cryptography, and Open Source.
