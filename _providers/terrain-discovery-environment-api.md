...
- collection_type: open
  name: Terrain Discovery Environment Analyses API
  slug: open-terrain-discovery-environment-api-analyses-api
- collection_type: open
  name: Terrain Discovery Environment Analyses Apps API
  slug: open-terrain-discovery-environment-api-apps-api
- collection_type: open
  name: Terrain Discovery Environment Analyses Authentication API
  slug: open-terrain-discovery-environment-api-authentication-api
- collection_type: open
  name: Terrain Discovery Environment Analyses Filesystem API
  slug: open-terrain-discovery-environment-api-filesystem-api
- collection_type: open
  name: Terrain Discovery Environment Analyses Identifiers API
  slug: open-terrain-discovery-environment-api-identifiers-api
- collection_type: open
  name: Terrain Discovery Environment Analyses Metadata API
  slug: open-terrain-discovery-environment-api-metadata-api
- collection_type: open
  name: Terrain Discovery Environment Analyses Notifications API
  slug: open-terrain-discovery-environment-api-notifications-api
- collection_type: open
  name: Terrain Discovery Environment Analyses Search API
  slug: open-terrain-discovery-environment-api-search-api
- collection_type: open
  name: Terrain Discovery Environment Analyses Sharing API
  slug: open-terrain-discovery-environment-api-sharing-api
- collection_type: open
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/terrain-discovery-environment-api/refs/heads/main/agentic-access/terrain-discovery-environment-api-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/terrain-discovery-environment-api-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/terrain-discovery-environment-api/refs/heads/main/security/terrain-discovery-environment-api-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/terrain-discovery-environment-api-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/terrain-discovery-environment-api/refs/heads/main/authentication/terrain-discovery-environment-api-authentication.yml
  title: ''
  type: Authentication
...
overview: 'Terrain Discovery Environment API publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Analyses API, Apps API, Authentication API, and 6 more. Tagged areas include Bioinformatics, Data Science, Life Sciences, Filesystem, and Cloud Computing.
  ...
  Terrain Discovery Environment API''s developer surface includes authentication, developer portal, documentation, and 9 more developer resources.'
plans:
