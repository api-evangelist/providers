...
nav: Providers
network: true
overview: 'Odoo publishes 3 APIs on the [APIs.io](https://apis.io/) network: Common API, JSON-RPC API, and Object API. Tagged areas include Business Applications, CRM, ERP, Open-Source, and Accounting.
