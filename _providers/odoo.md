...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/odoo/refs/heads/main/agentic-access/odoo-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/odoo-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/odoo/refs/heads/main/security/odoo-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/odoo-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/odoo/refs/heads/main/security/odoo-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/odoo-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/odoo/refs/heads/main/authentication/odoo-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Odoo publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Common API, JSON-RPC API, Object API, and 1 more. Tagged areas include Business Applications, CRM, ERP, Open Source, and Accounting.
