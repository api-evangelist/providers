...
nav: Providers
network: true
overview: 'Microsoft Outlook publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Attachments API, Mail Folders API, Messages API, and 1 more. Tagged areas include Calendar, Contacts, Email, Enterprise, and Microsoft.
