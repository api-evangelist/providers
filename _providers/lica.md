...
- group: operate
  title: ''
  type: IssueTracker
  url: https://github.com/lica-world/DesignMCP/issues
- group: company
  title: ''
  type: Website
  url: https://www.lica.world/
- group: company
  title: ''
  type: Blog
  url: https://www.lica.world/blog
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/lica-world
- group: start
  title: ''
  type: SignUp
  url: https://www.lica.world/early-access
- group: commercial
  title: ''
  type: TermsOfService
  url: https://www.lica.world/tc-agency
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://www.lica.world/privacy-policy
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/lica/refs/heads/main/mcp/lica-mcp.yml
  title: ''
  type: MCPServer
  url: mcp/lica-mcp.yml
- group: build
  title: ''
  type: SourceCode
  url: https://github.com/lica-world/DesignMCP
- group: build
  title: ''
  type: SourceCode
  url: https://github.com/lica-world/GDB
- group: build
  title: ''
  type: SourceCode
  url: https://github.com/lica-world/lica-dataset
- group: other
  title: ''
  type: Research
  url: https://www.lica.world/research
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/lica/refs/heads/main/llms/lica-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/lica-llms.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lica/refs/heads/main/security/lica-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/lica-domain-security.yml
created: '2026-07-17'
description: Lica is an AI research company building a substrate to train and evaluate AI models to be capable design partners across expressions of taste and consumption. Its research spans spatial reasoning and composition, layout generation and editing, vector-graphics (SVG) understanding, personalization and brand identity, and animation generation. Lica publishes the LICA dataset of layered graphic-design compositions and GDB (Graphic Design Benchmark), a real-world benchmark that scores frontier models on designer workflows across layout, typography, infographics, template semantics and animation. The company is backed by Accel, South Park Commons and Village Global. As of July 2026 Lica ships no public API, developer portal or API reference; product access is an email waitlist and its public developer surface is the lica-world GitHub organization, including the first-party DesignMCP MCP server.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/lica.png
layout: provider
mcp_servers:
- description: ''
