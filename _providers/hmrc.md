...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/hmrc/refs/heads/main/capabilities/hmrc-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/hmrc/refs/heads/main/agentic-access/hmrc-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/hmrc-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hmrc/refs/heads/main/security/hmrc-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/hmrc-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hmrc/refs/heads/main/security/hmrc-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/hmrc-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hmrc/refs/heads/main/authentication/hmrc-authentication.yml
  title: ''
  type: Authentication
  url: authentication/hmrc-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hmrc/refs/heads/main/scopes/hmrc-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/hmrc/refs/heads/main/openapi/_original/hmrc-vat-mtd-openapi.yml
  title: ''
  type: OpenAPI
  url: openapi/_original/hmrc-vat-mtd-openapi.yml
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/hmrc/refs/heads/main/json-schema/hmrc-vat-return-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/hmrc-vat-return-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/hmrc/refs/heads/main/json-ld/hmrc-context.jsonld
  title: ''
  type: JSONLDContext
...
nav: Providers
network: true
overview: 'HMRC UK Tax Authority publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Liabilities API, Obligations API, Payments API, and 5 more. Tagged areas include Government, Making Tax Digital, Regulatory, Tax, and United Kingdom.
