...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/sec/refs/heads/main/capabilities/sec-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/sec-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/sec/refs/heads/main/agentic-access/sec-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/sec-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sec/refs/heads/main/security/sec-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/sec-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sec/refs/heads/main/authentication/sec-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sec/refs/heads/main/plans/sec-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/sec-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/sec/refs/heads/main/rate-limits/sec-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/sec-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sec/refs/heads/main/finops/sec-finops.yml
  title: ''
  type: FinOps
  url: finops/sec-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sec/refs/heads/main/vocabulary/sec-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/sec-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sec/refs/heads/main/json-ld/sec-context.jsonld
  title: ''
  type: JSONLDContext
