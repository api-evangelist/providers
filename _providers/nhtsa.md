...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/nhtsa/refs/heads/main/security/nhtsa-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: NHTSA publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Vehicles and Public APIs.
random_paper: 14
score:
  band: minimal
  composite: 7.6
