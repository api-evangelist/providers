...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/national-fuel-gas/refs/heads/main/security/national-fuel-gas-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/national-fuel-gas-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/national-fuel-gas-company
- group: company
  title: ''
  type: Website
  url: https://www.nationalfuel.com/
- group: company
  title: ''
  type: InvestorRelations
  url: https://investor.nationalfuelgas.com/
- group: operate
  title: ''
  type: Contact
  url: https://www.nationalfuel.com/contact
created: '2026-03-24'
description: National Fuel Gas Company is a diversified energy company engaged in natural gas distribution, gas pipeline and storage, gas exploration and production, and energy marketing across the northeastern United States. National Fuel Gas does not currently publish a documented public REST API or developer portal; customer information and operational disclosures are made available through its corporate website, investor relations channels, and FERC regulatory filings.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/national-fuel-gas.png
layout: provider
modified: '2026-04-28'
...
- kind: domain-security
  name: National Fuel Gas Domain Security
  slug: national-fuel-gas-domain-security
