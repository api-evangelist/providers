...
nav: Providers
network: true
overview: 'Cohere publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Chat API, Embed API, Rerank API, and 6 more. Tagged areas include Artificial Intelligence, Natural Language Processing, Embeddings, Vector Search, and Tokenization.
  ...
  Cohere''s developer surface includes authentication, engineering blog, and 11 more developer resources.'
plans:
