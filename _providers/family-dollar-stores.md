...
- group: other
  title: ''
  type: Parent Company
  url: https://corporate.dollartree.com/
- group: other
  title: ''
  type: Store Locator
...
- group: commercial
  title: ''
  type: TermsOfService
  url: https://www.familydollar.com/terms-of-use/
- group: operate
  title: ''
  type: Contact
  url: https://www.familydollar.com/contact-us/
created: '2024-12-25'
description: Family Dollar is a chain of discount variety stores in the United States offering a broad assortment of merchandise including consumables, home products, apparel, and seasonal goods at low prices. Owned by Dollar Tree, Inc., Family Dollar operates thousands of locations across the country and serves millions of customers seeking value-oriented shopping. The company does not currently publish public APIs or a developer portal.
...
nav: Providers
network: true
overview: Family Dollar Stores is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Retail, Discount Stores, Consumer Goods, and Fortune 500.
press:
- date: '2026-05-25'
