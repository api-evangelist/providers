...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-tensorflow/refs/heads/main/agentic-access/google-tensorflow-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-tensorflow-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-tensorflow/refs/heads/main/security/google-tensorflow-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-tensorflow/refs/heads/main/json-ld/google-tensorflow-context.jsonld
  title: ''
  type: JSONLD
...
nav: Providers
network: true
overview: 'Google TensorFlow publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Model Status API, Prediction API, and 2 more. Tagged areas include Artificial Intelligence, Deep Learning, Google, Machine Learning, and Model Serving.


  The Google TensorFlow catalog on APIs.io includes 1 JSON-LD context and 1 Spectral governance ruleset.


  Google TensorFlow''s developer surface includes getting-started guide, pricing, support, engineering blog, and 7 more developer resources.'
plans:
