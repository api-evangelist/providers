...
nav: Providers
network: true
overview: 'ConocoPhillips publishes 3 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include Crude Oil, Energy, Exploration and Production, LNG, and Natural Gas.


  ConocoPhillips'' developer surface includes product news, engineering blog, and 9 more developer resources.'
plans:
