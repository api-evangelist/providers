...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/conocophillips/refs/heads/main/security/conocophillips-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/conocophillips-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/conocophillips
- group: company
  title: ''
  type: Website
...
- group: company
  title: ''
  type: Blog
  url: https://www.conocophillips.com/news-media/archive/
- group: other
  title: ''
  type: ProductPage
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/conocophillips.png
layout: provider
modified: '2026-07-25'
name: ConocoPhillips
nav: Providers
network: true
overview: 'ConocoPhillips is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Crude Oil, Energy, Exploration and Production, LNG, and Natural Gas.


  ConocoPhillips'' developer surface includes product news, engineering blog, and 10 more developer resources.'
plans:
- name: Conocophillips Plans Pricing
  plan_count: 1
