...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hirelogic/refs/heads/main/security/hirelogic-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: operate
  ...
  url: https://support.hirelogic.com/
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hirelogic/refs/heads/main/conformance/hirelogic-conformance.yml
  title: ''
  type: Compliance
...
- group: design
  ...
  url: conformance/hirelogic-conformance.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/hirelogic/refs/heads/main/llms/hirelogic-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/hirelogic-llms.txt
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/hirelogic/refs/heads/main/plans/hirelogic-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/hirelogic-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/hirelogic/refs/heads/main/rate-limits/hirelogic-rate-limits.yml
  title: ''
  type: RateLimits
...
nav: Providers
network: true
overview: 'HireLogic is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Human Resources, Recruiting, Talent Acquisition, and Interview Intelligence.
