...
common:
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/seqera-labs/refs/heads/main/plans/seqera-labs-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/seqera-labs-plans-pricing.yml
- group: company
  title: ''
  type: Website
...
- group: docs
  title: ''
  type: APIReference
  url: https://docs.seqera.io/platform-api/
- group: start
  title: ''
  type: GettingStarted
  url: https://docs.seqera.io/platform-cloud/getting-started/quickstart-demo/comm-showcase
- group: start
  title: ''
  type: SignUp
  url: https://cloud.seqera.io/login
- group: commercial
  title: ''
  type: Pricing
  url: https://seqera.io/pricing
- group: company
  title: ''
  type: Blog
  url: https://seqera.io/blog
- group: operate
  title: ''
  type: Support
...
- group: commercial
  title: ''
  type: TermsOfService
  url: https://seqera.io/legal
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://seqera.io/privacy-policy
- group: operate
  title: ''
  type: ChangeLog
  url: https://docs.seqera.io/changelog
- group: operate
  title: ''
  type: StatusPage
...
plans:
- name: Seqera Labs Plans Pricing
  plan_count: 8
  slug: seqera-labs-plans-pricing
random_paper: 4
score:
  band: strong
  composite: 60.4
...
- kind: vulnerability-disclosure
  name: Seqera Labs Vulnerability Disclosure
  slug: seqera-labs-vulnerability-disclosure
  summary_line: Hackerone
- kind: trust-center
  name: Seqera Labs Trust Center
  slug: seqera-labs-trust-center
  summary_line: status, note
slug: seqera-labs
tags:
- Company
- Bioinformatics
