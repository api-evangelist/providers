...
- collection_type: open
  name: Applications.Dapr Resource Management APIs
  slug: open-radius-applications-dapr
- collection_type: open
  name: Applications.Datastores Resource Management APIs
  slug: open-radius-applications-datastores
- collection_type: open
...
- group: company
  ...
  url: https://radapp.io/
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/radius/refs/heads/main/capabilities/radius-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/radius-capability-edges.yml
- group: operate
  title: ''
  type: IssueTracker
...
- group: commercial
  title: ''
  type: License
  url: https://github.com/radius-project/radius/blob/main/LICENSE
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/radius/refs/heads/main/agentic-access/radius-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/radius-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/radius/refs/heads/main/security/radius-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/radius-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/radius/refs/heads/main/authentication/radius-authentication.yml
  title: ''
  type: Authentication
  url: authentication/radius-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/radius/refs/heads/main/scopes/radius-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/radius-scopes.yml
- group: docs
  title: ''
  type: Documentation
...
- name: Radius Finops
  ...
  slug: radius-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/radius.png
layout: provider
modified: '2026-05-19'
name: Radius
nav: Providers
