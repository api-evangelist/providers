...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/codeship/refs/heads/main/security/codeship-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/codeship-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/codeship/refs/heads/main/security/codeship-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/codeship-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/codeship/refs/heads/main/security/codeship-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: Codeship publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Continuous Integration, Developer Tools, and Public APIs.
random_paper: 11
score:
  band: minimal
  composite: 9.2
