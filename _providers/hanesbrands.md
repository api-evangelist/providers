...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://www.hanesbrands.com'', ''status'': 301, ''note'': ''declared website redirects to https://gildancorp.com/en/gildan-and-hanesbrands-homepage/ — a different registrable domain (hanesbrands.com -> gildancorp.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hanesbrands/refs/heads/main/security/hanesbrands-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/hanesbrands-domain-security.yml
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/hanesbrands
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/hanesbrands-inc-
- group: company
  title: ''
  type: Website
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/hanesbrands.png
layout: provider
modified: '2026-04-28'
name: Hanesbrands
nav: Providers
