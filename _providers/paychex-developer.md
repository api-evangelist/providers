...
nav: Providers
network: true
overview: 'Paychex publishes 3 APIs on the [APIs.io](https://apis.io/) network: Companies API, Time Entries API, and Workers API. Tagged areas include Benefits, HCM, Human Resources, Paychex Flex, and Payroll.
