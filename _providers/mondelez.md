...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mondelez/refs/heads/main/security/mondelez-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/mondelez-domain-security.yml
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/mondelez-ctiso
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/mondelezinternational
- group: company
  title: ''
  type: Website
  url: https://www.mondelezinternational.com
created: '2026-03-21'
description: Mondelez International is a Fortune 500 multinational confectionery, food, and beverage company that owns iconic snack brands including Oreo, Cadbury, Milka, Toblerone, Trident, Ritz, and Triscuit.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/mondelez.png
layout: provider
modified: '2026-04-28'
name: Mondelez
nav: Providers
network: true
overview: Mondelez is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Fortune 500, Food, Snacks, Beverages, and Food and Beverage.
press:
- date: ''
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/mondelez/refs/heads/main/screenshots/mondelez-2026-06-20T185721.png
security:
