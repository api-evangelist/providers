...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/consumer-product-safety-commission/refs/heads/main/agentic-access/consumer-product-safety-commission-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/consumer-product-safety-commission-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/consumer-product-safety-commission/refs/heads/main/security/consumer-product-safety-commission-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  ...
  url: https://www.cpsc.gov/Newsroom/Privacy-and-Security-Statement
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/consumer-product-safety-commission/refs/heads/main/json-ld/consumer-product-safety-commission-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/consumer-product-safety-commission-context.jsonld
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/consumer-product-safety-commission/refs/heads/main/json-schema/cpsc-recall-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/cpsc-recall-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/consumer-product-safety-commission/refs/heads/main/rules/consumer-product-safety-commission-rules.yml
  title: ''
  type: Spectral
...
nav: Providers
network: true
overview: 'Consumer Product Safety Commission publishes 2 APIs on the [APIs.io](https://apis.io/) network, including Recalls API, and 1 more. Tagged areas include Consumer Protection, Federal Government, Hazards, Open Data, and Product Safety.
