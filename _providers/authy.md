...
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/authy/refs/heads/main/packages/authy-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/authy-packages.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/authy/refs/heads/main/lifecycle/authy-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: operate
  ...
  url: lifecycle/authy-lifecycle.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/authy/refs/heads/main/security/authy-domain-security.yml
  title: ''
  type: DomainSecurity
...
overview: 'Authy is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Authentication, Two-Factor Authentication, 2FA, and Identity.
  ...
  Authy''s developer surface includes documentation, support, and 8 more developer resources.'
random_paper: 5
score:
  band: emerging
  composite: 11.0
