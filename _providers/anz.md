...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/anz/refs/heads/main/capabilities/anz-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/anz-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/anz/refs/heads/main/agentic-access/anz-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/anz-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/anz/refs/heads/main/security/anz-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/anz-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/anz/refs/heads/main/authentication/anz-authentication.yml
  title: ''
  type: Authentication
  url: authentication/anz-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/anz/refs/heads/main/scopes/anz-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/anz-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/anz/refs/heads/main/conventions/anz-conventions.yml
  title: ''
  type: Conventions
  url: conventions/anz-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/anz/refs/heads/main/errors/anz-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/anz-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/anz/refs/heads/main/lifecycle/anz-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/anz/refs/heads/main/conformance/anz-conformance.yml
  title: ''
  type: Conformance
  url: conformance/anz-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/anz/refs/heads/main/data-model/anz-data-model.yml
  title: ''
  type: DataModel
  url: data-model/anz-data-model.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/anz/refs/heads/main/mcp/anz-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/anz-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/anz/refs/heads/main/llms/anz-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/anz-llms.txt
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/anz/refs/heads/main/overlays/anz-cds-banking-products-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/anz-cds-banking-products-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/anz/refs/heads/main/skills/anz-product-reference-data.md
  title: ''
  type: AgentSkill
  url: skills/anz-product-reference-data.md
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/anz/refs/heads/main/security/anz-vulnerability-disclosure.yml
  title: ''
...
nav: Providers
network: true
overview: 'Australia and New Zealand Banking Group (ANZ) publishes 16 APIs on the [APIs.io](https://apis.io/) network, including Banking Account Balances API, Banking Account Direct Debits API, Banking Account Scheduled Payments API, and 13 more. Tagged areas include Finance, Banks, Open Banking, CDR, and Consumer Banking.
