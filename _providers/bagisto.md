...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bagisto/refs/heads/main/security/bagisto-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/bagisto/refs/heads/main/plans/bagisto-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/bagisto-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/bagisto/refs/heads/main/rate-limits/bagisto-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/bagisto-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/bagisto/refs/heads/main/finops/bagisto-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Bagisto publishes 2 APIs on the [APIs.io](https://apis.io/) network, including REST API, and 1 more. Tagged areas include E-Commerce, Laravel, Open Source, Product, and Order.
