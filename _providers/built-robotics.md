...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/built-robotics/refs/heads/main/security/built-robotics-vulnerability-disclosure.yml
  title: ''
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/built-robotics/refs/heads/main/security/built-robotics-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/built-robotics-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/built-robotics/refs/heads/main/well-known/built-robotics-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/built-robotics-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/built-robotics/refs/heads/main/well-known/built-robotics-security.txt
  title: ''
  type: SecurityTxt
  url: well-known/built-robotics-security.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/built-robotics/refs/heads/main/llms/built-robotics-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/built-robotics-llms.txt
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/built-robotics/refs/heads/main/packages/built-robotics-packages.yml
  title: ''
  type: Packages
  url: packages/built-robotics-packages.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/built-robotics/refs/heads/main/conformance/built-robotics-conformance.yml
  title: ''
  type: Conformance
