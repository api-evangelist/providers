...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/spaceflight-news-api/refs/heads/main/agentic-access/spaceflight-news-api-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/spaceflight-news-api-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spaceflight-news-api/refs/heads/main/security/spaceflight-news-api-domain-security.yml
  title: ''
  type: DomainSecurity
...
overview: 'Spaceflight News API publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Articles API, Blogs API, Info API, and 1 more. Tagged areas include News, Space, Spaceflight, and Media.
  ...
  Spaceflight News API''s developer surface includes documentation, GitHub presence, support, and 6 more developer resources.'
plans:
