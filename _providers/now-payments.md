...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/now-payments/refs/heads/main/agentic-access/now-payments-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/now-payments-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/now-payments/refs/heads/main/security/now-payments-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/now-payments-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/now-payments/refs/heads/main/authentication/now-payments-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'NOWPayments publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Mass Payouts API, Authentication API, Currencies API, and 7 more. Tagged areas include Crypto Payments, Cryptocurrency, Payment Gateway, Invoicing, and Subscription.
