...
mcp_servers:
- description: ''
  name: Avalara MCP Server
  slug: avalara-mcp-server
modified: '2026-06-20'
name: Avalara
nav: Providers
network: true
overview: 'Avalara publishes 68 APIs on the [APIs.io](https://apis.io/) network, including 1099 Forms API, Accounts API, Addresses API, and 65 more. Tagged areas include Taxes.
  ...
  Avalara''s developer surface includes authentication, sandbox, changelog, engineering blog, support, developer portal, training material, and 89 more developer resources.'
plans:
