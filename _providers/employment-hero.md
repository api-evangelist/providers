...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/employment-hero/refs/heads/main/agentic-access/employment-hero-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/employment-hero-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/employment-hero/refs/heads/main/security/employment-hero-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/employment-hero-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/employment-hero/refs/heads/main/security/employment-hero-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/employment-hero-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/employment-hero/refs/heads/main/authentication/employment-hero-authentication.yml
  title: ''
  type: Authentication
  url: authentication/employment-hero-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/employment-hero/refs/heads/main/scopes/employment-hero-scopes.yml
  title: ''
  type: OAuthScopes
...
nav: Providers
network: true
overview: 'Employment Hero publishes 12 APIs on the [APIs.io](https://apis.io/) network, including Bank Accounts API, Certifications API, Cost Centres API, and 9 more. Tagged areas include Human Resources, HRIS, Payroll, Recruiting, and Employee Benefits.
