...
- baseURL: https://cockroachlabs.cloud
  ...
  name: CockroachDB Audit Logs API
...
- baseURL: https://cockroachlabs.cloud
  ...
  name: CockroachDB Backup Restore API
...
- baseURL: https://cockroachlabs.cloud
  ...
  name: CockroachDB Maintenance Windows API
...
- baseURL: https://cockroachlabs.cloud
  ...
  name: CockroachDB Private Endpoints API
...
- baseURL: https://cockroachlabs.cloud
  ...
  name: CockroachDB Role Management API
...
- baseURL: https://cockroachlabs.cloud
  ...
  name: CockroachDB Service Accounts API
...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/cockroachdb/refs/heads/main/capabilities/cockroachdb-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cockroachdb/refs/heads/main/agentic-access/cockroachdb-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/cockroachdb-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cockroachdb/refs/heads/main/security/cockroachdb-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/cockroachdb-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cockroachdb/refs/heads/main/security/cockroachdb-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/cockroachdb-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cockroachdb/refs/heads/main/security/cockroachdb-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/cockroachdb-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cockroachdb/refs/heads/main/authentication/cockroachdb-authentication.yml
  title: ''
  type: Authentication
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/cockroachdb/refs/heads/main/json-schema/cockroachdb-cluster-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/cockroachdb-cluster-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cockroachdb/refs/heads/main/json-ld/cockroachdb-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/cockroachdb-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cockroachdb/refs/heads/main/rules/cockroachdb-rules.yml
  title: ''
  type: Spectral
...
nav: Providers
network: true
overview: 'CockroachDB publishes 26 APIs on the [APIs.io](https://apis.io/) network, including Auth API, Billing API, Clusters API, and 23 more. Tagged areas include Cluster Management, Cloud, Database, Distributed SQL, and Infrastructure.
