...
nav: Providers
network: true
overview: 'FuriosaAI publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Health API, Models API, Predict API, and 2 more. Tagged areas include Artificial Intelligence, Machine Learning, Inference, Semiconductors, and NPU.
