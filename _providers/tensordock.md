...
- acting_count: 19
  ...
  summary_line: 33 operations · 19 acting · 3 human-in-the-loop
api_count: 1
apis:
...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/tensordock/refs/heads/main/capabilities/tensordock-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/tensordock-capability-edges.yml
- group: build
  title: ''
  type: PostmanWorkspace
  url: https://www.postman.com/kinlaneapi/tensordock/overview
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/tensordock/refs/heads/main/agentic-access/tensordock-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/tensordock-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tensordock/refs/heads/main/security/tensordock-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/tensordock-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tensordock/refs/heads/main/authentication/tensordock-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/tensordock/refs/heads/main/plans/tensordock-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/tensordock-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/tensordock/refs/heads/main/rate-limits/tensordock-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/tensordock-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/tensordock/refs/heads/main/finops/tensordock-finops.yml
  title: ''
  type: FinOps
...
overview: 'TensorDock publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Instances API, Secrets API, Authorization API, and 6 more. Tagged areas include GPU, Cloud, Marketplace, Compute, and Virtual Machines.
  ...
  TensorDock''s developer surface includes authentication, developer portal, documentation, getting-started guide, developer console, sandbox, signup flow, and 43 more developer resources.'
plans:
