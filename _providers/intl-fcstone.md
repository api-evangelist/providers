...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/intl-fcstone/refs/heads/main/security/intl-fcstone-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/intl-fcstone-domain-security.yml
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/INTLFCStone
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/intl-fcstone-ltd
- group: company
  title: ''
  type: Website
  url: https://www.intl-fcstone.com
- group: company
  title: ''
  type: Website
  url: https://www.stonex.com
created: '2025-01-01'
description: INTL FCStone Inc. (rebranded as StoneX Group in 2020) is a Fortune 100 financial services organization providing execution, risk management, advisory services, market intelligence, and post-trade services across asset classes and global markets including commodities, equities, fixed income, foreign exchange, and securities.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/intl-fcstone.png
layout: provider
modified: '2026-04-28'
name: INTL FCStone
nav: Providers
network: true
overview: INTL FCStone is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Financial-Services, Commodities, Foreign Exchange, Risk Management, and Trading.
press:
- date: ''
