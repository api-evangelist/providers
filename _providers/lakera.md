...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/lakera/refs/heads/main/agentic-access/lakera-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/lakera-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lakera/refs/heads/main/security/lakera-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/lakera-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lakera/refs/heads/main/security/lakera-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/lakera-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lakera/refs/heads/main/security/lakera-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/lakera-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lakera/refs/heads/main/authentication/lakera-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Lakera publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Guard API, Health API, Policies API, and 3 more. Tagged areas include AI Security, LLM Security, Prompt Injection, Guardrails, and Red Teaming.
