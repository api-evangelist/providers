...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/pulumi/refs/heads/main/capabilities/pulumi-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/pulumi-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/pulumi/refs/heads/main/agentic-access/pulumi-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/pulumi-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pulumi/refs/heads/main/security/pulumi-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/pulumi-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pulumi/refs/heads/main/security/pulumi-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/pulumi-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/pulumi
- group: company
  title: ''
  type: Website
...
- kind: vulnerability-disclosure
  name: Pulumi Vulnerability Disclosure
  slug: pulumi-vulnerability-disclosure
  summary_line: disclosure policy published
skill_count: 13
skills:
- name: cloudformation-to-pulumi
  slug: cloudformation-to-pulumi
- name: package-usage
  slug: package-usage
- name: provider-upgrade
  slug: provider-upgrade
- name: pulumi-arm-to-pulumi
  slug: pulumi-arm-to-pulumi
- name: pulumi-automation-api
  slug: pulumi-automation-api
- name: pulumi-best-practices
  slug: pulumi-best-practices
- name: pulumi-cdk-to-pulumi
  slug: pulumi-cdk-to-pulumi
- name: pulumi-component
  slug: pulumi-component
- name: pulumi-esc
  slug: pulumi-esc
- name: pulumi-neo-handoff
  slug: pulumi-neo-handoff
- name: pulumi-terraform-to-pulumi
  slug: pulumi-terraform-to-pulumi
- name: pulumi-upgrade-provider
  slug: pulumi-upgrade-provider
- name: upstream-patches
  slug: upstream-patches
slug: pulumi
tags:
- Automation
- Cloud
