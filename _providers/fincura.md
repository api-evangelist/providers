...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/fincura/refs/heads/main/capabilities/fincura-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/fincura-capability-edges.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/fincura/refs/heads/main/overlays/fincura-openapi-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/fincura-openapi-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/fincura/refs/heads/main/agentic-access/fincura-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/fincura-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/fincura/refs/heads/main/security/fincura-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/fincura-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/fincura/refs/heads/main/authentication/fincura-authentication.yml
  title: ''
  type: Authentication
  url: authentication/fincura-authentication.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/fincura/refs/heads/main/packages/fincura-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/fincura-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/fincura/refs/heads/main/mcp/fincura-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/fincura-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/fincura/refs/heads/main/llms/fincura-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/fincura-llms.txt
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/fincura/refs/heads/main/conformance/fincura-conformance.yml
  title: ''
  type: Conformance
  url: conformance/fincura-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/fincura/refs/heads/main/errors/fincura-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/fincura-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/fincura/refs/heads/main/lifecycle/fincura-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/fincura-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/fincura/refs/heads/main/conventions/fincura-conventions.yml
  title: ''
  type: Conventions
  url: conventions/fincura-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/fincura/refs/heads/main/components/fincura-components.yml
  title: ''
  type: Components
  url: components/fincura-components.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/fincura/refs/heads/main/data-model/fincura-data-model.yml
  title: ''
  type: DataModel
  url: data-model/fincura-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/fincura/refs/heads/main/asyncapi/fincura-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/fincura-webhooks.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/fincura/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/fincura/refs/heads/main/arazzo/fincura-spread-and-analyze.yml
  title: ''
  type: Arazzo
