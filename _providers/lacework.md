...
- group: auth
  title: ''
  type: DomainSecurity
  url: security/lacework-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
...
- group: docs
  title: ''
  type: Documentation
  url: https://docs.fortinet.com/product/lacework-forticnapp
- group: docs
  title: ''
  type: API Documentation
  url: https://docs.fortinet.com/document/lacework-forticnapp/latest/api-reference
- group: commercial
  title: ''
  type: Pricing
  url: https://www.lacework.com/pricing
- group: start
  title: ''
  type: Signup
  url: https://www.lacework.com/request-trial/
- group: start
  title: ''
  type: Login
...
- group: operate
  title: ''
  type: Support
  url: https://support.lacework.com
- group: company
  title: ''
  type: Blog
...
nav: Providers
network: true
overview: 'Lacework FortiCNAPP publishes 1 API on the [APIs.io](https://apis.io/) network: API v2. Tagged areas include Cloud Security, CNAPP, Compliance, Threat Detection, and Vulnerability Management.
