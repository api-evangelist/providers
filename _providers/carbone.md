...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/carbone/refs/heads/main/agentic-access/carbone-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/carbone-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/carbone/refs/heads/main/security/carbone-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/carbone-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/carbone/refs/heads/main/authentication/carbone-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/carbone/refs/heads/main/plans/carbone-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/carbone-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/carbone/refs/heads/main/rate-limits/carbone-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/carbone-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/carbone/refs/heads/main/finops/carbone-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Carbone publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Render API, Status API, Template API, and 3 more. Tagged areas include Document Generation, PDF, Templates, Open Source, and Office.
