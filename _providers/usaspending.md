...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/usaspending/refs/heads/main/capabilities/usaspending-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/usaspending-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/usaspending/refs/heads/main/agentic-access/usaspending-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/usaspending-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/usaspending/refs/heads/main/security/usaspending-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/usaspending/refs/heads/main/rate-limits/usaspending-rate-limits.yml
  title: ''
  type: RateLimits
...
nav: Providers
network: true
overview: 'USAspending.gov publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Agency API, Awards Search API, Budget Functions API, and 7 more. Tagged areas include Government, Federal Spending, Open Data, Contracts, and Grants.
