...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/capabilities/platform.sh-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/authentication/platform.sh-authentication.yml
  title: ''
  type: Authentication
  url: authentication/platform.sh-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/scopes/platform.sh-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/platform.sh-scopes.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/packages/platform.sh-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/platform.sh-packages.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/cli/platform.sh-cli.yml
  title: ''
  type: CLI
  url: cli/platform.sh-cli.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/llms/platform.sh-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/platform.sh-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/well-known/platform.sh-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/platform.sh-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/well-known/platform.sh-security.txt
  title: ''
  type: SecurityTxt
  url: well-known/platform.sh-security.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/security/platform.sh-vulnerability-disclosure.yml
  title: ''
  type: Security
...
- group: auth
  ...
  url: security/platform.sh-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/security/platform.sh-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/platform.sh-domain-security.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/conformance/platform.sh-conformance.yml
  title: ''
  type: Conformance
...
- group: auth
  ...
  url: conformance/platform.sh-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/lifecycle/platform.sh-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: operate
  ...
  url: lifecycle/platform.sh-lifecycle.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/changelog/platform.sh-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/platform.sh-changelog.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/errors/platform.sh-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/platform.sh-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/conventions/platform.sh-conventions.yml
  title: ''
  type: Conventions
  url: conventions/platform.sh-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/data-model/platform.sh-data-model.yml
  title: ''
  type: DataModel
  url: data-model/platform.sh-data-model.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/overlays/platform.sh-rest-api-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/platform.sh-rest-api-overlay.yaml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/plans/platform.sh-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/platform.sh-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/rate-limits/platform.sh-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/platform.sh-rate-limits.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/mcp/platform.sh-mcp.yml
  title: ''
  type: MCPServer
  url: mcp/platform.sh-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/asyncapi/platform.sh-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/platform.sh-webhooks.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/platform.sh/refs/heads/main/mcp/platform.sh-tool-crosswalk.yml
  title: ''
  type: ToolCrosswalk
