...
- baseURL: https://api.smith.langchain.com
  baseurl_source: declared
  description: The fleet auth API from LangSmith — 10 operation(s) for fleet auth.
  name: LangSmith fleet auth API
  slug: langsmith-fleet-auth-api
- baseURL: https://api.smith.langchain.com
  baseurl_source: declared
  description: The fleet github-app API from LangSmith — 9 operation(s) for fleet github-app.
  name: LangSmith fleet github-app API
  slug: langsmith-fleet-github-app-api
- baseURL: https://api.smith.langchain.com
  baseurl_source: declared
  description: The fleet integrations API from LangSmith — 3 operation(s) for fleet integrations.
  name: LangSmith fleet integrations API
  slug: langsmith-fleet-integrations-api
- baseURL: https://api.smith.langchain.com
  baseurl_source: declared
  description: The fleet mcp API from LangSmith — 7 operation(s) for fleet mcp.
  name: LangSmith fleet mcp API
  slug: langsmith-fleet-mcp-api
- baseURL: https://api.smith.langchain.com
  baseurl_source: declared
  description: The fleet threads API from LangSmith — 5 operation(s) for fleet threads.
  name: LangSmith fleet threads API
  slug: langsmith-fleet-threads-api
- baseURL: https://api.smith.langchain.com
  baseurl_source: declared
  description: The fleet usage API from LangSmith — 4 operation(s) for fleet usage.
  name: LangSmith fleet usage API
...
- baseURL: https://api.smith.langchain.com
  baseurl_source: declared
  description: The Organizations API from LangSmith — 1 operation(s) for organizations.
  name: LangSmith Organizations API
...
- baseURL: https://api.smith.langchain.com
  baseurl_source: declared
  description: The SCIM Tokens API from LangSmith — 2 operation(s) for scim tokens.
  name: LangSmith SCIM Tokens API
...
- baseURL: https://api.smith.langchain.com
  baseurl_source: declared
  description: The TTL Settings API from LangSmith — 2 operation(s) for ttl settings.
  name: LangSmith TTL Settings API
...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/langsmith/refs/heads/main/capabilities/langsmith-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/langsmith-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/langsmith/refs/heads/main/agentic-access/langsmith-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/langsmith-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/langsmith/refs/heads/main/security/langsmith-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/langsmith-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/langsmith/refs/heads/main/authentication/langsmith-authentication.yml
  title: ''
  type: Authentication
  url: authentication/langsmith-authentication.yml
- group: company
  title: ''
  type: Website
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/langsmith/refs/heads/main/plans/langsmith-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/langsmith-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/langsmith/refs/heads/main/rate-limits/langsmith-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/langsmith-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/langsmith/refs/heads/main/finops/langsmith-finops.yml
  title: ''
  type: FinOps
...
created: '2026-05-08'
description: LangSmith is the observability, debugging, and evaluation platform for LLM applications, built by LangChain. The LangSmith API exposes tracing, dataset management, evaluation, prompt-hub, and Fleet agent functionality for AI engineering teams.
finops:
- name: Langsmith Finops
  service_category: AI
  slug: langsmith-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/langsmith.png
layout: provider
modified: '2026-05-19'
name: LangSmith
nav: Providers
...
- name: Langsmith Price Estimates
  plan_count: 0
  slug: langsmith-price-estimates
random_paper: 21
rate_limits:
- limit_count: 0
