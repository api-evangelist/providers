...
- baseURL: https://mcp.botify.com/
  baseurl_source: declared
  description: The Data Source API from Botify — 1 operation(s) for data source.
  name: Botify Data Source API
...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/botify/refs/heads/main/overlays/botify-api-swagger-overlay.yaml
  title: ''
  type: Overlay
...
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/botify/refs/heads/main/packages/botify-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/botify-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/botify/refs/heads/main/llms/botify-llms.txt
  title: ''
  type: LLMSTxt
  url: llms/botify-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/botify/refs/heads/main/well-known/botify-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/botify-well-known.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/botify/refs/heads/main/lifecycle/botify-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/botify-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/botify/refs/heads/main/conformance/botify-conformance.yml
  title: ''
  type: Conformance
...
- group: auth
  ...
  url: conformance/botify-conformance.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/botify/refs/heads/main/security/botify-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/botify-domain-security.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/botify/refs/heads/main/changelog/botify-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/botify-changelog.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/botify/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/botify/refs/heads/main/skills/botify-query-seo-data.md
  title: ''
  type: AgentSkill
  url: skills/botify-query-seo-data.md
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/botify/refs/heads/main/skills/botify-export-seo-data.md
  title: ''
  type: AgentSkill
  url: skills/botify-export-seo-data.md
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/botify/refs/heads/main/skills/botify-run-and-monitor-a-crawl.md
  title: ''
  type: AgentSkill
  url: skills/botify-run-and-monitor-a-crawl.md
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/botify/refs/heads/main/skills/botify-audit-sitemaps-and-orphans.md
  title: ''
  type: AgentSkill
...
nav: Providers
network: true
overview: 'Botify publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Analysis API, Collections API, Job API, and 5 more. Tagged areas include SEO, Organic search, Web Crawling, Log Analysis, and search-console.
