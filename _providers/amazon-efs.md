...
overview: 'Amazon EFS publishes 1 API on the [APIs.io](https://apis.io/) network: 2015 02 01 API. Tagged areas include Amazon Web Services, EFS, Elastic File System, File Storage, and NFS.
  ...
  Amazon EFS''s developer surface includes authentication, developer portal, documentation, support, engineering blog, developer console, signup flow, and 26 more developer resources.'
plans:
