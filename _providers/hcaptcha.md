...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/hcaptcha/refs/heads/main/agentic-access/hcaptcha-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/hcaptcha-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hcaptcha/refs/heads/main/security/hcaptcha-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/hcaptcha-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hcaptcha/refs/heads/main/authentication/hcaptcha-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'hCaptcha publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Siteverify API, and 5 more. Tagged areas include CAPTCHA, Bot Defense, Privacy, hCaptcha, and Intuition Machines.
