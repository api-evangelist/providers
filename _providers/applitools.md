...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/applitools/refs/heads/main/agentic-access/applitools-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/applitools-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/applitools/refs/heads/main/security/applitools-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/applitools-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/applitools/refs/heads/main/security/applitools-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/applitools-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/applitools/refs/heads/main/authentication/applitools-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/applitools/refs/heads/main/plans/applitools-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/applitools-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/applitools/refs/heads/main/rate-limits/applitools-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/applitools-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/applitools/refs/heads/main/finops/applitools-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Applitools publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Batches API, Discussions API, SCM API, and 5 more. Tagged areas include Testing, Visual AI, Visual Testing, Autonomous Testing, and REST.
