...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/interos/refs/heads/main/capabilities/interos-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/interos/refs/heads/main/openapi/_original/interos-openapi.json
  title: ''
  type: OpenAPI
  url: openapi/_original/interos-openapi.json
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/interos/refs/heads/main/overlays/interos-openapi-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/interos-openapi-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/interos/refs/heads/main/mcp/interos-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/interos-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/interos/refs/heads/main/llms/interos-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/interos-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/interos/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/interos/refs/heads/main/authentication/interos-authentication.yml
  title: ''
  type: Authentication
  url: authentication/interos-authentication.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/interos/refs/heads/main/agentic-access/interos-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/interos-agentic-access.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/interos/refs/heads/main/conventions/interos-conventions.yml
  title: ''
  type: Conventions
  url: conventions/interos-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/interos/refs/heads/main/errors/interos-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/interos-problem-types.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/interos/refs/heads/main/rate-limits/interos-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/interos-rate-limits.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/interos/refs/heads/main/lifecycle/interos-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/interos-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/interos/refs/heads/main/conformance/interos-conformance.yml
  title: ''
  type: Conformance
  url: conformance/interos-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/interos/refs/heads/main/data-model/interos-data-model.yml
  title: ''
  type: DataModel
  url: data-model/interos-data-model.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/interos/refs/heads/main/well-known/interos-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/interos-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/interos/refs/heads/main/security/interos-domain-security.yml
  title: ''
  type: DomainSecurity
