...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sketch/refs/heads/main/security/sketch-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/sketch-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sketch/refs/heads/main/security/sketch-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/sketch-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sketch/refs/heads/main/security/sketch-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Sketch publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Design, Collaboration, Prototyping, Workspace, and Documents.
