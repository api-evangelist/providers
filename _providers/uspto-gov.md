...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/uspto-gov/refs/heads/main/capabilities/uspto-gov-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/uspto-gov-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/uspto-gov/refs/heads/main/agentic-access/uspto-gov-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/uspto-gov-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/uspto-gov/refs/heads/main/security/uspto-gov-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/uspto-gov-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/uspto-gov/refs/heads/main/authentication/uspto-gov-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/uspto-gov/refs/heads/main/vocabulary/uspto-gov-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/uspto-gov-vocabulary.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/uspto-gov/refs/heads/main/rate-limits/uspto-gov-rate-limits.yml
  title: ''
  type: RateLimits
...
- group: docs
  ...
  url: https://developer.uspto.gov/
created: '2026-05-25'
description: The United States Patent and Trademark Office publishes open data APIs for patents and trademarks, covering applications, assignments, citations, appeals and PTAB decisions, trademark status and document retrieval (TSDR), and bulk datasets.
