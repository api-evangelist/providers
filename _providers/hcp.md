...
- collection_type: open
  name: HCP Vault Secrets Apps API
  slug: open-hcp-apps-api
- collection_type: open
  name: HCP Vault Secrets Apps Gateway API
  slug: open-hcp-gateway-api
- collection_type: open
  name: HCP Vault Secrets Apps Integrations API
  slug: open-hcp-integrations-api
- collection_type: open
  name: HCP Vault Apps Secrets API
  slug: open-hcp-secrets-api
- collection_type: open
  name: HCP Vault Secrets Apps Sync API
  slug: open-hcp-sync-api
- collection_type: open
  name: HCP Vault Secrets API
  slug: open-hcp
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/hcp/refs/heads/main/agentic-access/hcp-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/hcp-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hcp/refs/heads/main/security/hcp-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/hcp-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hcp/refs/heads/main/authentication/hcp-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'HashiCorp Cloud Platform publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Apps API, Gateway API, Integrations API, and 6 more. Tagged areas include Cloud, Infrastructure, DevOps, Secrets Management, and Service Networking.
