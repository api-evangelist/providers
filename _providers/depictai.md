...
- group: docs
  title: ''
  type: Documentation
  url: https://docs.depict.ai/headless/introduction
- group: docs
  title: ''
  type: APIReference
...
- group: auth
  title: ''
  type: Security
  url: https://docs.depict.ai/reference/security
- group: build
  title: ''
...
- kind: domain-security
  name: Depictai Domain Security
  slug: depictai-domain-security
  summary_line: TLSv1.3 · HSTS · DMARC
- kind: vulnerability-disclosure
  name: Depictai Vulnerability Disclosure
  slug: depictai-vulnerability-disclosure
