...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/practicepanther/refs/heads/main/capabilities/practicepanther-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/practicepanther-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/practicepanther/refs/heads/main/agentic-access/practicepanther-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/practicepanther-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/practicepanther/refs/heads/main/security/practicepanther-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/practicepanther-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/practicepanther/refs/heads/main/authentication/practicepanther-authentication.yml
  title: ''
  type: Authentication
  url: authentication/practicepanther-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/practicepanther/refs/heads/main/scopes/practicepanther-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/practicepanther-scopes.yml
- group: company
  title: ''
  type: Website
...
- group: docs
  title: ''
  type: Documentation
  url: https://support.practicepanther.com/en/collections/340699-api
- group: company
  title: ''
  type: Blog
  url: https://www.practicepanther.com/blog/
- group: commercial
  title: ''
  type: Pricing
  url: https://www.practicepanther.com/pricing/
- group: operate
  title: ''
  type: StatusPage
  url: https://practicepanther.statuspage.io/
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/practicepanther-law-practice-management-software
- group: other
  title: ''
  type: X
  url: https://x.com/practicepanther
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/practicepanther/refs/heads/main/plans/practicepanther-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/practicepanther-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/practicepanther/refs/heads/main/rate-limits/practicepanther-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/practicepanther-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/practicepanther/refs/heads/main/finops/practicepanther-finops.yml
  title: ''
  type: FinOps
  url: finops/practicepanther-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/practicepanther/refs/heads/main/vocabulary/practicepanther-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/practicepanther-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/practicepanther/refs/heads/main/json-ld/practicepanther-context.jsonld
  title: ''
  type: JSONLDContext
  url: json-ld/practicepanther-context.jsonld
created: '2026-06-13'
description: Cloud-based legal practice management with a REST API for managing cases, contacts, tasks, time tracking, billing, and trust accounting.
examples:
- key_count: 8
  name: Practicepanther Account Example
  slug: practicepanther-account-example
- key_count: 9
  name: Practicepanther Expense Example
  slug: practicepanther-expense-example
- key_count: 9
  name: Practicepanther Payment Example
  slug: practicepanther-payment-example
- key_count: 11
  name: Practicepanther Project Example
  slug: practicepanther-project-example
- key_count: 11
  name: Practicepanther Timeentry Example
  slug: practicepanther-timeentry-example
finops:
- name: Practicepanther Finops
  service_category: ''
  slug: practicepanther-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/practicepanther.png
json_schemas:
- name: Account
  property_count: 89
  slug: practicepanther-account
- name: Activity
  property_count: 70
  slug: practicepanther-activity
- name: Address
  property_count: 26
  slug: practicepanther-address
- name: Attachment
  property_count: 10
  slug: practicepanther-attachment
- name: BankAccount
  property_count: 37
  slug: practicepanther-bankaccount
- name: Contact
  property_count: 29
  slug: practicepanther-contact
- name: CustomField
  property_count: 24
  slug: practicepanther-customfield
- name: Expense
  property_count: 45
  slug: practicepanther-expense
- name: Payment
  property_count: 81
  slug: practicepanther-payment
- name: Project
  property_count: 71
  slug: practicepanther-project
- name: SaleDocument
  property_count: 84
  slug: practicepanther-saledocument
- name: Tag
  property_count: 17
  slug: practicepanther-tag
- name: TimeEntry
  property_count: 37
  slug: practicepanther-timeentry
- name: User
  property_count: 83
  slug: practicepanther-user
- name: Workflow
  property_count: 16
  slug: practicepanther-workflow
jsonld:
- class_count: 0
  name: Practicepanther Context
  property_count: 56
  slug: practicepanther-context
layout: provider
modified: '2026-06-13'
name: PracticePanther
nav: Providers
network: true
overview: 'PracticePanther publishes 40 APIs on the [APIs.io](https://apis.io/) network, including Account API, AccountingSnapshot API, Activity API, and 37 more. Tagged areas include Legal, Law Practice Management, Case Management, Billing, and Trust Accounting.
...
- limit_count: 0
  ...
  slug: practicepanther-rate-limits
rules:
- effective_rule_count: 5
  extends: []
  name: PracticePanther API Rules
  rule_count: 5
  severity_counts:
    error: 0
    hint: 0
    info: 2
    warn: 3
  slug: practicepanther-jsonschema-spectral-rules
scopes:
