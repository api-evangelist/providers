...
- description: Read an album, enumerate its items, then resolve the first track and its artist.
  ...
  slug: tidal-album-tracklist-workflow
- description: Resolve an artist, then walk their albums, top tracks, and similar artists.
  name: TIDAL Artist Discography Explorer
  slug: tidal-artist-discography-workflow
- description: Read the user's saved tracks, then enrich the first track with its catalog detail.
  name: TIDAL Browse Collection Tracks
  slug: tidal-browse-collection-tracks-workflow
- description: Create a new playlist, then add a track to its items relationship.
  name: TIDAL Create Playlist and Add Tracks
  slug: tidal-create-playlist-and-add-tracks-workflow
- description: Read the user's discovery mix, enumerate its items, then resolve the first track.
  name: TIDAL Discovery Mix Tracks
  slug: tidal-discovery-mix-tracks-workflow
- description: Search for a track, confirm it, then add it to the user's collection.
  name: TIDAL Search and Save Track to Collection
  slug: tidal-search-and-save-track-to-collection-workflow
- description: Run a catalog search, pick a matching track, then resolve that track and its album.
  name: TIDAL Search to Track and Album
  slug: tidal-search-to-track-album-workflow
- description: Resolve a track by ISRC, confirm it, then fetch its playback manifest.
  name: TIDAL Track Playback Manifest
  slug: tidal-track-playback-manifest-workflow
...
- collection_type: postman
  ...
  slug: postman-tidal-catalog-api
- collection_type: postman
  name: TIDAL Claims API
  slug: postman-tidal-claims-api
- collection_type: postman
  name: TIDAL Commerce API
  slug: postman-tidal-commerce-api
- collection_type: postman
  name: TIDAL Playback API
  slug: postman-tidal-playback-api
- collection_type: postman
  name: TIDAL Playlists API
  slug: postman-tidal-playlists-api
- collection_type: postman
  name: TIDAL Recommendations API
  slug: postman-tidal-recommendations-api
- collection_type: postman
  name: TIDAL Search API
  slug: postman-tidal-search-api
- collection_type: postman
  name: TIDAL Social API
  slug: postman-tidal-social-api
- collection_type: postman
  name: TIDAL User Collections API
  slug: postman-tidal-user-collections-api
- collection_type: postman
  name: TIDAL Users API
...
- name: Tidal Finops
  ...
  slug: tidal-finops
graphqls:
- description: TIDAL is a music streaming service offering high-fidelity audio. The API covers track catalog, artist pages, album details, playlist management, user library, music metadata, and high-fidelity audio q
  name: TIDAL GraphQL API
  slug: tidal-graphql
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/tidal.png
json_schemas:
- name: TIDAL Album
  property_count: 5
  slug: tidal-album
...
nav: Providers
network: true
overview: 'TIDAL publishes 65 APIs on the [APIs.io](https://apis.io/) network, including Playlists API, Users API, acceptedTerms API, and 62 more. Tagged areas include Music, Streaming, Hi-Fi, HiRes Lossless, and Audio.
...
- kind: vulnerability-disclosure
  name: Tidal Vulnerability Disclosure
  slug: tidal-vulnerability-disclosure
