...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/langwatch/refs/heads/main/capabilities/langwatch-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/langwatch/refs/heads/main/agentic-access/langwatch-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/langwatch-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/langwatch/refs/heads/main/security/langwatch-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/langwatch-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/langwatch/refs/heads/main/security/langwatch-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/langwatch-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/langwatch/refs/heads/main/authentication/langwatch-authentication.yml
  title: ''
  type: Authentication
  url: authentication/langwatch-authentication.yml
- group: start
  title: ''
  type: Portal
...
- group: docs
  title: ''
  type: Documentation
  url: https://langwatch.ai/docs/
- group: start
  title: ''
  type: GettingStarted
  url: https://langwatch.ai/docs/integration/quickstart
- group: docs
  title: ''
  type: Documentation
  url: https://langwatch.ai/docs/api-reference
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/langwatch/refs/heads/main/openapi/_original/langwatch-openapi.json
  title: ''
  type: OpenAPI
...
- group: start
  title: ''
  type: Signup
  url: https://app.langwatch.ai/auth/signup
- group: commercial
  title: ''
  type: Pricing
  url: https://langwatch.ai/pricing
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/langwatch/refs/heads/main/plans/langwatch-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/langwatch-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/langwatch/refs/heads/main/rate-limits/langwatch-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/langwatch-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/langwatch/refs/heads/main/finops/langwatch-finops.yml
  title: ''
  type: FinOps
  url: finops/langwatch-finops.yml
- group: docs
  title: ''
  type: Documentation
  url: https://langwatch.ai/docs/self-hosting/overview
- group: docs
  title: ''
  type: Documentation
  url: https://langwatch.ai/docs/observability
- group: docs
  title: ''
  type: Documentation
  url: https://langwatch.ai/docs/evaluations
- group: docs
  title: ''
  type: Documentation
  url: https://langwatch.ai/docs/prompt-management
- group: docs
  title: ''
  type: Documentation
  url: https://langwatch.ai/docs/simulations
- group: docs
  title: ''
  type: Documentation
...
- group: build
  title: ''
  type: SourceCode
  url: https://github.com/langwatch/langevals
- group: build
  title: ''
  type: SourceCode
  url: https://github.com/langwatch/cookbooks
- group: build
  title: ''
  type: SourceCode
  url: https://github.com/langwatch/skills
- group: build
  title: ''
  type: SDKs
  url: https://pypi.org/project/langwatch/
- group: build
  title: ''
  type: SDKs
  url: https://www.npmjs.com/package/langwatch
- group: docs
  title: ''
  type: Documentation
  url: https://www.npmjs.com/package/@langwatch/mcp-server
- group: commercial
  title: ''
  type: License
  url: https://github.com/langwatch/langwatch/blob/main/LICENSE
- group: commercial
  title: ''
  type: TermsOfService
  url: https://langwatch.ai/terms
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://langwatch.ai/privacy
- group: company
  title: ''
  type: Blog
  url: https://langwatch.ai/blog
- group: operate
  title: ''
  type: ChangeLog
  url: https://langwatch.ai/docs/changelog
- group: operate
  title: ''
  type: Forums
...
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/langwatch
- group: company
  title: ''
  type: Twitter
  url: https://twitter.com/langwatchai
- group: learn
  title: ''
  type: YouTube
  url: https://www.youtube.com/@langwatch
created: '2026-05-25'
...
finops:
- name: Langwatch Finops
  service_category: AI and Machine Learning
  slug: langwatch-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/langwatch.png
jsonld:
- class_count: 56
  name: Langwatch Context
  property_count: 0
...
overview: 'LangWatch publishes 28 APIs on the [APIs.io](https://apis.io/) network, including Agents API, Analytics API, Annotations API, and 25 more. Tagged areas include Artificial Intelligence, LLM, LLM Observability, LLM Evaluation, and Agent Testing.
  ...
  LangWatch''s developer surface includes authentication, developer portal, documentation, getting-started guide, signup flow, pricing, engineering blog, and 39 more developer resources.'
plans:
...
security:
- kind: authentication
  name: Langwatch Authentication
  slug: langwatch-authentication
  summary_line: apiKey/http · 2 schemes
- kind: domain-security
  name: Langwatch Domain Security
  slug: langwatch-domain-security
  summary_line: TLSv1.3 · HSTS · DMARC
- kind: trust-center
  name: Langwatch Trust Center
  slug: langwatch-trust-center
