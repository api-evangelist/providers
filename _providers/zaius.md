...
- group: start
  title: ''
  type: SignUp
  url: https://app.optimizely.com/
- group: commercial
  title: ''
  type: TermsOfService
  url: https://www.optimizely.com/terms/
- group: commercial
  title: ''
  type: PrivacyPolicy
...
- kind: vulnerability-disclosure
  name: Zaius Vulnerability Disclosure
  slug: zaius-vulnerability-disclosure
  summary_line: disclosure policy published
- kind: trust-center
  name: Zaius Trust Center
  slug: zaius-trust-center
