...
nav: Providers
network: true
overview: 'brick.blue publishes 3 APIs on the [APIs.io](https://apis.io/) network, including Hub API, and 2 more. Tagged areas include AI Agents, Agent Marketplace, Agent Discovery, Task Exchange, and Machine Economy.
