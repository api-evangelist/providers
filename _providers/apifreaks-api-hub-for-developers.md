...
- group: start
  ...
  url: https://apifreaks.com/api
- group: docs
  title: ''
  type: Documentation
  url: https://apifreaks.com/docs
- group: docs
  title: ''
  type: APIReference
  url: https://apifreaks.com/api/swagger
- group: start
  title: ''
  type: GettingStarted
  url: https://apifreaks.com/docs
...
- group: build
  ...
  url: https://github.com/api-freaks
- group: company
  title: ''
  type: Blog
  url: https://apifreaks.com/resources/blogs
- group: commercial
  title: ''
  type: Pricing
  url: https://apifreaks.com/pricing
- group: start
  title: ''
  type: SignUp
  url: https://apifreaks.com/signup
- group: start
  title: ''
  type: Login
  url: https://apifreaks.com/login
- group: commercial
  title: ''
  type: TermsOfService
  url: https://apifreaks.com/terms
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://apifreaks.com/privacy-policy
- group: operate
  title: ''
  type: StatusPage
...
nav: Providers
network: true
overview: 'APIFreaks - API Hub for Developers publishes 28 APIs on the [APIs.io](https://apis.io/) network, including Commodity APIs API, Currency APIs API, DNS APIs API, and 25 more. Tagged areas include IP Intelligence, Geolocation, WHOIS, Domain Intelligence, and DNS.
...
- kind: authentication
  ...
  slug: apifreaks-api-hub-for-developers-authentication
  summary_line: apiKey · 2 schemes
- kind: domain-security
  name: Apifreaks Api Hub For Developers Domain Security
  slug: apifreaks-api-hub-for-developers-domain-security
