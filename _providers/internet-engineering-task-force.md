...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/internet-engineering-task-force/refs/heads/main/agentic-access/internet-engineering-task-force-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/internet-engineering-task-force-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/internet-engineering-task-force/refs/heads/main/security/internet-engineering-task-force-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/internet-engineering-task-force-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/internet-engineering-task-force/refs/heads/main/authentication/internet-engineering-task-force-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Internet Engineering Task Force publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Documents API, Framework API, Identity API, and 3 more. Tagged areas include Internet, Protocol, RFC, Standards, and Working Groups.
