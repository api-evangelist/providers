...
- description: Allows TPPs to dynamically register as OAuth clients with ASPSPs by submitting Software Statement Assertions issued by the Open Banking Directory. Supports client creation, retrieval, update, and dele
  name: UK Open Banking Dynamic Client Registration API
  slug: uk-open-banking-dynamic-client-registration-api
...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/open-banking-uk/refs/heads/main/capabilities/open-banking-uk-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/open-banking-uk/refs/heads/main/agentic-access/open-banking-uk-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/open-banking-uk-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/open-banking-uk/refs/heads/main/security/open-banking-uk-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/open-banking-uk-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/open-banking-uk/refs/heads/main/authentication/open-banking-uk-authentication.yml
  title: ''
  type: Authentication
  url: authentication/open-banking-uk-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/open-banking-uk/refs/heads/main/scopes/open-banking-uk-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/open-banking-uk-scopes.yml
- group: company
  title: ''
  type: Website
...
- group: build
  ...
  url: https://github.com/OpenBankingUK
- group: other
  title: ''
  type: APIPerformance
  url: https://www.openbanking.org.uk/api-performance/
- group: company
  title: ''
  type: Blog
  url: https://www.openbanking.org.uk/news/blog/
- group: company
  title: ''
  type: News
  url: https://www.openbanking.org.uk/news/
- group: commercial
  title: ''
  type: TermsOfService
...
- group: commercial
  title: ''
  type: Plans
  url: https://raw.githubusercontent.com/api-evangelist/open-banking-uk/refs/heads/main/plans/plans.yml
- group: operate
  title: ''
  type: RateLimits
...
- group: commercial
  title: ''
  type: FinOps
  url: https://raw.githubusercontent.com/api-evangelist/open-banking-uk/refs/heads/main/finops/finops.yml
created: '2026-06-13'
description: UK Open Banking standard with REST APIs for account and transaction data, payment initiation, variable recurring payments, and confirmation of funds for regulated financial services. Governed by the Open Banking Implementation Entity (OBIE) and overseen by the FCA and PSR under PSD2 and the CMA Order.
examples:
- key_count: 5
  name: Account Info Examples
  slug: account-info-examples
- key_count: 5
  name: Confirmation Funds Examples
  slug: confirmation-funds-examples
- key_count: 5
  name: Event Notifications Examples
  slug: event-notifications-examples
- key_count: 5
  name: Events Examples
  slug: events-examples
- key_count: 5
  name: Payment Initiation Examples
  slug: payment-initiation-examples
- key_count: 5
  name: Vrp Examples
  slug: vrp-examples
finops:
- name: Finops
  service_category: ''
  slug: finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/open-banking-uk.png
json_schemas:
...
nav: Providers
network: true
overview: 'UK Open Banking publishes 42 APIs on the [APIs.io](https://apis.io/) network, including Account Access Consents API, Accounts API, ATM API, and 39 more. Tagged areas include Open Banking, Financial Services, Payments, Account Information, and PSD2.
...
- effective_rule_count: 6
  extends: []
  name: UK Open Banking API Rules
  rule_count: 6
  severity_counts:
    error: 0
    hint: 0
    info: 1
    warn: 5
  slug: open-banking-uk-jsonschema-spectral-rules
scopes:
