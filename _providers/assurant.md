...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/assurant/refs/heads/main/capabilities/assurant-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/assurant-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/assurant/refs/heads/main/agentic-access/assurant-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/assurant-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/assurant/refs/heads/main/security/assurant-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/assurant-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/assurant/refs/heads/main/authentication/assurant-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Assurant publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Claims API, Enrollments API, Policies API, and 2 more. Tagged areas include Insurance, Device Protection, Embedded Insurance, Housing, and Claims.


  Assurant''s developer surface includes authentication, developer portal, signup flow, and 7 more developer resources.'
plans:
