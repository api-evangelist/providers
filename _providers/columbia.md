...
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/columbia/refs/heads/main/examples/index.yml
  title: ''
  type: Examples
  url: examples/index.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/columbia/refs/heads/main/rules/columbia-rules.yml
  title: ''
  type: Rules
  url: rules/columbia-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/columbia/refs/heads/main/vocabulary/columbia-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/columbia-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/columbia/refs/heads/main/json-ld/columbia-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/columbia-context.jsonld
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/columbia/refs/heads/main/authentication/columbia-authentication.yml
  title: ''
  type: Authentication
  url: authentication/columbia-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/columbia/refs/heads/main/scopes/columbia-scopes.yml
  title: ''
  type: Scopes
  url: scopes/columbia-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/columbia/refs/heads/main/errors/columbia-errors.yml
  title: ''
  type: Errors
  url: errors/columbia-errors.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/columbia/refs/heads/main/conformance/columbia-conformance.yml
  title: ''
  type: Conformance
  url: conformance/columbia-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/columbia/refs/heads/main/lifecycle/columbia-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/columbia-lifecycle.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/columbia/refs/heads/main/agentic-access/columbia-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/columbia-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/columbia/refs/heads/main/security/columbia-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/columbia-domain-security.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/columbia/refs/heads/main/plans/columbia-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/columbia-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/columbia/refs/heads/main/rate-limits/columbia-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/columbia-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/columbia/refs/heads/main/finops/columbia-finops.yml
  title: ''
  type: FinOps
  url: finops/columbia-finops.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/columbia/refs/heads/main/review.yml
  title: ''
  type: Review
  url: review.yml
created: '2026-06-03'
...
nav: Providers
network: true
overview: 'Columbia University publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Locations API, and 9 more. Tagged areas include University, Higher Education, Education, Ivy League, and Private Research University.
