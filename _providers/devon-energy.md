...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://www.devon-energy.com'', ''status'': 302, ''note'': ''declared website redirects to hugedomains.com — a domain sales/parking service, so the domain has lapsed rather than moved to an acquirer (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
description: Devon Energy Corporation. Profile pending re-enrichment against the corrected website (www.devonenergy.com); the prior description was harvested from a domain-parking page and has been removed.
...
nav: Providers
network: true
overview: Devon Energy is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Fortune 500.
press:
- date: '2026-05-25'
