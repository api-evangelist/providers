...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/corelogic/refs/heads/main/capabilities/corelogic-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/corelogic-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/corelogic/refs/heads/main/agentic-access/corelogic-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/corelogic-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/corelogic/refs/heads/main/security/corelogic-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/corelogic-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/corelogic/refs/heads/main/authentication/corelogic-authentication.yml
  title: ''
  type: Authentication
  url: authentication/corelogic-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/corelogic/refs/heads/main/scopes/corelogic-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/corelogic/refs/heads/main/vocabulary/corelogic-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/corelogic-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/corelogic/refs/heads/main/json-ld/corelogic-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/corelogic-context.jsonld
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/corelogic/refs/heads/main/plans/corelogic-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/corelogic-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/corelogic/refs/heads/main/rate-limits/corelogic-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/corelogic-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/corelogic/refs/heads/main/finops/corelogic-finops.yml
  title: ''
  type: FinOps
