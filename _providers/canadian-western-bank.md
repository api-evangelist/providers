...
access_model:
  ...
  source:
  - security
  - '{''url'': ''https://www.cwbank.com/'', ''status'': 301, ''note'': ''declared website redirects to https://www.nbc.ca/en/business.html — a different registrable domain (cwbank.com -> nbc.ca), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/canadian-western-bank/refs/heads/main/security/canadian-western-bank-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/canadian-western-bank-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/canadian-western-bank/refs/heads/main/llms/canadian-western-bank-llms.txt
  title: ''
  type: LLMsTxt
