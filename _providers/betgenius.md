...
nav: Providers
network: true
overview: 'BetGenius is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Sportsbook, Sports Betting, Sports Data, Odds Feeds, and Trading Services.
