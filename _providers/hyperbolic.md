...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/hyperbolic/refs/heads/main/agentic-access/hyperbolic-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/hyperbolic-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hyperbolic/refs/heads/main/security/hyperbolic-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/hyperbolic-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hyperbolic/refs/heads/main/authentication/hyperbolic-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/hyperbolic/refs/heads/main/plans/hyperbolic-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/hyperbolic-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/hyperbolic/refs/heads/main/rate-limits/hyperbolic-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/hyperbolic-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/hyperbolic/refs/heads/main/finops/hyperbolic-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Hyperbolic publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Audio API, Chat API, Completions API, and 4 more. Tagged areas include Artificial Intelligence, LLM, Inference, GPU, and Open Source.
