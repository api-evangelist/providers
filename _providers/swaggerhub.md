...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/swaggerhub/refs/heads/main/agentic-access/swaggerhub-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/swaggerhub-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/swaggerhub/refs/heads/main/security/swaggerhub-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/swaggerhub-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/swaggerhub/refs/heads/main/authentication/swaggerhub-authentication.yml
  title: ''
  type: Authentication
  url: authentication/swaggerhub-authentication.yml
- group: company
  title: ''
  type: LinkedIn
...
examples:
- key_count: 3
  name: Swaggerhub Create Api Example
  slug: swaggerhub-create-api-example
- key_count: 3
  name: Swaggerhub Search Apis Example
  slug: swaggerhub-search-apis-example
finops:
- name: Swaggerhub Finops
  service_category: API
  slug: swaggerhub-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/swaggerhub.png
json_schemas:
- name: SwaggerHub API Entry
  property_count: 8
  slug: swaggerhub-api-entry
json_structures:
- name: Swaggerhub Api Entry Structure
  property_count: 0
  slug: swaggerhub-api-entry-structure
jsonld:
- class_count: 0
