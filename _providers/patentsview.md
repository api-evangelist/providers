...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/patentsview/refs/heads/main/security/patentsview-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: PatentsView publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Patents and Public APIs.
random_paper: 0
score:
  band: minimal
  composite: 5.7
