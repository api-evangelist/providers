...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/brunswick/refs/heads/main/security/brunswick-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/brunswick-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/brunswick-corporation
- group: company
  title: ''
  type: Website
  url: https://www.brunswick.com
- group: company
  title: ''
  type: InvestorRelations
  url: https://ir.brunswick.com
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://www.brunswick.com/privacy-policy
- group: commercial
  title: ''
  type: TermsOfService
  url: https://www.brunswick.com/terms-of-use
- group: company
  title: ''
  type: Blog
  url: https://www.brunswick.com/news
created: '2026-03-23'
description: 'Brunswick Corporation is a global leader in marine recreation and technology, headquartered in Mettawa, Illinois (NYSE: BC). Brunswick owns over 60 brands across marine propulsion (Mercury Marine, Mercury Racing, MerCruiser, Fliteboard), boat manufacturing (Boston Whaler, Sea Ray, Bayliner, Lund, Crestliner, Harris, Lowe, heyday), and marine parts and accessories (Navico Group: B&G, C-Map, Lowrance, Simrad). The company''s ACES innovation strategy centers on Autonomy/Assistance, Connectivity, Electrification, and Shared Access.'
