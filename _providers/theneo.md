...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/theneo/refs/heads/main/agentic-access/theneo-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/theneo-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/theneo/refs/heads/main/security/theneo-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/theneo-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/theneo/refs/heads/main/security/theneo-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/theneo-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/theneo/refs/heads/main/authentication/theneo-authentication.yml
  title: ''
  type: Authentication
...
overview: 'Theneo publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Import API, Projects API, Publishing API, and 2 more. Tagged areas include API Documentation, Developer Portal, Developer Tools, Documentation Platform, and Artificial Intelligence.
  ...
  Theneo''s developer surface includes authentication, documentation, FAQ, pricing, engineering blog, signup flow, and 12 more developer resources.'
plans:
