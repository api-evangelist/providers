...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mediabeacon/refs/heads/main/security/mediabeacon-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'MediaBeacon publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Digital Asset Management, Integration, and Media.
