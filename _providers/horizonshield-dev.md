...
nav: Providers
network: true
overview: 'HORIZON SHIELD publishes 7 APIs on the [APIs.io](https://apis.io/) network, including MCP Verification Gate (MCP conduct register) API, and 6 more. Tagged areas include Construction, Renovation, Cost Estimation, Fair Pricing, and Consumer Protection.
