...
- group: operate
  title: ''
  type: Releases
  url: https://github.com/meshery/meshery/releases
- group: auth
  title: ''
  type: SecurityPolicy
  url: https://github.com/meshery/meshery/blob/master/SECURITY.md
- group: build
  title: ''
  type: CodeOfConduct
  url: https://github.com/meshery/meshery/blob/master/CODE_OF_CONDUCT.md
- group: docs
  title: ''
  type: ContributionGuide
  url: https://github.com/meshery/meshery/blob/master/CONTRIBUTING.md
- group: commercial
  title: ''
  type: License
  url: https://github.com/meshery/meshery/blob/master/LICENSE
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/meshery/refs/heads/main/security/meshery-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/meshery-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/showcase/meshery
- group: company
  title: ''
  type: Website
...
- group: start
  ...
  url: https://docs.meshery.io/reference
- group: build
  title: ''
  type: SourceCode
...
- group: start
  title: ''
  type: Signup
  url: https://meshery.io/playground
- group: company
  title: ''
  type: Blog
...
- group: commercial
  title: ''
  type: TermsOfService
  url: https://layer5.io/company/legal/terms-of-service
- group: commercial
  title: ''
  type: PrivacyPolicy
