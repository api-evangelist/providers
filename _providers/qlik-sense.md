...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/qlik-sense/refs/heads/main/capabilities/qlik-sense-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/qlik-sense-capability-edges.yml
- group: build
  title: ''
  type: PostmanWorkspace
  url: https://www.postman.com/kinlaneapi/qlik-sense/overview
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/qlik-sense/refs/heads/main/agentic-access/qlik-sense-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/qlik-sense-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/qlik-sense/refs/heads/main/security/qlik-sense-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/qlik-sense-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/qlik-sense/refs/heads/main/authentication/qlik-sense-authentication.yml
  title: ''
  type: Authentication
...
overview: 'Qlik Sense publishes 3 APIs on the [APIs.io](https://apis.io/) network: Apps API, Reloads API, and Spaces API. Tagged areas include Analytics, Business Intelligence, Cloud, Data Integration, and Visualization.
  ...
  Qlik Sense''s developer surface includes authentication, developer portal, documentation, getting-started guide, support, engineering blog, signup flow, and 16 more developer resources.'
plans:
