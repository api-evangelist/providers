...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jabil-circuit/refs/heads/main/security/jabil-circuit-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/jabil-circuit-domain-security.yml
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/JABIL
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/jabil
- group: company
  title: ''
  type: Website
...
created: '2026-03-24'
description: Jabil (formerly Jabil Circuit) is a global manufacturing services and solutions company providing comprehensive electronics design, production, and product management services to electronics and technology companies in a broad range of industries.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/jabil-circuit.png
layout: provider
modified: '2026-04-28'
name: Jabil Circuit
nav: Providers
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/jabil-circuit/refs/heads/main/screenshots/jabil-circuit-2026-06-20T183646.png
security:
- kind: domain-security
  name: Jabil Circuit Domain Security
  slug: jabil-circuit-domain-security
