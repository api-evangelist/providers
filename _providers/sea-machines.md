...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sea-machines/refs/heads/main/security/sea-machines-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sea-machines/refs/heads/main/plans/sea-machines-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/sea-machines-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/sea-machines/refs/heads/main/rate-limits/sea-machines-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/sea-machines-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sea-machines/refs/heads/main/finops/sea-machines-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Sea Machines Robotics publishes 5 APIs on the [APIs.io](https://apis.io/) network, including SMLink Streaming-API, SMLink Control-API, and 3 more. Tagged areas include Marine, Autonomy, Robotics, Maritime, and Computer Vision.
