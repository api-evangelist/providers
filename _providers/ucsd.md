...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/ucsd/refs/heads/main/capabilities/ucsd-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ucsd/refs/heads/main/agentic-access/ucsd-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/ucsd-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ucsd/refs/heads/main/security/ucsd-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/ucsd-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ucsd/refs/heads/main/authentication/ucsd-authentication.yml
  title: ''
  type: Authentication
  url: authentication/ucsd-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ucsd/refs/heads/main/conformance/ucsd-conformance.yml
  title: ''
  type: Conformance
  url: conformance/ucsd-conformance.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ucsd/refs/heads/main/scopes/ucsd-scopes.yml
  title: ''
  type: Scopes
  url: scopes/ucsd-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ucsd/refs/heads/main/errors/ucsd-errors.yml
  title: ''
  type: Errors
  url: errors/ucsd-errors.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ucsd/refs/heads/main/lifecycle/ucsd-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/ucsd-lifecycle.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/ucsd/refs/heads/main/plans/ucsd-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/ucsd-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/ucsd/refs/heads/main/rate-limits/ucsd-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/ucsd-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/ucsd/refs/heads/main/finops/ucsd-finops.yml
  title: ''
  type: FinOps
  url: finops/ucsd-finops.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/ucsd/refs/heads/main/review.yml
  title: ''
  type: Review
  url: review.yml
created: '2026-06-03'
...
nav: Providers
network: true
overview: 'University of California, San Diego publishes 13 APIs on the [APIs.io](https://apis.io/) network, including TritonAI Developer API — chat, TritonAI Developer API — completions, TritonAI Developer API — embeddings, and 10 more. Tagged areas include Education, Higher Education, University, Public Research University, and UC System.
