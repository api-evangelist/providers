...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/noonswoon/refs/heads/main/security/noonswoon-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: Noonswoon is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Startups, Mobile, Consumer, and Social.
random_paper: 18
score:
  band: minimal
  composite: 5.3
