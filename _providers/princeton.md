...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/princeton/refs/heads/main/conformance/princeton-conformance.yml
  title: ''
  type: Conformance
  url: conformance/princeton-conformance.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/princeton/refs/heads/main/authentication/princeton-authentication.yml
  title: ''
  type: Authentication
  url: authentication/princeton-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/princeton/refs/heads/main/errors/princeton-errors.yml
  title: ''
  type: ErrorCatalog
  url: errors/princeton-errors.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/princeton/refs/heads/main/vocabulary/princeton-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/princeton-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/princeton/refs/heads/main/rules/princeton-openapi-spectral-rules.yml
  title: ''
  type: SpectralRules
  url: rules/princeton-openapi-spectral-rules.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/princeton/refs/heads/main/scopes/princeton-scopes.yml
  title: ''
  type: Scopes
  url: scopes/princeton-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/princeton/refs/heads/main/lifecycle/princeton-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/princeton-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/princeton/refs/heads/main/json-ld/princeton-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/princeton-context.jsonld
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/princeton/refs/heads/main/security/princeton-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/princeton-domain-security.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/princeton/refs/heads/main/plans/princeton-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/princeton-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/princeton/refs/heads/main/rate-limits/princeton-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/princeton-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/princeton/refs/heads/main/finops/princeton-finops.yml
  title: ''
  type: FinOps
  url: finops/princeton-finops.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/princeton/refs/heads/main/review.yml
  title: ''
  type: Review
  url: review.yml
created: '2026-06-03'
...
nav: Providers
network: true
overview: 'Princeton University publishes 30 APIs on the [APIs.io](https://apis.io/) network, including Art Museum API, Article API, Banner API, and 27 more. Tagged areas include University, Higher Education, Education, Ivy League, and United States.
