...
created: '2024-12-03'
description: The Federal Mediation and Conciliation Service (FMCS) provides mediation and other conflict resolution services for managing and enhancing labor-management relationships.
...
nav: Providers
network: true
overview: 'Federal Mediation and Conciliation Service is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Federal-Government and Labor.
