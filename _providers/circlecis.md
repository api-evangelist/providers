...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/circlecis/refs/heads/main/agentic-access/circlecis-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/circlecis-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/circlecis/refs/heads/main/security/circlecis-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/circlecis-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/circlecis/refs/heads/main/security/circlecis-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/circlecis-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/circlecis/refs/heads/main/security/circlecis-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/circlecis-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/circlecis/refs/heads/main/authentication/circlecis-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'CircleCI publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Context API, Job API, Pipeline API, and 3 more. Tagged areas include CI/CD, Continuous Deployment, Continuous Integration, Developer Tools, and DevOps.
