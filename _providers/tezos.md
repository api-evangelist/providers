...
- group: operate
  title: ''
  type: IssueTracker
  url: https://github.com/baking-bad/tzkt/issues
- group: operate
  title: ''
  type: Releases
  url: https://github.com/baking-bad/tzkt/releases
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/tezos/refs/heads/main/agentic-access/tezos-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/tezos-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tezos/refs/heads/main/security/tezos-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/tezos/refs/heads/main/openapi/_original/openapi.json
  title: ''
  type: OpenAPI
  url: openapi/_original/openapi.json
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/tezos/refs/heads/main/plans/tezos-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/tezos-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/tezos/refs/heads/main/rate-limits/tezos-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/tezos-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/tezos/refs/heads/main/finops/tezos-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Tezos publishes 34 APIs on the [APIs.io](https://apis.io/) network, including Accounts API, BigMaps API, Blocks API, and 31 more. Tagged areas include Tezos, Blockchain, TzKT, Baking Bad, and Cryptocurrency.


  The Tezos catalog on APIs.io includes 2 JSON-LD contexts and 1 Spectral governance ruleset.


  Tezos'' developer surface includes documentation, status page, engineering blog, and 15 more developer resources.'
plans:
