...
nav: Providers
network: true
overview: 'Plex publishes 31 APIs on the [APIs.io](https://apis.io/) network, including Activities API, Butler API, Collections API, and 28 more. Tagged areas include Company, Media, Streaming, Video, and Music.
