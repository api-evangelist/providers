...
- group: commercial
  title: ''
  type: Pricing
  url: https://app.trint.com/plans
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/trint/refs/heads/main/capabilities/trint-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/trint-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/trint/refs/heads/main/agentic-access/trint-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/trint-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/trint/refs/heads/main/authentication/trint-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/trint/refs/heads/main/plans/trint-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/trint-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/trint/refs/heads/main/rate-limits/trint-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/trint-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/trint/refs/heads/main/finops/trint-finops.yml
  title: ''
  type: FinOps
...
overview: 'Trint publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Export API, Realtime API, Transcripts and Files API, and 3 more. Tagged areas include Audio Transcription, Transcription, Speech-to-Text, Media, and Journalism.
  ...
  Trint''s developer surface includes pricing, authentication, documentation, engineering blog, and 7 more developer resources.'
plans:
- name: Trint Plans Pricing
  plan_count: 5
  slug: trint-plans-pricing
- name: Trint Price Estimates
  plan_count: 0
  slug: trint-price-estimates
random_paper: 11
rate_limits:
- limit_count: 4
