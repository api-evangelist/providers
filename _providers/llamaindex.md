...
- collection_type: open
  ...
  slug: open-llamaindex-llamacloud-index-api
- collection_type: open
  name: LlamaIndex LlamaExtract API
  slug: open-llamaindex-llamaextract-api
- collection_type: open
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/llamaindex/refs/heads/main/agentic-access/llamaindex-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/llamaindex-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/llamaindex/refs/heads/main/security/llamaindex-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/llamaindex-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/llamaindex/refs/heads/main/authentication/llamaindex-authentication.yml
  title: ''
  type: Authentication
  url: authentication/llamaindex-authentication.yml
- group: build
  title: ''
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/llamaindex/refs/heads/main/json-ld/llamaindex-context.jsonld
  title: ''
  type: JSONLD
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/llamaindex/refs/heads/main/json-schema/llamaindex-pipeline-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/llamaindex-pipeline-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/llamaindex/refs/heads/main/json-schema/llamaindex-extraction-agent-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/llamaindex-extraction-agent-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/llamaindex/refs/heads/main/json-schema/llamaindex-parse-job-schema.json
  title: ''
  type: JSONSchema
...
- name: CreateExtractionAgentRequest
  property_count: 5
  slug: llamaindex-createextractionagentrequest
- name: CreateExtractionJobRequest
  property_count: 2
  slug: llamaindex-createextractionjobrequest
- name: CreateIndexRequest
  property_count: 4
  slug: llamaindex-createindexrequest
- name: CreatePipelineRequest
  property_count: 3
  slug: llamaindex-createpipelinerequest
- name: CreateProjectRequest
  property_count: 1
  slug: llamaindex-createprojectrequest
- name: DataSink
  property_count: 4
  slug: llamaindex-datasink
- name: DataSource
  property_count: 6
  slug: llamaindex-datasource
- name: DataSourceInput
  property_count: 4
  slug: llamaindex-datasourceinput
- name: LlamaIndex Extraction Agent
  property_count: 9
  slug: llamaindex-extraction-agent
- name: ExtractionAgent
  property_count: 7
  slug: llamaindex-extractionagent
- name: ExtractionJob
  property_count: 6
  slug: llamaindex-extractionjob
- name: ExtractionResult
  property_count: 2
  slug: llamaindex-extractionresult
- name: File
  property_count: 6
  slug: llamaindex-file
- name: FileExtractionResult
  property_count: 5
  slug: llamaindex-fileextractionresult
- name: Index
  property_count: 8
  slug: llamaindex-index
- name: IndexFile
  property_count: 4
  slug: llamaindex-indexfile
- name: IndexFileCounts
  property_count: 5
  slug: llamaindex-indexfilecounts
- name: IndexFileInput
  property_count: 2
  slug: llamaindex-indexfileinput
- name: IndexJob
  property_count: 5
  slug: llamaindex-indexjob
- name: LlamaIndex Parse Job
  property_count: 12
  slug: llamaindex-parse-job
- name: ParseJob
  property_count: 8
  slug: llamaindex-parsejob
- name: ParseJobCreated
  property_count: 2
  slug: llamaindex-parsejobcreated
- name: ParsePage
  property_count: 3
  slug: llamaindex-parsepage
- name: ParseRequest
  property_count: 7
  slug: llamaindex-parserequest
- name: ParseResult
  property_count: 5
  slug: llamaindex-parseresult
- name: ParseUploadRequest
  property_count: 2
  slug: llamaindex-parseuploadrequest
- name: LlamaIndex Pipeline
  property_count: 10
  slug: llamaindex-pipeline
- name: PipelineFile
  property_count: 4
  slug: llamaindex-pipelinefile
- name: PipelineFileInput
  property_count: 2
  slug: llamaindex-pipelinefileinput
- name: PipelineJob
  property_count: 5
  slug: llamaindex-pipelinejob
- name: Project
  property_count: 4
  slug: llamaindex-project
- name: RetrievalRequest
  property_count: 3
  slug: llamaindex-retrievalrequest
- name: RetrievalResponse
  property_count: 1
  slug: llamaindex-retrievalresponse
- name: RetrievalResult
  property_count: 3
  slug: llamaindex-retrievalresult
- name: UpdateExtractionAgentRequest
  property_count: 3
  slug: llamaindex-updateextractionagentrequest
json_structures:
- name: Llamaindex Structure
  property_count: 0
  slug: llamaindex-structure
jsonld:
- class_count: 0
...
overview: 'Llamaindex publishes 18 APIs on the [APIs.io](https://apis.io/) network, including Data Sources API, Extraction Agents API, Extraction Jobs API, and 15 more. Tagged areas include Agents, Framework, LLM, Open-Source, and RAG.
  ...
  Llamaindex''s developer surface includes authentication, engineering blog, and 10 more developer resources.'
plans:
