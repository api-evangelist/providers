...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/granite-construction/refs/heads/main/security/granite-construction-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/granite-construction-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/granite-construction
- group: company
  title: ''
  type: Website
...
- group: company
  title: ''
  type: About
  url: https://www.graniteconstruction.com/about
- group: other
  title: ''
  type: Services
  url: https://www.graniteconstruction.com/services
- group: company
  title: ''
  type: Investor Relations
  url: https://investor.graniteconstruction.com/
- group: company
  title: ''
  type: Newsroom
  url: https://www.graniteconstruction.com/newsroom
- group: company
  title: ''
  type: Careers
...
- group: company
  ...
  url: https://www.graniteconstruction.com/newsroom
created: '2026-03-24'
description: Granite Construction is one of the largest diversified heavy civil contractors and construction materials producers in the United States, with operations spanning transportation infrastructure, water infrastructure, mineral exploration, and aggregate materials.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/granite-construction.png
layout: provider
modified: '2026-04-28'
name: Granite Construction
nav: Providers
network: true
overview: 'Granite Construction is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Aggregates, Civil Engineering, Construction, Heavy Civil, and Infrastructure.
...
- kind: domain-security
  name: Granite Construction Domain Security
  slug: granite-construction-domain-security
  summary_line: TLSv1.3 · HSTS · DNSSEC · DMARC
slug: granite-construction
tags:
- Aggregates
- Civil Engineering
- Construction
