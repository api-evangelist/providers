...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/hedera/refs/heads/main/agentic-access/hedera-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/hedera-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/hedera/refs/heads/main/security/hedera-domain-security.yml
  title: ''
  type: DomainSecurity
...
overview: 'Hedera publishes 10 APIs on the [APIs.io](https://apis.io/) network, including accounts API, airdrops API, balances API, and 7 more. Tagged areas include Hedera, Distributed Ledger, Blockchain, DLT, and Hashgraph.
  ...
  Hedera''s developer surface includes developer portal, documentation, GitHub presence, engineering blog, status page, YouTube channel, and 15 more developer resources.'
plans:
- name: Plans
  plan_count: 4
  slug: plans
