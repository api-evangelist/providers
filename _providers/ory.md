...
- baseURL: https://{project-slug}.projects.oryapis.com
  ...
  name: Ory O Auth2 API
  slug: ory-oauth2-api
- baseURL: https://{project-slug}.projects.oryapis.com
  baseurl_source: declared
  description: Well-Known Endpoints
  name: Ory .well Known API
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ory/refs/heads/main/agentic-access/ory-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/ory-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ory/refs/heads/main/security/ory-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/ory-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ory/refs/heads/main/security/ory-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/ory-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ory/refs/heads/main/security/ory-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/ory-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ory/refs/heads/main/authentication/ory-authentication.yml
  title: ''
  type: Authentication
  url: authentication/ory-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ory/refs/heads/main/scopes/ory-scopes.yml
  title: ''
  type: OAuthScopes
...
nav: Providers
network: true
overview: 'Ory publishes 22 APIs on the [APIs.io](https://apis.io/) network, including courier API, frontend API, and 20 more. Tagged areas include Authentication, Authorization, Identity, OpenID Connect, and Open-Source.
