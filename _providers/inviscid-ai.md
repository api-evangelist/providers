...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/inviscid-ai/refs/heads/main/security/inviscid-ai-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Inviscid AI is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Artificial Intelligence, Simulation, Digital Twin, and HVAC.
...
- kind: domain-security
  name: Inviscid Ai Domain Security
  slug: inviscid-ai-domain-security
