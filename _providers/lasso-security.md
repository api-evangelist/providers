...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lasso-security/refs/heads/main/security/lasso-security-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/lasso-security-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lasso-security/refs/heads/main/authentication/lasso-security-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/lasso-security/refs/heads/main/plans/lasso-security-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/lasso-security-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/lasso-security/refs/heads/main/rate-limits/lasso-security-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/lasso-security-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/lasso-security/refs/heads/main/finops/lasso-security-finops.yml
  title: ''
  type: FinOps
