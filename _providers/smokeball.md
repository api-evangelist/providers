...
- acting_count: 118
  ...
  summary_line: 233 operations · 118 acting
api_count: 1
apis:
...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/smokeball/refs/heads/main/capabilities/smokeball-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/smokeball/refs/heads/main/agentic-access/smokeball-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/smokeball-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/smokeball/refs/heads/main/security/smokeball-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/smokeball-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/smokeball/refs/heads/main/authentication/smokeball-authentication.yml
  title: ''
  type: Authentication
  url: authentication/smokeball-authentication.yml
- group: company
  title: ''
  type: Website
...
- group: build
  title: ''
  type: GitHubOrg
  url: https://github.com/smokeballdev
- group: company
  title: ''
  type: LinkedIn
...
- group: company
  title: ''
  type: Blog
  url: https://www.smokeball.com/blog
- group: company
  href: https://raw.githubusercontent.com/api-evangelist/smokeball/refs/heads/main/blogs/blogs.json
  title: ''
  type: BlogFeed
...
- group: commercial
  title: ''
  type: Pricing
  url: https://www.smokeball.com/pricing
- group: operate
  title: ''
  type: StatusPage
  url: https://status.smokeball.com
- group: other
  title: ''
  type: X
  url: https://x.com/smokeballnews
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/smokeball/refs/heads/main/plans/smokeball-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/smokeball-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/smokeball/refs/heads/main/rate-limits/smokeball-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/smokeball-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/smokeball/refs/heads/main/finops/smokeball-finops.yml
  title: ''
  type: FinOps
  url: finops/smokeball-finops.yml
created: '2026-06-13'
description: Legal practice management software with a REST API for managing matters, contacts, documents, time entries, billing, trust accounting, and law firm workflows. The API follows REST principles, accepts JSON, returns JSON, and supports OAuth 2.0 authentication. Available in US, AU, and UK regions.
examples:
- key_count: 8
  name: Smokeball Bankaccount Example
  slug: smokeball-bankaccount-example
- key_count: 5
  name: Smokeball Contact Example
  slug: smokeball-contact-example
- key_count: 11
  name: Smokeball Fee Example
  slug: smokeball-fee-example
- key_count: 8
  name: Smokeball Invoice Example
  slug: smokeball-invoice-example
- key_count: 11
  name: Smokeball Matter Example
  slug: smokeball-matter-example
- key_count: 10
  name: Smokeball Task Example
  slug: smokeball-task-example
- key_count: 6
  name: Smokeball Webhook Example
  slug: smokeball-webhook-example
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/smokeball.png
json_schemas:
- name: Smokeball BankAccount
  property_count: 17
  slug: smokeball-bankaccount
- name: Smokeball Contact
  property_count: 14
  slug: smokeball-contact
- name: Smokeball ContactDto
  property_count: 6
  slug: smokeball-contactdto
- name: Smokeball Event
  property_count: 21
  slug: smokeball-event
- name: Smokeball EventDto
  property_count: 14
  slug: smokeball-eventdto
- name: Smokeball Expense
  property_count: 36
  slug: smokeball-expense
- name: Smokeball ExpenseDto
  property_count: 21
  slug: smokeball-expensedto
- name: Smokeball Fee
  property_count: 39
  slug: smokeball-fee
- name: Smokeball FeeDto
  property_count: 21
  slug: smokeball-feedto
- name: Smokeball File
  property_count: 23
  slug: smokeball-file
- name: Smokeball FirmUser
  property_count: 8
  slug: smokeball-firmuser
- name: Smokeball Folder
  property_count: 7
  slug: smokeball-folder
- name: Smokeball Invoice
  property_count: 23
  slug: smokeball-invoice
- name: Smokeball Matter
  property_count: 37
  slug: smokeball-matter
- name: Smokeball MatterDto
  property_count: 30
  slug: smokeball-matterdto
- name: Smokeball MatterType
  property_count: 13
  slug: smokeball-mattertype
- name: Smokeball Memo
  property_count: 14
  slug: smokeball-memo
- name: Smokeball MemoDto
  property_count: 4
  slug: smokeball-memodto
- name: Smokeball Role
  property_count: 13
  slug: smokeball-role
- name: Smokeball RoleDto
  property_count: 7
  slug: smokeball-roledto
- name: Smokeball API Schemas
  property_count: 0
  slug: smokeball-schemas
- name: Smokeball Staff
  property_count: 24
  slug: smokeball-staff
- name: Smokeball StaffDto
  property_count: 14
  slug: smokeball-staffdto
- name: Smokeball Tag
  property_count: 3
  slug: smokeball-tag
- name: Smokeball Task
  property_count: 25
  slug: smokeball-task
- name: Smokeball TaskDto
  property_count: 13
  slug: smokeball-taskdto
- name: Smokeball WebhookSubscription
  property_count: 12
  slug: smokeball-webhooksubscription
- name: Smokeball WebhookSubscriptionDto
  property_count: 4
  slug: smokeball-webhooksubscriptiondto
jsonld:
- class_count: 2
  name: Smokeball Context
  property_count: 21
  slug: smokeball-context
layout: provider
modified: '2026-06-13'
name: Smokeball
nav: Providers
