...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/circuit/refs/heads/main/capabilities/circuit-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/circuit-capability-edges.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/circuit/refs/heads/main/security/circuit-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/circuit-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/circuit/refs/heads/main/authentication/circuit-authentication.yml
  title: ''
  type: Authentication
...
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/circuit/refs/heads/main/lifecycle/circuit-lifecycle.yml
  title: ''
  type: Deprecation
  url: lifecycle/circuit-lifecycle.yml
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/circuit/refs/heads/main/openapi/_original/circuit-v1-openapi-original.json
  title: ''
  type: OpenAPI
  url: openapi/_original/circuit-v1-openapi-original.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/circuit/refs/heads/main/asyncapi/circuit-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/circuit-webhooks.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/circuit/refs/heads/main/errors/circuit-error-codes.yml
  title: ''
  type: ErrorCatalog
  url: errors/circuit-error-codes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/circuit/refs/heads/main/conventions/circuit-conventions.yml
  title: ''
  type: Conventions
  url: conventions/circuit-conventions.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/circuit/refs/heads/main/rate-limits/circuit-rate-limits.yml
  title: ''
  type: RateLimits
...
- group: design
  ...
  url: lifecycle/circuit-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/circuit/refs/heads/main/data-model/circuit-data-model.yml
  title: ''
  type: DataModel
  url: data-model/circuit-data-model.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/circuit/refs/heads/main/mcp/circuit-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/circuit-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/circuit/refs/heads/main/llms/circuit-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/circuit-llms.txt
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/circuit/refs/heads/main/conformance/circuit-conformance.yml
  title: ''
  type: Conformance
  url: conformance/circuit-conformance.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/circuit/refs/heads/main/changelog/circuit-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/circuit-changelog.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/circuit/refs/heads/main/overlays/circuit-v1-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/circuit-v1-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/circuit/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
...
nav: Providers
network: true
overview: 'Circuit publishes 11 APIs on the [APIs.io](https://apis.io/) network, including Depots API, Drivers API, Live Plans API, and 8 more. Tagged areas include Company, Delivery, Logistics, Last Mile Delivery, and Route Optimization.
