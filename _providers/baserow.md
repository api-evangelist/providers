...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/baserow/refs/heads/main/capabilities/baserow-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/baserow/refs/heads/main/agentic-access/baserow-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/baserow-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/baserow/refs/heads/main/security/baserow-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/baserow-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/baserow/refs/heads/main/authentication/baserow-authentication.yml
  title: ''
  type: Authentication
  url: authentication/baserow-authentication.yml
- group: company
  title: ''
  type: Website
...
examples:
- key_count: 2
  name: Baserow Api Examples
  slug: baserow-api-examples
finops:
- name: Baserow Finops
  service_category: ''
  slug: baserow-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/baserow.png
json_schemas:
- name: Baserow API Schemas
  property_count: 0
  slug: baserow-schemas
jsonld:
- class_count: 20
  name: Baserow Context
  property_count: 22
  slug: baserow-context
layout: provider
modified: '2026-06-12'
name: Baserow
nav: Providers
...
- name: Baserow Price Estimates
  plan_count: 0
  slug: baserow-price-estimates
random_paper: 7
rate_limits:
- limit_count: 4
  name: Baserow Rate Limits
  slug: baserow-rate-limits
rules:
- effective_rule_count: 6
  extends: []
  name: Baserow API Rules
  rule_count: 6
  severity_counts:
    error: 0
    hint: 0
