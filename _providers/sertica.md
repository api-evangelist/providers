...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/sertica/refs/heads/main/agentic-access/sertica-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/sertica-agentic-access.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/sertica/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sertica/refs/heads/main/authentication/sertica-authentication.yml
  title: ''
  type: Authentication
  url: authentication/sertica-authentication.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/sertica/refs/heads/main/changelog/sertica-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/sertica-changelog.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sertica/refs/heads/main/conformance/sertica-conformance.yml
  title: ''
  type: Conformance
  url: conformance/sertica-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sertica/refs/heads/main/conventions/sertica-conventions.yml
  title: ''
  type: Conventions
  url: conventions/sertica-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sertica/refs/heads/main/data-model/sertica-data-model.yml
  title: ''
  type: DataModel
  url: data-model/sertica-data-model.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sertica/refs/heads/main/security/sertica-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/sertica-domain-security.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sertica/refs/heads/main/errors/sertica-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/sertica-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sertica/refs/heads/main/lifecycle/sertica-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/sertica-lifecycle.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/sertica/refs/heads/main/overlays/sertica-web-api-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/sertica-web-api-overlay.yaml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/sertica/refs/heads/main/packages/sertica-packages.yml
  title: ''
  type: Packages
  url: packages/sertica-packages.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sertica/refs/heads/main/plans/sertica-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/sertica-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/sertica/refs/heads/main/rate-limits/sertica-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/sertica-rate-limits.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/sertica/refs/heads/main/sandbox/sertica-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/sertica-sandbox.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/sertica/refs/heads/main/asyncapi/sertica-webhooks.yml
  title: ''
  type: Webhooks
