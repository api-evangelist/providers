...
- group: operate
  title: ''
  type: IssueTracker
  url: https://github.com/XRPLF/rippled/issues
- group: operate
  title: ''
  type: Releases
  url: https://github.com/XRPLF/rippled/releases
- group: auth
  title: ''
  type: SecurityPolicy
  url: https://github.com/XRPLF/rippled/blob/develop/SECURITY.md
- group: docs
  title: ''
  type: ContributionGuide
  url: https://github.com/XRPLF/rippled/blob/develop/CONTRIBUTING.md
- group: commercial
  title: ''
  type: License
  url: https://github.com/XRPLF/rippled/blob/develop/LICENSE
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/xrpl/refs/heads/main/security/xrpl-domain-security.yml
  title: ''
  type: DomainSecurity
