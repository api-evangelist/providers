...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/johnson-controls/refs/heads/main/security/johnson-controls-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/johnson-controls-domain-security.yml
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/johnsoncontrols
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/johnson-controls
- group: company
  title: ''
  type: Website
...
created: '2026-03-24'
description: Johnson Controls is a global diversified technology and multi-industrial leader serving customers in over 150 countries, providing products, services, and solutions for buildings (HVAC, fire, security, building automation), energy storage, and connected building platforms (Metasys, OpenBlue). No public, self-service developer portal or OpenAPI is currently published; partner and customer integrations are typically delivered through the OpenBlue and Metasys product lines.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/johnson-controls.png
layout: provider
modified: '2026-04-28'
