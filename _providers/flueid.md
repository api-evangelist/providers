...
- baseURL: https://api.pro.flueid.com
  baseurl_source: declared
  description: The Order Events API from Flueid — 2 operation(s) for order events.
  name: Flueid Order Events API
  slug: flueid-order-events-api
- baseURL: https://api.pro.flueid.com
  baseurl_source: declared
  description: The Property Data API from Flueid — 22 operation(s) for property data.
  name: Flueid Property Data API
  slug: flueid-property-data-api
artifact_total: 22
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/flueid/refs/heads/main/capabilities/flueid-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/flueid-capability-edges.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/flueid/refs/heads/main/overlays/flueid-pro-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/flueid-pro-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/flueid/refs/heads/main/agentic-access/flueid-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/flueid-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/flueid/refs/heads/main/security/flueid-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/flueid/refs/heads/main/security/flueid-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/flueid-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/flueid/refs/heads/main/authentication/flueid-authentication.yml
  title: ''
  type: Authentication
  url: authentication/flueid-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/flueid/refs/heads/main/conventions/flueid-conventions.yml
  title: ''
  type: Conventions
  url: conventions/flueid-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/flueid/refs/heads/main/data-model/flueid-data-model.yml
  title: ''
  type: DataModel
  url: data-model/flueid-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/flueid/refs/heads/main/lifecycle/flueid-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/flueid-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/flueid/refs/heads/main/conformance/flueid-conformance.yml
  title: ''
  type: Conformance
  url: conformance/flueid-conformance.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/flueid/refs/heads/main/llms/flueid-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/flueid-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/flueid/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/flueid/refs/heads/main/plans/flueid-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/flueid-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/flueid/refs/heads/main/rate-limits/flueid-rate-limits.yml
  title: ''
  type: RateLimits
