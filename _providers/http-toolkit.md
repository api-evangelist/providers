...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/http-toolkit/refs/heads/main/agentic-access/http-toolkit-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/http-toolkit-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/http-toolkit/refs/heads/main/security/http-toolkit-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/http-toolkit-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/http-toolkit/refs/heads/main/authentication/http-toolkit-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/http-toolkit/refs/heads/main/plans/http-toolkit-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/http-toolkit-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/http-toolkit/refs/heads/main/rate-limits/http-toolkit-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/http-toolkit-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/http-toolkit/refs/heads/main/finops/http-toolkit-finops.yml
  title: ''
  type: FinOps
