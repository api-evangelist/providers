...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lucidworks/refs/heads/main/security/lucidworks-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/lucidworks-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lucidworks/refs/heads/main/security/lucidworks-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/lucidworks-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lucidworks/refs/heads/main/authentication/lucidworks-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Lucidworks publishes 12 APIs on the [APIs.io](https://apis.io/) network, including Chunking API, Classification API, Deployments API, and 9 more. Tagged areas include Search, Artificial Intelligence, Enterprise Search, Vector Search, and RAG.
