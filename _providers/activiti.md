...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/activiti/refs/heads/main/capabilities/activiti-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/activiti/refs/heads/main/agentic-access/activiti-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/activiti-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/activiti/refs/heads/main/security/activiti-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/activiti-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/activiti/refs/heads/main/authentication/activiti-authentication.yml
  title: ''
  type: Authentication
  url: authentication/activiti-authentication.yml
- group: company
  title: ''
  type: Website
...
- group: docs
  title: ''
  type: Documentation
  url: https://www.activiti.org/documentation
- group: docs
  title: ''
  type: Documentation
  url: https://activiti.gitbook.io/activiti-7-developers-guide
- group: build
  title: ''
  type: GitHubOrg
...
- group: company
  title: ''
  type: Blog
  url: https://github.com/Activiti/Activiti/wiki/Articles-and-Blogs-on-Activiti
- group: commercial
  title: ''
  type: Pricing
  url: https://www.activiti.org/get-started
- group: other
  title: ''
  type: X
  url: https://x.com/activiti
- group: operate
  title: ''
  type: StackOverflow
  url: https://stackoverflow.com/questions/tagged/activiti
- group: operate
  title: ''
  type: Forums
  url: https://community.alfresco.com/community/bpm
- group: operate
  title: ''
  type: RoadMap
  url: https://github.com/Activiti/Activiti/wiki/Activiti-7-Roadmap
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/activiti/refs/heads/main/plans/activiti-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/activiti-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/activiti/refs/heads/main/rate-limits/activiti-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/activiti-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/activiti/refs/heads/main/finops/activiti-finops.yml
  title: ''
  type: FinOps
  url: finops/activiti-finops.yml
created: 2026-06-13
description: Activiti is a lightweight, Java-centric open-source Business Process Management (BPM) and workflow automation engine. It provides a BPMN 2.0 compliant process engine and a REST API for managing process definitions, process instances, tasks, variables, user management, deployments, and historical data. Activiti Cloud extends the platform to cloud-native environments using Spring Boot, Docker, and Kubernetes.
examples:
- key_count: 6
  name: Activiti Deployment Example
  slug: activiti-deployment-example
- key_count: 9
  name: Activiti Form Example
  slug: activiti-form-example
- key_count: 16
  name: Activiti Process Instance Example
  slug: activiti-process-instance-example
- key_count: 19
  name: Activiti Task Example
  slug: activiti-task-example
- key_count: 16
  name: Activiti User Example
  slug: activiti-user-example
finops:
- name: Activiti Finops
  service_category: ''
  slug: activiti-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/activiti.png
json_schemas:
- name: AppDefinitionRepresentation
  property_count: 9
  slug: activiti-appdefinition
- name: CommentRepresentation
  property_count: 4
  slug: activiti-comment
...
- name: ModelRepresentation
  property_count: 16
  slug: activiti-model
- name: ProcessInstanceRepresentation
  property_count: 17
  slug: activiti-processinstance
- name: RestVariable
  property_count: 5
  slug: activiti-restvariable
- name: TaskRepresentation
  property_count: 28
  slug: activiti-task
- name: TenantRepresentation
  property_count: 8
  slug: activiti-tenant
- name: UserRepresentation
  property_count: 20
  slug: activiti-user
jsonld:
- class_count: 38
  name: Activiti Context
  property_count: 17
  slug: activiti-context
layout: provider
modified: 2026-06-13
name: Activiti
nav: Providers
network: true
overview: 'Activiti publishes 43 APIs on the [APIs.io](https://apis.io/) network, including About API, Admin Endpoints API, Admin Groups API, and 40 more. Tagged areas include Business Process Management, Workflows, BPMN, Open Source, and Process Automation.
...
- limit_count: 0
  ...
  slug: activiti-rate-limits
rules:
- effective_rule_count: 5
  extends: []
  name: Activiti API Rules
  rule_count: 5
  severity_counts:
    error: 0
    hint: 0
...
security:
- kind: authentication
  name: Activiti Authentication
  slug: activiti-authentication
