...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/sui/refs/heads/main/agentic-access/sui-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/sui-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sui/refs/heads/main/security/sui-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Sui publishes 11 APIs on the [APIs.io](https://apis.io/) network, including Coin Query API, Extended API, Governance Read API, and 8 more. Tagged areas include Blockchain, Move, Web3, Cryptocurrency, and Smart Contracts.
