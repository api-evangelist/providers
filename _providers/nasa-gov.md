...
- collection_type: open
  ...
  slug: open-apod
- collection_type: open
  name: NASA Asteroids NeoWs API
  slug: open-asteroids-neows
- collection_type: open
...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/nasa-gov/refs/heads/main/capabilities/nasa-gov-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/nasa-gov/refs/heads/main/agentic-access/nasa-gov-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/nasa-gov-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/nasa-gov/refs/heads/main/security/nasa-gov-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/nasa-gov-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/nasa-gov/refs/heads/main/authentication/nasa-gov-authentication.yml
  title: ''
  type: Authentication
  url: authentication/nasa-gov-authentication.yml
- group: start
  title: ''
  type: Portal
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/nasa-gov.png
json_schemas:
- name: ApodEntry
  property_count: 9
  slug: apod
...
- name: MarsRoverPhoto
  property_count: 6
  slug: mars-rover-photo
- name: NearEarthObject
  property_count: 11
  slug: neo
jsonld:
- class_count: 30
  name: Nasa Gov Context
  property_count: 0
  slug: nasa-gov-context
layout: provider
modified: '2026-05-25'
name: NASA Open APIs
nav: Providers
network: true
overview: 'NASA Open APIs publishes 34 APIs on the [APIs.io](https://apis.io/) network, including Album API, APOD API, Asset API, and 31 more. Tagged areas include Government, Federal, Space, Earth Science, and Open Data.
...
- limit_count: 0
  ...
  slug: nasa-gov-rate-limits
rules:
- effective_rule_count: 5
  extends: []
  name: NASA Open APIs API Rules
  rule_count: 5
  severity_counts:
    error: 0
    hint: 0
