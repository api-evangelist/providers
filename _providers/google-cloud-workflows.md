...
- collection_type: open
  name: Google Cloud Workflows Projects API
  slug: open-google-cloud-workflows-projects-api
- collection_type: open
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-workflows/refs/heads/main/agentic-access/google-cloud-workflows-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-cloud-workflows-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-workflows/refs/heads/main/security/google-cloud-workflows-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-cloud-workflows-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-workflows/refs/heads/main/security/google-cloud-workflows-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-workflows/refs/heads/main/json-ld/json-ld.json
  title: ''
  type: JSONLD
...
overview: 'Google Cloud Workflows publishes 1 API on the [APIs.io](https://apis.io/) network: Projects API. Tagged areas include Automation, Google Cloud, Integration, Orchestration, and Serverless.
  ...
  Google Cloud Workflows'' developer surface includes developer portal, getting-started guide, documentation, authentication, pricing, support, engineering blog, and 10 more developer resources.'
plans:
