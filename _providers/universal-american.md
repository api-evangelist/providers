...
- group: other
  title: ''
  type: ParentCompany
  url: https://apis.io/providers/wellcare-health-plans/
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/universal-american
- group: company
  title: ''
  type: Website
...
jsonld:
- class_count: 4
  name: Universal American Context
  property_count: 12
  slug: universal-american-context
layout: provider
modified: '2026-05-03'
name: Universal American
nav: Providers
network: true
overview: 'Universal American is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Health Insurance, Medicare, Medicare Advantage, Healthcare, and Insurance.
...
- Healthcare
- Insurance
website: https://www.universal-american.com
---
