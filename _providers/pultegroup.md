...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pultegroup/refs/heads/main/security/pultegroup-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/pultegroup-domain-security.yml
- group: company
  title: ''
  type: Website
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/pultegroup.png
layout: provider
modified: '2026-04-28'
name: PulteGroup
nav: Providers
network: true
overview: 'PulteGroup is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Homebuilding, Real-Estate, Construction, Fortune 500, and Enterprise.
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/pultegroup/refs/heads/main/screenshots/pultegroup-2026-06-20T192308.png
security:
- kind: domain-security
  name: Pultegroup Domain Security
  slug: pultegroup-domain-security
