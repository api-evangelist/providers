...
common:
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/cheerio/refs/heads/main/packages/cheerio-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/cheerio-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cheerio/refs/heads/main/llms/cheerio-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/cheerio-llms.txt
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cheerio/refs/heads/main/conformance/cheerio-conformance.yml
  title: ''
  type: Conformance
  url: conformance/cheerio-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cheerio/refs/heads/main/conventions/cheerio-conventions.yml
  title: ''
  type: Conventions
  url: conventions/cheerio-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cheerio/refs/heads/main/lifecycle/cheerio-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/cheerio-lifecycle.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/cheerio/refs/heads/main/changelog/cheerio-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/cheerio-changelog.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cheerio/refs/heads/main/security/cheerio-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/cheerio-vulnerability-disclosure.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/cheerio/refs/heads/main/plans/cheerio-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/cheerio-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/cheerio/refs/heads/main/rate-limits/cheerio-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/cheerio-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/cheerio/refs/heads/main/finops/cheerio-finops.yml
  title: ''
  type: FinOps
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cheerio/refs/heads/main/security/cheerio-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cheerio/refs/heads/main/json-ld/cheerio-context.jsonld
  title: ''
  type: JSONLD
