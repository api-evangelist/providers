...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cri-o/refs/heads/main/agentic-access/cri-o-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/cri-o-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cri-o/refs/heads/main/security/cri-o-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'CRI-O publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Containers API, Debug API, Information API, and 3 more. Tagged areas include Apache 2.0, CNCF, Cloud-Native, conmon, and Container Runtime.
