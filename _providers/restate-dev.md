...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/restate-dev/refs/heads/main/security/restate-dev-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/restate-dev-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/restate-dev/refs/heads/main/security/restate-dev-domain-security.yml
  title: ''
  type: DomainSecurity
