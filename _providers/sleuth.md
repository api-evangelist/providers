...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/sleuth/refs/heads/main/agentic-access/sleuth-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/sleuth-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sleuth/refs/heads/main/security/sleuth-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/sleuth-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sleuth/refs/heads/main/security/sleuth-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/sleuth-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sleuth/refs/heads/main/authentication/sleuth-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sleuth/refs/heads/main/plans/sleuth-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/sleuth-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/sleuth/refs/heads/main/rate-limits/sleuth-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/sleuth-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sleuth/refs/heads/main/finops/sleuth-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Sleuth publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Deployments API, Impact API, Manual Changes API, and 2 more. Tagged areas include DORA, DevOps, Deployment Tracking, Engineering Metrics, and Continuous Delivery.
