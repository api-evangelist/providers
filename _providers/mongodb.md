...
common:
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/mongodb/refs/heads/main/rate-limits/mongodb-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/mongodb-rate-limits.yml
- group: commercial
  title: ''
  type: Pricing
  url: https://www.mongodb.com/pricing
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/mongodb/refs/heads/main/plans/mongodb-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/mongodb-plans-pricing.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/mongodb/refs/heads/main/capabilities/mongodb-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/mongodb-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/mongodb/refs/heads/main/agentic-access/mongodb-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/mongodb-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mongodb/refs/heads/main/security/mongodb-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/mongodb-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mongodb/refs/heads/main/security/mongodb-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/mongodb-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mongodb/refs/heads/main/security/mongodb-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/mongodb-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mongodb/refs/heads/main/authentication/mongodb-authentication.yml
  title: ''
  type: Authentication
  url: authentication/mongodb-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mongodb/refs/heads/main/scopes/mongodb-scopes.yml
  title: ''
  type: OAuthScopes
...
nav: Providers
network: true
overview: 'MongoDB publishes 51 APIs on the [APIs.io](https://apis.io/) network, including Access Tracking API, Activity Feed API, Alert Configurations API, and 48 more. Tagged areas include Cloud Database, Database, Document Database, NoSQL, and MongoDB.


  MongoDB''s developer surface includes pricing, authentication, getting-started guide, engineering blog, support, developer portal, and 17 more developer resources.'
plans:
- name: Mongodb Plans Pricing
  plan_count: 13
  slug: mongodb-plans-pricing
- name: Mongodb Price Estimates
  plan_count: 0
  slug: mongodb-price-estimates
random_paper: 16
rate_limits:
- limit_count: 12
