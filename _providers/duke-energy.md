...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/duke-energy/refs/heads/main/security/duke-energy-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/duke-energy-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/duke-energy-corporation
- group: company
  title: ''
  type: Website
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/duke-energy.png
layout: provider
modified: '2026-04-28'
name: Duke Energy
nav: Providers
network: true
overview: Duke Energy is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Fortune 500 and Utilities.
press:
- date: ''
