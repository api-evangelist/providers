...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/aeb/refs/heads/main/capabilities/aeb-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/aeb-capability-edges.yml
- group: operate
  title: ''
  type: IssueTracker
...
nav: Providers
network: true
overview: 'AEB publishes 67 APIs on the [APIs.io](https://apis.io/) network, including Delivery API, Billing API, Billing Scenario API, and 64 more. Tagged areas include Logistics, Supply Chain, Germany, Customs, and Trade Compliance.
