...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/flow-engineering/refs/heads/main/well-known/flow-engineering-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/flow-engineering-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/flow-engineering/refs/heads/main/authentication/flow-engineering-authentication.yml
  title: ''
  type: Authentication
  url: authentication/flow-engineering-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/flow-engineering/refs/heads/main/scopes/flow-engineering-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/flow-engineering-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/flow-engineering/refs/heads/main/conformance/flow-engineering-conformance.yml
  title: ''
  type: Conformance
  url: conformance/flow-engineering-conformance.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/flow-engineering/refs/heads/main/security/flow-engineering-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/flow-engineering-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/flow-engineering/refs/heads/main/security/flow-engineering-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/flow-engineering-domain-security.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/flow-engineering/refs/heads/main/conventions/flow-engineering-conventions.yml
  title: ''
  type: Conventions
  url: conventions/flow-engineering-conventions.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/flow-engineering/refs/heads/main/llms/flow-engineering-llms.txt
  title: ''
  type: LLMsTxt
