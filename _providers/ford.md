...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/ford/refs/heads/main/capabilities/ford-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/ford-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ford/refs/heads/main/agentic-access/ford-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/ford-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ford/refs/heads/main/security/ford-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/ford-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ford/refs/heads/main/authentication/ford-authentication.yml
  title: ''
  type: Authentication
  url: authentication/ford-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ford/refs/heads/main/scopes/ford-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ford/refs/heads/main/well-known/ford-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/ford-well-known.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ford/refs/heads/main/vocabulary/ford-data-dictionary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/ford-data-dictionary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ford/refs/heads/main/lifecycle/ford-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/ford-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ford/refs/heads/main/conformance/ford-conformance.yml
  title: ''
  type: Conformance
  url: conformance/ford-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ford/refs/heads/main/conventions/ford-conventions.yml
  title: ''
  type: Conventions
  url: conventions/ford-conventions.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/ford/refs/heads/main/packages/ford-packages.yml
  title: ''
  type: Packages
  url: packages/ford-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ford/refs/heads/main/llms/ford-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/ford-llms.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ford/refs/heads/main/security/ford-vulnerability-disclosure.yml
  title: ''
...
- group: auth
  ...
  url: security/ford-vulnerability-disclosure.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/ford/refs/heads/main/plans/ford-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/ford-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/ford/refs/heads/main/rate-limits/ford-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/ford-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/ford/refs/heads/main/finops/ford-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Ford publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Charging API, Commands API, Images API, and 3 more. Tagged areas include Automobiles, Cars, Vehicles, Connected Vehicles, and Automotive.
