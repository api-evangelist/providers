...
access_model:
  ...
  source:
  - plans
  - '{''url'': ''https://resurface.io'', ''status'': 301, ''note'': ''declared website redirects to https://graylog.org/ — a different registrable domain (resurface.io -> graylog.org), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/resurface/refs/heads/main/security/resurface-domain-security.yml
  title: ''
  type: DomainSecurity
