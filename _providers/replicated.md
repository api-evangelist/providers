...
- group: docs
  title: ''
  type: APIReference
  url: https://docs.replicated.com/reference/vendor-api-using
- group: start
  title: ''
  type: GettingStarted
  url: https://docs.replicated.com/vendor/quick-start
- group: operate
  title: ''
  type: Support
  url: https://community.replicated.com
- group: company
  title: ''
  type: Blog
  url: https://www.replicated.com/blog
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/replicatedhq
- group: commercial
  title: ''
  type: Pricing
  url: https://replicated.com/pricing
- group: start
  title: ''
  type: SignUp
...
- group: commercial
  title: ''
  type: TermsOfService
  url: https://replicated.com/terms
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://replicated.com/privacy
- group: operate
  title: ''
  type: StatusPage
...
nav: Providers
network: true
overview: 'Replicated publishes 22 APIs on the [APIs.io](https://apis.io/) network, including apps API, channelReleases API, channels API, and 19 more. Tagged areas include Company, Developer Tools, Software Distribution, Kubernetes, and On-Premises.
...
- kind: vulnerability-disclosure
  name: Replicated Vulnerability Disclosure
  slug: replicated-vulnerability-disclosure
  summary_line: security.txt · contact published
- kind: trust-center
  name: Replicated Trust Center
  slug: replicated-trust-center
