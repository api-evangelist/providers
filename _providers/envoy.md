...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/envoy/refs/heads/main/agentic-access/envoy-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/envoy-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/envoy/refs/heads/main/security/envoy-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/envoy-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/envoy/refs/heads/main/authentication/envoy-authentication.yml
  title: ''
  type: Authentication
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/envoy/refs/heads/main/json-schema/envoy-bootstrap.json
  title: ''
  type: JSONSchema
  url: json-schema/envoy-bootstrap.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/envoy/refs/heads/main/json-schema/envoy-cluster.json
  title: ''
  type: JSONSchema
  url: json-schema/envoy-cluster.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/envoy/refs/heads/main/json-schema/envoy-listener.json
  title: ''
  type: JSONSchema
  url: json-schema/envoy-listener.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/envoy/refs/heads/main/json-schema/envoy-route-configuration.json
  title: ''
  type: JSONSchema
  url: json-schema/envoy-route-configuration.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/envoy/refs/heads/main/json-ld/envoy-context.jsonld
  title: ''
  type: JSONLD
...
nav: Providers
network: true
overview: 'Envoy publishes 15 APIs on the [APIs.io](https://apis.io/) network, including Certificates API, Chat API, Clusters API, and 12 more. Tagged areas include Envoy, Cloud-Native, Load Balancing, Proxy, and Service Mesh.
