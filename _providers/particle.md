...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/particle/refs/heads/main/capabilities/particle-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/particle-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/particle/refs/heads/main/agentic-access/particle-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/particle-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/particle/refs/heads/main/security/particle-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/particle-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/particle/refs/heads/main/security/particle-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/particle-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/particle/refs/heads/main/authentication/particle-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Particle publishes 28 APIs on the [APIs.io](https://apis.io/) network, including Authentication API, Configuration API, Customers API, and 25 more. Tagged areas include IoT, Cellular, Wi-Fi, Bluetooth, and Device Management.
