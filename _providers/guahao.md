...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/guahao/refs/heads/main/security/guahao-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: guahao is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Healthcare, Digital Health, Telehealth, and Appointment Booking.
random_paper: 13
score:
  band: minimal
  composite: 3.3
