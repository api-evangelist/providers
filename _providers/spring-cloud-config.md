...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/spring-cloud-config/refs/heads/main/agentic-access/spring-cloud-config-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/spring-cloud-config-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spring-cloud-config/refs/heads/main/security/spring-cloud-config-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/spring-cloud-config-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spring-cloud-config/refs/heads/main/security/spring-cloud-config-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/spring-cloud-config-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spring-cloud-config/refs/heads/main/authentication/spring-cloud-config-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/spring-cloud-config/refs/heads/main/vocabulary/spring-cloud-config-vocabulary.yml
  title: ''
  type: Vocabulary
