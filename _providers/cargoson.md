...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/cargoson/refs/heads/main/capabilities/cargoson-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/cargoson-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cargoson/refs/heads/main/agentic-access/cargoson-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/cargoson-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cargoson/refs/heads/main/security/cargoson-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/cargoson-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cargoson/refs/heads/main/security/cargoson-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/cargoson-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cargoson/refs/heads/main/authentication/cargoson-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/cargoson/refs/heads/main/plans/cargoson-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/cargoson-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/cargoson/refs/heads/main/rate-limits/cargoson-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/cargoson-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/cargoson/refs/heads/main/finops/cargoson-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Cargoson publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Carriers API, Price Requests API, Shipments API, and 2 more. Tagged areas include Transport Management, TMS, Freight, Shipping, and Logistics.


  Cargoson''s developer surface includes authentication, documentation, and 10 more developer resources.'
plans:
