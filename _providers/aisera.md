...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/aisera/refs/heads/main/llms/aisera-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/aisera-llms.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/aisera/refs/heads/main/authentication/aisera-authentication.yml
  title: ''
  type: Authentication
  url: authentication/aisera-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aisera/refs/heads/main/conventions/aisera-conventions.yml
  title: ''
  type: Conventions
  url: conventions/aisera-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aisera/refs/heads/main/errors/aisera-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/aisera-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aisera/refs/heads/main/lifecycle/aisera-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/aisera-lifecycle.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/aisera/refs/heads/main/changelog/aisera-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/aisera-changelog.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aisera/refs/heads/main/conformance/aisera-conformance.yml
  title: ''
  type: Conformance
  url: conformance/aisera-conformance.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/aisera/refs/heads/main/security/aisera-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/aisera-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/aisera/refs/heads/main/security/aisera-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/aisera-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/aisera/refs/heads/main/security/aisera-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/aisera-trust-center.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aisera/refs/heads/main/components/aisera-components.yml
  title: ''
  type: Components
  url: components/aisera-components.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aisera/refs/heads/main/data-model/aisera-data-model.yml
  title: ''
  type: DataModel
  url: data-model/aisera-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aisera/refs/heads/main/asyncapi/aisera-events-webhooks.yml
  title: ''
  type: Webhooks
