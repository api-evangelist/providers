...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/plasmic/refs/heads/main/agentic-access/plasmic-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/plasmic-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/plasmic/refs/heads/main/security/plasmic-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/plasmic-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/plasmic/refs/heads/main/authentication/plasmic-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Plasmic publishes 11 APIs on the [APIs.io](https://apis.io/) network, including Items API, Rows API, and 9 more. Tagged areas include Visual Builder, Headless CMS, React, Next.js, and Gatsby.
