...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/lightdash/refs/heads/main/capabilities/lightdash-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/lightdash-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/lightdash/refs/heads/main/agentic-access/lightdash-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/lightdash-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lightdash/refs/heads/main/security/lightdash-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/lightdash-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lightdash/refs/heads/main/authentication/lightdash-authentication.yml
  title: ''
  type: Authentication
  url: authentication/lightdash-authentication.yml
- group: company
  title: ''
  type: Website
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/lightdash/refs/heads/main/plans/lightdash-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/lightdash-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/lightdash/refs/heads/main/rate-limits/lightdash-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/lightdash-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/lightdash/refs/heads/main/finops/lightdash-finops.yml
  title: ''
  type: FinOps
  url: finops/lightdash-finops.yml
created: 2026-06-12
description: Lightdash is an open-source business intelligence platform built on top of dbt that connects directly to the semantic layer defined in dbt projects. It provides a REST API covering core data operations including catalog management, chart and dashboard CRUD, SQL runner queries, scheduling and automated deliveries, user and access control, AI agent threads, and integrations with GitHub, GitLab, Slack, and Google Sheets. Authentication uses Personal Access Tokens passed via the Authorization header. Lightdash is available as a managed cloud service or self-hosted, with pricing based on cloud-hosted plans or free open-source self-hosting.
examples:
- key_count: 6
  name: Lightdash My Account Example
  slug: lightdash-my-account-example
- key_count: 6
  name: Lightdash Organization Warehouse Credentials Example
  slug: lightdash-organization-warehouse-credentials-example
- key_count: 6
  name: Lightdash Organizations Example
  slug: lightdash-organizations-example
- key_count: 6
  name: Lightdash Projects Example
  slug: lightdash-projects-example
- key_count: 6
  name: Lightdash Scim Example
  slug: lightdash-scim-example
- key_count: 6
  name: Lightdash User Attributes Example
  slug: lightdash-user-attributes-example
- key_count: 6
  name: Lightdash V2 Example
  slug: lightdash-v2-example
finops:
- name: Lightdash Finops
  service_category: ''
  slug: lightdash-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/lightdash.png
json_schemas:
- name: ApiErrorPayload
  property_count: 2
  slug: lightdash-apierrorpayload
- name: ChartSummary
  property_count: 0
  slug: lightdash-chartsummary
- name: Dashboard
  property_count: 27
  slug: lightdash-dashboard
- name: Project
  property_count: 21
  slug: lightdash-project
- name: SchedulerAndTargets
  property_count: 0
  slug: lightdash-schedulerandtargets
- name: ScimUser
  property_count: 9
  slug: lightdash-scimuser
- name: ServiceAccount
  property_count: 12
  slug: lightdash-serviceaccount
- name: Space
  property_count: 19
  slug: lightdash-space
jsonld:
- class_count: 0
  name: Lightdash Context
  property_count: 68
  slug: lightdash-context
layout: provider
modified: 2026-06-12
name: Lightdash
nav: Providers
