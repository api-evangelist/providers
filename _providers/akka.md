...
- collection_type: open
  name: Akka Management Bootstrap API
  slug: open-akka-bootstrap-api
- collection_type: open
  name: Akka Management Bootstrap Cluster API
  slug: open-akka-cluster-api
- collection_type: open
  name: Akka Management Bootstrap Health API
  slug: open-akka-health-api
- collection_type: open
  name: Akka Management API
  slug: open-akka-management
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/akka/refs/heads/main/agentic-access/akka-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/akka-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/akka/refs/heads/main/security/akka-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/akka-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/akka/refs/heads/main/security/akka-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Akka publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Bootstrap API, Cluster API, Health API, and 3 more. Tagged areas include Actor Model, Distributed Systems, Framework, Java, and Microservices.
