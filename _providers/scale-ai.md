...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/scale-ai/refs/heads/main/agentic-access/scale-ai-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/scale-ai-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/scale-ai/refs/heads/main/security/scale-ai-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/scale-ai-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/scale-ai/refs/heads/main/security/scale-ai-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/scale-ai-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/scale-ai/refs/heads/main/security/scale-ai-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/scale-ai-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/scale-ai/refs/heads/main/authentication/scale-ai-authentication.yml
  title: ''
  type: Authentication
...
overview: 'Scale AI publishes 3 APIs on the [APIs.io](https://apis.io/) network: Batches API, Projects API, and Tasks API. Tagged areas include Data Engine, Labeling, RLHF, GenAI Platform, and Donovan.
  ...
  Scale AI''s developer surface includes authentication, developer portal, documentation, API reference, getting-started guide, engineering blog, signup flow, and 12 more developer resources.'
plans:
