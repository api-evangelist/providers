...
nav: Providers
network: true
overview: 'Finn-tannlege publishes 3 APIs on the [APIs.io](https://apis.io/) network, including REST API, and 2 more. Tagged areas include Dental, Healthcare, Directory, Norway, and Search.
