...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/overture-maps-foundation/refs/heads/main/security/overture-maps-foundation-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/overture-maps-foundation-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
...
- name: Overture Maps Foundation Plans Pricing
  plan_count: 3
  slug: overture-maps-foundation-plans-pricing
random_paper: 16
rate_limits:
- limit_count: 5
  name: Overture Maps Foundation Rate Limits
  slug: overture-maps-foundation-rate-limits
score:
  band: emerging
  composite: 11.4
  coverage:
