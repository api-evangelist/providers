...
- collection_type: open
  name: Gluu Flex SCIM 2.0 discovery API
  slug: open-gluu-discovery-api
- collection_type: open
  name: Gluu Flex SCIM 2.0 discovery fido API
  slug: open-gluu-fido-api
- collection_type: open
  name: Gluu Flex SCIM 2.0 discovery groups API
  slug: open-gluu-groups-api
- collection_type: open
  name: Gluu Flex SCIM 2.0 discovery users API
  slug: open-gluu-users-api
- collection_type: open
