...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/olympusdao/refs/heads/main/agentic-access/olympusdao-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/olympusdao-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/olympusdao/refs/heads/main/security/olympusdao-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'OlympusDAO publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Health API, Legacy API, Metadata API, and 5 more. Tagged areas include DeFi, Protocol-Owned Liquidity, Reserve Currency, Treasury, and Staking.
