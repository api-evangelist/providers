...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/workwave/refs/heads/main/capabilities/workwave-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/workwave-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/workwave/refs/heads/main/agentic-access/workwave-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/workwave-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/workwave/refs/heads/main/security/workwave-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/workwave-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/workwave/refs/heads/main/authentication/workwave-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/workwave/refs/heads/main/plans/workwave-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/workwave-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/workwave/refs/heads/main/rate-limits/workwave-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/workwave-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/workwave/refs/heads/main/finops/workwave-finops.yml
  title: ''
  type: FinOps
...
overview: 'WorkWave publishes 11 APIs on the [APIs.io](https://apis.io/) network, including Callback API, Companies API, Depots API, and 8 more. Tagged areas include Field Service, Route Optimization, Last Mile Delivery, Fleet, and GPS Tracking.
  ...
  WorkWave''s developer surface includes authentication, engineering blog, documentation, and 9 more developer resources.'
plans:
