...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/audacy/refs/heads/main/security/audacy-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: operate
  title: ''
  type: Contact
  url: https://amperwave.com
- group: other
  title: ''
  type: ProductPage
  url: https://www.audacyinc.com/podcasts
- group: other
  title: ''
  type: ProductPage
...
nav: Providers
network: true
overview: 'Audacy is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Audio, Radio, Podcasts, Streaming, and Broadcasting.
