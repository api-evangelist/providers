...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-anthos/refs/heads/main/agentic-access/google-anthos-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-anthos-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-anthos/refs/heads/main/security/google-anthos-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-anthos-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-anthos/refs/heads/main/security/google-anthos-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/google-anthos-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-anthos/refs/heads/main/authentication/google-anthos-authentication.yml
  title: ''
  type: Authentication
  url: authentication/google-anthos-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-anthos/refs/heads/main/scopes/google-anthos-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-anthos/refs/heads/main/json-ld/google-anthos-context.jsonld
  title: ''
  type: JSONLD
...
nav: Providers
network: true
overview: 'Google Anthos publishes 4 APIs on the [APIs.io](https://apis.io/) network, including BareMetalClusters API, VmwareClusters API, VmwareNodePools API, and 1 more. Tagged areas include Container Platform, Hybrid Cloud, Kubernetes, Multi-Cloud, and On-Premises.


  The Google Anthos catalog on APIs.io includes 1 JSON-LD context and 1 Spectral governance ruleset.


  Google Anthos'' developer surface includes authentication, getting-started guide, pricing, and 7 more developer resources.'
plans:
