...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/synopsys/refs/heads/main/agentic-access/synopsys-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/synopsys-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/synopsys/refs/heads/main/security/synopsys-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/synopsys-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/synopsys/refs/heads/main/authentication/synopsys-authentication.yml
  title: ''
  type: Authentication
  url: authentication/synopsys-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/synopsys/refs/heads/main/scopes/synopsys-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/synopsys/refs/heads/main/json-ld/synopsys-context.jsonld
  title: ''
  type: JSONLDContext
  url: json-ld/synopsys-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/synopsys/refs/heads/main/vocabulary/synopsys-vocabulary.yml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'Synopsys publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Coverity REST API, Entitlements API, Issues API, and 5 more. Tagged areas include Software Security, Application Security Testing, Static Analysis, Software Composition Analysis, and EDA Tools.
