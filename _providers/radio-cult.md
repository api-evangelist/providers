...
- group: company
  title: ''
  type: Website
  url: https://radiocult.fm
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/radio-cult/refs/heads/main/capabilities/radio-cult-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/radio-cult-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/radio-cult/refs/heads/main/agentic-access/radio-cult-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/radio-cult-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/radio-cult/refs/heads/main/security/radio-cult-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/radio-cult-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/radio-cult/refs/heads/main/authentication/radio-cult-authentication.yml
  title: ''
  type: Authentication
...
overview: 'Radio Cult publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Artists API, Media API, Playlists API, and 4 more. Tagged areas include Radio, Streaming, Audio, Music, and Broadcasting.
  ...
  Radio Cult''s developer surface includes authentication, engineering blog, and 5 more developer resources.'
plans:
