...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/geoapify/refs/heads/main/agentic-access/geoapify-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/geoapify-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/geoapify/refs/heads/main/security/geoapify-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Geoapify publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Geocode API, and 9 more. Tagged areas include Geocoding, Geospatial, Location, and Maps.
