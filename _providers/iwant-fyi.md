...
nav: Providers
network: true
overview: 'iwant.fyi publishes 1 API on the [APIs.io](https://apis.io/) network: Agent API. Tagged areas include Agentic Commerce, Marketplace, AI Agents, Purchase Intent, and Shopping.
