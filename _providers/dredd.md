...
created: '2026-03-25'
description: Dredd is a language-agnostic, open source HTTP API testing framework that validates API implementations against API Blueprint or OpenAPI (2.0/3.0) description documents.
finops:
- name: Dredd Finops
...
overview: 'Dredd publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Contract Testing, API Testing, OpenAPI, API Blueprint, and Tooling.
  ...
  Dredd''s developer surface includes documentation and 5 more developer resources.'
plans:
