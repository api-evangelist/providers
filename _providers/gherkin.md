...
- group: operate
  title: ''
  type: Releases
  url: https://github.com/cucumber/gherkin/releases
- group: build
  title: ''
  type: CodeOfConduct
...
- group: docs
  ...
  url: https://github.com/cucumber/gherkin/blob/main/CONTRIBUTING.md
- group: commercial
  title: ''
  type: License
  url: https://github.com/cucumber/gherkin/blob/main/LICENSE
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/gherkin/refs/heads/main/security/gherkin-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/gherkin-domain-security.yml
- group: docs
  title: ''
  type: Documentation
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/gherkin.png
layout: provider
modified: '2026-04-28'
name: Gherkin
nav: Providers
network: true
overview: 'Gherkin is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include BDD, Gherkin, Testing, Acceptance Testing, and Cucumber.


  Gherkin''s developer surface includes documentation, engineering blog, and 9 more developer resources.'
random_paper: 9
score:
  band: emerging
  composite: 16.9
...
- kind: domain-security
  name: Gherkin Domain Security
  slug: gherkin-domain-security
