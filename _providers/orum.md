...
mcp_servers:
- description: ''
  name: Orum MCP Server
  slug: orum-mcp-server
modified: '2026-07-20'
name: Orum
nav: Providers
network: true
overview: 'Orum publishes 17 APIs on the [APIs.io](https://apis.io/) network, including Authentication API, Balance API, Book Transfers API, and 14 more. Tagged areas include Company, Payments, Fintech, Banking, and Instant Payments.
  ...
  Orum''s developer surface includes documentation, API reference, getting-started guide, support, authentication, changelog, sandbox, and 22 more developer resources.'
random_paper: 10
scopes:
- name: Orum Scopes
  scope_count: 29
