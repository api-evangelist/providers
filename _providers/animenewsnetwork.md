...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/animenewsnetwork/refs/heads/main/security/animenewsnetwork-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/animenewsnetwork-domain-security.yml
- group: company
  title: ''
  type: Website
...
nav: Providers
network: true
overview: 'AnimeNewsNetwork publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Anime and Public APIs.
