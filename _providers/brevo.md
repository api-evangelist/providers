...
- baseURL: https://api.brevo.com/v3
  baseurl_source: declared
  description: The Consent Groups API from Brevo — 2 operation(s) for consent groups.
  name: Brevo Consent Groups API
  slug: brevo-consent-groups-api
- baseURL: https://api.brevo.com/v3
  baseurl_source: declared
  description: The Custom Objects API from Brevo — 3 operation(s) for custom objects.
  name: Brevo Custom Objects API
  slug: brevo-custom-objects-api
- baseURL: https://api.brevo.com/v3
  baseurl_source: declared
  description: The Email Campaigns API from Brevo — 10 operation(s) for email campaigns.
  name: Brevo Email Campaigns API
  slug: brevo-email-campaigns-api
- baseURL: https://api.brevo.com/v3
  baseurl_source: declared
  description: The External Feeds API from Brevo — 2 operation(s) for external feeds.
  name: Brevo External Feeds API
  slug: brevo-external-feeds-api
- baseURL: https://api.brevo.com/v3
  baseurl_source: declared
  description: The Master Account API from Brevo — 21 operation(s) for master account.
  name: Brevo Master Account API
  slug: brevo-master-account-api
- baseURL: https://api.brevo.com/v3
  baseurl_source: declared
  description: The SMS Campaigns API from Brevo — 7 operation(s) for sms campaigns.
  name: Brevo SMS Campaigns API
  slug: brevo-sms-campaigns-api
artifact_total: 165
asyncapis:
...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/capabilities/brevo-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/brevo-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/agentic-access/brevo-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/brevo-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/security/brevo-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/brevo-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/authentication/brevo-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/json-ld/brevo-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/brevo-context.jsonld
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/json-schema/brevo-contact-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/brevo-contact-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/json-schema/brevo-email-event-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/brevo-email-event-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/json-schema/brevo-order-schema.json
  title: ''
  type: JSONSchema
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/well-known/brevo-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/brevo-well-known.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/well-known/brevo-api-catalog.json
  title: ''
  type: APICatalog
  url: well-known/brevo-api-catalog.json
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/packages/brevo-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/brevo-packages.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/cli/brevo-cli.yml
  title: ''
  type: CLI
  url: cli/brevo-cli.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/mcp/brevo-mcp.yml
  title: ''
  type: MCPServer
  url: mcp/brevo-mcp.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/mcp/brevo-tool-crosswalk.yml
  title: ''
  type: ToolCrosswalk
  url: mcp/brevo-tool-crosswalk.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/llms/brevo-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/brevo-llms.txt
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/conventions/brevo-conventions.yml
  title: ''
  type: Conventions
...
- group: design
  ...
  url: conventions/brevo-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/errors/brevo-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/brevo-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/lifecycle/brevo-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/changelog/brevo-changelog.yml
  title: ''
  type: ChangeLog
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/scopes/brevo-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/brevo-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/conformance/brevo-conformance.yml
  title: ''
  type: Conformance
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/security/brevo-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/brevo-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/security/brevo-vulnerability-disclosure.yml
  title: ''
...
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/sandbox/brevo-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/brevo-sandbox.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/components/brevo-components.yml
  title: ''
  type: Components
  url: components/brevo-components.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/data-model/brevo-data-model.yml
  title: ''
  type: DataModel
  url: data-model/brevo-data-model.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/plans/brevo-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/brevo-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/rate-limits/brevo-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/brevo-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/finops/brevo-finops.yml
  title: ''
  type: FinOps
  url: finops/brevo-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/vocabulary/brevo-vocabulary.yml
  title: ''
  type: Vocabulary
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/asyncapi/brevo-webhooks-asyncapi.yml
  title: ''
  type: AsyncAPI
  url: asyncapi/brevo-webhooks-asyncapi.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/overlays/brevo-email-api-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/brevo-email-api-overlay.yaml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/overlays/brevo-transactional-sms-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/brevo-transactional-sms-overlay.yaml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/overlays/brevo-transactional-whatsapp-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/brevo-transactional-whatsapp-overlay.yaml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/overlays/brevo-marketing-campaigns-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/brevo-marketing-campaigns-overlay.yaml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/overlays/brevo-contact-management-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/brevo-contact-management-overlay.yaml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/overlays/brevo-events-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/brevo-events-overlay.yaml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/overlays/brevo-object-management-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/brevo-object-management-overlay.yaml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/overlays/brevo-accounts-and-settings-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/brevo-accounts-and-settings-overlay.yaml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/overlays/brevo-sales-crm-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/brevo-sales-crm-overlay.yaml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/overlays/brevo-conversations-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/brevo-conversations-overlay.yaml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/overlays/brevo-ecommerce-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/brevo-ecommerce-overlay.yaml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/overlays/brevo-loyalty-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/brevo-loyalty-overlay.yaml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/brevo/refs/heads/main/overlays/brevo-wallet-overlay.yaml
  title: ''
  type: Overlay
...
nav: Providers
network: true
overview: 'Brevo publishes 44 APIs on the [APIs.io](https://apis.io/) network, including Agent Status API, Automated Messages API, Categories API, and 41 more. Tagged areas include Marketing, Marketing Automation, Email Marketing, Transactional Email, and SMS Marketing.
