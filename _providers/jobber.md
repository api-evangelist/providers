...
- collection_type: open
  name: Jobber Developer GraphQL API
  slug: open-jobber-graphql-api
common:
- group: company
  title: ''
  type: Website
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/jobber/refs/heads/main/agentic-access/jobber-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/jobber-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jobber/refs/heads/main/security/jobber-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/jobber-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jobber/refs/heads/main/security/jobber-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/jobber-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jobber/refs/heads/main/authentication/jobber-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/jobber/refs/heads/main/plans/jobber-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/jobber-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/jobber/refs/heads/main/rate-limits/jobber-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/jobber-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/jobber/refs/heads/main/finops/jobber-finops.yml
  title: ''
  type: FinOps
  url: finops/jobber-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/jobber/refs/heads/main/rules/jobber-rules.yml
  title: ''
  type: SpectralRules
  url: rules/jobber-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/jobber/refs/heads/main/vocabulary/jobber-vocabulary.yml
  title: ''
  type: Vocabulary
...
overview: 'Jobber publishes 1 API on the [APIs.io](https://apis.io/) network: GraphQL API. Tagged areas include Field Service Management, Home Service, Scheduling, Quoting, and Invoicing.
  ...
  Jobber''s developer surface includes authentication, developer portal, documentation, signup flow, developer console, pricing, academy / training, and 22 more developer resources.'
plans:
