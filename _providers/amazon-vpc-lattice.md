...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/amazon-vpc-lattice/refs/heads/main/capabilities/amazon-vpc-lattice-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/amazon-vpc-lattice-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/amazon-vpc-lattice/refs/heads/main/agentic-access/amazon-vpc-lattice-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/amazon-vpc-lattice-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/amazon-vpc-lattice/refs/heads/main/security/amazon-vpc-lattice-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/amazon-vpc-lattice-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/amazon-vpc-lattice/refs/heads/main/security/amazon-vpc-lattice-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/amazon-vpc-lattice-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/amazon-vpc-lattice/refs/heads/main/security/amazon-vpc-lattice-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/amazon-vpc-lattice-domain-security.yml
- group: start
  title: ''
  type: Portal
...
examples:
- key_count: 2
  name: Amazon Vpc Lattice Example
  slug: amazon-vpc-lattice-example
features:
...
- description: Programmatic access to Amazon VPC Lattice resources.
  name: API Access
finops:
- name: Amazon Vpc Lattice Finops
  service_category: API
  slug: amazon-vpc-lattice-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/amazon-vpc-lattice.png
jsonld:
- class_count: 0
...
nav: Providers
network: true
overview: 'Amazon VPC Lattice publishes 73 APIs on the [APIs.io](https://apis.io/) network, including BatchUpdateRule API, CreateAccessLogSubscription API, CreateListener API, and 70 more. Tagged areas include Microservices, Service Mesh, and Service Networking.
...
- limit_count: 5
  ...
  slug: amazon-vpc-lattice-rate-limits
rules:
...
- kind: domain-security
  name: Amazon Vpc Lattice Domain Security
  slug: amazon-vpc-lattice-domain-security
  summary_line: TLSv1.3 · HSTS · DMARC
- kind: vulnerability-disclosure
  name: Amazon Vpc Lattice Vulnerability Disclosure
  slug: amazon-vpc-lattice-vulnerability-disclosure
  summary_line: security.txt · contact published
- kind: trust-center
  name: Amazon Vpc Lattice Trust Center
  slug: amazon-vpc-lattice-trust-center
