...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/katana/refs/heads/main/capabilities/katana-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/katana-capability-edges.yml
- group: start
  title: ''
  type: DeveloperPortal
  url: https://developer.katanamrp.com/
- group: docs
  title: ''
  type: Documentation
  url: https://developer.katanamrp.com/docs
- group: docs
  title: ''
  type: APIReference
  url: https://developer.katanamrp.com/reference
- group: start
  title: ''
  type: GettingStarted
  url: https://developer.katanamrp.com/docs/getting-started
- group: operate
  title: ''
  type: Support
  url: https://support.katanamrp.com/en/
- group: company
  title: ''
  type: Blog
...
- group: start
  title: ''
  type: Login
  url: https://factory.katanamrp.com
- group: commercial
  title: ''
  type: TermsOfService
...
- group: operate
  title: ''
  type: StatusPage
  url: https://status.katanamrp.com
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/katana/refs/heads/main/changelog/katana-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/katana-changelog.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/katana/refs/heads/main/authentication/katana-authentication.yml
  title: ''
  type: Authentication
  url: authentication/katana-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/katana/refs/heads/main/conventions/katana-conventions.yml
  title: ''
  type: Conventions
  url: conventions/katana-conventions.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/katana/refs/heads/main/rate-limits/katana-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/katana-rate-limits.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/katana/refs/heads/main/errors/katana-error-codes.yml
  title: ''
  type: ErrorCatalog
  url: errors/katana-error-codes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/katana/refs/heads/main/lifecycle/katana-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/katana-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/katana/refs/heads/main/asyncapi/katana-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/katana-webhooks.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/katana/refs/heads/main/mcp/katana-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/katana-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/katana/refs/heads/main/llms/katana-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/katana-llms.txt
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/katana/refs/heads/main/overlays/katana-openapi-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/katana-openapi-overlay.yaml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/katana/refs/heads/main/conformance/katana-conformance.yml
  title: ''
  type: Conformance
  url: conformance/katana-conformance.yml
- group: auth
  title: ''
  type: Compliance
  url: https://katanamrp.com/security/
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/katana/refs/heads/main/security/katana-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/katana-trust-center.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/katana/refs/heads/main/data-model/katana-data-model.yml
  title: ''
  type: DataModel
  url: data-model/katana-data-model.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/katana/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/katana/refs/heads/main/agentic-access/katana-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/katana-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/katana/refs/heads/main/security/katana-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/katana-domain-security.yml
- group: company
  title: ''
  type: Website
...
nav: Providers
network: true
overview: 'Katana publishes 64 APIs on the [APIs.io](https://apis.io/) network, including AdditionalCostController API, BatchController API, BatchStockController API, and 61 more. Tagged areas include Company, Enterprise, Inventory, Manufacturing, and ERP.


  The Katana catalog on APIs.io includes 1 event-driven AsyncAPI specification.
