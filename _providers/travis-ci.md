...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/travis-ci/refs/heads/main/agentic-access/travis-ci-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/travis-ci-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/travis-ci/refs/heads/main/security/travis-ci-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/travis-ci-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/travis-ci/refs/heads/main/authentication/travis-ci-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/travis-ci/refs/heads/main/plans/travis-ci-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/travis-ci-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/travis-ci/refs/heads/main/rate-limits/travis-ci-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/travis-ci-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/travis-ci/refs/heads/main/finops/travis-ci-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Travis CI publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Builds API, Jobs API, Logs API, and 5 more. Tagged areas include DevOps, CI/CD, Builds, Open Source, and Hosted.
