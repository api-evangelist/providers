...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/capabilities/lobcom-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/lobcom-capability-edges.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/overlays/lobcom-openapi-overlay.yaml
  title: ''
  type: Overlay
...
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/packages/lobcom-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/lobcom-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/mcp/lobcom-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/lobcom-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/llms/lobcom-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/lobcom-llms.txt
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/conformance/lobcom-conformance.yml
  title: ''
  type: Conformance
  url: conformance/lobcom-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/errors/lobcom-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/lobcom-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/errors/lobcom-error-codes.yml
  title: ''
  type: ErrorCatalog
  url: errors/lobcom-error-codes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/lifecycle/lobcom-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/changelog/lobcom-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/lobcom-changelog.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/conventions/lobcom-conventions.yml
  title: ''
  type: Conventions
...
- group: design
  ...
  url: conventions/lobcom-conventions.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/sandbox/lobcom-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/lobcom-sandbox.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/data-model/lobcom-data-model.yml
  title: ''
  type: DataModel
  url: data-model/lobcom-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/asyncapi/lobcom-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/lobcom-webhooks.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/authentication/lobcom-authentication.yml
  title: ''
  type: Authentication
  url: authentication/lobcom-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/security/lobcom-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/lobcom-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/agentic-access/lobcom-agentic-access.yml
  title: ''
  type: AgenticAccess
...
- group: operate
  ...
  url: https://help.lob.com/
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/plans/lobcom-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/lobcom-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/rate-limits/lobcom-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/lobcom-rate-limits.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/components/lobcom-components.yml
  title: ''
  type: Components
  url: components/lobcom-components.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/security/lobcom-trust-center.yml
  title: ''
  type: TrustCenter
...
- group: auth
  ...
  url: security/lobcom-trust-center.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/lobcom/refs/heads/main/mcp/lobcom-tool-crosswalk.yml
  title: ''
  type: ToolCrosswalk
...
overview: 'Lob.com publishes 32 APIs on the [APIs.io](https://apis.io/) network, including Accounts API, Addresses API, Bank Accounts API, and 29 more. Tagged areas include Company, Direct Mail, Print, Address Verification, and Mail.
  ...
  Lob.com''s developer surface includes documentation, API reference, getting-started guide, support, engineering blog, pricing, signup flow, and 38 more developer resources.'
plans:
