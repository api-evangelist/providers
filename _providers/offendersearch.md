...
- group: company
  title: ''
  type: Website
  url: https://www.offendersearch.app/
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/offendersearch/refs/heads/main/security/offendersearch-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/offendersearch-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/offendersearch/refs/heads/main/authentication/offendersearch-authentication.yml
  title: ''
  type: Authentication
  url: authentication/offendersearch-authentication.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/offendersearch/refs/heads/main/llms/offendersearch-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/offendersearch-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/offendersearch/refs/heads/main/well-known/offendersearch-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/offendersearch-well-known.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/offendersearch/refs/heads/main/mcp/offendersearch-mcp.yml
  title: ''
  type: MCPServer
  url: mcp/offendersearch-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/offendersearch/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
...
overview: 'Offendersearch publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Background Screening, Identity & risk, Trust and Safety, Public Records, and Criminal data.
  ...
  Offendersearch''s developer surface includes authentication, support, engineering blog, signup flow, and 9 more developer resources.'
plans:
...
- Healthcare
- Gig marketplaces
website: https://www.offendersearch.app/
---
