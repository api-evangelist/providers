...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/frax/refs/heads/main/agentic-access/frax-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/frax-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/frax/refs/heads/main/security/frax-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/frax-domain-security.yml
- group: company
  title: ''
  type: Website
...
- group: docs
  ...
  url: https://docs.frax.finance/smart-contracts/api
- group: docs
  title: ''
  type: OpenAPI
...
- group: docs
  title: ''
  type: OpenAPI
  url: https://api.frax.finance/v2/docs
- group: other
  title: ''
  type: Subgraphs
  url: https://thegraph.com/explorer/profile/0x6e74053a3798e0fc9a9775f7995316b27f21c4d2?view=Subgraphs
- group: build
  title: ''
  type: GitHub
...
- group: operate
  title: ''
  type: RateLimits
  url: https://raw.githubusercontent.com/api-evangelist/frax/refs/heads/main/rate-limits/rate-limits.yml
- group: commercial
  title: ''
  type: Plans
  url: https://raw.githubusercontent.com/api-evangelist/frax/refs/heads/main/plans/plans.yml
- group: commercial
  title: ''
  type: FinOps
  url: https://raw.githubusercontent.com/api-evangelist/frax/refs/heads/main/finops/finops.yml
created: '2026-06-14'
description: Frax Finance is a fractional-algorithmic stablecoin protocol offering FRAX (USD-pegged stablecoin), FPI (Frax Price Index stablecoin pegged to a consumer goods basket), frxETH (liquid ETH staking derivative), and supporting DeFi infrastructure including Fraxswap, Fraxlend, and Fraxtal L2. The protocol operates Algorithmic Market Operations (AMOs) to manage collateral and generate revenue, and exposes public REST APIs for querying token supply, collateral ratios, AMO positions, pool APRs, and frxETH staking analytics.
finops:
- name: Finops
  service_category: ''
  slug: finops
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/frax.png
jsonld:
- class_count: 0
  name: Frax Finance Context
  property_count: 0
  slug: frax-finance
layout: provider
modified: '2026-06-14'
...
nav: Providers
network: true
overview: 'Frax Finance publishes 18 APIs on the [APIs.io](https://apis.io/) network, including v1-gauge API, v1-prices API, v1-protocol API, and 15 more. Tagged areas include DeFi, Stablecoins, Fractional-Algorithmic, Ethereum, and frxETH.


  The Frax Finance catalog on APIs.io includes 1 JSON-LD context.


  Frax Finance''s developer surface includes documentation, GitHub presence, pricing, and 15 more developer resources.'
plans:
- name: Plans
  plan_count: 1
  slug: plans
