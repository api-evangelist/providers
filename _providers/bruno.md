...
- group: auth
  title: ''
  type: TrustCenter
  url: security/bruno-trust-center.yml
- group: auth
  title: ''
  type: DomainSecurity
  url: security/bruno-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
...
- group: agent
  title: ''
  type: LlmsText
  url: https://docs.usebruno.com/llms.txt
created: '2026-03-16'
...
graphqls:
- description: Bruno is an open-source API client for exploring and testing REST, GraphQL, and gRPC APIs. Collections are stored as plain text Bru files on the filesystem, enabling Git-based version control, team co
  name: Bruno GraphQL API
  slug: bruno-graphql
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/bruno.png
layout: provider
modified: '2026-04-21'
name: Bruno
nav: Providers
...
- kind: trust-center
  name: Bruno Trust Center
  slug: bruno-trust-center
  summary_line: SOC 2
slug: bruno
tags:
- API Client
