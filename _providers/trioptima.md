...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/trioptima/refs/heads/main/capabilities/trioptima-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/trioptima-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/trioptima/refs/heads/main/agentic-access/trioptima-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/trioptima-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/trioptima/refs/heads/main/security/trioptima-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/trioptima-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/trioptima/refs/heads/main/authentication/trioptima-authentication.yml
  title: ''
  type: Authentication
  url: authentication/trioptima-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/trioptima/refs/heads/main/scopes/trioptima-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/trioptima/refs/heads/main/json-ld/trioptima-context.jsonld
  title: ''
  type: JSONLDContext
  url: json-ld/trioptima-context.jsonld
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/trioptima/refs/heads/main/json-schema/trioptima-compression-cycle-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/trioptima-compression-cycle-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/trioptima/refs/heads/main/json-schema/trioptima-trade-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/trioptima-trade-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/trioptima/refs/heads/main/vocabulary/trioptima-vocabulary.yml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'Trioptima publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Cycles API, Results API, Risk API, and 2 more. Tagged areas include CME Group, Derivatives, Financial Services, OSTTRA, and Portfolio Compression.
