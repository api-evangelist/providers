...
access_model:
  ...
  source:
  - plans
  - '{''url'': ''https://explorer.mantle.xyz/'', ''status'': 302, ''note'': ''declared website redirects to https://mantlescan.xyz/ — a different registrable domain (mantle.xyz -> mantlescan.xyz), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: agent-aware
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mantle-network/refs/heads/main/security/mantle-network-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Mantle Network publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Mantle WebSocket (Mainnet), and 7 more. Tagged areas include Layer 2, Ethereum, Rollup, EigenDA, and Liquid Staking.
