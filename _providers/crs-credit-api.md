...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/crs-credit-api/refs/heads/main/security/crs-credit-api-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'CRS Credit API publishes 3 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include Credit, Consumer Credit, Business Credit, Identity, and Fraud Prevention.
