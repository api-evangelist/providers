...
- group: company
  title: ''
  type: Website
  url: https://www.openfga.dev/
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/openfga/refs/heads/main/agentic-access/openfga-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/openfga-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/openfga/refs/heads/main/security/openfga-domain-security.yml
  title: ''
  type: DomainSecurity
...
overview: 'OpenFGA publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Assertions API, Authorization Models API, AuthZenService API, and 3 more. Tagged areas include Access Control, Authorization, Cloud-Native, Fine-Grained, and Incubating.
  ...
  OpenFGA''s developer surface includes documentation, engineering blog, and 5 more developer resources.'
plans:
