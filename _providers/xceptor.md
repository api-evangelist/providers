...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/xceptor/refs/heads/main/agentic-access/xceptor-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/xceptor-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/xceptor/refs/heads/main/security/xceptor-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/xceptor-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/xceptor/refs/heads/main/authentication/xceptor-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Xceptor publishes 14 APIs on the [APIs.io](https://apis.io/) network, including Workflow API, Authentication API, Data Sources API, and 11 more. Tagged areas include API Integration, Data Automation, Data Extraction, Document Processing, and ETL.
