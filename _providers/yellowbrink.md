...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/yellowbrink/refs/heads/main/security/yellowbrink-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/yellowbrink-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/yellowbrink/refs/heads/main/llms/yellowbrink-llms.txt
  title: ''
  type: LLMsTxt
...
nav: Providers
network: true
overview: YellowBrink is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Healthcare, Health Data, openEHR, and Interoperability.
random_paper: 14
score:
  band: minimal
  composite: 4.0
