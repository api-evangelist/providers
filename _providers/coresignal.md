...
nav: Providers
network: true
overview: 'Coresignal publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Collect API, Search API, and 2 more. Tagged areas include Agentic Search, B2B Data, Companies, Company Data, and Data as a Service.
