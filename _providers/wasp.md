...
- group: start
  title: ''
  type: GettingStarted
  url: https://wasp.sh/docs/quick-start
- group: company
  title: ''
  type: Blog
  url: https://wasp.sh/blog
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/wasp-lang
- group: operate
  title: ''
  type: Support
...
- kind: vulnerability-disclosure
  name: Wasp Vulnerability Disclosure
  slug: wasp-vulnerability-disclosure
