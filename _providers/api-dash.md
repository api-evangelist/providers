...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/api-dash/refs/heads/main/scopes/api-dash-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/api-dash-scopes.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/api-dash/refs/heads/main/authentication/api-dash-authentication.yml
  title: ''
  type: Authentication
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/api-dash/refs/heads/main/security/api-dash-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/api-dash/refs/heads/main/packages/api-dash-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/api-dash-packages.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/api-dash/refs/heads/main/components/api-dash-components.yml
  title: ''
  type: Components
  url: components/api-dash-components.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/api-dash/refs/heads/main/mcp/api-dash-mcp.yml
  title: ''
  type: MCPServer
  url: mcp/api-dash-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/api-dash/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/api-dash/refs/heads/main/llms/api-dash-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/api-dash-llms.txt
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/api-dash/refs/heads/main/overlays/api-dash-openapi-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/api-dash-openapi-overlay.yaml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/api-dash/refs/heads/main/conformance/api-dash-conformance.yml
  title: ''
  type: Conformance
  url: conformance/api-dash-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/api-dash/refs/heads/main/errors/api-dash-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/api-dash-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/api-dash/refs/heads/main/conventions/api-dash-conventions.yml
  title: ''
  type: Conventions
  url: conventions/api-dash-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/api-dash/refs/heads/main/data-model/api-dash-data-model.yml
  title: ''
  type: DataModel
  url: data-model/api-dash-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/api-dash/refs/heads/main/lifecycle/api-dash-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/api-dash-lifecycle.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/api-dash/refs/heads/main/changelog/api-dash-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/api-dash-changelog.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/api-dash/refs/heads/main/sandbox/api-dash-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/api-dash-sandbox.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/api-dash/refs/heads/main/rate-limits/api-dash-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/api-dash-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/api-dash/refs/heads/main/plans/api-dash-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/api-dash-plans-pricing.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/api-dash/refs/heads/main/security/api-dash-vulnerability-disclosure.yml
  title: ''
