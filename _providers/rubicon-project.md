...
nav: Providers
network: true
overview: 'Rubicon Project publishes 77 APIs on the [APIs.io](https://apis.io/) network, including Account Partner Segments API, Accounts API, Advertiser Domain Lists API, and 74 more. Tagged areas include Company, Advertising, AdTech, Programmatic Advertising, and Sell-Side Platform.


  Rubicon Project''s developer surface includes engineering blog, support, documentation, API reference, getting-started guide, legal docs, authentication, and 26 more developer resources.'
plans:
