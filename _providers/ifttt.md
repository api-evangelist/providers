...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ifttt/refs/heads/main/agentic-access/ifttt-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/ifttt-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ifttt/refs/heads/main/security/ifttt-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'IFTTT publishes 2 APIs on the [APIs.io](https://apis.io/) network, including Trigger API, and 1 more. Tagged areas include Automation, Webhook, iPaaS, No-Code, and Smart Home.
