...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/flowable/refs/heads/main/capabilities/flowable-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/flowable/refs/heads/main/agentic-access/flowable-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/flowable-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/flowable/refs/heads/main/security/flowable-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/flowable-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/flowable/refs/heads/main/security/flowable-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/flowable-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/flowable/refs/heads/main/authentication/flowable-authentication.yml
  title: ''
  type: Authentication
  url: authentication/flowable-authentication.yml
- group: company
  title: ''
  type: Website
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/flowable/refs/heads/main/vocabulary/flowable-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/flowable-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/flowable/refs/heads/main/json-ld/flowable-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/flowable-context.jsonld
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/flowable/refs/heads/main/plans/flowable-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/flowable-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/flowable/refs/heads/main/rate-limits/flowable-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/flowable-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/flowable/refs/heads/main/finops/flowable-finops.yml
  title: ''
  type: FinOps
...
examples:
- key_count: 12
  name: Flowable Create Process Instance Example
  slug: flowable-create-process-instance-example
- key_count: 15
  name: Flowable Process Definition Example
  slug: flowable-process-definition-example
- key_count: 15
  name: Flowable Process Instance Example
  slug: flowable-process-instance-example
- key_count: 15
  name: Flowable Task Example
  slug: flowable-task-example
- key_count: 15
  name: Flowable Task Request Example
  slug: flowable-task-request-example
finops:
- name: Flowable Finops
  service_category: ''
  slug: flowable-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/flowable.png
json_schemas:
- name: Flowable BPMN API Schemas
  property_count: 0
  slug: flowable-bpmn
- name: Flowable CMMN API Schemas
  property_count: 0
  slug: flowable-cmmn
- name: Flowable CONTENT API Schemas
  property_count: 0
  slug: flowable-content
- name: Flowable DMN API Schemas
  property_count: 0
  slug: flowable-dmn
- name: Flowable EXTERNAL-WORKER API Schemas
  property_count: 0
  slug: flowable-external-worker
- name: Flowable FORM API Schemas
  property_count: 0
  slug: flowable-form
- name: Flowable IDM API Schemas
  property_count: 0
  slug: flowable-idm
jsonld:
- class_count: 23
  name: Flowable Context
  property_count: 55
  slug: flowable-context
layout: provider
modified: '2026-06-13'
name: Flowable
nav: Providers
...
- limit_count: 0
  ...
  slug: flowable-rate-limits
rules:
- effective_rule_count: 6
  extends: []
  name: Flowable API Rules
  rule_count: 6
  severity_counts:
    error: 0
    hint: 0
