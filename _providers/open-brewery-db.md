...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/open-brewery-db/refs/heads/main/agentic-access/open-brewery-db-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/open-brewery-db-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/open-brewery-db/refs/heads/main/security/open-brewery-db-domain-security.yml
  title: ''
  type: DomainSecurity
