...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/a10-networks/refs/heads/main/capabilities/a10-networks-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/a10-networks-capability-edges.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/a10-networks/refs/heads/main/security/a10-networks-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'A10 Networks publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Authentication API, SLB Health Monitor API, SLB Server API, and 3 more. Tagged areas include Application Delivery, Load Balancing, DDoS Protection, Application Delivery Controller, and Network Security.
