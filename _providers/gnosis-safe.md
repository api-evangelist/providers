...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/gnosis-safe/refs/heads/main/agentic-access/gnosis-safe-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/gnosis-safe-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/gnosis-safe/refs/heads/main/security/gnosis-safe-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/gnosis-safe-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/gnosis-safe/refs/heads/main/authentication/gnosis-safe-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/gnosis-safe/refs/heads/main/plans/gnosis-safe-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/gnosis-safe-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/gnosis-safe/refs/heads/main/rate-limits/gnosis-safe-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/gnosis-safe-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/gnosis-safe/refs/heads/main/finops/gnosis-safe-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Safe (Gnosis Safe) publishes 16 APIs on the [APIs.io](https://apis.io/) network, including 4337 API, about API, analytics API, and 13 more. Tagged areas include Multisig, Smart Contract, Ethereum, Web3, and Blockchain.
