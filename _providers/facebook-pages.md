...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/facebook-pages/refs/heads/main/capabilities/facebook-pages-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/facebook-pages-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/facebook-pages/refs/heads/main/agentic-access/facebook-pages-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/facebook-pages-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/facebook-pages/refs/heads/main/authentication/facebook-pages-authentication.yml
  title: ''
  type: Authentication
  url: authentication/facebook-pages-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/facebook-pages/refs/heads/main/scopes/facebook-pages-scopes.yml
  title: ''
  type: OAuthScopes
...
nav: Providers
network: true
overview: 'Facebook Pages API publishes 12 APIs on the [APIs.io](https://apis.io/) network, including Comments API, Conversations API, Feed API, and 9 more. Tagged areas include Social Media, Facebook, Meta Graph API, Pages, and Content Publishing.
