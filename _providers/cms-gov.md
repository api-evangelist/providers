...
created: '2026-05-25'
description: The Centers for Medicare & Medicaid Services (CMS) is the U.S. federal agency within the Department of Health and Human Services that administers Medicare, Medicaid, the Children's Health Insurance Program (CHIP), the Health Insurance Marketplace, and the broader CMS open-data program. CMS operates one of the largest collections of HL7 FHIR APIs in the U.S. federal government — Blue Button 2.0, BCDA, AB2D, DPC, and the upstream BFD server — alongside the Marketplace API, the data.cms.gov open-data catalog, the Provider Data Catalog, the Quality Payment Program API, and the Medicare Coverage Database.
examples:
- key_count: 5
  name: Cms Gov Bcda Job Example
  slug: cms-gov-bcda-job-example
- key_count: 16
  name: Cms Gov Explanation Of Benefit Example
  slug: cms-gov-explanation-of-benefit-example
- key_count: 14
  name: Cms Gov Marketplace Plan Example
  slug: cms-gov-marketplace-plan-example
- key_count: 8
  name: Cms Gov Patient Example
  slug: cms-gov-patient-example
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/cms-gov.png
json_schemas:
- name: Coverage
  property_count: 11
  slug: cms-gov-coverage
- name: ExplanationOfBenefit
  property_count: 18
  slug: cms-gov-explanation-of-benefit
- name: Patient
  property_count: 11
  slug: cms-gov-patient
jsonld:
- class_count: 0
  name: Cms Gov Context
  property_count: 6
  slug: cms-gov-context
layout: provider
modified: '2026-05-25'
...
overview: 'CMS — Centers for Medicare & Medicaid Services publishes 25 APIs on the [APIs.io](https://apis.io/) network, including Articles API, Auth API, Benchmarks API, and 22 more. Tagged areas include Healthcare, Medicare, Medicaid, FHIR, and Bulk Data.
  ...
  CMS — Centers for Medicare & Medicaid Services'' developer surface includes authentication, developer portal, support, sandbox, engineering blog, privacy policy, documentation, and 28 more developer resources.'
random_paper: 7
rate_limits:
- limit_count: 0
