...
- group: auth
  title: ''
  type: DomainSecurity
  url: security/open-voice-network-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/open-voice-network
- group: docs
  title: ''
  type: Documentation
  url: https://openvoicenetwork.org/resources/
- group: build
  title: ''
  type: GitHubOrg
  url: https://github.com/open-voice-network
created: '2026-03-16'
description: The Open Voice Network is a Linux Foundation project advancing open standards for AI-enabled voice assistance systems. Its core initiatives around TrustMark and interoperability promote ethical, accessible, and interoperable voice technology across platforms and devices.
finops:
- name: Open Voice Network Finops
...
- kind: domain-security
  name: Open Voice Network Domain Security
  slug: open-voice-network-domain-security
