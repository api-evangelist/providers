...
overview: 'Google Cloud Translation publishes 1 API on the [APIs.io](https://apis.io/) network: Projects API. Tagged areas include Google Cloud, Language, Localization, Machine Learning, and Translation.
  ...
  Google Cloud Translation''s developer surface includes developer portal, getting-started guide, documentation, authentication, pricing, support, engineering blog, and 8 more developer resources.'
plans:
