...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/gravatar/refs/heads/main/agentic-access/gravatar-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/gravatar-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/gravatar/refs/heads/main/security/gravatar-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/gravatar-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/gravatar/refs/heads/main/authentication/gravatar-authentication.yml
  title: ''
  type: Authentication
  url: authentication/gravatar-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/gravatar/refs/heads/main/scopes/gravatar-scopes.yml
  title: ''
  type: OAuthScopes
...
overview: 'Gravatar publishes 4 APIs on the [APIs.io](https://apis.io/) network, including avatars API, experimental API, profiles API, and 1 more. Tagged areas include Avatars, Identity, Profiles, Social, and Image.
  ...
  Gravatar''s developer surface includes authentication, developer portal, documentation, getting-started guide, pricing, status page, engineering blog, and 12 more developer resources.'
plans:
- name: Plans
  plan_count: 2
  slug: plans
