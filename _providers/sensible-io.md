...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/sensible-io/refs/heads/main/agentic-access/sensible-io-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/sensible-io-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sensible-io/refs/heads/main/security/sensible-io-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/sensible-io-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sensible-io/refs/heads/main/security/sensible-io-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/sensible-io-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sensible-io/refs/heads/main/security/sensible-io-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/sensible-io-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sensible-io/refs/heads/main/authentication/sensible-io-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sensible-io/refs/heads/main/plans/sensible-io-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/sensible-io-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/sensible-io/refs/heads/main/rate-limits/sensible-io-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/sensible-io-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sensible-io/refs/heads/main/finops/sensible-io-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Sensible publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Account API, Classify API, Configs API, and 6 more. Tagged areas include Artificial Intelligence, Document AI, IDP, Extraction, and LLM.
