...
- group: other
  title: ''
  type: ParentCompany
  url: https://apis.io/providers/s-and-p-global/
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ihs/refs/heads/main/security/ihs-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/ihs-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/ihsmarkit
- group: company
  title: ''
  type: Website
...
- group: other
  title: ''
  type: Historical
  url: https://en.wikipedia.org/wiki/IHS_Markit
created: '2026-03-24'
description: IHS was a global information and analytics company providing critical insight to customers across industries including aerospace, defense, automotive, chemicals, energy, and financial services. IHS merged with Markit in 2016 to form IHS Markit, which was subsequently acquired by S&P Global in 2022. The legacy ihs.com domain now redirects to S&P Global. No public IHS-branded APIs are tracked here; current API offerings live within S&P Global product lines.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/ihs.png
layout: provider
modified: '2026-04-28'
name: IHS
nav: Providers
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/ihs/refs/heads/main/screenshots/ihs-2026-06-20T183228.png
security:
- kind: domain-security
  name: Ihs Domain Security
  slug: ihs-domain-security
