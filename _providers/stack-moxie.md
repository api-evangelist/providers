...
- group: agent
  title: ''
  type: WellKnown
  url: well-known/stack-moxie-well-known.yml
- group: auth
  title: ''
  type: Compliance
...
nav: Providers
network: true
overview: 'Stack Moxie is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, RevOps, Marketing Operations, Observability, and Monitoring.
