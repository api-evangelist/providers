...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://www.praxair.com'', ''status'': 301, ''note'': ''declared website redirects to https://www.lindeus.com/ — a different registrable domain (praxair.com -> lindeus.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/praxair/refs/heads/main/security/praxair-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/praxair-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/praxairinc
- group: company
  title: ''
  type: Website
...
created: '2026-03-21'
description: Praxair was an American multinational industrial gases company that merged with Linde AG in 2018 to form Linde plc. Praxair operations in the United States now operate as Linde. The company supplies atmospheric, process, and specialty gases, along with related equipment and services to a range of industries.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/praxair.png
layout: provider
modified: '2026-04-28'
name: Praxair
nav: Providers
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/praxair/refs/heads/main/screenshots/praxair-2026-06-20T192041.png
security:
