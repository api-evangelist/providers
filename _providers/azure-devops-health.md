...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/azure-devops-health/refs/heads/main/security/azure-devops-health-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/azure-devops-health-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/azure-devops-health/refs/heads/main/security/azure-devops-health-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: Azure DevOps Health publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Continuous Integration, Developer Tools, and Public APIs.
random_paper: 14
score:
  band: minimal
  composite: 7.6
