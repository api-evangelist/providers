...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/oracle-database/refs/heads/main/capabilities/oracle-database-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/oracle-database-capability-edges.yml
- group: other
  title: ''
  type: ParentCompany
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/oracle-database/refs/heads/main/agentic-access/oracle-database-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/oracle-database-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/oracle-database/refs/heads/main/security/oracle-database-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/oracle-database-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/oracle-database/refs/heads/main/authentication/oracle-database-authentication.yml
  title: ''
  type: Authentication
  url: authentication/oracle-database-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/oracle-database/refs/heads/main/scopes/oracle-database-scopes.yml
  title: ''
  type: OAuthScopes
...
nav: Providers
network: true
overview: 'Oracle Database publishes 39 APIs on the [APIs.io](https://apis.io/) network, including Oracle Transactional Event Queues (TxEventQ), APEX API, Autonomous Databases API, and 36 more. Tagged areas include Cloud, Database, Enterprise, Oracle, and REST API.
  ...
  Oracle Database''s developer surface includes authentication, developer portal, documentation, getting-started guide, support, engineering blog, developer console, and 17 more developer resources.'
plans:
