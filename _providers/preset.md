...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/preset/refs/heads/main/agentic-access/preset-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/preset-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/preset/refs/heads/main/security/preset-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/preset-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/preset/refs/heads/main/authentication/preset-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/preset/refs/heads/main/plans/preset-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/preset-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/preset/refs/heads/main/rate-limits/preset-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/preset-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/preset/refs/heads/main/finops/preset-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Preset publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Authentication API, Charts API, Dashboards API, and 5 more. Tagged areas include Business Intelligence, Analytics, Superset, Dashboards, and Data Visualization.
