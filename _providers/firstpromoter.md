...
- collection_type: open
  ...
  slug: open-firstpromoter-v2-advanced-payout-methods
- collection_type: open
  name: FirstPromoter Admin API - Products
  slug: open-firstpromoter-v2-advanced-products
- collection_type: open
  name: FirstPromoter Assets
  slug: open-firstpromoter-v2-affiliate-assets
- collection_type: open
  name: FirstPromoter Affiliate Campaigns API
  slug: open-firstpromoter-v2-affiliate-campaigns
- collection_type: open
  name: FirstPromoter API
  slug: open-firstpromoter-v2-affiliate-commissions
- collection_type: open
  name: FirstPromoter Contract Documents API
  slug: open-firstpromoter-v2-affiliate-contract-documents
- collection_type: open
  name: FirstPromoter Email Settings API
  slug: open-firstpromoter-v2-affiliate-email-settings
- collection_type: open
  name: FirstPromoter API
  slug: open-firstpromoter-v2-affiliate-payout-methods
- collection_type: open
  name: FirstPromoter Affiliate Payouts API
  slug: open-firstpromoter-v2-affiliate-payouts
- collection_type: open
  name: FirstPromoter API
  slug: open-firstpromoter-v2-affiliate-promo-codes
- collection_type: open
  name: FirstPromoter API
  slug: open-firstpromoter-v2-affiliate-promoter-campaigns
- collection_type: open
  name: FirstPromoter API
  slug: open-firstpromoter-v2-affiliate-promoters
- collection_type: open
  name: FirstPromoter API
  slug: open-firstpromoter-v2-affiliate-referral-links
- collection_type: open
  name: FirstPromoter API
  slug: open-firstpromoter-v2-affiliate-referrals
- collection_type: open
  name: FirstPromoter API
  slug: open-firstpromoter-v2-affiliate-reports
- collection_type: open
  name: FirstPromoter Asset Categories API
  slug: open-firstpromoter-v2-asset-categories
- collection_type: open
  name: FirstPromoter Assets API
  slug: open-firstpromoter-v2-assets
- collection_type: open
  name: FirstPromoter Batch Processes API
  slug: open-firstpromoter-v2-batches
- collection_type: open
  name: FirstPromoter Campaigns API
  slug: open-firstpromoter-v2-campaigns
- collection_type: open
  name: FirstPromoter Commissions API
  slug: open-firstpromoter-v2-commissions
- collection_type: open
  name: FirstPromoter Contract Documents API
  slug: open-firstpromoter-v2-contract-documents
- collection_type: open
  name: FirstPromoter Contracts API
  slug: open-firstpromoter-v2-contracts
- collection_type: open
  name: FirstPromoter Custom Referral Statuses API
  slug: open-firstpromoter-v2-custom-referral-statuses
- collection_type: open
  name: FirstPromoter Dashboards API
  slug: open-firstpromoter-v2-dashboard
- collection_type: open
  name: FirstPromoter Email API
  slug: open-firstpromoter-v2-emails
- collection_type: open
  name: FirstPromoter Invoices API
  slug: open-firstpromoter-v2-invoices
- collection_type: open
  name: FirstPromoter API
  slug: open-firstpromoter-v2-payent-batches
- collection_type: open
  name: FirstPromoter Admin Payouts API
  slug: open-firstpromoter-v2-payouts
- collection_type: open
  name: FirstPromoter PromoCodes API
  slug: open-firstpromoter-v2-promocodes
- collection_type: open
  name: FirstPromoter Promoter Campaigns API
  slug: open-firstpromoter-v2-promoter-campaigns
- collection_type: open
  name: FirstPromoter API
  slug: open-firstpromoter-v2-promoters
- collection_type: open
  name: FirstPromoter Referral Custom Status API
  slug: open-firstpromoter-v2-referral-custom-status
- collection_type: open
  name: FirstPromoter Admin API
  slug: open-firstpromoter-v2-referrals
- collection_type: open
  name: FirstPromoter Reports API
  slug: open-firstpromoter-v2-reports
- collection_type: open
  name: FirstPromoter Admin API - Rewards
  slug: open-firstpromoter-v2-rewards
- collection_type: open
  name: FirstPromoter Tracking API V2
  slug: open-firstpromoter-v2-tracking
- collection_type: open
...
- group: docs
  title: ''
  type: APIReference
  url: https://docs.firstpromoter.com/api-reference-v2/api-admin/introduction
- group: start
  title: ''
  type: GettingStarted
  url: https://docs.firstpromoter.com/quickstart
- group: operate
  title: ''
  type: Support
  url: https://help.firstpromoter.com/en/
- group: operate
  title: ''
  type: HelpCenter
  url: https://help.firstpromoter.com/en/
...
- group: start
  title: ''
  type: SignUp
  url: https://app.firstpromoter.com/signup
- group: start
  title: ''
  type: Login
  url: https://app.firstpromoter.com/login
- group: commercial
  title: ''
  type: TermsOfService
...
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://firstpromoter.com/privacy
- group: auth
  title: ''
  type: Compliance
  url: https://firstpromoter.com/gdpr
- group: operate
  title: ''
  type: ChangeLog
...
created: '2026-06-13'
description: FirstPromoter is an affiliate, referral and influencer marketing platform for SaaS and subscription businesses, run by Igil Web SRL since 2016. It tracks clicks, leads and sales, manages promoters and campaigns, calculates multi-tier commissions and rewards, and pays affiliates through PayPal, Wise, Stripe and managed payouts. The public v2 REST API spans 37 first-party OpenAPI definitions and 179 operations across an admin surface, a promoter-facing surface and a server-side tracking surface, alongside a 44-event webhooks v2 system, a browser tracking library, and a remote MCP server for AI clients.
examples:
- key_count: 3
