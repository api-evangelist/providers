...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/exegy/refs/heads/main/security/exegy-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/exegy-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/exegy/refs/heads/main/llms/exegy-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/exegy-llms.txt
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/exegy/refs/heads/main/packages/exegy-packages.yml
  title: ''
  type: Packages
...
nav: Providers
network: true
overview: 'Exegy is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Finance, Market Data, Trading, Real-Time, and Low Latency.
