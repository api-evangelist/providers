...
nav: Providers
network: true
overview: 'Monday.com publishes 2 APIs on the [APIs.io](https://apis.io/) network, including Platform GraphQL API, and 1 more. Tagged areas include Work Management, CRM, Automation, and GraphQL.
