...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/bunny-net/refs/heads/main/capabilities/bunny-net-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/bunny-net-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/bunny-net/refs/heads/main/agentic-access/bunny-net-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/bunny-net-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bunny-net/refs/heads/main/security/bunny-net-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/bunny-net-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/bunny-net/refs/heads/main/authentication/bunny-net-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/bunny-net/refs/heads/main/plans/bunny-net-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/bunny-net-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/bunny-net/refs/heads/main/rate-limits/bunny-net-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/bunny-net-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/bunny-net/refs/heads/main/finops/bunny-net-finops.yml
  title: ''
  type: FinOps
