...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ip2location/refs/heads/main/security/ip2location-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/ip2location-domain-security.yml
- group: company
  title: ''
  type: Website
...
created: '2026-05-28'
description: IP geolocation web service to get more than 55 parameters
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/ip2location.png
layout: provider
modified: '2026-05-28'
name: IP2Location
nav: Providers
...
- kind: domain-security
  name: Ip2Location Domain Security
  slug: ip2location-domain-security
