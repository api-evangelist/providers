...
nav: Providers
network: true
overview: 'Sendoso publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Marketplace and SmartSend API, Webhooks, Campaigns API, and 5 more. Tagged areas include Corporate Gifting, Direct Mail, Sales Engagement, Marketing Automation, and CRM Integration.
