...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/chromacode/refs/heads/main/well-known/chromacode-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/chromacode-well-known.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/chromacode/refs/heads/main/well-known/chromacode-openid-configuration-apps.json
  title: ''
  type: OpenIDConnect
  url: well-known/chromacode-openid-configuration-apps.json
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/chromacode/refs/heads/main/authentication/chromacode-authentication.yml
  title: ''
  type: Authentication
  url: authentication/chromacode-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/chromacode/refs/heads/main/scopes/chromacode-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/chromacode-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/chromacode/refs/heads/main/conventions/chromacode-conventions.yml
  title: ''
  type: Conventions
  url: conventions/chromacode-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/chromacode/refs/heads/main/errors/chromacode-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/chromacode-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/chromacode/refs/heads/main/lifecycle/chromacode-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/chromacode-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/chromacode/refs/heads/main/conformance/chromacode-conformance.yml
  title: ''
  type: Conformance
  url: conformance/chromacode-conformance.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/chromacode/refs/heads/main/security/chromacode-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/chromacode-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/chromacode/refs/heads/main/llms/chromacode-llms.txt
  title: ''
  type: LLMsTxt
