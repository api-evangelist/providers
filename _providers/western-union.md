...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/western-union/refs/heads/main/capabilities/western-union-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/western-union-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/western-union/refs/heads/main/agentic-access/western-union-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/western-union-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/western-union/refs/heads/main/security/western-union-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/western-union-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/western-union/refs/heads/main/authentication/western-union-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'The Western Union Company publishes 8 APIs on the [APIs.io](https://apis.io/) network, including western-union Balances API, western-union Batches API, western-union Customers API, and 5 more. Tagged areas include Fortune 500.
