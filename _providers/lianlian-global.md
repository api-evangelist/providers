...
- acting_count: 262
  human_in_the_loop: 0
  name: Lianlian Global Agentic Access
  operation_count: 548
  slug: lianlian-global-agentic-access
...
- group: company
  title: ''
  type: Website
  url: https://www.lianlianglobal.com
- group: start
  title: ''
  type: DeveloperPortal
  url: https://developer.lianlianglobal.com
- group: docs
  title: ''
  type: Documentation
  url: https://developer.lianlianglobal.com
- group: docs
  title: ''
  type: APIReference
  url: https://developer.lianlianglobal.com/docs/lppe/72b66de24898e-introduction
- group: start
  title: ''
  type: GettingStarted
  url: https://developer.lianlianglobal.com/docs/lppe/b6b6c2d4906e9-authentication
- group: operate
  title: ''
  type: Support
  url: https://support.us.lianlianglobal.com/hc/en-us
- group: company
  title: ''
  type: Blog
  url: https://www.lianlianglobal.com/in-the-news
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/LLGlobal
- group: start
  title: ''
  type: SignUp
  url: https://account.lianlianglobal.com/signupguide
- group: start
  title: ''
  type: Login
  url: https://global.lianlian.com/console
- group: commercial
  title: ''
  type: TermsOfService
  url: https://us.lianlianglobal.com/legal/terms
- group: commercial
  title: ''
  type: PrivacyPolicy
...
created: '2026-07-17'
description: LianLian Global (连连国际) is the cross-border payments arm of LianLian DigiTech, providing licensed collection, disbursement, foreign exchange and card issuing rails for e-commerce sellers, marketplaces, travel platforms and B2B traders moving money between China and the rest of the world. Its developer platform publishes 18 distinct API products on a Stoplight portal at developer.lianlianglobal.com — covering B2C marketplace collection, multi-currency e-wallets, global payout, B2B import/export settlement, standard remittance, tuition and travel payments, embedded Connect accounts, virtual and physical card issuing, and the OAuth 2.0 LPPE platform surface — backed by 173 published OpenAPI/Swagger specifications describing more than 550 operations. LianLian authenticates with API keys and OAuth 2.0, signs every request and webhook with RSA SHA-256 via the LLPAY-Signature header, and ships first-party Java and TypeScript SDKs, a Python sandbox CLI and three published AI agent skills
...
security:
- kind: authentication
  name: Lianlian Global Authentication
  slug: lianlian-global-authentication
  summary_line: apiKey/http/oauth2 · 6 schemes
- kind: domain-security
  name: Lianlian Global Domain Security
  slug: lianlian-global-domain-security
  summary_line: TLSv1.3 · HSTS · DMARC
slug: lianlian-global
tags:
- Payments
