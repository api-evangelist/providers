...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/getlinks/refs/heads/main/security/getlinks-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: Getlinks is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Recruiting, Hiring, Talent, and Job.
random_paper: 7
score:
  band: minimal
  composite: 2.8
