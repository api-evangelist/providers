...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/superlinked/refs/heads/main/security/superlinked-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/superlinked-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/superlinked/refs/heads/main/security/superlinked-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/superlinked-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/superlinked/refs/heads/main/authentication/superlinked-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Superlinked publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Data Loader API, Ingestion API, Query API, and 2 more. Tagged areas include Vectors, Embeddings, Vector Search, Retrieval, and Recommendations.
