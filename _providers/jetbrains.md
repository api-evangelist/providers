...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/jetbrains/refs/heads/main/capabilities/jetbrains-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/jetbrains-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/jetbrains/refs/heads/main/agentic-access/jetbrains-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/jetbrains-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jetbrains/refs/heads/main/security/jetbrains-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/jetbrains-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jetbrains/refs/heads/main/security/jetbrains-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/jetbrains-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jetbrains/refs/heads/main/authentication/jetbrains-authentication.yml
  title: ''
  type: Authentication
...
overview: 'JetBrains publishes 33 APIs on the [APIs.io](https://apis.io/) network, including Activities API, Agent Pools API, Agents API, and 30 more. Tagged areas include CI/CD, Developer Tools, and IDE.
  ...
  JetBrains'' developer surface includes authentication, documentation, engineering blog, support, and 8 more developer resources.'
plans:
