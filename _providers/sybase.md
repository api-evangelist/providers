...
common:
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/sybase/refs/heads/main/plans/sybase-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/sybase-plans-pricing.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/sybase/refs/heads/main/capabilities/sybase-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/sybase/refs/heads/main/agentic-access/sybase-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/sybase-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sybase/refs/heads/main/security/sybase-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/sybase-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sybase/refs/heads/main/security/sybase-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/sybase-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sybase/refs/heads/main/authentication/sybase-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Sybase publishes 12 APIs on the [APIs.io](https://apis.io/) network, including Backups API, Configuration API, Databases API, and 9 more. Tagged areas include Database, Enterprise, SAP, and SQL.


  The Sybase catalog on APIs.io includes 1 JSON-LD context and 2 Spectral governance rulesets.


  Sybase''s developer surface includes authentication, developer portal, support, engineering blog, documentation, getting-started guide, changelog, and 20 more developer resources.'
plans:
