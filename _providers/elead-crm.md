...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/elead-crm/refs/heads/main/capabilities/elead-crm-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/elead-crm-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/elead-crm/refs/heads/main/agentic-access/elead-crm-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/elead-crm-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/elead-crm/refs/heads/main/security/elead-crm-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/elead-crm-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/elead-crm/refs/heads/main/authentication/elead-crm-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/elead-crm/refs/heads/main/plans/elead-crm-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/elead-crm-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/elead-crm/refs/heads/main/rate-limits/elead-crm-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/elead-crm-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/elead-crm/refs/heads/main/finops/elead-crm-finops.yml
  title: ''
  type: FinOps
...
overview: 'Elead publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Activities API, Customers API, Opportunities API, and 1 more. Tagged areas include CRM, Automotive, Dealership, Sales, and Leads.
  ...
  Elead''s developer surface includes authentication, documentation, and 8 more developer resources.'
plans:
