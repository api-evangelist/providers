...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tmdb/refs/heads/main/security/tmdb-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/tmdb/refs/heads/main/plans/tmdb-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/tmdb-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/tmdb/refs/heads/main/rate-limits/tmdb-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/tmdb-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/tmdb/refs/heads/main/finops/tmdb-finops.yml
  title: ''
  type: FinOps
  url: finops/tmdb-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tmdb/refs/heads/main/rules/tmdb-rules.yml
  title: ''
  type: SpectralRules
  url: rules/tmdb-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tmdb/refs/heads/main/vocabulary/tmdb-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/tmdb-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tmdb/refs/heads/main/json-ld/tmdb-context.jsonld
  title: ''
  type: JSONLD
...
nav: Providers
network: true
overview: 'The Movie Database publishes 21 APIs on the [APIs.io](https://apis.io/) network, including Account API, Authentication API, Certification API, and 18 more. Tagged areas include Catalog, Discovery, Entertainment, Image, and Media.
