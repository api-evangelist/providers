...
nav: Providers
network: true
overview: 'Wireshark publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Debugging, Developer Tools, Network Analysis, Open-Source, and Packet Capture.
