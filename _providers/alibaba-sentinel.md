...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/alibaba-sentinel/refs/heads/main/mcp/alibaba-sentinel-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/alibaba-sentinel-mcp.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/alibaba-sentinel/refs/heads/main/overlays/alibaba-sentinel-sentinel-dashboard-api-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/alibaba-sentinel-sentinel-dashboard-api-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/alibaba-sentinel/refs/heads/main/agentic-access/alibaba-sentinel-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/alibaba-sentinel-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/alibaba-sentinel/refs/heads/main/security/alibaba-sentinel-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/alibaba-sentinel-domain-security.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/alibaba-sentinel/refs/heads/main/packages/alibaba-sentinel-packages.yml
  title: ''
  type: Packages
  url: packages/alibaba-sentinel-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/alibaba-sentinel/refs/heads/main/well-known/alibaba-sentinel-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/alibaba-sentinel-well-known.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/alibaba-sentinel/refs/heads/main/llms/alibaba-sentinel-llms.txt
  title: ''
  type: LLMsTxt
