...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/routeros/refs/heads/main/capabilities/routeros-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/routeros-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/routeros/refs/heads/main/agentic-access/routeros-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/routeros-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/routeros/refs/heads/main/security/routeros-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/routeros-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/routeros/refs/heads/main/security/routeros-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/routeros-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/routeros/refs/heads/main/authentication/routeros-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'RouterOS publishes 11 APIs on the [APIs.io](https://apis.io/) network, including Bridge API, DHCP API, DNS API, and 8 more. Tagged areas include Networking, Router, Network Management, Firewall, and MikroTik.
