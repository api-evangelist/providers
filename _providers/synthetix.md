...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/synthetix/refs/heads/main/agentic-access/synthetix-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/synthetix-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/synthetix/refs/heads/main/security/synthetix-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Synthetix publishes 11 APIs on the [APIs.io](https://apis.io/) network, including Escrowed Balance API, Health Check API, Staking API, and 8 more. Tagged areas include DeFi, Derivatives, Perpetuals, Synthetic Assets, and Liquidity Protocol.


  The Synthetix catalog on APIs.io includes 1 Spectral governance ruleset.


  Synthetix''s developer surface includes documentation and 15 more developer resources.'
plans:
- name: Plans
  plan_count: 9
  slug: plans
