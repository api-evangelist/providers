...
- collection_type: open
  name: RoomKeyPMS POS API
  slug: open-roomkeypms-pos-api
- collection_type: open
  name: RoomKeyPMS POS Reservation Data API
  slug: open-roomkeypms-reservation-data-api
- collection_type: open
  name: RoomKeyPMS POS Statistics API
  slug: open-roomkeypms-statistics-api
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/roomkeypms/refs/heads/main/capabilities/roomkeypms-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/roomkeypms-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/roomkeypms/refs/heads/main/agentic-access/roomkeypms-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/roomkeypms-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/roomkeypms/refs/heads/main/security/roomkeypms-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/roomkeypms-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/roomkeypms/refs/heads/main/security/roomkeypms-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/roomkeypms-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/roomkeypms/refs/heads/main/authentication/roomkeypms-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/roomkeypms/refs/heads/main/plans/roomkeypms-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/roomkeypms-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/roomkeypms/refs/heads/main/rate-limits/roomkeypms-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/roomkeypms-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/roomkeypms/refs/heads/main/finops/roomkeypms-finops.yml
  title: ''
  type: FinOps
...
score:
  ...
  upsert:
    applies: true
    score: 0.0
screenshot: https://raw.githubusercontent.com/api-evangelist/roomkeypms/refs/heads/main/screenshots/roomkeypms-2026-09-02T154117.png
security:
- kind: authentication
