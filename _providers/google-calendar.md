...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-calendar/refs/heads/main/agentic-access/google-calendar-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-calendar-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-calendar/refs/heads/main/security/google-calendar-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-calendar-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-calendar/refs/heads/main/security/google-calendar-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-calendar/refs/heads/main/json-ld/json-ld.jsonld
  title: ''
  type: JSONLD
...
overview: 'Google Calendar publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Calendars API, Colors API, Users API, and 1 more. Tagged areas include Availability, Calendar, Event, Google, and Google Workspace.
  ...
  Google Calendar''s developer surface includes developer portal, getting-started guide, documentation, authentication, pricing, support, engineering blog, and 10 more developer resources.'
plans:
