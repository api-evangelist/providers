...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/wideorbit/refs/heads/main/security/wideorbit-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/wideorbit-domain-security.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/wideorbit/refs/heads/main/conformance/wideorbit-conformance.yml
  title: ''
  type: Conformance
  url: conformance/wideorbit-conformance.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/wideorbit/refs/heads/main/scopes/wideorbit-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/wideorbit/refs/heads/main/well-known/wideorbit-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/wideorbit-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/wideorbit/refs/heads/main/authentication/wideorbit-authentication.yml
  title: ''
  type: Authentication
...
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/wideorbit/refs/heads/main/packages/wideorbit-packages.yml
  title: ''
  type: Packages
  url: packages/wideorbit-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/wideorbit/refs/heads/main/llms/wideorbit-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/wideorbit-llms.txt
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/wideorbit/refs/heads/main/conventions/wideorbit-conventions.yml
  title: ''
  type: Conventions
  url: conventions/wideorbit-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/wideorbit/refs/heads/main/errors/wideorbit-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/wideorbit-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/wideorbit/refs/heads/main/data-model/wideorbit-data-model.yml
  title: ''
  type: DataModel
  url: data-model/wideorbit-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/wideorbit/refs/heads/main/lifecycle/wideorbit-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/wideorbit-lifecycle.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/wideorbit/refs/heads/main/sandbox/wideorbit-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/wideorbit-sandbox.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/wideorbit/refs/heads/main/asyncapi/wideorbit-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/wideorbit-webhooks.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/wideorbit/refs/heads/main/plans/wideorbit-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/wideorbit-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/wideorbit/refs/heads/main/rate-limits/wideorbit-rate-limits.yml
  title: ''
  type: RateLimits
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/wideorbit/refs/heads/main/screenshots/wideorbit-2026-09-02T170733.png
security:
- kind: authentication
