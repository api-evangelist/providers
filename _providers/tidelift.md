...
- group: other
  title: ''
  type: ParentCompany
  url: https://apis.io/providers/sonar/
- group: company
  title: ''
  type: Website
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tidelift/refs/heads/main/authentication/tidelift-authentication.yml
  title: ''
  type: Authentication
  url: authentication/tidelift-authentication.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/tidelift/refs/heads/main/agentic-access/tidelift-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/tidelift-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tidelift/refs/heads/main/security/tidelift-vulnerability-disclosure.yml
  title: ''
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tidelift/refs/heads/main/security/tidelift-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/tidelift-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/tidelift/refs/heads/main/well-known/tidelift-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/tidelift-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/tidelift/refs/heads/main/well-known/tidelift-security.txt
  title: ''
  type: SecurityTxt
  url: well-known/tidelift-security.txt
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/tidelift/refs/heads/main/packages/tidelift-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/tidelift-packages.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/tidelift/refs/heads/main/cli/tidelift-cli.yml
  title: ''
  type: CLI
  url: cli/tidelift-cli.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/tidelift/refs/heads/main/mcp/tidelift-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/tidelift-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/tidelift/refs/heads/main/llms/tidelift-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/tidelift-llms.txt
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tidelift/refs/heads/main/conventions/tidelift-conventions.yml
  title: ''
  type: Conventions
  url: conventions/tidelift-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tidelift/refs/heads/main/errors/tidelift-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/tidelift-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tidelift/refs/heads/main/conformance/tidelift-conformance.yml
  title: ''
  type: Conformance
  url: conformance/tidelift-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tidelift/refs/heads/main/lifecycle/tidelift-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/tidelift-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tidelift/refs/heads/main/data-model/tidelift-data-model.yml
  title: ''
  type: DataModel
  url: data-model/tidelift-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tidelift/refs/heads/main/asyncapi/tidelift-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/tidelift-webhooks.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/tidelift/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/tidelift/refs/heads/main/arazzo/tidelift-package-vulnerability-check.arazzo.yml
  title: ''
  type: Arazzo
