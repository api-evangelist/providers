...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/open-financial/refs/heads/main/security/open-financial-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Open (open.money) publishes 10 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include Connected Banking, Neobank, Small Business, Embedded Finance, and Banking as a Service.
