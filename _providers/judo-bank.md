...
api_count: 1
apis:
- baseURL: https://public.open.judo.bank/cds-au/v1/banking/products
...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/judo-bank/refs/heads/main/capabilities/judo-bank-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/judo-bank-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/judo-bank/refs/heads/main/agentic-access/judo-bank-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/judo-bank-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/judo-bank/refs/heads/main/authentication/judo-bank-authentication.yml
  title: ''
  type: Authentication
  url: authentication/judo-bank-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/judo-bank/refs/heads/main/security/judo-bank-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/judo-bank-domain-security.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/judo-bank/refs/heads/main/conventions/judo-bank-conventions.yml
  title: ''
  type: Conventions
  url: conventions/judo-bank-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/judo-bank/refs/heads/main/errors/judo-bank-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/judo-bank-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/judo-bank/refs/heads/main/conformance/judo-bank-conformance.yml
  title: ''
  type: Conformance
  url: conformance/judo-bank-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/judo-bank/refs/heads/main/lifecycle/judo-bank-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/judo-bank-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/judo-bank/refs/heads/main/data-model/judo-bank-data-model.yml
  title: ''
  type: DataModel
  url: data-model/judo-bank-data-model.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/judo-bank/refs/heads/main/mcp/judo-bank-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/judo-bank-mcp.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/judo-bank/refs/heads/main/overlays/judo-bank-cds-banking-products-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/judo-bank-cds-banking-products-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/judo-bank/refs/heads/main/skills/judo-bank-product-lookup.md
  title: ''
  type: AgentSkill
  url: skills/judo-bank-product-lookup.md
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/judo-bank/refs/heads/main/well-known/judo-bank-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/judo-bank-well-known.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/judo-bank/refs/heads/main/llms/judo-bank-llms.txt
  title: ''
  type: LLMsTxt
...
nav: Providers
network: true
overview: 'Judo Bank publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Banking Account Balances API, Banking Account Direct Debits API, Banking Account Scheduled Payments API, and 4 more. Tagged areas include Finance, Banks, Open Banking, CDR, and Consumer Banking.
