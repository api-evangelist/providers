...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/ucla/refs/heads/main/openapi/_original/ucla-sis-dictionary-openapi.yml
  title: ''
  type: OpenAPI
  url: openapi/_original/ucla-sis-dictionary-openapi.yml
- group: docs
...
nav: Providers
network: true
overview: 'University of California, Los Angeles publishes 14 APIs on the [APIs.io](https://apis.io/) network, including Class Sections API, Classes API, Courses API, and 11 more. Tagged areas include University, Higher Education, Education, United States, and California.
