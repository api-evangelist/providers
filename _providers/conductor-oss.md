...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/conductor-oss/refs/heads/main/agentic-access/conductor-oss-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/conductor-oss-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/conductor-oss/refs/heads/main/security/conductor-oss-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Conductor OSS publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Events API, Metadata API, Tasks API, and 2 more. Tagged areas include AI Agents, Durable Execution, Event-Driven, Microservices, and Netflix.
