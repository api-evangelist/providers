...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/test-scripts/refs/heads/main/agentic-access/test-scripts-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/test-scripts-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/test-scripts/refs/heads/main/security/test-scripts-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/test-scripts-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/test-scripts/refs/heads/main/security/test-scripts-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/test-scripts-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/test-scripts/refs/heads/main/security/test-scripts-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/test-scripts-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/test-scripts/refs/heads/main/authentication/test-scripts-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Test Scripts publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Collections API, Environments API, Mocks API, and 1 more. Tagged areas include Automation, CI/CD, Contract Testing, Developer Tools, and Quality Assurance.
