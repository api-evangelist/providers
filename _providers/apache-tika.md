...
- group: auth
  title: ''
  type: SecurityPolicy
  url: https://github.com/apache/tika/blob/main/SECURITY.md
- group: build
  title: ''
  type: CodeOfConduct
...
- group: docs
  ...
  url: https://github.com/apache/tika/blob/main/CONTRIBUTING.md
- group: commercial
  title: ''
  type: License
  url: https://github.com/apache/tika/blob/main/LICENSE
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/apache-tika/refs/heads/main/agentic-access/apache-tika-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/apache-tika-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apache-tika/refs/heads/main/security/apache-tika-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/apache-tika-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apache-tika/refs/heads/main/security/apache-tika-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Apache Tika publishes 13 APIs on the [APIs.io](https://apis.io/) network, including Apache Tika Server REST API, Detect API, Detectors API, and 10 more. Tagged areas include Content Extraction, Document Processing, Metadata, Text Extraction, and Open Source.
