...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/apple/refs/heads/main/agentic-access/apple-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/apple-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apple/refs/heads/main/security/apple-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/apple-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apple/refs/heads/main/security/apple-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/apple-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apple/refs/heads/main/authentication/apple-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/apple/refs/heads/main/json-ld/apple-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/apple-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/apple/refs/heads/main/rules/apple-spectral-rules.yml
  title: ''
  type: SpectralRules
...
overview: 'Apple publishes 3 APIs on the [APIs.io](https://apis.io/) network: Apps API, Beta Testers API, and Builds API. Tagged areas include Apple, Developers, iOS, macOS, and Mobile.
  ...
  Apple''s developer surface includes authentication, support, engineering blog, signup flow, pricing, YouTube channel, changelog, and 19 more developer resources.'
plans:
