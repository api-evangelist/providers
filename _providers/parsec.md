...
common:
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/parsec/refs/heads/main/plans/parsec-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/parsec-plans-pricing.yml
- group: company
  title: ''
  type: Website
...
overview: 'Parsec publishes 8 APIs on the [APIs.io](https://apis.io/) network, including App Rule API, Audit Log API, Group API, and 5 more. Tagged areas include Company, Remote Desktop, Cloud Gaming, Streaming, and Virtual Desktop.
  ...
  Parsec''s developer surface includes documentation, API reference, support, engineering blog, pricing, signup flow, changelog, and 29 more developer resources.'
plans:
- name: Parsec Plans Pricing
  plan_count: 6
  slug: parsec-plans-pricing
- name: Parsec Price Estimates
  plan_count: 0
  slug: parsec-price-estimates
random_paper: 0
rate_limits:
- limit_count: 1
