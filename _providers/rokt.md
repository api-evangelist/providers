...
nav: Providers
network: true
overview: 'Rokt publishes 1 API on the [APIs.io](https://apis.io/) network: Query API. Tagged areas include E-Commerce, Advertising, Transaction Moment, Personalization, and Offers.
