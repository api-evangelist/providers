...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/callisto-media/refs/heads/main/security/callisto-media-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/callisto-media-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/callisto-media/refs/heads/main/well-known/callisto-media-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/callisto-media-well-known.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/callisto-media/refs/heads/main/llms/callisto-media-llms.txt
  title: ''
  type: LLMsTxt
