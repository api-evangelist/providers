...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/docebo/refs/heads/main/security/docebo-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/docebo/refs/heads/main/plans/docebo-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/docebo-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/docebo/refs/heads/main/rate-limits/docebo-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/docebo-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/docebo/refs/heads/main/finops/docebo-finops.yml
  title: ''
  type: FinOps
  url: finops/docebo-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/docebo/refs/heads/main/json-ld/docebo.json
  title: ''
  type: JSONLD
  url: json-ld/docebo.json
- group: company
  href: https://raw.githubusercontent.com/api-evangelist/docebo/refs/heads/main/blogs/blogs.json
  title: ''
  type: BlogPosts
...
overview: 'Docebo publishes 1 API on the [APIs.io](https://apis.io/) network: REST API. Tagged areas include Learning Management System, LMS, E-Learning, Training, and Courses.
  ...
  Docebo''s developer surface includes documentation, developer portal, authentication, changelog, status page, engineering blog, release notes, and 9 more developer resources.'
plans:
