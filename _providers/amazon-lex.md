...
overview: 'Amazon Lex publishes 1 API on the [APIs.io](https://apis.io/) network: Bots API.
  ...
  Amazon Lex''s developer surface includes authentication, developer portal, documentation, support, engineering blog, GitHub presence, developer console, and 18 more developer resources.'
plans:
