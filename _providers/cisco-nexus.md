...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cisco-nexus/refs/heads/main/agentic-access/cisco-nexus-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/cisco-nexus-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cisco-nexus/refs/heads/main/security/cisco-nexus-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/cisco-nexus-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cisco-nexus/refs/heads/main/authentication/cisco-nexus-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Cisco Nexus Dashboard publishes 16 APIs on the [APIs.io](https://apis.io/) network, including Authentication API, Interfaces API, Routing API, and 13 more. Tagged areas include Data Center, Infrastructure, Network Automation, Networking, and SDN.


  The Cisco Nexus Dashboard catalog on APIs.io includes 2 JSON-LD contexts and 2 Spectral governance rulesets.


  Cisco Nexus Dashboard''s developer surface includes authentication, engineering blog, training material, sandbox, support, code examples, and 8 more developer resources.'
plans:
