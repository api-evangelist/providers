...
- baseURL: https://rest.ceros.com
  baseurl_source: declared
  description: The o Embed API from Ceros — 1 operation(s) for o embed.
  name: Ceros o Embed API
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ceros/refs/heads/main/mcp/ceros-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/ceros-mcp.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/ceros/refs/heads/main/overlays/ceros-public-api-overlay.yaml
  title: ''
  type: Overlay
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ceros/refs/heads/main/security/ceros-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/ceros-trust-center.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/ceros/refs/heads/main/packages/ceros-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/ceros-packages.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ceros/refs/heads/main/components/ceros-components.yml
  title: ''
  type: Components
  url: components/ceros-components.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ceros/refs/heads/main/llms/ceros-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/ceros-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ceros/refs/heads/main/well-known/ceros-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/ceros-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ceros/refs/heads/main/authentication/ceros-authentication.yml
  title: ''
  type: Authentication
  url: authentication/ceros-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ceros/refs/heads/main/conventions/ceros-conventions.yml
  title: ''
  type: Conventions
  url: conventions/ceros-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ceros/refs/heads/main/lifecycle/ceros-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/ceros-lifecycle.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/ceros/refs/heads/main/changelog/ceros-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/ceros-changelog.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ceros/refs/heads/main/errors/ceros-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/ceros-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ceros/refs/heads/main/data-model/ceros-data-model.yml
  title: ''
  type: DataModel
  url: data-model/ceros-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/ceros/refs/heads/main/conformance/ceros-conformance.yml
  title: ''
  type: Conformance
  url: conformance/ceros-conformance.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ceros/refs/heads/main/security/ceros-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/ceros-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ceros/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
