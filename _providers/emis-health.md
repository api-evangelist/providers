...
nav: Providers
network: true
overview: 'EMIS Health publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Appointments API, CORS API, and 8 more. Tagged areas include Healthcare, United Kingdom, EHR, EMR, and Interoperability.
