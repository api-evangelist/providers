...
access_model:
  ...
  source:
  - security
  - '{''url'': ''https://www.dustphotonics.com/'', ''status'': 301, ''note'': ''declared website redirects to https://credosemi.com/products/silicon-photonics/ — a different registrable domain (dustphotonics.com -> credosemi.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/dustphotonics/refs/heads/main/llms/dustphotonics-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/dustphotonics-llms.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/dustphotonics/refs/heads/main/security/dustphotonics-domain-security.yml
  title: ''
  type: DomainSecurity
