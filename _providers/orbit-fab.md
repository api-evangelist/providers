...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/orbit-fab/refs/heads/main/a2a/orbit-fab-a2a.yml
  title: ''
  type: AgentCard
...
nav: Providers
network: true
overview: 'Orbit Fab is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company and A2A.
