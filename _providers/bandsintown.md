...
nav: Providers
network: true
overview: 'Bandsintown publishes 2 APIs on the [APIs.io](https://apis.io/) network: artist events API and artist information API. Tagged areas include concerts, live music, events, artists, and venues.
