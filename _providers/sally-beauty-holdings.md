...
- description: Sally Beauty Supply's digital commerce platform powered by Salesforce Commerce Cloud, providing product catalog, shopping cart, checkout, and order management capabilities for consumer beauty supply c
  ...
  slug: sallybeauty-ecommerce
- description: 'The Beauty Systems Group professional distribution platform serving licensed salon professionals. Provides product ordering, professional pricing, loyalty programs, and salon-focused services through '
  name: Beauty Systems Group (BSG) Professional Platform
  slug: bsg-ecommerce
artifact_total: 10
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sally-beauty-holdings/refs/heads/main/security/sally-beauty-holdings-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/sally-beauty-holdings-domain-security.yml
- group: company
  title: ''
  type: Website
...
finops:
- name: Sally Beauty Holdings Finops
  service_category: API
  slug: sally-beauty-holdings-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/sally-beauty-holdings.png
json_schemas:
- name: Sally Beauty Product
  property_count: 16
  slug: sally-beauty-product
json_structures:
- name: Sally Beauty Product Structure
  property_count: 0
  slug: sally-beauty-product-structure
jsonld:
- class_count: 0
...
overview: 'Sally Beauty Holdings publishes 2 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include Beauty, Retail, E-Commerce, Professional, and Consumer.
  ...
  Sally Beauty Holdings'' developer surface includes engineering blog and 10 more developer resources.'
plans:
- name: Sally Beauty Holdings Plans Pricing
  plan_count: 3
