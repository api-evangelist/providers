...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/micro-connect/refs/heads/main/well-known/micro-connect-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/micro-connect-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/micro-connect/refs/heads/main/authentication/micro-connect-authentication.yml
  title: ''
  type: Authentication
  url: authentication/micro-connect-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/micro-connect/refs/heads/main/scopes/micro-connect-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/micro-connect-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/micro-connect/refs/heads/main/conformance/micro-connect-conformance.yml
  title: ''
  type: Conformance
...
- group: auth
  ...
  url: conformance/micro-connect-conformance.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/micro-connect/refs/heads/main/security/micro-connect-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/micro-connect-domain-security.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/micro-connect/refs/heads/main/lifecycle/micro-connect-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/micro-connect-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/micro-connect/refs/heads/main/conventions/micro-connect-conventions.yml
  title: ''
  type: Conventions
  url: conventions/micro-connect-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/micro-connect/refs/heads/main/errors/micro-connect-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/micro-connect-problem-types.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/micro-connect/refs/heads/main/packages/micro-connect-packages.yml
  title: ''
  type: Packages
  url: packages/micro-connect-packages.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/micro-connect/refs/heads/main/plans/micro-connect-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/micro-connect-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/micro-connect/refs/heads/main/rate-limits/micro-connect-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/micro-connect-rate-limits.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/micro-connect/refs/heads/main/llms/micro-connect-llms.txt
  title: ''
  type: LLMsTxt
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/micro-connect/refs/heads/main/screenshots/micro-connect-2026-09-02T150543.png
security:
- kind: authentication
