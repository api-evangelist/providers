...
- group: operate
  title: ''
  type: Releases
  url: https://github.com/Arize-ai/phoenix/releases
- group: auth
  title: ''
  type: SecurityPolicy
...
- group: build
  title: ''
  type: CodeOfConduct
  url: https://github.com/Arize-ai/phoenix/blob/main/CODE_OF_CONDUCT.md
- group: docs
  title: ''
  type: ContributionGuide
  url: https://github.com/Arize-ai/phoenix/blob/main/CONTRIBUTING.md
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/arize-ai/refs/heads/main/agentic-access/arize-ai-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/arize-ai-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/arize-ai/refs/heads/main/security/arize-ai-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/arize-ai-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/arize-ai/refs/heads/main/authentication/arize-ai-authentication.yml
  title: ''
  type: Authentication
