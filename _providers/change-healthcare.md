...
access_model:
  ...
  - '{''url'': ''https://www.changehealthcare.com'', ''status'': 301, ''note'': ''declared website redirects to https://business.optum.com/en/?src=chc — a different registrable domain (changehealthcare.com -> optum.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/change-healthcare/refs/heads/main/llms/change-healthcare-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/change-healthcare-llms.txt
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/change-healthcare/refs/heads/main/lifecycle/change-healthcare-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/change-healthcare-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/change-healthcare/refs/heads/main/conformance/change-healthcare-conformance.yml
  title: ''
  type: Conformance
  url: conformance/change-healthcare-conformance.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/change-healthcare/refs/heads/main/packages/change-healthcare-packages.yml
  title: ''
  type: Packages
  url: packages/change-healthcare-packages.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/change-healthcare/refs/heads/main/security/change-healthcare-domain-security.yml
  title: ''
  type: DomainSecurity
