...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://waifu.pics/docs'', ''status'': 301, ''note'': ''declared website redirects to https://sejarahjitu1.com/ — a different registrable domain (waifu.pics -> sejarahjitu1.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/waifu-pics/refs/heads/main/security/waifu-pics-domain-security.yml
  title: ''
  type: DomainSecurity
