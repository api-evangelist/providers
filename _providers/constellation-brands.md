...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/constellation-brands/refs/heads/main/capabilities/constellation-brands-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/constellation-brands-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/constellation-brands/refs/heads/main/agentic-access/constellation-brands-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/constellation-brands-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/constellation-brands/refs/heads/main/security/constellation-brands-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/constellation-brands-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/constellation-brands/refs/heads/main/authentication/constellation-brands-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Constellation Brands publishes 13 APIs on the [APIs.io](https://apis.io/) network, including BottleShots API, HotSheets API, Items API, and 10 more. Tagged areas include Alcohol, Beer, Beverages, Digital Assets, and Fortune 500.
