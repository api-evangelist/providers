...
access_model:
  ...
  - authentication
  - security
  - '{''url'': ''https://www.groovehq.com'', ''status'': 308, ''note'': ''declared website redirects to https://helply.com/ — a different registrable domain (groovehq.com -> helply.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: agent-ready
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/groove/refs/heads/main/security/groove-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/groove-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/groove/refs/heads/main/authentication/groove-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Groove publishes 12 APIs on the [APIs.io](https://apis.io/) network, including Webhooks, Agents API, Attachments API, and 9 more. Tagged areas include Customer Support, Help Desk, Shared Inbox, Knowledge Base, and Conversations.
