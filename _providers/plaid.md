...
nav: Providers
network: true
overview: 'Plaid publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Finance, Fintech, Open Banking, Bank Accounts, and Data Aggregation.
