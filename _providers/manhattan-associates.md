...
- collection_type: open
  name: Manhattan Active Omni Order Management Inbound API
  slug: open-manhattan-associates-inbound-api
- collection_type: open
  name: Manhattan Active Omni Order Management Inbound Inventory API
  slug: open-manhattan-associates-inventory-api
- collection_type: open
  name: Manhattan Active Omni Order Management API
  slug: open-manhattan-associates-omni
- collection_type: open
  name: Manhattan Active Omni Order Management Inbound Orders API
  slug: open-manhattan-associates-orders-api
- collection_type: open
  name: Manhattan Active Omni Order Management Inbound Outbound API
  slug: open-manhattan-associates-outbound-api
- collection_type: open
  name: Manhattan Active Omni Order Management Inbound Promising API
  slug: open-manhattan-associates-promising-api
- collection_type: open
  name: Manhattan Active Omni Order Management Inbound Returns API
  slug: open-manhattan-associates-returns-api
- collection_type: open
  name: Manhattan Active Supply Chain (WMS) API
  slug: open-manhattan-associates-wms
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/manhattan-associates/refs/heads/main/capabilities/manhattan-associates-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/manhattan-associates-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/manhattan-associates/refs/heads/main/agentic-access/manhattan-associates-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/manhattan-associates-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/manhattan-associates/refs/heads/main/security/manhattan-associates-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/manhattan-associates-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/manhattan-associates/refs/heads/main/authentication/manhattan-associates-authentication.yml
  title: ''
  type: Authentication
  url: authentication/manhattan-associates-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/manhattan-associates/refs/heads/main/scopes/manhattan-associates-scopes.yml
  title: ''
  type: OAuthScopes
...
nav: Providers
network: true
overview: 'Manhattan Associates publishes 9 APIs on the [APIs.io](https://apis.io/) network, including manhattan-associates Inbound API, manhattan-associates Inventory API, manhattan-associates Orders API, and 6 more. Tagged areas include Logistics, Supply Chain, Platform, Software-as-a-Service, and Transportation.
