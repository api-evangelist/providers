...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/socialcrawl/refs/heads/main/capabilities/socialcrawl-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/socialcrawl-capability-edges.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/socialcrawl/refs/heads/main/well-known/socialcrawl-provider-apis.json
  title: ''
  type: APIsJSON
  url: well-known/socialcrawl-provider-apis.json
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/socialcrawl/refs/heads/main/well-known/socialcrawl-api-onboarding.json
  title: ''
  type: Onboarding
  url: well-known/socialcrawl-api-onboarding.json
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/socialcrawl/refs/heads/main/llms/socialcrawl-llms.txt
  title: ''
  type: LLMsTxt
...
nav: Providers
network: true
overview: 'SocialCrawl publishes 58 APIs on the [APIs.io](https://apis.io/) network, including AI Search API, Amazon API, App Store API, and 55 more. Tagged areas include social media scraping, Unified-API, Data Extraction, and cross-platform search.
