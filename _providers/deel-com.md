...
nav: Providers
network: true
overview: 'Deel publishes 39 APIs on the [APIs.io](https://apis.io/) network, including Adjustments API, Applications API, Candidates API, and 36 more. Tagged areas include HR, Payroll, Global Payroll, EOR, and Employer of Record.
