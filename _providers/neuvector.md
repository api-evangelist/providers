...
- baseURL: https://localhost:10443
  baseurl_source: declared
  description: The API Key API from NeuVector — 2 operation(s) for api key.
  name: NeuVector API Key API
...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/neuvector/refs/heads/main/capabilities/neuvector-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/neuvector-capability-edges.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/neuvector/refs/heads/main/security/neuvector-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/neuvector-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/neuvector
- group: company
  title: ''
  type: Website
...
finops:
- name: Neuvector Finops
  service_category: API
  slug: neuvector-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/neuvector.png
layout: provider
modified: '2026-04-28'
name: NeuVector
nav: Providers
network: true
overview: 'NeuVector publishes 31 APIs on the [APIs.io](https://apis.io/) network, including Admission API, Authentication API, Compliance API, and 28 more. Tagged areas include Compliance, Containers, Kubernetes, Open-Source, and Runtime Protection.
