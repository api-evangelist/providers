...
- group: other
  title: ''
  type: ParentCompany
  url: https://apis.io/providers/labcorp/
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/covance/refs/heads/main/security/covance-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/covance-domain-security.yml
- group: company
  title: ''
  type: Website
...
- group: company
  title: ''
  type: Blog
  url: https://www.fortrea.com/insights
created: '2024-01-01'
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/covance.png
layout: provider
modified: '2026-04-28'
name: Covance (Fortrea)
nav: Providers
network: true
overview: 'Covance (Fortrea) is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Bioanalytical, Biotechnology, Central Laboratory, Clinical Development, and Clinical Trials.
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/covance/refs/heads/main/screenshots/covance-2026-06-20T175114.png
security:
- kind: domain-security
  name: Covance Domain Security
  slug: covance-domain-security
