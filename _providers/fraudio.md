...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/fraudio/refs/heads/main/security/fraudio-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Fraudio is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Fraud Prevention, Payment Fraud, AML, Financial Crime, and Payments.
