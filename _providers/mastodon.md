...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mastodon/refs/heads/main/security/mastodon-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Mastodon publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Open Source, Social Network, Real-Time, and Social.
