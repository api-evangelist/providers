...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/datafiniti/refs/heads/main/agentic-access/datafiniti-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/datafiniti-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/datafiniti/refs/heads/main/security/datafiniti-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/datafiniti-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/datafiniti/refs/heads/main/authentication/datafiniti-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/datafiniti/refs/heads/main/json-ld/datafiniti-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/datafiniti-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/datafiniti/refs/heads/main/vocabulary/datafiniti-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/datafiniti-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/datafiniti/refs/heads/main/rules/datafiniti-rules.yml
  title: ''
  type: Rules
...
nav: Providers
network: true
overview: 'Datafiniti publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Authentication API, Businesses API, People API, and 6 more. Tagged areas include Business Data, Data Aggregation, Data as a Service, People Data, and Product Data.
