...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/customs-and-border-protection/refs/heads/main/security/customs-and-border-protection-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Customs and Border Protection publishes 5 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include ACE, ACAS, AES, AESDirect, and Borders.
