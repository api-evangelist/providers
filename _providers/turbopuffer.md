...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/turbopuffer/refs/heads/main/agentic-access/turbopuffer-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/turbopuffer-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/turbopuffer/refs/heads/main/security/turbopuffer-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/turbopuffer-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/turbopuffer/refs/heads/main/authentication/turbopuffer-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'turbopuffer publishes 11 APIs on the [APIs.io](https://apis.io/) network, including Namespaces API, and 10 more. Tagged areas include Vector Search, Full-Text Search, Hybrid Search, BM25, and Serverless.
