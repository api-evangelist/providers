...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/lambda/refs/heads/main/capabilities/lambda-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/lambda/refs/heads/main/agentic-access/lambda-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/lambda-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lambda/refs/heads/main/security/lambda-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/lambda-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lambda/refs/heads/main/security/lambda-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/lambda-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lambda/refs/heads/main/security/lambda-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/lambda-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lambda/refs/heads/main/authentication/lambda-authentication.yml
  title: ''
  type: Authentication
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/lambda/refs/heads/main/json-schema/lambda-cloud-api-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/lambda-cloud-api-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/lambda/refs/heads/main/json-ld/lambda-context.jsonld
  title: ''
  type: JSONLD
...
overview: 'Lambda publishes 5 APIs on the [APIs.io](https://apis.io/) network, including File Systems API, Images API, Instance Types API, and 2 more. Tagged areas include Artificial Intelligence, Cloud Computing, Compute, Deep Learning, and GPU.
  ...
  Lambda''s developer surface includes authentication, developer portal, documentation, getting-started guide, pricing, engineering blog, support, and 14 more developer resources.'
plans:
