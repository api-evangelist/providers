...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/blynk/refs/heads/main/security/blynk-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Blynk publishes 3 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include IoT, No-Code, Low-Code, Connected Devices, and Device Management.
