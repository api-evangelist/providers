...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/highline-fi/refs/heads/main/agentic-access/highline-fi-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/highline-fi-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/highline-fi/refs/heads/main/security/highline-fi-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/highline-fi-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/highline-fi/refs/heads/main/authentication/highline-fi-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Highline publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Auth API, Companies API, Connections API, and 7 more. Tagged areas include Embedded Finance, Payroll, Payments, ACH, and Bill Pay.
