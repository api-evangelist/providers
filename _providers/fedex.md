...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/fedex/refs/heads/main/capabilities/fedex-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/fedex-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/fedex/refs/heads/main/agentic-access/fedex-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/fedex-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/fedex/refs/heads/main/security/fedex-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/fedex-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/fedex/refs/heads/main/authentication/fedex-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'FedEx publishes 2 APIs on the [APIs.io](https://apis.io/) network: Authorization API and Track API. Tagged areas include Address Validation, Freight, Logistics, Pickup, and Ratings.


  FedEx''s developer surface includes authentication, documentation, getting-started guide, signup flow, and 6 more developer resources.'
plans:
