...
- group: start
  ...
  url: https://docs.metamarkets.com/docs/getting-started
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/metamarkets-group/refs/heads/main/llms/metamarkets-group-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/metamarkets-group-llms.txt
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/metamarkets-group/refs/heads/main/packages/metamarkets-group-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/metamarkets-group-packages.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/metamarkets-group/refs/heads/main/authentication/metamarkets-group-authentication.yml
  title: ''
  type: Authentication
  url: authentication/metamarkets-group-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/metamarkets-group/refs/heads/main/conventions/metamarkets-group-conventions.yml
  title: ''
  type: Conventions
  url: conventions/metamarkets-group-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/metamarkets-group/refs/heads/main/errors/metamarkets-group-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/metamarkets-group-problem-types.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/metamarkets-group/refs/heads/main/sandbox/metamarkets-group-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/metamarkets-group-sandbox.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/metamarkets-group/refs/heads/main/well-known/metamarkets-group-well-known.yml
  title: ''
  type: WellKnown
