...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/baseten/refs/heads/main/agentic-access/baseten-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/baseten-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/baseten/refs/heads/main/security/baseten-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/baseten-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/baseten/refs/heads/main/security/baseten-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/baseten-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/baseten/refs/heads/main/authentication/baseten-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/baseten/refs/heads/main/plans/baseten-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/baseten-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/baseten/refs/heads/main/rate-limits/baseten-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/baseten-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/baseten/refs/heads/main/finops/baseten-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Baseten publishes 3 APIs on the [APIs.io](https://apis.io/) network, including Chat Completions API, Messages API, and 1 more. Tagged areas include Artificial Intelligence, Machine Learning, Inference, Deployment, and MLOps.
