...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/rigetti-and-co/refs/heads/main/agentic-access/rigetti-and-co-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/rigetti-and-co-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/rigetti-and-co/refs/heads/main/security/rigetti-and-co-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/rigetti-and-co-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/rigetti-and-co/refs/heads/main/authentication/rigetti-and-co-authentication.yml
  title: ''
  type: Authentication
  url: authentication/rigetti-and-co-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/rigetti-and-co/refs/heads/main/conventions/rigetti-and-co-conventions.yml
  title: ''
  type: Conventions
  url: conventions/rigetti-and-co-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/rigetti-and-co/refs/heads/main/errors/rigetti-and-co-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/rigetti-and-co-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/rigetti-and-co/refs/heads/main/lifecycle/rigetti-and-co-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: operate
  ...
  url: lifecycle/rigetti-and-co-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/rigetti-and-co/refs/heads/main/conformance/rigetti-and-co-conformance.yml
  title: ''
  type: Conformance
  url: conformance/rigetti-and-co-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/rigetti-and-co/refs/heads/main/data-model/rigetti-and-co-data-model.yml
  title: ''
  type: DataModel
  url: data-model/rigetti-and-co-data-model.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/rigetti-and-co/refs/heads/main/packages/rigetti-and-co-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/rigetti-and-co-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/rigetti-and-co/refs/heads/main/mcp/rigetti-and-co-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/rigetti-and-co-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/rigetti-and-co/refs/heads/main/llms/rigetti-and-co-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/rigetti-and-co-llms.txt
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/rigetti-and-co/refs/heads/main/overlays/rigetti-and-co-qcs-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/rigetti-and-co-qcs-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/rigetti-and-co/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/rigetti-and-co/refs/heads/main/well-known/rigetti-and-co-well-known.yml
  title: ''
  type: WellKnown
