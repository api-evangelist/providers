...
- description: The Assets API from Marketo — 133 operation(s) for assets.
...
nav: Providers
network: true
overview: 'Marketo publishes 64 APIs on the [APIs.io](https://apis.io/) network, including Approve API, Assets API, Campaigns API, and 61 more. Tagged areas include Adobe, Automation, Marketing, and Marketing Automation.


  The Marketo catalog on APIs.io includes 1 event-driven AsyncAPI specification and 1 Spectral governance ruleset.


  Marketo''s developer surface includes developer portal, getting-started guide, engineering blog, privacy policy, and 8 more developer resources.'
plans:
...
website: https://developers.marketo.com/
---
