...
- acting_count: 22
  ...
  summary_line: 106 operations · 22 acting · 1 human-in-the-loop
api_count: 42
apis:
...
- group: start
  ...
  url: https://developer.lytx.com
- group: docs
  title: ''
  type: Documentation
  url: https://developer.lytx.com/docs/gettingstarted
- group: start
  title: ''
  type: GettingStarted
  url: https://developer.lytx.com/docs/gettingstarted
...
- group: docs
  title: ''
  type: APIReference
  url: https://developer.lytx.com/docs/api-reference
- group: build
  title: ''
  type: Postman
  url: https://developer.lytx.com/assets/postman_collection.b9289c66b5614d0fc97bd8f06d2fcbc20ed198edf70f2535d33b8300b6d87b86.5a30fde5.json
- group: commercial
  title: ''
  type: TermsOfService
  url: https://developer.lytx.com/tos
- group: operate
  title: ''
  type: Support
  url: https://support.lytx.com
created: '2026-07-17'
description: Lytx is a video telematics and fleet management technology company whose Lytx Vision Platform combines machine-vision cameras (DriveCam and Surfsight), AI event detection, GPS tracking, and telematics data for commercial fleets and safety programs. Lytx exposes an open developer API at api.lytx.com that lets integrators access video, real-time GPS and location, vehicle and device data, driver and safety event data, and tracking data programmatically to build custom fleet, insurance, maintenance, and routing integrations on top of the Lytx platform. Authentication is bearer-token based (with advanced OIDC/SSO/MFA options), and the developer portal at developer.lytx.com publishes getting-started guides, authentication docs, an API reference, and webhooks documentation.
...
nav: Providers
network: true
overview: 'Lytx publishes 37 APIs on the [APIs.io](https://apis.io/) network, including Consent API, Devices (DriveCam) API, Devices (GO9) API, and 34 more. Tagged areas include Company, Fleet Management, Video Telematics, Vehicle Safety, and GPS Tracking.
...
security:
- kind: authentication
  name: Lytx Authentication
  slug: lytx-authentication
  summary_line: apiKey/http · 2 schemes
- kind: domain-security
  name: Lytx Domain Security
  slug: lytx-domain-security
