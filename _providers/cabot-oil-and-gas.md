...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cabot-oil-and-gas/refs/heads/main/security/cabot-oil-and-gas-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/cabot-oil-and-gas-domain-security.yml
- group: company
  title: ''
  type: Website
...
- group: company
  ...
  url: https://investors.coterra.com
- group: other
  title: ''
  type: Sustainability
  url: https://www.coterra.com/sustainability/
- group: company
  title: ''
  type: Newsroom
  url: https://www.coterra.com/media/
- group: company
  title: ''
  type: Careers
  url: https://www.coterra.com/careers/
- group: commercial
  title: ''
  type: Legal Notice
  url: https://www.coterra.com/legal-notice/
created: '2026-03-23'
description: Cabot Oil & Gas was an independent oil and gas company engaged in the development, exploitation, exploration, production, and marketing of natural gas and oil properties in the United States. In 2021 it merged with Cimarex Energy to form Coterra Energy, which operates across the Permian Basin, Marcellus Shale, and Anadarko Basin.
finops:
- name: Cabot Oil And Gas Finops
  service_category: Energy / Oil & Gas
  slug: cabot-oil-and-gas-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/cabot-oil-and-gas.png
layout: provider
modified: '2026-07-25'
name: Cabot Oil & Gas
nav: Providers
network: true
overview: Cabot Oil & Gas is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Energy, Oil and Gas, Natural Gas, Coterra, and Company.
plans:
- name: Cabot Oil And Gas Plans Pricing
  plan_count: 0
...
- limit_count: 0
  ...
  slug: cabot-oil-and-gas-rate-limits
score:
  band: minimal
  composite: 4.9
  coverage:
...
- kind: domain-security
  name: Cabot Oil And Gas Domain Security
  slug: cabot-oil-and-gas-domain-security
  summary_line: TLSv1.3 · HSTS · DMARC
slug: cabot-oil-and-gas
tags:
- Energy
- Oil and Gas
- Natural Gas
