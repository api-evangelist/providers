...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://mensabrands.com'', ''status'': 301, ''note'': ''declared website redirects to https://brndme.in/ — a different registrable domain (mensabrands.com -> brndme.in), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mensa-brands/refs/heads/main/security/mensa-brands-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/mensa-brands-domain-security.yml
- group: company
  title: ''
  type: Website
...
- group: company
  title: ''
  type: LinkedIn
  url: https://in.linkedin.com/company/mensa-brands
created: '2026-07-17'
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/mensa-brands/refs/heads/main/screenshots/mensa-brands-2026-08-07T172528.png
security:
