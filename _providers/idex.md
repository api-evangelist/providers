...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/idex/refs/heads/main/security/idex-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/idex-domain-security.yml
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/idex-corp
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/idex-corporation
- group: company
  title: ''
  type: Website
  url: https://www.idexcorp.com/
- group: company
  title: ''
  type: About
  url: https://www.idexcorp.com/about-idex/
- group: company
  title: ''
  type: Investor Relations
  url: https://investors.idexcorp.com/
- group: company
  title: ''
  type: Careers
  url: https://www.idexcorp.com/careers/
- group: company
  title: ''
  type: Blog
  url: https://idexcorp.com/feed/
created: '2026-03-24'
description: 'IDEX Corporation (NYSE: IEX) is a global engineered products company that designs and manufactures pumps, flow meters, valves, fluidics systems, precision components, and fire and safety equipment. IDEX serves health, science, water, energy, semiconductor, aerospace, fire and safety, and industrial markets through three segments: Fluid and Metering Technologies, Health and Science Technologies, and Fire and Safety / Diversified Products.'
