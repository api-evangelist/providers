...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/apache-knox/refs/heads/main/agentic-access/apache-knox-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/apache-knox-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apache-knox/refs/heads/main/security/apache-knox-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/apache-knox-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apache-knox/refs/heads/main/security/apache-knox-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/apache-knox-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apache-knox/refs/heads/main/authentication/apache-knox-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/apache-knox/refs/heads/main/rules/apache-knox-spectral-rules.yml
  title: ''
  type: SpectralRules
  url: rules/apache-knox-spectral-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/apache-knox/refs/heads/main/vocabulary/apache-knox-vocabulary.yaml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'Apache Knox publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Descriptors API, Providers API, Topologies API, and 1 more. Tagged areas include API Gateway, Authentication, Hadoop, Open Source, and Security.


  The Apache Knox catalog on APIs.io includes 3 JSON-LD contexts and 2 Spectral governance rulesets.


  Apache Knox''s developer surface includes authentication, documentation, getting-started guide, and 13 more developer resources.'
plans:
