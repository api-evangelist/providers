...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/calpine/refs/heads/main/security/calpine-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/calpine-domain-security.yml
- group: company
  title: ''
  type: Website
  url: https://www.calpine.com
- group: other
  title: ''
  type: Wikipedia
  url: https://en.wikipedia.org/wiki/Calpine
- group: other
  title: ''
  type: Champion Energy
  url: https://www.championenergyservices.com/
- group: other
  title: ''
  type: Parent Company
...
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/calpine
- group: company
  title: ''
  type: Blog
  url: https://www.calpine.com/feed/
created: '2024-01-01'
description: Calpine Corporation was a major U.S. energy company headquartered in Houston, Texas, and was the largest generator of electricity from natural gas and geothermal energy in the United States. It operated 80 power plants with approximately 26,035 megawatts of generation capacity, including The Geysers, the world's largest geothermal complex. Calpine also operated the Champion Energy retail electricity subsidiary serving deregulated markets. As of January 2026, Constellation Energy completed its acquisition of Calpine for $16.4 billion, making it a business unit of Constellation. Calpine does not publish a public developer API program.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/calpine.png
layout: provider
modified: '2026-04-23'
name: Calpine
nav: Providers
network: true
overview: 'Calpine is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Electricity, Energy, Geothermal, Natural Gas, and Power Generation.
...
- kind: domain-security
  name: Calpine Domain Security
  slug: calpine-domain-security
