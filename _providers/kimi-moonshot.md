...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/kimi-moonshot/refs/heads/main/agentic-access/kimi-moonshot-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/kimi-moonshot-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/kimi-moonshot/refs/heads/main/security/kimi-moonshot-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/kimi-moonshot-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/kimi-moonshot/refs/heads/main/authentication/kimi-moonshot-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Kimi (Moonshot AI) publishes 13 APIs on the [APIs.io](https://apis.io/) network, including Batch API, Billing API, Chat API, and 10 more. Tagged areas include LLM, Long Context, Artificial Intelligence, OpenAI-Compatible, and Multi-Modal.
