...
- group: commercial
  title: ''
  type: Pricing
  url: https://www.whippy.ai/pricing
- group: other
...
overview: 'Whippy publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Campaigns API, Channels API, Contacts API, and 4 more. Tagged areas include Communications, Messaging, SMS, Email, and Voice.
  ...
  Whippy''s developer surface includes pricing, authentication, documentation, engineering blog, and 8 more developer resources.'
plans:
- name: Whippy Plans Pricing
  plan_count: 6
  slug: whippy-plans-pricing
- name: Whippy Price Estimates
  plan_count: 0
  slug: whippy-price-estimates
random_paper: 13
rate_limits:
- limit_count: 12
