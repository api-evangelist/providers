...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/synapse/refs/heads/main/capabilities/synapse-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/synapse-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/synapse/refs/heads/main/agentic-access/synapse-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/synapse-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/synapse/refs/heads/main/security/synapse-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/synapse-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/synapse/refs/heads/main/security/synapse-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/synapse-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/synapse/refs/heads/main/authentication/synapse-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Synapse publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Federation API, Media API, Registration API, and 6 more. Tagged areas include Chat, Collaboration, Decentralized, Federation, and Matrix.
