...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/salesforce-automation-system/refs/heads/main/agentic-access/salesforce-automation-system-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/salesforce-automation-system-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/salesforce-automation-system/refs/heads/main/security/salesforce-automation-system-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/salesforce-automation-system-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/salesforce-automation-system/refs/heads/main/authentication/salesforce-automation-system-authentication.yml
  title: ''
  type: Authentication
  url: authentication/salesforce-automation-system-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/salesforce-automation-system/refs/heads/main/scopes/salesforce-automation-system-scopes.yml
  title: ''
  type: OAuthScopes
...
overview: 'Salesforce Automation System publishes 2 APIs on the [APIs.io](https://apis.io/) network: Flows API and Process Automation API. Tagged areas include Approval Process, Automation, CRM, Flow, and Process Builder.
  ...
  Salesforce Automation System''s developer surface includes authentication, documentation, engineering blog, support, and 13 more developer resources.'
plans:
