...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/att/refs/heads/main/agentic-access/att-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/att-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/att/refs/heads/main/security/att-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/att-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/att/refs/heads/main/authentication/att-authentication.yml
  title: ''
  type: Authentication
  url: authentication/att-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/att/refs/heads/main/scopes/att-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/att-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/att/refs/heads/main/rules/att-spectral-rules.yml
  title: ''
  type: SpectralRules
  url: rules/att-spectral-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/att/refs/heads/main/vocabulary/att-vocabulary.yaml
  title: ''
  type: Vocabulary
  url: vocabulary/att-vocabulary.yaml
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/att/refs/heads/main/graphql/att-graphql.md
  title: ''
  type: GraphQL
  url: graphql/att-graphql.md
- group: company
  title: ''
  type: Website
...
created: '2025-05-02'
description: 'AT&T Inc. is a multinational telecommunications holding company providing wireless and wireline communications, broadband, and business networking to consumers and enterprises. Its developer surface spans four programs: the legacy AT&T Developer Program (SMS, MMS, in-app messaging, speech and OAuth), the MVNX APIs for mobile virtual network operators, the Alliance enterprise wireline APIs for service qualification and ordering, and the invite-only Network API Accelerator Program exposing GSMA CAMARA network APIs — SIM swap, device status, number verification, quality on demand, network insights and mobility threat detection.'
examples:
- key_count: 6
  name: Att Checksimswap Example
  slug: att-checksimswap-example
- key_count: 6
  name: Att Createqodsession Example
  slug: att-createqodsession-example
- key_count: 6
  name: Att Getdeviceconnectivitystatus Example
  slug: att-getdeviceconnectivitystatus-example
- key_count: 6
  name: Att Getdeviceroamingstatus Example
  slug: att-getdeviceroamingstatus-example
- key_count: 6
  name: Att Getdevicethreats Example
  slug: att-getdevicethreats-example
- key_count: 6
  name: Att Getnetworkmetrics Example
  slug: att-getnetworkmetrics-example
- key_count: 6
  name: Att Getqodsession Example
  slug: att-getqodsession-example
- key_count: 6
  name: Att Listqodsessions Example
  slug: att-listqodsessions-example
- key_count: 6
  name: Att Retrievesimswapdate Example
  slug: att-retrievesimswapdate-example
- key_count: 6
  name: Att Subscribetothreatalerts Example
  slug: att-subscribetothreatalerts-example
- key_count: 6
  name: Att Verifyphonenumber Example
  slug: att-verifyphonenumber-example
- key_count: 1
...
- name: Att Finops
  ...
  slug: att-finops
graphqls:
- description: This conceptual GraphQL schema models the AT&T telecommunications and network services platform, covering wireless accounts, device management, voice and messaging services, data usage, billing, netwo
  name: AT&T GraphQL Schema
  slug: att-graphql
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/att.png
integrations:
...
- name: CreateSessionRequest
  property_count: 5
  slug: att-createsessionrequest
- name: Device
  property_count: 3
  slug: att-device
- name: DeviceConnectivityRequest
  property_count: 1
  slug: att-deviceconnectivityrequest
- name: DeviceConnectivityStatus
  property_count: 2
  slug: att-deviceconnectivitystatus
- name: DeviceRoamingRequest
  property_count: 1
  slug: att-deviceroamingrequest
- name: DeviceRoamingStatus
  property_count: 3
  slug: att-deviceroamingstatus
- name: ErrorInfo
  property_count: 3
  slug: att-errorinfo
- name: NetworkMetrics
  property_count: 6
  slug: att-networkmetrics
- name: NetworkMetricsRequest
  property_count: 1
  slug: att-networkmetricsrequest
- name: NumberVerificationRequest
  property_count: 1
  slug: att-numberverificationrequest
- name: NumberVerificationResponse
  property_count: 1
  slug: att-numberverificationresponse
- name: SessionInfo
  property_count: 7
  slug: att-sessioninfo
- name: SimSwapCheckRequest
  property_count: 2
  slug: att-simswapcheckrequest
- name: SimSwapCheckResponse
  property_count: 1
  slug: att-simswapcheckresponse
- name: SimSwapDateRequest
  property_count: 1
  slug: att-simswapdaterequest
- name: SimSwapDateResponse
  property_count: 1
  slug: att-simswapdateresponse
- name: ThreatAssessment
  property_count: 4
  slug: att-threatassessment
- name: ThreatAssessmentRequest
  property_count: 1
  slug: att-threatassessmentrequest
- name: ThreatIndicator
  property_count: 4
  slug: att-threatindicator
- name: ThreatSubscription
  property_count: 4
  slug: att-threatsubscription
- name: ThreatSubscriptionRequest
  property_count: 4
  slug: att-threatsubscriptionrequest
- name: DeviceConnectivityRequest
  property_count: 1
...
jsonld:
- class_count: 5
  name: Att Device Status Api Context
  property_count: 11
  slug: att-device-status-api-context
- class_count: 9
  name: Att In App Messaging Api Context
  property_count: 28
  slug: att-in-app-messaging-api-context
- class_count: 7
  name: Att Mobility Threat Anomaly Detection Api Context
  property_count: 14
  slug: att-mobility-threat-anomaly-detection-api-context
- class_count: 18
  name: Att Mvnx Api Context
  property_count: 30
  slug: att-mvnx-api-context
- class_count: 3
  name: Att Network Insights Api Context
  property_count: 10
  slug: att-network-insights-api-context
- class_count: 2
  name: Att Number Verification Api Context
  property_count: 2
  slug: att-number-verification-api-context
- class_count: 3
  name: Att Quality On Demand Api Context
  property_count: 13
  slug: att-quality-on-demand-api-context
- class_count: 4
  name: Att Sim Swap Api Context
  property_count: 4
  slug: att-sim-swap-api-context
- class_count: 8
  name: Att Sms Api Context
  property_count: 27
  slug: att-sms-api-context
- class_count: 0
...
- effective_rule_count: 4
  ...
  severity_counts:
    ...
    info: 1
    warn: 3
  slug: att-jsonschema-spectral-rules
