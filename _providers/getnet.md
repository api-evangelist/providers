...
nav: Providers
network: true
overview: 'Getnet publishes 19 APIs on the [APIs.io](https://apis.io/) network, including SAP Immediate Delivery APIs, and 18 more. Tagged areas include Payments, Acquirer, Brazil, Latin America, and Santander.
