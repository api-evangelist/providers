...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/jmock/refs/heads/main/security/jmock-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/jmock-domain-security.yml
- group: company
  title: ''
  type: Website
...
created: '2024-01-01'
description: JMock is a library that supports test-driven development of Java code with mock objects. It provides an expressive API for defining expectations and mock behavior in unit tests, integrating with popular testing frameworks including JUnit. The most recent stable release is jMock 2.13.1.
finops:
- name: Jmock Finops
  service_category: API
  slug: jmock-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/jmock.png
layout: provider
modified: '2026-04-28'
name: JMock
nav: Providers
