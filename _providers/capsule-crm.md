...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/capsule-crm/refs/heads/main/agentic-access/capsule-crm-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/capsule-crm-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/capsule-crm/refs/heads/main/security/capsule-crm-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/capsule-crm-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/capsule-crm/refs/heads/main/authentication/capsule-crm-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Capsule CRM publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Entries API, Opportunities API, Parties API, and 6 more. Tagged areas include CRM, Sales, Contacts, Pipeline Management, and Task.
