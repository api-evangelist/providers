...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/signal/refs/heads/main/agentic-access/signal-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/signal-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/signal/refs/heads/main/security/signal-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/signal-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/signal/refs/heads/main/security/signal-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/signal-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/signal/refs/heads/main/authentication/signal-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Signal publishes 14 APIs on the [APIs.io](https://apis.io/) network, including Accounts API, Attachments API, Certificates API, and 11 more. Tagged areas include Encryption, Messaging, Security, Cryptography, and Open Source.
