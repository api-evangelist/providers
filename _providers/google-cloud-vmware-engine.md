...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-vmware-engine/refs/heads/main/agentic-access/google-cloud-vmware-engine-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-cloud-vmware-engine-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-vmware-engine/refs/heads/main/security/google-cloud-vmware-engine-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-cloud-vmware-engine-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-vmware-engine/refs/heads/main/security/google-cloud-vmware-engine-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/google-cloud-vmware-engine-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-vmware-engine/refs/heads/main/authentication/google-cloud-vmware-engine-authentication.yml
  title: ''
  type: Authentication
  url: authentication/google-cloud-vmware-engine-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-vmware-engine/refs/heads/main/scopes/google-cloud-vmware-engine-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-vmware-engine/refs/heads/main/json-ld/vmwareengine-context.jsonld
  title: ''
  type: JSONLD
...
overview: 'Google Cloud VMware Engine publishes 3 APIs on the [APIs.io](https://apis.io/) network: Clusters API, PrivateClouds API, and Network Policies API. Tagged areas include Compute, Google Cloud, Migration, Private Cloud, and Virtualization.
  ...
  Google Cloud VMware Engine''s developer surface includes authentication, getting-started guide, pricing, engineering blog, and 7 more developer resources.'
plans:
