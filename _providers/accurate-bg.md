...
nav: Providers
network: true
overview: 'Accurate Background publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Adjudication API, Candidates API, Documents API, and 6 more. Tagged areas include Background Checks, Employment Screening, Identity Verification, Compliance, and Human Resources.
