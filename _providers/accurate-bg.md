...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/accurate-bg/refs/heads/main/agentic-access/accurate-bg-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/accurate-bg-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/accurate-bg/refs/heads/main/security/accurate-bg-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/accurate-bg-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/accurate-bg/refs/heads/main/authentication/accurate-bg-authentication.yml
  title: ''
  type: Authentication
  url: authentication/accurate-bg-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/accurate-bg/refs/heads/main/scopes/accurate-bg-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: start
  ...
  url: https://developer.accuratebackground.com/
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/accurate-bg/refs/heads/main/plans/accurate-bg-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/accurate-bg-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/accurate-bg/refs/heads/main/rate-limits/accurate-bg-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/accurate-bg-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/accurate-bg/refs/heads/main/finops/accurate-bg-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Accurate Background publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Adjudication API, Candidates API, Documents API, and 7 more. Tagged areas include Background Checks, Employment Screening, Identity Verification, Compliance, and Human Resources.
