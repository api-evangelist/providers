...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://opengraphr.com/docs/1.0/overview'', ''status'': 301, ''note'': ''declared website redirects to https://heine.familiedeelstra.com/ — a different registrable domain (opengraphr.com -> familiedeelstra.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/opengraphr/refs/heads/main/security/opengraphr-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/opengraphr-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/opengraphr/refs/heads/main/security/opengraphr-domain-security.yml
  title: ''
  type: DomainSecurity
