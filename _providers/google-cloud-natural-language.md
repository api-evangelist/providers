...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-natural-language/refs/heads/main/agentic-access/google-cloud-natural-language-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/google-cloud-natural-language-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-natural-language/refs/heads/main/security/google-cloud-natural-language-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/google-cloud-natural-language-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-natural-language/refs/heads/main/security/google-cloud-natural-language-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/google-cloud-natural-language/refs/heads/main/json-ld/context.jsonld
  title: ''
  type: JSONLD
...
overview: 'Google Cloud Natural Language publishes 5 APIs on the [APIs.io](https://apis.io/) network, including documents:analyzeEntities API, documents:analyzeSentiment API, documents:analyzeSyntax API, and 2 more. Tagged areas include Entity Recognition, Google Cloud, Machine-Learning, Natural Language Processing, and Sentiment Analysis.
  ...
  Google Cloud Natural Language''s developer surface includes developer portal, getting-started guide, documentation, authentication, pricing, support, and 10 more developer resources.'
plans:
