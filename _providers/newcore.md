...
- group: auth
  ...
  url: https://trust.newcore.com/
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/newcore/refs/heads/main/security/newcore-trust-center.yml
  title: ''
  type: TrustCenter
...
- group: auth
  ...
  url: security/newcore-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/newcore/refs/heads/main/security/newcore-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/newcore-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/newcore/refs/heads/main/security/newcore-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'NewCore is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Security, Identity, Identity and Access Management, and Authentication.
