...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/perplexity/refs/heads/main/agentic-access/perplexity-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/perplexity-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/perplexity/refs/heads/main/security/perplexity-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/perplexity-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/perplexity/refs/heads/main/security/perplexity-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/perplexity-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/perplexity/refs/heads/main/authentication/perplexity-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Perplexity publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Async Chat Completions API, Responses API, Agent API, and 6 more. Tagged areas include Artificial Intelligence, LLM, Search, Agents, and Embeddings.
