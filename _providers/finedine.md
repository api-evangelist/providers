...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/finedine/refs/heads/main/security/finedine-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/finedine-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/finedine/refs/heads/main/llms/finedine-llms.txt
  title: ''
  type: LLMsTxt
...
nav: Providers
network: true
overview: 'FineDine is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Restaurant, Hospitality, Digital Menu, and Ordering.
