...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/orderco/refs/heads/main/overlays/orderco-content-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/orderco-content-overlay.yaml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/orderco/refs/heads/main/authentication/orderco-authentication.yml
  title: ''
  type: Authentication
  url: authentication/orderco-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/orderco/refs/heads/main/conventions/orderco-conventions.yml
  title: ''
  type: Conventions
  url: conventions/orderco-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/orderco/refs/heads/main/errors/orderco-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/orderco-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/orderco/refs/heads/main/lifecycle/orderco-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/orderco/refs/heads/main/conformance/orderco-conformance.yml
  title: ''
  type: Conformance
  url: conformance/orderco-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/orderco/refs/heads/main/data-model/orderco-data-model.yml
  title: ''
  type: DataModel
  url: data-model/orderco-data-model.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/orderco/refs/heads/main/security/orderco-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/orderco-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/orderco/refs/heads/main/well-known/orderco-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/orderco-well-known.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/orderco/refs/heads/main/llms/orderco-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/orderco-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/orderco/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/orderco/refs/heads/main/examples/orderco-content-discovery.json
  title: ''
  type: Examples
