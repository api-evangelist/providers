...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/speak/refs/heads/main/well-known/speak-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/speak-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/speak/refs/heads/main/well-known/speak-security.txt
  title: ''
  type: SecurityTxt
  url: well-known/speak-security.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/speak/refs/heads/main/llms/speak-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/speak-llms.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/speak/refs/heads/main/authentication/speak-authentication.yml
  title: ''
  type: Authentication
  url: authentication/speak-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/speak/refs/heads/main/security/speak-vulnerability-disclosure.yml
  title: ''
...
- group: auth
  ...
  url: security/speak-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/speak/refs/heads/main/security/speak-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Speak publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Artificial Intelligence, Language Learning, Education, and EdTech.
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/speak/refs/heads/main/screenshots/speak-2026-09-02T160346.png
security:
- kind: authentication
