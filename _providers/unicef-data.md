...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/unicef-data/refs/heads/main/capabilities/unicef-data-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/unicef-data-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/unicef-data/refs/heads/main/agentic-access/unicef-data-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/unicef-data-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/unicef-data/refs/heads/main/security/unicef-data-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/unicef-data-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/unicef-data/refs/heads/main/authentication/unicef-data-authentication.yml
  title: ''
  type: Authentication
  url: authentication/unicef-data-authentication.yml
- group: company
  title: ''
  type: Website
...
- group: other
  title: ''
  type: OpenData
  url: https://data.unicef.org/open-data/
- group: build
  title: ''
  type: GitHubOrg
...
- group: company
  title: ''
  type: Blog
  url: https://data.unicef.org/blog/
- group: operate
  title: ''
  type: Support
  url: mailto:data@unicef.org
- group: other
  title: ''
  type: X
  url: https://x.com/unicefdata
- group: commercial
  title: ''
  type: License
  url: https://data.unicef.org/open-data/
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/unicef-data/refs/heads/main/plans/unicef-data-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/unicef-data-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/unicef-data/refs/heads/main/rate-limits/unicef-data-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/unicef-data-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/unicef-data/refs/heads/main/finops/unicef-data-finops.yml
  title: ''
  type: FinOps
  url: finops/unicef-data-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/unicef-data/refs/heads/main/vocabulary/unicef-data-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/unicef-data-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/unicef-data/refs/heads/main/json-ld/unicef-rdm-context.jsonld
  title: ''
  type: JSONLDContext
  url: json-ld/unicef-rdm-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/unicef-data/refs/heads/main/json-ld/unicef-geosight-context.jsonld
  title: ''
  type: JSONLDContext
  url: json-ld/unicef-geosight-context.jsonld
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/unicef-data/refs/heads/main/json-schema/unicef-geosight-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/unicef-geosight-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/unicef-data/refs/heads/main/json-schema/unicef-rdm-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/unicef-rdm-schema.json
created: '2026-06-13'
description: UNICEF Data is the official open data platform of the United Nations Children's Fund, providing programmatic access to global child welfare statistics, health and nutrition indicators, education data, child protection metrics, MICS (Multiple Indicator Cluster Survey) results, and SDG indicators for children across countries worldwide. The primary API is an SDMX REST web service exposing UNICEF's Data Warehouse, which contains 748+ indicators organized into thematic dataflows covering demography, maternal and child health, nutrition, HIV/AIDS, WASH, education, and gender. All data is freely accessible without authentication, licensed under Creative Commons Attribution 3.0 IGO.
examples:
- key_count: 2
  name: Sdmx Afghanistan Child Mortality 2020 2022
  slug: sdmx-afghanistan-child-mortality-2020-2022
finops:
- name: Unicef Data Finops
  service_category: ''
  slug: unicef-data-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/unicef-data.png
json_schemas:
- name: UNICEF GeoSight API Schemas
  property_count: 0
  slug: unicef-geosight
- name: UNICEF Reference Data Manager API Schemas
  property_count: 0
  slug: unicef-rdm
jsonld:
- class_count: 33
  name: Unicef Geosight Context
  property_count: 3
  slug: unicef-geosight-context
- class_count: 39
  name: Unicef Rdm Context
  property_count: 1
  slug: unicef-rdm-context
- class_count: 39
  name: Unicef Sdmx Context
  property_count: 5
...
overview: 'UNICEF Data publishes 25 APIs on the [APIs.io](https://apis.io/) network, including Basemap API, Code List API, Codelist API, and 22 more. Tagged areas include Children, Child Welfare, Global Health, Statistics, and SDG.
  ...
  UNICEF Data''s developer surface includes authentication, documentation, engineering blog, support, and 17 more developer resources.'
plans:
