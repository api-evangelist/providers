...
nav: Providers
network: true
overview: 'Clever publishes 11 APIs on the [APIs.io](https://apis.io/) network, including Events API, Assignments API, Courses API, and 8 more. Tagged areas include Education, K-12, EdTech, SSO, and Rostering.
