...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/disco/refs/heads/main/security/disco-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/disco-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/disco/refs/heads/main/security/disco-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'DISCO publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include eDiscovery, Legal Technology, Artificial Intelligence, Document Review, and Litigation.
