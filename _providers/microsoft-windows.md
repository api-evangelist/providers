...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/microsoft-windows/refs/heads/main/security/microsoft-windows-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/microsoft-windows-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/microsoft-windows/refs/heads/main/security/microsoft-windows-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Microsoft Windows publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Windows Runtime (WinRT) API, and 7 more. Tagged areas include Desktop, Development, Microsoft, Operating System, and Windows.


  Microsoft Windows'' developer surface includes developer portal, engineering blog, support, and 14 more developer resources.'
plans:
