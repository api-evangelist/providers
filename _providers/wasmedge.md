...
- group: operate
  title: ''
  type: IssueTracker
  url: https://github.com/WasmEdge/WasmEdge/issues
- group: operate
  title: ''
  type: Releases
...
- group: auth
  title: ''
  type: SecurityPolicy
  url: https://github.com/WasmEdge/WasmEdge/blob/master/SECURITY-INSIGHTS.yml
- group: build
  title: ''
  type: CodeOfConduct
  url: https://github.com/WasmEdge/WasmEdge/blob/master/docs/CODE_OF_CONDUCT.md
- group: docs
  title: ''
  type: ContributionGuide
  url: https://github.com/WasmEdge/WasmEdge/blob/master/docs/CONTRIBUTING.md
- group: commercial
  title: ''
  type: License
  url: https://github.com/WasmEdge/WasmEdge/blob/master/LICENSE
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/wasmedge/refs/heads/main/security/wasmedge-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/wasmedge/refs/heads/main/vocabulary/wasmedge-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/wasmedge-vocabulary.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/wasmedge/refs/heads/main/json-ld/wasmedge-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/wasmedge-context.jsonld
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/wasmedge/refs/heads/main/json-schema/wasmedge-config-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/wasmedge-config-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/wasmedge/refs/heads/main/json-structure/wasmedge-config-structure.json
  title: ''
  type: JSONStructure
...
overview: 'WasmEdge publishes 5 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include Cloud-Native, CNCF, Edge Computing, High Performance, and Runtime.
  ...
  WasmEdge''s developer surface includes documentation, getting-started guide, engineering blog, and 18 more developer resources.'
plans:
