...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/parse-biosciences/refs/heads/main/conformance/parse-biosciences-conformance.yml
  title: ''
  type: Conformance
  url: conformance/parse-biosciences-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/parse-biosciences/refs/heads/main/conventions/parse-biosciences-conventions.yml
  title: ''
  type: Conventions
  url: conventions/parse-biosciences-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/parse-biosciences/refs/heads/main/lifecycle/parse-biosciences-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/parse-biosciences-lifecycle.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/parse-biosciences/refs/heads/main/packages/parse-biosciences-packages.yml
  title: ''
  type: Packages
  url: packages/parse-biosciences-packages.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/parse-biosciences/refs/heads/main/plans/parse-biosciences-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/parse-biosciences-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/parse-biosciences/refs/heads/main/rate-limits/parse-biosciences-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/parse-biosciences-rate-limits.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/parse-biosciences/refs/heads/main/llms/parse-biosciences-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/parse-biosciences-llms.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/parse-biosciences/refs/heads/main/security/parse-biosciences-domain-security.yml
  title: ''
  type: DomainSecurity
