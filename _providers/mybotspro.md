...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mybotspro/refs/heads/main/security/mybotspro-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/mybotspro-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/mybotspro/refs/heads/main/well-known/mybotspro-well-known.yml
  title: ''
  type: WellKnown
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mybotspro/refs/heads/main/authentication/mybotspro-authentication.yml
  title: ''
  type: Authentication
  url: authentication/mybotspro-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mybotspro/refs/heads/main/scopes/mybotspro-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/mybotspro-scopes.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mybotspro/refs/heads/main/conformance/mybotspro-conformance.yml
  title: ''
  type: Conformance
  url: conformance/mybotspro-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mybotspro/refs/heads/main/conventions/mybotspro-conventions.yml
  title: ''
  type: Conventions
  url: conventions/mybotspro-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mybotspro/refs/heads/main/errors/mybotspro-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/mybotspro-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mybotspro/refs/heads/main/lifecycle/mybotspro-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/mybotspro-lifecycle.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/mybotspro/refs/heads/main/plans/mybotspro-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/mybotspro-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/mybotspro/refs/heads/main/rate-limits/mybotspro-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/mybotspro-rate-limits.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/mybotspro/refs/heads/main/components/mybotspro-components.yml
  title: ''
  type: Components
  url: components/mybotspro-components.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/mybotspro/refs/heads/main/packages/mybotspro-packages.yml
  title: ''
  type: Packages
  url: packages/mybotspro-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/mybotspro/refs/heads/main/llms/mybotspro-llms.txt
  title: ''
  type: LLMsTxt
