...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/orders-api/refs/heads/main/agentic-access/orders-api-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/orders-api-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/orders-api/refs/heads/main/authentication/orders-api-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Orders publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Application Programming Interface and Order.
