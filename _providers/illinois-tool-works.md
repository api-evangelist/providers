...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/illinois-tool-works/refs/heads/main/security/illinois-tool-works-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/illinois-tool-works-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
...
- group: company
  title: ''
  type: Investors
  url: https://investor.itw.com/
- group: company
  title: ''
  type: Careers
  url: https://www.itw.com/careers/
created: '2026-03-21'
description: Illinois Tool Works (ITW) is a Fortune 500 global multi-industrial manufacturer of value-added consumables and specialty equipment with related service businesses across automotive OEM, food equipment, test and measurement, electronics, welding, polymers and fluids, construction products, and specialty products. ITW does not publish a public API or developer program. This repository exists to track APIs, SDKs, and developer resources should they become available.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/illinois-tool-works.png
layout: provider
modified: '2026-04-28'
