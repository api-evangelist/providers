...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/apiops-cycles-canvas/refs/heads/main/agentic-access/apiops-cycles-canvas-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/apiops-cycles-canvas-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apiops-cycles-canvas/refs/heads/main/security/apiops-cycles-canvas-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/apiops-cycles-canvas-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apiops-cycles-canvas/refs/heads/main/authentication/apiops-cycles-canvas-authentication.yml
  title: ''
  type: Authentication
...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/apiops-cycles-canvas/refs/heads/main/canvases/Canvas_apiBusinessModelCanvas_en-US.json
  title: ''
  type: APIOpsBusinessModelCanvas
  url: canvases/Canvas_apiBusinessModelCanvas_en-US.json
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/apiops-cycles-canvas/refs/heads/main/canvases/Canvas_apiValuePropositionCanvas_en-US.json
  title: ''
  type: APIOpsValuePropositionCanvas
  url: canvases/Canvas_apiValuePropositionCanvas_en-US.json
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/apiops-cycles-canvas/refs/heads/main/canvases/Canvas_businessImpactCanvas_en-US.json
  title: ''
  type: APIOpsBusinessImpactCanvas
  url: canvases/Canvas_businessImpactCanvas_en-US.json
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/apiops-cycles-canvas/refs/heads/main/canvases/Canvas_capacityCanvas_en-US.json
  title: ''
  type: APIOpsCapacityCanvas
  url: canvases/Canvas_capacityCanvas_en-US.json
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/apiops-cycles-canvas/refs/heads/main/canvases/Canvas_customerJourneyCanvas_en-US.json
  title: ''
  type: APIOpsCustomerJourneyCanvas
  url: canvases/Canvas_customerJourneyCanvas_en-US.json
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/apiops-cycles-canvas/refs/heads/main/canvases/Canvas_domainCanvas_en-US.json
  title: ''
  type: APIOpsDomainCanvas
  url: canvases/Canvas_domainCanvas_en-US.json
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/apiops-cycles-canvas/refs/heads/main/canvases/Canvas_eventCanvas_en-US.json
  title: ''
  type: APIOpsEventCanvas
  url: canvases/Canvas_eventCanvas_en-US.json
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/apiops-cycles-canvas/refs/heads/main/canvases/Canvas_interactionCanvas_en-US.json
  title: ''
  type: APIOpsInteractionCanvas
  url: canvases/Canvas_interactionCanvas_en-US.json
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/apiops-cycles-canvas/refs/heads/main/canvases/Canvas_locationsCanvas_en-US.json
  title: ''
  type: APIOpsLocationsCanvas
  url: canvases/Canvas_locationsCanvas_en-US.json
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/apiops-cycles-canvas/refs/heads/main/canvases/Canvas_restCanvas_en-US.json
  title: ''
  type: APIOpsRestCanvas
  url: canvases/Canvas_restCanvas_en-US.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/apiops-cycles-canvas/refs/heads/main/json-schema/apiops-canvas-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/apiops-canvas-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/apiops-cycles-canvas/refs/heads/main/json-ld/apiops-context.jsonld
  title: ''
  type: JSONLD
...
nav: Providers
network: true
overview: 'APIOps Cycles Canvas publishes 1 API on the [APIs.io](https://apis.io/) network: Products API. Tagged areas include API Design, API Strategy, Business Model, Canvas, and Developer Tools.
