...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/clever-care/refs/heads/main/authentication/clever-care-authentication.yml
  title: ''
  type: Authentication
  url: authentication/clever-care-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/clever-care/refs/heads/main/scopes/clever-care-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/clever-care-scopes.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/clever-care/refs/heads/main/agentic-access/clever-care-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/clever-care-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/clever-care/refs/heads/main/security/clever-care-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/clever-care-domain-security.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/clever-care/refs/heads/main/lifecycle/clever-care-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/clever-care-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/clever-care/refs/heads/main/conventions/clever-care-conventions.yml
  title: ''
  type: Conventions
  url: conventions/clever-care-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/clever-care/refs/heads/main/errors/clever-care-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/clever-care-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/clever-care/refs/heads/main/data-model/clever-care-data-model.yml
  title: ''
  type: DataModel
  url: data-model/clever-care-data-model.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/clever-care/refs/heads/main/mcp/clever-care-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/clever-care-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/clever-care/refs/heads/main/llms/clever-care-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/clever-care-llms.txt
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/clever-care/refs/heads/main/overlays/clever-care-fhir-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/clever-care-fhir-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/clever-care/refs/heads/main/well-known/clever-care-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/clever-care-well-known.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/clever-care/refs/heads/main/conformance/clever-care-conformance.yml
  title: ''
  type: Conformance
...
- group: auth
  ...
  url: https://clevercarehealthplan.com/interoperability-and-patient-access/
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/clever-care/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
