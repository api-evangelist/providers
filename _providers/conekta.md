...
- baseURL: https://api.conekta.io
  baseurl_source: declared
  description: The anti Fraud API from Conekta — 4 operation(s) for anti fraud.
  name: Conekta anti Fraud API
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/conekta/refs/heads/main/agentic-access/conekta-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/conekta-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/conekta/refs/heads/main/security/conekta-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/conekta-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/conekta/refs/heads/main/authentication/conekta-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/conekta/refs/heads/main/plans/conekta-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/conekta-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/conekta/refs/heads/main/rate-limits/conekta-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/conekta-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/conekta/refs/heads/main/finops/conekta-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Conekta publishes 25 APIs on the [APIs.io](https://apis.io/) network, including Api Keys API, Balances API, Charges API, and 22 more. Tagged areas include Payments, Payment Processing, Cards, Cash, and OXXO.
