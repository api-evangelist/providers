...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/labvantage/refs/heads/main/security/labvantage-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/labvantage-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/labvantage/refs/heads/main/authentication/labvantage-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'LabVantage Solutions publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Containers API, Instruments API, Results API, and 4 more. Tagged areas include Pharma, Laboratory, LIMS, Quality, and GxP.
