...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/pc-connection/refs/heads/main/security/pc-connection-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/pc-connection-domain-security.yml
- group: company
  title: ''
  type: Website
  url: https://www.connection.com
created: '2026-03-24'
description: PC Connection (now Connection) is a leading IT solutions provider to business, government, healthcare, and education markets, offering technology products and services. No public developer APIs are currently documented for this organization.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/pc-connection.png
layout: provider
modified: '2026-04-28'
name: PC Connection
nav: Providers
...
- kind: domain-security
  name: Pc Connection Domain Security
  slug: pc-connection-domain-security
