...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/postgrid/refs/heads/main/security/postgrid-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/postgrid/refs/heads/main/plans/postgrid-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/postgrid-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/postgrid/refs/heads/main/rate-limits/postgrid-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/postgrid-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/postgrid/refs/heads/main/finops/postgrid-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'PostGrid publishes 3 APIs on the [APIs.io](https://apis.io/) network, including Print & Mail API, and 2 more. Tagged areas include Direct Mail, Print & Mail, Address Verification, Address Validation, and Postcards.
