...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/re-max-canada/refs/heads/main/security/re-max-canada-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/re-max-canada-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/re-max-canada/refs/heads/main/authentication/re-max-canada-authentication.yml
  title: ''
  type: Authentication
  url: authentication/re-max-canada-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/re-max-canada/refs/heads/main/conventions/re-max-canada-conventions.yml
  title: ''
  type: Conventions
  url: conventions/re-max-canada-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/re-max-canada/refs/heads/main/errors/re-max-canada-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/re-max-canada-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/re-max-canada/refs/heads/main/lifecycle/re-max-canada-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/re-max-canada-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/re-max-canada/refs/heads/main/conformance/re-max-canada-conformance.yml
  title: ''
  type: Conformance
  url: conformance/re-max-canada-conformance.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/re-max-canada/refs/heads/main/llms/re-max-canada-llms.txt
  title: ''
  type: LLMsTxt
