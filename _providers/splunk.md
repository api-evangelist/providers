...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/splunk/refs/heads/main/agentic-access/splunk-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/splunk-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/splunk/refs/heads/main/security/splunk-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/splunk-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/splunk/refs/heads/main/security/splunk-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/splunk-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/splunk/refs/heads/main/security/splunk-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/splunk-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/splunk/refs/heads/main/authentication/splunk-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/splunk/refs/heads/main/arazzo/splunk-control-and-cleanup-search-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/splunk-control-and-cleanup-search-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/splunk/refs/heads/main/arazzo/splunk-hec-ingest-and-acknowledge-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/splunk-hec-ingest-and-acknowledge-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/splunk/refs/heads/main/arazzo/splunk-provision-index-and-monitor-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/splunk-provision-index-and-monitor-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/splunk/refs/heads/main/arazzo/splunk-raw-ingest-and-search-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/splunk-raw-ingest-and-search-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/splunk/refs/heads/main/arazzo/splunk-run-search-job-workflow.yml
  title: ''
  type: Arazzo
  url: arazzo/splunk-run-search-job-workflow.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/splunk/refs/heads/main/arazzo/splunk-search-events-workflow.yml
  title: ''
  type: Arazzo
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/splunk/refs/heads/main/rules/splunk-spectral-rules.yml
  title: ''
  type: SpectralRules
...
overview: 'Splunk publishes 3 APIs on the [APIs.io](https://apis.io/) network: Data Inputs API, Index API, and Search API. Tagged areas include Analytics, Data Analysis, Logging, Machine Data, and Monitoring.
  ...
  Splunk''s developer surface includes authentication, engineering blog, support, documentation, getting-started guide, pricing, signup flow, and 51 more developer resources.'
plans:
