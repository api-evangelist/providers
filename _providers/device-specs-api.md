...
overview: 'Device Specs API publishes 1 API on the [APIs.io](https://apis.io/) network: Values API. Tagged areas include mobile, smartphones, phone-specs, chipsets, and hardware.
  ...
  Device Specs API''s developer surface includes documentation, API reference, getting-started guide, engineering blog, support, pricing, signup flow, and 25 more developer resources.'
plans:
