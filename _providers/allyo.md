...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://www.allyo.com/'', ''status'': 301, ''note'': ''declared website redirects to https://www.hirevue.com/platform/candidate-engagement-tools — a different registrable domain (allyo.com -> hirevue.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/allyo/refs/heads/main/security/allyo-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: AllyO is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Human Resources, Recruiting, Conversational AI, and Chatbots.
random_paper: 17
score:
  band: minimal
  composite: 5.0
