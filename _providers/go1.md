...
common:
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/plans/go1-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/go1-plans-pricing.yml
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/capabilities/go1-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/go1-capability-edges.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/security/go1-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/go1-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/agentic-access/go1-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/go1-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/scopes/go1-scopes.yml
  title: ''
  type: OAuthScopes
  url: scopes/go1-scopes.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/authentication/go1-authentication.yml
  title: ''
  type: Authentication
  url: authentication/go1-authentication.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/packages/go1-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/go1-packages.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/cli/go1-cli.yml
  title: ''
  type: CLI
  url: cli/go1-cli.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/components/go1-components.yml
  title: ''
  type: Components
  url: components/go1-components.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/well-known/go1-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/go1-well-known.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/mcp/go1-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/go1-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/llms/go1-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/go1-llms.txt
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/overlays/go1-openapi-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/go1-openapi-overlay.yaml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/conformance/go1-conformance.yml
  title: ''
  type: Conformance
  url: conformance/go1-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/errors/go1-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/go1-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/conventions/go1-conventions.yml
  title: ''
  type: Conventions
  url: conventions/go1-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/data-model/go1-data-model.yml
  title: ''
  type: DataModel
  url: data-model/go1-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/lifecycle/go1-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/security/go1-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/go1-trust-center.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/asyncapi/go1-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/go1-webhooks.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/arazzo/go1-discover-and-enroll.yml
  title: ''
  type: Arazzo
  url: arazzo/go1-discover-and-enroll.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/go1/refs/heads/main/arazzo/go1-provision-portal-and-webhook.yml
  title: ''
  type: Arazzo
...
overview: 'Go1 publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Enrollments API, Learning objects API, Portals API, and 1 more. Tagged areas include Company, EdTech, Learning, E-Learning, and Corporate Training.
  ...
  Go1''s developer surface includes authentication, CLI, documentation, API reference, getting-started guide, support, engineering blog, and 30 more developer resources.'
plans:
- name: Go1 Plans Pricing
  plan_count: 3
  slug: go1-plans-pricing
random_paper: 21
scopes:
- name: Go1 Scopes
  scope_count: 8
