...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/indeed/refs/heads/main/agentic-access/indeed-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/indeed-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/indeed/refs/heads/main/security/indeed-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/indeed-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/indeed/refs/heads/main/authentication/indeed-authentication.yml
  title: ''
  type: Authentication
  url: authentication/indeed-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/indeed/refs/heads/main/scopes/indeed-scopes.yml
  title: ''
  type: OAuthScopes
...
nav: Providers
network: true
overview: 'Indeed publishes 15 APIs on the [APIs.io](https://apis.io/) network, including Candidates API, Employers API, Jobs API, and 12 more. Tagged areas include Careers, Employment, Hiring, Job Search, and Job.


  The Indeed catalog on APIs.io includes 2 JSON-LD contexts and 2 Spectral governance rulesets.


  Indeed''s developer surface includes authentication, support, engineering blog, getting-started guide, release notes, sandbox, and 14 more developer resources.'
plans:
