...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/replyrai/refs/heads/main/capabilities/replyrai-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/replyrai/refs/heads/main/security/replyrai-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/replyrai-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/replyrai/refs/heads/main/authentication/replyrai-authentication.yml
  title: ''
  type: Authentication
  url: authentication/replyrai-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/replyrai/refs/heads/main/conventions/replyrai-conventions.yml
  title: ''
  type: Conventions
  url: conventions/replyrai-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/replyrai/refs/heads/main/errors/replyrai-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/replyrai-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/replyrai/refs/heads/main/data-model/replyrai-data-model.yml
  title: ''
  type: DataModel
  url: data-model/replyrai-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/replyrai/refs/heads/main/lifecycle/replyrai-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/replyrai-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/replyrai/refs/heads/main/conformance/replyrai-conformance.yml
  title: ''
  type: Conformance
  url: conformance/replyrai-conformance.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/replyrai/refs/heads/main/packages/replyrai-packages.yml
  title: ''
  type: Packages
  url: packages/replyrai-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/replyrai/refs/heads/main/llms/replyrai-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/replyrai-llms.txt
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/replyrai/refs/heads/main/overlays/replyrai-platform-api-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/replyrai-platform-api-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/replyrai/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/replyrai/refs/heads/main/plans/replyrai-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/replyrai-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/replyrai/refs/heads/main/rate-limits/replyrai-rate-limits.yml
  title: ''
  type: RateLimits
