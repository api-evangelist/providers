...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/crossmint/refs/heads/main/agentic-access/crossmint-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/crossmint-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/crossmint/refs/heads/main/security/crossmint-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/crossmint-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/crossmint/refs/heads/main/security/crossmint-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/crossmint-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/crossmint/refs/heads/main/authentication/crossmint-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/crossmint/refs/heads/main/plans/crossmint-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/crossmint-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/crossmint/refs/heads/main/rate-limits/crossmint-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/crossmint-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/crossmint/refs/heads/main/finops/crossmint-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Crossmint publishes 12 APIs on the [APIs.io](https://apis.io/) network, including Balances API, Signatures API, Signers API, and 9 more. Tagged areas include Web3, Wallets, NFT, Payments, and Checkout.
