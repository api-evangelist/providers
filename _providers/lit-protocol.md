...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lit-protocol/refs/heads/main/security/lit-protocol-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/lit-protocol/refs/heads/main/plans/lit-protocol-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/lit-protocol-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/lit-protocol/refs/heads/main/rate-limits/lit-protocol-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/lit-protocol-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/lit-protocol/refs/heads/main/finops/lit-protocol-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Lit Protocol publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Account Management API, Actions API, Billing API, and 2 more. Tagged areas include Web3, Key Management, MPC, Programmable Keys, and Lit Actions.
