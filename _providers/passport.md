...
- baseURL: https://api.passportshipping.com/v3
  baseurl_source: declared
  description: The Health Check API from Passport — 1 operation(s) for health check.
  name: Passport Health Check API
...
nav: Providers
network: true
overview: 'Passport publishes 8 APIs on the [APIs.io](https://apis.io/) network, including Cart API, Order API, Product Price API, and 5 more. Tagged areas include Company, Shipping, Logistics, Cross-border eCommerce, and International Shipping.
