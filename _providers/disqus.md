...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/disqus/refs/heads/main/capabilities/disqus-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/disqus-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/disqus/refs/heads/main/agentic-access/disqus-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/disqus-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/disqus/refs/heads/main/security/disqus-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/disqus-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/disqus/refs/heads/main/authentication/disqus-authentication.yml
  title: ''
  type: Authentication
  url: authentication/disqus-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/disqus/refs/heads/main/scopes/disqus-scopes.yml
  title: ''
  type: OAuthScopes
...
overview: 'Disqus publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Categories API, Forums API, Posts API, and 2 more. Tagged areas include Comments, Community, Discussions, Publishing, and Audience Engagement.
  ...
  Disqus'' developer surface includes authentication, documentation, pricing, signup flow, support, engineering blog, and 14 more developer resources.'
random_paper: 5
scopes:
- name: Disqus Scopes
  scope_count: 3
