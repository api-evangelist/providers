...
- group: operate
  title: ''
  type: Releases
  url: https://github.com/lxc/incus/releases
- group: auth
  title: ''
  type: SecurityPolicy
  url: https://github.com/lxc/incus/blob/main/SECURITY.md
- group: build
  title: ''
  type: CodeOfConduct
  url: https://github.com/lxc/incus/blob/main/CODE_OF_CONDUCT.md
- group: docs
  title: ''
  type: ContributionGuide
  url: https://github.com/lxc/incus/blob/main/CONTRIBUTING.md
- group: commercial
  title: ''
  type: License
  url: https://github.com/lxc/incus/blob/main/LICENSE
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/incus/refs/heads/main/agentic-access/incus-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/incus-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/incus/refs/heads/main/security/incus-domain-security.yml
  title: ''
  type: DomainSecurity
...
overview: 'Incus publishes 22 APIs on the [APIs.io](https://apis.io/) network, including certificates API, cluster API, cluster-groups API, and 19 more. Tagged areas include Containers, Virtual Machines, Virtualization, Linux, and Open-Source.
  ...
  Incus'' developer surface includes documentation, getting-started guide, engineering blog, and 11 more developer resources.'
plans:
