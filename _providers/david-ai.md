...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/david-ai/refs/heads/main/security/david-ai-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'David AI is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Artificial Intelligence, Machine-Learning, Audio Data, and Speech Recognition.
