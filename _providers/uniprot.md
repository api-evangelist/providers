...
nav: Providers
network: true
overview: 'UniProt publishes 7 APIs on the [APIs.io](https://apis.io/) network, including UniProtKB REST API, and 6 more. Tagged areas include Proteins, Bioinformatics, Genomics, Life Sciences, and Open Data.
