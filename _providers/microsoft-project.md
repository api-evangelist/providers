...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/microsoft-project/refs/heads/main/agentic-access/microsoft-project-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/microsoft-project-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/microsoft-project/refs/heads/main/security/microsoft-project-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/microsoft-project-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/microsoft-project/refs/heads/main/security/microsoft-project-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/microsoft-project-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/microsoft-project/refs/heads/main/authentication/microsoft-project-authentication.yml
  title: ''
  type: Authentication
  url: authentication/microsoft-project-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/microsoft-project/refs/heads/main/scopes/microsoft-project-scopes.yml
  title: ''
  type: OAuthScopes
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/microsoft-project/refs/heads/main/rules/microsoft-project-spectral-rules.yml
  title: ''
  type: SpectralRules
  url: rules/microsoft-project-spectral-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/microsoft-project/refs/heads/main/vocabulary/microsoft-project-vocabulary.yaml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'Microsoft Project publishes 21 APIs on the [APIs.io](https://apis.io/) network, including Assignments API, Calendars API, Custom Fields API, and 18 more. Tagged areas include Budgeting, Gantt Charts, Microsoft, Portfolio Management, and Project Management.
