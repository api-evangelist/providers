...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/open-podcast-api-open-podcast-api/refs/heads/main/security/open-podcast-api-open-podcast-api-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Open Podcast API publishes 6 APIs on the [APIs.io](https://apis.io/) network. Tagged areas include Audio, Episodes, Open Standard, Podcasts, and Subscription.
