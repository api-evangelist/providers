...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ansible-health/refs/heads/main/security/ansible-health-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Ansible Health is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Healthcare, Telehealth, Virtual Care, and COPD.
