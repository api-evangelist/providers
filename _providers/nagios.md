...
nav: Providers
network: true
overview: 'Nagios publishes 13 APIs on the [APIs.io](https://apis.io/) network, including Config API, CPU API, Disk API, and 10 more. Tagged areas include Monitoring, Infrastructure Monitoring, Network Monitoring, Open Source, and IT Operations.
