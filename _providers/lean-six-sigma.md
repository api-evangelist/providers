...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/lean-six-sigma/refs/heads/main/security/lean-six-sigma-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/lean-six-sigma-domain-security.yml
- group: company
  title: ''
  type: Website
  url: https://www.lean.org/lexicon-terms/six-sigma/
- group: agent
  title: ''
  type: LlmsText
...
jsonld:
- class_count: 3
  name: Lean Six Sigma Context
  property_count: 24
  slug: lean-six-sigma-context
layout: provider
modified: '2026-04-28'
name: Lean Six Sigma
nav: Providers
