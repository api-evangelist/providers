...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/locbox-labs/refs/heads/main/security/locbox-labs-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/locbox-labs/refs/heads/main/plans/locbox-labs-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/locbox-labs-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/locbox-labs/refs/heads/main/rate-limits/locbox-labs-rate-limits.yml
  title: ''
  type: RateLimits
...
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/locbox-labs/refs/heads/main/packages/locbox-labs-packages.yml
  title: ''
  type: Packages
  url: packages/locbox-labs-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/locbox-labs/refs/heads/main/well-known/locbox-labs-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/locbox-labs-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/locbox-labs/refs/heads/main/authentication/locbox-labs-authentication.yml
  title: ''
  type: Authentication
  url: authentication/locbox-labs-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/locbox-labs/refs/heads/main/conventions/locbox-labs-conventions.yml
  title: ''
  type: Conventions
  url: conventions/locbox-labs-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/locbox-labs/refs/heads/main/conformance/locbox-labs-conformance.yml
  title: ''
  type: Conformance
  url: conformance/locbox-labs-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/locbox-labs/refs/heads/main/lifecycle/locbox-labs-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/locbox-labs-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/locbox-labs/refs/heads/main/components/locbox-labs-components.yml
  title: ''
  type: Components
  url: components/locbox-labs-components.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/locbox-labs/refs/heads/main/llms/locbox-labs-llms.txt
  title: ''
  type: LLMsTxt
