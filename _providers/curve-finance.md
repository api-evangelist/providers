...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/curve-finance/refs/heads/main/agentic-access/curve-finance-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/curve-finance-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/curve-finance/refs/heads/main/security/curve-finance-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/curve-finance-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/curve-finance/refs/heads/main/security/curve-finance-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/curve-finance/refs/heads/main/plans/curve-finance-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/curve-finance-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/curve-finance/refs/heads/main/rate-limits/curve-finance-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/curve-finance-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/curve-finance/refs/heads/main/finops/curve-finance-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Curve Finance publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Crv USD API, Deprecated API, Gauges API, and 7 more. Tagged areas include Web3, DeFi, DEX, AMM, and Stablecoins.
