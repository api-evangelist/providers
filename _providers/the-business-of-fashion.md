...
- group: auth
  title: ''
  type: DomainSecurity
  url: security/the-business-of-fashion-domain-security.yml
- group: company
  title: ''
  type: Website
...
- group: commercial
  title: ''
  type: Pricing
  url: https://www.businessoffashion.com/subscriptions/packages/
- group: start
  title: ''
  type: SignUp
  url: https://www.businessoffashion.com/subscriptions/packages/
- group: operate
  title: ''
  type: Support
  url: https://www.businessoffashion.com/subscriptions/faq/
- group: commercial
  title: ''
  type: TermsOfService
  url: https://www.businessoffashion.com/legal/
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://cdn.businessoffashion.com/privacy-policy/05-02-2025_BoF_Privacy_Policy.pdf
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/business-of-fashion
created: '2026-07-17'
...
nav: Providers
network: true
overview: 'The Business of Fashion is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Media, Fashion, Publishing, and News.
