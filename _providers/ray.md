...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ray/refs/heads/main/agentic-access/ray-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/ray-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ray/refs/heads/main/security/ray-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Ray publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Jobs API, Version API, and 3 more. Tagged areas include Distributed Computing, Machine Learning, AI Infrastructure, Python, and Model Serving.
