...
- acting_count: 10
  ...
  summary_line: 10 operations · 10 acting · 6 human-in-the-loop
api_count: 2
apis:
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/mockserver/refs/heads/main/agentic-access/mockserver-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/mockserver-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mockserver/refs/heads/main/security/mockserver-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/mockserver-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/mockserver/refs/heads/main/security/mockserver-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'MockServer publishes 3 APIs on the [APIs.io](https://apis.io/) network: Control API, Expectation API, and Verify API. Tagged areas include Mocking, Mock Servers, Testing, Service Virtualization, and HTTP.
