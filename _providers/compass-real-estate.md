...
- group: auth
  ...
  url: security/compass-real-estate-vulnerability-disclosure.yml
- group: auth
  title: ''
  type: DomainSecurity
  url: security/compass-real-estate-domain-security.yml
- group: company
  title: ''
  type: Website
...
- group: other
  title: ''
  type: Agents
  url: https://www.compass.com/agents-compass/
- group: other
  title: ''
  type: CompassOne
  url: https://www.compass.com/compass-one/
- group: other
  title: ''
  type: Concierge
...
- group: other
  title: ''
  type: PrivateExclusives
  url: https://www.compass.com/private-exclusives/
- group: other
  title: ''
  type: Luxury
  url: https://www.compass.com/luxury/
- group: other
  title: ''
  type: Commercial
  url: https://www.compass.com/commercial/
- group: other
  title: ''
  type: NewDevelopment
  url: https://www.compass.com/new-development/
- group: company
  title: ''
  type: Newsroom
...
- group: operate
  title: ''
  type: PressReleases
  url: https://www.compass.com/newsroom/press-releases/
- group: company
  title: ''
  type: Blog
  url: https://www.compass.com/newsroom/
- group: company
  ...
  url: https://investors.compass.com/
- group: other
  title: ''
  type: SECFilings
  url: https://investors.compass.com/financials/sec-filings/default.aspx
- group: company
  title: ''
  type: Careers
  url: https://www.compass.com/careers/
- group: other
  title: ''
  type: Engineering
  url: https://www.compass.com/careers/departments/engineering
- group: learn
  title: ''
  type: Academy
  url: https://openacademy.compass.com/
- group: other
  title: ''
  type: Offices
  url: https://www.compass.com/about/offices/
- group: build
  title: ''
  type: GitHub
...
- group: company
  title: ''
  type: Twitter
  url: https://twitter.com/compass
- group: company
  title: ''
  type: Instagram
  url: https://www.instagram.com/compass/
- group: learn
  title: ''
  type: YouTube
  url: https://www.youtube.com/@compassrealestate
created: '2026-05-25'
description: 'Compass is a New York City headquartered, tech-enabled residential real estate brokerage founded in 2012 by Robert Reffkin and Ori Allon. The company operates the largest residential real estate brokerage in the United States by sales volume, supporting roughly 36,890 agents and $267 billion in gross transaction value across approximately 250,360 transactions in fiscal year 2025, on $6.96 billion in revenue. Compass builds and operates a proprietary, end-to-end agent platform — an integrated cloud-based suite spanning CRM, marketing center, transaction management, listings, market analytics, the Compass One client dashboard, Compass Lens, AI-powered comparative market analysis, AI-generated video, virtual agent services, and a voice-activated AI assistant — custom-built for residential brokerage workflows. The company has invested over $100 million per year in technology and runs a 500+ person Product and Engineering organization, with engineering hubs that have included Seattle.
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/compass-real-estate.png
layout: provider
modified: '2026-05-25'
name: Compass
nav: Providers
...
- kind: vulnerability-disclosure
  name: Compass Real Estate Vulnerability Disclosure
  slug: compass-real-estate-vulnerability-disclosure
