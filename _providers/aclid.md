...
- baseURL: https://api.aclid.bio
  ...
  description: The Endpoints API from Aclid — 17 operation(s) for endpoints.
  name: Aclid Endpoints API
  slug: aclid-endpoints-api
artifact_total: 6
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/aclid/refs/heads/main/security/aclid-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/aclid/refs/heads/main/authentication/aclid-authentication.yml
  title: ''
  type: Authentication
  url: authentication/aclid-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aclid/refs/heads/main/conventions/aclid-conventions.yml
  title: ''
  type: Conventions
...
- group: design
  ...
  url: conventions/aclid-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aclid/refs/heads/main/errors/aclid-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/aclid-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aclid/refs/heads/main/lifecycle/aclid-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/aclid-lifecycle.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aclid/refs/heads/main/conformance/aclid-conformance.yml
  title: ''
  type: Conformance
  url: conformance/aclid-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aclid/refs/heads/main/data-model/aclid-data-model.yml
  title: ''
  type: DataModel
  url: data-model/aclid-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/aclid/refs/heads/main/components/aclid-components.yml
  title: ''
  type: Components
  url: components/aclid-components.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/aclid/refs/heads/main/packages/aclid-packages.yml
  title: ''
  type: Packages
  url: packages/aclid-packages.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/aclid/refs/heads/main/plans/aclid-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/aclid-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/aclid/refs/heads/main/rate-limits/aclid-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/aclid-rate-limits.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/aclid/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/aclid/refs/heads/main/llms/aclid-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/aclid-llms.txt
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/aclid/refs/heads/main/overlays/aclid-openapi-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/aclid-openapi-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/aclid/refs/heads/main/well-known/aclid-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/aclid-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/aclid/refs/heads/main/well-known/aclid-security.txt
  title: ''
  type: SecurityTxt
  url: well-known/aclid-security.txt
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/aclid/refs/heads/main/security/aclid-vulnerability-disclosure.yml
  title: ''
...
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/aclid/refs/heads/main/sandbox/aclid-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/aclid-sandbox.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/aclid/refs/heads/main/errors/aclid-compliance-reason-codes.yml
  title: ''
  type: DeclineCodes
...
nav: Providers
network: true
overview: 'Aclid publishes 1 API on the [APIs.io](https://apis.io/) network: Endpoints API. Tagged areas include Biosecurity, Biosafety, Compliance, Synthetic Biology, and Life Sciences.
