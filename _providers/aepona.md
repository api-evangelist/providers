...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/aepona/refs/heads/main/security/aepona-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: Aepona is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Infrastructure, Telecommunications, Network as a Service, and API Monetization.
random_paper: 12
security:
