...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/amazon-transfer-family/refs/heads/main/capabilities/amazon-transfer-family-capability-edges.yml
  title: ''
  type: CapabilityMap
  url: capabilities/amazon-transfer-family-capability-edges.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/amazon-transfer-family/refs/heads/main/agentic-access/amazon-transfer-family-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/amazon-transfer-family-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/amazon-transfer-family/refs/heads/main/security/amazon-transfer-family-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/amazon-transfer-family-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/amazon-transfer-family/refs/heads/main/security/amazon-transfer-family-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/amazon-transfer-family-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/amazon-transfer-family/refs/heads/main/security/amazon-transfer-family-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/amazon-transfer-family-domain-security.yml
- group: start
  title: ''
  type: Portal
...
examples:
- key_count: 2
  name: Amazon Transfer Family Example
  slug: amazon-transfer-family-example
features:
...
- description: Programmatic access to Amazon Transfer Family resources.
  name: API Access
finops:
- name: Amazon Transfer Family Finops
  service_category: API
  slug: amazon-transfer-family-finops
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/amazon-transfer-family.png
jsonld:
- class_count: 0
...
nav: Providers
network: true
overview: 'Amazon Transfer Family publishes 71 APIs on the [APIs.io](https://apis.io/) network, including CreateAccess API, CreateAgreement API, CreateConnector API, and 68 more. Tagged areas include File Transfer, FTP, and SFTP.
...
- limit_count: 5
  ...
  slug: amazon-transfer-family-rate-limits
rules:
...
- kind: domain-security
  name: Amazon Transfer Family Domain Security
  slug: amazon-transfer-family-domain-security
  summary_line: TLSv1.3 · HSTS · DMARC
- kind: vulnerability-disclosure
  name: Amazon Transfer Family Vulnerability Disclosure
  slug: amazon-transfer-family-vulnerability-disclosure
  summary_line: security.txt · contact published
- kind: trust-center
  name: Amazon Transfer Family Trust Center
  slug: amazon-transfer-family-trust-center
