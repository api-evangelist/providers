...
- group: auth
  ...
  url: https://www.impart.ai/
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/impart-security/refs/heads/main/packages/impart-security-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/impart-security-packages.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/impart-security/refs/heads/main/authentication/impart-security-authentication.yml
  title: ''
  type: Authentication
  url: authentication/impart-security-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/impart-security/refs/heads/main/conformance/impart-security-conformance.yml
  title: ''
  type: Conformance
  url: conformance/impart-security-conformance.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/impart-security/refs/heads/main/well-known/impart-security-well-known.yml
  title: ''
  type: WellKnown
  url: well-known/impart-security-well-known.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/impart-security/refs/heads/main/security/impart-security-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/impart-security-domain-security.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/impart-security/refs/heads/main/llms/impart-security-llms.txt
  title: ''
  type: LLMsTxt
