...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/abiomed/refs/heads/main/security/abiomed-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Abiomed is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Medical Devices, Healthcare, Cardiology, and Mechanical Circulatory Support.
