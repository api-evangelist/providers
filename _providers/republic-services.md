...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/republic-services/refs/heads/main/security/republic-services-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/republic-services-domain-security.yml
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/RepublicServicesRepository
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/republic-services-inc
- group: company
  title: ''
  type: Website
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/republic-services.png
jsonld:
- class_count: 0
  name: Republic Services Context
  property_count: 23
  slug: republic-services-context
layout: provider
modified: '2026-05-02'
name: Republic Services
nav: Providers
network: true
overview: 'Republic Services is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Environmental Services, Fortune 500, Recycling, and Waste Management.
