...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://www.mosaicml.com'', ''status'': 301, ''note'': ''declared website redirects to https://www.databricks.com/blog/category/databricks-ai — a different registrable domain (mosaicml.com -> databricks.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
nav: Providers
network: true
overview: 'Mosaic Ml is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Machine-Learning, Artificial Intelligence, Generative AI, and Large Language Models.
