...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cflow/refs/heads/main/agentic-access/cflow-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/cflow-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cflow/refs/heads/main/security/cflow-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/cflow-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cflow/refs/heads/main/authentication/cflow-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Cflow publishes 3 APIs on the [APIs.io](https://apis.io/) network: Requests API, Users API, and Workflows API. Tagged areas include Automation, Business Process Automation, Integration, No-Code, and Platform.
