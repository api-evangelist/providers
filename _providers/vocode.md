...
access_model:
  ...
  - authentication
  - security
  - '{''url'': ''https://www.vocode.dev'', ''status'': 301, ''note'': ''declared website redirects to https://github.com/vocodedev — a different registrable domain (vocode.dev -> github.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: true
agent_readiness:
  band: agent-aware
...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/vocode/refs/heads/main/agentic-access/vocode-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/vocode-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/vocode/refs/heads/main/security/vocode-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/vocode-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/vocode/refs/heads/main/authentication/vocode-authentication.yml
  title: ''
  type: Authentication
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/vocode/refs/heads/main/plans/vocode-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/vocode-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/vocode/refs/heads/main/rate-limits/vocode-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/vocode-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/vocode/refs/heads/main/finops/vocode-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Vocode publishes 9 APIs on the [APIs.io](https://apis.io/) network, including Actions API, Agents API, Calls API, and 6 more. Tagged areas include Voice AI, Voice Agents, Telephony, Conversational AI, and Phone Calls.
