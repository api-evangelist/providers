...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/sailpoint/refs/heads/main/agentic-access/sailpoint-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/sailpoint-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sailpoint/refs/heads/main/security/sailpoint-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/sailpoint-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sailpoint/refs/heads/main/authentication/sailpoint-authentication.yml
  title: ''
  type: Authentication
  url: authentication/sailpoint-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/sailpoint/refs/heads/main/scopes/sailpoint-scopes.yml
  title: ''
  type: OAuthScopes
...
nav: Providers
network: true
overview: 'SailPoint publishes 7 APIs on the [APIs.io](https://apis.io/) network, including Access Profiles API, Certifications API, Identities API, and 4 more. Tagged areas include Access Governance, Compliance, Identity and Access Management, Identity Management, and Identity Security.


  The SailPoint catalog on APIs.io includes 1 JSON-LD context and 2 Spectral governance rulesets.


  SailPoint''s developer surface includes authentication, getting-started guide, engineering blog, support, CLI, tooling, and 42 more developer resources.'
plans:
