...
access_model:
  ...
  - authentication
  - security
  - '{''url'': ''https://apiida.com/'', ''status'': 301, ''note'': ''declared website redirects to https://boomi.com/platform/api-management/ — a different registrable domain (apiida.com -> boomi.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: true
agent_readiness:
  band: agent-aware
...
- group: other
  ...
  url: https://boomi.com/
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/apiida/refs/heads/main/agentic-access/apiida-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/apiida-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apiida/refs/heads/main/security/apiida-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/apiida-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/apiida/refs/heads/main/authentication/apiida-authentication.yml
  title: ''
  type: Authentication
