...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/vuejs/refs/heads/main/vocabulary/vuejs-vocabulary.yml
  title: ''
  type: Vocabulary
  url: vocabulary/vuejs-vocabulary.yml
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/vuejs/refs/heads/main/json-schema/vuejs-component-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/vuejs-component-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/vuejs/refs/heads/main/json-ld/vuejs-context.jsonld
  title: ''
  type: JSONLDContext
...
json_schemas:
- name: Vue.js Component Options
  property_count: 23
  slug: vuejs-component
json_structures:
- name: Vuejs Sfc Structure
  property_count: 0
  slug: vuejs-sfc-structure
jsonld:
- class_count: 3
  name: Vuejs Context
  property_count: 17
...
- limit_count: 5
  ...
  slug: vuejs-rate-limits
rules:
- effective_rule_count: 5
  extends: []
  name: Vue.js API Rules
  rule_count: 5
  severity_counts:
    error: 0
    hint: 0
    info: 2
    warn: 3
  slug: vuejs-jsonschema-spectral-rules
score:
  band: thin
  composite: 29.8
  coverage:
