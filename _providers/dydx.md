...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/dydx/refs/heads/main/security/dydx-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'dYdX publishes 1 API on the [APIs.io](https://apis.io/) network: dYdX. Tagged areas include Cryptocurrency, Public APIs, and Real-Time.
