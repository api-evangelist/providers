...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cloudmersive/refs/heads/main/agentic-access/cloudmersive-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/cloudmersive-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cloudmersive/refs/heads/main/security/cloudmersive-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/cloudmersive-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cloudmersive/refs/heads/main/authentication/cloudmersive-authentication.yml
  title: ''
  type: Authentication
...
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cloudmersive/refs/heads/main/json-ld/cloudmersive-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/cloudmersive-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cloudmersive/refs/heads/main/rules/cloudmersive-rules.yml
  title: ''
  type: Spectral
...
nav: Providers
network: true
overview: 'Cloudmersive publishes 2 APIs on the [APIs.io](https://apis.io/) network: Scan API and ScanCloudStorage API. Tagged areas include Barcodes, Conversion, Documents, Image Recognition, and Natural-Language.
