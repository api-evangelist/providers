...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/on-semiconductor/refs/heads/main/security/on-semiconductor-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/on-semiconductor-domain-security.yml
- group: build
  title: ''
  type: GitHubOrganization
  url: https://github.com/ONSemiconductor
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/onsemi
- group: company
  title: ''
  type: Website
...
- group: company
  ...
  url: https://investor.onsemi.com
created: '2026-03-24'
description: ON Semiconductor (now branded as onsemi) is a global supplier of semiconductor-based solutions for power efficiency, image sensing, and signal processing in automotive, industrial, and other applications. No public APIs are documented at this time.
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/on-semiconductor.png
layout: provider
modified: '2026-04-28'
name: onsemi
nav: Providers
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/on-semiconductor/refs/heads/main/screenshots/on-semiconductor-2026-06-20T190706.png
security:
