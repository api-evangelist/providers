...
common:
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/us-army/refs/heads/main/agentic-access/us-army-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/us-army-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/us-army/refs/heads/main/security/us-army-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'US Army publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Articles API, Events API, News API, and 1 more. Tagged areas include Army, Federal Government, Military, Defense, and Open Data.
