...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/anaplan/refs/heads/main/security/anaplan-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/anaplan-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/anaplan/refs/heads/main/security/anaplan-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: company
  href: https://raw.githubusercontent.com/api-evangelist/anaplan/refs/heads/main/blogs/blogs.json
  title: ''
  type: BlogFeed
...
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/anaplan/refs/heads/main/plans/anaplan-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/anaplan-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/anaplan/refs/heads/main/rate-limits/anaplan-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/anaplan-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/anaplan/refs/heads/main/finops/anaplan-finops.yml
  title: ''
  type: FinOps
  url: finops/anaplan-finops.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/anaplan/refs/heads/main/json-ld/anaplan-context.jsonld
  title: ''
  type: JSONLDContext
...
nav: Providers
network: true
overview: 'Anaplan publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Integration API v2.0, and 5 more. Tagged areas include Connected Planning, Enterprise Planning, FP&A, Supply Chain, and Sales Planning.
