...
- baseURL: https://api.cardtonic.com/v1
  ...
  description: The Auth API from Cardtonic — 6 operation(s) for auth.
  name: Cardtonic Auth API
  slug: cardtonic-auth-api
- baseURL: https://api.cardtonic.com/v1
  baseurl_source: declared
  description: The User API from Cardtonic — 8 operation(s) for user.
  name: Cardtonic User API
...
common:
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/cardtonic/refs/heads/main/overlays/cardtonic-business-api-overlay.yaml
  title: ''
  type: Overlay
  url: overlays/cardtonic-business-api-overlay.yaml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cardtonic/refs/heads/main/mcp/cardtonic-mcp.yml
  title: ''
  type: MCPServer
  url: mcp/cardtonic-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cardtonic/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/cardtonic/refs/heads/main/llms/cardtonic-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/cardtonic-llms.txt
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cardtonic/refs/heads/main/conformance/cardtonic-conformance.yml
  title: ''
  type: Conformance
...
- group: auth
  ...
  url: conformance/cardtonic-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/cardtonic/refs/heads/main/lifecycle/cardtonic-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/cardtonic-lifecycle.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/cardtonic/refs/heads/main/packages/cardtonic-packages.yml
  title: ''
  type: Packages
  url: packages/cardtonic-packages.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/cardtonic/refs/heads/main/plans/cardtonic-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/cardtonic-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/cardtonic/refs/heads/main/rate-limits/cardtonic-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/cardtonic-rate-limits.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/cardtonic/refs/heads/main/security/cardtonic-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/cardtonic-domain-security.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/cardtonic/refs/heads/main/finops/cardtonic-finops.yml
  title: ''
  type: FinOps
...
nav: Providers
network: true
overview: 'Cardtonic publishes 2 APIs on the [APIs.io](https://apis.io/) network: Auth API and User API. Tagged areas include Africa, Bill Payments, eSIM, Finance, and Fintech.


  Cardtonic''s developer surface includes documentation, API reference, signup flow, engineering blog, support, and 27 more developer resources.'
plans:
