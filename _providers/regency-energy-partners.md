...
access_model:
  ...
  public: false
  source:
  - '{''url'': ''https://www.regencyenergy.com'', ''status'': 301, ''note'': ''declared website redirects to https://www.energytransfer.com/ — a different registrable domain (regencyenergy.com -> energytransfer.com), possible rename or acquisition (probed 2026-09-03, roadmap#169)''}'
  trial: false
  try_now: false
agent_readiness:
  band: human-only
...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/regency-energy-partners/refs/heads/main/security/regency-energy-partners-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/regency-energy-partners-domain-security.yml
- group: company
  title: ''
  type: LinkedIn
  url: https://www.linkedin.com/company/regency-energy-partners-lp
- group: company
  title: ''
  type: Website
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/regency-energy-partners.png
jsonld:
- class_count: 17
  name: Regency Energy Partners Context
  property_count: 5
  slug: regency-energy-partners-context
layout: provider
modified: '2026-05-02'
name: Regency Energy Partners
nav: Providers
network: true
overview: 'Regency Energy Partners is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include Midstream, Natural Gas, Energy, Master Limited Partnership, and Oil and Gas.
