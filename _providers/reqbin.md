...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/reqbin/refs/heads/main/security/reqbin-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/reqbin-domain-security.yml
- group: company
  title: ''
  type: Website
...
image: https://kinlane-images.s3.amazonaws.com/shared/apis-json/icons/reqbin.png
jsonld:
- class_count: 0
  name: Reqbin Context
  property_count: 15
...
nav: Providers
network: true
overview: 'ReqBin is profiled on the [APIs.io](https://apis.io/) network. Tagged areas include API Testing, Browser, Code Generation, Developer Tools, and HTTP Client.


  The ReqBin catalog on APIs.io includes 1 JSON-LD context.
...
score:
  ...
  upsert:
    ...
    reason: no_specs
screenshot: https://raw.githubusercontent.com/api-evangelist/reqbin/refs/heads/main/screenshots/reqbin-2026-06-20T192917.png
security:
