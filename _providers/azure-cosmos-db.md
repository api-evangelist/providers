...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/azure-cosmos-db/refs/heads/main/agentic-access/azure-cosmos-db-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/azure-cosmos-db-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/azure-cosmos-db/refs/heads/main/security/azure-cosmos-db-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/azure-cosmos-db-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/azure-cosmos-db/refs/heads/main/security/azure-cosmos-db-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/azure-cosmos-db-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/azure-cosmos-db/refs/heads/main/authentication/azure-cosmos-db-authentication.yml
  title: ''
  type: Authentication
  url: authentication/azure-cosmos-db-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/azure-cosmos-db/refs/heads/main/scopes/azure-cosmos-db-scopes.yml
  title: ''
  type: OAuthScopes
...
nav: Providers
network: true
overview: 'Azure Cosmos DB publishes 14 APIs on the [APIs.io](https://apis.io/) network, including Collections API, Databases API, Documents API, and 11 more. Tagged areas include Database, NoSQL, Document Database, Vector Database, and Globally Distributed.
