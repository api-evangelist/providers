...
nav: Providers
network: true
overview: 'Prediko publishes 1 API on the [APIs.io](https://apis.io/) network. Tagged areas include Company, Inventory, Demand Forecasting, Supply Chain, and E-Commerce.
