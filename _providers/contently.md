...
- group: auth
  ...
  url: https://contently.com/trust/security/
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/contently/refs/heads/main/security/contently-trust-center.yml
  title: ''
  type: TrustCenter
  url: security/contently-trust-center.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/contently/refs/heads/main/security/contently-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/contently-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/contently/refs/heads/main/security/contently-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/contently-vulnerability-disclosure.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/contently/refs/heads/main/lifecycle/contently-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/contently-lifecycle.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/contently/refs/heads/main/authentication/contently-authentication.yml
  title: ''
  type: Authentication
  url: authentication/contently-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/contently/refs/heads/main/asyncapi/contently-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/contently-webhooks.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/contently/refs/heads/main/conventions/contently-conventions.yml
  title: ''
  type: Conventions
  url: conventions/contently-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/contently/refs/heads/main/conformance/contently-conformance.yml
  title: ''
  type: Conformance
  url: conformance/contently-conformance.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/contently/refs/heads/main/plans/contently-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/contently-plans-pricing.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/contently/refs/heads/main/rate-limits/contently-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/contently-rate-limits.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/contently/refs/heads/main/packages/contently-packages.yml
  title: ''
  type: Packages
  url: packages/contently-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/contently/refs/heads/main/llms/contently-llms.txt
  title: ''
  type: LLMsTxt
