...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/ocelot/refs/heads/main/agentic-access/ocelot-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/ocelot-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ocelot/refs/heads/main/security/ocelot-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/ocelot-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/ocelot/refs/heads/main/authentication/ocelot-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'Ocelot publishes 4 APIs on the [APIs.io](https://apis.io/) network, including Authentication API, Cache API, Configuration API, and 1 more. Tagged areas include .NET, API Gateway, Microservices, and Open Source.
