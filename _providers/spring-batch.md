...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/spring-batch/refs/heads/main/agentic-access/spring-batch-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/spring-batch-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spring-batch/refs/heads/main/security/spring-batch-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/spring-batch-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spring-batch/refs/heads/main/security/spring-batch-domain-security.yml
  title: ''
  type: DomainSecurity
...
nav: Providers
network: true
overview: 'Spring Batch publishes 5 APIs on the [APIs.io](https://apis.io/) network, including Jobs API, Health API, Metrics API, and 2 more. Tagged areas include Batch Processing, Data Processing, Enterprise, ETL, and Java.
