...
common:
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/duplo/refs/heads/main/security/duplo-domain-security.yml
  title: ''
  type: DomainSecurity
...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/duplo/refs/heads/main/conformance/duplo-conformance.yml
  title: ''
  type: Compliance
  url: conformance/duplo-conformance.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/duplo/refs/heads/main/authentication/duplo-authentication.yml
  title: ''
  type: Authentication
  url: authentication/duplo-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/duplo/refs/heads/main/conventions/duplo-conventions.yml
  title: ''
  type: Conventions
  url: conventions/duplo-conventions.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/duplo/refs/heads/main/sandbox/duplo-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/duplo-sandbox.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/duplo/refs/heads/main/lifecycle/duplo-lifecycle.yml
  title: ''
  type: Lifecycle
...
- group: design
  ...
  url: conformance/duplo-conformance.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/duplo/refs/heads/main/asyncapi/duplo-atlas-webhooks.yml
  title: ''
  type: Webhooks
  url: asyncapi/duplo-atlas-webhooks.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/duplo/refs/heads/main/mcp/duplo-mcp.yml
  title: ''
  type: X-MCPServerCandidate
  url: mcp/duplo-mcp.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/duplo/refs/heads/main/skills/_index.yml
  title: ''
  type: AgentSkill
  url: skills/_index.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/duplo/refs/heads/main/data-model/duplo-data-model.yml
  title: ''
  type: DataModel
  url: data-model/duplo-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/duplo/refs/heads/main/errors/duplo-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/duplo-problem-types.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/duplo/refs/heads/main/llms/duplo-llms.txt
  title: ''
  type: LLMsTxt
