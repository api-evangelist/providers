...
- group: other
  href: https://raw.githubusercontent.com/api-evangelist/spothero/refs/heads/main/capabilities/spothero-capability-edges.yml
  title: ''
  type: CapabilityMap
...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/spothero/refs/heads/main/agentic-access/spothero-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/spothero-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spothero/refs/heads/main/security/spothero-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/spothero-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spothero/refs/heads/main/authentication/spothero-authentication.yml
  title: ''
  type: Authentication
...
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/spothero/refs/heads/main/json-schema/spothero-reservation-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/spothero-reservation-schema.json
- group: docs
  href: https://raw.githubusercontent.com/api-evangelist/spothero/refs/heads/main/json-schema/spothero-facility-schema.json
  title: ''
  type: JSONSchema
  url: json-schema/spothero-facility-schema.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/spothero/refs/heads/main/json-structure/spothero-reservation-structure.json
  title: ''
  type: JSONStructure
  url: json-structure/spothero-reservation-structure.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/spothero/refs/heads/main/json-structure/spothero-facility-structure.json
  title: ''
  type: JSONStructure
  url: json-structure/spothero-facility-structure.json
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/spothero/refs/heads/main/json-ld/spothero-context.jsonld
  title: ''
  type: JSONLD
  url: json-ld/spothero-context.jsonld
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/spothero/refs/heads/main/rules/spothero-rules.yml
  title: ''
  type: SpectralRules
  url: rules/spothero-rules.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/spothero/refs/heads/main/vocabulary/spothero-vocabulary.yml
  title: ''
  type: Vocabulary
...
nav: Providers
network: true
overview: 'SpotHero publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Availability API, Facilities API, Rates API, and 3 more. Tagged areas include Parking, Mobility, Transportation, Navigation, and Reservations.
