...
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/spotify/refs/heads/main/agentic-access/spotify-agentic-access.yml
  title: ''
  type: AgenticAccess
  url: agentic-access/spotify-agentic-access.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spotify/refs/heads/main/security/spotify-vulnerability-disclosure.yml
  title: ''
  type: VulnerabilityDisclosure
  url: security/spotify-vulnerability-disclosure.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spotify/refs/heads/main/security/spotify-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/spotify-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spotify/refs/heads/main/authentication/spotify-authentication.yml
  title: ''
  type: Authentication
  url: authentication/spotify-authentication.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/spotify/refs/heads/main/scopes/spotify-scopes.yml
  title: ''
  type: OAuthScopes
...
overview: 'Spotify publishes 15 APIs on the [APIs.io](https://apis.io/) network, including Albums API, Artists API, Audiobooks API, and 12 more. Tagged areas include Music, Audio, Streaming, Podcasts, and Playlists.
  ...
  Spotify''s developer surface includes authentication, getting-started guide, changelog, engineering blog, and 18 more developer resources.'
plans:
