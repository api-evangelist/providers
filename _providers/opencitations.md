...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/opencitations/refs/heads/main/security/opencitations-domain-security.yml
  title: ''
  type: DomainSecurity
  url: security/opencitations-domain-security.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/opencitations/refs/heads/main/authentication/opencitations-authentication.yml
  title: ''
  type: Authentication
...
nav: Providers
network: true
overview: 'OpenCitations publishes 6 APIs on the [APIs.io](https://apis.io/) network, including Authors API, Citations API, Editors API, and 3 more. Tagged areas include Citations, Scholarly, Research, Open Science, and Bibliometrics.
