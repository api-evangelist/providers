...
nav: Providers
network: true
overview: 'Classy publishes 10 APIs on the [APIs.io](https://apis.io/) network, including Authentication API, Campaigns API, Designations API, and 7 more. Tagged areas include Nonprofit, Fundraising, Donations, Peer to Peer, and Philanthropy.
