...
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/osha/refs/heads/main/authentication/osha-authentication.yml
  title: ''
  type: Authentication
  url: authentication/osha-authentication.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/osha/refs/heads/main/conventions/osha-conventions.yml
  title: ''
  type: Conventions
  url: conventions/osha-conventions.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/osha/refs/heads/main/errors/osha-problem-types.yml
  title: ''
  type: ErrorCatalog
  url: errors/osha-problem-types.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/osha/refs/heads/main/lifecycle/osha-lifecycle.yml
  title: ''
  type: Lifecycle
  url: lifecycle/osha-lifecycle.yml
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/osha/refs/heads/main/changelog/osha-changelog.yml
  title: ''
  type: ChangeLog
  url: changelog/osha-changelog.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/osha/refs/heads/main/data-model/osha-data-model.yml
  title: ''
  type: DataModel
  url: data-model/osha-data-model.yml
- group: design
  href: https://raw.githubusercontent.com/api-evangelist/osha/refs/heads/main/conformance/osha-conformance.yml
  title: ''
  type: Conformance
  url: conformance/osha-conformance.yml
- group: start
  href: https://raw.githubusercontent.com/api-evangelist/osha/refs/heads/main/sandbox/osha-sandbox.yml
  title: ''
  type: Sandbox
  url: sandbox/osha-sandbox.yml
- group: build
  href: https://raw.githubusercontent.com/api-evangelist/osha/refs/heads/main/packages/osha-packages.yml
  title: ''
  type: Packages
...
- group: build
  ...
  url: packages/osha-packages.yml
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/osha/refs/heads/main/llms/osha-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/osha-llms.txt
- group: operate
  href: https://raw.githubusercontent.com/api-evangelist/osha/refs/heads/main/rate-limits/osha-rate-limits.yml
  title: ''
  type: RateLimits
  url: rate-limits/osha-rate-limits.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/osha/refs/heads/main/plans/osha-plans-pricing.yml
  title: ''
  type: Plans
  url: plans/osha-plans-pricing.yml
- group: commercial
  href: https://raw.githubusercontent.com/api-evangelist/osha/refs/heads/main/finops/osha-finops.yml
  title: ''
  type: FinOps
  url: finops/osha-finops.yml
- group: auth
  href: https://raw.githubusercontent.com/api-evangelist/osha/refs/heads/main/security/osha-domain-security.yml
  title: ''
  type: DomainSecurity
