...
- group: auth
  ...
  title: ''
  type: DomainSecurity
  url: security/replika-ai-domain-security.yml
- group: company
  title: ''
  type: Website
...
- group: other
  title: ''
  type: Download
  url: https://replika.onelink.me/m83y/web2app
- group: operate
  title: ''
  type: Support
...
- group: commercial
  title: ''
  type: TermsOfService
  url: https://replika.com/legal/terms-of-service
- group: commercial
  title: ''
  type: PrivacyPolicy
  url: https://replika.com/legal/privacy
- group: company
  title: ''
  type: Careers
  url: https://careers.replika.com/
- group: other
  title: ''
  type: ParentCompany
  url: https://luka.ai/
- group: company
  title: ''
  type: X (Twitter)
  url: https://x.com/MyReplika
- group: company
  title: ''
  type: Instagram
  url: https://www.instagram.com/myreplika/
- group: company
  title: ''
  type: Facebook
  url: https://www.facebook.com/groups/Replika.AI.Friends/
- group: other
  title: ''
  type: Reddit
  url: https://www.reddit.com/r/replika/
- group: operate
  title: ''
  type: Discord
  url: https://discord.com/invite/replika
- group: other
  title: ''
  type: Notes
  url: ''
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/replika-ai/refs/heads/main/llms/replika-ai-llms.txt
  title: ''
  type: LLMsTxt
  url: llms/replika-ai-llms.txt
- group: agent
  href: https://raw.githubusercontent.com/api-evangelist/replika-ai/refs/heads/main/well-known/replika-ai-well-known.yml
  title: ''
  type: WellKnown
...
features:
- AI companion chatbot with persistent personality and memory
- Customizable avatar, personality, and voice
- Voice calls with the Replika
- Selfies and image-sharing inside chat
- Augmented reality and VR (Oculus Rift) modes
- Tiered relationship modes - free friend, paid partner/spouse/sibling/mentor
- Freemium model (Replika Pro subscription)
